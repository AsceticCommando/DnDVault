...
> [!NOTE|div-m] Player Name:  `Thumon "Monon" Menopolemon`
...
| Class    | `INPUT[template-person-class][:char_class]` `INPUT[template-person-class][:char_class2]` |

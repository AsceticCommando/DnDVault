...
You unleash a blast of brilliant fire. Make a ranged spell attack against a target within range; a target gains no benefit from [Half Cover](3-Mechanics/CLI/rules/variant-rules/cover-xphb.md) or [Three-Quarters Cover](3-Mechanics/CLI/rules/variant-rules/cover-xphb.md) for this attack roll. On a hit, the target takes `dice:2d10|noform|noparens|avg` (`2d10`) Radiant damage.

...
You temporarily summon three familiars—spirits that take animal forms of your choice. Each familiar uses the same rules and options for a familiar conjured by the [find familiar](3-Mechanics/CLI/spells/find-familiar-xphb.md) spell. All the familiars conjured by this spell must be the same type of creature (celestials, fey, or fiends; your choice). If you already have a familiar conjured by the [find familiar](3-Mechanics/CLI/spells/find-familiar-xphb.md) spell or similar means, then one fewer familiars are conjured by this spell.

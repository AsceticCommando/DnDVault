...
Whenever a creature you can see enters the spirit's space or starts its turn within 5 feet of the spirit, you can force that creature to make a Dexterity saving throw if the spirit has no creature [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained). On failed save, the target takes `dice:8d8|noform|noparens|avg` (`8d8`) damage of the spirit's type, and the target has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition until the spell ends. At the start of each of its turns, the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) target repeats the save. On a failed save, the target takes `dice:4d8|noform|noparens|avg` (`4d8`) damage of the spirit's type. On a successful save, the target isn't [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by the spirit.

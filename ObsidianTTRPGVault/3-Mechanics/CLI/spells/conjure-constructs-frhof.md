...
- **Orderly Ward.** The target gains [Temporary Hit Points](3-Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to `dice:1d6|noform|noparens|avg` (`1d6`) plus your spellcasting ability modifier.  

When you move on your turn, you can also move the spirits up to 30 feet to an unoccupied space you can see.

**Using a Higher-Level Spell Slot.** The damage and [Temporary Hit Points](3-Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md) both increase by `dice:1d6|noform|noparens|avg|text(1d6)` for each spell slot level above 3.

...
Burning radiance erupts from you in a 5-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md). Each creature of your choice that you can see in it must succeed on a Constitution saving throw or take `dice:1d6|noform|noparens|avg` (`1d6`) Radiant damage.

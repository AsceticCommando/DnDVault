...
On each of your subsequent turns, you can take a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) to deal `dice:1d12|noform|noparens|avg` (`1d12`) Lightning damage to the target automatically, even if the first attack missed.

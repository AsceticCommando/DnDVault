...
As a [Magic](3-Mechanics/CLI/rules/actions.md#Magic) action, you can make a melee spell attack with the fiery blade. On a hit, the target takes Fire damage equal to `dice:3d6|noform|noparens|avg` (`3d6`) plus your spellcasting ability modifier.

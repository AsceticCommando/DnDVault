...
Until the spell ends, you have [Resistance](3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Radiant damage, and your melee attacks deal an extra `dice:2d6|noform|noparens|avg` (`2d6`) Radiant damage on a hit.

...
You compel one creature you can see within range to die. If the target has 100 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) or fewer, it dies. Otherwise, it takes `dice:12d12|noform|noparens|avg` (`12d12`) Psychic damage.

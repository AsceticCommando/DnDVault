...
Silver energy bursts out from you in a 120-foot-long, 5-foot-wide [Line](3-Mechanics/CLI/rules/variant-rules/line-area-of-effect-xphb.md). Each creature of your choice in the [Line](3-Mechanics/CLI/rules/variant-rules/line-area-of-effect-xphb.md) makes a Strength saving throw. On a failed save, a creature takes `dice:3d10|noform|noparens|avg` (`3d10`) Force damage and has the [Prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition. On a successful save, a creature takes half as much damage only.

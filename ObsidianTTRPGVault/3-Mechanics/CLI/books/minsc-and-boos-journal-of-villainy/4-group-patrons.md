...
![](file://book/MaBJoV/013.webp#center)
...
It is much easier for you to sell magic items. Any magic item that you want to sell can be sold for its full price. Common and uncommon magic items take a day to sell. Rare and very rare items take `dice:1d10|noform|noparens|avg` (`1d10`) days. Legendary items take `dice:1d4|noform|noparens|avg` (`1d4`) weeks.
...
![](file://book/MaBJoV/014.webp#center)

## Candlekeep

![](file://book/MaBJoV/015.webp#center)
...
![](file://book/MaBJoV/016.webp#center)
...
![](file://book/MaBJoV/018.webp#center)
...
![](file://book/MaBJoV/017.webp#center)
...
![](file://book/MaBJoV/019.webp#center)
...
![](file://book/MaBJoV/020.webp#center)
...
![](file://book/MaBJoV/021.webp#center)
...
![](file://book/MaBJoV/022.webp#center)
...
Once per month the Flaming Fist gives your group a mission to perform. This mission takes precedence over all other activities. If completed, the group rolls on the [Treasure Hoard: Challenge 0—4](3-Mechanics/CLI/tables/treasure-hoard-challenge-04.md) table in the "Dungeon Master's Guide" for their reward.
...
![](file://book/MaBJoV/023.webp#center)
...
![](file://book/MaBJoV/024.webp#center)
...
Anyone who were to come into possession of the [iron flask](3-Mechanics/CLI/items/iron-flask-xdmg.md) that contains [Pazuzu](3-Mechanics/CLI/bestiary/npc/pazuzu-mabjov.md) would also be considered a great threat. Finally, the Zhentarim have always been a rival of the Harpers.
...
![](file://book/MaBJoV/025.webp#center)
...
![](file://book/MaBJoV/026.webp#center)
...
- **Bronze.** The egg must be exposed to the sky for 12 hours a day or suffused with electricity once a day. The [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp-xphb.md) spell also works.  
...
A typical dragon egg takes `dice:3d6|noform|noparens|avg` (`3d6`) weeks to hatch. When an egg is not looked after properly, there is a cumulative 10 percent chance per day that the egg will die. Once this happens, the egg will never hatch.
...
![](file://book/MaBJoV/027.webp#center)
...
You speak directly for [Jon Irenicus](3-Mechanics/CLI/bestiary/npc/jon-irenicus-mabjov.md). You may use the [sending](3-Mechanics/CLI/spells/sending-xphb.md) spell to communicate with him once per day.
...
![](file://book/MaBJoV/028.webp#center)
...
![](file://book/MaBJoV/030.webp#center)
...
![](file://book/MaBJoV/029.webp#center)
...
![](file://book/MaBJoV/031.webp#center)
...
![](file://book/MaBJoV/032.webp#center)
...
The fences of the Shadow Thieves are amongst the best in the world. They can sell rare and easily recognizable items (such as stolen art and jewelry) as well as expensive magic items. Any item that you want to sell can be sold for its full price. Non-magical items and common and uncommon magic items take a day to sell. Rare and very rare items take `dice:1d10|noform|noparens|avg` (`1d10`) days. Legendary items take `dice:1d4|noform|noparens|avg` (`1d4`) weeks.

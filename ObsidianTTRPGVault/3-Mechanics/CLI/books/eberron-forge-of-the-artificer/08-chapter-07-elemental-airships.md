...
![Conflict between houses escalates to the skies as elemental airships join in battle](file://book/EFA/066-07-001.airship-battle.webp#center)
...
![](file://book/EFA/067-07-002.airship-getaway.webp#center)
...
A ship that has enough movement can pull alongside another vessel, deploy a boarding party, and then move away, provided the members of the boarding party took the [Ready](3-Mechanics/CLI/rules/actions.md#Ready) action and positioned themselves so they can move onto the other vessel once it's close enough.
...
The ship has the [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) condition, and while on board it, creatures are also [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible). These effects last for 1 hour, until this station is destroyed, or until the crew member that took this action loses Concentration or leaves this station.
...
When an airship is at risk of getting lost—such as when traveling through dense fog or over unfamiliar land—the crew member operating the ship's Helm makes a Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check; the DC for this check is determined by the Airship Travel Conditions table. Another crew member who has proficiency in the [Survival](3-Mechanics/CLI/rules/skills.md#Survival) skill can take the [Help](3-Mechanics/CLI/rules/actions.md#Help) action to assist this check as normal.
...
As with a journey on the ground, sometimes characters spend part of their journey searching for something—usually something on the ground. When characters are searching the ground from the air, use the Search DC for the terrain on the ground from the [Travel Terrain table](3-Mechanics/CLI/tables/travel-terrain-xdmg.md) in the "Dungeon Master's Guide", but feel free to give characters Advantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks if their aerial vantage point makes it easier for them to see what they're looking for.
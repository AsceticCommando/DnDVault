...
![A hammerhead ship collides with a tyrant ship in the Astral Sea](file://book/AAG/012-02-001.astral-adventuring-splash.webp#center)
...
![Diagram 2.1: Air Envelope and Gravity Plane](file://book/AAG/013-02-002.air-and-gravity.webp#center)
...
> 
> Although nonmagical fire cannot exist in the vacuum of Wildspace, magical fire (such as that created by a [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell) does burn in a vacuum. Magical fire does not cause objects to burst into flame, however, because there is no air to make ignition possible.
^fire-in-wildspace
...
![Diagram 2.2: The Astral Plane](file://book/AAG/014-02-003.the-astral-plane.webp#center)

Wildspace is where the Astral Plane overlaps with the Material Plane. Creatures and objects in Wildspace age normally and exist on both planes simultaneously. This overlap enables creatures to use spells such as [teleport](3-Mechanics/CLI/spells/teleport-xphb.md) and [teleportation circle](3-Mechanics/CLI/spells/teleportation-circle-xphb.md) to travel from Wildspace to a nearby world, or vice versa.
...
World-to-world travel requires a spelljamming ship, a [teleport](3-Mechanics/CLI/spells/teleport-xphb.md) spell, or some other kind of magic.
...
At the end of each hour spent fishing, a character can make a DC 15 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check. A failed check indicates no fish is caught during that hour. On a successful check, roll a `dice:d10|noform|noparens|avg` (`d10`) and consult the Fishing table to determine the catch.
...
![While using an astral projection spell to traverse the Astral Sea, Mordenkainen the wizard happens upon a spelljamming ship](file://book/AAG/017-02-006.mordy-astral-projection.webp#center)

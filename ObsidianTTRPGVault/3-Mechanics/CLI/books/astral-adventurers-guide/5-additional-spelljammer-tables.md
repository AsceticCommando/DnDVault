...
To randomly determine what's in the cargo hold of a spelljamming ship, roll `dice:1d6|noform|noparens|avg` (`1d6`) times on the Cheap Cargo table and `dice:1d4|noform|noparens|avg` (`1d4`)–1 times on the Expensive Cargo table. A duplicate result indicates that the ship has more of the same cargo.
...
| dice: d12 | Cargo |
|-----------|-------|
| 1 | Trunk containing ten outfits of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md) (2 gp each) |
...
| 10 | Chest containing fifty [vials of perfume](3-Mechanics/CLI/items/perfume-xphb.md) (2 gp each) |
...
| 2 | Crate containing one hundred [1-ounce bottles of ink](3-Mechanics/CLI/items/ink-xphb.md) (10 gp each) and one thousand sheets of [parchment](3-Mechanics/CLI/items/parchment-xphb.md) (1 sp each) |
| 3 | Crate containing twenty [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), [flasks of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), or [vials of antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md) (50 gp each) |
| 4 | Crate containing one hundred bottles of exquisite wine (25 gp each) |
| 5 | Set of exquisitely crafted furniture (2,500 gp) |
| 6 | Locked trunk containing five unloaded [pistols](3-Mechanics/CLI/items/pistol-xphb.md) (250 gp each) and a box of 100 bullets |
| 7 | Locked case containing an exquisite Dragonchess set made of crystal or ivory (2,500 gp) |
| 8 | Locked trunk containing ten [bombs](3-Mechanics/CLI/items/bomb-xdmg.md) (150 gp each; see ""Explosives"" in the "Dungeon Master's Guide") |
| 9 | Crate containing one hundred fireworks (25 gp each) |
| 10 | Crate containing five unloaded [muskets](3-Mechanics/CLI/items/musket-xphb.md) (500 gp each) and a box of 100 bullets |
| 11 | Locked case containing five [spyglasses](3-Mechanics/CLI/items/spyglass-xphb.md) (1,000 gp each) |
| 12 | Ten 20-pound [kegs of gunpowder](3-Mechanics/CLI/items/gunpowder-keg-xdmg.md) (250 gp each; see ""Explosives"" in the "Dungeon Master's Guide") |
^expensive-cargo
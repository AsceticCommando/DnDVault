...
Planar travelers often find [mimirs](3-Mechanics/CLI/items/mimir-sato.md) invaluable in learning about reality and avoiding doom at the hands, claws, fangs, tentacles, proboscises, ovipositors, and other appendages of the multiverse's countless predatory and lethally grumpy inhabitants.

![Creatures from every corner of the multiverse crowd Sigil's busy streets](file://book/MPP/000-00-001.sigil-busy.webp#center)

[Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md), however, isn't a [mimir](3-Mechanics/CLI/items/mimir-sato.md).
...
![Sunflies influenced by various Outer Planes inhabit every corner of the Outlands](file://book/MPP/001-00-002.sunfly-side.webp#center)
...
> 
> **Soul Shape.** A dead petitioner can be returned to life only by the [true resurrection](3-Mechanics/CLI/spells/true-resurrection-xphb.md) spell or the [wish](3-Mechanics/CLI/spells/wish-xphb.md) spell. If affected by these spells, a petitioner chooses whether to return in its original mortal form or as a petitioner.
^005
...
![A Beastlands-influenced explorer picnics with her animal friends in an idyllic glade](file://book/MPP/002-00-003.picnic.webp#center)
...
Creatures influenced by the Beastlands gain wilder or more animalistic features, such as larger eyes, thicker fur, or more prominent canine teeth. Beasts influenced by the Beastlands are often affected per the [awaken](3-Mechanics/CLI/spells/awaken-xphb.md) spell—though normal Beasts also typically range through these areas in large numbers. A creature influenced by the Beastlands also gains one or more of following traits of your choice:
...
> [!note] 
> 
> **Phantasmal Dweomer (1/Day).** After being in continuous physical contact with a Tiny nonmagical object for 1 minute, the creature can imbue the object with one of the following magical properties (choose one or roll a `dice:d6|noform|noparens|avg` (`d6`)):
> 
...
> 
> **Torturous Teleport.** An invisible, magic-disrupting aura surrounds the creature. Any creature that teleports into or out of a space within 20 feet of the creature must make a DC 15 Constitution saving throw, taking `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) force damage on a failed save, or half as much damage on a successful one.
^027
...
![A unicorn influenced by Gehenna charges through a pustuled forest](file://book/MPP/003-00-004.gehenna-unicorn.webp#center)
...
> 
> **Larval Rebirth.** When the creature dies, it re-forms somewhere in Hades as a [larva](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) (see the "Dungeon Master's Guide") in `dice:1d10|noform|noparens|avg` (`1d10`) days.
> 
...
> [!note] 
> 
> **Chaotic Magic.** The creature can cast the [thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy-xphb.md) cantrip, choosing a magical effect at random. Charisma is the spellcasting ability for this spell.
> 
> **Churning Chaos.** When the creature scores a critical hit or takes a critical hit, chaotic energy bursts from the creature, creating one the following effects (choose one or roll a `dice:d6|noform|noparens|avg` (`d6`)):
> 
...
> 
> **Hidden Slaad.** When the creature dies, a [slaad tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from the creature's chest.
^039

![A night hag sells larvae fresh from the Lower Planes](file://book/MPP/004-00-005.hag-larvae.webp#center)
...
> 
> **Structural Repair (1/Day).** After being in continuous physical contact with a nonmagical object for 1 minute, the creature can magically repair the object as though it had cast a [mending](3-Mechanics/CLI/spells/mending-xphb.md) spell on it.
^03e
...
> [!note] 
> 
> **Healing Orb.** When the creature dies, its body releases a spectral orb that hovers in the same space and lasts for 1 minute. Any good-aligned creature that starts its turn within 5 feet of the orb regains `dice:1d6|noform|noparens|avg` (`1d6`) hit points.
> 
...
![A gleaming wyvern imbued with the radiance of Mount Celestia navigates a crystalline cave](file://book/MPP/005-00-006.gleaming-wyvern.webp#center)
...
> 
> **Viper Nest.** When the creature dies, its body disgorges a [swarm of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md) in the same space.
^046
...
![Mechanical dinosaurs roam an orderly realm influenced by the lawful energies of Mechanus](file://book/MPP/006-00-007.mechanus-dinosaurs.webp#center)
...
![In a landscape warped by Limbo's pure chaos, an animal-headed ettin fights a massive, many-eyed ooze](file://book/MPP/007-00-008.limbo-madness.webp#center)
...
![](file://book/MPP/008-00-017.morte-meet-dragon.webp#center)

...
![](file://book/CaBoMP/009.webp#center)
...
These patterns are intended to be accessible to adventurers of every class and background. There are no techniques that require the use of [mage hand](3-Mechanics/CLI/spells/mage-hand-xphb.md) to wield an additional hook or [unseen servant](3-Mechanics/CLI/spells/unseen-servant-xphb.md) to hold stitches into place. If you find it necessary to evoke [bless](3-Mechanics/CLI/spells/bless-xphb.md) or [beacon of hope](3-Mechanics/CLI/spells/beacon-of-hope-xphb.md) while tackling a pattern, you should consider setting it aside for a short while and trying an easier skill-building design first.
...
![](file://book/CaBoMP/010.webp#center)
...
![](file://book/RMR/042-c2-01.webp#center)

> [!note] 
> 
> ![](file://book/RMR/043-ram-head-rick-lol2.webp#center)
> 
...
![](file://book/RMR/044-c2-02.webp#center)
...
![](file://book/RMR/045-c2-03.webp#center)
...
> [!note] 
> 
> ![](file://book/RMR/046-ram-head-smile2.webp#center)
> 
> In fact, here's a SURPRISE Table I j-j-just whipped up that you can use. Roll a `dice:d12|noform|noparens|avg` (`d12`) and consult the results over here.
^05f
...
If a tie occurs, the DM decides the order among tied DM-controlled creatures, and the players decide the order among their tied characters. The DM can decide the order if the tie is between a monster and a player character. Optionally, the DM can have the tied characters and monsters each roll a `dice:d20|noform|noparens|avg` (`d20`) to determine the order, highest roll going first.

> [!note] 
> 
> ![](file://book/RMR/047-ram-head-rick-mad.webp#center)
> 
> This is why Dexterity is so important, Morty. You've gotta be fast to get what you want in life and in D&D.
> 
> ![](file://book/RMR/048-c2-04.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/049-c2-05.webp#center)
> 
...
> 
> ![](file://book/RMR/050-c2-06.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/051-ram-head-sarcasm.webp#center)
> 
...
> "AW HELL NO, SON!"
> 
> ![](file://book/RMR/052-ram-head-rick-madconfused.webp#center)
> 
...
![](file://book/RMR/053-c2-07.webp#center)
...
> [!note] 
> 
> ![](file://book/RMR/054-c2-08.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/055-ram-head-rick-lol.webp#center)
> 
...
![](file://book/RMR/056-c2-09.webp#center)
...
> [!note] 
> 
> ![](file://book/RMR/057-c2-10.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/058-c2-11.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/059-ram-head-rick-lol.webp#center)
> 
> HELP
> 
...
![](file://book/RMR/060-c2-12.webp#center)

When you make an attack, your attack roll determines whether the attack hits or misses. To make an attack roll, roll a `dice:d20|noform|noparens|avg` (`d20`) and add the appropriate modifiers. If the total of the roll plus modifiers equals or exceeds the target's Armor Class (AC), the attack hits. Each character's AC is shown on the character sheet, and each monster's AC is in the monster's stat block.
...
> [!note] 
> 
> ![](file://book/RMR/061-c2-13.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/062-c2-14.webp#center)
> 
...
![](file://book/RMR/063-c2-15.webp#center)
...
> [!note] 
> 
> ![](file://book/RMR/064-ram-head-smile1.webp#center)
> 
...
> 
> ![](file://book/RMR/065-ram-head-madyell.webp#center)
> 
> ***DON'T F*** WITH THAT SIMPLE LIFE-DEATH ECOSYSTEM.***
> 
> ![](file://book/RMR/066-ram-head-sarcasm.webp#center)
> 
...
> 
> ![](file://book/RMR/067-ram-head-hmph.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/068-ram-head-ehlol.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/069-c2-16.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/070-ram-head-confused.webp#center)
> 
...
> 
> ![](file://book/RMR/071-ram-head-stern-flip.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/072-c2-17.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/073-c2-18.webp#center)
> 
...
For example, if you score a critical hit with a dagger, roll `dice:2d4|noform|noparens|avg` (`2d4`) for the damage, rather than `dice:1d4|noform|noparens|avg` (`1d4`), and then add your relevant ability modifier. If the attack involves other damage dice, such as from the rogue's Sneak Attack feature, you roll those dice twice as well.

> [!note] 
> 
> ![](file://book/RMR/074-c2-19.webp#center)
> 
> ***CRITICAL FAIL***
> 
> Notice that there aren't any critical fails here in the rules. That's because the math is *completely ridiculous*.
> 
> You roll a `dice:d20|noform|noparens|avg` (`d20`) over and over each session, so if 5 percent of the time it caused a lethally stupid mistake, you'd be dead faster than Jerry's sex drive.
> 
> ***BUT-***
> 
...
> 
> Then, on the rare occasion it actually happens, roll a `dice:d12|noform|noparens|avg` (`d12`) and consult this special *Critical Fail Table* I put together just for you:
^09b
...
![](file://book/RMR/075-c2-20.webp#center)

> [!note] 
> 
> ![](file://book/RMR/076-c2-21.webp#center)
> 
> No saving throw.
> 
> No resistance.
...
> [!note] 
> 
> ![](file://book/RMR/077-ram-head-rick-lol.webp#center)
> 
...
> 
> ![](file://book/RMR/078-c2-22.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/079-ram-head-sarcasm.webp#center)
> 
...
> NOPE!
> 
> ![](file://book/RMR/080-ram-head-rick-madconfused.webp#center)
> 
...
> 
> ![](file://book/RMR/081-ram-head-yas.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/082-c2-23.webp#center)
> 
...
Roll a `dice:d20|noform|noparens|avg` (`d20`). If the roll is 10 or higher, you succeed. Otherwise, you fail. A success or failure has no effect by itself. On your third success, you become stable (see below). On your third failure, you die. The successes and failures don't need to be consecutive; keep track of both until you collect three of a kind. The number of both is reset to zero when you regain any hit points or become stable.

##### Rolling 1 or 20

When you make a death saving throw and roll a 1 on the `dice:d20|noform|noparens|avg` (`d20`), it counts as two failures. If you roll a 20 on the `dice:d20|noform|noparens|avg` (`d20`), you regain 1 hit point.
...
> [!note] 
> 
> ![](file://book/RMR/083-ram-mortyface-panic-flip.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/084-ram-mortyface-mad2-flip.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/085-ram-mortyface-sad.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/086-ram-mortyface-jaded.webp#center)
> 
...
> [!note] 
> 
> ![](file://book/RMR/087-ram-head-drunk.webp#center)
> 
> OW, F***!!
> 

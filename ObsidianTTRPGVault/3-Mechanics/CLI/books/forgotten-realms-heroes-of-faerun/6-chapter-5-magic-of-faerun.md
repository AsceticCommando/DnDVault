...
![Vajra Safahr commands the mighty walking statues of Waterdeep.](file://book/FRHoF/146-05-001.vajra-safahr-commands.webp#center)
...
![Presto casts the Blade of Disaster spell to fight off Venger.](file://book/FRHoF/147-05-002.presto-casts.webp#center)
...
After you initiate the spell, each secondary caster takes the [Magic](3-Mechanics/CLI/rules/actions.md#Magic) action to contribute to the spell. A secondary caster can take this action only while within 30 feet of you and before the start of your next turn.
...
If the spell has a casting time of 1 minute or more, you and each secondary caster must take the [Magic](3-Mechanics/CLI/rules/actions.md#Magic) action on each of your turns for the entire casting time, and you must each maintain Concentration while you do so. In this case, if any caster's Concentration is broken, the spell fails.
...
![Red Wizards developed circle magic to cast spells beyond the power of any single mage.](file://book/FRHoF/148-05-003.red-wizards-circle-magic.webp#center)
...
When you cast a spell that requires [Concentration](3-Mechanics/CLI/rules/conditions.md#Concentration), you can distribute the mental load of the spell among you and the secondary casters. Once the casting is complete, you and all secondary casters can maintain Concentration on this spell. As long as at least one caster who contributed to the spell maintains this Concentration, the spell's effects remain active.

#### Expand

When you cast a spell that creates an area of effect, you can increase one dimension of the spell's area of effect for this casting by 10 feet per secondary caster contributing to the spell. For example, if a spell creates a 20-foot-radius [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md), casting it as a Circle spell with two secondary casters would increase the radius to 40 feet. A spell that creates a [Line](3-Mechanics/CLI/rules/variant-rules/line-area-of-effect-xphb.md) that is 5 feet wide and 300 feet long, cast as a Circle spell with two secondary casters, could make a Line that is either 25 feet wide or 320 feet long.
...
When you cast a spell that creates an area of effect, you can carve out a safe zone within that area of effect that is unaffected by the spell for its duration. This safe zone consists of a number of 5-foot [Cubes](3-Mechanics/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) equal to your spellcasting ability modifier plus the number of secondary casters contributing to the spell (minimum of one Cube). You can arrange the Cubes as you like, but each Cube must be contiguous with at least one other Cube.
...
![Alustriel Silverhand uses her mooncloak to protect her allies.](file://book/FRHoF/149-05-004.alustriel-silverhand.webp#center)

...
Whether you're using [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set, oracle cards like tarokka cards or tarot cards, or a deck of playing cards, you can do things with cards that would be difficult or even impossible to do using dice:

![](file://book/BMT/007-02-001.balance.webp#center)

- **Archetypes and Imagery.** When interpreting [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set and oracle cards, you can lean on the cards' imagery, not just numbers and words. A card's artwork can generate meaning for that card beyond whatever this book or any other text might tell you it means. Cards from Magic: The Gathering (https://gatherer.wizards.com/Pages/Card/Details.aspx?action=random) also work well for inspiration since they feature amazing fantasy art in addition to symbols. Ordinary playing cards' suits, one-eyed jacks, and other markings can be assigned additional meanings.  
...
> 
> The ""Card Sparks"" and ""Journey Spread"" sections ask you to interpret cards based on their assigned meaning. The reference book that accompanies [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) describes meanings for those cards, and the Curse of Strahd adventure summarizes the meanings of tarokka cards. Various books and websites explain the meanings of tarot cards.
^01c

![You can use Magic: The Gathering (https://gatherer.wizards.com/Pages/Card/Details.aspx?action=random) cards to build idea decks for creatures, items, people, or situations](file://book/BMT/008-02-002.decks.webp#center)

The rest of this chapter is devoted to examples of how you can use these properties of cards to enrich your D&D game. If you're interested in further possibilities, the reference book that accompanies [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set also presents a method for using the deck to generate adventures, as well as advice on using them for in-game fortune-telling.
...
You can use [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set (or an equivalent deck built from twenty-two playing cards) to give players alternative ways to use inspiration.
...
The journey spread is a means of making long journeys more interesting. In this method, you place cards in a particular arrangement (a spread) and interpret them based on their meaning, position, and orientation. You can use [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set, tarokka cards, a tarot deck, or any other cards you can readily assign symbolic meanings to. This method works best for a journey you expect to last at least as many days as you have players.
...
Here is an example of how you might interpret cards from [The Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) card set in a journey spread, with interpretations informed by the card descriptions in the reference book:
...
- **Day 3 Reward or Ruin.** Gem. If the characters overcome the challenges of the menagerie, they discover valuable treasures there; if not, they must face one additional trap or monster that uses the appearance of treasure as bait, such as a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md).  
...
A friend is a creature that helps the characters fight the other creatures in an encounter. The friend might be the sole survivor of another adventuring party, a solitary traveler or recluse, or a benevolent monster like a [flumph](3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md) or an angel. The friend might have information about the adventure location or the creatures that dwell there.
...
Lurkers might include Humanoid foes like bandits, as well as ambush predators such as [violet fungi](3-Mechanics/CLI/bestiary/plant/violet-fungus-dosi.md), [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md), and [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md).
...
The twins could be a pair of [displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) or a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) with two pet [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) (with the two hell hounds represented by a single card). Because you're more likely to draw both twin cards when the encounter deck has thinned out, the twin encounter should make for a climactic battle. Each twin should have a challenge rating about equal to the characters' level.

![A pair of displacer beasts in a dark forest has the makings of a memorable encounter](file://book/BMT/012-02-005.displacer-beasts.webp#center)
...
Another way to handle a goal is to omit the goal card from the deck at the beginning of the session and shuffle it in when the characters reach a particular milestone. For example, suppose the goal is to defeat a [gnoll fang of Yeenoghu](3-Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md) responsible for raiding nearby villages. There might be four ordinary [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) (minions of the fang of Yeenoghu) in the encounter deck. Once the characters have killed three of the minions, shuffle the goal card in. That way, the characters always meet the minions first.

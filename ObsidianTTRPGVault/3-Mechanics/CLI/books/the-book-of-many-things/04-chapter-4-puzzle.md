...
This chapter includes puzzles, riddles, and traps themed to the [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) for Dungeon Masters' use.

## Puzzles

![](file://book/BMT/013-03-001.puzzle.webp#center)
...
The card on the table is a nonmagical version of the Rogue card from a [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md). The four other cards mentioned in the statue's message—Sage, Jester, Knight, and Fates—are each located in a different area nearby.
...
![Diagram 4.1: The Perfect Hand Puzzle Solution](file://book/BMT/014-03-002.diagram-4-1.webp#center)
...
> [!note] 
> 
> ![Diagram 4.2: Unseen Order Handout 1](file://book/BMT/015-03-006.diagram-42-unseen-order-1.webp#center)
> 
> ![Diagram 4.3: Unseen Order Handout 2](file://book/BMT/016-03-007.diagram-43-unseen-order-2.webp#center)
^050

#### Puzzle Features

The cards on the table are nonmagical versions of those from the [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md). If the characters struggle to understand the riddle, the ghost can explain the rules more clearly:
...
> [!note] 
> 
> ![Diagram 4.4: Unseen Order Solution (Example)](file://book/BMT/017-03-008.diagram-44-unseen-order-solve.webp#center)
^051
...
Here are twenty-two riddles you can use in any campaign. Each riddle's answer is the name of a card from the [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md):

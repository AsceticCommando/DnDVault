...
![](file://book/PaF/039_1.webp#center)
...
![A pink bottle label reading: Vodka distilled locally for The Pink Flumph Theater using only the purest waters from the Clearwell.](file://book/PaF/041_1.webp#center)

## Hordelander

![](file://recipes/PaF/042.webp#center)
...
![](file://recipes/PaF/044.webp#center)

## Mother

![](file://recipes/PaF/045.webp#center)
...
![](file://recipes/PaF/046.webp#center)
...
![](file://recipes/PaF/047.webp#center)

For anyone unsure of what a "[Flumph](3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md)" is, they are strange, floating, jellyfish-like creatures found in the Underdark. Wise, kind, and good-natured, these peculiar creatures feed exclusively on psionic energy. That energy affects their mood, which in turn affects their coloration. A pink flumph is a happy flumph. Darker colors reflect darker emotions and may suggest that the flumphs are feeding off something dangerous, like [aboleths](3-Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) or [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md), which is a useful warning to explorers.

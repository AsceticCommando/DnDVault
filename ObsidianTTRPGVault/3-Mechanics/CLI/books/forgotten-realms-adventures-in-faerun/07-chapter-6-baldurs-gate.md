...
![Karlach Cliffgate enjoys herself on the streets of Baldur's Gate](file://book/FRAiF/148-06-001.karlach.webp#center)
...
![Grand Duke Ulder Ravengard addresses the people of Baldur's Gate.](file://book/FRAiF/149-06-002.grand-duke-ulder.webp#center)
...
![The city's criminal gangs prey on patriars and wealthy visitors alike](file://book/FRAiF/150-06-003.citys-criminal-gangs.webp#center)
...
> [!gallery]
> ![Map: Baldur's Gate](file://book/FRAiF/151-map-06.001-baldurs-gate.webp#gallery)
> ![Player Version](file://book/FRAiF/152-map-06.001-baldurs-gate-player.webp#gallery)
...
> [!gallery]
> ![Map: The Unrolling Scroll](file://book/FRAiF/153-map-06.002-the-unrolling-scroll.webp#gallery)
> ![Player Version](file://book/FRAiF/154-map-06.002-the-unrolling-scroll-player.webp#gallery)
...
![](file://book/FRAiF/155-06-004.altar.webp#center)
...
> [!gallery]
> ![Map: Garmult's House of Mastery](file://book/FRAiF/156-map-06.003-garmults-house-of-mastery.webp#gallery)
> ![Player Version](file://book/FRAiF/157-map-06.003-garmults-house-of-mastery-player.webp#gallery)
...
![Garmult gives Karlach a lesson as Shadowheart and Astarion look on](file://book/FRAiF/158-06-005.garmult-and-karlach.webp#center)
...
> [!gallery]
> ![Map: Whitkeep Hostel](file://book/FRAiF/159-map-06.004-whitkeep-hostel.webp#gallery)
> ![Player Version](file://book/FRAiF/160-map-06.004-whitkeep-hostel-player.webp#gallery)
...
![Eegru, an animal trainer at Whitkeep Hostel, conceals a deadly secret](file://book/FRAiF/161-06-006.eegru-conceals.webp#center)
...
![](file://book/FRAiF/162-06-007.skull-amulet.webp#center)
...
> [!gallery]
> ![Map: Sewer Keep](file://book/FRAiF/163-map-06.005-sewer-keep.webp#gallery)
> ![Player Version](file://book/FRAiF/164-map-06.005-sewer-keep-player.webp#gallery)
...
> [!gallery]
> ![Map: Baldur's Gate Outskirts](file://book/FRAiF/165-map-06.007-baldurs-gate-outskirts.webp#gallery)
> ![Player Version](file://book/FRAiF/166-map-06.007-baldurs-gate-outskirts-player.webp#gallery)
...
> [!gallery]
> ![Map: Candlekeep](file://book/FRAiF/167-map-06.006-candlekeep.webp#gallery)
> ![Player Version](file://book/FRAiF/168-map-06.006-candlekeep-player.webp#gallery)
...
![](file://book/FRAiF/169-06-008.baldurs-gate-view.webp#center)
...
![The Flaming Fist maintains order in the Upper City of Baldur's Gate](file://book/FRAiF/170-06-009.flaming-fist.webp#center)
...
![](file://book/FRAiF/171-06-010.examining-ring.webp#center)
...
You can roll `dice:1d20|noform|noparens|avg` (`1d20`) on the table below to generate encounters for a party of any level traveling around Baldur's Gate. Alternatively, roll `dice:1d10|noform|noparens|avg` (`1d10`) if the characters are in the Upper City, `dice:1d10+5|noform|noparens|avg` (`1d10 + 5`) if the characters are in the Lower City, or `dice:1d10+10|noform|noparens|avg` (`1d10 + 10`) if the characters are elsewhere (such as in the Outer City or the Sewers). Once you've used a given encounter, remove it from the table and create a new one to replace it.
...
Two [Indifferent](3-Mechanics/CLI/rules/variant-rules/indifferent-attitude-xphb.md) dwarf Flaming Fist members (Medium [Guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) keep everyone away from Narrowlady Dock with assurances that the Flaming Fist is "solving the problem." This is a lie; the guards rolled the corpses off the dock and are hanging around until they can report back that they found no clues. A character can take an [Influence](3-Mechanics/CLI/rules/actions.md#Influence) action and convince the pair to leave with a successful DC 10 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception), [Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation), or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check or buy them off for 10 GP. The guards also leave if the characters try to start a fight, grumbling, "I hope you get the trouble you're so eager to find."

#### Dock Clues

Blood spatters cover the area where the stevedores were killed, and blood trails lead over the side of the dock. The only ship near the site is an unseaworthy vessel called the Fearsome Grimace. The ship has sunk up to its gunwales in Gray Harbor, and it's afloat only because it's lashed to Narrowlady Dock. A character who takes a Study action and succeeds on a DC 12 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check realizes that the corpses were recently rolled over the side of the dock by the Flaming Fist. A character who takes a [Search](3-Mechanics/CLI/rules/actions.md#Search) action and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception) or [Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check identifies tracks of the killers—the splayed, scaled feet of sahuagin.
...
> [!gallery]
> ![Map: Eomane House](file://book/FRAiF/172-map-06.008-eomane-house.webp#gallery)
> ![Player Version](file://book/FRAiF/173-map-06.008-eomane-house-player.webp#gallery)
...
character can participate in each round, but different characters can participate in ensuing rounds. Victory in a round requires a successful DC 18 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) roll, but a participating character who succeeds on one of the additional checks listed with each patriar below makes the Charisma check with Advantage. Intersperse the debate checks with reactions from the audience, such as gasps as the characters reveal secrets and applause if they win a round.

- **Arvin Dlusker.** A successful DC 15 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History)) or Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check reveals that Arvin's debate position is motivated by desire to reverse his family's severe financial losses.  
- **Brevek Faenor.** Duke Brevek Faenor's arguments in favor of expanding Parliament authority draw surprised gasps from the audience. A successful DC 15 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check reminds the character of Brevek's tense history as a former priest of Oghma here in the Unrolling Scroll.  
- **Tallis Whitburn.** A successful DC 15 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) or Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) notes slate dust on Tallis's garments, showing she has resorted to helping with manual labor at her understaffed Whitburn quarry.  

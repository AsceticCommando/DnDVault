...
![Princess Caitlyn Kendrick sails her Windskiff through magical Moonshae Isles](file://book/FRAiF/129-05-001.windskiff.webp#center)
...
![Moonwells are centers of worship for people throughout the Moonshaes.](file://book/FRAiF/130-05-002.moonwells.webp#center)
...
![Every fairy trod has its own guardian.](file://book/FRAiF/131-05-003.fairy-trod-guardian.webp#center)
...
> [!gallery]
> ![Map: Norlander Longship](file://book/FRAiF/132-map-05.001-norlander-longship.webp#gallery)
> ![Player Version](file://book/FRAiF/133-map-05.001-norlander-longship-player.webp#gallery)

#### Rusted Hulk

Rusted warriors conduct raids using mighty warships. [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) and her allies strengthen these hulking vessels by adding rusty metal plates to their hulls.
...
As a [Study](3-Mechanics/CLI/rules/actions.md#Study) action, a creature can search for a fairy trod within 1 mile of their current location and make a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check; a creature that has used this fairy trod before has Advantage on this check. On a successful check, the creature discovers the shortest path to the nearest fairy trod, if any.

#### Fairy Trod Guardians

Every fairy trod has a guardian, and they change over time. It is possible for characters to encounter a new guardian each time they use the same trod. A guardian is usually a Fey such as a Centaur [Druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md), [Dire Worg](3-Mechanics/CLI/bestiary/fey/dire-worg-xmm.md), [Green Hag](3-Mechanics/CLI/bestiary/fey/green-hag-xmm.md), or [Satyr Revelmaster](3-Mechanics/CLI/bestiary/fey/satyr-revelmaster-xmm.md). Most guardians are initially [Indifferent](3-Mechanics/CLI/rules/variant-rules/indifferent-attitude-xphb.md) to the characters. The guardian appears to anyone attempting to use the trod and puts them through a test. This test can take varying forms, such as a duel, a riddle game, or a poetry contest. If the party completes the test or if the guardian becomes [Friendly](3-Mechanics/CLI/rules/variant-rules/friendly-attitude-xphb.md), the characters can use the trod.
...
> [!gallery]
> ![Map: Moonshae Isles](file://book/FRAiF/134-map-05.002-moonshae-isles-full.webp#gallery)
> ![Player Version](file://book/FRAiF/135-map-05.002-moonshae-isles-full-player.webp#gallery)
...
![Touched by fey influences, creatures inhabiting the Moonshae Isles are beautiful and dangerous.](file://book/FRAiF/136-05-004.moonshae-creatures.webp#center)
...
The magic of Gwynneth makes it perilous. Bullywugs proliferate in the wetlands lining Gwynneth's coast, and [Displacer Beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) lurk in every forest and mountain vale. [The Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting), however, hasn't touched Gwynneth. The communities here are so magically isolated from the rest of the isles that their inhabitants haven't even heard of [the Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting). If the curse reaches this island, the Earthmother herself would be in peril.

#### Caer Corwell

The ancestral home of the Kendrick family, Caer Corwell fell into ruin after High Lady Ordalf's arrival. The castle was the lair of evil and mischievous fey for years, but after Ordalf's retreat to Winterglen, the Kendricks returned to Caer Corwell and rebuilt it. The reconstruction effort brought merchants and crafters aplenty, and the settlements of southern Gwynneth are thriving for the first time in a century. There's always more to do, such as driving back bullywugs in the Fens of the Fallen or hunting [Displacer Beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) in Llyrath Forest.
...
This busy, get-rich-quick atmosphere allowed Vvim Toth (Medium, Neutral Evil [Archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)), a human Red Wizard of Thay, to establish a Thayan enclave in Kingsbay, ostensibly providing magical services to well-paying merchants and mercenaries. In truth, Toth seeks information on the moonwells and the secret rites of the Moonshae druids, hoping to use them to fuel his rise to power in Thay.

![Druids serving the Earthmother protect the many moonwells of Gwynneth.](file://book/FRAiF/137-05-005.druids.webp#center)

#### Myrloch Vale

A forested valley with an ancient connection to the Feywild surrounds the lake known as Myrloch, framed by multiple mountain ranges. For centuries, fey creatures have crossed the border between worlds in the Vale, and enough have stayed to make the vale home to a bewildering population of fey. Here, centaurs ride in herds, pixies and [Sprites](3-Mechanics/CLI/bestiary/fey/sprite-xmm.md) flit through the air like starlings, and packs of [Blink Dogs](3-Mechanics/CLI/bestiary/fey/blink-dog-xmm.md) patrol the trails. Ancient forests are home to dryads and treants. Faerie dragons are especially common here. Druids work with bards of the College of the Moon to keep the peace, monitor moonwells, and perform rites to honor the Earthmother. Agents of the Emerald Enclave come here to train.

#### Karador

The fairy city of Karador lies beneath the waters of Myrloch. Once home to High Lady Ordalf and thousands of fey, the city sank beneath the waves when the magic of its mythal was broken. Treasure hunters and explorers probe the sunken ruins, preyed on by [Sea Hags](3-Mechanics/CLI/bestiary/fey/sea-hag-xmm.md), sahuagin, and giant sea beasts.
...
Although fey of every kind dwell here, the Shadowfell has corrupted flora and fauna alike. Trees crowd around trespassing travelers, herding them to their doom deep in the forest; packs of [Worgs](3-Mechanics/CLI/bestiary/fey/worg-xmm.md) and [Displacer Beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) prowl unchecked; [Swarms of Stirges](3-Mechanics/CLI/bestiary/monstrosity/swarm-of-stirges-xmm.md) feast on the slow and the dead.
...
Giants and giant kin live in the Trollclaw mountains on the north end of Moray and have built a new home for themselves above the remains of Dennin's Delve, an ancient dwarven stronghold. A portal connects tunnels beneath Dennin's Delve with old tunnels under the Fairheight Range in Alaron, and the [Shadow Dragon](3-Mechanics/CLI/bestiary/dragon/shadow-dragon-xmm.md) menacing the dwarves and orcs of Alaron has sent its minions to Dennin's Delve. The giants responded by locking the tunnels, and a small band of heroic goliaths later appointed themselves watchers of the locked door. They stand vigil to this day.
...
Norland's jarl is the human Olfsvenn (Medium [Warrior Commander](3-Mechanics/CLI/bestiary/humanoid/warrior-commander-xmm.md)), son of Olfgaut, son of Rault the Wise. He has sworn oaths of loyalty to House Kendrick but keeps a terrible secret: his sister Renauta embraced [the Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting) and became [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md). She is now gathering Rusted allies. Driven by the vain hope that he can redeem his sister, Olfsvenn corresponds with Forfallen through letters carried by trusted couriers. When she asks him for favors and information, such as key supplies or knowledge of lucrative targets for piracy, Olfsvenn occasionally obliges her by directing her against his enemies and rivals. Jarl Olfsvenn maintains Stormbanner Hold, a fortress and feasting hall outside the city of Rogarsheim. Famous for his hospitality, Olfsvenn's generous gifts have bought him the loyalty of many followers. But if the gold were to run out, the jarl might find himself alone.

![Rusted Basking Shark](file://book/FRAiF/138-05-006.rusted-basking-shark.webp#center)
...
Years ago, a coalition of giants from Maelstrom returned to Oman's Isle in enormous longboats, driving the previous inhabitants out of their homes and across the water. Now the giants live in small but well-established steadings across the isle, especially where Ostorian ruins were left intact in the Grampalt Highlands. [Hill Giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) cluster on the eastern slopes, protecting their steadings with kennels of [Dire Wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md). [Frost Giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) occupy the western highlands, which are covered in freezing rain and snow. Under the shadow of Icepeak, the region's tallest mountain, frost giants herd [Giant Goats](3-Mechanics/CLI/bestiary/beast/giant-goat-xmm.md), build ships, and raid Gwynneth from across the Strait of Oman. [Fire Giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) reopened the old Norlander mines underneath the highlands and sell the ore they find to Iron Keep in exchange for treasures gathered in Rusted raids.
...
Iron Keep was abandoned when the giants invaded Oman's Isle, and it lay empty for decades. Now it is home to Axenwight (Medium, Chaotic Evil, Rusted [Pirate Captain](3-Mechanics/CLI/bestiary/humanoid/pirate-captain-xmm.md); see the "Rusted|FRAiF|Other Rusted" sidebar in "chapter 9"), one of [Queen Forfallen's](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) chief lieutenants. No one knows why the giants tolerate Axenwight's presence in Oman's Isle, but rumor has it that the queen cut a deal with the fire giants, and the frost and hill giants followed along according to giant custom.

Although he's proclaimed himself jarl of Oman's Isle, Axenwight controls only the area around Iron Bay. From here, he harvests from the Stone Wood, buys ore from giants, and builds ships and weapons for [Queen Forfallen's](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) war machine. His desire to plunder Thelgaar Ironhand's tomb draws treasure seekers who promise to satisfy Axenwight's greed. However, expedition attempts have failed, and Axenwight doesn't tolerate failure.
...
![Rusted pirates travel the seas in well-armed, rusty ships.](file://book/FRAiF/139-05-007.rusted-pirates.webp#center)
...
Sometimes the natural currents around Ruathym, Whalebones, and the Moonshaes combine and create a whirlpool strong enough to draw in ships. Ships caught in its currents are torn apart and their wreckage drifts to the ocean floor three thousand feet below, where it is picked clean by [Giant Crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md).
...
Norlander culture was born on the island of Ruathym, two hundred miles north of the Moonshaes. Seeking to escape the bleak and mountainous Ruathym, wracked by strong waves and bitter cold, Norlanders sent longships south and east, settling in both the Moonshaes and the old city of Illusk (now Luskan). While Norlanders of the Moonshaes have little reason to return to Ruathym, they still tell stories of their people's grand exodus. [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) uses the settlement of Ruathym as a safe harbor, selling plunder from her raids, buying supplies, and recruiting fresh crew.
...
![](file://book/FRAiF/140-05-008.moonshae-full.webp#center)
...
A coven of hags makes an especially good recurring villain for a Moonshae Isles campaign, but you also might use a [Winter Eladrin](3-Mechanics/CLI/bestiary/fey/winter-eladrin-mpmm.md) (see "Mordenkainen Presents: Monsters of the Multiverse").
...
Norlander adventures often focus on piracy, raiding, or whaling. Norlander longships raid coastal settlements and prey on passing ships, so pirates and raiders make great enemies for your characters. You can use Humanoid creatures in the "Monster Manual" such as guards, scouts, berserkers, priests of Tempus, and, of course, pirates for Norlander raiders. They might bring animals or other monstrous companions with them on raids, such as [Winter Wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) or a pet [Owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md). After the characters fight off a raid, they might follow the raiders back to their home and negotiate with (or threaten) their leader to end the attacks.

Whaling has been part of Norland culture for centuries, and many Norland families depend on whales for survival. Whaling is an extraordinarily dangerous task that could make for exciting adventures. A successful hunt can yield meat for a village of hungry Norlanders and lucrative byproducts like ambergris and whalebone. But sometimes the "whale" turns out to be a [Dragon Turtle](3-Mechanics/CLI/bestiary/dragon/dragon-turtle-xmm.md) or an [Ancient Sea Serpent](3-Mechanics/CLI/bestiary/dragon/ancient-sea-serpent-ftd.md) (see "Fizban's Treasury of Dragons").

Seafaring adventures can also center around trade and exploration. In these stories, merchants hire characters to escort them through dangerous waters. The characters or one of their NPC allies might have their own ship. The party can discover undersea settlements and meet D&D's vast array of underwater creatures, including vicious [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md), [Merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md), and sahuagin, or the heroic merfolk and tritons (described in "Mordenkainen Presents: Monsters of the Multiverse").

### Protecting Nature

![Heroes in the Moonshaes protect nature in all its forms.](file://book/FRAiF/141-05-009.heroes-of-moonshae.webp#center)
...
The rulers of the Moonshae Isles are proud people who do as they please. They expect their customs and territory to be respected, and they expect to be treated like the nobles they are. While some of these rulers might be persuaded to unite peacefully, others—like [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) or the leaders of the Red Shadow—might need to be defeated by force.
...
As the characters explore more of the isles, they find symptoms of [the Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting) in many places and battle [Rusted Berserkers](3-Mechanics/CLI/bestiary/construct/rusted-berserker-fraif.md) and [Rusted Behemoths](3-Mechanics/CLI/bestiary/construct/rusted-behemoth-fraif.md) loyal to [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md). See "chapter 9" for more detail on these adversaries.
...
![Even unicorns and other Celestials are threatened by the Rusting.](file://book/FRAiF/142-05-010.unicorns.webp#center)
...
![In the Moonshaes, friends come in all shapes and sizes.](file://book/FRAiF/143-05-011.adorable-friends.webp#center)
...
You can roll `dice:1d20|noform|noparens|avg` (`1d20`) on the table below to generate encounters for a party of any level. Alternatively, roll `dice:1d10|noform|noparens|avg` (`1d10`) if the party is level 1–4, `dice:1d10+5|noform|noparens|avg` (`1d10 + 5`) if the party is level 5–10, or `dice:1d10+10|noform|noparens|avg` (`1d10 + 10`) if the party is level 11 or higher. Once you've used a given encounter, remove it from the table and create a new one to replace it.
...
- **Hook.** The gnome mayor of Kythyss, Grel Shivven (Small, Lawful Neutral [Noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), hires the characters to visit sites where [the Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting) has appeared and figure out why the curse is present.  
...
Here, the characters find sewage from Kythyss dumping into the harbor. The sewer tunnel is home to a [Wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) and six [Giant Rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md). If the sewage is redirected into septic tanks or cleaned before reintroduction to the harbor, [the Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting) withdraws.

#### Bregonshire Coast

[The Rusting](3-Mechanics/CLI/rules/diseases.md#The%20Rusting) continues up the rocky coast between Kythyss and Dorset, where dead fish wash ashore. As the characters investigate, a [Kuo-toa Monitor](3-Mechanics/CLI/bestiary/aberration/kuo-toa-monitor-xmm.md) and four [Kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) emerge from the sea to fight. Speaking with local farmers reveals they're using an alchemical fertilizer that is washed into the sea by rain.

#### Rushdown Wood

North of Dorset, the trees of Rushdown Wood are covered in a thin, metal skin, and their leaves have turned to rust. Lumbering efforts have penetrated deep into the forest, leaving behind fields of stumps. Rusted Norlanders have infiltrated the Rushdown Wood; a [Rusted Berserker](3-Mechanics/CLI/bestiary/construct/rusted-berserker-fraif.md) and six Rusted [Guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) attack when discovered. The characters can follow their trail back to an abandoned camp near the local moonwell; plans drawn in the dirt reveal a Rusted force is attacking the well.

#### The Moonwell

Use the Moonwell map below for these encounters. When the characters rush to the moonwell's defense, they must first get past three Rusted [Scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) in the trees to reach the main Rusted force, which is engaged with local druids and their allies. The characters must defeat four Rusted [Guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and two Rusted [Wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) before they can reach the leader of the assault: a Rusted [Warrior Veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md). If the leader is defeated, the remaining Rusted flee and the moonwell is saved.
...
> [!gallery]
> ![Map: Moonwell](file://book/FRAiF/144-map-05.003-moonwell.webp#gallery)
> ![Player Version](file://book/FRAiF/145-map-05.003-moonwell-player.webp#gallery)
...
- **Situation.** Braelin Wyngard (Medium, Neutral Good [Performer](3-Mechanics/CLI/bestiary/humanoid/performer-xmm.md)) sailed his [Windskiff](3-Mechanics/CLI/items/windskiff-fraif.md) to one of the Moonshae's wandering isles. While exploring a magical castle at its summit, he was confronted by evil fey who demanded a performance. Because his music was so good, they won't let him leave.  
...
The island has moved, requiring characters to chase it down. Once they arrive, they spot Braelin's [Windskiff](3-Mechanics/CLI/items/windskiff-fraif.md) on the beach. A [Chuul](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) lies in wait and begins combat when the characters investigate.

#### Entering the Castle

Use the map of the castle below. The castle is visible from everywhere on the island. Two [Indifferent](3-Mechanics/CLI/rules/variant-rules/indifferent-attitude-xphb.md) elf sentries (Medium [Knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md))guard the gate.
...
Braelin is locked in a small room protected by a [fire-casting statue](3-Mechanics/CLI/traps-hazards/fire-casting-statue-xdmg.md) trap (see "chapter 3" of the "Dungeon Master's Guide").

#### The Queen's Wrath

The queen (use the [Night Hag](3-Mechanics/CLI/bestiary/fiend/night-hag-xmm.md) stat block, but change its creature type to Fey) intercepts the characters before they escape with Braelin. If the characters defeat her, the [Hostile](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) occupants of the castle surrender and leave. The characters can claim the fey castle and its wandering isle as their Bastion.
...
> [!gallery]
> ![Map: Fey Castle](file://book/FRAiF/146-map-05.004-fey-castle.webp#gallery)
> ![Player Version](file://book/FRAiF/147-map-05.004-fey-castle-player.webp#gallery)
...
- **Hook.** Jarl Olfsvenn of Norland enlists the characters to explore the wreck and retrieve the contents of its safe. He's learned from his sister [Queen Forfallen](3-Mechanics/CLI/bestiary/npc/queen-forfallen-fraif.md) that the safe contains the lost ring of Cymrych Hugh; he intends to secure the ring and give it to High King Kendrick for safekeeping. Alternatively, the characters might spot the wreck while traveling.  
...
Use the ship map in the "Dungeon Master's Guide". The ship sank when a [Stone Golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) in the cargo hold broke through the port side.

#### The Approach

A [Giant Shark](3-Mechanics/CLI/bestiary/beast/giant-shark-xmm.md) hunts in the wreck.

#### Main Deck

When characters investigate, the corpses of sailors animate as six Lacedon [Ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md).

#### Foredeck

A [Merfolk Wavebender](3-Mechanics/CLI/bestiary/elemental/merfolk-wavebender-xmm.md) hides here, an exile from their people. The merfolk is [Indifferent](3-Mechanics/CLI/rules/variant-rules/indifferent-attitude-xphb.md) to the party but becomes [Friendly](3-Mechanics/CLI/rules/variant-rules/friendly-attitude-xphb.md) if a character takes an [Influence](3-Mechanics/CLI/rules/actions.md#Influence) action and succeeds on a DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check.

#### Cargo Hold

This hold contains five crates of an alchemical substance. Every crate is sealed and labeled with a bright-red warning. If a crate takes Fire or Radiant damage, the crate explodes. Creatures in a 15-foot-radius [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) centered on the crate make a DC 15 Dexterity saving throw, taking `dice:6d6|noform|noparens|avg` (`6d6`) Fire damage or half as much damage on a successful one. This might cause a cascading explosion of nearby crates.

#### Aft

The ship's aft is patrolled by five [Wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), all that remains of the captain and their mates. The safe is in the aft cabin belowdecks. The safe has AC 20, HP 20, and a [Damage Threshold](3-Mechanics/CLI/rules/variant-rules/damage-threshold-xphb.md) of 20. The safe door's lock is Complex (1 minute to pick) and of Good quality (DC 15). If the characters can open it, they find the ring.

#### Return of the Golem

When the characters open the safe and attempt to leave with its contents, the [Stone Golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) returns in the aft cabin.
...
- **Situation.** High King Kendrick wants a formal peace treaty and alliance with Moonshae's giants. But a [Fomorian](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) named Ulrik Fellwhisper is sabotaging the effort.  
- **Hook.** The high king chooses the characters as his emissaries, asking them to travel to Oman's Isle and enter negotiations with Thuven Moltenbeard, the [Fire Giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) king of Oman's Isle.  
...
The characters land in Trondhelm safely, but four [Ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) pick a fight. If the characters make a good impression with Trondhelm's goliath governor, Oakwright (Medium [Noble Prodigy](3-Mechanics/CLI/bestiary/humanoid/noble-prodigy-xmm.md)), he arranges a guide to lead the characters to a mine, where Thuven lives.

#### Ambush

As the characters cross Oman's Isle, they're ambushed by three [Hill Giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) Ulrik hired.

#### Earning an Audience

A dozen [Fire Giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) live in the mine. Thuven is [Indifferent](3-Mechanics/CLI/rules/variant-rules/indifferent-attitude-xphb.md) and won't see them until they've proven themselves in two tests. The first tests martial prowess against an [Azer Pyromancer](3-Mechanics/CLI/bestiary/elemental/azer-pyromancer-xmm.md), two [Hell Hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md), and four [Azer Sentinels](3-Mechanics/CLI/bestiary/elemental/azer-sentinel-xmm.md) The second tests crafting skill; the king provides 10 days and up to 200 GP of raw materials for the characters to craft one item. At the end of this time, a character presents the creation to Thuven and makes a DC 15 ([Performance](3-Mechanics/CLI/rules/skills.md#Performance) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check, earning the king's respect on a successful check. If the characters made a magic item from the Armor or Weapon category, the check automatically succeeds.
...
Moltenbeard takes the characters hunting. The hunt is disrupted by an [Adult White Dragon](3-Mechanics/CLI/bestiary/dragon/adult-white-dragon-xmm.md) that Ulrik has tricked into trying to kill Moltenbeard; if the king dies, the characters are blamed and the peace effort collapses. If the characters save the king, he becomes [Friendly](3-Mechanics/CLI/rules/variant-rules/friendly-attitude-xphb.md) and drafts a reasonable counterproposal for the high king.

#### When All Else Fails

Ulrik abducts Moltenbeard and leaves a forged letter for the characters, insulting the high king and rejecting the alliance. The characters must follow Ulrik into the Underdark. He is a [Fomorian](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) with three [Red Slaad](3-Mechanics/CLI/bestiary/aberration/red-slaad-xmm.md) bodyguards.
...
![](file://book/BGG/046-04-001.star-forge.webp#center)
...
> [!gallery]
> ![Map 4.1: Annam's Cradle](file://book/BGG/047-map-4.01-annams-cradle.webp#gallery)
> ![Player Version](file://book/BGG/048-map-4.01-annams-cradle-player.webp#gallery)
...
> [!gallery]
> ![Map 4.2: Ashen Grotto](file://book/BGG/049-map-4.02-ashen-grotto.webp#gallery)
> ![Player Version](file://book/BGG/050-map-4.02-ashen-grotto-player.webp#gallery)
...
![Map 4.3: Dreamer's Reach](file://book/BGG/051-map-4.03-dreamers-reach.webp#center)
...
![Map 4.4: Endless Rockslide](file://book/BGG/052-map-4.04-endless-rockslide.webp#center)
...
![Map 4.5: Forest Crystal](file://book/BGG/053-map-4.05-forest-crystal.webp#center)
...
- **Wild Magic.** The Feywild energy that fuels the crystal interacts unpredictably with other magic. Whenever a creature casts a spell of 1st level or higher within the glade, that creature must succeed on a DC 10 saving throw using its spellcasting ability or roll on the [Wild Magic Surge table](3-Mechanics/CLI/tables/wild-magic-surge-xphb.md) (see the "[Sorcerer](3-Mechanics/CLI/classes/sorcerer-xphb.md)" section in the "Player's Handbook").  
...
> [!gallery]
> ![Map 4.6: Forsaken Deep](file://book/BGG/054-map-4.06-forsaken-deep.webp#gallery)
> ![Player Version](file://book/BGG/055-map-4.06-forsaken-deep-player.webp#gallery)
...
- **Storm Call.** A creature that meditates within the Meditation Chamber's rune circle for 10 minutes and succeeds on a DC 20 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can create the effects of either the [control weather](3-Mechanics/CLI/spells/control-weather-xphb.md) spell or the [control water](3-Mechanics/CLI/spells/control-water-xphb.md) spell, or both simultaneously (user's choice). The magic affects the ocean and surface above the retreat within a radius of 10 miles for up to 8 hours, requiring no concentration.  
...
![Map 4.7: Gale's Eye Tower](file://book/BGG/056-map-4.07-gales-eye-tower.webp#center)
...
![Map 4.8: Grolantor's Larder](file://book/BGG/057-map-4.08-grolantors-larder.webp#center)
...
> [!gallery]
> ![Map 4.9: Hiatea's Hearth](file://book/BGG/058-map-4.09-hiateas-hearth.webp#gallery)
> ![Player Version](file://book/BGG/059-map-4.09-hiateas-hearth-player.webp#gallery)
...
![Map 4.10: Horizon's Edge](file://book/BGG/060-map-4.10-horizons-edge.webp#center)
...
> [!gallery]
> ![Map 4.11: Howling Iceberg](file://book/BGG/061-map-4.11-howling-iceberg.webp#gallery)
> ![Player Version](file://book/BGG/062-map-4.11-howling-iceberg-player.webp#gallery)
...
The tunnels in the Howling Iceberg twist deeper than should be possible. A creature exploring the tunnels can make a DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception) or [Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check after each hour. A creature that succeeds on three checks in a row or that rolls a 20 on the `dice:d20|noform|noparens|avg` (`d20`) finds a special destination, as shown on the Howling Iceberg Tunnels table.
...
> [!gallery]
> ![Map 4.12: Karontor's Hold](file://book/BGG/063-map-4.12-karontors-hold.webp#gallery)
> ![Player Version](file://book/BGG/064-map-4.12-karontors-hold-player.webp#gallery)
...
![Map 4.13: Misty Vale](file://book/BGG/065-map-4.13-misty-vale.webp#center)
...
![Map 4.14: Runic Circle](file://book/BGG/066-map-4.14-runic-circle.webp#center)
...
> [!gallery]
> ![Map 4.15: Singing Sands](file://book/BGG/067-map-4.15-singing-sands.webp#gallery)
> ![Player Version](file://book/BGG/068-map-4.15-singing-sands-player.webp#gallery)
...
![Map 4.16: Star Forge](file://book/BGG/069-map-4.16-star-forge.webp#center)
...
![Map 4.17: Thundering Observatory](file://book/BGG/070-map-4.17-thundering-observatory.webp#center)
...
- **Death Ray.** As an action, a creature can use the observatory controls to direct a deadly bolt of magical energy at a point it can see, including locations viewed through the observatory's Remote Viewing property (but not through any other means of scrying or magical sensing). The ray creates a line of destruction 10 feet wide starting from the target point and progressing 100 feet in a direction of the creature's choice. Creatures and objects in that line take `dice:26d10|noform|noparens|avg|text(143)` (`26d10`) force damage. A creature reduced to 0 hit points is disintegrated into fine gray ash and can be returned to life only by a [true resurrection](3-Mechanics/CLI/spells/true-resurrection-xphb.md) or [wish](3-Mechanics/CLI/spells/wish-xphb.md) spell. A creature that activates this property gains 6 levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Immunity to lightning or thunder damage reduces the number of levels gained by 1 for each such immunity.  
...
![Map 4.18: Worldroot Sapling](file://book/BGG/071-map-4.18-worldroot-sapling.webp#center)

Map 4.18 depicts the Worldroot Sapling, including the following features:

- **Gnarled Roots.** The great, twisted roots of an enormous dead tree cover a vast area surrounding the sapling. The roots bristle with immense thorns, some up to 5 feet long. The roots can be climbed easily, but a creature that moves more than half its speed on its turn while within 5 feet of the roots must succeed on a DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) piercing damage.  

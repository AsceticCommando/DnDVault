...
- **Person.** Someone with a distorted view of reality, perhaps a [cultist](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) or a [warlock of the Great Old One](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-great-old-one-mpmm.md); perhaps simply an eccentric person with a nonconformist style.  
...
- **Person.** A person (perhaps a [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md)) dedicated to preserving nature against corrupting influences.  
...
- **Treasure.** An art object depicting the triumph of nature over corruption, or a magic item useful against Aberrations (such as a [Ring of Mind Shielding](3-Mechanics/CLI/items/ring-of-mind-shielding-xdmg.md)).  
- **Situation.** People or creatures fighting against the influence of Aberrations.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/01-aberration.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/03-balance.webp#center)
...
- **Treasure.** A treasure that incorporates fur, feathers, bones, or claws from a Beast, or a magic item that allows transformation into a Beast (such as a [Cloak of the Bat](3-Mechanics/CLI/items/cloak-of-the-bat-xdmg.md) or [Staff of the Python](3-Mechanics/CLI/items/staff-of-the-python-xdmg.md)).  
...
- **Treasure.** An ornate saddle, a goad, or another item related to the use of domestic animals, or a magic item that allows control of Beasts (such as a [Potion of Animal Friendship](3-Mechanics/CLI/items/potion-of-animal-friendship-xdmg.md)).  
- **Situation.** Domestic animals rebelling against people's control.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/03-beast.webp#center)
...
- **Treasure.** A valuable or magical pen, an ink vial, or a set of pigments (such as [Nolzur's Marvelous Pigments](3-Mechanics/CLI/items/nolzurs-marvelous-pigments-xdmg.md)).  
- **Situation.** A situation that requires gleaning information from written clues.  

### Reversed Meaning

- **Person.** A well-educated person who reads often.  
- **Creature or Trap.** A trap involving written runes (such as a [Glyph of Warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) or [Symbol](3-Mechanics/CLI/spells/symbol-xphb.md) spell).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/04-book.webp#center)
...
- **Creature or Trap.** Someone who coordinates the efforts of different kinds of creatures, such as a [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) mastermind using [grimlocks](3-Mechanics/CLI/bestiary/aberration/grimlock-xmm.md) and [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) as agents.  
- **Place.** A bridge across a river or chasm.  
- **Treasure.** An art object depicting a bridge, or a magic item intended to help overcome obstacles (such as [Boots of Striding and Springing](3-Mechanics/CLI/items/boots-of-striding-and-springing-xdmg.md)).  
...
- **Treasure.** An art object depicting walls, barriers. or a labyrinth; alternatively, a magic item that creates magical walls (such as a [Cube of Force](3-Mechanics/CLI/items/cube-of-force-xdmg.md)).  
- **Situation.** Open conflict between two families or groups.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/05-bridge.webp#center)
...
- **Treasure.** An art object depicting a peaceful scene, or a magic item that facilitates safe rest (such as a [Rod of Security](3-Mechanics/CLI/items/rod-of-security-xdmg.md)).  
...
- **Treasure.** An art object that suggests frenetic activity, or a magic item that helps its user remain alert (such as a [Sentinel Shield](3-Mechanics/CLI/items/sentinel-shield-xdmg.md)),  
- **Situation.** A situation that demands unrelenting activity.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/06-campfire.webp#center)
...
- **Creature or Trap.** A creature (such as a [piercer](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) or a [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md)) that mimics the features of natural caverns.  
- **Place.** A cavern or a cavernous building such as a large temple.  
- **Treasure.** A geode, jewelry made from gems and precious metals, or a magic item that grants [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) (such as [Goggles of Night](3-Mechanics/CLI/items/goggles-of-night-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/07-cavern.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/08-celestial.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/12-comet.webp#center)
...
- **Creature or Trap.** A construct, particularly designed to be animated (like a golem) as opposed to an ordinary object (like a [broom](3-Mechanics/CLI/bestiary/construct/animated-broom-xmm.md) or [rug](3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md)) that has been animated.  
...
- **Treasure.** An object fashioned with minimum alteration of its raw materials, or a magic item useful against Constructs (such as a [Mace of Smiting](3-Mechanics/CLI/items/mace-of-smiting-xdmg.md)).  
- **Situation.** A rueful artisan attempting to destroy a Construct that has broken free of all restraint.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/10-construct.webp#center)
...
- **Treasure.** An art object depicting dead bodies, a corpse just starting to decay, or a magic item that causes decay (such as a [Staff of Withering](3-Mechanics/CLI/items/staff-of-withering-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/11-corpse.webp#center)
...
- **Creature or Trap.** A creature that induces confusion or erratic behavior (such as an [umber hulk](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md)).  
...
- **Creature or Trap.** A creature that prevents others from acting (such as a [ghoul](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/12-crossroads.webp#center)
...
- **Treasure.** A treasure that once held a being captive, such as an [Efreeti Bottle](3-Mechanics/CLI/items/efreeti-bottle-xdmg.md) that has lost its magic or an empty [Iron Flask](3-Mechanics/CLI/items/iron-flask-xdmg.md).  
- **Situation.** A situation that requires creative solutions, or an effort to free people or creatures from captivity.  

![](file://decks/BMT/Deck%20of%20Many%20Things/17-donjon.webp#center)
...
- **Treasure.** An art object that looks very different from various perspectives, or a magic item that creates portals or allows teleportation (such as an [Amulet of the Planes](3-Mechanics/CLI/items/amulet-of-the-planes-xdmg.md)).  
...
- **Treasure.** A jeweled chest or lockbox, or a magic item that resists change (such as an [Immovable Rod](3-Mechanics/CLI/items/immovable-rod-xdmg.md)).  
- **Situation.** A situation that keeps recurring.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/14-door.webp#center)
...
- **Treasure.** An art object depicting the death of a Dragon, or a magic item useful against Dragons (such as a [Dragon Slayer](3-Mechanics/CLI/items/dragon-slayer-xdmg.md)).  
- **Situation.** A group that plans to drive a Dragon from its lair, steal from its hoard, or kill it.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/15-dragon.webp#center)
...
- **Treasure.** An art object that incorporates material from an Elemental Plane or imagery of the elements, or a magic item that conjures or controls Elementals (such as a [Ring of Elemental Command](3-Mechanics/CLI/items/ring-of-elemental-command-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/16-elemental.webp#center)
...
- **Creature or Trap.** A [medusa](3-Mechanics/CLI/bestiary/monstrosity/medusa-xmm.md) or another creature with the power to petrify or a gaze attack.  
- **Place.** Somewhere with commanding views, such as a watchtower or a high promontory.  
- **Treasure.** A landscape painting or tapestry, or a magic item that enhances vision (such as [Goggles of Night](3-Mechanics/CLI/items/goggles-of-night-xdmg.md)).  
...
- **Treasure.** A valuable sculpture or statue, a gemstone, or a magic item made from stone, such as a [Figurine of Wondrous Power](3-Mechanics/CLI/items/figurine-of-wondrous-power-xdmg.md).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/22-euryale.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/18-expert.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/08-fates.webp#center)
...
- **Person.** A person with Fey ancestry or some other connection to the Fey (such as a [warlock of the Archfey](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-archfey-mpmm.md)), or a person with a whimsical sense of humor.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/20-fey.webp#center)
...
- **Person.** A tiefling, [warlock of the Fiend](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-fiend-mpmm.md), member of a Fiend-worshiping cult, or person who seeks to manipulate others into harmful contracts.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/21-fiend.webp#center)
...
- **Creature or Trap.** A Fiend, a vengeful Undead (such as a [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) or [revenant](3-Mechanics/CLI/bestiary/undead/revenant-xmm.md)), or a creature dedicated to pursuing designated prey (such as an [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md)).  
...
- **Treasure.** A treasure symbolizing or commemorating the end of a feud or war, or a magic item that can charm or calm creatures (such as a [Rod of Rulership](3-Mechanics/CLI/items/rod-of-rulership-xdmg.md)).  
- **Situation.** Unjust persecution or prejudicial hatred.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/22-flames.webp#center)
...
- **Treasure.** A treasure stolen from a child or naive person, or magic intended to deceive (such as a [Hat of Disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md)).  
- **Situation.** A guileless person being manipulated by schemers.  

![](file://decks/BMT/Deck%20of%20Many%20Things/01-fool.webp#center)
...
- **Creature or Trap.** A creature connected with wealth, such as a Dragon or a [Xorn](3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md), or a treasure that doubles as a trap.  
...
- **Creature or Trap.** A trap or creature that uses the appearance of treasure as bait, such as a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/05-gem.webp#center)
...
- **Treasure.** A treasure depicting or commemorating the slaying of a Giant, or a magic item useful against Giants (such as a [Giant Slayer](3-Mechanics/CLI/items/giant-slayer-xdmg.md)).  
- **Situation.** Someone unable or unwilling to recognize the importance of a critical factor.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/25-giant.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/26-humanoid.webp#center)
...
- **Creature or Trap.** o A monster some consider silly, such as a [flumph](3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md), an [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md), or a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md).  
- **Place.** A place dedicated to amusement, such as a fairground or a feasting hall.  
- **Treasure.** A humorous art object or magic item, such as a [Wand of Wonder](3-Mechanics/CLI/items/wand-of-wonder-xdmg.md).  
...
- **Creature or Trap.** A creature with an unsettling laugh, such as a [gnoll](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) or [hyena](3-Mechanics/CLI/bestiary/beast/hyena-xmm.md), or a creature with a cruel sense of humor.  
- **Place.** A place associated with cruelty and pain, such as a torture chamber.  
- **Treasure.** An art object depicting pain or humiliation, or a magic item meant to inflict pain (such as a [Sword of Wounding](3-Mechanics/CLI/items/sword-of-wounding-xdmg.md)).  
- **Situation.** One misfortune piling on another in a way that would be humorous—if it weren't disastrous.  

![](file://decks/BMT/Deck%20of%20Many%20Things/14-jester.webp#center)
...
- **Treasure.** A magic item needed to overcome an obstacle or defeat an enemy, or the means to unlock a treasure (such as a [Chime of Opening](3-Mechanics/CLI/items/chime-of-opening-xdmg.md)).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/02-key.webp#center)
...
- **Creature or Trap.** A knight who has failed to live up to their code of honor (such as a [death knight](3-Mechanics/CLI/bestiary/undead/death-knight-xmm.md)).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/09-knight.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/30-lance.webp#center)
...
- **Place.** A place where magic has caused destruction, doesn't work (like the effect of an [Antimagic Field](3-Mechanics/CLI/spells/antimagic-field-xphb.md)), or works unpredictably (perhaps triggering [wild magic surges](3-Mechanics/CLI/tables/wild-magic-surge-xphb.md)).  
- **Treasure.** An art object created by the use of magic, or a magic item with unpredictable effects (such as a [Wand of Wonder](3-Mechanics/CLI/items/wand-of-wonder-xdmg.md)).  
- **Situation.** A situation caused by magic misused or out of control.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/31-mage.webp#center)
...
- **Creature or Trap.** A creature (such as a [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md)) that leads travelers astray.  
- **Place.** A demiplane or similar place that can't be found on maps, or a location hidden behind a secret door.  
- **Treasure.** A treasure from another plane of existence, or a magic item that creates or accesses an extradimensional space (like a [Portable Hole](3-Mechanics/CLI/items/portable-hole-xdmg.md)).  
- **Situation.** No guide or direction is available.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/32-map.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/33-maze.webp#center)
...
- **Creature or Trap.** A creature that burrows underground, especially one that delves into the earth in search of prey (such as a [giant weasel](3-Mechanics/CLI/bestiary/beast/giant-weasel-xmm.md)).  
...
- **Creature or Trap.** A creature that lives underground but hunts above ground (such as an [ankheg](3-Mechanics/CLI/bestiary/monstrosity/ankheg-xmm.md) or a [bulette](3-Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/34-mine.webp#center)
...
- **Creature or Trap.** A Monstrosity, especially one that superficially resembles an ordinary animal or person (such as a [displacer beast](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) or [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md)).  
...
- **Creature or Trap.** A Monstrosity that is a potential ally, such as a [hippogriff](3-Mechanics/CLI/bestiary/monstrosity/hippogriff-xmm.md).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/35-monstrosity.webp#center)
...
- **Creature or Trap.** A lycanthrope, or a creature that appears to be an inanimate object until it strikes (such as a [gargoyle](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md)).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/11-moon.webp#center)
...
- **Treasure.** An art object depicting an ooze or the destruction of a particularly notable Ooze; alternatively, a magic item useful against Oozes (such as a [Ring of Acid Resistance](3-Mechanics/CLI/items/ring-of-acid-resistance-xdmg.md)).  
- **Situation.** A situation complicated by the sheer number of minor factors tangled within it.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/37-ooze.webp#center)
...
- **Treasure.** An art object depicting a road or path, or a magic item that allows divination (such as a [Crystal Ball](3-Mechanics/CLI/items/crystal-ball-xdmg.md) or a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-level-6-xdmg.md) of [Find the Path](3-Mechanics/CLI/spells/find-the-path-xphb.md)).  
...
- **Treasure.** An abstract art object, or a magic item that foils divination (such as an [Amulet of Proof against Detection and Location](3-Mechanics/CLI/items/amulet-of-proof-against-detection-and-location-xdmg.md)).  
- **Situation.** A series of distractions that deflect attention from an important goal.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/38-path.webp#center)
...
- **Treasure.** An art object depicting someone's calamitous fall, or a magic item that allows falling safely (such as a [Ring of Feather Falling](3-Mechanics/CLI/items/ring-of-feather-falling-xdmg.md)).  
...
- **Creature or Trap.** A creature (such as a [piercer](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md)) that attacks by falling on prey.  
- **Place.** An abandoned mansion or palace that is in disrepair due to the owner's downfall.  
- **Treasure.** An art object depicting flight or incorporating feathers, or a magic item that grants flight (such as [Winged Boots](3-Mechanics/CLI/items/winged-boots-xdmg.md) or a [Cloak of the Bat](3-Mechanics/CLI/items/cloak-of-the-bat-xdmg.md)).  
- **Situation.** A conspiracy to cause the downfall of a wealthy or prominent person.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/39-pit.webp#center)
...
- **Treasure.** An art object crafted from wood or incorporating leaves; alternatively, a magic item that allows uncontrolled vegetation growth (such as a [Bag of Beans](3-Mechanics/CLI/items/bag-of-beans-xdmg.md)).  
...
- **Creature or Trap.** A domesticated plant given artificial animation, such as an [awakened tree](3-Mechanics/CLI/bestiary/plant/awakened-tree-xmm.md) or [shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub-xmm.md).  
- **Place.** A place full of carefully pruned and neatly controlled vegetation, such as a topiary garden.  
- **Treasure.** A treasure that incorporates living greenery, such as an ornate terrarium or a potted topiary, or a magic item that allows control of vegetation (such as a [Staff of the Woodlands](3-Mechanics/CLI/items/staff-of-the-woodlands-xdmg.md)).  
- **Situation.** A conflict between a region suffering a famine and a region with abundant crops.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/40-plant.webp#center)
...
- **Treasure.** A magic item such as a [Staff of Healing](3-Mechanics/CLI/items/staff-of-healing-xdmg.md) or a [Holy Avenger](3-Mechanics/CLI/items/holy-avenger-xdmg.md); alternatively, valuable temple accouterments.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/41-priest.webp#center)
...
- **Treasure.** A treasure securely locked away, or a magic item that contains a creature (such as an [Elemental Gem](3-Mechanics/CLI/items/elemental-gem-xdmg.md) or an [Iron Flask](3-Mechanics/CLI/items/iron-flask-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/42-prisoner.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/04-puzzle.webp#center)
...
- **Creature or Trap.** A creature unwillingly bound to serve someone (such as an [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/44-ring.webp#center)
...
- **Treasure.** A treasure that hides a deadly secret, such as a ring with a spring-loaded poison needle, a [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom-xdmg.md), or a cursed magic item.  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/06-rogue.webp#center)
...
- **Creature or Trap.** A creature that destroys equipment, such as a [rust monster](3-Mechanics/CLI/bestiary/monstrosity/rust-monster-xmm.md) or a [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/16-ruin.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/07-sage.webp#center)
...
- **Creature or Trap.** A creature that protects others, such as a watchdog or [shield guardian](3-Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md), or a warding trap designed to repel invaders.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/48-shield.webp#center)
...
- **Treasure.** An art object depicting ships or travel, or a magic item that facilitates travel (such as a [Folding Boat](3-Mechanics/CLI/items/folding-boat-xdmg.md)).  
...
- **Treasure.** A treasure still in the hands of the person who made it, or a magic item (such as [Dimensional Shackles](3-Mechanics/CLI/items/dimensional-shackles-xdmg.md)) that prevents magical movement.  
- **Situation.** A situation arising from someone's inability or unwillingness to travel.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/49-ship.webp#center)
...
- **Treasure.** An art object that celebrates or depicts deliverance from death, or a magic item that wards off death (such as a [Periapt of Wound Closure](3-Mechanics/CLI/items/periapt-of-wound-closure-xdmg.md) or a [Scarab of Protection](3-Mechanics/CLI/items/scarab-of-protection-xdmg.md)).  
- **Situation.** Many lives at stake.  

![](file://decks/BMT/Deck%20of%20Many%20Things/19-skull.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/51-staff.webp#center)
...
- **Creature or Trap.** A creature that grows in power as battle continues (such as a [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) or a [hydra](3-Mechanics/CLI/bestiary/monstrosity/hydra-xmm.md)).  
- **Place.** A place reached by descending stairs, such as a basement or a lower level of a dungeon.  
- **Treasure.** An intricate treasure that was difficult to create, or a magic item that helps accomplish difficult tasks (such as an [Ioun Stone of Mastery](3-Mechanics/CLI/items/ioun-stone-mastery-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/52-stairway.webp#center)
...
![](file://decks/BMT/Deck%20of%20Many%20Things/13-star.webp#center)

## Statue

*A statue depicts the god Istus offering the original [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md) as a gift. The Statue card is a reminder of the past.*
...
- **Treasure.** A statuette or sculpture, either valuable or magical (such as a [Figurine of Wondrous Power](3-Mechanics/CLI/items/figurine-of-wondrous-power-xdmg.md)).  
...
- **Creature or Trap.** A creature that clings to a memory of fallen glory (such as a [storm giant](3-Mechanics/CLI/bestiary/giant/storm-giant-xmm.md) or a [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md)), a creature in the guise of a statue (such as a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md)), or a statue that functions as a trap.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/54-statue.webp#center)
...
- **Creature or Trap.** A creature (perhaps a [flumph](3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md) or a [pixie](3-Mechanics/CLI/bestiary/fey/pixie-xmm.md)) that offers aid but is too weak to provide meaningful help.  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/10-sun.webp#center)
...
- **Creature or Trap.** A predator, especially one that preys on people or slowly drains their life (such as a [vampire](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md)).  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/21-talons.webp#center)
...
- **Creature or Trap.** A parasite, [vampire](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md), or similar creature that siphons strength, happiness, or vitality from others, or a trap designed to separate those caught in it.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/57-tavern.webp#center)
...
- **Creature or Trap.** A temple guardian—perhaps a Celestial, Construct, or [guardian naga](3-Mechanics/CLI/bestiary/celestial/guardian-naga-xmm.md).  
- **Place.** A temple, shrine, or other place of worship.  
- **Treasure.** A valuable ritual object, such as a candelabra or sacrificial knife, or a magic item linked to worship or divine magic (such as a [Candle of Invocation](3-Mechanics/CLI/items/candle-of-invocation-xdmg.md)).  
...
- **Creature or Trap.** A creature that bestows curses (such as a [fomorian](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md), [rakshasa](3-Mechanics/CLI/bestiary/fiend/rakshasa-xmm.md), or [mummy](3-Mechanics/CLI/bestiary/undead/mummy-xmm.md)).  
- **Place.** An area where crime, vice, or other impious behaviors are widespread.  
- **Treasure.** A treasure with superstitious meaning perhaps an amulet meant to ward off evil (such as a [Scarab of Protection](3-Mechanics/CLI/items/scarab-of-protection-xdmg.md)).  
- **Situation.** A situation stemming from a superstitious fear of curses or bad luck.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/58-temple.webp#center)
...
- **Treasure.** A ruler's regalia, or a magic item (such as a [Rod of Rulership](3-Mechanics/CLI/items/rod-of-rulership-xdmg.md)) that imparts magical authority.  
...
- **Treasure.** Treasure. An art object created as an act of resistance to tyranny, or a magic item that protects against restraint (such as a [Ring of Free Action](3-Mechanics/CLI/items/ring-of-free-action-xdmg.md)).  
- **Situation.** A group of people rebelling against a ruler or an authority figure.  

![](file://decks/BMT/Deck%20of%20Many%20Things/15-throne.webp#center)
...
- **Creature or Trap.** A [mummy](3-Mechanics/CLI/bestiary/undead/mummy-xmm.md), [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), or similar Undead that lairs in its own tomb.  
...
- **Creature or Trap.** An incorporeal Undead (such as a [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) or [specter](3-Mechanics/CLI/bestiary/undead/specter-xmm.md)) that's not linked to the place of its death, burial place, or body.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/60-tomb.webp#center)
...
- **Treasure.** An art object depicting an isolated place or a lonely person; alternatively, [Daern's Instant Fortress](3-Mechanics/CLI/items/daerns-instant-fortress-xdmg.md) or a similar magic item.  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/61-tower.webp#center)
...
- **Treasure.** A treasure featuring diamonds, pearls, or precious wood, or a magic item that increases endurance (such as an [Amulet of Health](3-Mechanics/CLI/items/amulet-of-health-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/62-tree.webp#center)
...
- **Creature or Trap.** An Undead creature sustained by a thirst for revenge or an unfinished task, such as a [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) or [revenant](3-Mechanics/CLI/bestiary/undead/revenant-xmm.md).  
...
- **Treasure.** An art object depicting the destruction of an Undead, or a magic item particularly useful against Undead (such as a [Mace of Disruption](3-Mechanics/CLI/items/mace-of-disruption-xdmg.md)).  
- **Situation.** A serial criminal who has been pardoned for past misdeeds and now continues their wicked ways.  

![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/63-undead.webp#center)
...
- **Treasure.** An art object that reflects its creator's despair or sadness, or a [Sphere of Annihilation](3-Mechanics/CLI/items/sphere-of-annihilation-xdmg.md).  
...
- **Creature or Trap.** A [skeleton](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md), [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md), or similar Undead remnant of a living creature; alternatively, a trap that's broken and nonfunctional.  
...
![](file://decks/BMT/Deck%20of%20Many%20Things/18-void.webp#center)
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/65-warrior.webp#center)
...
- **Treasure.** A reliable treasure (such as gold coins), or a magic item that produces food or water (such as a [Decanter of Endless Water](3-Mechanics/CLI/items/decanter-of-endless-water-xdmg.md) or an [Alchemy Jug](3-Mechanics/CLI/items/alchemy-jug-xdmg.md)).  
...
![](file://decks/DMTCRG/Deck%20of%20Many%20More%20Things/66-well.webp#center)
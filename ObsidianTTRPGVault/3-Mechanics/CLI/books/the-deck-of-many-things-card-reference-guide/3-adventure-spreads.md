...
![Diagram 2: Adventure Spread](file://book/DMTCRG/Adventure%20Spread.webp#center)
...
![Diagram 3: Example Adventure Spread](file://book/DMTCRG/Example%20Adventure%20Spread.webp#center)
...
- **2 Adventure Begins.** Jennifer draws the [Comet](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Comet) card reversed, whose creature signifier suggests the fairground is overrun by small creatures fleeing from a rampaging monster. She decides the creatures are panicked [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md); they're not malicious or intent on fighting. but their arrival cre- ates chaos. Jennifer isn't sure what the monster is yet, but it should be a threat that demands heroic action from the characters.  
- **3 Journey.** Jennifer draws the [Fool](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Fool) card reversed. She opts to use the person signifier—a con artist—for an encounter during the journey. As the characters travel to where the rampaging monster was last seen. they're targeted by a con artist who pretends to be a refugee displaced by the monster. Jennifer decides this con artist is a [bard](3-Mechanics/CLI/bestiary/humanoid/bard-mpmm.md) (whose stat block appears in Mordenkainen Presents: Monsters of the Multiverse) who uses the [Charm Person](3-Mechanics/CLI/spells/charm-person-xphb.md) and [Sleep](3-Mechanics/CLI/spells/sleep-xphb.md) spells to try to overcome the characters and steal their belongings.  
...
- **5 Challenge.** For the first challenge, Jennifer draws the [Donjon](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Donjon) card reversed, which indicates a creature that has escaped captivity or gone feral. She decides the goblins kept a pack of [worgs](3-Mechanics/CLI/bestiary/fey/worg-xmm.md) in their gatehouse, and now the hungry worgs prowl the corridors. While the worgs are likely to attack, clever players might be able to get past them non-violently, perhaps by feeding them or speaking to them in a language they know (such as Goblin).  
- **6 Challenge.** For the second challenge, Jennifer draws the [Fates](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Fates) card, opting to use a [green hag](3-Mechanics/CLI/bestiary/fey/green-hag-xmm.md) investigating the gatehouse with an eye toward making it her new home. The hag warns the characters that fate isn't on their side, but she won't attack unless the adventurers force her hand.  
- **7 Challenge.** The third challenge is the [Flames](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Flames) card reversed, which suggests another creature fleeing from a larger or more dangerous creature, namely the rampaging monster at the heart of the adventure. Jennifer figures there must be goblins in the gatehouse, perhaps in a hastily fortified chamber; she creates an encounter using a [goblin boss](3-Mechanics/CLI/bestiary/fey/goblin-boss-xmm.md) and enough additional goblins to give the characters a fight. The goblin boss won't be satisfied until the adventurers, the hag, and the rampaging monster are all gone from the gatehouse. The adventurers can resolve this by clearing out the monster and the hag, winning the grudging appreciation of the goblin boss.  
- **8 Treasure.** 8: Treasure. Jennifer draws the [Gem](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Gem) card for the adventure's reward, which indicates precious gemstones or a magical gem. She decides a treasury in the gatehouse has a store of precious gemstones; she uses the tables in the Dungeon Master's Guide to generate a treasure hoard of gems appropriate for the characters. She also adds a [Spell Gem](3-Mechanics/CLI/items/spell-gem-oota.md) (a magic item described in Out of the Abyss) to make the treasure more memorable.  
- **9 Guardian.** For the Guardian card. Jennifer draws the [Balance](3-Mechanics/CLI/decks/deck-of-many-more-things-dmtcrg.md#Balance) card, suggesting an impartial enemy like a Construct or Beast. After a quick search of the Monster Manual, Jennifer decides that a [helmed horror](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md) is perfect for her party. She decides the goblins must've fought the helmed horror's creator, and now the Construct is rampaging through the gatehouse to satisfy its creator's final command: "Avenge me!" Jennifer places the [Spell Gem](3-Mechanics/CLI/items/spell-gem-oota.md) in the helmed horror's helmet; the Construct can use this gem, but without its creator to recharge it, that's a trick that works only once, If the heroes defeat the helmed horror, they can claim the [Spell Gem](3-Mechanics/CLI/items/spell-gem-oota.md) for themselves.  

![](file://bestiary/BMT/Deck%20Defender.webp#center)
...
![](file://book/BMT/073-12-002.sky.webp#center)

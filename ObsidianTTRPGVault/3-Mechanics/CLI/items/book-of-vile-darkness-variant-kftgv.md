...
![](file://items/DMG/Book%20of%20Vile%20Darkness.webp#right)
...
If a [solar](3-Mechanics/CLI/bestiary/celestial/solar-xmm.md) tears the book in two, the book is destroyed for `dice:1d100|noform|noparens|avg` (`1d100`) years, after which it reforms in some dark corner of the multiverse.

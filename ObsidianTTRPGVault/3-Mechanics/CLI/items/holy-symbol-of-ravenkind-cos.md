...
![](file://items/CoS/Holy%20Symbol%20of%20Ravenkind.webp#right)
...
As an action, you can expend 1 charge and present the holy symbol to make it flare with holy power. Vampires and [vampire spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) within 30 feet of the holy symbol when it flares must make a DC 15 Wisdom saving throw. On a failed save, a target is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) for 1 minute. It can repeat the saving throw at the end of its turns to end the effect on itself.

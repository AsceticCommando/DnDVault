...
You gain a +3 bonus to attack and damage rolls made with the magical rapier and it does `dice:1d8|noform|noparens|avg` (`1d8`) cold damage instead of its regular damage. When using the magic dagger, you gain a +3 bonus to your AC, as long as it is used as your offhand weapon, and it does `dice:1d6|noform|noparens|avg` (`1d6`) cold damage instead of its regular damage.
...
Additionally, you may cast [Scrying](3-Mechanics/CLI/spells/scrying-xphb.md) (with a spell save DC of 20) and Find the Path. Once either spell is cast, you must finish a long rest before casting either of them again.

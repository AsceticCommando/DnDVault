...
---
# True-Ice Shards (Dagger)
*Weapon ([dagger](3-Mechanics/CLI/items/dagger-xphb.md)), artifact (requires attunement)*  
...
When using the magic dagger, you gain a +3 bonus to your AC, as long as it is used as your offhand weapon, and it does `dice:1d6|noform|noparens|avg` (`1d6`) cold damage instead of its regular damage.
...
While attuned to the True-Ice Shards, you can use an action to cast the [Detect Thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md) spell (save DC 20), targeting any creature you have previously met. If the targeted creature is on a different plane of existence, the spell fails.

As long as you maintain [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration), you can use a bonus action to send a telepathic message to the focused creature. It can reply—using a bonus action to do so—as long as the focus and [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) continue.

## Omniscient

You can use the True-Ice Shards to cast a variety of divination spells. [Locate Animals or Plants](3-Mechanics/CLI/spells/locate-animals-or-plants-xphb.md), [Locate Creature](3-Mechanics/CLI/spells/locate-creature-xphb.md), and [Locate Object](3-Mechanics/CLI/spells/locate-object-xphb.md) may be cast at will, and don't have a maximum range. Other limitations of the spells still apply, and they can't detect subjects on other planes of existence.

Additionally, you may cast [Scrying](3-Mechanics/CLI/spells/scrying-xphb.md) (with a spell save DC of 20) and [Find the Path](3-Mechanics/CLI/spells/find-the-path-xphb.md). Once either spell is cast, you must finish a long rest before casting either of them again.

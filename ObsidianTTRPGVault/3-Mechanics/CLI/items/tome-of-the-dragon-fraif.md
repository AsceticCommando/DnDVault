...
![](file://items/FRAiF/Tome%20of%20the%20Dragon.webp#right)
...
When the ritual is complete, the tome explodes with violet light, dealing (`dice:12d6|noform|noparens|avg` (`12d6`)) Necrotic damage to you and each assistant. If this damage reduces a creature to 0 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), the creature is killed and immediately reanimates as a [Zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) under the DM's control.

...
![](file://items/WDH/Dragonstaff%20of%20Ahghairon.webp#right)
...
The staff has 10 charges. While holding it, you can expend 1 charge as an action to cast the [command](3-Mechanics/CLI/spells/command-xphb.md) spell. If you target a dragon with this casting, the dragon has disadvantage on its saving throw. The staff regains `dice:1d10|noform|noparens|avg` (`1d10`) charges daily at dawn.

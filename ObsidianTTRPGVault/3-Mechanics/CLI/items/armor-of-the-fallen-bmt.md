...
![](file://items/BMT/Armor%20of%20the%20Fallen.webp#right)


While wearing this armor, you can use it to cast either [Speak with Dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md) or [Animate Dead](3-Mechanics/CLI/spells/animate-dead-xphb.md). Once the armor has cast a spell in this way, it can't cast either spell until the next dawn.

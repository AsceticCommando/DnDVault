...
- Up to 5 magic scrolls that affect a single creature. The target of the spell is you, and if the spell requires [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration), you can concentrate.  

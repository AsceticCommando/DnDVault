...
The toy can also be used to fight off fear. When you make a saving throw to avoid or end the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) condition on yourself, you can give yourself advantage on the roll if the toy is on your person. You must decide to do so before rolling the `dice:d20|noform|noparens|avg` (`d20`). If the save succeeds, you can't use the toy in this way until you finish a long rest.

...
![](file://items/MOT/Pyxis%20of%20Pandemonium.webp#right)
...
| 6 | **Nightmare.** Tendrils of shadow seep from the vessel and form into `dice:1d4\|noform\|noparens\|avg` (`1d4`) [shadow demons](3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) (see the Monster Manual for their stat block), which appear in unoccupied spaces within 30 feet of it and are hostile. |

...
This wand has 2 charges. While holding it, you can use an action to expend 1 or more of its charges to cast either a green-flamed [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) or a blue [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md) at random from it (save DC 15).

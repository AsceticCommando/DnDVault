...
![](file://items/RoT/Dragontooth%20Dagger.webp#right)
...
You gain a +1 bonus to attack and damage rolls made with this weapon. On a hit with this weapon, the target takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) acid damage.

## Draconic Potency

Against enemies of the Cult of the Dragon, the dagger's bonus to attack and damage rolls increases to 2, and the extra acid damage increases to `dice:2d6|noform|noparens|avg` (`2d6`).

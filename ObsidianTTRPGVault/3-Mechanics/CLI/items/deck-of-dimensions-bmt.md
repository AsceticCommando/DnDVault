...
![](file://items/BMT/Deck%20of%20Dimensions.webp#right)
...
- **Riffling Portal.** As an action, you can expend 3 charges to cast the [Arcane Gate](3-Mechanics/CLI/spells/arcane-gate-xphb.md) spell from the deck. The deck vanishes, and fluttering cards create the spell's portal rings. When the spell ends, the deck reappears in your possession.  

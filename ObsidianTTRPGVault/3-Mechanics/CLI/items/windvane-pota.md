...
![](file://items/PotA/Windvane.webp#right)
...
You have a +2 bonus to attack and damage rolls made with this magic weapon, which has the finesse weapon property. When you hit with it, the target takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) lightning damage.

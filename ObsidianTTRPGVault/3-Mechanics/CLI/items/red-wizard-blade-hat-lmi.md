...
---
# Red Wizard Blade
*Weapon ([dagger](3-Mechanics/CLI/items/dagger.md)), legendary*  
![](3-Mechanics/CLI/items/img/red-wizard-blade.webp#right)
...
A creature reduced to 0 hit points by this weapon dies and can't be raised from the dead except by a deity or by a creature using a [tablet of reawakening](3-Mechanics/CLI/items/tablet-of-reawakening-hat-lmi.md) to cast the [true resurrection](3-Mechanics/CLI/spells/true-resurrection.md) spell.

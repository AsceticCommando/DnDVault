...
---
# Lucent Destroyer
*Weapon ([musket](3-Mechanics/CLI/items/musket-xphb.md)), very rare (requires attunement)*  
...
Additionally, while attuned to the weapon, you can cast [dancing lights](3-Mechanics/CLI/spells/dancing-lights-xphb.md) from the musket at will.

## Invoking the Rune

As an action, you can invoke the weapon's rune to cast the [sunbeam](3-Mechanics/CLI/spells/sunbeam-xphb.md) spell (save DC 17) with it. Once the rune has been invoked, it can't be invoked again until the next dawn.

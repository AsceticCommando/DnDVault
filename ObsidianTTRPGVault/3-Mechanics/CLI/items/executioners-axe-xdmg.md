...
Any Humanoid you hit with the weapon takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) Slashing damage, and you gain [Temporary Hit Points](3-Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to the extra damage dealt.

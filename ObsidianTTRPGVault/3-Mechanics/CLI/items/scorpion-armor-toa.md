...
This armor is cursed. Whenever you don or doff it, you must make a DC 15 Constitution saving throw, taking `dice:10d10+45|noform|noparens|avg|text(100)` (`10d10 + 45`) poison damage on a failed save, or half as much damage on a successful one. Only a [wish](3-Mechanics/CLI/spells/wish-xphb.md) spell can remove the armor's curse.

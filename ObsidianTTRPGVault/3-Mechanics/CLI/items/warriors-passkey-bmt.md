...
![](file://items/BMT/Warriors%20Passkey.webp#right)


This silver skeleton key is warm to the touch. While holding the key in its key form, you can use an action to cast the [Knock](3-Mechanics/CLI/spells/knock-xphb.md) spell from the key.

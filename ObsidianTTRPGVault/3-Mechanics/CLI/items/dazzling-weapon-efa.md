...
This magic weapon grants a +1 bonus to attack and damage rolls made with it. While holding it, you can take a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) to cause it to shed [Bright Light](3-Mechanics/CLI/rules/variant-rules/bright-light-xphb.md) in a 30-foot radius and [Dim Light](3-Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 30 feet. You can extinguish the light as a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md).

The weapon has 4 charges. You can take a [Reaction](3-Mechanics/CLI/rules/variant-rules/reaction-xphb.md) immediately after being hit by an attack roll to expend 1 of the weapon's charges and force the attacker to make a DC 15 Constitution saving throw. On a failed save, the attacker has the [Blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) condition until the end of its next turn. The weapon regains `dice:1d4|noform|noparens|avg` (`1d4`) expended charges daily at dawn.

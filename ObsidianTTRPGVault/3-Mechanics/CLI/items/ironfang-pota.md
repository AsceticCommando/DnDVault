...
![](file://items/PotA/Ironfang.webp#right)
...
You gain a +2 bonus to attack and damage rolls made with this magic weapon. When you hit with it, the target takes an extra `dice:1d8|noform|noparens|avg` (`1d8`) thunder damage.
...
Ironfang has 3 charges. You can use your action to expend 1 charge and cast the 2nd-level version of [shatter](3-Mechanics/CLI/spells/shatter-xphb.md) (DC 17). Ironfang regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn.

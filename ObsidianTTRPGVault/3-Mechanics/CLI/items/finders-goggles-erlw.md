...
- When you make a Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the check.  

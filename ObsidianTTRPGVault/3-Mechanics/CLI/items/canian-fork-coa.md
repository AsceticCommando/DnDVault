...
---
# Canian Fork
*Weapon ([trident](3-Mechanics/CLI/items/trident-xphb.md)), cursed item, rare (requires attunement)*  
...
On a failed save, the healing has no effect. Only the [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell allows you to end attunement to this item.

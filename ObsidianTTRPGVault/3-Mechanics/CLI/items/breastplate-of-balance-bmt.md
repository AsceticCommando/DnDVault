...
---
# Breastplate of Balance
*Medium armor ([breastplate](3-Mechanics/CLI/items/breastplate-xphb.md)), rare (requires attunement)*  
...
- **Expunge Imbalance.** As a bonus action, you can expend 2 charges to cast the [Lesser Restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell from the armor.  

...
This armor has 3 charges. You can use an action to expend a charge to cast the [Compulsion](3-Mechanics/CLI/spells/compulsion-xphb.md) spell (save DC 15) from this armor. The armor regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn.

...
The glove is considered a simple melee weapon with the finesse and light properties, and it deals `dice:1d4|noform|noparens|avg` (`1d4`) slashing damage on a hit. While attuned to the glove, you gain a burrowing speed equal to your walking speed and [blindsight](3-Mechanics/CLI/rules/senses.md#Blindsight) to 15 feet.

...
While holding the rod, you have [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks and on [Initiative](3-Mechanics/CLI/rules/variant-rules/initiative-xphb.md) rolls.

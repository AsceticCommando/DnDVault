...
Additionally, you can use the voting kit to cast [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) (save DC 15). This property of the kit can't be used again until the next dawn.

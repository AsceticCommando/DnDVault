...
![](file://items/PotA/Tinderstrike.webp#right)
...
A flint dagger, Tinderstrike is uncommonly sharp, and sparks cascade off its edge whenever it strikes something solid. Its handle is always warm to the touch, and the blade smolders for `dice:1d4|noform|noparens|avg` (`1d4`) minutes after it is used to deal damage. It contains a spark of [Imix](3-Mechanics/CLI/bestiary/npc/imix-pota.md), Prince of Evil Fire.

You gain a +2 bonus to attack and damage rolls made with this magic weapon. When you hit with it, the target takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) fire damage.

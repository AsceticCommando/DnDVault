...
While attuned to this device, you have a +1 bonus to Dexterity saving throws and you always know which way is north. Additionally, you can cast the [longstrider](3-Mechanics/CLI/spells/longstrider-xphb.md) spell on yourself at will.
...
As an action, you can cast the [teleport](3-Mechanics/CLI/spells/teleport-xphb.md) spell. Once you use this feature of the timepiece of travel, it cannot be used again until the next dawn.

...
You gain a +1 bonus to attack and damage rolls made with this magic weapon. When you hit a creature of the giant type with it, the giant takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) slashing damage, and it must succeed on a DC 15 Strength saving throw or fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone).

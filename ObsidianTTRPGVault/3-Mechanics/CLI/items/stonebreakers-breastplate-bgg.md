...
As an action, you can invoke the breastplate's rune to cast the [wall of stone](3-Mechanics/CLI/spells/wall-of-stone-xphb.md) spell (save DC 14) with it. When you cast the spell in this way, you have advantage on saving throws made to maintain [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) on the spell.

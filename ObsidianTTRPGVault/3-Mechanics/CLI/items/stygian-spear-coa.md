...
If there are multiple allies, randomly determine which is the target. Make a new attack roll with advantage against your ally. If the attack hits, in addition to the standard damage you deal an extra `dice:2d6|noform|noparens|avg` (`2d6`) poison damage. Only the [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell allows you to end attunement to this item.

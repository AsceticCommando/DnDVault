...
If you attack with a double-bladed scimitar as part of the [Attack](3-Mechanics/CLI/rules/actions.md#Attack) action on your turn, you can use a bonus action immediately after to make a melee attack with it. This attack deals `dice:1d4|noform|noparens|avg` (`1d4`) slashing damage on a hit, instead of `dice:2d4|noform|noparens|avg` (`2d4`).

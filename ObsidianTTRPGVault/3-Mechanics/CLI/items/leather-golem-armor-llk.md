...
---
# Leather Golem Armor
*Light armor ([leather armor](3-Mechanics/CLI/items/leather-armor-xphb.md)), cursed item, rare (requires attunement)*  
...
This armor is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with a [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic, you are unwilling to part with the armor. In addition, while you wear the cursed armor, you gain the following properties:

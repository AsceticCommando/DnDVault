...
![](file://items/IDRotF/Shield%20Guardian%20Amulet.webp#right)
...
Every [shield guardian](3-Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md) has an amulet magically linked to it. A shield guardian can have only one corresponding amulet, and if that amulet is destroyed, the shield guardian is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) until a replacement amulet is created.

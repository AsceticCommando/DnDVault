...
---
# Ranseur of Torture
*Weapon ([pike](3-Mechanics/CLI/items/pike-xphb.md)), artifact (requires attunement)*  
![](file://items/CoA/Ranseur%20of%20Torture.webp#right)
...
The Ranseur of Torture is a magic pike. You have a +3 bonus to attack and damage rolls made with this weapon, and it does `dice:2d10|noform|noparens|avg` (`2d10`) piercing damage instead of its regular damage. When you hit a good aligned creature with it, that creature takes an extra `dice:1d10|noform|noparens|avg` (`1d10`) necrotic damage.
...
Damage dealt by the Ranseur of Torture is particularly dangerous, as it can only be restored through magical means. Resting, food, and medicine won't restore hit points removed by the pike. If the damage goes untreated for 7 days, the missing hit points are permanently removed, and can be recovered only through casting a [Regenerate](3-Mechanics/CLI/spells/regenerate-xphb.md) or [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell on the victim.

## Execution

If a creature with less than its full hit points is hit by this pike, the Ranseur of Torture deals `dice:1d10|noform|noparens|avg` (`1d10`) additional piercing damage. If a creature is killed by the pike, their soul is sent to Phlegethos and can be restored only through casting a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell on the victim.
...
Spellcasters damaged by the Ranseur of Torture have disadvantage on Constitution checks made to maintain [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) until the damage is healed. If a creature is [concentrating](3-Mechanics/CLI/rules/conditions.md#Concentration) on a spell when damaged by the ranseur, their [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) is immediately ended.

...
"traits":
  - "desc": "Any hostile creature that starts its turn within 20 feet of the vorvolaka\
      \ must succeed on a DC 18 Wisdom saving throw or have [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
      ...
      \ 24 hours. This ability does not function if the vorvolaka is [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)."
    "name": "Fear Aura"
...
"source":
  - "CoA"
"image": "file://bestiary/tokens/CoA/Vorvolaka.webp"
```
^statblock
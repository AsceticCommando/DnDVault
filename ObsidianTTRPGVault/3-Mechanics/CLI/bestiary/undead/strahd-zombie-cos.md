...
"traits":
  - "desc": "Whenever the zombie takes at least 5 bludgeoning or slashing damage at\
      ...
      \ its bite attack and its body is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
      ...
      \ speed is halved if it's missing a leg. If it loses both legs, it falls [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
...
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Strahd%20Zombie.webp"
```
^statblock
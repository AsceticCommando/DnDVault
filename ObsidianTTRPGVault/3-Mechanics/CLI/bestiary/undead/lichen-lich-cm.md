...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the lichen lich can\
      ...
      \ must succeed on a DC 19 Strength saving throw or be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
...
"legendary_actions":
  ...
  - "desc": "The lich targets one [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
      ...
      \ 19 Constitution saving throw or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
...
"source":
  - "CM"
"image": "file://bestiary/tokens/CM/Lichen%20Lich.webp"
```
^statblock
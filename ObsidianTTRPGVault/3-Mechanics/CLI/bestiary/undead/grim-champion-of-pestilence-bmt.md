...
"actions":
  ...
  - "desc": "The champion casts one of the following spells, requiring no material\
      ...
      \ each:** [Blight](3-Mechanics/CLI/spells/blight-xphb.md), [Blindness/Deafness](3-Mechanics/CLI/spells/blindness-deafness-xphb.md)\n\
      \n**1/day each:** [Cloudkill](3-Mechanics/CLI/spells/cloudkill-xphb.md), [Contagion](3-Mechanics/CLI/spells/contagion-xphb.md)"
    "name": "Spellcasting"
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Grim%20Champion%20of%20Pestilence.webp"
```
^statblock
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 7 (1d6\
      ...
      \ humanoid dies from this attack, a [shadow](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md)\
      \ (see the Monster Manual) rises from the corpse 1d4 hours later."
    "name": "Shadow Blade"
"source":
  - "WDMM"
"image": "file://bestiary/tokens/WDMM/Shadow%20Assassin.webp"
```
^statblock
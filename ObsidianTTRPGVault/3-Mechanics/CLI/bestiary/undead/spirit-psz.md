...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of the spirit that can see it\
      ...
      \ or the effect ends for it, the target is immune to this spirit's Horrifying\
  ...
  - "desc": "One humanoid that the spirit can see within 5 feet of it must succeed\
      ...
      \ spirit is turned or forced out by an effect like the [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md)\
...
"source":
  - "PSZ"
"image": "file://bestiary/tokens/PSZ/Spirit.webp"
```
^statblock
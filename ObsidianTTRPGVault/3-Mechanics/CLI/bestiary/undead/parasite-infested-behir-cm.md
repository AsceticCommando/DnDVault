...
"actions":
  ...
  - "desc": "The behir makes one bite attack against a Medium or smaller target it\
      ...
      \ that turn or regurgitate the creature, which falls [prone](3-Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "CM"
"image": "file://bestiary/tokens/CM/Parasite-infested%20Behir.webp"
```
^statblock
...
"actions":
  ...
  - "desc": "One Humanoid Gremorly can see within 5 feet of himself must succeed on\
      ...
      \ his alignment, Intelligence, Wisdom, Charisma, and immunity to the [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
      \ and [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) conditions.\
      \ He otherwise uses the target's game statistics, but Gremorly doesn't gain\
      \ access to the target's knowledge, class features, or proficiencies.\n\nThe\
      \ possession lasts until the target drops to 0 hit points, Gremorly ends it\
      \ as a bonus action, or Gremorly is turned or forced out by an effect like the\
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Gremorly%27s%20Ghost.webp"
```
^statblock
...
"traits":
  - "desc": "When you regain [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      \ from a level 1+ spell, the steed regains the same number of [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  ...
  - "desc": "One creature within 5 feet of the steed regains a number of [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\

...
"bonus_actions":
  ...
  - "desc": "The aartuk tries to use its gooey tongue to snare one Medium or smaller\
      ...
      \ Dexterity saving throw. On a failed save, the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Aartuk%20Starhorror.webp"
```
^statblock
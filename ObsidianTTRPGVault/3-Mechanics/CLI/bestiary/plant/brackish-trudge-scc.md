...
"actions":
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 16\
      \ (2d10 + 5) piercing damage plus 3 (1d6) poison damage. If the target is a\
      \ creature, it must succeed on a DC 15 Strength saving throw or be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Tusk"
"source":
  - "SCC"
"image": "file://bestiary/tokens/SCC/Brackish%20Trudge.webp"
```
^statblock
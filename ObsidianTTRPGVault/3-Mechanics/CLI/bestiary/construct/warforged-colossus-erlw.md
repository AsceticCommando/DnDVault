...
"traits":
  ...
  - "desc": "Any enemy outside the colossus that starts its turn within 30 feet of\
      \ it must succeed on a DC 26 Wisdom saving throw or be [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "The colossus stomps one of its feet at a point on the ground within 20\
      ...
      \ to make a DC 26 Strength check. On a success, the creature relocates to an\
      \ unoccupied space of its choice within 5 feet of the colossus and is no longer\
      \ [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained).\n\nStructures,\
      \ as well as nonmagical objects that are neither being worn nor carried, take\
      \ the same amount of damage if they are in the cylinder (no save)."
    "name": "Stomp"

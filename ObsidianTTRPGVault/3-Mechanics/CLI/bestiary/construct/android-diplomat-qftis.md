...
"actions":
  ...
  - "desc": "The android casts one of the following spells, requiring no material\
      ...
      \ each:** [Identify](3-Mechanics/CLI/spells/identify-xphb.md), [Tongues](3-Mechanics/CLI/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"source":
  - "QftIS"
"image": "file://bestiary/tokens/QftIS/Android%20Diplomat.webp"
```
^statblock
...
"traits":
  ...
  - "desc": "The helmed horror is immune to [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md),\
      \ [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), and [scorching ray](3-Mechanics/CLI/spells/scorching-ray-xphb.md)."
    "name": "Spell Immunity"
"actions":
...
"source":
  - "KftGV"
"image": "file://bestiary/tokens/KftGV/Crimson%20Helmed%20Horror.webp"
```
^statblock
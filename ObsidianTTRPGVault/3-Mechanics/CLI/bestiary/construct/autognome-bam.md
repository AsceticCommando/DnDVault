...
"traits":
  - "desc": "Whenever the autognome takes 15 damage or more from a single source and\
      ...
      \ autognome to be [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) and\
      \ [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened) until a creature\
      \ uses an action to reattach the head, which reactivates it.  \n- **17-20 \"\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Autognome.webp"
```
^statblock
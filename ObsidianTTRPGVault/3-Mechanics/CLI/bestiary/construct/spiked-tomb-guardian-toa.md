...
"traits":
  - "desc": "Whenever the tomb guardian starts its turn with 40 hit points or fewer,\
      ...
      \ Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check.\
      \ If the check succeeds, the tomb guardian ceases being berserk. If it takes\
      \ damage while still at 40 hit points or fewer, the tomb guardian might go berserk\
      \ again."
    "name": "Berserk"
...
"source":
  - "ToA"
"image": "file://bestiary/tokens/ToA/Spiked%20Tomb%20Guardian.webp"
```
^statblock
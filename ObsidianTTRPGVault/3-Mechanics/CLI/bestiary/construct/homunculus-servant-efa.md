...
"traits":
  - "desc": "If the homunculus is subjected to an effect that allows it to make a\
      ...
      \ can't use this trait if it has the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Evasion"
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Homunculus%20Servant.webp"
```
^statblock
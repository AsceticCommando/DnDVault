...
- "Replica Tridrone"
---
# [Replica Tridrone](3-Mechanics/CLI/bestiary/construct/replica-tridrone-oow.md)
*Source: The Orrery of the Wanderer p. 132*  

```statblock
"name": "Replica Tridrone (OoW)"
"size": "Medium"
"type": "construct"
...
"traits":
  - "desc": "The tridrone can't be compelled to act in a manner contrary to its nature\
      \ or its instructions."
    "name": "Axiomatic Mind"
  - "desc": "If the replica tridrone dies, its body falls into a pile of parts (gears,\
...
"source":
  - "OoW"
"image": "file://bestiary/tokens/OoW/Replica%20Tridrone.webp"
```
^statblock
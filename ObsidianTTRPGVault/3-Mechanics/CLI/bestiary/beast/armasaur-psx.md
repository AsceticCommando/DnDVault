...
- "Armasaur"
---
# [Armasaur](3-Mechanics/CLI/bestiary/beast/armasaur-psx.md)
...
Armasaurs also have plates on their backs, but these rise up like spikes along their spines. Their whiplike tails bear sharp spikes for protection. Use the [stegosaurus](3-Mechanics/CLI/bestiary/beast/stegosaurus-mpmm.md) in "Volo's Guide to Monsters" for the armasaur.
...
"source":
  - "PSX"
"image": "file://bestiary/tokens/PSX/Armasaur.webp"
```
^statblock
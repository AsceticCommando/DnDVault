...
"traits":
  - "desc": "Whenever the snail starts its turn in contact with a pound or more of\
      \ salt, it takes 1d4 necrotic damage. Using an action to sprinkle a pound of\
      \ salt on the snail deals 1d4 necrotic damage to it immediately and another\
      \ 1d4 necrotic damage to it at the start of its next turn (after which the salt\

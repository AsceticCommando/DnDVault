...
"traits":
  ...
  - "desc": "The hag can cast the [Legend Lore](3-Mechanics/CLI/spells/legend-lore-xphb.md)\
...
"actions":
  ...
  - "desc": "While holding its shears, the hag casts one of the following spells,\
      ...
      \ [Guidance](3-Mechanics/CLI/spells/guidance-xphb.md), [Silent Image](3-Mechanics/CLI/spells/silent-image-xphb.md)\n\
      \n**1/day each:** [Bane](3-Mechanics/CLI/spells/bane-xphb.md), [Bestow Curse](3-Mechanics/CLI/spells/bestow-curse-xphb.md),\
      \ [Divination](3-Mechanics/CLI/spells/divination-xphb.md), [Scrying](3-Mechanics/CLI/spells/scrying-xphb.md)\
      \ (as an action)"
    "name": "Spellcasting"
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Fate%20Hag.webp"
```
^statblock
...
"bonus_actions":
  - "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
      ...
      \ mood:\n\n- **Fuming.** The spirit has [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
      ...
      \ can see within 10 feet of itself. *Failure:* The target is [Charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by you and the spirit for 1 minute or until the target takes any damage. \
      \ \n- **Tricksy.** The spirit fills a 10-foot [Cube](3-Mechanics/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\

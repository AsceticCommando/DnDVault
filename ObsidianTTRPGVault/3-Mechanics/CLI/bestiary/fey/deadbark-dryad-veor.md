...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 30 ft., one target. *Hit:* The\
      ...
      \ [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) by that vine no longer\
      \ has the [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) condition.\
      \ All vines immediately wither and disappear when the dryad is reduced to 0\
      \ hit points."
    "name": "Sapping Vine"
...
"source":
  - "VEoR"
"image": "file://bestiary/tokens/VEoR/Deadbark%20Dryad.webp"
```
^statblock
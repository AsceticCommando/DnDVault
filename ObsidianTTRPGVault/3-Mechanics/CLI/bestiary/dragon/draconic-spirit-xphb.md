...
"traits":
  - "desc": "When you summon the spirit, choose one of its Resistances. You have [Resistance](3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC equals your spell save DC, each creature\
      \ in a 30-foot [Cone](3-Mechanics/CLI/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 2d6 damage of a type this spirit has [Resistance](3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md)\

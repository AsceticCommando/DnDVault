...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      **1/day each:** [antilife shell](3-Mechanics/CLI/spells/antilife-shell.md),\
      \ [bane](3-Mechanics/CLI/spells/bane.md), [control water](3-Mechanics/CLI/spells/control-water.md),\
...
"regional_effects":
  - "desc": "The region surrounding a legendary topaz dragon's lair is altered by\
      ...
      \ unable to reduce its levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion)\

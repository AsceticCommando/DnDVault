...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no material components\
      ...
      \ [calm emotions](3-Mechanics/CLI/spells/calm-emotions.md), [dispel magic](3-Mechanics/CLI/spells/dispel-magic.md),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ there, the target is [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned).\

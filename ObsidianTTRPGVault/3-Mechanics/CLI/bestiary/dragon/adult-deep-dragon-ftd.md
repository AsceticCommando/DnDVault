...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ two rounds in a row:\n\n- **Deep Torpor.** The dragon casts the [slow](3-Mechanics/CLI/spells/slow.md)\
...
"regional_effects":
  - "desc": "The region surrounding a legendary deep dragon's lair is altered by the\
      ...
      \ Constitution saving throw or be unable to reduce its level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).\

...
"cr": "3"
"traits":
  - "desc": "Allies in a 10-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the scribe have [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
      ...
      \ This trait doesn't function if the scribe has the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ condition."
...
"actions":
  ...
  - "desc": "The scribe casts one of the following spells, requiring no Material components\
      ...
      \ [Message](3-Mechanics/CLI/spells/message-xphb.md)\n\n**1/day each:** [Sending](3-Mechanics/CLI/spells/sending-xphb.md)"
    "name": "Spellcasting"
"reactions":
  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 20-foot-radius\
      ...
      \ centered on a point the scribe can see within 60 feet. *Failure:* The target\
      \ has the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ condition until the start of the scribe's next turn. While the target is [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated),\
      \ its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md) is 0 and can't\
      \ increase."
    "name": "Word of Stasis (Recharge 5-6)"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Sivis%20Scribe.webp"
```
^statblock
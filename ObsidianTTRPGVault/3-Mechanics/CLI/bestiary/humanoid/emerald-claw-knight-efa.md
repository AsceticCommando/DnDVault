...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 7 (1d8 + 3) Bludgeoning damage—\
      plus 4 (1d8) Necrotic damage if the knight is Bloodied—and the target has [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Emerald%20Claw%20Knight.webp"
```
^statblock
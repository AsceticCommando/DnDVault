...
"traits":
  - "desc": "The spellcaster's spellcasting ability is Intelligence (spell save DC\
      \ 16, +8 to hit with spell attacks). The spellcaster has following wizard spells\
      ...
      \ [flaming sphere](3-Mechanics/CLI/spells/flaming-sphere-xphb.md), [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md)\n\
      ...
      \ (2 slots):** [cone of cold](3-Mechanics/CLI/spells/cone-of-cold-xphb.md),\
...
"source":
  - "DC"
"image": "file://bestiary/tokens/DC/Spellcaster%20%28Mage%29.webp"
```
^statblock
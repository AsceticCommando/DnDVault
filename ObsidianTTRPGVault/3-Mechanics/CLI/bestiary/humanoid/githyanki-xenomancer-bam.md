...
"actions":
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      \n**2/day each:** [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md)\
      \ (self only), [pass without trace](3-Mechanics/CLI/spells/pass-without-trace-xphb.md)\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Githyanki%20Xenomancer.webp"
```
^statblock
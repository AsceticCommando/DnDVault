...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 20-foot-radius\
      ...
      \ centered on a point the enforcer can see within 60 feet. *Failure:* 13 (3d8)\
      \ Lightning damage, and the creature can't take Reactions until the end of the\
      \ enforcer's next turn. *Success:* Half damage only."
...
"reactions":
  - "desc": "Trigger: The enforcer takes damage from a melee attack. _Response:_ The\
      ...
      \ saving throw, or its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md)\
      \ is halved until the start of the enforcer's next turn."
    "name": "Temporal Disruption (1/Day)"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Orien%20Enforcer.webp"
```
^statblock
...
"traits":
  - "desc": "While in a 30-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the commander, the commander and its allies have [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +6, reach 5 ft. or range 30/120 ft. *Hit:*\
      ...
      \ is [Bloodied](3-Mechanics/CLI/rules/conditions.md#Bloodied)."
    "name": "Javelin"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Emerald%20Claw%20Commander.webp"
```
^statblock
...
"actions":
  ...
  - "desc": "The elf casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ (8th-level version), [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md)\n\
      \n**1/day each:** [divination](3-Mechanics/CLI/spells/divination-xphb.md), [sending](3-Mechanics/CLI/spells/sending-xphb.md),\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Astral%20Elf%20Star%20Priest.webp"
```
^statblock
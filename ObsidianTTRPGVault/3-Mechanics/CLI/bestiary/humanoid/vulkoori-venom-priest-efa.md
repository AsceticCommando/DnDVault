...
"actions":
  ...
  - "desc": "The priest casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [Dancing Lights](3-Mechanics/CLI/spells/dancing-lights-xphb.md), [Ray of Sickness](3-Mechanics/CLI/spells/ray-of-sickness-xphb.md),\
      \ [Thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy-xphb.md)\n\n**1/day each:**\
      \ [Cure Wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md), [Hold Person](3-Mechanics/CLI/spells/hold-person-xphb.md),\
      \ [Protection from Poison](3-Mechanics/CLI/spells/protection-from-poison-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Each creature with the [Poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
      \ condition within a 30-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the priest takes 3 (1d6) Poison damage."
    "name": "Intensify Poison"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Vulkoori%20Venom%20Priest.webp"
```
^statblock
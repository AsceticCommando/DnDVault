...
"traits":
  - "desc": "Magic can't put the shadow walker to sleep."
    "name": "Fey Ancestry"
  - "desc": "While in sunlight, the shadow walker has [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, one creature the shadow walker can see\
      ...
      \ start of the shadow walker's next turn."
    "name": "Shadow Cowl"
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Umbragen%20Shadow%20Walker.webp"
```
^statblock
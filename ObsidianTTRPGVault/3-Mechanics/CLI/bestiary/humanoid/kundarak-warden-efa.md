...
"cr": "5"
"traits":
  - "desc": "The warden has [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 13 (3d6 + 3) Force damage,\
      \ and if the target is a Medium or smaller creature, it has the [Prone](3-Mechanics/CLI/rules/conditions.md#Prone)\
      \ condition. If the target already has the [Prone](3-Mechanics/CLI/rules/conditions.md#Prone)\
  ...
  - "desc": "*Strength Saving Throw:* DC 14, one creature the warden can see within\
      \ 60 feet. *Failure:* The creature has the [Grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
      \ condition (escape DC 14). While [Grappled](3-Mechanics/CLI/rules/conditions.md#Grappled),\
      \ the creature has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
      \ condition."
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Kundarak%20Warden.webp"
```
^statblock
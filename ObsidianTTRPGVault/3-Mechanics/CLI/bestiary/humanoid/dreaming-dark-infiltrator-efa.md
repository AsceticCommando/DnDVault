...
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature hit by the infiltrator's Mind\
      ...
      \ and is cursed. While cursed in this way, it has [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md)\
      ...
      \ A cursed creature repeats the save whenever it finishes a [Short](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md), ending\
      \ the effect on itself on a success. *Success:* Half damage only."
    "name": "Mind Curse"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Dreaming%20Dark%20Infiltrator.webp"
```
^statblock
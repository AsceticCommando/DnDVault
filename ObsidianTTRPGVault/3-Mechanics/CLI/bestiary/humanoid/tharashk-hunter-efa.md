...
"bonus_actions":
  - "desc": "The hunter magically marks one creature it can see within 150 feet. The\
      ...
      \ [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) again.\
      \ While the target is marked in this way, the hunter has [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Tharashk%20Hunter.webp"
```
^statblock
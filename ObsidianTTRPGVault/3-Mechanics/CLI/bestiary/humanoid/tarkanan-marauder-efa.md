...
"traits":
  - "desc": "If the marauder is subjected to an effect that allows it to make a Dexterity\
      ...
      \ use this trait if it has the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Evasion"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (3d6 + 3) Piercing damage,\
      \ plus 21 (6d6) Force damage if the marauder had [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
      \ on the attack roll."
...
"bonus_actions":
  - "desc": "The marauder teleports to a space it can see within 30 feet, appearing\
      ...
      \ end of the marauder's next turn."
    "name": "Tear Through Space"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Tarkanan%20Marauder.webp"
```
^statblock
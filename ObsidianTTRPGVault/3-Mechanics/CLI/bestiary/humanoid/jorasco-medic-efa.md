...
"cr": "4"
"traits":
  - "desc": "When the medic rolls a 1 on the d20 of a [D20 Test](3-Mechanics/CLI/rules/variant-rules/d20-test-xphb.md),\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +5, reach 5 ft. or range 30 ft. *Hit:*\
      \ 7 (2d6) Radiant damage, and the creature has the [Blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Jorasco%20Medic.webp"
```
^statblock
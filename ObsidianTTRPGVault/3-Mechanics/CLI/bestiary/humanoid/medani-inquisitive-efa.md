...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the inquisitive can see within\
      ...
      \ inquisitive has [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
      \ on attack rolls against a target it has marked. While marked, the target can't\
      \ become hidden from the inquisitive, and if it has the [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible)\
...
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Medani%20Inquisitive.webp"
```
^statblock
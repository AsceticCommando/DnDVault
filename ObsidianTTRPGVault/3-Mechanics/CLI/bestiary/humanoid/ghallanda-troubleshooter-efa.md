...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +5, reach 5 ft. or range 20/60 ft. *Hit:*\
      \ 5 (1d4 + 3) Piercing damage, and the target has the [Poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
  ...
  - "desc": "The troubleshooter casts one of the following spells, requiring no Material\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The troubleshooter takes the [Disengage](3-Mechanics/CLI/rules/actions.md#Disengage)\
      \ or [Hide](3-Mechanics/CLI/rules/actions.md#Hide) action."
    "name": "Nimble Escape"
"source":
  - "EFA"
"image": "file://bestiary/tokens/EFA/Ghallanda%20Troubleshooter.webp"
```
^statblock
...
"actions":
  ...
  - "desc": "The braxat casts one of the following spells, requiring no spell components\
      ...
      **1/day each:** [compulsion](3-Mechanics/CLI/spells/compulsion-xphb.md), [fear](3-Mechanics/CLI/spells/fear-xphb.md)"
...
"reactions":
  - "desc": "When the braxat would be hit by an attack roll or a [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md)\
      ...
      \ and prevents [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md)\
      \ spells from damaging it."
    "name": "Psionic Shield (3/Day)"
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Braxat.webp"
```
^statblock
...
"bonus_actions":
  - "desc": "The scion moves up to its speed and sends a shock wave through the ground\
      ...
      \ in that area that is [concentrating](3-Mechanics/CLI/rules/conditions.md#Concentration)\
      \ must succeed on a DC 25 Constitution saving throw or lose [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration)."
...
"source":
  - "BGG"
"image": "file://bestiary/tokens/BGG/Scion%20of%20Thrym.webp"
```
^statblock
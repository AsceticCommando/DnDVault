...
"bonus_actions":
  - "desc": "The scion moves up to its speed and then sends a shock wave through the\
      ...
      \ must succeed on a DC 24 Constitution saving throw or lose [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration)."
...
"source":
  - "BGG"
"image": "file://bestiary/tokens/BGG/Scion%20of%20Skoraeus.webp"
```
^statblock
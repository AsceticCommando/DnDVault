...
"traits":
  ...
  - "desc": "While in dim light or darkness, the horror can take the [Hide](3-Mechanics/CLI/rules/actions.md#Hide)\
...
"source":
  - "GGR"
"image": "file://bestiary/tokens/GGR/Shadow%20Horror.webp"
```
^statblock
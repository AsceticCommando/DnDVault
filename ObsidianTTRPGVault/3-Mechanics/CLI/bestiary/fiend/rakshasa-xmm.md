...
"damage_vulnerabilities": "piercing damage from weapons wielded by creatures under\
  \ the effect of a [Bless](3-Mechanics/CLI/spells/bless-xphb.md) spell"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ While cursed, the target gains no benefit from finishing a [Short](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md)\

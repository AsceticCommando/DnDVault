...
"traits":
  - "desc": "When the spirit drops to 0 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The spirit has [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\

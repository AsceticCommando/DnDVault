...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 10\
      ...
      \ Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or a similar effect.\
      \ If the cursed target drops to 0 hit points, it becomes a werevulture under\
      \ the DM's control and regains 10 hit points."
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Werevulture.webp"
```
^statblock
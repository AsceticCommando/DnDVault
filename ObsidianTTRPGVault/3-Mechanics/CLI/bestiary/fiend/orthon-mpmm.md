...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +7 to hit, range 100/400 ft., one target. *Hit:*\
      ...
      \ [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) until the end of the\
      \ orthon's next turn.  \n- **Concussion.** The target and each creature within\
      \ 20 feet of it must make a DC 17 Constitution saving throw, taking 13 (2d12)\
      ...
      \ 1 hour by strands of sticky webbing. The target can escape by taking an action\

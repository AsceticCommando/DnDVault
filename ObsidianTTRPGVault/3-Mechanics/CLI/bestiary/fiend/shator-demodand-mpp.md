...
"traits":
  ...
  - "desc": "The shator can cast the [imprisonment](3-Mechanics/CLI/spells/imprisonment-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 5 ft., one target. *Hit:* 17\
      \ (3d6 + 7) piercing damage plus 26 (4d12) acid damage. If the target is a creature,\
      \ it must succeed on a DC 16 Constitution saving throw or have the [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The shator casts one of the following spells, requiring no material components\
      ...
      \ each:** [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md), [plane\
      \ shift](3-Mechanics/CLI/spells/plane-shift-xphb.md) (to Carceri only), [scrying](3-Mechanics/CLI/spells/scrying-xphb.md)\
      \ (as an action)"
    "name": "Spellcasting"
"source":
  - "MPP"
"image": "file://bestiary/tokens/MPP/Shator%20Demodand.webp"
```
^statblock
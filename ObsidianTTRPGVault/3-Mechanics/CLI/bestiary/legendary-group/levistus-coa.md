...
- **Frozen Landscape.** Any creature that has the prone or unconscious conditions within 1 mile of the lair, takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) cold damage at the start of their turn.  

If Levistus dies, the effects fade over the course of `dice:1d10|noform|noparens|avg` (`1d10`) days.
...
- **The Devil's Greeting.** Within 500 miles of his lair, an illusory version of Asmodeus (as if he has cast the [Project Image](3-Mechanics/CLI/spells/project-image-xphb.md) spell) appears. Asmodeus attempts to communicate with any characters and decipher their intentions. If they're hostile, Asmodeus pretends to prepare himself for combat, in an effort to make the character's waste their resources.  

If Asmodeus dies, the effects fade over the course of `dice:1d10|noform|noparens|avg` (`1d10`) days.
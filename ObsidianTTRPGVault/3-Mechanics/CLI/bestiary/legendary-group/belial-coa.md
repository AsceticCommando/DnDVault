...
- **Slow Torture.** Every creature within 100 feet whose movement is currently reduced because of the Ranseur of Torture, takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) fire damage and `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) piercing damage.  

...
- A [wave](3-Mechanics/CLI/items/wave-xdmg.md) of searing heat fills the lair in a 300-foot radius around Imix for an instant. Each creature other than Imix in the area must succeed on a DC 15 Constitution saving throw or take `dice:1d8|noform|noparens|avg` (`1d8`) fire damage. Creatures that take fire damage from this effect gain one level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). In addition, there is a fifty percent chance that any container of fluid held or carried by an affected creature (for example, a magic potion) is destroyed.  

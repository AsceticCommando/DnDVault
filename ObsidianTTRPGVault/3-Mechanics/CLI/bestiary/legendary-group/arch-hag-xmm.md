...
- **Lapsus Linguae.** Creatures (excluding the hag and its allies) within 1 mile of the lair subtract `dice:1d10|noform|noparens|avg` (`1d10`) from any ability check they make when they take the [Influence](3-Mechanics/CLI/rules/actions.md#Influence) action.  

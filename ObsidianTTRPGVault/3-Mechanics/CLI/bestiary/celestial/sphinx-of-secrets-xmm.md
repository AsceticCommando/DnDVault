...
"actions":
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ on ability checks and attack rolls. In addition, if it takes the [Magic](3-Mechanics/CLI/rules/actions.md#Magic)\
      \ action, it must succeed on a DC 15 Intelligence saving throw or that action\
      \ is wasted. The cursed target can take a [Study](3-Mechanics/CLI/rules/actions.md#Study)\

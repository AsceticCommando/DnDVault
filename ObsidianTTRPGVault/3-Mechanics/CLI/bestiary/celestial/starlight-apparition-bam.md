...
"actions":
  - "desc": "*Melee  or Ranged Spell Attack:* +6 to hit, reach 5 ft. or range 120\
      ...
      \ a creature, it must succeed on a DC 14 Wisdom saving throw or be [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
  ...
  - "desc": "One Humanoid that the apparition can see within 5 feet of itself must\
      ...
      \ the apparition then disappears, and the target is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ like the [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md)\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Starlight%20Apparition.webp"
```
^statblock
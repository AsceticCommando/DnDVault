...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 5 ft., one target. *Hit:* 7\
      ...
      \ its turn, the target can make a DC 20 Constitution saving throw, ending the\
  ...
  - "desc": "Vecna causes necrotic magic to engulf one creature he can see within\
      ...
      \ on a successful one. A Humanoid killed by this magic rises as a [zombie](3-Mechanics/CLI/bestiary/undead/zombie.md)\
      \ at the start of Vecna's next turn and acts immediately after Vecna in the\
      \ initiative order. The [zombie](3-Mechanics/CLI/bestiary/undead/zombie.md)\
  ...
  - "desc": "Vecna casts one of the following spells, requiring no material components\
      ...
      **At will:** [animate dead](3-Mechanics/CLI/spells/animate-dead.md) (as an action),\
      ...
      \ [invisibility](3-Mechanics/CLI/spells/invisibility.md), [scrying](3-Mechanics/CLI/spells/scrying.md)\

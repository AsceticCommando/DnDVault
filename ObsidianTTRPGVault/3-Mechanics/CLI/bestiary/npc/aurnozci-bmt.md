...
"actions":
  ...
  - "desc": "Aurnozci casts one of the following spells, requiring no material components\
      ...
      \ [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [Heat Metal](3-Mechanics/CLI/spells/heat-metal-xphb.md)\
      \ (7th-level version)\n\n**2/day each:** [Darkness](3-Mechanics/CLI/spells/darkness-xphb.md),\
      \ [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md), [Hold Person](3-Mechanics/CLI/spells/hold-person-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Aurnozci.webp"
```
^statblock
...
"cr": "8"
"traits":
  - "desc": "Dermot wears [mariner's armor](3-Mechanics/CLI/items/mariners-armor-xdmg.md)\
...
"actions":
  ...
  - "desc": "Dermot casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \n**2/day each:** [bless](3-Mechanics/CLI/spells/bless-xphb.md) (at 3rd level),\
      \ [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md) (at 3rd level)\n\
      \n**1/day:** [revivify](3-Mechanics/CLI/spells/revivify-xphb.md)"
    "name": "Spellcasting"
"source":
  - "CRCotN"
"image": "file://bestiary/tokens/CRCotN/Dermot%20Wurder%20%28Tier%203%29.webp"
```
^statblock
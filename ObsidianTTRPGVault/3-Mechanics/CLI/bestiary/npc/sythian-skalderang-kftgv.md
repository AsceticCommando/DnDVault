...
"actions":
  ...
  - "desc": "Sythian casts one of the following spells, using Charisma as the spellcasting\
      ...
      \ each:** [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md), [faerie\
      \ fire](3-Mechanics/CLI/spells/faerie-fire-xphb.md), [unseen servant](3-Mechanics/CLI/spells/unseen-servant-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"source":
  - "KftGV"
"image": "file://bestiary/tokens/KftGV/Sythian%20Skalderang.webp"
```
^statblock
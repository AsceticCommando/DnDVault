...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ saving throw or be cursed with werebat [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md)."
...
"source":
  - "WDMM"
"image": "file://bestiary/tokens/WDMM/Mobar.webp"
```
^statblock
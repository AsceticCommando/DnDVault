...
"actions":
  ...
  - "desc": "Majesto magically turns [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible)\
      ...
      \ on a spell). Any equipment Majesto wears or carries is [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Majesto.webp"
```
^statblock
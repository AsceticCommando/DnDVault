...
"actions":
  ...
  - "desc": "Ctenmiir targets one humanoid it can see within 30 feet of it. If the\
      ...
      \ to end the effect."
    "name": "Charm"
  - "desc": "Ctenmiir magically calls 2d4 swarms of [bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md)\
      \ or [rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md), provided that\
      \ the sun isn't up. While outdoors, Ctenmiir can call 3d6 [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md)\
...
"source":
  - "LLK"
"image": "file://bestiary/tokens/LLK/Ctenmiir%20the%20Vampire.webp"
```
^statblock
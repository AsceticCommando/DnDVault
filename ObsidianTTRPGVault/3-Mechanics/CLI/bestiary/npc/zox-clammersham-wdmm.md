...
"traits":
  - "desc": "Zox is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
      \ (spell save DC 17, +9 to hit with spell attacks). Zox can cast [disguise self](3-Mechanics/CLI/spells/disguise-self-xphb.md)\
      \ and [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) at will and\
...
"source":
  - "WDMM"
"image": "file://bestiary/tokens/WDMM/Zox%20Clammersham.webp"
```
^statblock
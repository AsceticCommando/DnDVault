...
"actions":
  ...
  - "desc": "One humanoid that Celeste can see within 5 feet of it must succeed on\
      ...
      \ the body drops to 0 hit points, Celeste ends it as a bonus action, or Celeste\
      \ is turned or forced out by an effect like the [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md)\
      \ spell. When the possession ends, Celeste reappears in an unoccupied space\
...
"source":
  - "CRCotN"
"image": "file://bestiary/tokens/CRCotN/Celeste.webp"
```
^statblock
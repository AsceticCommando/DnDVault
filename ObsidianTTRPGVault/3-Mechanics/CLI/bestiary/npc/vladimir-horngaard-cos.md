...
"actions":
  ...
  - "desc": "Vladimir can target Strahd within 30 feet provided he can see Strahd.\
      \ Strahd must make a DC 15 Wisdom saving throw. On a failure, Strahd is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
      ...
      \ each of his turns, with disadvantage if he can see Vladimir, ending the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
      \ condition on itself on a success."
    "name": "Vengeful Glare"
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Vladimir%20Horngaard.webp"
```
^statblock
...
"traits":
  - "desc": "If a creature tries to read Dyrrn's thoughts or deals psychic damage\
      ...
      \ be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) for 1 minute. The\
      \ [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) creature can repeat\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +15 to hit, reach 10 ft., one target. *Hit:* 24\
      ...
      \ 23), pulled into an unoccupied space within 5 feet of Dyrrn, and must succeed\
      \ on a DC 23 Intelligence saving throw or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned)\
...
"lair_actions":
  - "desc": "While within the Palace of Sinew, Dyrrn can invoke the ambient magic\
      ...
      \ its turn in the area must succeed on a DC 23 Strength saving throw or be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained).\
...
"legendary_actions":
  ...
  - "desc": "Dyrrn magically emits psychic energy in a 60-foot cone. Each creature\
      ...
      \ (5d8 + 8) psychic damage and be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned)\

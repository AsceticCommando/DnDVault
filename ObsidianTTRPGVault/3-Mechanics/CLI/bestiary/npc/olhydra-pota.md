...
"traits":
  - "desc": "Olhydra's innate spellcasting ability is Charisma (spell save DC 20,\
      ...
      \ requiring no material components:\n\n**At will:** [wall of ice](3-Mechanics/CLI/spells/wall-of-ice-xphb.md)\n\
      \n**3/day:** [ice storm](3-Mechanics/CLI/spells/ice-storm-xphb.md)\n\n**1/day:**\
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +12 to hit, range 120 ft., one target. *Hit:*\
    ...
    "name": "Water Jet"
  - "desc": "Olhydra summons up to three [water elementals](3-Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md)\
...
"regional_effects":
  - "desc": "Olhydra's presence in an elemental node creates a number of widespread\
      ...
      \ A downpour occurs once every 2d12 hours, and lasts 1d3 hours. Downpours are\
      \ so heavy that creatures moving overland travel at half normal speed  \n- Within\
      \ 5 miles of the lair, currents and tides are exceptionally strong and treacherous.\
      ...
      \ is [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) and attempts\
      \ to leave the area, remaining [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "PotA"
"image": "file://bestiary/tokens/PotA/Olhydra.webp"
```
^statblock
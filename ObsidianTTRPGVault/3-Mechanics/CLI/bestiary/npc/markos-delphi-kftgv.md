...
"actions":
  ...
  - "desc": "Markos casts one of the following spells, requiring no material components\
      ...
      \ each:** [arms of Hadar](3-Mechanics/CLI/spells/arms-of-hadar-xphb.md), [charm\
      \ person](3-Mechanics/CLI/spells/charm-person-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "KftGV"
"image": "file://bestiary/tokens/KftGV/Markos%20Delphi.webp"
```
^statblock
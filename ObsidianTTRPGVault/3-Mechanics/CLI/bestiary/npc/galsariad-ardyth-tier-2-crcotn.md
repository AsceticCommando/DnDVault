...
"bonus_actions":
  - "desc": "Galsariad targets himself or one willing creature that he can see within\
      ...
      \ attacks. When this effect ends at the start of Galsariad's next turn, the\
      \ target floats gently down up to 20 feet."
    "name": "Distort Gravity (1/Day)"
"source":
  - "CRCotN"
"image": "file://bestiary/tokens/CRCotN/Galsariad%20Ardyth%20%28Tier%202%29.webp"
```
^statblock
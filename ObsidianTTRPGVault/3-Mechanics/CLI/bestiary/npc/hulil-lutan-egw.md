...
"traits":
  - "desc": "Hulil is a 4th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    "name": "Spellcasting"
  - "desc": "Hulil has advantage on saving throws against being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "EGW"
"image": "file://bestiary/tokens/EGW/Hulil%20Lutan.webp"
```
^statblock
...
- "Peebles"
---
# [Peebles](3-Mechanics/CLI/bestiary/npc/peebles-oota.md)
...
"traits":
  ...
  - "desc": "On each of its turns, Peebles can use a bonus action to take the [Dash](3-Mechanics/CLI/rules/actions.md#Dash),\
  ...
  - "desc": "Peebles deals an extra 7 (2d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Peebles that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "OotA"
"image": "file://bestiary/tokens/OotA/Peebles.webp"
```
^statblock
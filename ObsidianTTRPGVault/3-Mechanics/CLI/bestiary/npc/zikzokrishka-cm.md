...
"actions":
  ...
  - "desc": "Each creature of Zikzokrishka's choice that is within 120 feet of the\
      ...
      \ become [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) for 1\
      ...
      \ successful or the effect ends for it, the creature is immune to the Zikzokrishka's\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties) whenever she is in the\
      ...
      \ damage and be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone) and\
      \ buried under rubble. A buried creature is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
...
"source":
  - "CM"
"image": "file://bestiary/tokens/CM/Zikzokrishka.webp"
```
^statblock
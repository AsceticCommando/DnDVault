...
"actions":
  ...
  - "desc": "Auril breaks off an icicle from her body and hurls it into an unoccupied\
      ...
      \ an [ice mephit](3-Mechanics/CLI/bestiary/elemental/ice-mephit-xmm.md) (see\
      \ its entry in the Monster Manual). The mephit acts immediately after Auril\
...
"source":
  - "IDRotF"
"image": "file://bestiary/tokens/IDRotF/Auril%20%28Second%20Form%29.webp"
```
^statblock
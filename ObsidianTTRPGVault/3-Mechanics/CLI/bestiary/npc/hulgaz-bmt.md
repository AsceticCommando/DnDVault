...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ succeed on a DC 17 Wisdom saving throw or have the [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
  ...
  - "desc": "Hulgaz exhales a 30-foot cone of noxious, scorching-hot vapor. Each creature\
      ...
      \ a creature takes 31 (7d8) fire damage at the start of each of its turns and\
      \ has disadvantage on Wisdom saving throws. A target can repeat the Constitution\
  ...
  - "desc": "Hulgaz casts one of the following spells, requiring no material components\
      ...
      \ each:** [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md), [Fog\
      \ Cloud](3-Mechanics/CLI/spells/fog-cloud-xphb.md)\n\n**1/day:** [Teleport](3-Mechanics/CLI/spells/teleport-xphb.md)"
    "name": "Spellcasting"
...
"legendary_actions":
  - "desc": "Hulgaz makes one Claw attack."
    "name": "Attack"
  - "desc": "Hulgaz uses Spellcasting to cast [Charm Person](3-Mechanics/CLI/spells/charm-person-xphb.md)."
    "name": "Charm"
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Hulgaz.webp"
```
^statblock
...
"actions":
  ...
  - "desc": "One Humanoid that Caradoc can see within 5 feet of himself must succeed\
      ...
      \ Intelligence, Wisdom, and Charisma, immunity to being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
      \ and [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened), and his\
      \ Divisive Whispers bonus action. He otherwise uses the possessed target's statistics\

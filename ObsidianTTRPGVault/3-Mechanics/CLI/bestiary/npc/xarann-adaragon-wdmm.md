...
"traits":
  ...
  - "desc": "Xarann deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Xarann that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ and Xarann doesn't have disadvantage on the attack roll."
    "name": "Sneak Attack (1/Turn)"
  - "desc": "Xarann wears a [piwafwi](3-Mechanics/CLI/items/piwafwi-cloak-of-elvenkind-oota.md),\
      \ a drow-made [cloak of elvenkind](3-Mechanics/CLI/items/cloak-of-elvenkind-xdmg.md).\
...
"source":
  - "WDMM"
"image": "file://bestiary/tokens/WDMM/Xarann%20A%27Daragon.webp"
```
^statblock
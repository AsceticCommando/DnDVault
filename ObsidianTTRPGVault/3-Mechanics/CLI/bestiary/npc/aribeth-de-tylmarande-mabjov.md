...
"traits":
  ...
  - "desc": "Aribeth is accompanied by a [nightmare](3-Mechanics/CLI/bestiary/fiend/nightmare-xmm.md).\
  ...
  - "desc": "Aribeth regains 20 hit points at the start of her turn. If Aribeth takes\
    ...
    "name": "Regeneration"
  - "desc": "Three [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) hide within\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 7 (1d8\
      ...
      \ dealt by the sword Void dies and can't be revived by any means short of a\
  ...
  - "desc": "Aribeth casts one of the following spells, using Charisma as the spellcasting\
      ...
      \ [command](3-Mechanics/CLI/spells/command-xphb.md), [magic weapon](3-Mechanics/CLI/spells/magic-weapon-xphb.md),\
      \ [searing smite](3-Mechanics/CLI/spells/searing-smite-xphb.md), [shield of\
...
"source":
  - "MaBJoV"
"image": "file://bestiary/tokens/MaBJoV/Aribeth%20de%20Tylmarande.webp"
```
^statblock
...
"traits":
  ...
  - "desc": "Lorry has the following flaws:\n\n- **Forbiddance.** Lorry can't enter\
      ...
      \ into Lorry's heart while Lorry is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "Lorry targets one humanoid it can see within 30 feet of it. If the target\
      ...
      \ Lorry as a trusted friend to be heeded and protected. Although the target\
      \ isn't under Lorry's control, it takes Lorry's requests or actions in the most\
      \ favorable way it can, and it is a willing target for Lorry's bite attack.\n\
      \nEach time Lorry or Lorry's companions do anything harmful to the target, it\

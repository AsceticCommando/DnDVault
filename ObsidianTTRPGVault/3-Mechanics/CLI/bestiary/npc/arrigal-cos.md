...
"traits":
  - "desc": "During its first turn, Arrigal has advantage on attack rolls against\
      \ any creature that hasn't taken a turn. Any hit Arrigal scores against a [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Arrigal deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Arrigal that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "11\n\n- The target is unable to perform a certain kind of act involving\
      ...
      \ is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded), [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened),\
...
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Arrigal.webp"
```
^statblock
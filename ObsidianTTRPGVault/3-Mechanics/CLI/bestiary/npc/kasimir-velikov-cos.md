...
"traits":
  - "desc": "Kasimir is a 9th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    "name": "Spellcasting"
  - "desc": "Kasimir has advantage on saving throws against being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed),\
  ...
  - "desc": "Kasimir wears a [ring of warmth](3-Mechanics/CLI/items/ring-of-warmth-xdmg.md)\
      ...
      \ and good](3-Mechanics/CLI/spells/protection-from-evil-and-good-xphb.md), and\
...
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Kasimir%20Velikov.webp"
```
^statblock
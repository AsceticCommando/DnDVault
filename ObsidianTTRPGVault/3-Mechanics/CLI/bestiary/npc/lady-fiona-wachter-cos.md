...
"traits":
  - "desc": "Fiona is a 5th-level spellcaster. Her spellcasting ability is Wisdom\
      ...
      \ slots):** [animate dead](3-Mechanics/CLI/spells/animate-dead-xphb.md), [create\
      \ food and water](3-Mechanics/CLI/spells/create-food-and-water-xphb.md)"
    "name": "Spellcasting"
...
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Lady%20Fiona%20Wachter.webp"
```
^statblock
...
"traits":
  - "desc": "Stanimir is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
      ...
      \ [phantom steed](3-Mechanics/CLI/spells/phantom-steed-xphb.md), [vampiric touch](3-Mechanics/CLI/spells/vampiric-touch-xphb.md)\n\
...
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Stanimir.webp"
```
^statblock
...
"traits":
  ...
  - "desc": "Euryale carries one half of a pair of [Sending Stones](3-Mechanics/CLI/items/sending-stones-xdmg.md);\
...
"actions":
  ...
  - "desc": "Euryale casts one of the following spells, requiring no material components\
      ...
      \n**2/day each:** [Goodberry](3-Mechanics/CLI/spells/goodberry-xphb.md), [Lesser\
      \ Restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md), [Locate Creature](3-Mechanics/CLI/spells/locate-creature-xphb.md),\
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Euryale.webp"
```
^statblock
...
"traits":
  - "desc": "During its first turn, Koris has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Koris scores against a [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Koris deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Koris that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "CRCotN"
"image": "file://bestiary/tokens/CRCotN/Koris.webp"
```
^statblock
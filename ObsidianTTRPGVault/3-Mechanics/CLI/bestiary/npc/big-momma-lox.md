...
"actions":
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:* 45\
      ...
      \ which falls [prone](3-Mechanics/CLI/rules/conditions.md#Prone) in a space\
      ...
      \ and can escape from the corpse by using 10 feet of movement, exiting [prone](3-Mechanics/CLI/rules/conditions.md#Prone)."
...
"source":
  - "LoX"
"image": "file://bestiary/tokens/LoX/Big%20Momma.webp"
```
^statblock
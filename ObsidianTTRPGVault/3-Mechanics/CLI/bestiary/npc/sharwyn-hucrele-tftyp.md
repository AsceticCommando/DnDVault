...
"traits":
  ...
  - "desc": "Sharwyn's AC can't be lower than 16."
    "name": "Barkskin"
  - "desc": "Sharwyn has a [spellbook](3-Mechanics/CLI/items/spellbook.md) that contains\
      \ the spells listed in her Spellcasting trait, plus [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md)\
      \ and [silent image](3-Mechanics/CLI/spells/silent-image-xphb.md)."
...
"source":
  - "TftYP"
"image": "file://bestiary/tokens/TftYP/Sharwyn%20Hucrele.webp"
```
^statblock
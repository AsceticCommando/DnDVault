...
Ezmerelda keeps a [deck of tarokka cards](3-Mechanics/CLI/decks/tarokka-deck-rhw.md) in her wagon (chapter 11, area V1). Although the cards aren't magical, Ezmerelda can use them to perform a card reading for the characters (see chapter 1), like the one that can be performed by Madam Eva.
...
"traits":
  ...
  - "desc": "In addition to her magic armor and weapons, Ezmerelda has two [potions\
      ...
      \ six [vials of holy water](3-Mechanics/CLI/items/holy-water-xphb.md), and three\
      \ wooden stakes."
...
"actions":
  ...
  - "desc": "Ezmerelda targets one creature that she can see within 10 feet of her\
      ...
      \ Ezmerelda is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) until\
      \ the end of her next turn. Once a target succeeds on a saving throw against\
      \ this effect, it is immune to the Evil Eye power of all Vistani for 24 hours."
    "name": "Evil Eye (Recharges after a Short or Long Rest)"
"source":
  - "CoS"
"image": "file://bestiary/tokens/CoS/Ezmerelda%20d%27Avenir.webp"
```
^statblock
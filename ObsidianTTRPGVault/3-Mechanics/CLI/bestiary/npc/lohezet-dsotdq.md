...
"actions":
  ...
  - "desc": "Lohezet magically conjures a billowing cloud of purple fog in a 20-foot-radius\
      ...
      \ and is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) until the\
      \ start of its next turn. On a successful save, the creature takes half as much\
      \ damage and isn't [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned).\

...
"actions":
  - "desc": "*Melee Weapon Attack:* +2 to hit, reach 5 ft., one target. *Hit:* 3 (1d6)\
      \ bludgeoning damage."
    "name": "Mace"
  - "desc": "As an action, Dagdra draws a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md)\
      \ from her [documancy satchel](3-Mechanics/CLI/items/documancy-satchel-ai.md).\
...
"source":
  - "OoW"
"image": "file://bestiary/tokens/OoW/Dagdra%20Deepforge.webp"
```
^statblock
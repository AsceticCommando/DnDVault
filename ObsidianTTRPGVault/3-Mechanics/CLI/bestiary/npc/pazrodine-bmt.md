...
"traits":
  - "desc": "Pazrodine can sense when an item is stolen from Seelie Market. She knows\
      \ the distance and direction to stolen items, as if by the [Locate Object](3-Mechanics/CLI/spells/locate-object-xphb.md)\
      \ spell."
...
"actions":
  ...
  - "desc": "Pazrodine uses one of the following breath weapons:\n\n- **Dream Breath.**\
      ...
      \ succeed on a DC 21 Constitution saving throw or have the [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
  ...
  - "desc": "Pazrodine casts one of the following spells, requiring no material components\
      ...
      \n**1/day each:** [Mass Cure Wounds](3-Mechanics/CLI/spells/mass-cure-wounds-xphb.md),\
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Pazrodine.webp"
```
^statblock
...
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 11\
      ...
      \ takes 13 (3d8) poison damage at the start of each of the scavver's turns from\
      \ the poisonous gas in the scavver's gullet.\n\nIf the scavver takes 15 damage\
...
"source":
  - "BAM"
"image": "file://bestiary/tokens/BAM/Brown%20Scavver.webp"
```
^statblock
...
"cr": "17"
"traits":
  - "desc": "The medusa can cast the [Resurrection](3-Mechanics/CLI/spells/resurrection-xphb.md)\
...
"actions":
  ...
  - "desc": "The medusa casts one of the following spells, requiring no material components\
      ...
      \ Cure Wounds](3-Mechanics/CLI/spells/mass-cure-wounds-xphb.md) (cast at 8th\
      \ level)\n\n**1/day each:** [Blade Barrier](3-Mechanics/CLI/spells/blade-barrier-xphb.md),\
...
"bonus_actions":
  - "desc": "The medusa unleashes petrifying magic from its eyes in a 30-foot cone.\
      ...
      \ it doesn't have the [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
      \ condition. If the saving throw fails by 5 or more, the creature has the [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified)\
      ...
      \ lasts until the creature is freed by the [Greater Restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md)\
...
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Hierophant%20Medusa.webp"
```
^statblock
...
"traits":
  - "desc": "Augustus regains 10 hit points at the start of his turn. If he takes\
      ...
      \ doesn't regenerate."
    "name": "Regeneration"
  - "desc": "Augustus wields a [+2 Longsword](3-Mechanics/CLI/items/2-weapon-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 26\
      ...
      \ a DC 15 Constitution saving throw or be cursed with [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md).\
      ...
      \ remains so until the night ends. A [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md)\
...
"bonus_actions":
  - "desc": "Augustus polymorphs into a wolf-humanoid hybrid, a wolf, or his humanoid\
      ...
      \ form if he dies."
    "name": "Change Shape"
  - "desc": "Augustus takes the [Dash](3-Mechanics/CLI/rules/actions.md#Dash), [Disengage](3-Mechanics/CLI/rules/actions.md#Disengage),\
      \ or [Hide](3-Mechanics/CLI/rules/actions.md#Hide) action."
    "name": "Cunning Action"
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Boss%20Augustus.webp"
```
^statblock
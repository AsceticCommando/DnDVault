...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 26\
      ...
      \ a DC 14 Constitution saving throw or be cursed with [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md).\
...
"bonus_actions":
  - "desc": "Delour polymorphs into a rat-humanoid hybrid, a Medium giant rat, or\
    ...
    "name": "Change Shape"
  - "desc": "Delour takes the [Dash](3-Mechanics/CLI/rules/actions.md#Dash), [Disengage](3-Mechanics/CLI/rules/actions.md#Disengage),\
      \ or [Hide](3-Mechanics/CLI/rules/actions.md#Hide) action."
    "name": "Cunning Action"
"source":
  - "BMT"
"image": "file://bestiary/tokens/BMT/Boss%20Delour.webp"
```
^statblock
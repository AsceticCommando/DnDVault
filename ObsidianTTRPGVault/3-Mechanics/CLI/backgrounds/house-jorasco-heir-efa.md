...
![](file://backgrounds/EFA/House%20Jorasco%20Heir.webp#right)

- **Ability Scores.** Dexterity, Constitution, Wisdom  
- **Feat.** [Mark of Healing](3-Mechanics/CLI/feats/mark-of-healing-efa.md)  
- **Skill Proficiencies.** [Medicine](3-Mechanics/CLI/rules/skills.md#Medicine) and [Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Herbalism Kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md)  
- **Equipment.** Choose A or B: (A) [Herbalism Kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Healer's Kit](3-Mechanics/CLI/items/healers-kit-xphb.md), 25 GP; or (B) 50 GP  

...
- **Equipment.** [Fishing tackle](3-Mechanics/CLI/items/fishing-tackle.md), a [net](3-Mechanics/CLI/items/net-xphb.md), a favorite fishing lure or oiled leather wading boots, a set of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp  

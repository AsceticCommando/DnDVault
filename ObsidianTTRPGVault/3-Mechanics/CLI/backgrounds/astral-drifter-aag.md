...
![Plasmoid Astral Drifter](file://backgrounds/AAG/Astral%20Drifter.webp#right)
...
- **Equipment.** A set of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), a diary, an [ink pen](3-Mechanics/CLI/items/ink-pen-xphb.md), a [bottle of ink](3-Mechanics/CLI/items/ink-xphb.md), and a [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp  
...
You gain the [Magic Initiate feat](3-Mechanics/CLI/feats/magic-initiate-xphb.md) from the "Player's Handbook" and must choose cleric for the feat.

...
![](file://backgrounds/EFA/House%20Vadalis%20Heir.webp#right)

- **Ability Scores.** Constitution, Wisdom, Charisma  
- **Feat.** [Mark of Handling](3-Mechanics/CLI/feats/mark-of-handling-efa.md)  
- **Skill Proficiencies.** [Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling) and [Nature](3-Mechanics/CLI/rules/skills.md#Nature)  
- **Tool Proficiencies.** [Herbalism Kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md)  
- **Equipment.** Choose A or B: (A) [Herbalism Kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Net](3-Mechanics/CLI/items/net-xphb.md), 29 GP; or (B) 50 GP  

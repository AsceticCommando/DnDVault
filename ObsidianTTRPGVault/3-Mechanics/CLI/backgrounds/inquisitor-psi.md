...
![Moorland Inquisitor](file://backgrounds/PSI/Inquisitor.webp#right)
...
- **Tool Proficiencies.** [Thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md), one type of artisan's tools  
- **Equipment.** A [holy symbol](3-Mechanics/CLI/items/holy-symbol-xphb.md), a set of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 15 gp  

...
![](file://backgrounds/AI/celebrity-adventurers-scion.webp#right)
...
- **Equipment.** [Disguise kit](3-Mechanics/CLI/items/disguise-kit-xphb.md), a set of [fine clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 30 gp.  

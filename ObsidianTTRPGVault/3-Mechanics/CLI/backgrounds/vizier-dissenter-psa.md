...
- **Equipment.** A set of artisan's tools or a musical instrument (one of your choice), a scroll of your god's teachings, a vizier's cartouche, a set of [fine clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), and a [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 25 gp  
...
As a vizier, you can have any class, but you are especially likely to be a [cleric](3-Mechanics/CLI/classes/cleric-xphb.md), a [druid](3-Mechanics/CLI/classes/druid-xphb.md) (particularly if you serve Rhonas), or a [paladin](3-Mechanics/CLI/classes/paladin-xphb.md).
...
![Shadowstorm Vizier](file://backgrounds/PSA/Vizier.webp#center)
...
![Samut, Voice of Dissent](file://backgrounds/PSA/Dissenter.webp#right)
...
- **Equipment.** A simple puzzle box, a scroll containing the basic teachings of the five gods, a gaming set, a set of [common clothes](3-Mechanics/CLI/items/common-clothes.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 15 gp. If you have completed any trials before the start of the campaign, you also have any cartouches you have earned  
...
If you are a hand-to-hand specialist, consider the [barbarian](3-Mechanics/CLI/classes/barbarian-xphb.md), [fighter](3-Mechanics/CLI/classes/fighter-xphb.md), [monk](3-Mechanics/CLI/classes/monk-xphb.md), [paladin](3-Mechanics/CLI/classes/paladin-xphb.md), or [rogue](3-Mechanics/CLI/classes/rogue-xphb.md) classes. As a long-range combat specialist, you might be a [fighter](3-Mechanics/CLI/classes/fighter-xphb.md), a [ranger](3-Mechanics/CLI/classes/ranger-xphb.md), or a [rogue](3-Mechanics/CLI/classes/rogue-xphb.md). If you are a spellcasting specialist, you might be a [bard](3-Mechanics/CLI/classes/bard-xphb.md), [sorcerer](3-Mechanics/CLI/classes/sorcerer-xphb.md), or [wizard](3-Mechanics/CLI/classes/wizard-xphb.md). And beyond this initial choice, you might consider multiclassing or using feats to round out your skills in all three areas.
...
> [!gallery]
![Unwavering Initiate](file://backgrounds/PSA/Initiate.webp)
![Gust Walker](file://backgrounds/PSA/Initiate2.webp)
...
Any class that has martial prowess can be a good fit in the Knights of Solamnia. [Fighters](3-Mechanics/CLI/classes/fighter.md) and [paladins](3-Mechanics/CLI/classes/paladin.md) make up the bulk of the knighthood's forces. [Clerics](3-Mechanics/CLI/classes/cleric.md) (often with the [War](3-Mechanics/CLI/classes/cleric.md) domain) can also be found among the knights' ranks.

For a more unusual take on a Knight of Solamnia character, consider playing a bard of the [College of Valor](3-Mechanics/CLI/classes/bard.md) (or the [College of Swords](3-Mechanics/CLI/classes/bard-college-of-swords-xge.md) from "Xanathar's Guide to Everything") or a [barbarian](3-Mechanics/CLI/classes/barbarian.md) devoted to the ideals of the nature god Habbakuk (perhaps adopting the [Path of the Zealot](3-Mechanics/CLI/classes/barbarian-path-of-the-zealot-xge.md) from "Xanathar's Guide to Everything").

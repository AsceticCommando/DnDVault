...
- **Equipment.** One set of artisan's tools, [merchant's scale](3-Mechanics/CLI/items/merchants-scale.md), a set of [fine clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp  

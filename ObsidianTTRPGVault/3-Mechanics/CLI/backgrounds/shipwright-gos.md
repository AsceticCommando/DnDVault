...
- **Tool Proficiencies.** [Carpenter's tools](3-Mechanics/CLI/items/carpenters-tools-xphb.md), Vehicles (water)  
- **Equipment.** A set of well-loved [carpenter's tools](3-Mechanics/CLI/items/carpenters-tools-xphb.md), a blank [book](3-Mechanics/CLI/items/book-xphb.md), [1 ounce of ink](3-Mechanics/CLI/items/ink-xphb.md), an [ink pen](3-Mechanics/CLI/items/ink-pen-xphb.md), a set of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), and a leather [pouch](3-Mechanics/CLI/items/pouch-xphb.md) with 10 gp  

...
- **Equipment.** A [dagger](3-Mechanics/CLI/items/dagger-xphb.md) that belonged to a fallen comrade, a folded flag emblazoned with the symbol of your ship or company, a set of [traveler's clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), and a belt [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp  

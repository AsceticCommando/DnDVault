...
![](file://backgrounds/EFA/House%20Sivis%20Heir.webp#right)

- **Ability Scores.** Intelligence, Wisdom, Charisma  
- **Feat.** [Mark of Scribing](3-Mechanics/CLI/feats/mark-of-scribing-efa.md)  
- **Skill Proficiencies.** [History](3-Mechanics/CLI/rules/skills.md#History) and [Perception](3-Mechanics/CLI/rules/skills.md#Perception)  
- **Tool Proficiencies.** [Calligrapher's Supplies](3-Mechanics/CLI/items/calligraphers-supplies-xphb.md)  
- **Equipment.** Choose A or B: (A) [Calligrapher's Supplies](3-Mechanics/CLI/items/calligraphers-supplies-xphb.md), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Ink](3-Mechanics/CLI/items/ink-xphb.md), 5 [Ink Pens](3-Mechanics/CLI/items/ink-pen-xphb.md), [Paper](3-Mechanics/CLI/items/paper-xphb.md) (30 sheets), [Parchment](3-Mechanics/CLI/items/parchment-xphb.md) (9 sheets), 8 GP; or (B) 50 GP  

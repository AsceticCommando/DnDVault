...
![](file://adventure/ToA/051-301.webp#center)
...
![](file://adventure/ToA/052-302.webp#center)
...
| dice: d6 | Creatures |
|----------|-----------|
| 1–2 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [giant wasps](3-Mechanics/CLI/bestiary/beast/giant-wasp-xmm.md) |
| 3–4 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) |
| 5–6 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [swarms of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md) |
^creatures
...
Hiding in the ruin are `dice:1d4|noform|noparens|avg` (`1d4`) [vegepygmies](3-Mechanics/CLI/bestiary/plant/vegepygmy-mpmm.md) (see appendix D). They are not in a fighting mood and cower from interlopers. If attacked, they flee through cracks in the walls and attempt to hide in the surrounding marsh.
...
> [!gallery]
> ![Map 3.1: Omu](file://adventure/ToA/053-304.webp#gallery)
> ![Player Version](file://adventure/ToA/054-304a.webp#gallery)
...
![](file://adventure/ToA/055-303.webp#center)
...
> [!gallery]
> ![Map 3.2: Nine Shrines of Omu](file://adventure/ToA/056-305.webp#gallery)
> ![Player Version](file://adventure/ToA/057-305a.webp#gallery)
...
![](file://adventure/ToA/058-306.webp#center)
...
- As an action, he can make a melee weapon attack with his claws (`dice:1d20+3|noform|noparens|text(+3)` to hit), dealing `dice:1d4|noform|noparens|avg` (`1d4`) slashing damage on a hit.  
...
When a character pours a pint or more of water into the statue's right hand or one of its cupped feet, the liquid sizzles and transforms into `dice:1d3|noform|noparens|avg` (`1d3`) [steam mephits](3-Mechanics/CLI/bestiary/elemental/steam-mephit-xmm.md) that fight until destroyed. The statue can create up to six steam mephits in this fashion, after which no more mephits can be created until the next dawn. A steam mephit reduced to 0 hit points loses its form and disappears.
...
![](file://adventure/ToA/059-307.webp#center)
...
The grungs on the roof unleash arrows to ward off intruders. If the intruders fight back, more green-skinned [grungs](3-Mechanics/CLI/bestiary/humanoid/grung-mpmm.md) close in from nearby buildings, with `dice:1d4|noform|noparens|avg` (`1d4`) appearing at the end of each round until twenty have arrived.

...
![](file://adventure/ToA/004-0201.webp#center)
...
> [!gallery]
> ![Map 1.1: Port Nyanzaru](file://adventure/ToA/005-0202.webp#gallery)
> ![Player Version](file://adventure/ToA/006-0202a.webp#gallery)
...
![](file://adventure/ToA/007-0203.webp#center)
...
![](file://adventure/ToA/008-0204.webp#center)
...
![](file://adventure/ToA/009-0205.webp#center)
...
![](file://adventure/ToA/010-0206.webp#center)
...
![](file://adventure/ToA/011-0207.webp#center)
...
![](file://adventure/ToA/012-0208.webp#center)
...
![](file://adventure/ToA/013-0209.webp#center)
...
> [!gallery]
> ![Map 1.2: Merchant Prince's Villa](file://adventure/ToA/014-0210.webp#gallery)
> ![Player Version](file://adventure/ToA/015-0210a.webp#gallery)
...
This pleasant, breezy, tiled courtyard includes a splashing fountain and green plants. Visitors can refresh themselves in a washroom to the left of the entrance before meeting residents of the villa. The entry portico is always guarded by `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [gladiators](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) recruited from the merchant prince's extended family or hand-picked for their loyalty and fighting prowess. These guards are always on alert against tricksters and magicians trying to gain entrance to their master's home, so they have advantage on skill checks and saving throws against attempts to distract, bamboozle, or charm them.
...
Red Wizards are in Chult to find and steal the Soulmonger for Szass Tam. They've occupied the Heart of Ubtao and are using it as a base. Their leader is [Valindra Shadowmantle](3-Mechanics/CLI/bestiary/npc/valindra-shadowmantle-fraif.md). She remains at the Heart of Ubtao while her Thayan minions comb the ruins of Omu for clues to the Soulmonger's whereabouts. For more information on Valindra, see "Heart of Ubtao."
...
![](file://adventure/ToA/016-0211.webp#center)
...
| 1:5 | `dice:1d6\|noform\|noparens\|avg\|text(d6)` | 1 | Wager × 5 | Jungle Princess (deinonychus with [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) jockey) |
...
Losers are expected to pay up in a timely fashion. Those who don't are visited by a debt collector backed up by Chultan legbreakers (`dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) or [gladiators](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md), depending on the level and reputation of the bettor). Port Nyanzaru bookies never forget a debt; even a year away on an expedition into the jungle isn't long enough to erase an unpaid gambling loss.

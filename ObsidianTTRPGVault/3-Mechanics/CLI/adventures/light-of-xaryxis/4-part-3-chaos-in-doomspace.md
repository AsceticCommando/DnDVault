...
![](file://adventure/LoX/029-11-001.part-three-splash.webp#center)
...
![Major Warwyck Blastimoff](file://adventure/LoX/030-11-002.major-warwyck-blastimoff.webp#center)
...
Characters can persuade the giff to "buck up" with a successful DC 13 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. Those who motivate the commodore with a rousing speech or a healthy dose of tough love have advantage on this check. On a successful check, Krux regains his resolve and stands ready once more to tackle the Xaryxian Empire. On a failed check, the giff sulks in his cabin; when he emerges `dice:1d8|noform|noparens|avg` (`1d8`) hours later, he is pickled in equal measures of ale and shame.
...
- When the two giff last spoke, Warwyck was in Doomspace, on the moon of Aruun, entreating sentient plant creatures called aartuks to join the coalition. When he arrives in Doomspace, Krux plans to use the [Wildspace orrery](3-Mechanics/CLI/items/wildspace-orrery-aag.md) to locate Aruun.  
...
If the characters use the [Wildspace orrery](3-Mechanics/CLI/items/wildspace-orrery-aag.md) they acquired in chapter 5, read:
...
With the help of the [Wildspace orrery](3-Mechanics/CLI/items/wildspace-orrery-aag.md), the characters arrives at Aruun in ten days. As the ship approaches the moon, read:
...
> [!gallery]
> ![Doomspace](file://adventure/LoX/031-map-11.02-doomspace-system.webp#gallery)
> ![Player Version](file://adventure/LoX/032-map-11.02-doomspace-system-player.webp#gallery)
...
![Vocath's Base](file://adventure/LoX/033-11-004.vocaths-base.webp#center)
...
The following ships, each of which is equipped with a [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md), are docked at [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md)'s base when the characters arrive:

![Vocath](file://adventure/LoX/034-11-005.vocath.webp#center)

- **Dock 1.** The Skyrra, a [shrike ship](3-Mechanics/CLI/vehicles/shrike-ship-aag.md), has a crew of eleven [aarakocra](3-Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) and one [aarakocra spelljammer](3-Mechanics/CLI/bestiary/humanoid/aarakocra-spelljammer-lox.md) (use the [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) stat block, but give this aarakocra a flying speed of 50 feet).  
- **Dock 2.** The Remora, a [lamprey ship](3-Mechanics/CLI/vehicles/lamprey-ship-aag.md), has a crew of twelve [aartuk weedlings](3-Mechanics/CLI/bestiary/plant/aartuk-weedling-bam.md), three [aartuk starhorrors](3-Mechanics/CLI/bestiary/plant/aartuk-starhorror-bam.md), and one [aartuk elder](3-Mechanics/CLI/bestiary/plant/aartuk-elder-bam.md) (see "Boo's Astral Menagerie" for their stat blocks).  
- **Dock 4.** The Tarrasque, a [space galleon](3-Mechanics/CLI/vehicles/space-galleon-aag.md), has a crew of hadozees (four [hadozee explorers](3-Mechanics/CLI/bestiary/humanoid/hadozee-explorer-bam.md), fifteen [hadozee warriors](3-Mechanics/CLI/bestiary/humanoid/hadozee-warrior-bam.md), and one hadozee [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md)).  
- **Dock 5.** The Gadabout, a [wasp ship](3-Mechanics/CLI/vehicles/wasp-ship-aag.md) with a torn-off leg, has a crew of two [ssurran defilers](3-Mechanics/CLI/bestiary/monstrosity/ssurran-defiler-bam.md) and three [ssurran poisoners](3-Mechanics/CLI/bestiary/monstrosity/ssurran-poisoner-bam.md) (see "Boo's Astral Menagerie" for their stat blocks). Its cargo hold has been turned into a ssurran egg nursery.  
- **Dock 6.** The Vrusk, a [scorpion ship](3-Mechanics/CLI/vehicles/scorpion-ship-aag.md), has a crew of eight [thri-kreen hunters](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-hunter-bam.md), three [thri-kreen gladiators](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-gladiator-bam.md), and one [thri-kreen mystic](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-mystic-bam.md), who serves as the spelljammer (see "Boo's Astral Menagerie" for their stat blocks).  
- **Dock 8.** [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md)'s yacht, a [damselfly ship](3-Mechanics/CLI/vehicles/damselfly-ship-aag.md) called the Devil's Deal, is moored at the end of this dock. For more information about this ship and its crew, see area 6 later in this chapter.  
...
If [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md) is in danger, his bodyguards escort him to the [damselfly ship](3-Mechanics/CLI/vehicles/damselfly-ship-aag.md) berthed at area 6, which the mercane uses to escape from the threat.
...
> [!gallery]
> ![Vocath's Base](file://adventure/LoX/035-map-11.001-vocaths-base.webp#gallery)
> ![Player Version](file://adventure/LoX/036-map-11.01-vocaths-base-player.webp#gallery)
...
![](file://adventure/LoX/037-11-006.arena-battle-splash.webp#center)
...
![Prince Xeleth](file://adventure/LoX/038-11-007.prince-xeteth.webp#center)
...
The real Xeleth is safely aboard the *Xaryxia*, one of twelve [star moths](3-Mechanics/CLI/vehicles/star-moth-aag.md) surrounding [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md)'s base. The star moths form a ring around the base while staying 250 feet away from it. Their weapons open fire on any ship that tries to leave the base. (See [chapter 2](3-Mechanics/CLI/vehicles/star-moth-aag.md) of the "Astral Adventurer's Guide" for information about star moths and their weaponry.)
...
If Xeleth is unable to obtain Xedalli or her ring, his fleet opens fire on the ships docked at [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md)'s base. (These ships are detailed in chapter 8). After 5 rounds of bombardment, the following ships are destroyed before their crews can mount a defense: the [Skyrra](3-Mechanics/CLI/vehicles/shrike-ship-aag.md), the [Remora](3-Mechanics/CLI/vehicles/lamprey-ship-aag.md), the [Vrusk](3-Mechanics/CLI/vehicles/scorpion-ship-aag.md), the [Tarrasque](3-Mechanics/CLI/vehicles/space-galleon-aag.md), and the [Gadabout](3-Mechanics/CLI/vehicles/wasp-ship-aag.md).
...
> 
> Dakaer commands the *Tarrasque*, a [space galleon](3-Mechanics/CLI/vehicles/space-galleon-aag.md). He often sounds terse, even when he is speaking unemotionally. He and his crew dress plainly and wield weapons made from bone.
> 
...
> 
> Rika is the oldest crew member of the [shrike ship](3-Mechanics/CLI/vehicles/shrike-ship-aag.md) *Skyrra* and chief advisor to its captain, Kree'esh.
> 
...
> 
> - The [Wildspace orrery](3-Mechanics/CLI/items/wildspace-orrery-aag.md) acquired from [Topolah](3-Mechanics/CLI/bestiary/npc/topolah-lox.md)  
...
> 
> T'kitka serves as the spelljammer aboard the [scorpion ship](3-Mechanics/CLI/vehicles/scorpion-ship-aag.md) *Vrusk* and is keen to acquire more [spelljamming helms](3-Mechanics/CLI/items/spelljamming-helm-aag.md) and food supplies for her faction. She admits that the thri-kreen have taken to eating aartuks because of the scarcity of food in Doomspace (which hasn't endeared the thri-kreen to the aartuk faction).
> 
...
> 
> - A [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md)  
...
> 
> Vortshu, the captain of the [lamprey ship](3-Mechanics/CLI/vehicles/lamprey-ship-aag.md) *Remora*, is a warmonger who instigated a conflict with the thri-kreen. The thri-kreen have since acquired a taste for aartuk flesh. Characters can appeal to Vortshu's adversarial nature to win his support.
> 
...
> 
> The ssurran of Fyreen are acclimating to life in Wildspace. Their leader, Zoth'ess, commands the [wasp ship](3-Mechanics/CLI/vehicles/wasp-ship-aag.md) *Gadabout*.
> 
...
If the characters convince at least four factions to join the coalition, [Vocath](3-Mechanics/CLI/bestiary/npc/vocath-lox.md) decides their cause is worth supporting and telepathically reaches out to some of his mercane allies, who send additional ships. These ships come with their own [spelljamming helms](3-Mechanics/CLI/items/spelljamming-helm-aag.md) and crews. The mercane ships have crews pulled from different factions. The mercanes themselves stay out of the fight.
...
| Faction | Ships |
|---------|-------|
| Aarakocra | 5 [shrike ships](3-Mechanics/CLI/vehicles/shrike-ship-aag.md), including the Skyrra |
| Aartuks | 5 [lamprey ships](3-Mechanics/CLI/vehicles/lamprey-ship-aag.md), including the Remora |
| Hadozees | 3 [space galleons](3-Mechanics/CLI/vehicles/space-galleon-aag.md), including the Tarrasque |
| Mercanes | 2 [hammerhead ships](3-Mechanics/CLI/vehicles/hammerhead-ship-aag.md) (one crewed by humans, the other by thri-kreen) and 5 [squid ships](3-Mechanics/CLI/vehicles/squid-ship-aag.md) (each one crewed by members of a different faction) |
| Ssurran | 6 [wasp ships](3-Mechanics/CLI/vehicles/wasp-ship-aag.md), including the Gadabout |
| Thri-kreen | 4 [scorpion ships](3-Mechanics/CLI/vehicles/scorpion-ship-aag.md), including the Vrusk |
^coalition-fleet

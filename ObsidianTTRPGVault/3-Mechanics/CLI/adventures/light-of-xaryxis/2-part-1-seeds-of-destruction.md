...
![](file://adventure/LoX/004-09-001.part-one-splash.webp#center)
...
![Astral Blight](file://adventure/LoX/005-637961800673014558.webp#center)
...
Captain [Elaina Sartell](3-Mechanics/CLI/bestiary/npc/elaina-sartell-lox.md), a chaotic good [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md), commands the [galleon](3-Mechanics/CLI/vehicles/space-galleon-aag.md) *Moondancer*. She is unflappable—an island of calm in a sea of chaos.
...
![Captain Elaina Sartell](file://adventure/LoX/006-09-002.captain-elaina-sartell.webp#center)
...
Before running this chapter, familiarize yourself with "chapter 2" of the "Astral Adventurer's Guide". Keep the deck plans for the [space galleon](3-Mechanics/CLI/vehicles/space-galleon-aag.md) and the [star moth](3-Mechanics/CLI/vehicles/star-moth-aag.md) handy, because they will come into play.
...
![Flapjack](file://adventure/LoX/007-09-003.flapjack.webp#center)
...
> 
> 1/day each: [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [unseen servant](3-Mechanics/CLI/spells/unseen-servant-xphb.md)
^022

#### Features of the Moondancer

> [!gallery]
> ![Moondancer Deck Plans](file://adventure/LoX/008-map-2.11-space-galleon.webp#gallery)
> ![Player Version](file://adventure/LoX/009-map-2.11-space-galleon-player.webp#gallery)

Use the [space galleon](3-Mechanics/CLI/vehicles/space-galleon-aag.md) deck plans in the "Astral Adventurer's Guide" to represent the *Moondancer*. Noteworthy features are described below:

##### Area 3:

Captain's Quarters. Among Captain Sartell's possessions is a locked treasure chest, which she keeps in her cabin. Captain Sartell carries the only key to the chest. As an action, a character can pick the lock by making a successful DC 15 Dexterity check using thieves' tools, or break open the chest with a successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. The chest contains three bottles of fine wine (10 gp each), six gold bracelets (25 gp each), nine pearls (100 gp each) in a velvet pouch, and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [air bubble](3-Mechanics/CLI/spells/air-bubble-aag.md) (see the "Astral Adventurer's Guide").

##### Area 5:

Spelljamming Helm. The ship's [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md) looks like a floating, ornate silver chair with a purple seat cushion and no legs. Glowing blue crystals underneath the seat project a magic circle onto the floor, stabilizing the chair. [Flapjack the flumph](3-Mechanics/CLI/bestiary/npc/flapjack-lox.md) sits in the chair while piloting the ship.
...
The astral elf vessel is a [star moth](3-Mechanics/CLI/vehicles/star-moth-aag.md) called the *Dark Star*. It is crewed by three [astral elf warriors](3-Mechanics/CLI/bestiary/humanoid/astral-elf-warrior-bam.md)—Captain Azmadian (lawful evil), Lieutenant Jalin (lawful evil), and Lieutenant Zanth (lawful neutral)—as well as a neutral evil [astral elf star priest](3-Mechanics/CLI/bestiary/humanoid/astral-elf-star-priest-bam.md) named Altura (the ship's spelljammer), and nine [plasmoid explorers](3-Mechanics/CLI/bestiary/ooze/plasmoid-explorer-bam.md) of various alignments.

![The Dark Star](file://adventure/LoX/010-09-004.the-dark-star.webp#center)

#### Ship-to-Ship Battle

See [chapter 2](3-Mechanics/CLI/rules/variant-rules/ship-to-ship-combat-aag.md) of the "Astral Adventurer's Guide" for rules on ship-to-ship engagements.

Captain Sartell grimly informs the characters that the [star moth](3-Mechanics/CLI/vehicles/star-moth-aag.md) is the faster ship and that the *Moondancer* has no hope of outrunning it. She estimates the characters have about a minute to prepare before the star moth gets close enough to use its mangonel (at long range). Once that happens, Sartell orders her ship to turn about and close with the astral elves as quickly as possible to minimize the *Dark Star*'s opportunity to fire on the *Moondancer*. It then takes another minute for the two ships to come within boarding distance.
...
The *Dark Star* is a fine treasure; however, surviving plasmoid crew members recommend abandoning it, knowing that the astral elves will rain vengeance upon anyone in control of one of their ships. Its [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md) is a more easily usable prize. It looks like a legless, high-backed chair made of wood, with crystal wings and armrests. Luminous crystals under the seat project a golden hexagon onto the floor; this hexagon stabilizes the helm, allowing it to swivel while holding it in place.
...
![Wreck of the Lucent Edict](file://adventure/LoX/011-09-005.wreck-lucent-edict.webp#center)

### The Lucent Edict

The vessel is the *Lucent Edict*, a [nautiloid](3-Mechanics/CLI/vehicles/nautiloid-aag.md). After the characters sight the craft, read:
...
Use the nautiloid deck plans in [chapter 2](3-Mechanics/CLI/vehicles/nautiloid-aag.md) of the "Astral Adventurer's Guide" to represent the *Lucent Edict*. The ship shows signs of battle damage and has 220 hit points remaining.

The nautiloid is also missing its [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md) and its ballistae, and its mangonel is broken.

> [!gallery]
> ![Nautiloid Deck Plans](file://adventure/LoX/012-map-2.07-nautiloid.webp#gallery)
> ![Player Version](file://adventure/LoX/013-map-2.07-nautiloid-player.webp#gallery)
...
The githyanki who attacked the nautiloid disabled the craft by removing its [spelljamming helm](3-Mechanics/CLI/items/spelljamming-helm-aag.md). They took the head of the dead mind flayer as a trophy.
...
![](file://adventure/LoX/014-09-006.nehthalggu-splash.webp#center)

...
![](file://adventure/LoX/039-12-001.part-four-splash.webp#center)
...
> [!gallery]
> ![Xaryxispace](file://adventure/LoX/040-map-12.01-xaryxis-space.webp#gallery)
> ![Player Version](file://adventure/LoX/041-map-12.01-xaryxis-space-player.webp#gallery)
...
Another rocky world, Rivus escaped Vaerduran's fate because of its rich platinum deposits, which the astral elves mine. Although it appears desolate on the surface, Rivus bustles with activity below ground, where [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md), [purple worms](3-Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm.md), and other burrowing creatures make their lairs.
...
> [!gallery]
> ![Imperial Citadel](file://adventure/LoX/042-map-12.02-imperial-citadel.webp#gallery)
> ![Player Version](file://adventure/LoX/043-map-12.02-imperial-citadel-player.webp#gallery)
...
A chamber beneath the Great Orrery contains a ring of twelve [spelljamming helms](3-Mechanics/CLI/items/spelljamming-helm-aag.md) joined together by crystal filaments. Theraxana and her fellow mages use these [spelljamming helms](3-Mechanics/CLI/items/spelljamming-helm-aag.md) to move the citadel across Wildspace and the Astral Sea, in accordance with the wishes of the emperor. All twelve helms are required to propel the citadel, which has a flying speed of 50 feet (5½ mph).
...
> [!gallery]
> ![Temple of Light](file://adventure/LoX/044-map-12.03-cathedral-of-light.webp#gallery)
> ![Player Version](file://adventure/LoX/045-map-12.03-cathedral-of-light-player.webp#gallery)
...
- **Star Beam.** A creature that ends its turn in the beam of light is magically teleported to the radiant core of Xaryxis, along with anything it is wearing or carrying. (The [zodar](3-Mechanics/CLI/bestiary/aberration/zodar-bam.md) is immune to this effect.) A creature that enters the star or starts its turn there takes `dice:24d10|noform|noparens|avg|text(132)` (`24d10`) radiant damage.  
...
![Xaryxis explodes!](file://adventure/LoX/046-12-003.xaryxis-explodes.webp#center)
...
![The destruction of Xaryxis causes the crystal vines to crumble. The heroes have saved their world!](file://adventure/LoX/047-12-004.crystal-vines-crumble.webp#center)

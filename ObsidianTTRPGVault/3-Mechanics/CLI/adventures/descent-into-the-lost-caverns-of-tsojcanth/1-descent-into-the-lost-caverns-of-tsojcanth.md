...
![](file://adventure/DitLCoT/000-00-001.iggwilv-cover.webp#center)
...
![](file://adventure/DitLCoT/001-00-002.original-cover.webp#center)
...
> [!gallery]
> ![Map 1.1: Lesser Caverns](file://adventure/DitLCoT/002-map-0.01-lesser-caverns.webp#gallery)
> ![Player Version](file://adventure/DitLCoT/003-map-0.01-lesser-caverns-player.webp#gallery)
...
![A ghastly visage outside the entry caverns portends the dangers within](file://adventure/DitLCoT/004-00-003.ghastly-visage.webp#center)
...
The figure is a [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) created by Iggwilv to destroy intruders. The golem attacks any creature that enters the chamber. The golem fights to the death and pursues trespassers relentlessly, even chasing them out of the caverns.
...
![Four pechs diligently dig a staired tunnel up into the mountain, decorating its walls with carvings](file://adventure/DitLCoT/005-00-004.diligent-pechs.webp#center)
...
![Three hungry trolls pass the time in their foul-smelling cave](file://adventure/DitLCoT/006-00-005.hungry-trolls-splash.webp#center)
...
The ceiling of this corridor is covered in thousands of roosting bats. Bright light or any noise louder than a whisper agitates the bats and sends them into a panic, causing a number of [swarms of bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) equal to the number of characters in this area descend from the ceiling and attack the source of the disturbance. The swarms extinguish any nonmagical light sources they come within 5 feet of with a flurry of buffeting wings.
...
The vessel is a [Folding Boat](3-Mechanics/CLI/items/folding-boat-xdmg.md) created to traverse the lake and the rivers that branch from it. In addition to its usual properties, the boat has an extra command word that functions only while the boat is within the Lost Caverns. A character who knows this additional command word ("Shrimpkin")—discovered by casting the [Identify](3-Mechanics/CLI/spells/identify-xphb.md) spell on the boat or by examining clues in the boat's intricate designs and succeeding on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check—can command the boat to row itself in a particular direction at a speed of 30 feet or to hold its position in defiance of the water's swiftest currents.
...
Four [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) lurk near the lakebed, 90 feet below the surface. They're content to creep along the lightless depths and prey on cave fish unless something else catches their attention. Bright light draws the chuuls to the water's edge, as does any magic in the lake or near its surface, such as the boat from area L12. If drawn to the surface, the chuuls attack.
...
![Adventurers clash with the behir Lludd in his lair within the Lost Caverns](file://adventure/DitLCoT/007-00-006.behir-lludd-splash.webp#center)

The ceiling of this colorful cavern rises to a height of 50 feet. Careful examination of the floor reveals many cracked bone fragments among the stalagmites. Once the lair of a chimera, this cavern is now home to Lludd, a clever and long-lived [behir](3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) who ousted the smaller, weaker creature that preceded him. Lludd speaks Common and Giant in addition to Draconic. The behir lurks on a rufous ledge near the entrance to the chamber, waiting for morsels worthy of his hunger.
...
|  | Cast [Control Water](3-Mechanics/CLI/spells/control-water-xphb.md), [Water Breathing](3-Mechanics/CLI/spells/water-breathing-xphb.md), or [Water Walk](3-Mechanics/CLI/spells/water-walk-xphb.md) | +1 |
| L14: Basilisk Den | Defeated the basilisks | +1 |
|  | One or more characters gained the [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) condition | −1 |
...
> [!gallery]
> ![Cathartic](file://adventure/DitLCoT/013-00-012.cathartic.webp#gallery)
> ![Dunil](file://adventure/DitLCoT/014-00-013.dunil.webp#gallery)
> ![Ethelrede](file://adventure/DitLCoT/015-00-014.ethelrede.webp#gallery)
> ![Flemin](file://adventure/DitLCoT/016-00-015.flemin.webp#gallery)
> ![Rustle Berrydust](file://adventure/DitLCoT/017-00-016.rustle-berrydust.webp#gallery)
> ![Weslocke](file://adventure/DitLCoT/018-00-017.weslocke.webp#gallery)

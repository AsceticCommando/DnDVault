...
![The threshold of the Betrayers' Rise is guarded by soldiers of the Aurora Watch to keep intruders out and demons in](file://adventure/CRCotN/025-03-001.intro-splash.webp#center)
...
This chapter begins as two Aurora Watch [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) guide the characters from the gate of Bazzoxan toward the Gatehold Barracks. Read or paraphrase the following as the characters enter the town:
...
![A gibbering mouther threatens two Aurora Watch soldiers](file://adventure/CRCotN/026-03-002.gibbering-mouther-threat.webp#center)

Five [gibbering mouthers](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) have sneaked into Bazzoxan and are intent on consuming anyone in their path. Opposing them are members of the Aurora Watch led by Taskhand [Verin Thelyss](3-Mechanics/CLI/bestiary/npc/verin-thelyss-crcotn.md) (see the accompanying stat block).
...
![Verin Thelyss](file://adventure/CRCotN/027-637828636927085942.webp#center)

### Fight!

If the characters choose to help the Aurora Watch, everyone rolls initiative. [Verin](3-Mechanics/CLI/bestiary/npc/verin-thelyss-crcotn.md) and two orc [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) of the Aurora Watch stay with the party, while the rest of the soldiers leave to secure other parts of the city.
...
![Bazzoxan has an eerie beauty that is lost on most visitors and residents](file://adventure/CRCotN/028-03-003.bazzoxan-scene.webp#center)
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | A chaotic neutral, orc [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) tends a garden of root vegetables in one of the ruined buildings, aggressively pulling up weeds. |
| 2 | A weary drow mother (neutral good [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) sits in the marketplace, instructing her children on what to do if she dies. |
| 3 | A tired drow merchant (neutral [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) attempts to sell what's left of his inventory. |
| 4 | An Aurora Watch soldier (lawful good [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md)) breaks up a fight between two sobbing citizens (lawful good [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). |
| 5 | Ten Aurora Watch [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (lawful good drow, humans, and orcs) jog in formation, keeping tempo by singing about the ways they'll die. |
| 6 | A neutral good [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) fixes the wheelchair of a lawful neutral, drow [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) who has lost a leg. |
| 7 | A teenage, lawful neutral, dwarf [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) sits in a dark corner, weeping as she clutches a helm to her chest. |
| 8 | A red-faced human (chaotic neutral [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) rambles drunkenly about how the demons are coming to kill them all. |
| 9 | Two members of the Aurora Watch, a lawful neutral [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) and a chaotic neutral [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md), bicker over which of them should take on a dangerous assignment. |
| 10 | An old tiefling (lawful good [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) sobs as he carries a small casket toward the crematorium (area B2). |
^bazzoxan-scenes
...
> [!gallery]
> ![Bazzoxan](file://adventure/CRCotN/029-map-3.1-Bazzoxan.webp#gallery)
> ![Player Version](file://adventure/CRCotN/030-map-3.1-Bazzoxan-player.webp#gallery)
...
The two men are Reynard Allerton, a chaotic good [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), and his bigger, older brother, Sebastian Allerton, a neutral good [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md). Their crematorium has two furnaces, each of which can hold up to four Medium bodies or one Large body at a time. The brothers are responsible for the proper disposal of corpses. Reynard seems to be the more gregarious of the siblings, although if the characters can coax Sebastian out of his silence with a joke or a kind remark, the older brother is also revealed to be a good-natured chatterbox.
...
Lacking experience with dead bodies, Prolix turns to the characters for assistance. A character who wants to extract the contents of the vrock's stomach must first cleave through the vrock's hide. To do so, the character must succeed on a DC 15 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check. A failed check triggers an eruption of spores from the vrock's corpse that fill a 10-foot-radius sphere centered on the corpse. All creatures in that area must succeed on a DC 14 Constitution saving throw or become [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned). A creature [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) in this way takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) poison damage at the start of each of its turns. It can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

##### Treasure

The vrock's gullet contains a pair of gold-trimmed [eyes of the eagle](3-Mechanics/CLI/items/eyes-of-the-eagle-xdmg.md), three gaudy rings worth 2 gp each, and a cube-shaped puzzle box made of onyx and measuring 3 inches on a side. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic around the box, which is locked. Prolix grabs it before anyone else can do so, leaving the other items for the characters. As soon as the puzzle box is removed from the dead vrock's gullet, the enchantment on the vrock fades, and it begins to dissolve into a puddle of reeking ichor.

Anyone who tinkers with the puzzle box's locking mechanism for 1 minute can make a DC 20 Intelligence check, opening the box on a success. The box contains a folded-up [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [bestow curse](3-Mechanics/CLI/spells/bestow-curse-xphb.md).

![Aloysia Telfan and Prolix Yusaf](file://adventure/CRCotN/031-03-004.aloysia-prolix.webp#center)
...
A neutral good, firbolg [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) named [Foghome](3-Mechanics/CLI/bestiary/npc/foghome-crcotn.md) moves through the temple at all hours of the day. For more information on firbolgs, see the accompanying "Firbolgs of Exandria" sidebar.

![Foghome the Firbolg](file://adventure/CRCotN/032-03-005.foghome-the-firbolg.webp#center)
...
The Ready Room is run by Delez and Prima Demona, a brother-and-sister team who are both lawful neutral [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md). Delez runs the bar and the kitchen and handles most interactions with customers, while Prima manages the finances and inventory.
...
The escaped creatures are two [gloomstalkers](3-Mechanics/CLI/bestiary/monstrosity/gloomstalker-egw.md) (see appendix A). The soldiers stationed outside can assist the characters in battling the gloomstalkers, or you can have them rush inside to help three gravely injured Aurora Watch soldiers (lawful good, orc [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md)) in area R1.
...
- **Black Stone..** Unless otherwise noted, all surfaces in the Betrayers' Rise are made of smooth, shiny black stone. The power that pervades the place prevents the architecture from being affected by magic such as [stone shape](3-Mechanics/CLI/spells/stone-shape-xphb.md).  
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | The characters enter a room lined with flickering candles, only to discover that their shadows have detached from them and transformed into [shadow demons](3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) (one per character). |
| 2 | Four [ochre jellies](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) burble along the walls of a hallway, looking for prey to devour. |
| 3 | A [yochlol](3-Mechanics/CLI/bestiary/fiend/yochlol-xmm.md) in giant spider form skitters around in an antechamber draped in spider webs. |
| 4 | A [yochlol](3-Mechanics/CLI/bestiary/fiend/yochlol-xmm.md) in drow form wears the insectile armor of the Aurora Watch. Claiming to be a lost Aurora Watch soldier, the demon tries to lure the characters into greater danger. |
| 5 | Two [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) [barlguras](3-Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) ambush the characters. |
| 6 | A passageway opens into what was once a coliseum and now contains three enraged [nightmares](3-Mechanics/CLI/bestiary/fiend/nightmare-xmm.md). |
| 7 | A gurgling, acidic river cuts through a cavern where three [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) stealthily await. |
| 8 | Three [chasmes](3-Mechanics/CLI/bestiary/fiend/chasme-xmm.md) emerge from their hive, which has overtaken what was once a chandelier. |
| 9 | A [glabrezu](3-Mechanics/CLI/bestiary/fiend/glabrezu-xmm.md) tempts all who come into its chamber with promises of riches. Anyone it can't bribe into serving it is attacked. |
| 10 | Orange light emanates from the depths of a chasm, where a [balor](3-Mechanics/CLI/bestiary/fiend/balor-xmm.md) sleeps in molten lava. If it is attacked, the demon wakes. The characters, who have no chance of defeating this powerful demon in combat, must flee or die. |
^betrayers-rise-encounters

### Retreat and Reinforcements

To survive the trials of the Betrayers' Rise, the characters might need to retreat to Bazzoxan to regroup and rest. If the characters retreat from the Betrayers' Rise, new demons emerge from the Abyssal portals in the depths of the temple after 8 hours to populate empty areas. Roll a `dice:d6|noform|noparens|avg` (`d6`) for each area in the Betrayers' Rise that the characters explored on their previous trip. On a roll of 6, the area has become home to one or more new creatures, determined by rolling another `dice:d6|noform|noparens|avg` (`d6`) and consulting the Betrayers' Rise Reinforcements table.
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [quasits](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) nesting in the corpses of the area's previous inhabitants or crawling on the walls in centipede form |
| 2 | 1 [chasme](3-Mechanics/CLI/bestiary/fiend/chasme-xmm.md) clinging to the ceiling |
| 3 | 1 [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) [barlgura](3-Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) standing guard |
| 4 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [shadow demons](3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) lurking in the darkness |
| 5 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [manes](3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) looking for a more powerful demon to lead them |
...
> [!gallery]
> ![Betrayers' Rise](file://adventure/CRCotN/033-map-3.2-Betrayers-Rise.webp#gallery)
> ![Player Version](file://adventure/CRCotN/034-map-3.2-Betrayers-Rise-player.webp#gallery)
...
The shaft leading down to the chasm is too sheer to climb without the use of magic or climbing gear. Any character who falls into the chasm takes `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage from the plunge.
...
The wall that lies between area R4 and area R3 is a featureless surface when viewed from this side, offering no way of returning to area R3. This one-way passage can't be navigated, except with a [passwall](3-Mechanics/CLI/spells/passwall-xphb.md) spell or similar magic.
...
Opening the door to this room releases three hostile [flameskulls](3-Mechanics/CLI/bestiary/undead/flameskull-xmm.md)—the remains of torturers who served the Betrayer Gods long ago.

![Torturers who served the Betrayer Gods linger on as flameskulls](file://adventure/CRCotN/035-03-006.lingering-flameskulls.webp#center)
...
The corpses are the remains of an Aurora Watch expedition that was trapped in the Betrayers' Rise. A character who searches the bodies finds an onyx-hilted longsword that has become a [sword of vengeance](3-Mechanics/CLI/items/sword-of-vengeance-xdmg.md) haunted by the spirit of its former wielder.
...
Each [dancing flame](3-Mechanics/CLI/bestiary/fiend/dancing-flame-crcotn.md) uses the [succubus](3-Mechanics/CLI/bestiary/fiend/succubus-xmm.md)/[incubus](3-Mechanics/CLI/bestiary/fiend/incubus-xmm.md) stat block, with these changes:

![This stained-glass mosaic is the key to escaping the Basilica of Revelry](file://adventure/CRCotN/036-03-007.stain-glass-mosaic.webp#center)
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic emanating from the iron doors in the statue's chest. Similar auras are apparent in the palms of the stone arms that are within the spell's range.
...
- While the creature has fewer than half its hit points, its successful weapon attacks deal an extra `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) psychic damage.  

The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. Otherwise, the curse of Torog remains in effect on the creature until ended by a [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic, or until the creature enters area R16.

![A giant wailing statue guards the path to the Prayer Site of Avandra, but learning its secret is no simple matter](file://adventure/CRCotN/037-03-008.giant-wailing-statue.webp#center)
...
When one or more characters enter the hallway to the south, they hear a loud grinding noise. This is the sound of a stone slab rising from the floor to block the entrance to area R14. This slab has no handle or keyhole. Defeating the fiendish orcs in area R14 or using a [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic causes the slab to sink back into the floor; it can't be moved or breached otherwise.
...
When the characters enter the labyrinth, they're faced with a choice of three paths: one lit by violet [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells, one by red [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells, and one shrouded in impenetrable magical darkness. Following any of the paths leads them to another three-way fork with the same choices available, and then another. The way to get through the labyrinth most quickly is always to take the fork shrouded in darkness.
...
The [creatures](3-Mechanics/CLI/bestiary/fiend/fiendish-orc-crcotn.md) are two [orc war chiefs](3-Mechanics/CLI/bestiary/humanoid/tough-boss-xmm.md) that were once valiant soldiers of the Aurora Watch. Both have been corrupted by demonic magic and have the following changes to their statistics:
...
- Stone slabs rise from the floor to block the north and south exits (unless both slabs were already closed). A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic can force a slab to sink back into the floor.  
...
- A creature that ends its turn in the boiling blood takes `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) fire damage.  
...
A short hallway connects area R14 with the chasm south of it. The archway at the south end of the corridor is carved to resemble the open-mouthed, fanged visage of Gruumsh the Ruiner when seen from inside the chasm. Fire fills one of the visage's eye sockets, courtesy of a [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spell.
...
When a creature passes through the gaping mouth of the stone-carved face, a planar rift opens in the floor on the east side of the chasm (see "Abyssal Rift" below), and a hostile [vrock](3-Mechanics/CLI/bestiary/fiend/vrock-xmm.md) flies out of it. The vrock begins searching the chasm for food, attacking the characters on sight.
...
A character who inspects the remains of the two Cobalt Soul explorers finds a [cloak of protection](3-Mechanics/CLI/items/cloak-of-protection-xdmg.md) and a [cracked driftglobe](3-Mechanics/CLI/items/cracked-driftglobe-cm.md). In its damaged state, the [driftglobe](3-Mechanics/CLI/items/cracked-driftglobe-cm.md) can be used only to cast the [light](3-Mechanics/CLI/spells/light-xphb.md) spell.
...
If the characters retain possession of the jewel, Aloysia loses her temper and begins ranting on her next turn. Midway through her rant, she pulls a scroll from her belt. The scroll is a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [earthquake](3-Mechanics/CLI/spells/earthquake-xphb.md), which she casts (choosing the Structures option) as an action on her turn. Aloysia then flees up the passageway, accidentally dropping two [teleportation tablets](3-Mechanics/CLI/items/teleportation-tablet-crcotn.md) while she rummages through her satchel. A huge chunk of stone falls from the ceiling behind her, separating her from the characters and blocking their only exit. On her next turn, she uses her third and final [teleportation tablet](3-Mechanics/CLI/items/teleportation-tablet-crcotn.md) to escape to Ank'Harel.

Each creature in the prayer site when Aloysia casts [earthquake](3-Mechanics/CLI/spells/earthquake-xphb.md) must make a DC 13 Dexterity saving throw, taking `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) bludgeoning damage from falling rubble on a failed save, or half as much damage on a successful one.

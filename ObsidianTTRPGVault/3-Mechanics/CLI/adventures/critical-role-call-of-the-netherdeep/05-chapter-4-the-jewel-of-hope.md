...
![The spectacular desert metropolis of Ank'Harel is the most precious jewel on the continent of Marquet](file://adventure/CRCotN/039-04-001.intro-splash.webp#center)
...
- **Friendly Rivals..** If the rivals are predominantly friendly toward the characters, they cordially part ways after the "Arrival in Ank'Harel" scenario. The rivals find an inn that they make their semi-permanent residence, and a few days later Galsariad shares the address with the characters using a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [sending](3-Mechanics/CLI/spells/sending-xphb.md).  
...
Before leaving their company, Question tells the characters that they'll be called upon in a few days' time and gives them one stone from a pair of [sending stones](3-Mechanics/CLI/items/sending-stones-xdmg.md) that they can use when that time comes. She says that her superior, Iwo Zalarre, will probably be the one to contact them through the stone. She also entrusts them with a map of Ank'Harel (use the poster map), so they can become familiar with the city during their stay. She then catches a carriage to the Guided District. This branch of the adventure continues in "Knowledge Is Power," the story track for the Library of the Cobalt Soul.
...
> [!gallery]
> ![The Jewel of Hope, Ank'Harel](file://adventure/CRCotN/040-map-4.1-Ank_Harel.webp#gallery)
> ![Player Version](file://adventure/CRCotN/041-map-4.1-Ank_Harel-player.webp#gallery)
...
![High Curator Jamil A'alithiya of the Library of the Cobalt Soul](file://adventure/CRCotN/043-04-003.high-curator-jamil.webp#center)
...
- **Leader..** Ironhand Sem, a lawful good [minotaur](3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md), commands the Hands of Ord and oversees all military operations in Ank'Harel.  
...
- **Leader..** Once a mercenary in his own right, Quartermaster Croog Lynn, a chaotic neutral, goliath [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md), has now taken to running the guild in his later years (see the accompanying "Goliaths of Exandria" sidebar).  
- **Allies..** None.  
- **Opponents..** None.  
...
- **Leader..** Watcher Trast, a neutral, elf [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) and a former cleric of Ioun, founded the Sentinels of Memory and maintains command over the faction to this day.  
...
![Alluvium District](file://adventure/CRCotN/044-04-005.alluvium-district.webp#center)
...
![](file://adventure/CRCotN/045-04-004.goliaths-of-exandria.webp#center)
...
The quarry is run by a gruff, middle-aged miner named Zala Keencutter, a neutral, tiefling [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md). Though he puts up an abrasive facade, Zala has a shy and empathetic soul, and he wants dearly to work up the courage to read his prose writings at the Opalite Forum some evening.
...
The shop is run by Bas and Kovra Lyrean, twin sisters who are neutral evil, half-elf [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md). Originally alchemists by trade, they use their knowledge to brew magic potions deemed by the Hands of Ord to be too dangerous for public consumption.
...
![Guided District](file://adventure/CRCotN/046-04-006.guided-district.webp#center)
...
The Sunfire Forge is under the control of Rohaya Tak, a neutral good, half-elf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), who inherited the business from her mother two decades ago. An innovative metalworker, Rohaya combines her smithcraft with shrewd business intuition. In addition to crafting blades and tools, Rohaya uses the forge to produce cannons for use on sailing ships and skyships, modeled after the bronze cannons of her family's homeland in southern Marquet.
...
An hour's visit at the most exclusive spa costs 5 gp. Characters who spend 8 hours eating, luxuriating, and relaxing in the spa awaken the next morning with `dice:1d10|noform|noparens|avg` (`1d10`) "temporary hit points" that last for the next 24 hours, in addition to the usual benefits of finishing a long rest.
...
![Sigil District](file://adventure/CRCotN/047-04-007.sigil-district.webp#center)
...
> [!gallery]
> ![Streets of the Sigil District](file://adventure/CRCotN/048-map-4.2-Streets-of-the-Sigil-District.webp#gallery)
> ![Player Version](file://adventure/CRCotN/049-map-4.2-Streets-of-the-Sigil-District-player.webp#gallery)
...
A contingent of five lawful neutral Scarbearer [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) patrols the rim of the maw, on the lookout for unauthorized visitors. They are led by a loyal, lawful good, orc [scholarly excavator](3-Mechanics/CLI/bestiary/humanoid/scholarly-excavator-crcotn.md) (see appendix A) named Hakzorne. He permits only people who display Allegiance badges to enter the maw; Hakzorne gives only one warning before ordering the mercenaries to attack.
...
The Omnival Library is managed by Bookkeeper Khime, a neutral good, orc [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md). He's convinced that shadowy forces are constantly trying to undermine Ank'Harel, and this penchant for conspiracy theories makes him incredibly observant. He's an excellent source of information about happenings in the city, despite his wild conclusions.
...
![Suncut Bazaar](file://adventure/CRCotN/050-04-009.suncut-bazaar.webp#center)
...
- **T2 Battlements..** The walls of the Suncut Bazaar are made of sandstone and patrolled day and night by Hands of Ord [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).  
...
> [!gallery]
> ![Streets of the Suncut Bazaar](file://adventure/CRCotN/051-map-4.3-Streets-of-the-Suncut-Bazaar.webp#gallery)
> ![Player Version](file://adventure/CRCotN/052-map-4.3-Streets-of-the-Suncut-Bazaar-player.webp#gallery)
...
The Bone Garden is run by Rerosha, a chaotic good, human [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) who's a nonverbal young woman with a brazen attitude toward life. She uses facial expressions, gestures, and a sassy gray parrot named Akil to communicate.
...
The casino is owned and run by Adima Shemsilver, a chaotic neutral, halfling [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) who walks with the confidence of someone twice his height. Adima secretly uses half of the casino's earnings to fund the Veil, as his family has done for generations.

Three of the most popular games at Luck's Run are described below.

##### Avandra's Favor

This dice game has a 25 gp minimum bet. Each participant rolls `dice:2d6|noform|noparens|avg` (`2d6`) and wins back twice their bet on a roll of 7 or 12. A participant who doesn't win can roll another `dice:d6|noform|noparens|avg` (`d6`) and add it to their total by wagering an additional 25 gp. A participant can do this as many times as they want, until they "bust" by accumulating a total higher than 12.
...
To simulate the play of this game, have each participant roll dice in secret. At the first draw, all participants roll a `dice:d8|noform|noparens|avg` (`d8`). The second draw is a `dice:d6|noform|noparens|avg` (`d6`) roll, and the third is a `dice:d4|noform|noparens|avg` (`d4`) roll. Then, all reveal their dice, and whoever has the highest total wins.
...
To simulate the play of this game, roll `dice:3d4|noform|noparens|avg` (`3d4`) for each lizard. The winning lizard is the one with the highest total (ties are possible).
...
The "soothsayer" is a charlatan named Amkezne, a chaotic neutral, tiefling [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md). She is a Crystal Chateau dropout who makes a living defrauding wide-eyed tourists with her mystical displays and fake enchanted trinkets. Customers who see through her act but treat her with respect can purchase any spell component worth 1,000 gp or less from Amkezne. She also has a collection of fine jewelry for sale, including five gold bracelets (25 gp each), three gem-studded gold rings (250 gp each), and two jewel-encrusted necklaces and tiaras (750 gp each). An [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) watches over this collection and attacks anyone who tries to steal from it.

![Ruidium Elephant in Figurine Form](file://adventure/CRCotN/053-04-008.ruidium-elephant.webp#center)

## Faction Story Tracks

![A figurine of wondrous power corrupted by ruidium transforms into a rampaging crystalline elephant](file://adventure/CRCotN/054-04-010.corrupted-ruidium-figurine.webp#center)
...
As rumors about Cael Morrow continue to spread, the Allegiance of Allsight's expeditions have been targeted by other factions and would-be thieves. The Allegiance has recently located an item that was stolen during an encounter with one such thief: a [figurine of wondrous power (marble elephant)](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md), now lying among the oddities and trinkets for sale at the Bone Garden in the Suncut Bazaar. The proprietor of the shop, Rerosha, has agreed to hand over the item to the Allegiance of Allsight. The faction tasks the characters with retrieving the figurine from Rerosha and delivering it safely to the Crystal Chateau. See the "Suncut Bazaar" section of the "Ank'Harel Gazetteer" for information about the Bone Garden.
...
The figurine transforms even if the space where the elephant appears is occupied by other creatures. A creature in the space where the elephant appears must make a successful DC 13 Dexterity saving throw or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) force damage and be pushed into the nearest unoccupied space.
...
If the characters slay or redeem the Apotheon (see chapter 7), the figurine is rid of its ruidium corruption and functions like a normal [figurine of wondrous power (marble elephant)](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md).
...
When they see that the characters survived the surge, two [invisible stalkers](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) move in for the kill. The [invisible stalkers](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) were summoned by Professor Lymmle Wist and infiltrated the Life Dome a short time ago without Carliale's knowledge, slipping through the entrance as the gnome arrived for work. The [invisible stalkers](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) focus their attacks on the characters, ignoring Carliale.
...
Characters who encountered the [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) at Mystic Pursuits (described earlier in the chapter) might assume that Amkezne, the owner of that shop, is behind the Life Dome incident. Amkezne denies any involvement and is telling the truth. If the characters use magical coercion or threaten to report her to the Hands of Ord, Amkezne tells them that she learned how to summon [invisible stalkers](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) in her final year at the Crystal Chateau and that the professor who taught her the arcane ritual was Lymmle Wist (see mission 3 of this story track).
...
![The Maw of Cael Morrow is the only known entrance to the Drowned City](file://adventure/CRCotN/055-04-011.maw-of-cael-morrow.webp#center)
...
If the characters acquired the Key to the Netherdeep in the previous mission, they have already accomplished their first goal. In that case, Cryon gives the greataxe to them so they can use it to open the rift. He also offers each character a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md), in case they have no other way to navigate the water-filled areas of Cael Morrow.
...
> The characters must steal a [figurine of wondrous power](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md) from the Allegiance of Allsight and deliver it to [Aradrine the Owl](3-Mechanics/CLI/bestiary/npc/aradrine-the-owl-crcotn.md).
%% %%
...
[Shira](3-Mechanics/CLI/bestiary/npc/shira-crcotn.md) is a chaotic good, human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), with the following additional action option:

> [!note] 
> 
> **Spellcasting.** [Shira](3-Mechanics/CLI/bestiary/npc/shira-crcotn.md) casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 10, `dice:1d20+2|noform|noparens|text(+2)` to hit with spell attacks):
> 
> At will: [chill touch](3-Mechanics/CLI/spells/chill-touch-xphb.md)
> 
> 1/day each: [blindness/deafness](3-Mechanics/CLI/spells/blindness-deafness-xphb.md), [ray of sickness](3-Mechanics/CLI/spells/ray-of-sickness-xphb.md)
^20d
...
When the characters get to Luck's Run, Security Captain Nedosi Anay, a neutral, half-orc [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md), brusquely briefs them. She relays the following information:
...
At night the casino is crowded, as people filter in after work has finished for the day to try their hand at one of the casino's games. Each floor of the casino is patrolled by four [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md); in addition, the ground floor is staffed by ten [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md). A pair of finely upholstered spiral staircases in the back of the building connects the three floors. Each staircase is magical and functions like an escalator—one has stairs that carry patrons upward, while the other has stairs that move downward.
...
The vault is 10 feet in diameter and rises 20 feet to the apex of the casino's domed ceiling. It appears to have no door, but a character who examines the vault and succeeds on a successful DC 20 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a thin keyhole near its base. The vault's lock can be opened by using a master key, which only Nedosi and Adima possess, by a character who makes a successful DC 21 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md), or by magic. Nedosi has her copy of the master key on her person.

##### Vault Trap

If the vault is opened by any means other than using the master key, the vault's magical trap is triggered. Each creature within 5 feet of the vault must make a DC 16 Wisdom saving throw. On a failed saving throw, a creature takes `dice:8d8|noform|noparens|avg|text(36)` (`8d8`) psychic damage and is [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) for 1 minute. On a successful save, a creature takes half as much damage and isn't [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned).

The trap can't be disarmed, but successfully casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 15) on the lock before an attempt is made to open it suppresses the trap for 1 minute, allowing the lock to be manipulated without negative consequences.

#### Casino Heist

As the sun sinks below the horizon, the thieves put their plan in motion. Three individuals are involved in the operation:

- Ena (neutral, human [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md)) masquerades as a casino patron.  
- Duskwood (chaotic neutral, half-elf [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)), like Ena, masquerades as a casino patron and wears a [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md).  
- [Koris](3-Mechanics/CLI/bestiary/npc/koris-crcotn.md) (lawful neutral, tiefling [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)), the crew's leader, works at one of the casino's card tables—a job she has held for about a month. She carries a [potion of gaseous form](3-Mechanics/CLI/items/potion-of-gaseous-form-xdmg.md), a tiny packet containing [dust of disappearance](3-Mechanics/CLI/items/dust-of-disappearance-xdmg.md), and a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md).  

If any of the thieves are confronted before they can pull off the heist, they try to flee the casino and foil any pursuers by running through the streets. Resolve such a chase using the "chase rules" and the [Urban Chase Complications](3-Mechanics/CLI/tables/urban-chase-complications-xdmg.md) table in the "Dungeon Master's Guide".
...
Aradrine wants the characters to retrieve a [figurine of wondrous power](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md) in the shape of an elephant that has been affected by ruidium. She believes the figurine is being kept inside the Crystal Chateau. She asks the characters to press the Crystal Chateau's gatekeeper, Jor Raashid, for information.
...
Jor knows that the elephant figurine has been moved from the Crystal Chateau to a vault inside the Emerald Ibis Relic Hall (area S4 on the Streets of the Sigil District map presented earlier in the chapter). If the characters fail to obtain this information by other means, a character can pry it from his mind with a [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md) spell or similar magic.

#### Assassins Above

As the characters travel to the storehouse where the elephant figurine is being kept, they are watched from the rooftops by two lawful evil, human [assassins](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) who have been hired by the Sentinels of Memory to grab the figurine from the storehouse and return it to the faction's headquarters. After watching the characters interact with Jor Raashid, the assassins follow them to the storehouse. When the characters arrive, the assassins attack. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 19 or higher spot the assassins before they attack and are not [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised) during the first round of combat.

##### Long Hands of the Law

On initiative count 20 of the third round of combat, five Hands of Ord [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) arrive to apprehend everyone involved in the brawl. The assassins try to flee rather than face arrest and incarceration. Two of the knights pursue the assassins while the remaining knights try to take the characters into custody. If the characters don't resist, they are held overnight in a Sigil District jail, then released the next morning and fined 50 gp each for disturbing the peace. This delay enables the Allegiance of Allsight to keep the [figurine of wondrous power](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md) safe, and the mission ends in failure (see "Mission Failed" below).
...
A character can use an action to try to forcibly pry open the vault door, doing so with a successful DC 21 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. Forcing the vault open, however, produces a loud, concussive blast of energy that fills a 15-foot cube immediately outside the vault. This trap can't be disarmed. Any creature in the cube must make a DC 18 Constitution saving throw, taking `dice:6d10|noform|noparens|avg|text(33)` (`6d10`) thunder damage on a failed save, or half as much damage on a successful one.

##### Treasure

A short flight of stairs descends into the main chamber of the vault. Square alcoves line the walls, and inside one of them is the [figurine of wondrous power](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md).

Most of the other alcoves are empty, but a thorough search of the vault also yields a set of [Nolzur's marvelous pigments](3-Mechanics/CLI/items/nolzurs-marvelous-pigments-xdmg.md) and a [wand of wonder](3-Mechanics/CLI/items/wand-of-wonder-xdmg.md).
...
![Master Aradrine the Owl](file://adventure/CRCotN/057-04-013.master-aradrine-the-owl.webp#center)

#### Returning with the Elephant

Master Aradrine is delighted if the characters deliver the elephant figurine to her, and she allows them to keep any plunder they gained from their mission. In addition, she makes arrangements to have one [ruidium weapon](3-Mechanics/CLI/items/ruidium-weapon-crcotn.md) or a suit of [ruidium armor](3-Mechanics/CLI/items/ruidium-armor-crcotn.md) of their choice (see appendix B) delivered to them within `dice:1d6|noform|noparens|avg` (`1d6`) days.
...
The person of interest is a chaotic evil half-elf named [Laurin Ophidas](3-Mechanics/CLI/bestiary/npc/laurin-ophidas-crcotn.md). He uses the [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) stat block, with these changes:

- He has immunity to poison damage and the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition.  
- He wields a [staff of the adder](3-Mechanics/CLI/items/staff-of-the-adder-xdmg.md) and is attuned to it as though he were a cleric.  

#### Ophidas's Motives

[Laurin Ophidas](3-Mechanics/CLI/bestiary/npc/laurin-ophidas-crcotn.md) is a disgraced member of the Cerberus Assembly, an organization of spellcasters in the Dwendalian Empire in Wildemount. He fled from that organization after stealing a [staff of the adder](3-Mechanics/CLI/items/staff-of-the-adder-xdmg.md) from a superior. Convinced that the assembly's assassins are pursuing him, Ophidas is trying to locate other Zehir cultists in the city who will protect him. His search is not going well.
...
If the characters accost Ophidas in public, he hollers for the Hands of Ord. Five Hands of Ord [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) arrive 3 rounds later. If the characters are still nearby when the Hands arrive, the guards try to arrest them and hold them overnight. If they don't resist, the characters are detained in a Sigil District jail, then released the next morning and assessed a fine of 50 gp each for disturbing the peace. While the characters are cooling their heels in jail, Ophidas (who is questioned by the Hands of Ord but not arrested) collects his belongings and disappears. The characters have no chance of finding him again.

##### Success

If the characters report back to Iwo with the truth about Ophidas's motives, Iwo assures the characters that they'll be called upon again in a few days' time and gives them one stone from a pair of [sending stones](3-Mechanics/CLI/items/sending-stones-xdmg.md) for future communication.
...
Seven days after the characters successfully finish their first mission, Iwo Zalarre sends one of them a message via [sending stone](3-Mechanics/CLI/items/sending-stones-xdmg.md). Whichever character has the matching stone receives the message, which is as follows:
...
> [!gallery]
> ![River District Canal](file://adventure/CRCotN/058-map-4.4-River-District-Canal.webp#gallery)
> ![Player Version](file://adventure/CRCotN/059-map-4.4-River-District-Canal-player.webp#gallery)
...
The front door is unlocked, and a small silver bell on the door jingles as it's opened. Unsold items are still sitting in their display cases. Old Man Kruuk, a neutral, half-orc [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md), sits behind the counter, counting the day's proceeds.
...
A character who makes a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check locates a metal lockbox stowed underneath an upside-down crate in a corner of the room. The lockbox can be opened by a character who makes a successful DC 21 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md). It can also be pried open with a successful DC 16 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. If the box is forced open, poison gas sprays outward, and the character who opened it must succeed on a DC 15 Constitution saving throw or take `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) poison damage and be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 hour.
...
![Ashann](file://adventure/CRCotN/060-04-014.ashann.webp#center)
...
- New members can buy the following magic items at the Temple of the Mentor: a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) (10 gp), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [divination](3-Mechanics/CLI/spells/divination-xphb.md) (125 gp), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [commune](3-Mechanics/CLI/spells/commune-xphb.md) (250 gp), and a pair of [sending stones](3-Mechanics/CLI/items/sending-stones-xdmg.md) (250 gp).  
...
The first elephant that drops to 0 hit points turns into a tiny marble elephant [figurine of wondrous power](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md) with thin veins of ruidium running through it.

...
![Two goblin children run through the streets of Jigow with a delicious meat pie](file://adventure/CRCotN/008-01-001.intro-splash.webp#center)
...
> [!gallery]
> ![Jigow](file://adventure/CRCotN/009-map-1.1-Jigow.webp#gallery)
> ![Player Version](file://adventure/CRCotN/010-map-1.1-Jigow-player.webp#gallery)
...
[Agathe Silverspoon](3-Mechanics/CLI/bestiary/npc/agathe-silverspoon-crcotn.md) is a chaotic good [orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) who moves from counter to counter, deftly slicing a variety of cooked and spiced meats, then folding them into piecrusts that she places into the oven behind her.

Agathe gestures toward the raised platform next to her cooking station, where three people are already seated: a cocky male [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) flexing his muscles, pointing at people in the gathering crowd and winking; a female halfling (use the [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) stat block), sitting very still with a smirk on her face; and a young male human, scanning the crowd as if looking for someone. This individual is [Irvan Wastewalker (tier 1)](3-Mechanics/CLI/bestiary/npc/irvan-wastewalker-tier-1-crcotn.md), whose stat block appears in appendix A. These contestants have the following modifiers to their Constitution checks and saving throws, which come into play during the pie-eating contest:

- **Male Drow.** <span title='Constitution'>`dice:d2010|noform|noparens|text(+0)`</span>  
- **Female Halfling.** <span title='Constitution'>`dice:d2014|noform|noparens|text(+2)`</span>  
- **Irvan Wastewalker.** <span title='Constitution'>`dice:d2012|noform|noparens|text(+1)`</span> on checks, <span title='Constitution'>`dice:d20+3|noform|noparens|text(+3)`</span> on saving throws  
...
![Agathe Silverspoon makes the best meat pies in Jigow](file://adventure/CRCotN/011-01-002.agathe-silverspoon.webp#center)
...
The way to win is to study the maze from the outside, and then follow the only correct path to the exit in one shot. If a creature reaches a dead end, the judge—a lawful neutral [aarakocra](3-Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) named Sharpwatch—swoops down and plucks them from the maze.
...
![Medal of the Maze](file://adventure/CRCotN/012-01-003.medal-of-the-maze.webp#center)
...
The game is refereed by an impassive, lawful neutral [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) named Omo.
...
Other than Ayo, the contestants are a lanky male orc [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), a broad-shouldered female human [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), and a surly male [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md). These nonplayer characters have the following modifiers to their Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) checks, which come into play during the swimming contest:

- **Ayo Jabe.** [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20+4|noform|noparens|text(+4)`)  
- **Male Orc.** [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20+0|noform|noparens|text(+0)`)  
- **Female Human.** [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20+2|noform|noparens|text(+2)`)  
- **Male Goblin.** [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20-1|noform|noparens|text(-1)`)  
...
The victor in this contest, and the defending champion of the event, is Maryl Bronzefang, a lawful neutral, orc [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md). A native of Jigow serving in Bazzoxan's Aurora Watch, she was given leave to return home for the festival. She is flanked by two compatriots, both female drow [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) clad in chitinous splint armor. A quiet male goblin [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)—Vars, the owner of the butcher shop—sits off to the side, managing the wagers made by onlookers.
...
- **Maggie Keeneyes.** <span title='Strength'>`dice:d2018|noform|noparens|text(+4)`</span>  
- **Maryl Bronzefang.** <span title='Strength'>`dice:d2018|noform|noparens|text(+4)`</span>  
- **Female Drow.** <span title='Strength'>`dice:d2016|noform|noparens|text(+3)`</span>  
...
This event is managed by two neutral good [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) named Beetle and Zag. Their farm is jointly run by the Gakthash and Uvuroh goblin clans, and every year, the goblin couple uses the festival competitions as a labor-saving way to harvest their crops.
...
Each team is responsible for a 20-foot-long, 5-foot-wide strip of a paddy. On Beetle's signal, the teams race to successfully harvest their strip. Aside from the characters, two other teams are competing in this race: an imposing female [orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) and her rambunctious son (who uses the [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) stat block); and a pair of [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) siblings, who wear broad-brimmed straw hats and constantly bicker with each other. These teams have the following modifiers to their Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) and Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) checks, which come into play during the contest:

##### Orc Team

[Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20+3|noform|noparens|text(+3)`), [Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand) [Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand) (`dice:1d20+0|noform|noparens|text(+0)`)

##### Drow Team

[Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) (`dice:1d20+0|noform|noparens|text(+0)`), [Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand) [Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand) (`dice:1d20+2|noform|noparens|text(+2)`)
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar effect also reveals the fifth bottle to be the only one containing magical liquid.
...
The temple is maintained by Belana Zolaed, a neutral good drow [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) who also conducts worship ceremonies.
...
The complex consists of two main structures: a low wooden barracks that houses the guards of the Aurora Watch stationed in Jigow, and a two-story stone dodecahedral building that is the residence of Durth Mirimm, a lawful neutral [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) who is the Taskhand of the Aurora Watch. Durth governs the settlement alongside the two clan elders, Colbu Kaz and Ushru.
...
> [!gallery]
> ![Emerald Grotto](file://adventure/CRCotN/014-map-1.2-Emerald-Grotto.webp#gallery)
> ![Player Version](file://adventure/CRCotN/015-map-1.2-Emerald-Grotto-player.webp#gallery)
...
The pale plants blocking the exit to the cavern are ghostgrass, a carnivorous variety of sea grass. A creature that tries to swim past the ghostgrass must succeed on a DC 12 Dexterity saving throw or take `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) necrotic damage and be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained). A [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) creature takes the damage again at the start of each of its turns until it escapes.
...
Each character must make a DC 14 Dexterity saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) bludgeoning damage from the landslide on a failed save, or half as much damage on a successful one.
...
A character who explores this cave discovers a vial containing a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and a soggy but usable [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md).
...
A [swarm of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) swims in the middle of this cave. The swarm attacks characters who move within 10 feet of it or deal damage to it. The swarm pursues the characters into area E10 or back into E5 if it isn't killed.
...
A [giant octopus](3-Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) dwells at the bottom of the pit and attacks anyone who enters it. A character who enters the pit and succeeds on a DC 17 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices the octopus at the bottom and is not [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised) when it attacks. If reduced to 13 hit points or fewer, it uses Ink Cloud and moves 10 feet away, hoping the characters leave it alone.

##### Treasure

Once the octopus is defeated, a character who searches the bottom of the pit finds 57 sp and a pouch containing [dust of dryness](3-Mechanics/CLI/items/dust-of-dryness-xdmg.md) in the form of eight marble-sized pellets that have absorbed hundreds of gallons of water. When a pellet is smashed, the act releases a 15-foot cube of water.
...
![A giant octopus waits to ambush prey in the depths of the Emerald Grotto](file://adventure/CRCotN/016-01-005.giant-octopus.webp#center)
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the tablet radiates an aura of evocation magic. The tablet has AC 15, 10 hit points, and immunity to poison and psychic damage. Destroying the tablet causes the current to subside, allowing creatures to travel through the tunnel without resistance.
...
- A character can spend 1 round [searching](3-Mechanics/CLI/rules/actions.md#Search) the east wall, then succeed on a DC 11 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check.  
...
A character who searches this cave finds three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), likely stashed here by a hopeful contestant planning to gain an advantage in this race.
...
- If the shark uses its action to make a Bite attack but misses, it can use a bonus action to swim up to 25 feet. This movement doesn't provoke [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack).  
...
![A spectral figure not seen in ages sets the adventurers on a quest that could change the fate of the world](file://adventure/CRCotN/017-01-006.spectral-figure.webp#center)

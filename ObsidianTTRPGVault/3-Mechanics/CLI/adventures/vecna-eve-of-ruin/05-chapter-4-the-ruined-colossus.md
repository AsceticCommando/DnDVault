...
![The next piece of the Rod of Seven Parts is inside an enormous war machine](file://adventure/VEoR/061-04-001.the-colossus-warforged.webp#center)
...
![The Mount Ironrot region is a wasteland scattered with broken war machines](file://adventure/VEoR/062-04-002.mount-ironrot-region.webp#center)
...
> [!gallery]
> ![Map 4.1: Mount Ironrot Outskirts](file://adventure/VEoR/063-map-4.01-mount-ironrot-outskirts.webp#gallery)
> ![Player Version](file://adventure/VEoR/064-map-4.01-mount-ironrot-outskirts-player.webp#gallery)
...
![](file://adventure/VEoR/065-04-011.kalyth.webp#center)
...
> [!gallery]
> ![Map 4.2: Ialos](file://adventure/VEoR/066-4.02-ialos.webp#gallery)
> ![Player Version](file://adventure/VEoR/067-4.02-ialos-player.webp#gallery)
...
![Mercy](file://adventure/VEoR/068-04-013.mercy.webp#center)
...
![Warforged try to survive in the blasted wilderness around Mount Ironrot](file://adventure/VEoR/069-04-003.mount-ironrot.webp#center)
...
![A Docent](file://adventure/VEoR/070-04-004.docent.webp#center)
...
The easiest way to enter the colossus is through the mountain caves that lead to area L5. The characters can also search higher up the mountain along outdoor paths for the entrances to caverns that lead to areas L11 and L16. Searching for area L11 takes `dice:2d4|noform|noparens|avg` (`2d4`) hours, and during the characters' search, a hungry [roc](3-Mechanics/CLI/bestiary/monstrosity/roc-xmm.md) ambushes them. Searching for area L16 takes `dice:3d4|noform|noparens|avg` (`3d4`) hours, and during the characters' search, they stumble on a nest with two [rocs](3-Mechanics/CLI/bestiary/monstrosity/roc-xmm.md) and one roc egg the height of a human. The angry roc parents attack the characters, though the rocs don't pursue if the characters flee.
...
- **Psychic Damage.** For each ounce of graymatter fluid consumed, the creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage. A creature killed by this damage rises as a [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) `dice:1d4|noform|noparens|avg` (`1d4`) hours after dying.  
...
> [!gallery]
> ![Map 4.3: Landro](file://adventure/VEoR/072-4.03-landro.webp#gallery)
> ![Player Version](file://adventure/VEoR/073-4.03-landro-player.webp#gallery)
...
![Filch](file://adventure/VEoR/074-04-010.filch.webp#center)
...
![A strange pool found inside Landro has magical effects on items dipped into it](file://adventure/VEoR/075-04-006.dragonshard-pool.webp#center)
...
The chest is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) in disguise. As soon as a creature touches it, the mimic attacks. Once it has grappled a creature, the mimic attempts to drag its victim outside so it can drop the victim off the edge of the walkway (area L22). Creatures that fall take `dice:13d6|noform|noparens|avg|text(45)` (`13d6`) bludgeoning damage.
...
As soon as a character is halfway up this area, Glaive activates the weapon, which ejects a jet of water in a 60-foot line. Any creature in this line must succeed on a DC 15 Dexterity saving throw or take `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) bludgeoning damage and fall down to area L18, landing with the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition.

Glaive compromised the weapons system when she moved it; once fired, it breaks, losing its magic.

#### L27: Weapons System

![Glaive and her subordinates might confront the heroes inside Landro's weapons systems room](file://adventure/VEoR/076-04-007.glaive-and-subordinates.webp#center)
...
![The graymatter engine serves as Landro's brain, though it can't control the colossus's mechanical systems](file://adventure/VEoR/077-04-008.graymatter-engine.webp#center)
...
![Landro](file://adventure/VEoR/078-04-012.landro.webp#center)
...
![Elemental Gem (Emerald)](file://adventure/VEoR/079-04-009.emerald-elemental-gem.webp#center)

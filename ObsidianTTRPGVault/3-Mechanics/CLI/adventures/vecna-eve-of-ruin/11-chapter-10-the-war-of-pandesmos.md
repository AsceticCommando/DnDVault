...
![Kas has fled Sigil, intent on using the Rod of Seven Parts to free Miska, his ally against Vecna](file://adventure/VEoR/141-10-001.miska-freed.webp#center)
...
> [!gallery]
> ![Map 10.1: Pandesmos Battlefield](file://adventure/VEoR/142-map-10.01-pandesmos-battlefield.webp#gallery)
> ![Player Version](file://adventure/VEoR/143-map-10.01-pandesmos-battlefield-player.webp#gallery)
...
![Vaeve](file://adventure/VEoR/144-10-001.vaeve.webp#center)
...
![Hurricane Tower](file://adventure/VEoR/145-10-002.hurricane-tower.webp#center)
...
If the characters are careless or fail to fool Lolth's forces, they might face a squad of `dice:1d4|noform|noparens|avg` (`1d4`) [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md), `dice:1d6|noform|noparens|avg` (`1d6`) [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md), and `dice:1d4|noform|noparens|avg` (`1d4`) [assassins](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md). Characters who defeat the squad can try again to infiltrate the tower.
...
> [!gallery]
> ![Map 10.2: Hurricane Tower](file://adventure/VEoR/146-10.02-hurricane-tower.webp#gallery)
> ![Player Version](file://adventure/VEoR/147-10.02-hurricane-tower-player.webp#gallery)
...
![Miska is imprisoned in the Ruinous Citadel, which serves as the headquarters for the demon lord's forces](file://adventure/VEoR/149-10-004.ruinous-citadel.webp#center)
...
> [!gallery]
> ![Map 10.3: Ruinous Citadel](file://adventure/VEoR/150-10.03-ruinous-citadel.webp#gallery)
> ![Player Version](file://adventure/VEoR/151-10.03-ruinous-citadel-player.webp#gallery)
...
The exterior door has an invisible glyph inscribed on it. Each time a creature other than a Fiend opens the door, the glyph glows for a split second, and the creature must make a DC 18 Wisdom saving throw, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) psychic damage on a failed save or half as much damage on a successful one. Casting [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on the door removes the glyph, allowing the door to be opened safely.
...
![Outside the Ruinous Citadel, battles between demonic forces loyal to Miska and Lolth still rage](file://adventure/VEoR/152-10-005.battles.webp#center)
...
![The vampire Kas refuses to tolerate any interruptions to his plans to ruin Vecna and claim the multiverse for his own](file://adventure/VEoR/153-10-006.kas.webp#center)
...
> [!gallery]
> ![Map 10.4: Cliffside Redoubt](file://adventure/VEoR/154-10.04-cliffside-redoubt.webp#gallery)
> ![Player Version](file://adventure/VEoR/155-10.04-cliffside-redoubt-player.webp#gallery)
...
![At your discretion, the characters might have found the legendary Sword of Kas in this adventure](file://adventure/VEoR/156-10-007.sword-of-kas.webp#center)

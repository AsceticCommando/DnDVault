...
![The next rod piece lurks deep in the deadly Tomb of Wayward Souls](file://adventure/VEoR/106-07-001.the-tomb-of-wayward-souls.webp#center)
...
> [!gallery]
> ![Map 7.1: Isle of Serpents Lagoon](file://adventure/VEoR/107-7.01-isle-of-serpents-lagoon.webp#gallery)
> ![Player Version](file://adventure/VEoR/108-7.01-isle-of-serpents-lagoon-player.webp#gallery)
...
![A kraken attacks people on the Isle of Serpents](file://adventure/VEoR/109-07-001.isle-of-serpents.webp#center)
...
![Laysa Matulin](file://adventure/VEoR/110-07-002.laysa-matulin.webp#center)
...
![Map 7.2: Tomb Complex](file://adventure/VEoR/111-map-7.02-tomb-complex.webp#center)
...
> [!gallery]
> ![Map 7.3: Tomb of Wayward Souls](file://adventure/VEoR/112-7.03-tomb-of-wayward-souls.webp#gallery)
> ![Player Version](file://adventure/VEoR/113-7.03-tomb-of-wayward-souls-player.webp#gallery)
...
![A cryptic message written in Celestial provides clues about how to use the seven casks in a nearby cave](file://adventure/VEoR/114-07-003.seven-casks.webp#center)
...
![+3 Wand of the War Mage](file://adventure/VEoR/115-07-004.wand-of-the-war-mage.webp#center)
...
![Anyone who wanders into the tomb's arena must contend with granite juggernauts](file://adventure/VEoR/116-07-005.granite-juggernauts.webp#center)
...
![Sword of Sharpness (scimitar) with a snake-shaped pommel](file://adventure/VEoR/117-07-006.sword-of-sharpness.webp#center)
...
There are two ways to open the doors. A character can play one of the hallway's instruments and make a DC 20 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check; if the character doesn't have proficiency with the chosen instrument, this check is made with disadvantage. On a successful check, the doors open. On a failed check, the character takes `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) psychic damage, and the doors remain locked.
...
![A Manual of Bodily Healthy written on engraved copper sheets](file://adventure/VEoR/118-07-007.manual-of-bodily-health.webp#center)
...
While [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) in this way, a creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage for every 5 feet it moves. After taking this damage, the creature can repeat the saving throw, ending the frightened condition on a itself on a success.
...
![Map 7.4: Vortex Bridge Puzzle](file://adventure/VEoR/119-07-009.vortex-bridge-puzzle.webp#center)
...
The secret compartment bears a magical trap. If the compartment is opened by any means other than using the key found on Rerak in area T26, magical lightning shoots from the drawer. Each creature in the room must make a DC 15 Dexterity saving throw, taking `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) lightning damage on a failed save or half as much damage on a successful one. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar effect unveils the source of this trap: a tiny rune inscribed in the drawer. The trap can be disarmed by dispelling the rune with a [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell (DC 17).
...
If the double door is opened via any other means besides the correct combination, a cloud of sweet-smelling gas is released from the skull engraving. The gas fills the widened area immediately south of the double door. Each creature in that area must succeed on a DC 20 Constitution saving throw or have the [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) condition for `dice:2d4+10|noform|noparens|avg` (`2d4 + 10`) minutes. An [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) creature can repeat this saving throw each time it takes damage, ending the effect on itself on a successful save.
...
The items on the pedestals are false re-creations of treasures that can be found throughout the complex. A creature that touches one of these false treasures must immediately succeed on a DC 15 Constitution saving throw or take `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) necrotic damage and have the [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) condition until the start of its next turn.
...
![The false lich Rerak is a terrifying sight to behold](file://adventure/VEoR/120-07-008.rerak.webp#center)

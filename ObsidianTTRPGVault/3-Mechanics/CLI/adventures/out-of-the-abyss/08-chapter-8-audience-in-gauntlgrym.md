...
![](file://adventure/OotA/063-08-01.webp#center)
...
Check for a random encounter once every hour of travel in the Iron Tabernacle by rolling a `dice:d20|noform|noparens|avg` (`d20`) and consulting the table below to determine what, if anything, the characters meet.
...
| 14 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) |
...
| 17 | 1 shield dwarf [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) and `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) shield dwarf [acolytes](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) |
| 18 | `dice:1d6+1\|noform\|noparens\|avg` (`1d6 + 1`) [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
| 19 | 1 [grick alpha](3-Mechanics/CLI/bestiary/aberration/grick-ancient-xmm.md) and `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) |
| 20 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [rust monsters](3-Mechanics/CLI/bestiary/monstrosity/rust-monster-xmm.md) |
^encounter
...
The Great Forge is always occupied by either Helgrim or Rollo, their apprentices and assistants (`dice:2d4|noform|noparens|avg` (`2d4`) shield dwarf [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), and shield dwarf [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) working in squads of six to guard the active furnaces. The characters might also encounter other creatures if they explore the unoccupied areas of the Great Forge. Check for such an encounter once per hour of travel or rest outside the protected areas of the forge by rolling a `dice:d20|noform|noparens|avg` (`d20`) and consulting the Great Forge Encounters table to determine what, if anything, comes out of the darkness. If the heroes call for help, four shield dwarf [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) arrive in `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) rounds to aid them.
...
|-----------|-----------|
| 1–14 | No encounter |
| 15 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [doppelgangers](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) disguised as shield dwarves |
| 16 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [fire elementals](3-Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md) and `dice:3d6\|noform\|noparens\|avg` (`3d6`) [magmins](3-Mechanics/CLI/bestiary/elemental/magmin-xmm.md) |
| 17 | 1 [salamander](3-Mechanics/CLI/bestiary/elemental/salamander-xmm.md) and `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [fire snakes](3-Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md) |
| 18 | 1 [spirit naga](3-Mechanics/CLI/bestiary/fiend/spirit-naga-xmm.md) |
| 19 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) |
| 20 | 1 [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) leading `dice:1d6+1\|noform\|noparens\|avg` (`1d6 + 1`) [specter](3-Mechanics/CLI/bestiary/undead/specter-xmm.md) |
^encounter
...
![](file://adventure/OotA/064-ooa08-01.webp#center)
...
![](file://adventure/OotA/065-ooa08-02.webp#center)
...
![](file://adventure/OotA/066-ooa08-03.webp#center)
...
![](file://adventure/OotA/067-ooa08-05a.webp#center)
...
![](file://adventure/OotA/068-ooa08-04.webp#center)
...
![](file://adventure/OotA/069-ooa08-05.webp#center)

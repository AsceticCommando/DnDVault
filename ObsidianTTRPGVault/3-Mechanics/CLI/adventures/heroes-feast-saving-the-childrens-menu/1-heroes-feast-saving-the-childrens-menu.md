...
![](file://adventure/HFStCM/000-00-001.opening-splash.webp#center)
...
![](file://adventure/HFStCM/001-00-002.hollow-homestead.webp#center)
...
![Chef Kaga](file://adventure/HFStCM/002-00-003.chef-kaga.webp#center)
...
![Lord Invido commands the loyalty of many fire giants](file://adventure/HFStCM/003-00-004.lord-invido-giant.webp#center)
...
Near the house, three-foot-high mustard plants grow in raised beds among other herbs; a character who searches the garden and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check spots them. A character can harvest the seeds from the mustard plants with a few minutes of work and a successful DC 15 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check, rolling the seed pods between their fingers so the seeds fall out into a bag. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that a faint aura of enchantment magic emanates from the seeds.
...
Arthur's corpse lies in this fresh grave, and the [Speak with Dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md) spell works on him. A key inside his trouser pocket opens the safe in the house's library.

### Encountering Ignis

If the characters aren't trying to be stealthy as they move about the house, Ignis, the neutral good [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) currently inside the barn, comes to investigate the newcomers. Otherwise, the characters must [hide](3-Mechanics/CLI/rules/actions.md#Hide) and succeed on a DC 16 group Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check to avoid attracting her attention.
...
> [!gallery]
> ![Map: Holrow Homestead](file://adventure/HFStCM/004-map-0.01-holrow-homestead.webp#gallery)
> ![Player Version](file://adventure/HFStCM/005-map-0.01-holrow-homestead-player.webp#gallery)
...
Inside the barn, cows chew away on troughs of Arthur's special bovine feed. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that a faint aura of abjuration magic emanates from the feed. The barn has milking stations equipped with buckets and milk cans. A character can try to milk a cow, doing so with a successful DC 10 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. The buckets and cans can be used to store the milk for the short trip back to Daggerford.
...
Arthur's cheese storage room holds shelves of aging cheese wheels. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the room emanates a faint aura of conjuration magic. There are nine shelves in the room, each with a numbered label that denotes how many seasons the cheese on that shelf has aged.
...
Anyone looking outside sees three [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) heading for the house. Two enormous [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) (change their size to Large) accompany the giants, each on a leash of iron chain held by one of the giants. The giant who isn't holding a leash is the commander of the search party. The characters are likely to notice the arrival of such enormous adversaries; even in the basement, the giants' heavy footfalls can be felt.
...
If the search party gains access to the children, Ignis abandons whatever she is doing and goes to defend them. Invido's giants and their hell hounds avoid hurting the children; instead, they [grapple](3-Mechanics/CLI/rules/variant-rules/unarmed-strike-xphb.md) the children and try to carry them away. If by chance one of the children takes damage, they do not die, but instead cling to life long enough for the characters to heal them.
...
![](file://adventure/HFStCM/006-00-006.kender-stumblenoodles.webp#center)

...
![](file://adventure/IDRotF/038-01-019.shield-dougan.webp#center)
...
Speaker Edgra Durmoot (neutral human [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)), a plainspoken trapper getting on in years, speaks for the townsfolk. She seldom attends meetings of the Council of Speakers.

### Militia

Dougan's Hole can muster up to 12 soldiers (use the [tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 1 [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
> [!gallery]
> ![Map 1.7: Dougan's Hole](file://adventure/IDRotF/039-map-1.7-dougan.webp#gallery)
> ![Player Version](file://adventure/IDRotF/040-map-1.7-dougan-player.webp#gallery)
...
Two [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) are extorting the people of Dougan's Hole for food and treasure on behalf of a woolly [mammoth](3-Mechanics/CLI/bestiary/beast/mammoth-xmm.md) named Norsu. Years ago, a frost druid cast an [awaken](3-Mechanics/CLI/spells/awaken-xphb.md) spell on the mammoth. Last year, a group of adventurers killed Garagai, the mammoth's frost giant master. Norsu has never recovered from the loss and, to this day, watches over its master's frozen corpse, unwilling to leave its side. The winter wolves, who served Garagai as faithful friends, look after the mammoth. Although Norsu feeds on plants, not meat, it delights in killing humanoids to avenge Garagai's death. Slaying the mammoth is a tall order, so characters would be wise to flee from Norsu or try to reason with it.
...
![The winter wolf brothers, Koran and Kanan, pose a threat to all who visit Dougan's Hole](file://adventure/IDRotF/041-01-020.winter-wolf.webp#center)

### Good Wolf, Bad Wolf

When the characters first approach the outskirts of Dougan's Hole or shortly after they first leave town, they encounter two [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) named Koran and Kanan. Here's how the encounter plays out:
...
Also crossing the tundra are a pack of `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md), prowling the white in search of food. Characters who make a successful DC 13 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check note that the wolves are gaunt from starvation. If the winter wolves are with the party, Kanan and Koran growl and bare their teeth, which deters the pack from approaching closer.

![Terror lurks in the icy depths of this frost giant lodge](file://adventure/IDRotF/042-01-021.webp#center)
...
> [!gallery]
> ![Map 1.8: Frost Giant Ice Lodge](file://adventure/IDRotF/043-map-1.8-frost-giant.webp#gallery)
> ![Player Version](file://adventure/IDRotF/044-map-1.8-frost-giant-player.webp#gallery)
...
Garagai built the cage to hold Norsu when the mammoth was younger. Now it holds Silja and Finn Dejarr (neutral good human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), who are described below:
...
If the awakened [mammoth](3-Mechanics/CLI/bestiary/beast/mammoth-xmm.md) is aware of the characters' presence, add:
...
The symbol carved into the throne is the Giant rune for "ice," as any character who succeeds on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can ascertain. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of conjuration magic around the rune, which empowers the throne. A creature that sits in the throne becomes aware of its magical nature and can use an action while seated in the throne to summon a blizzard, which takes 1 minute to form. The blizzard engulfs the lodge, extends 1 mile from it in all directions, and lasts for 8 hours. This property of the throne recharges after a tenday.
...
Hilda married her older brother, who was a hunter. He passed away a few years ago but left behind some magic boots he won from a wayward adventurer he bested in a drinking contest. If one or both of her children are returned safely, Hilda gives the characters her husband's [Boots of the Winterlands](3-Mechanics/CLI/items/boots-of-the-winterlands-xdmg.md) as a thank-you.
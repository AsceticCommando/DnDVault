...
![](file://adventure/IDRotF/045-01-022.shield-easthaven.webp#center)
...
Speaker Danneth Waylen (chaotic good human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), respected for his humility and forthrightness. Captain Imdra Arlaggath (lawful good half-elf [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) commands the town's militia.

### Militia

Easthaven can muster up to 150 soldiers (use the [tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 12 [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
> [!gallery]
> ![Map 1.9: Easthaven](file://adventure/IDRotF/046-map-1.9-easthaven.webp#gallery)
> ![Player Version](file://adventure/IDRotF/047-map-1.9-easthaven-player.webp#gallery)
...
Rinaldo senses that the White Lady's spirit is close and urges the characters to reach out to it. Ask the players in turn what their characters say or do. The characters who try to help Rinaldo must make a DC 12 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) group check. If the group check fails, the White Lady's spirit manifests as a poltergeist and attacks the party, frightening away the other participants. This [poltergeist](3-Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) uses the [specter](3-Mechanics/CLI/bestiary/undead/specter-xmm.md) stat block, with the changes outlined in the "Variant: Poltergeist" sidebar that appears with it in the "Monster Manual".
...
![Rinaldo the halfling leads a seance to contact the spirit of the White Lady of Lac Dinneshere](file://adventure/IDRotF/049-01-024.rinaldo.webp#center)
...
![Easthaven residents bask in the warmth of an evil wizard being burned at the stake](file://adventure/IDRotF/050-01-025.easthaven.webp#center)
...
A woman bedecked in a tailored coat and a fur hat approaches the characters as people huddle around the burning wizard. She introduces herself as Imdra Arlaggath, captain of Easthaven's militia. Captain Arlaggath (lawful good half-elf [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) speaks curtly but is not unfriendly. If any of the characters ask about Dzaan, she tells them that he coldly murdered some adventurers who had aided the people of Icewind Dale in the past; his public execution isn't an act of vengeance but is meant to deter others from engaging in similar behavior.
...
If the characters need a boat, they can borrow one from the angler docks and drag it across the ice to the open water. A [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md) can hold up to four Medium characters, while a single-masted skiff can hold up to eight. A skiff requires at least one crew member who has proficiency with water vehicles.

If the characters request a reward for their services, Captain Arlaggath says she's not authorized to give one. But she did confiscate two items from Dzaan that might interest the characters: a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) in a copper tube and a [gray bag of tricks](3-Mechanics/CLI/items/bag-of-tricks-gray-xdmg.md). They can have one or the other if they find the missing fishers.
...
> [!readaloud] 
> 
> A [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md) bobs untethered in the water amid some small ice floes, not far from the eighty-foot-high cliffs that abut the shoreline. The mouths of four caves dot the snowy cliffside. One of these caves is at water level, and the others are elevated twenty to thirty feet above the frozen lake. The wind tearing through these icy caves sounds like moaning.
^173

Characters who search the abandoned [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md) find four oars, four sets of fishing tackle, and a dozen empty bottles lying in it. Characters can also see faint tracks on the ice leading from the boat to the southernmost cave, which is where the four missing anglers went. The spicy scent that lured the fishers into the cave is not present when the characters arrive.

As the characters conclude their search of the [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md) and make their way toward the caves, two [harpies](3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md) fly over the coastline. Like many creatures in this region, the harpies are starving and eager for anything they can eat. If one is killed, the other flees.
...
> [!gallery]
> ![Map 1.10: Cauldron Caves](file://adventure/IDRotF/051-map-1.10-cauldron.webp#gallery)
> ![Player Version](file://adventure/IDRotF/052-map-1.10-cauldron-player.webp#gallery)
...
A hungry [dire wolf](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) haunts this dark cave, the uneven floor of which is strewn with animal and humanoid bones. Unless the characters offer it fresh meat, the dire wolf attacks them. It's too mean-tempered to be befriended. The wolf has no trouble scrambling up or down the 20-foot-high wall at the mouth of its den.
...
![Maud Chiselbone uses her magic cauldron to whip up a tasty human stew](file://adventure/IDRotF/053-01-026.maud.webp#center)

#### U10. Cauldron of Plenty

The lake hag, Maud Chiselbone (use the [sea hag](3-Mechanics/CLI/bestiary/fey/sea-hag-xmm.md) stat block), and her [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) companion await characters in the middle of this cave. Maud stands between her [cauldron of plenty](3-Mechanics/CLI/items/cauldron-of-plenty-idrotf.md) (see appendix D) and a stone block atop which she butchers whatever meat is destined for her stew. Heaped around this block are rusty hatchets and the flayed corpses of the four fishers from Easthaven. The will-o'-wisp is normally [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) when its light is extinguished, but it brightens when it wants intruders to behold Maud's true, hideous form.
...
The chest that Maud pulls from the depths of Lac Dinneshere contains 600 gp. Buried under the gold coins are four [crawling claws](3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) that leap out and attack if the gold is removed, dumped, or otherwise disturbed.
...
Having completed their quest, the characters are entitled to either the [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) or the [gray bag of tricks](3-Mechanics/CLI/items/bag-of-tricks-gray-xdmg.md), both of which Captain Arlaggath has in her custody.
...
Any character who barters with Danneth and succeeds on a DC 12 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can convince him to sweeten the deal, in which case he offers up to ten 500 gp gemstones. If the characters accept his offer, Danneth needs 48 hours to call in some debts and acquire the gems, during which time he insists that the cauldron remain in Easthaven's Town Hall, under guard in area T17. The characters can either let four members of town militia ([tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md)) watch over the cauldron, or they can protect it themselves. Danneth is satisfied either way.

![Speaker Danneth Waylen](file://adventure/IDRotF/054-01-027.danneth.webp#center)

#### Zhentarim Thieves

News of the cauldron reaches Speaker Naerth Maxildanarr of Targos within a day, thanks to a Zhentarim [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) named Prudence Tarkwold, who works as a clerk in Easthaven's Town Hall and owns a small cottage nearby (where she keeps a [flying snake](3-Mechanics/CLI/bestiary/monstrosity/flying-snake-xmm.md) that serves her as a messenger). After Prudence notifies him of the cauldron, Naerth sets into motion a plan to steal it. He dispatches three human [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) in [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md) to meet with Prudence at the Town Hall as night falls. These thugs bring with them a domesticated [axe beak](3-Mechanics/CLI/bestiary/monstrosity/axe-beak-xmm.md), which they tie to a wooden post outside the Town Hall's north entrance.
...
> [!gallery]
> ![Map 1.11: Easthaven Town Hall](file://adventure/IDRotF/055-map-1.11-easthaven-town-hall.webp#gallery)
> ![Player Version](file://adventure/IDRotF/056-map-1.11-easthaven-town-hall-player.webp#gallery)
...
![Bound to a demonic figurehead is a haunting figure, but not all is what it seems](file://adventure/IDRotF/057-01-028.webp#center)
...
Characters who spend at least 10 minutes searching the bookshelves discover a worn book with a red leather cover and yellow pages. The edges of the pages are stained with dry blood. The writing inside suggests the book is nothing more than a poetry anthology. However, it's actually the spellbook of a Red Wizard of Thay named Dzaan. The book's true contents are hidden by an [illusory script](3-Mechanics/CLI/spells/illusory-script-xphb.md) spell that ends 5 days after Dzaan's execution (see "Public Execution").

After the book was confiscated by a member of the town militia, it was brought to the Town Hall, where a clerk saw fit to place it in this library for safe keeping. Casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on the book ends the [illusory script](3-Mechanics/CLI/spells/illusory-script-xphb.md) spell placed upon it. When the [illusory script](3-Mechanics/CLI/spells/illusory-script-xphb.md) spell ends, the book's true contents are revealed. It contains the following spells: [animate objects](3-Mechanics/CLI/spells/animate-objects-xphb.md), [arcane eye](3-Mechanics/CLI/spells/arcane-eye-xphb.md), [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md), [blur](3-Mechanics/CLI/spells/blur-xphb.md), [confusion](3-Mechanics/CLI/spells/confusion-xphb.md), [conjure elemental](3-Mechanics/CLI/spells/conjure-elemental-xphb.md), [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [disguise self](3-Mechanics/CLI/spells/disguise-self-xphb.md), [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), [hallucinatory terrain](3-Mechanics/CLI/spells/hallucinatory-terrain-xphb.md), [illusory script](3-Mechanics/CLI/spells/illusory-script-xphb.md), [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md), [knock](3-Mechanics/CLI/spells/knock-xphb.md), [levitate](3-Mechanics/CLI/spells/levitate-xphb.md), [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [major image](3-Mechanics/CLI/spells/major-image-xphb.md), [mirror image](3-Mechanics/CLI/spells/mirror-image-xphb.md), [mislead](3-Mechanics/CLI/spells/mislead-xphb.md), [phantasmal force](3-Mechanics/CLI/spells/phantasmal-force-xphb.md), [phantasmal killer](3-Mechanics/CLI/spells/phantasmal-killer-xphb.md), [seeming](3-Mechanics/CLI/spells/seeming-xphb.md), [sending](3-Mechanics/CLI/spells/sending-xphb.md), [silent image](3-Mechanics/CLI/spells/silent-image-xphb.md), and [slow](3-Mechanics/CLI/spells/slow-xphb.md).

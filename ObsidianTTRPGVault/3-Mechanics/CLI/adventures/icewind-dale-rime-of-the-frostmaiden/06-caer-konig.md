...
![](file://adventure/IDRotF/031-01-016.shield-caer-konig.webp#center)
...
Speaker Trovus (neutral good silver dragonborn [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)), a retired adventurer, represents the town. Trovus won over his fellow townsfolk with his brawn and good humor, though he's too blunt to be a good politician and drinks too much.

### Militia

Caer-Konig can muster up to 25 soldiers (use the [tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 2 [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
> [!gallery]
> ![Map 1.5: Caer-Konig](file://adventure/IDRotF/032-map-1.5-caer-konig.webp#gallery)
> ![Player Version](file://adventure/IDRotF/033-map-1.5-caer-konig-player.webp#gallery)
...
This tavern owes its popularity to the free half-pints of ale that the proprietor, Eglendar "Glen" Korr (neutral good half-elf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), keeps on the table by the front door. He presses one into the hand of every person who stops by (the hook), which compels most of them to stay to order seconds and thirds (the line). The "sinker" part of the tavern's name refers both to the last drink call of the night and—when locals challenge visitors to a drinking contest—to the last drink that sends a losing contestant under the table.
...
Run by a seasoned ranger named Atenas Swift (neutral good human [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)), this shop sells adventuring gear. Attached to the shop is a locked wooden shed where Atenas stores a pair of dogsleds and a kennel where he keeps a dozen healthy [sled dogs](3-Mechanics/CLI/items/sled-dog-frhof.md) (use the [wolf](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) stat block to represent them). Six dogs are enough to pull each [sled](3-Mechanics/CLI/items/dogsled-idrotf.md). Helping Atenas run the shop is an experienced mountain guide named Jarthra Farzassh (lawful good shield dwarf [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)). The two have an excellent rapport, mixed with some competitive ribbing.
...
Trovus (neutral good silver dragonborn [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) spends most of his days drinking and reminiscing about his bygone adventuring days. He's been patrolling at night looking for thieves, but after yet another night of heavy drinking, he passed out in the snow after a few hours. He has no recollection of how he ended up in the snow pile or why he was outside drinking in the first place.
...
The woman, Allie, is one of the Shorard sisters (neutral good human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), who own the inn. The other owner, Cori, is working in the kitchen. Allie settles Trovus into a chair before approaching the characters.
...
If the characters are interested in following the suspicious tracks, the Shorard sisters suggest they visit Frozenfar Expeditions and secure a [dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md) before setting out on their adventure. If the characters do so, they discover that Jarthra, the mountain guide at Frozenfar Expeditions, is willing to accompany the characters for a small fee of 10 gp per day of travel. Jarthra has advantage on Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) checks made in the vicinity of Kelvin's Cairn.
...
> 
> When the characters arrive, the outpost contains five [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) (including Nildar), who behave as described here.
> 
...
> [!gallery]
> ![Map 1.6: Duergar Outpost](file://adventure/IDRotF/035-map-1.6-duergar-outpost.webp#gallery)
> ![Player Version](file://adventure/IDRotF/036-map-1.6-duergar-outpost-player.webp#gallery)
...
A [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) named Brojk stands guard in the bunker and shoots his heavy crossbow through the arrow slits at any creatures he sees. He carries this crossbow in addition to his regular weapons.
...
The two [goats](3-Mechanics/CLI/bestiary/beast/goat-xmm.md) were stolen from Caer-Konig, and the duergar plan to eat them. The duergar use the [ogre zombie](3-Mechanics/CLI/bestiary/undead/ogre-zombie-xmm.md) to pull their [dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md). The zombie has been enslaved and browbeaten by the duergar and does as they command. Inside its cage, it can do no harm to anyone.
...
Unless she has cause to leave the overlook and raise the drawbridge in area O2, a [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) named Urthhild stands guard here, stamping her feet to fight off the cold.
...
If the characters made it through area O5 without getting into a fight, they catch Nildar Sunblight, a [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md), seated at the desk, studying his collection of glassy shards. He attacks the characters when they enter.
...
![Nildar Sunblight](file://adventure/IDRotF/037-01-018.nildar.webp#center)
...
If the characters let Nildar go or if he escapes, he leaves the outpost using the ogre zombie and [dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md) in area O2; if that's no longer an option, he flees on foot. He returns to his father's fortress in the mountains (see chapter 3), swearing revenge on the characters and vowing to inflict great pain on them if their paths cross again.
...
Each of the northern rooms has one [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) sleeping in it. The two duergar are brothers named Ruvik and Skorn. If the characters move around without making any loud noises, the duergar stay asleep. If awakened, they attack the intruders. The duergar sleep in their armor, keeping their shields and weapons within reach.

##### Treasure

The crates and most of the sacks contain basic supplies, including blankets, rations, hempen rope, and other equipment. One small sack holds the stolen valuables from Caer-Konig: twenty-five pearls carved into decorative beads (5 gp each). Another sack contains three [daggers](3-Mechanics/CLI/items/dagger-xphb.md), a set of [woodcarver's tools](3-Mechanics/CLI/items/woodcarvers-tools-xphb.md), a set of [navigator's tools](3-Mechanics/CLI/items/navigators-tools-xphb.md), [fishing tackle](3-Mechanics/CLI/items/fishing-tackle.md), and a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) hidden in a leather [pouch](3-Mechanics/CLI/items/pouch-xphb.md) along with 73 sp.

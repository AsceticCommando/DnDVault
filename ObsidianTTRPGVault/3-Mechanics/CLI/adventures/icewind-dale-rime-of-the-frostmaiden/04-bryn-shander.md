...
![](file://adventure/IDRotF/016-01-007.shield-bryn-shander.webp#center)
...
![Speaker Duvessa Shane](file://adventure/IDRotF/017-01-008.duvessa.webp#center)
...
Speaker [Duvessa Shane](3-Mechanics/CLI/bestiary/npc/duvessa-shane-skt.md) (lawful good human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) speaks for the townsfolk. Though relatively young, Duvessa is the head of the Council of Speakers. Sheriff [Markham Southwell](3-Mechanics/CLI/bestiary/npc/markham-southwell-skt.md) (lawful good human [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) commands the militia.

### Militia

Bryn Shander can muster up to 250 soldiers (use the [tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 20 [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
> [!gallery]
> ![Map 1.2: Bryn Shander](file://adventure/IDRotF/018-map-1.2-bryn-shander.webp#gallery)
> ![Player Version](file://adventure/IDRotF/019-map-1.2-bryn-shander-player.webp#gallery)
...
The characters can pick up this quest if they start the adventure in Bryn Shander or shortly after they arrive in town. It begins when the characters learn about a group of shield dwarves who were forced to abandon a [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) loaded with iron ingots, which they were transporting from the mines at the base of Kelvin's Cairn. The ingots belong to the Battlehammer clan and are stamped with the clan's iconic symbol, a foaming mug. The dwarves ask the characters to retrieve the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) and deliver the ingots safely to Blackiron Blades, for which each character will receive a gemstone as payment. Characters who complete this quest also earn a 10 percent discount on goods bought at Blackiron Blades—a little thank-you from the establishment's grateful owner.

Complications arise when goblins find the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) before the characters do. The characters must either fight the goblins or finagle the ingots from them using guile or stealth. To further complicate matters, the goblins have a wagon pulled by hungry polar bears. The bears aren't fussy about what they eat, so clever characters might think to turn them against the goblins.
...
> [!readaloud] 
> 
> Three stocky figures bundled in cold weather garb stumble toward you. They have [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) slung over their backs and ice picks fastened to their belts, and two of them have thick beards. The third holds up a gloved hand and says, through a thick wool scarf in a raspy voice, "Well met! I'm Hruna, and these are my friends, Korux and Storn. We need help, and you look capable."
^0a3
...
The dwarves wear [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md). Only their eyes are visible. Treat them as [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) who speak Common and Dwarvish; being dwarves, they have [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) out to a range of 60 feet and resistance to poison damage. They carry ice picks (`dice:1d4|noform|noparens|avg` (`1d4`) piercing damage) instead of clubs. Each dwarf is briefly described below:
...
> [!readaloud] 
> 
> "We're the survivors of a group of dwarves tasked with delivering a [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) of iron ingots to Bryn Shander. A yeti surprised us and killed a member of our group. The rest of us fled as the yeti tore Oobok limb from limb. Now we need someone to go back and get the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) for us. As payment, we offer each of you a gemstone worth fifty gold pieces. The friendship of the dwarves of Icewind Dale can also be a boon in these harsh times. You'll need snowshoes to make the trip in good time."
^0a4

If the characters slay the dwarves and take the [pouch](3-Mechanics/CLI/items/pouch-xphb.md) of gemstones that Hruna carries on her person (see "Treasure" below), witnesses report them to the town militia, leading to their arrest unless they flee Bryn Shander at once.

Korux can cover the expense of equipping the party with [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) if the characters are too cheap to pay for the [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) themselves.
...
Hruna carries a sealskin [pouch](3-Mechanics/CLI/items/pouch-xphb.md) that holds six [bloodstones](3-Mechanics/CLI/items/bloodstone-xdmg.md) (50 gp each). Korux carries 15 gp in a yeti fur-lined leather [pouch](3-Mechanics/CLI/items/pouch-xphb.md). Storn carries a rusty iron lock (3 gp) as a good luck charm; he lost the key that opens it.

### Search for the Sled

If the characters agree to complete this quest, Hruna points them in the direction they must travel—straight toward Kelvin's Cairn. The [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) lies halfway between Bryn Shander and Kelvin's Cairn, in the middle of the tundra.

#### Blizzard

When the characters get within a couple miles of the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md), a blizzard sweeps down from the north and engulfs them:
...
When the characters arrive at the location where the dwarves were forced to abandon their [sled](3-Mechanics/CLI/items/dogsled-idrotf.md), read:
...
Characters who inspect the tracks around the corpse can, with a successful DC 10 [Survival](3-Mechanics/CLI/rules/skills.md#Survival) (Wisdom) check, determine that they are fresh (made in the past hour) and belong to a half-dozen Small humanoids wearing [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md). The tracks lead south. Characters who follow them for a half-hour catch up to the goblins, who are hindered by the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) they're hauling.
...
These goblins were rolling across the tundra when their advance scout, a trained [hawk](3-Mechanics/CLI/bestiary/beast/hawk-xmm.md), spotted the abandoned [sled](3-Mechanics/CLI/items/dogsled-idrotf.md). The one-eared [goblin boss](3-Mechanics/CLI/bestiary/fey/goblin-boss-xmm.md), Izobai, sent six [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) forth to seize the sled and its cargo, while she and two [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) stayed behind to guard the wagon and keep an eye on the two [polar bears](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) that pull it.

At the start of the encounter, the characters are 120 feet behind the [sled](3-Mechanics/CLI/items/dogsled-idrotf.md), and the goblins' wagon is 120 feet farther still. The goblins hauling the sled are too distracted to notice they're being followed, so the characters have surprise.

The [sled](3-Mechanics/CLI/items/dogsled-idrotf.md) weighs 300 pounds, and the iron ingots add another 600 pounds of weight to it. A single goblin can push or drag 240 pounds, so it takes at least four of them to move the sled. If they come under attack, the goblins take cover behind the sled and retaliate with ranged attacks. On the goblins' first turn in combat, one of them blows a horn to alert Izobai, who climbs to the roof of the wagon with a lit torch in one hand and her hooded hawk perched on her other arm. From this perch, she watches the battle unfold. If she spots enemies within 60 feet of the wagon, she orders the two goblins inside the wagon to shoot arrows at these enemies through gaps in the wagon's walls. These two goblins have three-quarters cover.
...
Izobai carries two [potions of animal friendship](3-Mechanics/CLI/items/potion-of-animal-friendship-xdmg.md) and a sealskin [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 13 sp, 25 cp, and a bone whistle (1 sp). The other goblins each carry `dice:1d6|noform|noparens|avg` (`1d6`) cp in sealskin [pouch](3-Mechanics/CLI/items/pouch-xphb.md)es.

![Two surly polar bears pull a goblin wagon across the snowy tundra](file://adventure/IDRotF/022-01-011.polar-bears.webp#center)

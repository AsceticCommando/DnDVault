...
> [!gallery]
> ![Page 1](file://adventure/IDRotF/193-character-secrets-page-1.webp#gallery)
> ![Page 2](file://adventure/IDRotF/194-character-secrets-page-2.webp#gallery)

## Alagondar Scion

![](file://adventure/IDRotF/195-AppB-Secret-Alagondar-Scion.webp#center)

*Prerequisite: You must be a [human](3-Mechanics/CLI/races/human-xphb.md), [half-elf](3-Mechanics/CLI/races/khoravar-efa.md), or [half-orc](3-Mechanics/CLI/races/half-orc.md) to have this secret. If you don't meet this prerequisite, draw a different card.*
...
![](file://adventure/IDRotF/196-AppB-Secret-Doppelganger.webp#center)
...
- I can innately cast [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md), requiring no components. My spellcasting ability is Intelligence. The spell's Wisdom save DC is 8 + my proficiency bonus + my Intelligence modifier.  
...
![](file://adventure/IDRotF/197-AppB-Secret-Drizzt-Fan.webp#center)
...
![](file://adventure/IDRotF/198-AppB-Secret-Elusive-Paramour.webp#center)
...
![](file://adventure/IDRotF/199-AppB-Secret-Escaped-Prisoner.webp#center)
...
![](file://adventure/IDRotF/200-AppB-Secret-Littlest-Yeti.webp#center)
...
![](file://adventure/IDRotF/201-AppB-Secret-Midwinter-Child.webp#center)

Auril the Frostmaiden has blessed me, for I was born on the Midwinter holiday. I have resistance to cold damage.

## Old Flame

![](file://adventure/IDRotF/202-AppB-Secret-Old-Flame.webp#center)
...
![](file://adventure/IDRotF/203-AppB-Secret-Orc-Stone.webp#center)
...
![](file://adventure/IDRotF/204-AppB-Secret-Owlbear-Whisperer.webp#center)

Owlbears are predisposed to like me.

If I am within 10 feet of an [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md), I can use an action to make a DC 10 Charisma ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. On a success, I change the owlbear's attitude toward me from hostile to indifferent or from indifferent to friendly.

## Pirate Cannibal

![](file://adventure/IDRotF/205-AppB-Secret-Pirate-Cannibal.webp#center)
...
![](file://adventure/IDRotF/206-AppB-Secret-Reghed-Heir.webp#center)
...
![](file://adventure/IDRotF/207-AppB-Secret-Reincarnation.webp#center)

I died and was brought back to life by a friendly human druid using the [reincarnate](3-Mechanics/CLI/spells/reincarnate-xphb.md) spell. I have no idea what became of the druid, whose name I don't know. I retain the memories of my previous life, some or all of which was spent in Icewind Dale. (Roll on the table in the spell's description to determine your character's previous race, or choose a race from the table that you like, then flesh out the story of your previous life.)

## Ring Hunter

![](file://adventure/IDRotF/208-AppB-Secret-Ring-Hunter.webp#center)
...
![](file://adventure/IDRotF/209-AppB-Secret-Runaway.webp#center)
...
![](file://adventure/IDRotF/210-AppB-Secret-Slaad.webp#center)

A [red slaad](3-Mechanics/CLI/bestiary/aberration/red-slaad-xmm.md) implanted a pellet-sized egg in me shortly before I started my adventuring career. If I can't get rid of it in the next two months, the egg will gestate inside me, and a slaad tadpole will burst from my chest, killing me. It will then quickly grow into an adult slaad and kill even more people.

## Spy

![](file://adventure/IDRotF/211-AppB-Secret-Spy.webp#center)
...
My only Harper contact in Ten-Towns is a human named [Beldora](3-Mechanics/CLI/bestiary/npc/beldora-skt.md), who poses as a homeless woman and spends her days gathering information in Bryn Shander.
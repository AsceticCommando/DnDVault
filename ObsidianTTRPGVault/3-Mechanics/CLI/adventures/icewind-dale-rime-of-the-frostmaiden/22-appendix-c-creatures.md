...
Several of the creatures in this appendix are common beasts—foxes, hares, mountain goats, seals, sperm whales, and walruses—that live among other beasts from the "Monster Manual", such as polar bears, deer, elk, [reindeer](3-Mechanics/CLI/bestiary/beast/reindeer-idrotf.md) (use the [elk](3-Mechanics/CLI/bestiary/beast/elk-xmm.md) stat block), killer whales, mammoths, moose (use the [giant goat](3-Mechanics/CLI/bestiary/beast/giant-goat-xmm.md) stat block), saber-toothed tigers, snowy owls, woolly rhinoceroses, and wolves. And then there's the notoriously ugly knucklehead trout, without which there would be no Ten-Towns.

If the adventuring party includes a wizard who can prepare the [find familiar](3-Mechanics/CLI/spells/find-familiar-xphb.md) spell, consider allowing the wizard to add the [fox](3-Mechanics/CLI/bestiary/beast/fox-idrotf.md) and the [hare](3-Mechanics/CLI/bestiary/beast/hare-idrotf.md) to the spell's list of eligible familiars.

![](file://adventure/IDRotF/212-08-003.webp#center)
...
- [Brain in a Jar](3-Mechanics/CLI/bestiary/undead/brain-in-a-jar-rhw.md)  
...
![](file://adventure/IDRotF/235-08-011.goliath-warrior.webp#center)

### Goliath Player Characters

With your consent, any player in your game can play a [goliath](3-Mechanics/CLI/races/goliath-xphb.md) character. A goliath native to Icewind Dale can be a member of the Skytower (Akannathi) clan, the Wyrmdoom (Thuunlakalaga) clan, or another goliath clan that you and the player create together.

### Spine of the World Goliaths

Goliaths inhabit the Spine of the World, where their mettle is tested against [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md), [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), [remorhazes](3-Mechanics/CLI/bestiary/monstrosity/remorhaz-xmm.md), [ice trolls](3-Mechanics/CLI/bestiary/giant/ice-troll-idrotf.md), [young white dragons](3-Mechanics/CLI/bestiary/dragon/young-white-dragon-xmm.md), the treacherous mountain terrain, and the cruel indifference of nature.
...
| Role | Stat Block |
|------|------------|
| Hunter or [warrior](3-Mechanics/CLI/bestiary/humanoid/reghed-warrior-idrotf.md) | [Tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) with [Survival](3-Mechanics/CLI/rules/skills.md#Survival) [Survival](3-Mechanics/CLI/rules/skills.md#Survival) (`dice:1d20+4\|noform\|noparens\|text(+4)`); speaks Common |
| [Shaman](3-Mechanics/CLI/bestiary/humanoid/reghed-shaman-idrotf.md) | [Druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) with [Survival](3-Mechanics/CLI/rules/skills.md#Survival) [Survival](3-Mechanics/CLI/rules/skills.md#Survival) (`dice:1d20+4\|noform\|noparens\|text(+4)`); speaks Common and Druidic |
| [Clan chieftain](3-Mechanics/CLI/bestiary/humanoid/reghed-chieftain-idrotf.md) or [great warrior](3-Mechanics/CLI/bestiary/humanoid/reghed-great-warrior-idrotf.md) | [Gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) with [hide armor](3-Mechanics/CLI/items/hide-armor-xphb.md) instead of [studded leather](3-Mechanics/CLI/items/studded-leather-armor-xphb.md) and [Survival](3-Mechanics/CLI/rules/skills.md#Survival) [Survival](3-Mechanics/CLI/rules/skills.md#Survival) (`dice:1d20+5\|noform\|noparens\|text(+5)`); speaks Common |
^reghed-tribesfolk

![Reghed hunters of the four tribes](file://adventure/IDRotF/249-08-016.reghed.webp#center)
...
As if she weren't fearsome enough, Bjornhild has a pet [saber-toothed tiger](3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm.md) named Grava.

![Queen Bjornhild Solvigsdottir and her saber-toothed tiger, Grava](file://adventure/IDRotF/250-08-015.bjornhild.webp#center)

...
![Two young children from Lonelywood go ice fishing on Maer Dualdon](file://adventure/IDRotF/000-00-000.intro-splash.webp#center)
...
![Fragments of chardalyn—the remains of an evil artifact—are scattered throughout Icewind Dale.](file://adventure/IDRotF/001-00-001.webp#center)
...
![The yeti of Icewind Dale like to stalk their prey in raging blizzards](file://adventure/IDRotF/004-00-004.yeti-splash.webp#center)

#### Extreme Cold

Rules for [extreme cold](3-Mechanics/CLI/traps-hazards/extreme-cold-xdmg.md) appear in the "Dungeon Master's Guide" but are repeated here for your convenience.

A creature exposed to the cold must succeed on a DC 10 Constitution saving throw at the end of each hour or gain one level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Creatures with resistance or immunity to cold damage automatically succeed on the saving throw, as do creatures wearing [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md) (thick coats, gloves, and the like) and creatures naturally adapted to cold climates, such as [reindeer](3-Mechanics/CLI/bestiary/beast/reindeer-idrotf.md) and [snowy owlbears](3-Mechanics/CLI/bestiary/monstrosity/snowy-owlbear-idrotf.md).
...
The fastest way to travel across the tundra is by [dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md) (see "Getting Around Ten-Towns"). But dogs are expensive and require food, water, and shelter. Unless they have more equipment than they can carry, adventurers are better off traveling on foot.
...
|------------------|-------------------|
| [Dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md) | 1 mile |
| On foot, with [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) | 1/2 mile |
| On foot, without [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) | 1/4 mile |
^overland-travel
...
The Mountain Travel table shows how fast the characters can move through the mountains on foot or by [dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md). Even in the best of cases, a journey in the mountains takes twice as long as one of the same distance across the tundra.

**Mountain Travel**

| Method of Travel | Distance per Hour |
|------------------|-------------------|
| [Dogsled](3-Mechanics/CLI/items/dogsled-idrotf.md) | 1/2 mile |
| On foot, with [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) | 1/4 mile |
| On foot, without [snowshoes](3-Mechanics/CLI/items/snowshoes-idrotf.md) | 1/8 mile |
^mountain-travel
...
| [Arveiaturace](3-Mechanics/CLI/bestiary/npc/arveiaturace-idrotf.md) | ar-vay-AH-chur-us | Ancient white dragon known as the White Wyrm |
...
| [Duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) | DEW-ur-gar or DWAIR-gar | Evil, gray-skinned dwarves that dwell in the Underdark |
| [Dzaan](3-Mechanics/CLI/bestiary/npc/dzaan-idrotf.md) | duh-ZAWN | Red Wizard of Thay and member of the Arcane Brotherhood |
...
|------------|----------------|
| [Acolyte](3-Mechanics/CLI/backgrounds/acolyte-xphb.md) | Auril the Frostmaiden, the god of winter's fury, has cast an evil spell over Icewind Dale. You can bring hope and faith to the people of Ten-Towns or, even better, free them from winter's cold embrace in the name of your god. |
| [Charlatan](3-Mechanics/CLI/backgrounds/charlatan-xphb.md) | Your cons and deceptions nearly got the better of you. You needed to disappear for a while, and Icewind Dale was the perfect place to do so. Nothing could prepare you for the cold and the dark desolation, but at least there's money to be made. |
| [Criminal](3-Mechanics/CLI/backgrounds/criminal-xphb.md) | You are wanted for crimes in the cities of Luskan and Mirabar, but no one will think to look for you in Ten-Towns, the cold heart of Icewind Dale. Thankfully, nobody in Ten-Towns cares who you are—or what you've done. |
...
| [Hermit](3-Mechanics/CLI/backgrounds/hermit-xphb.md) | You've never felt at ease in civilized society, and there's no place farther from the trappings of civilization than Icewind Dale. This is a land without pretense, and the people of Ten-Towns pay you little mind. To them, you're just another silly old fool. |
| [Noble](3-Mechanics/CLI/backgrounds/noble-xphb.md) | Your wealthy grandfather or grandmother sent you to Icewind Dale to learn a hard lesson. Perhaps the cruel indifference of this frozen land will prepare you for the cruel indifference of Waterdeep's politics. |
...
| [Sage](3-Mechanics/CLI/backgrounds/sage-xphb.md) | You came to Icewind Dale in search of ruins and artifacts left behind by the giants who ruled the ancient empire of Ostoria. To find even one Ostorian relic would fulfill a lifelong dream and make your rivals back home green with envy. |
| [Sailor](3-Mechanics/CLI/backgrounds/sailor-xphb.md) | You've sailed ships up and down the Sword Coast, but a shipwreck made you reevaluate your life choices. Two years ago, you headed north, bought a house and a fishing boat in Ten-Towns, and became a fisher. You were told that the summers here are beautiful, but you have yet to see one. |
| [Soldier](3-Mechanics/CLI/backgrounds/soldier-xphb.md) | You are a soldier of Ten-Towns, trained to fight orcs and other threats lurking in the Spine of the World mountains. Auril the Frostmaiden has cast an evil spell over Icewind Dale, and you struggle to see how your soldier's training can save this land from so terrible a doom. Still, you are not about to give up on the people of Ten-Towns. |
...
All characters begin the adventure with a free set of [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md) in addition to the starting equipment they receive from their class and background choices. See "Winter Survival Gear", for more information about [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md).
...
At some point, Lord Dagult Neverember might send a lone [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)—a nameless, middle-aged woman with a shaved head and a hook for a right hand—to kill the character who has this secret.
...
This secret is another nod to the Drizzt novels, setting up a situation like the one faced by Regis the halfling. At a time of your choosing, you can have the disgruntled pasha's assassin, an [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md), show up to menace the character.

##### Escaped Prisoner

The character with this secret knows the location of the crashed nautiloid in chapter 2 and can lead the party to it. The trauma of being held captive by the illithids prevents the character from remembering events prior to the crash. A [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell removes this trauma, allowing the character to remember details about the illithids as well as the other prisoners aboard the nautiloid when it crashed (a bulette and two carrion crawlers).
...
The spirit summoned by the stone belongs to a fierce [orc war chief](3-Mechanics/CLI/bestiary/humanoid/tough-boss-xmm.md) named Vokarr the Eyebiter, who was killed by dwarves. This spirit looks like a living, breathing orc. It speaks Common and Orc.
...
Allow the player to flesh out the details of the character's life prior to being reincarnated, and try to imagine how that back story might tie into some part of the adventure. Some of the races listed in the [reincarnate](3-Mechanics/CLI/spells/reincarnate-xphb.md) spell's table go by different names in the Realms, as noted in the Forgotten Realms Races table. If the player wants to randomly determine the character's cause of death, let them roll on the How I Died table.

![Harboring a secret for too long can be detrimental to one's health](file://adventure/IDRotF/005-00-005.red-slaad-surprise.webp#center)

**Forgotten Realms Races**

| Race | Realms Version |
|------|----------------|
| [Dwarf, hill](3-Mechanics/CLI/races/dwarf-xphb.md) | Dwarf, gold |
| [Dwarf, mountain](3-Mechanics/CLI/races/dwarf-xphb.md) | Dwarf, shield |
| [Elf, high](3-Mechanics/CLI/races/elf-xphb.md) | Elf, moon or sun |
| [Elf, wood](3-Mechanics/CLI/races/elf-xphb.md) | Elf, wild or wood |
| [Halfling, stout](3-Mechanics/CLI/races/halfling-xphb.md) | Halfling, strongheart |
^forgotten-realms-races
...
Worshipers of Asmodeus send three [bearded devils](3-Mechanics/CLI/bestiary/fiend/bearded-devil-xmm.md) (whose fiendish features are cloaked by [cold weather clothing](3-Mechanics/CLI/items/clothing-cold-weather-idrotf.md)) to kill the character who has this secret. If the characters visit Caer-Dineval, the Knights of the Black Sword (see "Knights of the Black Sword"), as followers of Levistus rather than Asmodeus, might warn the characters that an attack on one of them is imminent and even offer sanctuary in Caer-Dineval's keep.

##### Slaad Host

The exact timing of the slaad tadpole's birth is deliberately left vague, although there are a few places in the adventure where the text suggests that the emergence might occur then and there. See the slaadi entry in the "Monster Manual" for more information about red slaad eggs and slaad tadpoles. Any magic that can cure a disease can end this threat, provided the cure is administered before the [slaad tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from the character's chest.

##### Spy

Harpers assigned to Icewind Dale can't rely on much support from the organization, so they are expected to look after themselves. Beldora, the character's Harper contact in Bryn Shander, is a chaotic good human [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) who can help steer the adventure by sharing rumors and providing helpful advice.
...
![](file://adventure/IDRotF/081-01-040.termalaine.webp#center)
...
Termalaine can muster up to 50 soldiers (use the [tribal warrior](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 4 [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
> [!gallery]
> ![Map 1.18: Termalaine](file://adventure/IDRotF/082-map-1.18-termalaine.webp#gallery)
> ![Player Version](file://adventure/IDRotF/083-map-1.18-termalaine-player.webp#gallery)
...
The innkeeper is Marta Peskryk (lawful good human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), a willowy teenager who spends much of her time tending to her bedridden father, Clyde, a retired fisherman and noncombatant. As she performs her daily chores, Marta sings the following song to herself:
...
Marta wears the mysterious woman's ring (which she has inherited) around her neck on a chain. It is a [ring of warmth](3-Mechanics/CLI/items/ring-of-warmth-xdmg.md), and Marta will part with it only if she can be convinced that it can help bring an end to the wintry curse that besets Icewind Dale.
...
> [!gallery]
> ![Map 1.19: Gem Mine](file://adventure/IDRotF/085-map-1.19-gem-mine.webp#gallery)
> ![Player Version](file://adventure/IDRotF/086-map-1.19-gem-mine-player.webp#gallery)
...
The two [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) are aggressive, giving chase if the characters run away.
...
![The true monster of the mine reveals itself](file://adventure/IDRotF/087-01-042.grell.webp#center)
...
![Trex](file://adventure/IDRotF/088-01-043.trex.webp#center)

...
In solo play, there's always a chance the character can die. In the case of a single adventurer, this death results in the end of play; which isn't optimal for an afternoon of fun! One way to avoid death is to have healing readily available to the adventurer. If they're without healing, have the character find the odd [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) lying in a dusty crate or have them discover a special healing plant on their journey that, if eaten, puts them back to full hit points.
...
Begin play in the sparring room of the Critical Strike Combat School where Orange is exercising and practicing various skills with the sword. In the training room, Orange has access to one energy drink which acts as a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
If Orange gets into trouble during the fight with the goons, have a warrior from the Lorekeeper Society (a [guard](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) who's a former student of Orange's kick down the door and come to the rescue.
...
If Orange agrees to help, Mr. Honeycutt offers a reward of 20 gp for the return of the gem. He also gives Orange a [necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md) with one bead remaining. As he gives the item to Orange, Mr. Honeycutt says, "I hope you never have to use this."
...
![](file://adventure/NRH-ASS/006.webp#center)
...
The staircase leads down to a corridor that ends in a rotting wood door which can be easily opened or broken down. However, lurking on the ceiling of this corridor is a [gray ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md).
...
If Orange listens at the door to this tomb before opening it, they hear tapping or clacking sounds. Opening the door reveals two [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) repeatedly bumping into each other. When the door opens, they attack.
...
Orange has discovered a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md) that's behaving oddly!

##### Encounter Adjustments

The gelatinous cube is weakened from its attempts to digest the Peach Gem and a magic sword, both of which it has engulfed. When Orange discovers the [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md), it only has 40 hit points remaining and it doesn't have its Transparent trait.

##### Defeating the Cube

Even in its weakened stat, a gelatinous cube is no easy task. Hopefully, Orange uses the last bead of the necklace of fireballs to finish off the cube. If that doesn't work, have [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md) arrive with four [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) to help Orange defeat the cube. Have the cube attack the guards first before attacking Mr. Honeycutt or Orange.
...
If Orange is engulfed, the fighter can attempt to grab items from within the gelatinous cube. Roll a `dice:d6|noform|noparens|avg` (`d6`) (rerolling duplicates) to determine what Orange retrieves from the table below:
...
| dice: d6 | Treasure |
|----------|----------|
| 1 | [+1 greatsword](3-Mechanics/CLI/items/1-weapon-xdmg.md) |
| 2 | [Potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) |
| 3 | [Ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md) |
| 4 | Two metal gambling dice |
| 5 | The Peach Gem |
| 6 | Brass bell |
^gelatinous-cube-treasures

When the gelatinous cube is reduced to 24 hit points or fewer, it spits out the [+1 greatsword](3-Mechanics/CLI/items/1-weapon-xdmg.md), the [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and the glowing orange gem (the Peach Gem), and makes its retreat by dashing away.
...
- [Weapon, +1](3-Mechanics/CLI/items/1-weapon-xdmg.md)  

![](file://adventure/NRH-ASS/sheet005.webp#center)

![](file://adventure/NRH-ASS/sheet006.webp#center)
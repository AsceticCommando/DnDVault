...
![Shemshime's Bedtime Rhyme](file://adventure/CM/042-06-001.Book.webp#center)
...
![](file://adventure/CM/043-06-002.handout.webp#center)
...
- Instead of a rapier, [Varnyr](3-Mechanics/CLI/bestiary/npc/varnyr-cm.md) wields a cane and can use an action to make two melee weapon attacks with it: `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit*: `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) bludgeoning damage.  
...
- As an action, [K'Tulah](3-Mechanics/CLI/bestiary/npc/ktulah-cm.md) can make a melee weapon attack with her claws: `dice:1d20+2|noform|noparens|text(+2)` to hit, reach 5 ft., one target. *Hit*: `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) slashing damage.  
...
![Crinkle](file://adventure/CM/044-06-003.Crinkle.webp#center)
...
![Scenes in the Opened Book](file://adventure/CM/045-06-004.scenes-in-the-opened-book.webp#center)
...
![Shemshime](file://adventure/CM/046-637514193181534197.webp#center)
...
> [!gallery]
> ![Map 6.1: Firefly Cellar](file://adventure/CM/047-map-6.01-firefly-cellar.webp#gallery)
> ![Player Version](file://adventure/CM/048-map-6.01-firefly-cellar-player.webp#gallery)

...
![Lore of Lurue](file://adventure/CM/077-10-001.lore-of-lurue.webp#center)
...
| 10–13 | A nearby tree bleeds gold sap. A successful DC 16 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) or Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check reveals that the sap has healing properties. (The satyrs know about these properties.) Anyone who consumes the sap regains `dice:2d4+2\|noform\|noparens\|avg` (`2d4 + 2`) hit points. The tree has enough sap for four doses. |
...
![Dewlight](file://adventure/CM/078-10-002.dewlight.webp#center)
...
> [!gallery]
> ![Map 10.1: Hags Hovel](file://adventure/CM/079-map-10.01-hags-hovel.webp#gallery)
> ![Player Version](file://adventure/CM/080-map-10.01-hags-hovel-player.webp#gallery)
...
> [!gallery]
> ![Map 10.2: Pool of Eternal Spring](file://adventure/CM/081-map-10.02-pool-of-eternal-spring.webp#gallery)
> ![Player Version](file://adventure/CM/082-map-10.02-pool-of-eternal-spring-player.webp#gallery)
...
![Corrupted Avatar of Lurue](file://adventure/CM/083-637514193128459607.webp#center)
...
If the characters defeated the corrupted unicorn before Selûne intervened, and thus they feel deserving of a reward, they might discover that Lurue herself has provided them with one. Sitting on the front cover of the book as the characters emerge from the demiplane is a moonstone and opal ring. A successful DC 18 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check reveals this to be a [ring of shooting stars](3-Mechanics/CLI/items/ring-of-shooting-stars-xdmg.md). In addition, each character is the recipient of a supernatural gift from Lurue: a [charm of animal conjuring](3-Mechanics/CLI/rewards/charm-of-animal-conjuring-xdmg.md) (see ""Charms"" in the "Dungeon Master's Guide").
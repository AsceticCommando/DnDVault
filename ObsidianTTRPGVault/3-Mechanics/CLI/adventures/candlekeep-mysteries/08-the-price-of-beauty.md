...
![The Price of Beauty](file://adventure/CM/050-07-001.Book.webp#center)
...
![Azirssa, Greensong, and Morganna](file://adventure/CM/051-07-002.azirssa.webp#center)
...
A creature can use an action to try to destroy a painting, doing so with a successful DC 18 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. On a failed check, the creature takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) psychic damage. Any character who uses an action to examine the painting knows, with a successful DC 18 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check, that the painting can also be destroyed by splashing it with fresh blood from a celestial.
...
> [!gallery]
> ![Map 7.1: Temple of the Restful Lily](file://adventure/CM/052-map-7.01-temple-of-the-restful-lily.webp#gallery)
> ![Player Version](file://adventure/CM/053-map-7.01-temple-of-the-restful-lily-player.webp#gallery)
...
![Naiad](file://adventure/CM/054-637266349920661945.webp#center)
...
Submerged in the pool is [Radiance](3-Mechanics/CLI/items/radiance-cm.md), a [+1 wand of the war mage](3-Mechanics/CLI/items/1-wand-of-the-war-mage-xdmg.md) in the form of an exquisite golden hand mirror. While surrounded by darkness, it sheds dim light in a 5-foot radius. A creature that is attuned to Radiance can use a bonus action while holding the mirror to cast the [enhance ability](3-Mechanics/CLI/spells/enhance-ability-xphb.md) spell, choosing itself and no other creature as the spell's target. Once this property of the wand is used, it can't be used again until the next dawn. The wand is Sylvarie's, but she offers it to the characters as a reward for ending her curse.

> [!gallery]
> ![Map 7.2: Temple of the Restful Lily—Tower Floors](file://adventure/CM/055-map-7.02-temple-of-the-restful-lily.webp#gallery)
> ![Player Version](file://adventure/CM/056-map-7.02-temple-of-the-restful-lily-player.webp#gallery)

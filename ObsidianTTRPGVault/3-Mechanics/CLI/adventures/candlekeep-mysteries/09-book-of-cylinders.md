...
![Book of Cylinders](file://adventure/CM/058-08-001.Book-of-cylinders.webp#center)
...
![Wooden Cylinders](file://adventure/CM/059-08-002.wooden-cylinders.webp#center)
...
As the characters move, they must make a successful DC 20 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) group check every 100 feet to avoid attracting giant crabs. If any group check fails, `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) [giant crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md) claw their way out of their cages and attack the characters.
...
![Crab Maze](file://adventure/CM/060-08-003.Crab-maze.webp#center)
...
> [!gallery]
> ![Map 8.1: Grippli Village](file://adventure/CM/061-map-8.01-grippli-village.webp#gallery)
> ![Player Version](file://adventure/CM/062-map-8.01-grippli-village-player.webp#gallery)
...
> [!gallery]
> ![Map 8.2: Temple](file://adventure/CM/063-map-8.02-temple.webp#gallery)
> ![Player Version](file://adventure/CM/064-map-8.02-temple-player.webp#gallery)
...
![Grippli Warrior](file://adventure/CM/065-637514193136770284.webp#center)

...
![](file://adventure/WDMM/030-10-01.webp#center)
...
- Each troglodyte wears a [breastplate](3-Mechanics/CLI/items/breastplate-xphb.md) (AC 14) and wields a [longsword](3-Mechanics/CLI/items/longsword-xphb.md), which it uses instead of its claws.  
...
Adventurers exploring areas 13 through 30 are likely to encounter one or more drow patrols, each consisting of `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) wearing the insignia of House Auvryndar. The leader of such a patrol is always a female drow who reports directly to [Zress Orlezziir](3-Mechanics/CLI/bestiary/npc/zress-orlezziir-wdmm.md). Most drow patrols are spoiling for a fight; if a battle turns against them, however, they withdraw to a more defensible location.
...
> [!gallery]
> ![Map 10](file://adventure/WDMM/031-10-02.webp#gallery)
> ![Player Version](file://adventure/WDMM/032-10-03.webp#gallery)
...
- The northern corpse (that of Kravos, a tiefling rogue) wears [leather armor](3-Mechanics/CLI/items/leather-armor-xphb.md) and clutches a [shortsword](3-Mechanics/CLI/items/shortsword-xphb.md). Necrotic energy causes his flesh to shrivel.  
- The southern corpse (that of Zundra Underdottir, a dwarf barbarian) wears [hide armor](3-Mechanics/CLI/items/hide-armor-xphb.md) and has a [greataxe](3-Mechanics/CLI/items/greataxe-xphb.md) lying nearby. Her face is frozen in a horrific scream.  
...
![Obsidian Scarabs of Houses Freth and Auvryndar](file://adventure/WDMM/033-10-04.webp#center)
...
Gorzil's hoard includes 500 cp, 350 sp, 60 gp, a healer's kit, four torches, a rotted quiver containing seven [silvered arrows](3-Mechanics/CLI/items/silvered-ammunition.md), and a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) in a crystal vial with a spider-shaped stopper.
...
- Each has a Charisma of 14 and the following skill: [Performance](3-Mechanics/CLI/rules/skills.md#Performance) [Performance](3-Mechanics/CLI/rules/skills.md#Performance) (`dice:1d20+4|noform|noparens|text(+4)`).  
...
![](file://adventure/WDMM/034-10-05.webp#center)
...
This chamber contains two dozen wooden cots in rows. Resting in six of them are wounded [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) (three females and three males), each with `dice:1d12|noform|noparens|avg` (`1d12`) hit points remaining. They are still clad in armor, and they keep their weapons within arm's reach.

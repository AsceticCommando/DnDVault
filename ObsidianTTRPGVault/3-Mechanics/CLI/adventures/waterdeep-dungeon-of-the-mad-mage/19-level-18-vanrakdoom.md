...
![](file://adventure/WDMM/057-18-01.webp#center)
...
Keresta is a 9th-level spellcaster. Her spellcasting ability is Wisdom (spell save DC 15, `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks). She has the following cleric spells prepared:
...
> [!gallery]
> ![Map 18](file://adventure/WDMM/058-18-02.webp#gallery)
> ![Player Version](file://adventure/WDMM/059-18-03.webp#gallery)
...
If the characters have had an easy time thus far, Keresta might send waves of [vampire spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) to harangue them as they make their way through these candlelit halls. The [vampire spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) attack in packs of `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) and avoid the pit traps in areas 12c and 12d by crawling along the walls.
...
Any creature that moves through the curtain must make a DC 17 Constitution saving throw, taking `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) necrotic damage on a failed save, or half as much damage on a successful one. The greater danger of the curtain is less obvious: if the double door is forced open, six [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) emerge from the curtain and attack, pursuing creatures that flee. A wraith that has nothing to attack on its turn enters the shadow curtain and vanishes. The wraiths don't appear once the curtain disappears.
...
- His [Stealth](3-Mechanics/CLI/rules/skills.md#Stealth) skill modifier is [Stealth](3-Mechanics/CLI/rules/skills.md#Stealth) (`dice:1d20+10|noform|noparens|text(+10)`).  

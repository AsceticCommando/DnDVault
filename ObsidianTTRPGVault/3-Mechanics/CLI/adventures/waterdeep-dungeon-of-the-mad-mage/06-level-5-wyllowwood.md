...
![](file://adventure/WDMM/015-501.webp#center)
...
Wyllowwood is a thriving ecosystem. The woods support [awakened shrubs](3-Mechanics/CLI/bestiary/plant/awakened-shrub-xmm.md), [awakened trees](3-Mechanics/CLI/bestiary/plant/awakened-tree-xmm.md), [bats](3-Mechanics/CLI/bestiary/beast/bat-xmm.md), [bears](3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md), [blink dogs](3-Mechanics/CLI/bestiary/fey/blink-dog-xmm.md), [boars](3-Mechanics/CLI/bestiary/beast/boar-xmm.md), [deer](3-Mechanics/CLI/bestiary/beast/deer-xmm.md), [elk](3-Mechanics/CLI/bestiary/beast/elk-xmm.md), rodents, small birds, and other denizens of temperate forests. Carrion crawlers, ettercaps, giant spiders, and owlbears make occasional forays into the woods as well.
...
> [!gallery]
> ![Map 5](file://adventure/WDMM/016-502.webp#gallery)
> ![Player Version](file://adventure/WDMM/017-503.webp#gallery)
...
The river's depth varies from a few feet to as much as 30 feet in spots. Characters who trawl the depths for treasure might find the odd bauble here and there, or possibly something more dangerous like a sleeping [hydra](3-Mechanics/CLI/bestiary/monstrosity/hydra-xmm.md).
...
Haddon's corpse wears a salvageable suit of halfling-sized leather armor. It clutches a [silvered shortsword](3-Mechanics/CLI/items/silvered-weapon-xdmg.md) in one hand and a burnt torch stub in the other. A search of the corpse yields a dungeoneer's pack with spoiled rations and 5 torches remaining, and a small pouch containing 4 gp.
...
Characters who clear away the dust can see the objects on the table more clearly: a suit of [hide armor of resistance (lightning)](3-Mechanics/CLI/items/armor-of-resistance-xdmg.md) made of stitched rothé hide and fur, a [silvered scimitar](3-Mechanics/CLI/items/silvered-weapon-xdmg.md), and a leather quiver containing 20 [silvered arrows](3-Mechanics/CLI/items/silvered-ammunition.md). The staff leaning against the table is a [silvered quarterstaff](3-Mechanics/CLI/items/silvered-weapon-xdmg.md).

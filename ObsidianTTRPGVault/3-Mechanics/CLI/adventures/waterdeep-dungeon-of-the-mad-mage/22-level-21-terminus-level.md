...
![](file://adventure/WDMM/068-21-01.webp#center)
...
> [!gallery]
> ![Map 21](file://adventure/WDMM/069-21-02.webp#gallery)
> ![Player Version](file://adventure/WDMM/070-21-03.webp#gallery)
...
If anyone opens the secret door, the ultroloth appears and tries to slay them. It ignores those who leave the secret door alone, allowing them to move through the area unmolested. If threatened by three or more enemies, it tries to summon `dice:1d6|noform|noparens|avg` (`1d6`) [mezzoloths](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md), `dice:1d4|noform|noparens|avg` (`1d4`) [nycaloths](3-Mechanics/CLI/bestiary/fiend/nycaloth-xmm.md), or another [ultroloth](3-Mechanics/CLI/bestiary/fiend/ultroloth-xmm.md) (see the "Variant: Yugoloth Summoning" sidebar in the "Yugoloths" entry in the "Monster Manual").

...
![](file://adventure/WDMM/004-201.webp#center)
...
> [!gallery]
> ![Map 2](file://adventure/WDMM/005-202.webp#gallery)
> ![Player Version](file://adventure/WDMM/006-203.webp#gallery)
...
The summoning circle hidden under the rug radiates an aura of abjuration magic under the scrutiny of a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, but three of its activation glyphs have been erased. A character who examines the circle and succeeds on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check can reconstruct the circle and, with blood or paint, reapply the missing glyphs in `dice:1d10|noform|noparens|avg` (`1d10`) minutes.
...
Rex's backpack lies next to one of the mine carts. It contains a [silvered shortsword](3-Mechanics/CLI/items/silvered-weapon-xdmg.md), a 30-foot-long coil of hempen rope, 2 days of rations, a flask of oil, a pouch containing 13 gp, and a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). The oil lantern in the middle of the room belongs to Rex as well.
...
The torch brackets bolted to the walls are beyond the rust monsters' reach but make irresistible snacks if fed to the creatures. Tearing loose a torch bracket requires an action and a successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. One bracket is enough to distract the rust monsters for `dice:1d6|noform|noparens|avg` (`1d6`) minutes.
...
Dense webbing fills this room as well (see area 19c for rules). Suspended within the webs are six cocoons. Five contain the desiccated corpses of four goblins and a nothic. The sixth contains a [swarm of insects (spiders)](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) that bursts forth and attacks if the cocoon is torn open.

##### Treasure

The dead nothic has no treasure. A thorough search of the goblin corpses yields 20 cp, 18 sp, 5 gp, and a [silvered dagger](3-Mechanics/CLI/items/silvered-weapon-xdmg.md).
...
![](file://adventure/WDMM/007-204.webp#center)

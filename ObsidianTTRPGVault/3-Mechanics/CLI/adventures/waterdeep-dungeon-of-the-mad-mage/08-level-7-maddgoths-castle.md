...
![](file://adventure/WDMM/021-701.webp#center)
...
- It has a Strength score of <span title='Strength'>`18` (`dice:d20+4|noform|noparens|text(+4)`)</span>, and its bite attack deals `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) piercing damage on a hit.  
...
- It has a Strength score of <span title='Strength'>`15` (`dice:d20+2|noform|noparens|text(+2)`)</span>, and its bite attack deals `dice:2d6+2|noform|noparens|avg|text(9)` (`2d6 + 2`) piercing damage on a hit.  
...
> [!gallery]
> ![Map 7](file://adventure/WDMM/022-702.webp#gallery)
> ![Player Version](file://adventure/WDMM/023-703.webp#gallery)
...
> [!note] 
> 
> **Decor**. The wood-paneled walls are decorated with six framed portraits of a fat, smiling wizard clutching a [wand](3-Mechanics/CLI/bestiary/construct/flying-wand-wdmm.md). A thick, brown, wall-to-wall carpet covers the floor.
> 
...
> 
> **Tridents**. Four [tridents](3-Mechanics/CLI/bestiary/construct/flying-trident-wdmm.md) hang on the north and east walls between the arrow slits. They fly off the walls and attack if certain conditions are met.
^43a
...
Halaster melded a [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) and a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) to create [this creature](3-Mechanics/CLI/bestiary/monstrosity/shapechanged-roper-wdmm.md) with the statistics of a roper and the ability to shape itself into objects like a mimic. While immobile in object form, it is indistinguishable from a normal object. Only when the roper reverts to its true form do its monstrous features become apparent.

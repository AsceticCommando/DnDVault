...
![](file://adventure/WDMM/024-801.webp#center)
...
> [!gallery]
> ![Map 8](file://adventure/WDMM/025-802.webp#gallery)
> ![Player Version](file://adventure/WDMM/026-803.webp#gallery)
...
Each character drawn into the scene temporarily becomes one of the yuan-ti fighting the wounded Hexacali. The character gains the statistics of a [yuan-ti pureblood](3-Mechanics/CLI/bestiary/monstrosity/yuan-ti-infiltrator-xmm.md) with `dice:2d20|noform|noparens|avg` (`2d20`) hit points remaining.

...
![](file://adventure/WDMM/071-22-01.webp#center)
...
> [!gallery]
> ![Map 22](file://adventure/WDMM/072-22-02.webp#gallery)
> ![Player Version](file://adventure/WDMM/073-22-03.webp#gallery)
...
- Any humanoid that dies in Shadowdusk Hold rises from its corpse `dice:1d4|noform|noparens|avg` (`1d4`) hours later as a [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) under the DM's control. Casting [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md) on the corpse before the will-o'-wisp forms prevents such an occurrence, as does bringing the body out of Shadowdusk Hold or into the area of a [hallow](3-Mechanics/CLI/spells/hallow-xphb.md) spell.  
...
- Zalthar wields a [nine lives stealer](3-Mechanics/CLI/items/nine-lives-stealer-xdmg.md) longsword with 5 charges remaining. He has a `dice:1d20+13|noform|noparens|text(+13)` bonus to hit with the weapon. On a hit, he deals `dice:1d8+7|noform|noparens|avg|text(11)` (`1d8 + 7`) slashing damage, or `dice:1d10+7|noform|noparens|avg|text(12)` (`1d10 + 7`) slashing damage if used with two hands, plus `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) necrotic damage.  
...
![Dezmyr Shadowdusk](file://adventure/WDMM/074-22-04.webp#center)

...
- Convince Headmaster Gustava (Lawful good, human, [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) to allow Purple to open the Flower Door and enter the crypt. Purple must make a successful DC 17 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) or—with a more wizardly argument—a successful DC 17 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check to convince the headmaster.  
...
![](file://adventure/NRH-TLT/010.webp#center)
...
Purple notices a perfect square of what looks like dirt on the door. It can't be cleaned by hand, only with a [prestidigitation](3-Mechanics/CLI/spells/prestidigitation-xphb.md) spell.

When the dirt is cleaned off, it reveals a small button. Again, the button can't be pushed except by a [mage hand](3-Mechanics/CLI/spells/mage-hand-xphb.md) spell.

When the button is pushed, it turns into a cog that begins turning. It can only be stopped by targeting it with the [ray of frost](3-Mechanics/CLI/spells/ray-of-frost-xphb.md) spell.
...
Inside the tomb is the corpse of Professor Althea in her Prism Academy robes. Her skeleton wears a [necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md).
...
As a reward, he gives Purple a [rust bag of tricks](3-Mechanics/CLI/items/bag-of-tricks-rust-xdmg.md) and asks if Purple will join the Lorekeeper Society and help find out how to restore the color to Harmony.
...
- [Rust Bag of Tricks](3-Mechanics/CLI/items/bag-of-tricks-rust-xdmg.md)  
- [Necklace of Fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md)  

![](file://adventure/NRH-TLT/sheet009.webp#center)

![](file://adventure/NRH-TLT/sheet010.webp#center)
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 12th | 84 (`dice:13d8+26\|noform\|noparens\|avg` (`13d8 + 26`)) | **Ability Score Improvement.** The warrior's Str. score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) bonus; and the bonuses to hit and damage of the warrior's weapon attacks. |
^level-hit-points-new-features
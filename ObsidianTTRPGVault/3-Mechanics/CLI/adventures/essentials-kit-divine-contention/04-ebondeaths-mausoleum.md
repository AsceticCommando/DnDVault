...
Characters who search the surface area and succeed on a DC 18 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature) or [Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check discern that a nearby saltwater lake has been recently disturbed: mud is splattered around the shore as though a [wave](3-Mechanics/CLI/items/wave-xdmg.md) of water was violently displaced here. The lake is very deep and connects via a murky underwater tunnel to the pool in area E8 of the mausoleum below. The dragon uses this route to enter and exit its lair.
...
> 
> **Wards**. The mausoleum is under the permanent effect of a [forbiddance](3-Mechanics/CLI/spells/forbiddance-xphb.md) spell that is set to damage any fey creatures that enter. When a fey creature enters the mausoleum for the first time on a turn or starts its turn there, the creature takes `dice:5d10|noform|noparens|avg` (`5d10`) necrotic damage.
^mausoleum-features

> [!gallery]
> ![Map 4: Ebondeath's Mausoleum](file://adventure/DC/007-nokov-map-ebondeaths-mausoleum_dm.webp#gallery)
> ![Player Version](file://adventure/DC/008-xva5z-map-ebondeaths-mausoleum_player.webp#gallery)
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the voice is an illusion. Characters who succeed on a DC 20 Intelligence ([Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check recognize the "Lord of Bones" as one of the ancient titles given to Myrkul, god of the dead. If a character says this name aloud, the door at the end of the hallway silently opens.

#### E2. Cultist Camp

This chamber was once a storeroom but is now used as a camp for Ularan Mortus's cultists. Bedrolls are laid over the floor and a fire burns in a brazier in the center of the room. There is one [necromancer](3-Mechanics/CLI/bestiary/humanoid/necromancer-wizard-mpmm.md) in here, plus one [ghast](3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) and one [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) for every character in the party, including sidekicks.

The characters surprise the cultists if they sneak up on them after silently opening the door from area E1. If combat ensues here, any monsters present in areas E3 and E4 are alerted to the battle and arrive after `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) rounds. The cultists in area E5 remain where they are but begin their summoning chant.

**Treasure**. The cultists carry 170 gp and 105 ep in loose coins, as well as five [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).

![Zombie Lair in Water](file://adventure/DC/009-fui5e-zombie-lair-in-water.webp#center)
...
The death priest's backpack contains 700 gp, 35 pp, [eyes of minute seeing](3-Mechanics/CLI/items/eyes-of-minute-seeing-xdmg.md), and the following spell scrolls: [raise dead](3-Mechanics/CLI/spells/raise-dead-xphb.md), [forbiddance](3-Mechanics/CLI/spells/forbiddance-xphb.md), and [holy aura](3-Mechanics/CLI/spells/holy-aura-xphb.md).

> [!note] Using the Ruinstone
> 
> Once per day as a bonus action, a villain can activate the [ruinstone](3-Mechanics/CLI/items/ruinstone-dc.md) to undo one deed they have performed. The possibilities here are broad, but in combat it's simplest to allow them the opportunity to "rewind" one action and take it again, or to reroll a failed saving throw (if it can still take actions). Each use of the artifact has a terrible side effect: someone known to the wielder is also erased from reality. After the villain uses the [ruinstone](3-Mechanics/CLI/items/ruinstone-dc.md), roll a `dice:d20|noform|noparens|avg` (`d20`): on a 5–20, one of their allies disintegrates, on an 1–4, one of the player characters disintegrates. If a creature bound its soul to the [ruinstone](3-Mechanics/CLI/items/ruinstone-dc.md) in the "Thalivar's Beacon" quest, the artifact explodes when used and the creature who is bound to it disintegrates.
^using-the-ruinstone

#### E5. Ritual Room

These ancient barracks have been cleared for use as a ritual room. A huge circle of ash has been laid out over the floor, surrounding a skull design painted in human blood. Around the circle, the cultists of Myrkul kneel in prayer for guidance from their god.There is one [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) here for every character in the party, including sidekicks. Cultists who detect trouble nearby chant to their god for aid. If at least one cultist chants for three rounds, a [bone devil](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md) appears in the circle to serve the cult.
...
The characters now face [Ebondeath](3-Mechanics/CLI/bestiary/npc/ebondeath-dc.md). If the dragon fled Leilon in spirit form (see the "Leilon Besieged" quest), the party faces a spectral version of the dragon. This has the statistics a [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md), with the following important modifications:
...
The treasures gathered here comprise 14,000 gp, 1,750 pp, ten jet gemstones worth 100 gp each, two [potions of supreme healing](3-Mechanics/CLI/items/potion-of-supreme-healing-xdmg.md), a [potion of storm giant strength](3-Mechanics/CLI/items/potion-of-storm-giant-strength-xdmg.md), and a [circlet of blasting](3-Mechanics/CLI/items/circlet-of-blasting-xdmg.md).

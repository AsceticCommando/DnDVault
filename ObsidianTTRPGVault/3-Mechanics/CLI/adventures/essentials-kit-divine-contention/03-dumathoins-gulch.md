...
The party hears a commotion in the forest as something hurries toward them. A gnome, Bindlemint Mincemower, emerges from the underbrush. Her clothes are torn and her face is bloodied by cuts, and she is terrified to the point of exhaustion. She only has enough energy to utter the word "beasts" before she collapses at the characters' feet. Moments later, a [wereboar](3-Mechanics/CLI/bestiary/monstrosity/wereboar-xmm.md), plus one wereboar per character, including sidekicks, bursts onto the path and attacks.
...
> [!gallery]
> ![Map 3: Dumathoin's Gulch](file://adventure/DC/005-5omvv-map-dumathoins-gulch_dm.webp#gallery)
> ![Player Version](file://adventure/DC/006-oubp4-map-dumathoins-gulch_player.webp#gallery)
...
> 
> Nine of the gnomes are [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), and the tenth is a [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md). The priest, Favora Corehoarder, is a follower of Garl Glittergold, brave enough to put herself in danger to save others.

...
Each captain wears a [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md) so they can maintain their illusionary appearance while not on the ship. The drow keep their real identities secret from the characters, but do not deny it if they are accused or caught. They're not willing to die to keep their identities secret.
...
> 
> **Figureheads.** A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of illusion magic around either ship's figurehead—the effect that makes every drow aboard the ship appear as a human. A drow's gender, height, and weight are unchanged; the illusion affects only appearance, not voice or mannerisms. Casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on a disguised drow causes the illusion around it to wink out, but only for a moment. An [antimagic field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) (including the one generated by the crystal on *Twinkle* in area T5) suppresses the figurehead's magic within the field's area. Destroying the figurehead ends the effect throughout the ship. A figurehead has AC 15, 50 hit points, and immunity to poison and psychic damage.
> 
...
> [!gallery]
> ![Map 5: Icingdeath and Twinkle](file://adventure/DC/010-ibovp-map-icingdeath-and-twinkle_dm.webp#gallery)
> ![Player Version](file://adventure/DC/011-enh49-map-icingdeath-and-twinkle_player.webp#gallery)
...
An 8-foot-tall, 4,000-pound stone statue of Drizzt Do'Urden, a famous drow ranger, stands near the front of the main deck, posed with hands on the pommels of his famous, sheathed scimitars. The statue's mouth is open in a goofy grin. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the statue radiates an aura of transmutation magic. Whenever a creature on the main deck speaks the statue's command word ("Artemis"), the statue animates and obeys the creature who animated it. As a bonus action, the creature can direct the statue to move up to 30 feet or shoot a stream of water out of its mouth at a target within 30 feet of the statue. The stream of water has the same effect as the geyser option of a [decanter of endless water](3-Mechanics/CLI/items/decanter-of-endless-water-xdmg.md). If the command word is spoken by that creature again, the statue returns to its original position on the ship and is no longer animate. The statue has AC 17, 27 hit points, and immunity to poison and psychic damage. Captain Xalti Tezzan (see "Drow Crews") knows the statue's command word.
...
The inside lid of the chest is covered by a [swarm of insects spiders](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md)), which attack any creature who opens the chest, expect Xalti. The chest contains Xalti's spellbook, which includes all the spells he has prepared, as well as [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [find familiar](3-Mechanics/CLI/spells/find-familiar-xphb.md), and [fireball](3-Mechanics/CLI/spells/fireball-xphb.md). The inside cover of the spellbook also contains the phrase "Artemis animates" in Elvish (a clue to animating the statue in area I1).
...
If a canister takes 5 or more points of fire damage from a single spell or attack, it explodes in a 10-foot-radius sphere. Creatures in the area must make a DC 15 Dexterity saving throw, taking `dice:6d8|noform|noparens|avg|text(27)` (`6d8`) fire damage on a failed save, or half as much damage on a successful one. This also catches the ship on fire, and will require immediate attention to keep it from spreading any further.
...
A character who searches the bed finds a concealed drawer in the bed frame, beneath the sheets. Inside the drawer are Deloz's neatly folded clothing and a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md)
...
The antimagic crystal creates a 200-foot-radius sphere of antimagic, as in the [antimagic field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell, centered on the crystal. While inside the cabin, the crystal's effect is contained in the room. The crystal has AC 13, 27 hit points, and immunity to poison and psychic damage.
...
- If half or more of the characters succeeded, their ship takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) bludgeoning damage from the storm.  
- If fewer than half of the characters succeeded, their ship takes `dice:8d10|noform|noparens|avg|text(44)` (`8d10`) bludgeoning damage from the storm.  
...
- Six officers: a captain, a first mate, a bosun, a quartermaster, a surgeon, and a cook (chaotic evil [bandit captains](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)).  
- Forty sailors (chaotic evil [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)).  
...
- Forty sailors (chaotic evil [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md)).  
- Ten chaotic evil [berserkers](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) who attempt to board enemy vessels and kill the crew.  

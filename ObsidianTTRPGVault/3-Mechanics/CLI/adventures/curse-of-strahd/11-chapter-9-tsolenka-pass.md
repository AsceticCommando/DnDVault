...
![](file://adventure/CoS/094-cos09-01.webp#center)
...
> [!gallery]
> ![Map 9.1: Tsolenka Pass (Area T)](file://adventure/CoS/095-025.webp#gallery)
> ![Player Version](file://adventure/CoS/096-cos901.webp#gallery)
...
These statues are actually two [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) [vrocks](3-Mechanics/CLI/bestiary/fiend/vrock-xmm.md). If they are attacked, or if the characters bypass the gatehouse, the vrocks revert to flesh and attack, pursuing prey that flees and fighting until slain.
...
The cloaked rider is a manifestation of [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md)—a grim warning to proceed no further. If the characters interact with the manifestation in any way, the rider and horse disperse like ash in the wind.
...
![](file://adventure/CoS/097-cos09-03.webp#center)
...
If no character has a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher, the party is [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised). Otherwise, read:

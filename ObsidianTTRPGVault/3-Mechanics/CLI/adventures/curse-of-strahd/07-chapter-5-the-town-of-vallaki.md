...
![](file://adventure/CoS/046-cos05-01.webp#center)
...
> [!quote] A quote from [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md)  
> 
...
> [!gallery]
> ![Map 5.1: Vallaki (Area N)](file://adventure/CoS/047-013.webp#gallery)
> ![Player Version](file://adventure/CoS/048-cos05-02-player.webp#gallery)
...
Two town [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (LG male and female humans) stand just inside each gate. Instead of spears, they carry pikes (reach 10 ft., `dice:1d10+1|noform|noparens|avg` (`1d10 + 1`) piercing damage on a hit). These weapons are long enough to stab creatures through the bars of the gate. The guards greet all visitors with suspicion, particularly those who arrive at night. If the characters arrive at night, one or more of them must succeed on a DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check to convince the guards to unlock the gate and let them enter.
...
> [!gallery]
> ![Map 5.2: Blue Water Inn (Area N2)](file://adventure/CoS/050-014.webp#gallery)
> ![Player Version](file://adventure/CoS/051-cos501.webp#gallery)

#### Keepers of the Feather

[Urwin Martikov](3-Mechanics/CLI/bestiary/npc/urwin-martikov-cos.md) (LG male human) is a [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) (see appendix D) and a high-ranking member of the Keepers of the Feather, a secret society of wereravens that opposes Strahd. Urwin's wife and business partner, [Danika Dorakova](3-Mechanics/CLI/bestiary/npc/danika-dorakova-cos.md) (LG female human), is also a [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md), as are their two sons, [Brom Martikov](3-Mechanics/CLI/bestiary/npc/brom-martikov-cos.md) and [Bray Martikov](3-Mechanics/CLI/bestiary/npc/bray-martikov-cos.md). The boys have only 7 hit points each and, at ages eleven and nine, are too young to be effective combatants.

At any given time, another `dice:1d4|noform|noparens|avg` (`1d4`) [wereravens](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) (members of the Keepers of the Feather) are present at the inn, either perched on the rooftop in raven form or huddled inside in human form. These wereravens are loyal friends of the Martikovs and help protect the inn.

If the characters earn the trust of the wereravens in Vallaki, the Keepers of the Feather will watch their backs. The next time the characters get themselves in serious trouble, you can have a group of `dice:1d4|noform|noparens|avg` (`1d4`) [wereravens](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) show up to rescue or otherwise help them.
...
Urwin sends a [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) in raven form to observe the party's progress from a distance. If the characters get in trouble, the wereraven reports to Urwin at once.
...
Danika Martikov usually tends bar while her husband busies himself in the kitchen (area N2e). Their boys, [Brom Martikov](3-Mechanics/CLI/bestiary/npc/brom-martikov-cos.md) and [Bray Martikov](3-Mechanics/CLI/bestiary/npc/bray-martikov-cos.md), scamper about and easily get underfoot.
...
> [!gallery]
> ![Szoldar Szoldarovich](file://adventure/CoS/052-cos05-05.webp#gallery)
> ![Yevgeni Krushkin](file://adventure/CoS/053-cos05-06.webp#gallery)
...
Inside the locked chest are 140 ep, 70 pp, two [elixirs of health](3-Mechanics/CLI/items/elixir-of-health-xdmg.md), three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a [gray bag of tricks](3-Mechanics/CLI/items/bag-of-tricks-gray-xdmg.md). The coins are embossed with the profiled likeness of [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md).
...
![The Martikov Family](file://adventure/CoS/054-cos05-07.webp#center)
...
Urwin carries the key to the locked iron strongbox. The lock can be picked with thieves' tools and a successful DC 20 Dexterity check. The box contains a sack of 150 ep (each coin bearing the profiled visage of [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md)), six pieces of jewelry (worth 250 gp each), and three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
> [!gallery]
> ![Map 5.3: Burgomaster's Mansion (Area N3)](file://adventure/CoS/055-015.webp#gallery)
> ![Player Version](file://adventure/CoS/056-cos502.webp#gallery)
...
![The Baroness and Baron](file://adventure/CoS/057-cos05-09.webp#center)
...
For practice and for fun, Victor dug up some old cat bones behind the Wachter estate (see area N4) and animated them, creating six [cat skeletons](3-Mechanics/CLI/bestiary/beast/cat-skeleton-cos.md) (use the [cat](3-Mechanics/CLI/bestiary/beast/cat-xmm.md) stat block, but give them [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) out to a range of 60 feet and immunity to poison damage, [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion), and the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition). The skeletons attack only when Victor commands them to.
...
> [!gallery]
> ![Map 5.4: Wachterhaus (Area N4)](file://adventure/CoS/058-016.webp#gallery)
> ![Player Version](file://adventure/CoS/059-cos503.webp#gallery)
...
[Lady Fiona Wachter](3-Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos.md) (LE female human [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) with AC 10 and no armor) makes no secret of her family's long-standing loyalty to the von Zarovich line. She believes that [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md) is no tyrant but, at worst, a negligent landlord. She would happily serve Strahd as burgomaster of Vallaki, but she knows that [Baron Vargas Vallakovich](3-Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos.md) won't give up his birthright without a fight.
...
![Fiona Wachter and Majesto](file://adventure/CoS/060-cos05-11.webp#center)
...
Eight [cats](3-Mechanics/CLI/bestiary/beast/cat-xmm.md) have the run of the library. These family pets have vicious dispositions, attacking anyone who tries to pick them up. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 10 or higher notice that one cat has a small key hanging from its collar. The key opens the locked chest in area N4q.
...
- Five scrolls—notarized deeds for parcels of land given to the Wachter family by Count [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md) nearly four centuries ago  
...
The four people are town residents (LE male and female human [cult fanatics](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) whom Lady Wachter has seduced with promises of power, wealth, and long life. They are members of her "book club," eagerly waiting for Lady Wachter to join them, read passages from her manifesto (see area N4q), and maybe conjure up a few coins. Resting on the fifth chair, quietly eavesdropping on the cultists, is the lady's [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) [imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md), [Majesto](3-Mechanics/CLI/bestiary/npc/majesto-cos.md).
...
![](file://adventure/CoS/061-cos05-12.webp#center)
...
- A [silvered shortsword](3-Mechanics/CLI/items/silvered-weapon-xdmg.md)  
- A [hand crossbow](3-Mechanics/CLI/items/hand-crossbow-xphb.md) inlaid with mother-of-pearl (worth 250 gp)  
- A bundle of twenty [silvered crossbow bolts](3-Mechanics/CLI/items/silvered-ammunition.md)  
...
![Henrik Van Der Voort](file://adventure/CoS/062-cos05-14.webp#center)
...
> [!gallery]
> ![Map 5.5: Coffin Maker's Shop (Area N6)](file://adventure/CoS/063-cos05-13.webp#gallery)
> ![Player Version](file://adventure/CoS/064-cos504.webp#gallery)
...
![Gadof Blinsky and Piccolo](file://adventure/CoS/065-cos05-15.webp#center)
...
- A ventriloquist's dummy that looks like [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md) (price 9 sp)  
...
> [!gallery]
> ![Map 5.6: Vistani Camp (Area N9)](file://adventure/CoS/066-018.webp#gallery)
> ![Player Version](file://adventure/CoS/067-cos505.webp#gallery)
...
> [!gallery]
> ![Luvash](file://adventure/CoS/068-cos05-18.webp#gallery)
> ![Arrigal](file://adventure/CoS/069-cos05-17.webp#gallery)

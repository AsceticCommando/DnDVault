...
![](file://adventure/CoS/126-cos15-01.webp#center)
...
> [!gallery]
> ![Map 15.1: Werewolf Den (Area Z)](file://adventure/CoS/127-032.webp#gallery)
> ![Player Version](file://adventure/CoS/128-cos1501.webp#gallery)
...
![Zuleika Toranescu](file://adventure/CoS/129-cos15-03.webp#center)
...
![Kiril Stoyanovich](file://adventure/CoS/130-cos15-04.webp#center)
...
If the characters aren't sure where to take the children, a [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) (see appendix D) that has been spying on the den in raven form assumes hybrid form and suggests that they take refuge in the nearby village of Krezk (chapter 8). If the characters head that way, the wereraven scouts from overhead until the characters reach the village, whereupon it flies south to the Wizard of Wines winery (chapter 12) and reports what has happened to [Davian Martikov](3-Mechanics/CLI/bestiary/npc/davian-martikov-cos.md).

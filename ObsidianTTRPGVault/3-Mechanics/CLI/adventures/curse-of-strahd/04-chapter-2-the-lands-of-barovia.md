...
![](file://adventure/CoS/004-cos02-01.webp#center)
...
![](file://adventure/CoS/005-cos02-02.webp#center)
...
- [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md) is a vampire, and he dwells in Castle Ravenloft. No one is welcome at the castle.  
...
![](file://adventure/CoS/006-cos02-03.webp#center)
...
- Some Vistani women are blessed with prescience. Of all the great Vistani fortune-tellers, none compares to [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md). If knowledge of the future is what you seek, [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) will tell you your fate.  
...
- The target is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded), [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened), or both. When this curse ends, the Vistana takes `dice:5d6|noform|noparens|avg` (`5d6`) psychic damage.  
...
| d12 + d8 | Encounter |
|----------|-----------|
| 2 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [Barovian Commoner](3-Mechanics/CLI/bestiary/humanoid/barovian-commoner-cos.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [Barovian Scout](3-Mechanics/CLI/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
...
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [swarm of ravens](3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) (50%) or 1 [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) (see appendix D) in raven form (50%) |
...
The area is lightly obscured by fog. If more than one dire wolf is present, the others aren't far behind and can be seen as dark shadows in the fog. The [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) of Barovia are cruel, overgrown wolves and Strahd's loyal servants. They can't be [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened).
...
If more than one [scarecrow](3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) is present, the others are close by. If none of the characters has a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 11 or higher, the scarecrows catch the party by surprise.
...
This [wereraven](3-Mechanics/CLI/bestiary/monstrosity/wereraven-rhw.md) in raven form watches the characters from a distance. Compare its Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check result to the characters' passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) scores to see whether it remains hidden from the party.
...
The light is a [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) that enters the ruined tower and becomes [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible), hoping to lure the characters inside to their doom.
...
Characters have a few minutes to steel themselves before these [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) attack. They heed the will of Strahd and can't be [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened).
...
> [!gallery]
> ![Map 2.1: Barovia](file://adventure/CoS/007-001.webp#gallery)
> ![Player Version](file://adventure/CoS/008-cos201.webp#gallery)
...
![](file://adventure/CoS/009-cos02-04.webp#center)
...
If the characters linger at the camp, continue with "A Vistana's Tale" below. If they seem in a hurry to leave, one of the Vistani tells them, "It was fated that you would visit our humble camp. [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) foretold your coming. She awaits you." The Vistana then points to the largest tent. If the characters head that way, continue with "[Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md)'s Tent."

> [!gallery]
> ![Map 2.2: Tser Pool Encampment](file://adventure/CoS/010-cos02-06.webp#gallery)
> ![Player Version](file://adventure/CoS/011-cos202.webp#gallery)
...
The Vistana storyteller doesn't remember the wizard's name, but recalls that it sounded important. If the characters haven't spoken with [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md), the storyteller urges them to do so.

#### Madam Eva's Tent

If the characters decide to see [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md), read:
...
[Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) (see appendix D) speaks the name of each party member and makes some reference to that individual's past deeds. She then asks the characters if they want their fortunes read. If they say yes, [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) produces a worn deck of cards and proceeds with the sequence outlined in chapter 1. (If the characters don't want a reading of their fates, continue play using the card reading you performed before starting the adventure.)

[Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) might seem mad, but she is, in fact, cunning and sharp of mind. She has met a good many adventurers in her time and knows they can't be fully trusted. She wants to free the land of Barovia from its curse, and her fate is interwoven with Strahd's (see appendix D for details). She does the vampire's bidding when called upon and does nothing to anger Strahd or bring harm to the Vistani. She never gives aid and never asks for any.
...
If your card reading reveals that a treasure is here, it is hidden in one of the Vistani wagons. [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) grants the characters permission to search the wagons if they ask, and any such search yields the treasure.
...
Chapter 4 explores Castle Ravenloft, lair of the vampire [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md).
...
A descendant of [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) with the blood of Barovian royalty in her veins, [Arabelle](3-Mechanics/CLI/bestiary/npc/arabelle-cos.md) is unaware of her connection to Strahd. She acts more like an adult than a child. Despite her recent misadventure, she believes that a great destiny awaits her.
...
If Mordenkainen isn't the party's ally as foretold in [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md)'s card reading (see chapter 1), he declines to join them if asked. With his wits restored, he sets out to find his missing staff and spellbook, leaving the characters on their own. He doesn't allow them to help him, for he fears they might be tempted to steal either his staff or his spellbook. (Being an adventurer himself, he knows how the lure of powerful magic can bring out the worst in adventurers.) Before he leaves, as a parting gift, the [archmage](3-Mechanics/CLI/bestiary/npc/the-mad-mage-of-mount-baratok-cos.md) imbues each character with a [charm of heroism](3-Mechanics/CLI/rewards/charm-of-heroism-xdmg.md) (see ""Supernatural Gifts"" in chapter 7 of the "Dungeon Master's Guide").
...
The [archmage](3-Mechanics/CLI/bestiary/npc/the-mad-mage-of-mount-baratok-cos.md) has never had his fortune read by [Madam Eva](3-Mechanics/CLI/bestiary/npc/madam-eva-rhw.md) and doesn't care to, but if he is told about the [Holy Symbol of Ravenkind](3-Mechanics/CLI/items/holy-symbol-of-ravenkind-cos.md), the [Tome of Strahd](3-Mechanics/CLI/items/tome-of-strahd-cos.md), and the [Sunsword](3-Mechanics/CLI/items/sunsword-cos.md), he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.

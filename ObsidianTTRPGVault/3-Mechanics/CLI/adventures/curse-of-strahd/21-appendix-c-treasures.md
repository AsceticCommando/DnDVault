...
Scattered throughout Barovia are ancient treasures that can be brought to bear against [Strahd von Zarovich](3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-rhw.md) and his fell servants. The locations of three of them—the [Tome of Strahd](3-Mechanics/CLI/items/tome-of-strahd-cos.md), the [Holy Symbol of Ravenkind](3-Mechanics/CLI/items/holy-symbol-of-ravenkind-cos.md), and the [Sunsword](3-Mechanics/CLI/items/sunsword-cos.md)—are determined by the results of the card reading in chapter 1. The other items can be acquired as characters discover their whereabouts during the course of the adventure.

## Tome of Strahd

![](file://adventure/CoS/136-cos18-01.webp#center)

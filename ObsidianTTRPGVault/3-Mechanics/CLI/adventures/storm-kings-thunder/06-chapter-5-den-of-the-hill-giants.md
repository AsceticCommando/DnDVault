...
![](file://adventure/SKT/063-skt05-01.webp#center)
...
| 61–70 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), each carrying a basket of apples, carrots, or potatoes |
...
| 81–90 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) Iceshield [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) and 1 Iceshield [orc war chief](3-Mechanics/CLI/bestiary/humanoid/tough-boss-xmm.md), who travel downriver on two rafts |
| 91–00 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) male [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md), each carrying a basket of dead fish, a barrel of pickles, or a block of sugar |
^creature-s
...
At the end of each hour, roll percentile dice and consult the Grudd Haug Reinforcements table to determine what creatures, if any, appear. Unless otherwise noted, such creatures enter through the stockyard (area 9) and go to the feasting hall (area 2), to pay homage or deliver food to [Chief Guh](3-Mechanics/CLI/bestiary/npc/chief-guh-skt.md). There is a 25 percent chance that the creatures have `dice:1d4|noform|noparens|avg` (`1d4`) prisoners (unarmed [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) in tow. If Guh commands the reinforcements to stay, they take up defensive positions in and around the stockyard after confining their prisoners in area 13. Otherwise, they leave by the route they came after 20 minutes or so.

### Areas of Grudd Haug

> [!gallery]
> ![Map 5.1: Grudd Haug](file://adventure/SKT/064-skt05-gruddhaug.webp#gallery)
> ![Player Version](file://adventure/SKT/065-501.webp#gallery)
...
![](file://adventure/SKT/066-skt05-03.webp#center)

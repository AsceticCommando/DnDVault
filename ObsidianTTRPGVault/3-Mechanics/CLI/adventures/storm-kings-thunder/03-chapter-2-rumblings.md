...
![](file://adventure/SKT/015-skt02-01.webp#center)
...
> [!gallery]
> ![Map 2.1: Bryn Shander](file://adventure/SKT/016-skt02-02.webp#gallery)
> ![Player Version](file://adventure/SKT/017-201.webp#gallery)
...
> [!gallery]
> ![Map 2.2: Goldenfields](file://adventure/SKT/018-goldenfields-1.webp#gallery)
> ![Player Version](file://adventure/SKT/019-202.webp#gallery)
...
![](file://adventure/SKT/020-skt02-04.webp#center)
...
> [!gallery]
> ![Map 2.3: Triboar](file://adventure/SKT/021-triboar-1.webp#gallery)
> ![Player Version](file://adventure/SKT/022-203.webp#gallery)
...
Each of these plain stone cottages is home to `dice:1d4|noform|noparens|avg` (`1d4`) adult [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) and `dice:1d4|noform|noparens|avg` (`1d4`)−1 children (noncombatants) of various ethnicities.

#### F. Farm

Each of these plots of land contains a modest stone farmhouse, a wooden outhouse, and a tilled garden or pasture. The farm is occupied by `dice:1d6|noform|noparens|avg` (`1d6`) adult [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) and `dice:1d6|noform|noparens|avg` (`1d6`)−1 children (noncombatants) of various ethnicities.
...
Locked in the Six Windows' attic are the bones of Tolmara's dead husband, Mirak, of whom she rarely speaks. Tolmara hides the key to the attic door in her brassiere. The lock can be picked with thieves' tools and a DC 10 Dexterity check. If Mirak's bones are touched, his [skeleton](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) animates for `dice:1d4|noform|noparens|avg` (`1d4`) rounds, after which it clatters to the floor. The effect repeats if the bones are touched again, unless the skeleton is reduced to 0 hit points or the bones are destroyed, in which case they can't animate. The skeleton is unarmed and deals 1 bludgeoning damage on a hit.
...
North of the Evermoor Way, a quaint cottage stands near a brightly painted barn topped with a pony-shaped weather vane. A white picket fence encloses a small field behind the barn. Set among flowers on the front lawn is a sign that reads "Merivold Pony Park." Two spinster-sisters named Janna and Leera Merivold (LN female Illuskan human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) raise and train ponies here, including riding ponies for halflings. At any given time, the Merivolds have `dice:2d4|noform|noparens|avg` (`2d4`) ponies for sale.
...
![](file://adventure/SKT/023-skt02-06.webp#center)
...
The parlor in Moongleam Tower contains austere furnishings and a dozen harmless, domesticated [tressym](3-Mechanics/CLI/bestiary/monstrosity/tressym-bgdia.md) (see appendix C) behaving like house cats. A silent [alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell notifies Krowen Valharrow, the tower's resident archmage, of the party's arrival. The dotty old wizard enters the parlor shortly after the characters appear, greets them warmly, and grants them free access to a secret network of teleportation circles until, as he puts it, "the Harpers decide otherwise" (see the "Inner Circles" section in chapter 3).

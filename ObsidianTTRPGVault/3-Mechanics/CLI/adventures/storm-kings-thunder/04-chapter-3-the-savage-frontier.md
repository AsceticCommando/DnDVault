...
The Mirabarran authorities would be angry to learn that the Harpers have compromised the city's security by constructing a permanent [teleportation circle](3-Mechanics/CLI/spells/teleportation-circle.md) within Mirabar's walls. The circle is inscribed in a stable house loft and can be quickly hidden under hay. The circle's attendant, Zazspar Bronzefire (LG male shield dwarf [mage](3-Mechanics/CLI/bestiary/humanoid/mage.md)), poses as a stable hand, complete with leather overalls and straw in his beard.

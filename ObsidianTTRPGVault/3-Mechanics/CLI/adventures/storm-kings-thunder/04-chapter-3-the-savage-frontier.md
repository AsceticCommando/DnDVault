...
![](file://adventure/SKT/024-skt03-01.webp#center)
...
![](file://adventure/SKT/025-skt03-02.webp#center)
...
![](file://adventure/SKT/026-skt03-03.webp#center)
...
A marauding gang of bandits confronts the party. The gang consists of a [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) and `dice:3d6+2|noform|noparens|avg` (`3d6 + 2`) [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md), all wearing cloaks and mounted on [riding horses](3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md). There is a 25 percent chance that the bandits attack without provocation. Otherwise, the captain promises not to attack in exchange for a toll (no less than 100 gp worth of treasure). If the characters pay up, the captain bids them a safe journey before departing peacefully.
...
The characters come across `dice:2d10|noform|noparens|avg` (`2d10`) [elk](3-Mechanics/CLI/bestiary/beast/elk-xmm.md) (or reindeer). The beasts aren't hostile and flee if attacked.
...
If this encounter occurs at sea, the characters encounter `dice:3d6|noform|noparens|avg` (`3d6`) friendly [sea elves](3-Mechanics/CLI/bestiary/humanoid/sea-elf-skt.md). These elves know the location of Maelstrom (see chapter 10, "Hold of the Storm Giants") and can lead characters there upon request; they also warn characters about Maelstrom's whirlpool if they're headed in that direction. Sea elves use the [merfolk](3-Mechanics/CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) statistics, with the following changes:
...
A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) is searching for lost fragments of the Vonindod. The giant carries a [rod of the Vonindod](3-Mechanics/CLI/items/rod-of-the-vonindod-skt.md) (see appendix B), and `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) [smoke mephits](3-Mechanics/CLI/bestiary/elemental/smoke-mephit-xmm.md) are fluttering around it. The giant is frustrated because weeks of searching have yielded nothing of value. If it spots the adventurers, it puts away the rod and begins hurling rocks at them to alleviate its boredom and frustration. The mephits follow the giants' commands to the best of their ability, though they loathe melee combat. On subsequent occurrences of this encounter, you can replace the mephits with `dice:1d2|noform|noparens|avg` (`1d2`) [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md), `dice:1d2|noform|noparens|avg` (`1d2`) [fire elementals](3-Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md), or `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) [magmins](3-Mechanics/CLI/bestiary/elemental/magmin-xmm.md).
...
A male [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) is looking for food, stuffing anything that looks even remotely edible into a big sack that he drags behind him. Lagging a few hundred feet behind the giant are `dice:1d4|noform|noparens|avg` (`1d4`) bored [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) and `dice:1d6|noform|noparens|avg` (`1d6`) [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md). Characters spot the giant from far enough away that they can plan an ambush. For an ambush to succeed, the characters must catch the monsters by surprise by succeeding on a group DC 10 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check. The ogres and bugbears carry no treasure. The hill giant's sack contains `dice:1d4|noform|noparens|avg` (`1d4`) mundane items, determined by rolling on the Items in a Giant's Bag table in the introduction.

### Frost Giants

The characters come upon `dice:1d3|noform|noparens|avg` (`1d3`) [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md). If a single giant is encountered, it has a [winter wolf](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) companion. The giants are marauders looking for homesteads or caravans to wreck and plunder.
...
The characters encounter a [draft horse](3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) pulling a battered old wagon. Accompanying the wagon are `dice:1d6|noform|noparens|avg` (`1d6`)−1 people (use the [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) stat block unless otherwise noted below). If the die result indicates that no commoners are present, that means the drivers are either missing or dead, leaving the horse and wagon unattended. If one or more people are present, assume that they are guiding the wagon toward the nearest settlement. The encounter might be one of the following:
...
- A friendly merchant transporting `dice:2d4|noform|noparens|avg` (`2d4`) pigs worth 3 gp each; any other persons present are Zhentarim [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (N male and female humans of various ethnicities) hired to ward off bandits and other threats  
...
The characters hear loud, deep voices and spot `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) from a safe distance away. The big dummies are lost and trying to find their way home, whether that is Grudd Haug (see chapter 5, "Den of the Hill Giants") or some other location. The characters catch them in the middle of a loud argument about which direction they should go, and can easily avoid the ogres or take them by surprise. The ogres have no treasure.

#### Sea

If this encounter occurs at sea, the party encounters `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md). The merrow try to harpoon characters and pull them into the water.
...
Vordana Jezral (NG female lightfoot halfling [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) has the psionic ability to cast the [misty step](3-Mechanics/CLI/spells/misty-step-xphb.md) spell once per day. She is familiar with the roads and trails of the North and the settlements along them. She knows every innkeeper from Neverwinter to Deadsnows, and she has two traveling companions: a [tressym](3-Mechanics/CLI/bestiary/monstrosity/tressym-bgdia.md) (see appendix C) named Flycatcher and an old [mule](3-Mechanics/CLI/bestiary/beast/mule-xmm.md) named Tod, which she freed from an abusive owner.
...
A group of `dice:1d3+1|noform|noparens|avg` (`1d3 + 1`) [stone giants](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) is searching for settlements to destroy and ruins to dismantle. The giants might already be in the midst of dismantling a ruin, intent on wiping its existence from the face of the world. They hurl rocks at any "small folk" they see.
...
> 
> **Grassland**: `dice:1d6|noform|noparens|avg` (`1d6`) farmers whose homestead was attacked by hill giants, or `dice:1d4|noform|noparens|avg` (`1d4`) ranchers on [riding horses](3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) who are heading to a nearby settlement to warn it about giants in the area
> 
...
![Map 3.1: The North](file://adventure/SKT/027-skt03-thenorth.webp#center)
...
> [!gallery]
> ![Map 3.2: Beorunna's Well](file://adventure/SKT/028-skt03-beorunnaswell.webp#gallery)
> ![Player Version](file://adventure/SKT/029-301.webp#gallery)
...
> [!gallery]
> ![Map 3.3: Everlund](file://adventure/SKT/030-skt03-everlund.webp#gallery)
> ![Player Version](file://adventure/SKT/031-302.webp#gallery)
...
> [!gallery]
> ![Map 3.4: Flint Rock](file://adventure/SKT/032-skt03-08.webp#gallery)
> ![Player Version](file://adventure/SKT/033-303.webp#gallery)
...
- The leader carries an [oathbow](3-Mechanics/CLI/items/oathbow-xdmg.md) and has a `dice:1d20+5|noform|noparens|text(+5)` bonus to hit with the weapon, which deals `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) piercing damage on a hit, plus an extra `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) piercing damage against a sworn enemy. (See "chapter 7" of the "Dungeon Master's Guide" for other properties of the [oathbow](3-Mechanics/CLI/items/oathbow-xdmg.md).)  
...
> [!gallery]
> ![Map 3.5: The Grandfather Tree](file://adventure/SKT/034-skt03-grandfathertree.webp#gallery)
> ![Player Version](file://adventure/SKT/035-304.webp#gallery)
...
> [!gallery]
> ![Map 3.6: Great Worm Cavern](file://adventure/SKT/036-skt03-greatwormcavern.webp#gallery)
> ![Player Version](file://adventure/SKT/037-305.webp#gallery)
...
- He has 99 hit points and wields a [+1 greataxe](3-Mechanics/CLI/items/1-weapon-xdmg.md). He has a `dice:1d20+6|noform|noparens|text(+6)` bonus to hit with this weapon and deals `dice:1d12+4|noform|noparens|avg|text(10)` (`1d12 + 4`) slashing damage on a hit.  
...
Characters who accept the quest and head south for 10 miles spot a [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) walking toward the coast. The giant recently attacked a caravan traveling north along the High Road and has 88 hit points remaining. He carries a sack stuffed with pillaged food as well as `dice:1d4|noform|noparens|avg` (`1d4`) mundane items (roll on the Items in a Giant's Bag table in the introduction). The giant fights to the death if he is attacked. If the characters follow the giant while keeping their distance, he leads them to a miles-long stretch of 100-foot-high cliffs. Anchored a half mile off the coast is a greatship (see the "Svardborg: General Features" sidebar in chapter 7, "Berg of the Frost Giants") with two giant-sized punts tethered to it. Three [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) are aboard the ship. When the giant carrying the sack of food waves from the top of the cliffs, one of the giants aboard the ship climbs into a punt and rows it to shore, while the first giant climbs down the cliff to meet it. Most of the ship's crew is still plundering the mainland, so the ship isn't leaving anytime soon.

Sixteen frost giants have yet to return to the ship from their inland raids. If the characters hide aboard the ship or remain within sight of it, roll a `dice:d20|noform|noparens|avg` (`d20`) at the end of each hour that passes. On a roll of 17 or higher, `dice:1d4|noform|noparens|avg` (`1d4`) [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) return and signal the ship to send a punt to shore. If no punt is available, the giants swim to the ship to find out what happened.
...
| 6–8 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) |
...
| 13–15 | `dice:3d8\|noform\|noparens\|avg` (`3d8`) reindeer ([elk](3-Mechanics/CLI/bestiary/beast/elk-xmm.md)) |
| 16–17 | Ten-Towners ([scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) |
| 18–19 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [yeti](3-Mechanics/CLI/bestiary/monstrosity/yeti-xmm.md) |
...
![](file://adventure/SKT/038-skt03-11.webp#center)
...
> [!gallery]
> ![Map 3.7: Morgur's Mound](file://adventure/SKT/039-skt03-morgursmound.webp#gallery)
> ![Player Version](file://adventure/SKT/040-306.webp#gallery)
...
- A thunderbeast skeleton can attack with its bite instead of its tail. Its bite attack has a `dice:1d20+7|noform|noparens|text(+7)` bonus to hit, has a reach of 5 feet, and deals `dice:4d6+4|noform|noparens|avg|text(18)` (`4d6 + 4`) piercing damage on a hit. Unlike its tail attack, its bite attack can't knock a target [prone](3-Mechanics/CLI/rules/conditions.md#Prone).  
...
> [!gallery]
> ![Map 3.8: One Stone](file://adventure/SKT/041-skt03-onestone.webp#gallery)
> ![Player Version](file://adventure/SKT/042-307.webp#gallery)
...
> [!gallery]
> ![Map 3.9: Raven Rock](file://adventure/SKT/043-skt03-ravenrock.webp#gallery)
> ![Player Version](file://adventure/SKT/044-308.webp#gallery)
...
Characters who explore Raven Rock in the dead of night encounter `dice:2d4|noform|noparens|avg` (`2d4`) [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) and `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [werewolves](3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in wolf form. The werewolves are members of the Gray Wolf tribe.
...
![Map 3.10: Gundarlun and Ruathym](file://adventure/SKT/045-skt03-gundarlunruathym.webp#center)
...
> [!gallery]
> ![Map 3.11: Shining White](file://adventure/SKT/046-skt03-16.webp#gallery)
> ![Player Version](file://adventure/SKT/047-309.webp#gallery)
...
> [!gallery]
> ![Map 3.12: Stone Stand](file://adventure/SKT/048-skt03-stonestand.webp#gallery)
> ![Player Version](file://adventure/SKT/049-310.webp#gallery)
...
![Map 3.13: Tuern and Purple Rocks](file://adventure/SKT/050-skt03-tuernpurplerocks.webp#center)
...
- Instead of a scimitar and a dagger, he wields a pair of [+1 handaxes](3-Mechanics/CLI/items/1-weapon-xdmg.md) (`dice:1d20+5|noform|noparens|text(+5)` to hit with each). As an action, he can make three melee attacks, two attacks with one handaxe and one attack with the other handaxe. Each handaxe deals `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) slashing damage on a hit.  
...
Kaltivar the frost giant carries a sack containing `2d6 × 100` gp, `dice:1d4|noform|noparens|avg` (`1d4`) mundane items (determined by rolling on the Items in a Giant's Bag table in the introduction), and one magic item, determined by rolling on [Magic Item Table C](3-Mechanics/CLI/tables/magic-item-table-c.md) in "chapter 7" of the "Dungeon Master's Guide". The goblinoids have no treasure.
...
![Map 3.14: Old Tower](file://adventure/SKT/052-skt03-20.webp#center)
...
![Figure 3.1: Harper Teleportation Network](file://adventure/SKT/053-skt03-21.webp#center)
...
- He wields [Gurt's greataxe](3-Mechanics/CLI/items/gurts-greataxe-skt.md), which has a long history as well as some cold-related properties (see appendix B). He has a `dice:1d20+11|noform|noparens|text(+11)` bonus to hit with the axe, which deals `dice:3d12+7|noform|noparens|avg|text(26)` (`3d12 + 7`) slashing damage on a hit, or `dice:5d12+7|noform|noparens|avg|text(39)` (`5d12 + 7`) slashing damage if the target is human.  
...
![](file://adventure/SKT/054-skt03-22.webp#center)
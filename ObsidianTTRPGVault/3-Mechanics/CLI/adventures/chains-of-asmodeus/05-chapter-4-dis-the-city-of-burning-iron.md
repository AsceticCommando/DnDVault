...
![At the center of the Agora of Floating Knives sits Orishada's Palace.](file://adventure/CoA/080-0.webp#center)
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | A pack of six [lemures](3-Mechanics/CLI/bestiary/fiend/lemure-xmm.md) have escaped the mines they were working. Four hell hounds pursue close behind. |
| 2 | Eight [spined devils](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) attack without provocation, mostly just for sport. They retreat from opponents who give as good as they get. |
| 3 | The characters notice an [imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) crouching on the rooftops, presumably spying on them. |
| 4 | A githyanki trade caravan makes its way toward the City of Dis. A half dozen [githyanki knights](3-Mechanics/CLI/bestiary/aberration/githyanki-knight-xmm.md) on [young red dragons](3-Mechanics/CLI/bestiary/dragon/young-red-dragon-xmm.md) provide protection. |
| 5 | A lone [barbed devil](3-Mechanics/CLI/bestiary/fiend/barbed-devil-xmm.md) approaches and demands 100 gp as tax for traveling across [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s realm. If he is attacked, he calls upon a pair of [war devils](3-Mechanics/CLI/bestiary/fiend/war-devil-coa.md) (see appendix B) circling hundreds of feet above to protect him. |
| 6 | A blazing orb of iron, seemingly ejected from a faraway mine, lands on a random character. It explodes and that character, and each creature in 20-foot-radius sphere, must make a DC 17 Dexterity saving throw. A creature takes `dice:20d6\|noform\|noparens\|avg\|text(70)` (`20d6`) fire damage and `dice:20d6\|noform\|noparens\|avg\|text(70)` (`20d6`) bludgeoning damage on a failed save, or half as much damage on a successful one. The collected fragments of the orb are worth 2,000 gp. |
^random-encounters-in-dis
...
| Objective | Location |
|-----------|----------|
| [Instrument of the Bards (Ollamh Harp)](3-Mechanics/CLI/items/instrument-of-the-bards-ollamh-harp-xdmg.md) | The Agora of Floating Knives: Barges of Theater |
| [Cloak of Invisibility](3-Mechanics/CLI/items/cloak-of-invisibility-xdmg.md) | The Agora of Floating Knives: The Market of Killers |
...
| [Iron Horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-iron-xdmg.md) | Orishada's Palace: Aelvette |
...
> [!gallery]
> ![Dis, the Second Hell](file://adventure/CoA/083-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/083-0.webp#gallery)
...
![The Iron Tower of Dispater Looms over the City of Dis.](file://adventure/CoA/082-0.webp#center)
...
Iron itself bends to the influence of Dis. Whenever a good-aligned creature touches nonmagical iron, they take `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) fire damage. This includes armor or weapons that creatures might be using, ammunition, storage devices, keys, etc. A Protection from Good and Evil spell or similar effect allows creatures to resist this effect for the duration.

As the most lawful of the infernal planes, visitors to this plane become bound to their words and contracts. Any time a mortal gives a promise, enters into a contract, or otherwise ensures their end of a bargain, they find themselves magically compelled to follow. A creature that breaks such a bond while on Dis takes `dice:5d12|noform|noparens|avg|text(32)` (`5d12`) necrotic damage and gains a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).
...
If the characters decide to visit, they struggle to ever reach the tower. Wherever they're in the city, the tower always appears right around the next corner, but no matter how long they walk, it never gets any closer. If the characters succeed on a DC 21 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check and spend `dice:2d6|noform|noparens|avg` (`2d6`) hours searching, they finally reach the Iron Tower. If they fail the check, they waste `dice:2d6|noform|noparens|avg` (`2d6`) hours and are no closer, but they do trigger a random encounter.
...
The characters may pay 50 gp apiece to enter the Garden. Once inside they're handed cool and delicious (and illusory) drinks. Now roll a `dice:d100|noform|noparens|avg` (`d100`)—this is the number of hours the characters waste, captivated by the illusory delights the garden provides. At the end of this time, a character must succeed on a DC 17 Charisma saving throw to even want to leave, if they fail the saving throw, they spend another `dice:d100|noform|noparens|avg` (`d100`) hours within and must repeat the saving throw. When the characters finally succeed on the saving throw and depart, each gains a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).
...
- They might find what they're searching for in the markets. If not, then they might need to seek an audience with the ruler of the Agora, Orishada, a powerful [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse).  
...
Visitors relying on the services of the [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) (for the small sum of 10 gp) should be very specific in giving their destination, as the diminutive gondoliers delight in malevolently misinterpreting instructions every bit as much as an archdevil bargaining for a soul.
...
| Dream bottle | 50 gp |
| [Dust of Sneezing and Choking](3-Mechanics/CLI/items/dust-of-sneezing-and-choking-xdmg.md) | 250 gp |
| [Oil of Sharpness](3-Mechanics/CLI/items/oil-of-sharpness-xdmg.md) | 2,500 gp |
| [Oil of Slipperiness](3-Mechanics/CLI/items/oil-of-slipperiness-xdmg.md) | 250 gp |
| [Potion of Fire Breath](3-Mechanics/CLI/items/potion-of-fire-breath-xdmg.md) | 250 gp |
| [Potion of Mind Reading](3-Mechanics/CLI/items/potion-of-mind-reading-xdmg.md) | 750 gp |
^items-for-sale

> [!gallery]
> ![The Agora of Floating Knives](file://adventure/CoA/086-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/086-0.webp#gallery)
...
There is also a thriving trade market. These items are readily available for anyone who succeeds on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check. However, the buyer is only interested in trading for a magic item with [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) as an additional cost.

**Magic Items Trade Cost**

| Magic Item | Trade In |
|------------|----------|
| [Mirror of Life Trapping](3-Mechanics/CLI/items/mirror-of-life-trapping-xdmg.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom-xdmg.md) | Uncommon or rare weapon, plus 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Crystal Ball](3-Mechanics/CLI/items/crystal-ball-xdmg.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Efreeti Bottle](3-Mechanics/CLI/items/efreeti-bottle-xdmg.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Ring of Shooting Stars](3-Mechanics/CLI/items/ring-of-shooting-stars-xdmg.md) | Rare or very rare ring, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Robe of Stars](3-Mechanics/CLI/items/robe-of-stars-xdmg.md) | Rare or very rare magic cloak or robe, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Staff of Fire](3-Mechanics/CLI/items/staff-of-fire-xdmg.md) | Rare or very rare magic rod or staff, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Staff of Frost](3-Mechanics/CLI/items/staff-of-frost-xdmg.md) | Rare or very rare magic rod or staff, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Spellguard Shield](3-Mechanics/CLI/items/spellguard-shield-xdmg.md) | Rare or very rare shield, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Nine Lives Stealer](3-Mechanics/CLI/items/nine-lives-stealer-xdmg.md) | Rare or very rare weapon, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
^magic-items-trade-cost
...
- **Test of Strength.** The character must fight a [chain devil](3-Mechanics/CLI/bestiary/fiend/chain-devil-xmm.md).  
- **Test of Skill.** The character must either best a [horned devil](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) in a complicated game of knot tying or compete against an [erinyes](3-Mechanics/CLI/bestiary/fiend/erinyes-xmm.md) to see who can calm an enraged [hellcat](3-Mechanics/CLI/bestiary/fiend/hellcat-bezekira-coa.md) (see appendix B). Tying the knot requires a successful DC 18 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check whereas taming the creature requires a successful DC 15 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. If the character fails the check, they can try to make a DC 16 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check. If successful they bluff their way into getting a second (and final) chance on the original check.  
- **Test of Wits.** The character challenges an [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse) to a dice game popular in the Nine Hells. The character must make a successful DC 15 Intelligence check to win the match.  

When a character loses a challenge, they gain a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). If the character rests or otherwise recovers from that [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion), they must start all three matches over. They may repeat each challenge as often as needed to win but can have no help from anyone. Once they win all three matches, a succubus or incubus appears and hands them their phylactery.

#### A2: Neogi Shop

One of the shops in the Outer Agora is run by the enigmatic and ruthless [neogi](3-Mechanics/CLI/bestiary/aberration/neogi-mpmm.md) (see Monsters of the Multiverse). These spider-like monsters are planar travelers that trade in magic items and prisoners. Their shop usually only stays in the same place for `dice:1d6|noform|noparens|avg` (`1d6`) weeks. Each visit to the shop brings the chance of danger, for sometimes the neogi aren't looking to sell items, but are more interested in acquiring new victims. A new shopper must make a DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. If they succeed, the items on sale are real. If they fail, then the items are illusory and the neogi have prepared an ambush. A [neogi master](3-Mechanics/CLI/bestiary/aberration/neogi-master-mpmm.md) leads the ambush, with an additional [neogi](3-Mechanics/CLI/bestiary/aberration/neogi-mpmm.md) (see Monsters of the Multiverse) and an [umber hulk](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md) for each shopper. More powerful customers might mean the neogi bring an additional `dice:1d6|noform|noparens|avg` (`1d6`) [gray renders](3-Mechanics/CLI/bestiary/monstrosity/gray-render-mpmm.md) (see Monsters of the Multiverse). The Illusory Items table lists items that they sell, along with what the items really are if the neogi have decided to ambush the shoppers.

**Illusory Items**

| Magic Item | If Illusory | Cost |
|------------|-------------|------|
| [Apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md) | A [hook horror](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) by the neogi | 100,000 gp |
| [Brazier of Commanding Fire Elementals](3-Mechanics/CLI/items/brazier-of-commanding-fire-elementals-xdmg.md) | An [xorn](3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md) [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by [Dimensional Shackles](3-Mechanics/CLI/items/dimensional-shackles-xdmg.md) | 10,000 gp |
| [Cape of the Mountebank](3-Mechanics/CLI/items/cape-of-the-mountebank-xdmg.md) | A rotting nonmagical cloak | 5,000 gp |
| [Carpet of Flying](3-Mechanics/CLI/items/carpet-of-flying-xdmg.md) | A cheap carpet | 20,000 gp |
| [Cloak of Arachnida](3-Mechanics/CLI/items/cloak-of-arachnida-xdmg.md) | A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) that is the pet of one of the neogi | 15,000 gp |
| [Deck of Illusions](3-Mechanics/CLI/items/deck-of-illusions-xdmg.md) | A set of playing cards with depraved images | 400 gp |
| [Demon Armor](3-Mechanics/CLI/items/demon-armor-xdmg.md) | [Hezrou](3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by [Iron Bands of Binding](3-Mechanics/CLI/items/iron-bands-of-bilarro-xdmg.md) | 40,000 gp |
| [Dwarven Plate](3-Mechanics/CLI/items/dwarven-plate-xdmg.md) | A [shield guardian](3-Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md) whose control amulet is worn by the neogi master | 35,000 gp |
| [Figurine of Wondrous Power (golden lions)](3-Mechanics/CLI/items/figurine-of-wondrous-power-golden-lions-xdmg.md) | Same as above except a pair of [hellcats](3-Mechanics/CLI/bestiary/fiend/hellcat-bezekira-coa.md) (see appendix B) | 11,500 gp |
| [Figurine of Wondrous Power (marble elephant)](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant-xdmg.md) | Same as above except a single [maelephant nomad](3-Mechanics/CLI/bestiary/fiend/maelephant-nomad-coa.md) (see appendix B) | 11,000 gp |
| [Figurine of Wondrous Power (onyx dog)](3-Mechanics/CLI/items/figurine-of-wondrous-power-onyx-dog-xdmg.md) | [Displacer fiend](3-Mechanics/CLI/bestiary/fiend/displacer-fiend-coa.md) (see appendix B) under permanent Reduce spell and held by an adamantine leash | 11,000 gp |
| [Helm of Brilliance](3-Mechanics/CLI/items/helm-of-brilliance-xdmg.md) | [Intellect devourer](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) | 25,000 gp |
| [Mace of Terror](3-Mechanics/CLI/items/mace-of-terror-xdmg.md) | A [flameskull](3-Mechanics/CLI/bestiary/undead/flameskull-xmm.md) attached to an [Immovable Rod](3-Mechanics/CLI/items/immovable-rod-xdmg.md) | 9,000 gp |
| [Sword of Life Stealing](3-Mechanics/CLI/items/sword-of-life-stealing-xdmg.md) | A rusty nonmagical sword | 12,000 gp |
| [Wings of Flying](3-Mechanics/CLI/items/wings-of-flying-xdmg.md) | Muzzled [harpy](3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md) in a cage | 11,000 gp |
^illusory-items
...
Woe betide any visitor who shows distress at such theatre. With the Agora being so readily accessible, Orishada keeps a watching legion of [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) haunting the rooftops like pigeons, watching for any intruders who lack the appropriate immoral fiber. Those who do are followed by the imps until a squad of four bone devils arrive to exterminate them.

##### Conclave (Bard)—Instrument of the Bards (Ollamh Harp)

Gazrak (chaotic evil, tiefling [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) sells all manner of grotesque musical instruments, but he also owns an [Instrument of the Bards (Ollamh Harp)](3-Mechanics/CLI/items/instrument-of-the-bards-ollamh-harp-xdmg.md). He is fond of the harp but also greedy. He suggests an outrageous price at first—30 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md). A successful DC 17 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can either lower the price to 20 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) or allow the characters to pay 100,000 gp instead of using [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md). Giving him a rare or very rare magic item as part of the exchange reduces the price by half.
...
To obtain the cloak the characters must hire the assassin (neutral evil, lizardfolk [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)) who wears it, and then kill them for it. When they threaten the assassin he mocks them because he is protected by a powerful archdevil.
...
|--------|------|-----------------------------|
| [Thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) | 100 gp | 1 |
| [Gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) | 250 gp | 3 |
| [Assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) | 500 gp | 5 |
| Undead [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md)* who summons a [bone devil](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md) instead of a shadow demon | 750 gp | 6 |
| Undead [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)* | 1,000 gp | 7 |
| Undead githyanki knight* on a [young shadow dragon](3-Mechanics/CLI/bestiary/dragon/shadow-dragon-xmm.md) (red) | 1,500 gp | 8 |
| The yat-ja slayer (lizardfolk [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) with a [Cloak of Invisibility](3-Mechanics/CLI/items/cloak-of-invisibility-xdmg.md)) | 5,000 gp | 9 |
| Saint of killers (fallen [planetar](3-Mechanics/CLI/bestiary/celestial/planetar-xmm.md) with no wings or fly speed, dressed in dark leather) | 20,000 gp | 12 |
^assassins-for-hire
...
**Incorporeal Movement.** The killer moves through other creatures and objects as if they were difficult terrain. The killer takes `dice:1d10\|noform\|noparens\|avg\|text(5)` (`1d10`) force damage if it ends its turn inside an object.
...
Aelvette is in possession of the [Iron Horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-iron-xdmg.md), a character searching for it has to steal it from her. When the characters enter Aelvette's chambers read the following:
...
The chefs working the kitchen are three [flesh golems](3-Mechanics/CLI/bestiary/construct/flesh-golem-xmm.md) directed by a [horned devil](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md). Any violence in the kitchens brings down the wrath of all the chefs and their overseer.
...
Corteso is always protected by a half-dozen [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) and their [intellect devourer](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) pets. If asked where he obtains his memories, the characters are told their suppliers are many, but recently high-quality memories have been obtained from a location known as the Ineffable Trove, located in Minauros.

> [!note] Temptation of Harm
> 
> ***"Carved in Flesh"***
> 
> One of the butchering knives, currently ensconced in a hunk of meat, appears larger and somehow more ominous than the others. It can be retrieved without alerting the golems and devil with a successful DC 16 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check. The characters now have the Knife of Stolen Resistance (see appendix D).
^temptation-of-harm
...
If his guests have no idea what he is talking about, Orishada—an [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse)—won't immediately order their deaths. He assumes it is part of some negotiation tactic. He summons one of his [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) to explain what a dispensation is:
...
If his guests decline to purchase a dispensation or they're impolite or violent, Orishada becomes enraged and orders his personal guard to liquidate the intruders. These include a quartet of [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) and a half dozen [bone devils](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md).

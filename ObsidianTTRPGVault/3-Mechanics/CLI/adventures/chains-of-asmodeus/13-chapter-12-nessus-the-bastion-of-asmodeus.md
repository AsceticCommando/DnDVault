...
![Nessus, a rocky wasteland.](file://adventure/CoA/194-0.webp#center)
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | A singular [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse) approaches the characters with a smile on their face. It offers a quick passage out of Nessus in exchange for 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) per character. To each paying character it gives a wishbone, that when snapped, transports the character back to the Falls of the Frozen Titan in Cania. |
| 2 | Two [pit fiends](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) spar with each other, testing their strength. They invite any travelers to spar with them. If they find their sparring partner to be lacking in strength, they quickly change their tune to harvest a wayward soul. |
| 3 | A group of four [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) patrol the skies of Nessus, looking for any potential intruders. If they spot any, they approach and ask to see a writ of passage. If the intruder can't produce valid evidence, the group attacks. |
| 4 | Filled with rage by the sheer quantity of souls it absorbed, a [tyrant shadow](3-Mechanics/CLI/bestiary/aberration/tyrant-shadow-coa.md) (see appendix B) rampages through the layer. Creatures of its size and strength are rare, and its death curries favor in the realm. If they kill it, the characters have advantage on all checks when interacting with the Triad. Additionally, when the tyrant shadow dies, `dice:3d4\|noform\|noparens\|avg` (`3d4`) [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) are created. |
...
| 6 | Actively sneaking towards the center of Nessus is a single [balor](3-Mechanics/CLI/bestiary/fiend/balor-xmm.md) dressed in black robes. It is constantly vigilant and approaches any creature that notices its presence. Its infiltration was difficult to secure, and it goes to any length to ensure no devil learns of its mission. |
^random-encounters-in-nessus
...
> [!gallery]
> ![Nessus, the Ninth Hell](file://adventure/CoA/196-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/196-0.webp#gallery)
...
Climbing down the titan isn't without its dangers. [Shredwings](3-Mechanics/CLI/bestiary/fiend/shredwing-coa.md) roost in parts of the body of the titan. `dice:2d6|noform|noparens|avg` (`2d6`) of them attack anyone descending, but once half of them are killed, the rest retreat.

![Climbing down the frozen giant to Nessus.](file://adventure/CoA/199-0.webp#center)
...
The escort is led by a [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) and includes four [war devils](3-Mechanics/CLI/bestiary/fiend/war-devil-coa.md) (see appendix B), six [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md), and a pair of [adult red dragons](3-Mechanics/CLI/bestiary/dragon/adult-red-dragon-xmm.md) that the characters are to ride if they can't fly themselves. Even the most powerful characters will find this to be a difficult fight if it comes to violence, but the devils have been told to simply escort the characters, not imprison them. They only attack to defend themselves or if the characters refuse to accompany them. Proceed to the "Adventure: Malsheem" section.
...
If the characters are successful, they obtain `4d4 x 1000` pp and one rare magic item from the "Dungeon Master's Guide". The characters also find `dice:2d4|noform|noparens|avg` (`2d4`) [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md).

![Like the Styx, the River Lethe contains many dangers.](file://adventure/CoA/200-0.webp#center)

#### The Plains of Nessus

![In an attempt to escape Nessus, desperate souls have stolen an armored wagon.](file://adventure/CoA/201-0.webp#center)
...
The Bright Hounds are comprised of four [devas](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) and two [planetars](3-Mechanics/CLI/bestiary/celestial/planetar-xmm.md) (lawful evil and delivering necrotic damage instead of radiant). The characters, encountering the wagon on its headlong flight, might get involved in a variety of ways. The wagon's inhabitants, believing they know a way out of Nessus (which conveniently is at the Oasis of the Lethe, but is also just a lie planted by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)) may offer them a place aboard in return for fighting off the devils—only to be revealed as monsters almost as bad as the devils outside. The angelic hunters may provoke pity, though there is little the characters can do for them save end them.

## Adventure: The Oasis of the Lethe

![The oasis floats above vast desolation.](file://adventure/CoA/202-0.webp#center)
...
> [!gallery]
> ![The Oasis of the Lethe](file://adventure/CoA/203-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/203-0.webp#gallery)

### Oasis of the Lethe Locations

![Elihandrel lures scholars to the Nine Hells with the promise of knowledge.](file://adventure/CoA/204-0.webp#center)
...
One of the most respected minds of the current roster of scholars at the Oasis is that of Aldri Teskethmus, a living human [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) of the Red Wizards, who theorizes that the traditional arrangement of the planes is merely an artifact of mortals' limited ability to comprehend the wider universe.

#### O3: Home of Orvedarc

Orvedarc is a [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) heretic priest-scholar who died centuries ago and has spent time in the Nine Hells both in torment and in service to devils. Now released, he works on his incomplete research into the nature of divinity and divine magic.

#### O4: Home of Isitrix

Isitrix the Termagant is a sahuagin magician-queen ([mummy lord](3-Mechanics/CLI/bestiary/undead/mummy-lord-xmm.md) but she isn't Undead, her creature type is Humanoid) who in life brought wars that encompassed entire oceans, but who now peaceably studies the River Lethe and its curious mechanics.

#### O5: Home of Elihandrel

It is an inevitable fact that those long-dead souls at the Oasis are mostly of evil persuasion. There are other incautious mortals who fall into [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s power, but the majority of souls in his domain are those drawn to the Nine Hells by the choices they made in life. However, the arch-magister of the Oasis, Elihandrel (use [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md) stats but Elihandrel is Medium sized), keeps order. His word is law, as much as [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s is within Malsheem. Those who won't abide by his codes of peace and scholarly amity know that a return to the Nine Hells awaits.
...
- **Dire Winter.** This allows the caster to bring about a winter across an entire continent that lasts for `dice:2d12|noform|noparens|avg` (`2d12`) years.  
...
It is here, in the legal section, where the characters find the loopholes needed to annul the contracts. Each hour that is spent searching requires a successful DC 20 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check to find the legal books that are needed to annul one of the contracts.

Once a character has found a loophole, they can ask the caretaker to annul the contract. The caretaker is only too happy to oblige, commenting on the vigorous and impressive research the character has done to prepare their case. However, a successful DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check informs a character that it might be best to wait to trigger an annulment until all the loopholes required for all the characters are found.
...
|----------|-----------|
| 1 | Nothing |
| 2 | A [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) |
| 3 | Five [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) |
...
![An unholy deal: no one but Elihandrel survives the purges.](file://adventure/CoA/207-0.webp#center)
...
> 
> Any knowledge or spells that a character learned at the Oasis is lost within `dice:2d12|noform|noparens|avg` (`2d12`) hours of leaving. This includes attribute adjustments from books such as the Manual of Bodily Health.
...
![Malsheem, the seat of power.](file://adventure/CoA/208-0.webp#center)
...
There are several ways the characters might arrive at the city: captured upon entering Nessus and taken directly to Malsheem, brought here as captives of the Dukes—some brave characters may even choose to walk into the city themselves. No matter how they get here, they always enter through the city gates of Malsheem. Here they're met by an escort of two [pit fiends](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) and eight [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) who announce that they're to be guests in the palace of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). The characters can go with them or attack. If they attack, the devils are joined by another pit fiend on initiative count 15 of every round. Once defeated, the characters are deposited at the palace for an audience with The Triad.
...
![Baalzebul's slug form](file://adventure/CoA/212-0.webp#center)
...
- You agree to become an agent for [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). This guarantees you arrive in the Nine Hells as a horned devil upon death. A successful DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check upgrades this to a pit fiend.  
...
Once terms have been agreed upon, the Triad writes up the contract. However, there are some obvious loopholes that could be exploited by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). There are three loopholes in total, one written by each of the Triad. A successful DC 20 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) or Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check reveals the first loophole and alerts the characters that they're being tricked, lowering the DC for finding the second and third loophole to 15. Once discovered, the characters can succeed on a DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check to have the loophole removed—or they can threaten violence. If they're violent, then whoever they've threatened attacks. If it wasn't [Buer](3-Mechanics/CLI/bestiary/npc/buer-coa.md) that they threatened, she helps in the attack. The other(s) stand back and watch. At half hit points the hostile devil accepts defeat and removes the loophole.
...
Any of the characters can agree to sign a contract that stipulates that their soul goes to the Nine Hells when they die. However, they will arrive in the Nine Hells as horned devils. A successful DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can make it so that they arrive in the Nine Hells as pit fiends instead. In exchange for their souls [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) will grant them power undreamed of by most mortals. They can choose any 2 of the epic boons available in the "Dungeon Master's Guide" (a successful DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check increases this to 3).
...
![Asmodeus towers over his guests.](file://adventure/CoA/213-0.webp#center)
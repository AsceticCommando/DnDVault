...
![Powerful infernal items are found in dangerous places across all layers of the Nine Hells.](file://adventure/CoA/269-0.webp#center)
...
After failing the Wisdom saving throw in Stage One, the character progresses to Stage Two. While in Stage Two, they become delusional, seeing plots against them where there are none. Additionally, each time they rest, they experience terrifying visions and infernal whispers. Whenever they finish a long rest, they take `dice:1d12|noform|noparens|avg|text(6)` (`1d12`) necrotic damage, which ignores resistances and immunities and can't be healed until a Dispel Evil and Good or [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell is cast on them. Once the character has taken this damage from their nightmarish visions six times, they progress to Stage Three of their corruption. While in Stage Two, the infernal corruption can be removed with one of the following spells: [Divine Word](3-Mechanics/CLI/spells/divine-word-xphb.md), [Heal](3-Mechanics/CLI/spells/heal-xphb.md), [Mass Heal](3-Mechanics/CLI/spells/mass-heal-xphb.md), [True Polymorph](3-Mechanics/CLI/spells/true-polymorph-xphb.md), [True Resurrection](3-Mechanics/CLI/spells/true-resurrection-xphb.md), or [Wish](3-Mechanics/CLI/spells/wish-xphb.md).

### Stage Three Corruption: Departings

Once a character's will has been significantly weakened, they progress to Stage Three. While in Stage Three, the character begins to suffer physical transformation, and slowly embraces evil. After they finish their first long rest upon entering Stage Three they must roll `dice:1d10|noform|noparens|avg` (`1d10`) to determine how the infernal curse has begun shaping them into a devil. In addition to the specific effects, a part-devil character is rendered infertile and the character detects as a Fiend when subjected to [Detect Evil and Good](3-Mechanics/CLI/spells/detect-evil-and-good-xphb.md) spells and similar magic.
...
While in Stage Three, the infernal corruption can be ended with one of the following spells: [True Polymorph](3-Mechanics/CLI/spells/true-polymorph-xphb.md), [True Resurrection](3-Mechanics/CLI/spells/true-resurrection-xphb.md) or [Wish](3-Mechanics/CLI/spells/wish-xphb.md).
...
Once the character reaches Stage Four, the only two cures are the [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell, which counts as beyond the scope of the spell, or by signing an infernal contract with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) to reclaim their soul.
...
![A battle erupts on the River Styx](file://adventure/CoA/277-0.webp#center)
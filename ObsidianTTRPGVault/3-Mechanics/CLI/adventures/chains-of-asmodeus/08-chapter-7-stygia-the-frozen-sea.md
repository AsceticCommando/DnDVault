...
![No one finds the Chasm of Found Things. It finds you.](file://adventure/CoA/122-0.webp#center)
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | One [ice devil](3-Mechanics/CLI/bestiary/fiend/ice-devil-xmm.md) travels through the icy hellscape. |
| 2 | Breaking through the ice to hunt for food, a [kraken](3-Mechanics/CLI/bestiary/monstrosity/kraken-xmm.md) with immunity to cold damage thrashes about. If it spots any prey, such as mortals visiting the Nine Hells, it attacks. |
| 3 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [white abishai](3-Mechanics/CLI/bestiary/fiend/white-abishai-mpmm.md) (see Monsters of the Multiverse) stalk the blizzards, looking for treasure to bring back to their lair. When they spot the characters, they threaten and extort hoping for loot. |
| 4 | A mismatched pack of animals, starved nearly to death, attacks the characters out of desperation. The pack is led by an ancient [mammoth](3-Mechanics/CLI/bestiary/beast/mammoth-xmm.md), but also includes `dice:3d6\|noform\|noparens\|avg` (`3d6`) [polar bears](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md). |
| 5 | Shouts and sounds of combat can be heard from nearby. A pair of [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) are locked in a heated battle with a [remorhaz](3-Mechanics/CLI/bestiary/monstrosity/remorhaz-xmm.md). It is a den mother, and each of the `dice:2d4\|noform\|noparens\|avg` (`2d4`) eggs in its hive, are worth 500 gp. |
| 6 | A pocket of intense cold erupts in a 60-foot radius sphere around one of the characters. Each creature within the area must make a DC 19 Constitution saving throw. On a failed save, a creature takes `dice:12d6\|noform\|noparens\|avg\|text(42)` (`12d6`) cold damage. On a successful save, it takes half as much damage. |
^random-encounters-in-stygia
...
| Chasm of Found Things: The Angel of the Ice | [Manual of Golems (iron)](3-Mechanics/CLI/items/manual-of-iron-golems-xdmg.md) |
| Chasm of Found Things: The Aboleth | [Rod of Resurrection](3-Mechanics/CLI/items/rod-of-resurrection-xdmg.md) |
| Chasm of Found Things: The [Awful Fisher](3-Mechanics/CLI/bestiary/npc/awful-fisher-coa.md) | [Holy Avenger](3-Mechanics/CLI/items/holy-avenger-xdmg.md) |
...
Many creatures call the frozen surface of Stygia home, most of which aren't native to the Nine Hells. Small pockets of warmer temperature dot the sea, creating arctic swamps of plants and lichen. Animals such as [mammoths](3-Mechanics/CLI/bestiary/beast/mammoth-xmm.md), [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md), and [polar bears](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) flock to the swamps for warmth and sustenance. In the region of Stygia known as Sheyruushk, enormous sharks the size of whales swim below the frozen surface.
...
![Stygia's glaciers hide many secrets.](file://adventure/CoA/124-0.webp#center)
...
The cold of Stygia chills to the bone, leaving creatures fighting for survival. Each time a creature finishes a long rest, they must succeed on a DC 16 Constitution saving throw or gain a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Creatures with resistance or immunity to cold automatically succeed on the save.
...
> [!gallery]
> ![Stygia, the Fifth Hell](file://adventure/CoA/125-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/125-0.webp#gallery)
...
> ***"Mixed Blessings"***
> 
> A [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md), perhaps in the service of [Levistus](3-Mechanics/CLI/bestiary/npc/levistus-coa.md), approaches a character.
> 
...
> [!gallery]
> ![The Chasm of Found Things](file://adventure/CoA/126-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/126-0.webp#gallery)
...
Once each character has gained a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion), they hear whispers and see strange apparitions in the blowing snow, and eventually find themselves near the Chasm of Found Things, drawn to the entrance (area C1).

### Chasm of Found Things Locations

Wandering the frozen wastes endlessly, the characters grow convinced that their search is futile. Exhausted and frostbitten they collapse in the snow. The character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score finds a cave entrance nearby.
...
The Congregation consists of three dozen [kuo-toa monitors](3-Mechanics/CLI/bestiary/aberration/kuo-toa-monitor-xmm.md) and a trio of [kuo-toa archpriests](3-Mechanics/CLI/bestiary/aberration/kuo-toa-archpriest-xmm.md). The kuo-toa are in a period of contemplation and therefore peaceful, if not attacked. However, they're so deranged that they provide scarce information and the characters would need to spend considerable time moving between the various tunnels to encounter all of them. If a kuo-toa is attacked here, it summons all its brethren to defend it. If the entire kuo-toa populace in this area is slain, the characters recover 8,000 gp worth of various gems and other valuables.

> [!note] The Blind Believers
> 
> The kuo-toa living in the chasm have [blindsight](3-Mechanics/CLI/rules/senses.md#Blindsight) out to a range of 60 feet and resistance to cold damage.
^the-blind-believers
...
Below, the tunnels twine and corkscrew downwards. In these reaches, travelers might encounter Congregation pilgrims trekking towards their ultimate religious experience, or sometimes fugitive devils—[ice devils](3-Mechanics/CLI/bestiary/fiend/ice-devil-xmm.md) and [pain devils](3-Mechanics/CLI/bestiary/fiend/pain-devil-excruciarch-coa.md) (see appendix B)—drawn into the caves seeking mortals to torment or escaping more powerful devils. Most common, though, are the Echoes. Read the following:
...
Like any religion, the Congregation has heretics to persecute. Separate caves hold a smaller community of dissidents led by the Angel of the Ice (lawful evil [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md)). This fallen Celestial claims to have been sent to the Chasm to reclaim it from the Nine Hells and build a gateway to the higher realms, preparatory to ushering in a vast army to cleanse all the lower planes. It is just as deluded as the Congregation, dwelling before a mirror-like wall of ice on which it has scratched out a vastly complex diagram that it says holds the secret to the movements and future of the planes.

##### Defenders of the Faith

The Angel is attended by a cult of kuo-toa that it has attempted to reshape into something more holy, resulting in a curious admixture of aasimar-like qualities into its brood. There are a dozen of these heretics ([kuo-toa monitors](3-Mechanics/CLI/bestiary/aberration/kuo-toa-monitor-xmm.md) that can change the damage type of their attacks to radiant damage). Each heretic carries `dice:2d20|noform|noparens|avg` (`2d20`) gp.

![A statue of the Angel of the Ice.](file://adventure/CoA/130-0.webp#center)

If the ice wall, or the [Holy Avenger](3-Mechanics/CLI/items/holy-avenger-xdmg.md) within it, is disturbed for any reason, the following occurs:
...
The Angel of Ice eventually found themselves incapable of wielding their [Holy Avenger](3-Mechanics/CLI/items/holy-avenger-xdmg.md) and so they ensconced it in the ice. Just the hilt sticks out now and anyone examining the diagram on the wall easily notices it. It requires two successful consecutive DC 18 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) checks to pull the sword from the ice. Each check requires an action.
...
A character searching for the [Manual of Golems (iron)](3-Mechanics/CLI/items/manual-of-iron-golems-xdmg.md) discovers it in the clutches of the first aboleth they encounter.
...
A character searching for one of the [True-Ice Shards](3-Mechanics/CLI/items/true-ice-shards-coa.md) sees it lodged in the ice at the end of the chasm. If they touch the shard while still encased in the ice, they take `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) cold damage and must succeed on a DC 18 Constitution saving throw. If they fail, they can't let go of the object and the ice starts enveloping them. The character takes `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) cold damage at the start of each turn that they're still holding the shard, but doesn't repeat the saving throw.
...
![Kuo Toa give offerings to Gjaaki.](file://adventure/CoA/132-0.webp#center)

...
![The Eye Market looms over the surrounding streets.](file://adventure/CoA/148-0.webp#center)
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [erinyes](3-Mechanics/CLI/bestiary/fiend/erinyes-xmm.md) quietly travel throughout the realm, checking in on construction projects. They're spies from another layer of the Nine Hells, though from which they're unwilling to share. |
| 2 | Construction on a new project is being done by thirty [lemures](3-Mechanics/CLI/bestiary/fiend/lemure-xmm.md), led by a [corruption devil](3-Mechanics/CLI/bestiary/fiend/corruption-devil-paeliryon-coa.md) (see appendix B). |
| 3 | An [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse) researcher is exploring the various ruins nearby, cataloguing what it finds for storage in Grenpoli. |
...
| 5 | Hidden within a nearby ruin is a small camp of six [spined devil](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) runaways. They shirked their construction duties and are hiding from their former masters. |
| 6 | A belch of foul smog suddenly drops from the sky, covering one of the characters and expanding out from them. Treat the smog as if it were a 9th-level [Cloudkill](3-Mechanics/CLI/spells/cloudkill-xphb.md) spell except that it covers a 200-foot-radius sphere and has a save DC of 21. |
^random-encounters-in-maladomini
...
| [Staff of the Woodlands](3-Mechanics/CLI/items/staff-of-the-woodlands-xdmg.md) | Eye Market: The Slums |
...
> [!gallery]
> ![Maladomini, the Seventh Hell](file://adventure/CoA/150-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/150-0.webp#gallery)
...
![A flying fortress oversees the construction of Gorloron.](file://adventure/CoA/151-0.webp#center)
...
![Visitors must dock their ships outside the gates of Grenpoli.](file://adventure/CoA/152-0.webp#center)
...
> [!gallery]
> ![The Eye Market](file://adventure/CoA/154-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/154-0.webp#gallery)

### Eye Market Locations

![Akrekarn imposes the law on the streets outside the Eye Market.](file://adventure/CoA/155-0.webp#center)
...
To pass through this territory the characters need to pay 7,500 gp or deliver a rival's head. If they choose to fight their way through, they're challenged by Ilkatar ([green abishai](3-Mechanics/CLI/bestiary/fiend/green-abishai-mpmm.md)), the [white abishai](3-Mechanics/CLI/bestiary/fiend/white-abishai-mpmm.md) lieutenant (see Monsters of the Multiverse for the abishai stat blocks), and four [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md).

##### Treasure

If the characters slay Ilkatar and succeed on a DC 22 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check, they find a discarded lockbox under the wooden throne. Opening it reveals 3,500 pp.
...
To save them, the character needs to find their true love among the many reflections. Have the character make an Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check. Look up their result on the Mirror Reflections table. Once the character has dealt with the outcome of a failure they can try again.
...
| Result | Outcome |
|--------|---------|
| 3 or less | The reflection vanishes, meanwhile three [white abishai](3-Mechanics/CLI/bestiary/fiend/white-abishai-mpmm.md) (see Monsters of the Multiverse) step out of nearby mirrors, surrounding the character. If the character gets this result on their fourth or later roll, they find their true love instead. |
| 4–6 | The mirror shatters and the shards cut the character. The character must make a DC 16 Dexterity saving throw, taking `dice:6d6\|noform\|noparens\|avg\|text(21)` (`6d6`) piercing damage on a failed save, or half as much damage on a successful one. |
...
| 10–12 | The character is pulled into the reflection by two [black abishai](3-Mechanics/CLI/bestiary/fiend/black-abishai-mpmm.md). If the character gets this result on their third roll, they find their true love instead. |
| 13–15 | A [red abishai](3-Mechanics/CLI/bestiary/fiend/red-abishai-mpmm.md) lunges forward from the reflection and attacks the character but vanishes at the end of its second turn of combat. If the character gets this result on their second roll, they find their true love instead. |
| 16 or more | They find their true love. |
^mirror-reflections

#### M3: Ganglands—Memnoriac's Territory

Memnoriac was once one of [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-coa.md)'s architects, a [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) of great status and power. Like all such, his perceived 'failures' eventually led to his downfall, and now he squats with his ragbag of followers in the city he designed and will never complete. The single most powerful devil in the ruin, he is tormented by the collapse of his final project and has become a [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-coa.md) in miniature. Those under his control are constantly re-edifying the buildings around him, raising them up and tearing them down as he seeks his own minuscule perfection.
...
The character realizes that this imp is the vessel for their soul and that they must rescue it from a [chain devil](3-Mechanics/CLI/bestiary/fiend/chain-devil-xmm.md), a [bone devil](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md), and three [bearded devils](3-Mechanics/CLI/bestiary/fiend/bearded-devil-xmm.md). The devils immediately attack. On each of their turns, one of the devils tries to hit the imp while the others attack the characters. Each time the imp dies it comes back to life on initiative count 20 of the following round but another hostile bearded devil also materializes at the same time. The imp has the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) condition and is afraid of both the devils and the characters and on its turn, it attempts to flee from both.
...
Given that her route is the shortest to the Eye Market, and observing that the character's carry many interesting valuables, Jacelisk demands a rare or better magic item and at least four uncommon or better magic items as tribute. If attacked, Jacelisk ([archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) with resistance to fire damage, the ability to cast [Hellish Rebuke](3-Mechanics/CLI/spells/hellish-rebuke-xphb.md) twice a day, and the ability to use her Eyes of Charming one time), tries to keep her three [barbed devils](3-Mechanics/CLI/bestiary/fiend/barbed-devil-xmm.md) in between herself and the characters while she unleashes deadly magic. She has already cast [Mage Armor](3-Mechanics/CLI/spells/mage-armor-xphb.md) and [Stoneskin](3-Mechanics/CLI/spells/stoneskin-xphb.md) on herself. If the characters have attempted to fly past this area, they're intercepted by the barbed devils—Jacelisk has cast the [Fly](3-Mechanics/CLI/spells/fly-xphb.md) spell on them.
...
A remarkable number of the denizens of this slum are damaged, victims of [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-coa.md)'s construction works where safety is never a concern. Crooked and whining [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) and other lesser devils roost or slither everywhere, proffering fistfuls of slimy muck, desperate to get in on the ground floor of the city's nonsense economy.

##### Conclave (Druid)—Staff of the Woodlands

When the characters walk the slums, they're beset by lowly devils trying to sell them their useless trinkets. If a character is looking for the Staff of the Woodlands their attention is drawn to a miserable looking imp who has set up shop in the corner. When they inspect its wares, they find the staff among them. The imp has no idea of the value of the item it possesses. The character needs to succeed on a DC 16 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check to purchase it for a reasonable price.
...
![Vaness inspects his wares.](file://adventure/CoA/159-0.webp#center)
...
| [Eyes of Charming](3-Mechanics/CLI/items/eyes-of-charming-xdmg.md) (see "Dungeon Master's Guide") | None | 5,000 gp |
| [Eyes of the Eagle](3-Mechanics/CLI/items/eyes-of-the-eagle-xdmg.md) (see "Dungeon Master's Guide") | None | 2,000 gp |
| Eyes of Far Sight—the recipient can cast [Clairvoyance](3-Mechanics/CLI/spells/clairvoyance-xphb.md) at will. | 12th-level character | 25,000 gp |
| [Eyes of Minute Seeing](3-Mechanics/CLI/items/eyes-of-minute-seeing-xdmg.md) (see "Dungeon Master's Guide") | None | 3,000 gp |
| Eyes of True Seeing—The recipient gains [truesight](3-Mechanics/CLI/rules/senses.md#Truesight) out to a range of 30 feet. | 15th-level character | 75,000 gp |
^eyes-for-sale
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | A [blue abishai](3-Mechanics/CLI/bestiary/fiend/blue-abishai-mpmm.md) (see Monsters of the Multiverse) leads a half-dozen [black abishai](3-Mechanics/CLI/bestiary/fiend/black-abishai-mpmm.md), cloaked in [Darkness](3-Mechanics/CLI/spells/darkness-xphb.md) spells, in an ambush, hoping to steal the eyes. |
| 2 | A primordial glittering beast ([adult black dragon](3-Mechanics/CLI/bestiary/dragon/adult-black-dragon-xmm.md) with no flight speed) hunts anyone who possesses magical eyes. |
| 3 | Twisted vegetation emerges and grows around the afflicted character and a dozen strange creatures ([nothics](3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) with a burrowing speed of 30) crawl out from under the plants. They attack anyone with magical eyes. |
| 4 | A beautiful bird the size of a building (roc with legendary resistance 3/Day) hunts anyone who possesses magical eyes. |
| 5–10 | A glorious vision enthralls anyone that possesses magical eyes. Each of them must succeed on a DC 20 Wisdom saving throw or have the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) condition for `dice:1d12\|noform\|noparens\|avg` (`1d12`) hours as they stare at the vision. When they wake, they gain the benefit of a long rest. |
^vaness-eyes-random-encounters
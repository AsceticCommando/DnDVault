...
![Sentry Towers overlook the battlefield.](file://adventure/CoA/068-0.webp#center)
...
| 2 | A group of [black abishai](3-Mechanics/CLI/bestiary/fiend/black-abishai-mpmm.md) and [white abishai](3-Mechanics/CLI/bestiary/fiend/white-abishai-mpmm.md) led by a [blue abishai](3-Mechanics/CLI/bestiary/fiend/blue-abishai-mpmm.md) (see Monsters of the Multiverse) fly overhead. If the characters follow them, they find Tiamat's Lair but risk discovery. |
| 3 | Six [spined devils](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) and eight [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) circle in the sky above the remains of a recent battlefield. |
...
| 6 | A storm of flame and dust that is equivalent to the [Storm of Vengeance](3-Mechanics/CLI/spells/storm-of-vengeance-xphb.md) spell (with a spell save DC of 19) erupts, centered around the characters and lasting for 10 rounds. |
^random-encounters-in-avernus
...
> [!gallery]
> ![Avernus, the First Hell](file://adventure/CoA/070-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/070-0.webp#gallery)
...
![Stay inside on a rainy day in Avernus.](file://adventure/CoA/071-0.webp#center)
...
> [!gallery]
> ![The War-Slough](file://adventure/CoA/072-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/072-0.webp#gallery)
...
| 4 | The creature's ears tear free from its head and scurry away; the creature has the [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened) condition. |
...
Every time the characters take a short or long rest in the War-Slough roll on the Random Encounters in the War-Slough table. Then roll a `dice:d6|noform|noparens|avg` (`d6`). On a 1–3 the random encounter interrupts the rest. On a 4–6 the encounter happens a few minutes after the rest is finished.
...
| 2 | A gang of five bulbous [hezrou](3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) (speed 20) erupt from a pool of demonic ichor. |
| 3 | A lost legion of one hundred [merregon](3-Mechanics/CLI/bestiary/fiend/merregon-mpmm.md) (see Monsters of the Multiverse) march in formation, ignoring anything that doesn't get in their way. A headless [horned devil](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) leads them. |
| 4 | A corpse worm ([purple worm](3-Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm.md) with the Fiend type) erupts from the ground beneath the characters. |
| 5 | A squad of a dozen insane [merregon](3-Mechanics/CLI/bestiary/fiend/merregon-mpmm.md) mistakes the characters for demons. |
| 6 | Two [horned devils](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) fused together (they always occupy the same space but have their own turns) lead a battalion of two dozen [merregon](3-Mechanics/CLI/bestiary/fiend/merregon-mpmm.md). One horned devil orders the battalion to attack, while the other orders them to march in formation. Each round there is a 50 percent chance of the merregon obeying either leader. |
^random-encounters-in-the-war-slough
...
Technically, [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md) has set a prohibition against any devil entering the War-Slough, to avoid the region being destabilized any further. Because of this prohibition, ambitious devils bargain with mortals to trick or bribe them to enter the Slough seeking rumored treasures. One such is an [amnizu](3-Mechanics/CLI/bestiary/fiend/amnizu-mpmm.md) (see Monsters of the Multiverse) named Rexlexkala. He approaches the characters if he sees them on the border of the War-Slough. Once he has convinced them that he doesn't intend harm, he explains what he has to offer them:
...
> [!gallery]
> ![Ruined Tower (W2)](file://adventure/CoA/075-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/075-0.webp#gallery)

The first obstacle is a half dozen barbed devils and a half dozen bearded devils marching back and forth along the road to the entrance. If observed, they're seemingly following orders that only they hear. They'll attack anyone that they see, but it is easy to avoid them when they're marching away from the tower. When first discovered they're 90 feet away from the tower and marching back towards it. Every turn, there is a 50 percent chance they reverse direction. Any noise makes them [Dash](3-Mechanics/CLI/rules/actions.md#Dash) towards the direction of that distraction, but they ignore anything that happens overhead, because they're, after all, mere foot soldiers. If these devils engage in combat with the characters, each round, one devil attempts to [Dash](3-Mechanics/CLI/rules/actions.md#Dash) back to the tower at "A" and if any devil reaches it, this obstacle is considered failed.

The second obstacle is only encountered if the characters approach the tower by air. If they do so, and are noticed, they're confronted by four [bone devils](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md) that patrol the skies about 600 feet above ground. One of the bone devils will [Dash](3-Mechanics/CLI/rules/actions.md#Dash) to the window ("C" on the map) 100 feet away that leads into the "Throne Room". If it reaches that window, this obstacle is considered failed.

The final obstacle is within the tower. The interior is mostly an empty ruin, with a simple stone staircase rising upwards. But `dice:1d4|noform|noparens|avg` (`1d4`) [shadow demons](3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) linger at each location marked "B" on the staircase (see the "Ruined Tower" map). These shadow demons attempt to hide from the characters and, if not discovered, they ascend to the next "B" (or to the "Throne Room," if the uppermost "B" has been reached). If any shadow demons reach the throne room, this obstacle is considered failed. If discovered, the shadow demons attack the characters.

##### The Throne Room

The [marilith](3-Mechanics/CLI/bestiary/fiend/marilith-xmm.md) is dressed up in the garments of a queen and attended to by four [bearded devils](3-Mechanics/CLI/bestiary/fiend/bearded-devil-xmm.md) that wear the fine clothing of palace courtiers and are busy entertaining the marilith. The marilith and her minions are unaware of the heroes until they announce themselves, or come within 15 feet of the throne, unless they've failed 2 or more of the previous obstacles, in which case she is very much aware of them. There is an additional bearded devil for every failed obstacle.

Once aware of them, the marilith and her devil courtiers mock the characters. They do this until the intruders attempt to leave or show any sort of disrespect, then they attack. If the marilith is killed her body vanishes and she appears on her throne `dice:1d6|noform|noparens|avg` (`1d6`) rounds later with 100 hit points. Only by destroying the throne can she be killed. The throne has an AC of 15 and 100 hit points.
...
In a fight this servant ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) doesn't participate, even if attacked directly. Once the queen is permanently slain, the servant contorts and twists, leaving behind the character's soul phylactery.

#### W3: Ichor Lake and the Demon Nest

![The ichor lake awaits.](file://adventure/CoA/077-0.webp#center)

> [!gallery]
> ![Demon Nest (W3)](file://adventure/CoA/077-1-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/077-1.webp#gallery)
...
Each cave has [hezrou](3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) and [barlgura](3-Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) embedded in its walls, many only partially formed. Blood vessels in the walls pump demonic ichor into the catatonic demons. Attacking any of them awakens `dice:1d6|noform|noparens|avg` (`1d6`) of each.

#### W3C: Demons

A mixture of two dozen [dretches](3-Mechanics/CLI/bestiary/fiend/dretch-xmm.md) and [manes](3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) mill about mindlessly in these caves. They ignore intruders but descend with fury on anyone who attacks them.
...
![A brave prospector ventures into the Trove despite its dangers.](file://adventure/CoA/079-0.webp#center)
...
This isolated canyon descends into the depths of the Slough and is where the real treasures of the War-Slough are found, including the horn that Rexlexkala desires. Strange things occur sporadically as the characters descend, the place twisted and distorted by the great war. When a character least expects it (perhaps just after a rest, or in the midst of battle), a [grotesque tentacle](3-Mechanics/CLI/bestiary/monstrosity/grotesque-tentacle-coa.md) with a shrieking mouth instead of suckers bursts from the canyon wall to flail about wildly before withdrawing again. The tentacles are harmless unless the characters decide to attack one (then the tentacles have the statistics of a [guardian naga](3-Mechanics/CLI/bestiary/celestial/guardian-naga-xmm.md), but 0 movement speed, lawful evil alignment and no spellcasting trait).

Though the tentacles can be safely ignored, there are real dangers in the canyon. And to find items of true value, the characters have to make an effort to explore, heading deep into the canyon's bowels. Each hour the characters make a DC 20 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check to search for clues that might lead them to the treasures they seek. Failure results in an encounter, while success leads to treasure.

##### Encounter

The first time the characters fail their search results in them encountering the "Temptation of Anger." Afterwards, on future failures, roll a `dice:d8|noform|noparens|avg` (`d8`). 1–4 means an empty cave; 5–6 means they stumble upon `dice:1d2|noform|noparens|avg` (`1d2`) [glabrezu](3-Mechanics/CLI/bestiary/fiend/glabrezu-xmm.md); a 7–8 means they find `dice:1d4|noform|noparens|avg` (`1d4`) [hezrou](3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md).
...
A [nalfeshnee](3-Mechanics/CLI/bestiary/fiend/nalfeshnee-xmm.md) carries the artifact that Rexlexkala seeks and won't relinquish it without a fight. The artifact looks like a metallic horn, but if touched it begins to wriggle like a grotesque worm. Other than this it can be handled safely. An [Identify](3-Mechanics/CLI/spells/identify-xphb.md) spell reveals that it is meant to be swallowed to attune to it, but if anyone other than a devil does so, they gain none of its powers and instead are afflicted with a random major insanity that can't be removed until the artifact is extracted.
...
| 5 | Demonbone Polearm | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [barlguras](3-Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) |
| 6 | Sword of Retribution | Yellow mold |
| 7 | Infernal Amulet | Angry [horned devil](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) |
...
| 2 | This box casts bright light for 200 feet and dim light for 1,000 feet. Covering it negates the light. An [Identify](3-Mechanics/CLI/spells/identify-xphb.md) spell reveals that the box is full of divine energy and will explode if opened. If an action is used to open the box, every creature in a 100-foot-radius takes `dice:20d6\|noform\|noparens\|avg\|text(70)` (`20d6`) radiant damage and the box is destroyed. |
| 3 | This ornate fan is comprised of dozens of partly melted blades. When an action is used to unfurl the blades, spores are released in a 40-foot-radius. Any demon in the area must make a DC 17 Constitution saving throw. On a failed save, they take `dice:10d6\|noform\|noparens\|avg\|text(35)` (`10d6`) necrotic damage and one affliction from the Flesh Warping table. Once used, the fan can't be used again until a long rest is finished. |
| 4 | This is a bag with `dice:10d10\|noform\|noparens\|avg` (`10d10`) strange seeds inside. If a seed is planted in the Nine Hells, it immediately grows into a corrupted [shrieker](3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md). Any demon that doesn't have the [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened) condition and starts its turn within 30 feet of a corrupted shrieker takes `dice:2d6\|noform\|noparens\|avg\|text(7)` (`2d6`) psychic damage. This damage doesn't stack with damage from other corrupted shriekers. |
^ancient-blood-war-weapons
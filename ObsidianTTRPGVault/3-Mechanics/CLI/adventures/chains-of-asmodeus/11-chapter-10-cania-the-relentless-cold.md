...
![Trapped in the ice, the Anakim's brains are harvested to make wine.](file://adventure/CoA/162-0.webp#center)
...
| [Staff of the Magi](3-Mechanics/CLI/items/staff-of-the-magi-xdmg.md) | Sorrow Mine: The Mines |
^objectives-in-cania
...
> [!gallery]
> ![Cania, the Eighth Hell](file://adventure/CoA/164-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/164-0.webp#gallery)
...
Colder even than Stygia, all creatures on Cania face a constant battle with hypothermia. Each time a mortal finishes a long rest, they must succeed on a DC 17 Constitution saving throw or gain a level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).
...
![Cania's glaciers hide ancient evils.](file://adventure/CoA/165-0.webp#center)
...
> ***"To Cheat Death"***
> 
> If the characters explore Mephistar they risk drawing attention from Adonides or [Mephistopheles](3-Mechanics/CLI/bestiary/npc/mephistopheles-coa.md). But if they enter the city nonetheless, a [succubus](3-Mechanics/CLI/bestiary/fiend/succubus-xmm.md) calls to them from a shop inset into the wall of the glacier-city. She offers to inscribe a magic tattoo and suggests it protects against death. She charges only 250 gp and has ink for only one such tattoo. Run the appropriate temptation event from chapter 2 if one of the characters gets tattooed by her.
...
> 
> If sorrow wine is consumed by a creature that is not a Fiend, that creature takes `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) necrotic damage. This damage can be healed only with a short or long rest.
^the-sorrow-of-sorrow-wine

### The Sorrow Mine Locations

> [!gallery]
> ![The Sorrow Mine](file://adventure/CoA/169-0-dm.webp#gallery)
> ![Player Version](file://adventure/CoA/169-0.webp#gallery)
...
The prison is where the soul of the merciless can be found. Upon entering the village at the foot of the mines, the character searching for this soul, feels a strange pull towards this location. When the characters enter, they must evade a patrol of three [chain devils](3-Mechanics/CLI/bestiary/fiend/chain-devil-xmm.md). If they're discovered, they're attacked, and at initiative count 20 of round 5, and every 5 rounds thereafter while combat continues, another chain devil arrives to help. While being attacked in this way, the characters can't easily investigate the cells—they need to eliminate the devils and go back to hiding first.

Finding their way is easy, as the character in question recognizes the voices coming from one of the cells. Inside two figures are torturing a flesh golem that resembles a haggard and emaciated version of the character. The torturers look and sound exactly like the character's true love but are actually [chain devils](3-Mechanics/CLI/bestiary/fiend/chain-devil-xmm.md). If the character slays the devils without exposing their true form first, another chain devil appears in the doorway. They immediately transform into the form of the character's true love before entering the cell and attacking. During these battles the devils constantly taunt and mock the character in the voice of their loved one.

A successful DC 14 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check can help the characters understand that they need to remove the devils' disguises before slaying them. They can use [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) or any other similar means to help them break the magical disguise. Once the devils are wearing their own faces, and then slain, the flesh golem vanishes, leaving the phylactery in its place.
...
![The mining of sorrow brings its own challenges.](file://adventure/CoA/172-0.webp#center)
...
The items of value these giants crafted aren't easily transported. If an entire day is spent excavating, the characters recover a 100-pound statue made of gold and gems (and worth `d12 x 500` gp). However, this excavation draws the attention–and wrath–of the devils unless the baron has granted the characters a dispensation. A similar statue can be recovered with each day's effort, until `dice:3d4|noform|noparens|avg` (`3d4`) have been unearthed.
...
Only if the characters are investigating Kargan Skul's claims of sabotage, do they discover the truth. A lowly modron (chaotic neutral [quadrone](3-Mechanics/CLI/bestiary/construct/modron-quadrone-xmm.md) with 50 hit points) has been corrupted by the overwhelming grief permeating the mines. It has gone rogue and skulks the shadows of the mines, pushing miners off scaffolding, or narrow rock bridges when it can. Unfortunately, the Undead tend to be easier to shove than the golems, so many more of Kargan's minions have been lost to the mines, than Cornelius' golems.
...
![What lies beneath the Lake of Wael?](file://adventure/CoA/176-0.webp#center)
...
[Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) has previously cast [Mage Armor](3-Mechanics/CLI/spells/mage-armor-xphb.md) on himself. Regardless of the characters' affiliation, he approaches [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) in a friendly manner but casts [Contagion](3-Mechanics/CLI/spells/contagion-xphb.md) (using the mindfire effect). The attack roll required for this spell automatically succeeds against the unaware [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) unless the characters are able to warn him. Depending on past character decisions, [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) may have allies or additional opponents as described below:

- [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) has bribed one of the crew members (use the [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) stat block) and they assist [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) in this battle.  
- Additionally, if Grinken Eyre (neutral evil Medium-sized [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md)) was encountered in Minauros and not slain by the party, he has masqueraded as the other crew member since then and allied with [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md). He assists [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) in this fight. Grinken Eyre's presence makes the battle considerably more difficult if he is fighting the characters, so feel free to omit him.  
- If the characters have previously met Sir Calenhad Strongheart in the "A Paladin In Hell" encounter, he may have joined them on the barge. If so, he sides with [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) in this battle and comes to the characters aid if the characters do so as well. Calenhad is a lawful neutral [death knight](3-Mechanics/CLI/bestiary/undead/death-knight-xmm.md) that doesn't have the Marshal Undead trait or the Hellfire Orb action.  
- If Grinken Eyre isn't present, [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) previously called in a favor owed him by an [ice devil](3-Mechanics/CLI/bestiary/fiend/ice-devil-xmm.md), who shows up at initiative count 10 of the second round of combat. The other crew member (also a [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) fights to defend [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md), in this situation.  

The characters can choose to side with [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) or [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md). If they ally with [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md), it is very likely [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) will perish here and [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) will serve his role for the remainder of the plot. On the other hand, [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) is very fond of being alive and if reduced to less than half of his hit points (or otherwise feeling like the battle is going against him) casts [Dimension Door](3-Mechanics/CLI/spells/dimension-door-xphb.md) in an attempt to retreat.

...
![The Grassroads span the vast savannas and forests of Atagua, a boon to both travelers and predators](file://adventure/JttRC/134-14-001.grassroads.webp#center)
...
![Yarana and Nene](file://adventure/JttRC/135-14-002.yarana-and-nene.webp#center)
...
![The mysterious Ghost Orchid Tepui is a familiar sight in the dreams of Atagua's people](file://adventure/JttRC/136-14-003.ghost-orchid-tepui.webp#center)
...
> [!gallery]
> ![Map 14.1: Ghost Orchid Tepui](file://adventure/JttRC/137-map-14.1-ghost-orchid-tepui.webp#gallery)
> ![Player Version](file://adventure/JttRC/138-map-14.1-ghost-orchid-tepui-player.webp#gallery)
...
The water of the pool, the waterfall, and the stream that feeds them in area A4 has been magically tainted, causing creatures that touch it to rapidly decay. Any creature that enters the water for the first time on a turn or that starts its turn in the water takes `dice:8d10|noform|noparens|avg|text(44)` (`8d10`) necrotic damage. A character who investigates the water and succeeds on a DC 16 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check, or who tests the water by submerging any sort of organic material, recognizes the water's magical corruption. The [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the water has an aura of necromantic magic.
...
> [!gallery]
> ![Map 14.2: Crystal Caves](file://adventure/JttRC/139-map-14.2-crystal-caves.webp#gallery)
> ![Player Version](file://adventure/JttRC/140-map-14.2-crystal-caves-player.webp#gallery)
...
![Hammock of Worlds](file://adventure/JttRC/141-14-004.hammock-of-worlds.webp#center)
...
![The desiccated husk of the Drought Elder endlessly drifts through a lifeless void in the Far Realm](file://adventure/JttRC/142-14-005.dessicated-husk.webp#center)
...
Characters can access the exterior of the Drought Elder's carapace from areas D3 and D5. It can be climbed by any creature that succeeds on a DC 16 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. However, traveling outside the carapace beyond area D3 or `D5` attracts the attention of `dice:1d3|noform|noparens|avg` (`1d3`) [whistlers](3-Mechanics/CLI/bestiary/aberration/whistler-jttrc.md) every minute. These whistlers are hostile.
...
> [!gallery]
> ![Map 14.3: The Drought Elder](file://adventure/JttRC/143-map-14.3-the-drought-elder.webp#gallery)
> ![Player Version](file://adventure/JttRC/144-map-14.3-the-drought-elder-player.webp#gallery)
...
> [!gallery]
> ![Map 14.4: Atagua](file://adventure/JttRC/145-map-14.4-atagua.webp#gallery)
> ![Player Version](file://adventure/JttRC/146-map-14.4-atagua-player.webp#gallery)
...
![Whistler](file://adventure/JttRC/147-637937472238310589.webp#center)
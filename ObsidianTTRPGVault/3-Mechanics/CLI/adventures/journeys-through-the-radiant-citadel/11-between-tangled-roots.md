...
![The Storyteller Nimuel reveals the chaos caused by a rampaging bakunawa](file://adventure/JttRC/089-10-001.storyteller-nimuel.webp#center)
...
Before the characters can go with [Nimuel](3-Mechanics/CLI/bestiary/npc/nimuel-jttrc.md), the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score notices something moving amid the debris. A character who investigates realizes someone's trapped in the rubble. Clearing the rubble safely requires a character to make a DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. On a failed check, they find one of the home's residents (a [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) with 0 hit points. On a successful check, they find the resident coughing but largely unharmed. Whether found conscious or restored by healing, the resident thanks the characters. The resident can't reward the characters but speaks well of them to the whole neighborhood—a development that impresses [Nimuel](3-Mechanics/CLI/bestiary/npc/nimuel-jttrc.md).
...
![Lungtian](file://adventure/JttRC/090-10-002.lungtian.webp#center)
...
![Paolo Maykapal](file://adventure/JttRC/091-10-003.paolo-maykapal.webp#center)
...
![Flames Everlasting Skybridge stretches over steep hills and seas to the island of Lambakluha](file://adventure/JttRC/092-10-004.everlasting-skybridge.webp#center)
...
> [!gallery]
> ![Map 10.1: Lambakluha](file://adventure/JttRC/093-map-10.1-lambakluha.webp#gallery)
> ![Player Version](file://adventure/JttRC/094-map-10.1-lambakluha-player.webp#gallery)
...
![A Spirit Blister at Sorrow's Zenith](file://adventure/JttRC/095-10-005.spirit-blister.webp#center)
...
> [!gallery]
> ![Map 10.2: Roots of Bathalang Puno](file://adventure/JttRC/096-map-10.2-roots-of-bathalang-puno.webp#gallery)
> ![Player Version](file://adventure/JttRC/097-map-10.2-roots-of-bathalang-puno-player.webp#gallery)
...
![Bakunawa](file://adventure/JttRC/098-637937472199827263.webp#center)
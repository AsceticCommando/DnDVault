...
![Ghouls drag a fresh victim into the depths of Hollow Mine](file://adventure/JttRC/029-04-001.ghouls.webp#center)
...
As conversation dies down, [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) emerges from a door leading to the cellar and approaches the characters. She is wrapped in a rebozo and suffers from sereno with 3 levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). If the characters threaten to take her for the bounty, the dwarf [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) rush to protect her, and Rufina warns the characters that not just the villagers, but the folk of the entire region, will turn against them if they proceed.

![Paloma](file://adventure/JttRC/030-04-002.paloma.webp#center)
...
![Serapio](file://adventure/JttRC/031-04-003.serapio.webp#center)
...
> [!gallery]
> ![Map 4.1: Hollow Mine](file://adventure/JttRC/032-map-4.1-hollow-mine.webp#gallery)
> ![Player Version](file://adventure/JttRC/033-map-4.1-hollow-mine-player.webp#gallery)
...
A 5th-level [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) holding a [passwall](3-Mechanics/CLI/spells/passwall-xphb.md) spell is inscribed on the floor in front of the door. Characters can spot the glyph with a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check. If someone opens the door while standing on the glyph, the glyph triggers and casts its spell on the floor around it, opening a pit into area H3. Each creature standing in the shaded spaces in front of the door on map 4.1 falls 30 feet into area H3 and takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) bludgeoning damage. The glyph's effects can be avoided by opening the door from a distance, which prevents the spell from being triggered.
...
![The living and the dead celebrate the Night of the Remembered in San Citlán](file://adventure/JttRC/034-04-004.night-of-the-remembered.webp#center)
...
![Altar with Ofrendas](file://adventure/JttRC/035-04-005.altar-with-ofrendas.webp#center)
...
|-----------|--------------|
| 1 | A 20-foot-tall, papier-mâché skeleton puppet walks across the street. Make a DC 10 Dexterity saving throw to avoid being stepped on. On a failed check, you take `dice:2d4\|noform\|noparens\|avg\|text(5)` (`2d4`) bludgeoning damage and fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone). |
...
> [!gallery]
> ![Map 4.2: Abandoned Metalworks](file://adventure/JttRC/036-map-4.2-abandoned-metalworks.webp#gallery)
> ![Player Version](file://adventure/JttRC/037-map-4.2-abandoned-metalworks-player.webp#gallery)
...
> [!gallery]
> ![Map 4.3: San Citlán and Borderlands](file://adventure/JttRC/038-map-4.3-san-citlan-and-borderlands.webp#gallery)
> ![Player Version](file://adventure/JttRC/039-map-4.3-san-citlan-and-borderlands-player.webp#gallery)
...
![Tlacatecolo](file://adventure/JttRC/040-637937472229339929.webp#center)
...
![The plans of Ashen Heir anarchists go awry when a purple worm erupts into Three Suns Square](file://adventure/JttRC/099-11-001.ashen-heir-plans.webp#center)
...
> [!gallery]
> ![Map 11.1: Three Sun Square](file://adventure/JttRC/100-map-11.1-three-sun-square.webp#gallery)
> ![Player Version](file://adventure/JttRC/101-map-11.1-three-sun-square-player.webp#gallery)
...
During the chase, a participant can freely use the [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action a number of times equal to 3 + its Constitution modifier. Each additional [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action it takes during the chase requires the creature to succeed on a DC 10 Constitution check at the end of its turn or gain 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Unless it can move in some other manner, like riding a [carpet of flying](3-Mechanics/CLI/items/carpet-of-flying-xdmg.md), a creature drops out of the chase if its [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) reaches level 5, since its speed becomes 0. A creature can remove the levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) it gained during the chase by finishing a short or long rest. The [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action cannot make a [carpet of flying](3-Mechanics/CLI/items/carpet-of-flying-xdmg.md) move faster.
...
| 4 | You pass through an arc of knives thrown by performing food vendors (`dice:1d20+3\|noform\|noparens\|text(+3)` to hit, `dice:4d4+1\|noform\|noparens\|avg` (`4d4 + 1`) piercing damage on a hit). |
...
![](file://adventure/JttRC/102-11-002.ashen-carpet.webp#center)
...
![Laleh Ghorbani](file://adventure/JttRC/103-11-003.laleh-ghorbani.webp#center)
...
> [!gallery]
> ![Map 11.2: Ashen Heir Hideout](file://adventure/JttRC/104-map-11.2-ashen-heir-hideout.webp#gallery)
> ![Player Version](file://adventure/JttRC/105-map-11.2-ashen-heir-hideout-player.webp#gallery)
...
The crates scattered through the room hold 500 gp worth of stolen goods, including numerous fine jars stolen from the bazaar. A character who succeeds on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check while searching the scaffolding also discovers a set of [Nolzur's marvelous pigments](3-Mechanics/CLI/items/nolzurs-marvelous-pigments-xdmg.md).
...
> [!gallery]
> ![Map 11.3: Pedestal of Judgment](file://adventure/JttRC/107-map-11.3-pedestal-of-judgment.webp#gallery)
> ![Player Version](file://adventure/JttRC/108-map-11.3-pedestal-of-judgment-player.webp#gallery)
...
Each crystal is an immobile, Large object with AC 13, 25 hit points, and immunity to poison and psychic damage. Creatures inside the magic crystals are immune to all damage. A trapped creature is freed if its crystal is reduced to 0 hit points, or if the crystal is targeted with a [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast at 5th level or higher. The crystals leave their prisoners magically drained. If Afsoun is freed, she has 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) and can only cast spells of 3rd level or lower until she finishes a long rest. She seeks to avoid combat unless the characters find themselves about to be defeated.
...
A creature that falls from the platform or within 10 feet of it must make a DC 14 Dexterity saving throw. On a successful save, they grab onto one of the crystals hovering near or just below the platform. On a failed save, they plummet 300 feet to the ground, taking `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage and landing [prone](3-Mechanics/CLI/rules/conditions.md#Prone).

![Afsoun Ghorbani, Imprisoned in Crystal](file://adventure/JttRC/109-11-005.afsoun-ghorbani.webp#center)
...
![Atash, Ruler of Akharin Sangar](file://adventure/JttRC/110-11-006.atash.webp#center)
...
![Pari](file://adventure/JttRC/111-637937472213108340.webp#center)
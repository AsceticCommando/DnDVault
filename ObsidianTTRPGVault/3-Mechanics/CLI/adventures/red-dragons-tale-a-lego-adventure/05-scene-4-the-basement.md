...
> [!gallery]
> ![](file://adventure/LRDT/grimoire.webp#gallery)
> ![](file://adventure/LRDT/beholder.webp#gallery)
...
The three [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) (see the "Monster Manual" for their stat block) are Undead—the hostile remains of three members of the Hard Way (the group of adventurers hired by Ervan to steal the dragon egg).

These skeletons fight until destroyed and carry the following treasure:

- **Fighter.** This skeleton wears a [+1 Breastplate](3-Mechanics/CLI/items/1-armor-xdmg.md) and a nonmagical helm, and it carries a [Sword of Sharpness](3-Mechanics/CLI/items/sword-of-sharpness-xdmg.md).  
- **Rogue.** This skeleton carries a [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom-xdmg.md) and wears a [Ring of Invisibility](3-Mechanics/CLI/items/ring-of-invisibility-xdmg.md).  
- **Wizard.** This skeleton wears a magic cloak that has the properties of a [Robe of Scintillating Colors](3-Mechanics/CLI/items/robe-of-scintillating-colors-xdmg.md).  

Once the skeletons are defeated, a Player Character can use the [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of Speak with Dead found in scene 3 (if it hasn't already been used) to interrogate the skull of one of the dead adventurers and ask it up to five questions. The skull knows the same information as the one in scene 3.

### Poisonous Plants

The plants that grow in the basement are pink and extremely poisonous. Any creature that so much as touches one of these plants takes `dice:2d6|noform|noparens|avg` (`2d6`) poison damage.

> [!gallery]
> ![](file://adventure/LRDT/dagger.webp#gallery)
> ![](file://adventure/LRDT/sword.webp#gallery)
> ![](file://adventure/LRDT/cloak.webp#gallery)
> ![](file://adventure/LRDT/ring.webp#gallery)
...
![](file://adventure/LRDT/lantern.webp#center)

After the skeletons are dealt with, Player Characters can loot the basement. It contains the following treasures:

- **Book.** A [Manual of Quickness of Action](3-Mechanics/CLI/items/manual-of-quickness-of-action-xdmg.md) rests near some poisonous plants. Tucked inside the book is a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Protection from Energy](3-Mechanics/CLI/spells/protection-from-energy-xphb.md).  
- **Coins.** Lying on the floor is pile of loose coins worth 100 gold pieces.  
- **Lantern.** A [Lantern of Revealing](3-Mechanics/CLI/items/lantern-of-revealing-xdmg.md) sits in an alcove.  
- **Potion.** Set atop high shelves are a [Potion of Healing (Greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) and a [Potion of Heroism](3-Mechanics/CLI/items/potion-of-heroism-xdmg.md).
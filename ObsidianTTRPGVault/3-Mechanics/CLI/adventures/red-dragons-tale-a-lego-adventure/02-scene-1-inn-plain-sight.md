...
If attacked, Merry casts a spell ([Dimension Door](3-Mechanics/CLI/spells/dimension-door-xphb.md)) and disappears. He reappears in his workshop, which the Player Characters explore in scene 5.
...
![](file://adventure/LRDT/food.webp#center)
...
In the back is a kitchen that's barely used. This room contains several jars of hot sauce; a barrel of cooked, magically preserved chicken wings; and a rack of ordinary items that belonged to victims of the mimics upstairs, including a battleaxe, a [lute](3-Mechanics/CLI/items/lute-xphb.md), a pike, and a rapier.
...
- **Bag.** This [Bag of Holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md) contains mundane travel gear, such as a bedroll and edible dried rations.  

### Mimics

![](file://adventure/LRDT/mimic.webp#center)

The bed and the trunk are two [mimics](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) (see the "Monster Manual" for their stat block). The mimics attack as soon as one of them is touched.
...
If he hasn't already fled the scene, Merry casts a spell ([Dimension Door](3-Mechanics/CLI/spells/dimension-door-xphb.md)) that magically transports him to his workshop as soon as he hears any commotion in the bedroom. Player Characters can explore the workshop in scene 5.

...
![](file://adventure/LRDT/cube.webp#center)
...
- **Black Puddings.** The black blobs creeping across the floor are three [black puddings](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md). They can't communicate with the Player Characters and are hostile. Swords and other slashing weapons have no effect on them, but the puddings are afraid of fire and won't attack anyone who carries a lit torch. Dealing fire damage to a pudding causes it to slink away. The puddings love hot sauce; if a character spills a jar of hot sauce on the floor, the puddings creep toward the hot sauce, ignoring other creatures as they do so. It takes them 1 minute to digest the sauce, during which time they won't attack unless they are disturbed.  
- **Gelatinous Cubes.** The glowing yellow gemstone, skull, and silvered frying pan appear to be floating because they're encased in a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md). The cube is transparent and hostile. Player Characters near the cube can see its glistening form more clearly. Shambling quietly behind this cube is a baby gelatinous cube. The baby cube doesn't fight.  
...
> [!gallery]
> ![](file://adventure/LRDT/censer.webp#gallery)
> ![](file://adventure/LRDT/pan.webp#gallery)

- **Coins and Gems.** Player Characters can find an amethyst worth 500 gold pieces, a diamond worth 1,000 gold pieces, and a pile of loose coins worth 100 gold pieces. The glowing yellow gem inside the adult gelatinous cube is a topaz worth 500 gold pieces and has a [Continual Light](3-Mechanics/CLI/spells/continual-flame-xphb.md) spell cast on it.  
- **Book and Shield.** A [Tome of Clear Thought](3-Mechanics/CLI/items/tome-of-clear-thought-xdmg.md) rests behind a [+1 Shield](3-Mechanics/CLI/items/1-shield-xdmg.md). Tucked inside the book is a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Speak with Dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md).  
- **Devotee's Censer.** This magic flail deals an extra `dice:1d8|noform|noparens|avg` (`1d8`) radiant damage on a hit and can be used as a holy symbol. As a bonus action, you can cause the head of the flail to release a thin cloud of incense within a 10-foot radius for 1 minute. At the start of each of your turns, you and any other creatures in the cloud each regain `dice:1d4|noform|noparens|avg` (`1d4`) hit points. This property can't be used again until the next dawn.  
- **Potion.** On a shelf behind the ladder is a [Potion of Speed](3-Mechanics/CLI/items/potion-of-speed-xdmg.md).  
- **Scimitar.** The headless skeleton clutches a [Scimitar of Speed](3-Mechanics/CLI/items/scimitar-of-speed-xdmg.md). Removing the blade from the skeleton's tight grip causes the skeleton to collapse into a pile of bones.  
...
- **Staff and Shortbow.** A fully charged [Staff of Frost](3-Mechanics/CLI/items/staff-of-frost-xdmg.md) juts from a barrel in one corner. Lying on the floor near the barrel is a nonmagical shortbow.  

### Cleric's Skull

The skull floating in the gelatinous cube belongs to Estus the Cleric, an ill-fated member of the Hard Way. A Player Character can use the [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of Speak with Dead to interrogate the skull and ask it up to five questions. It knows the following information:
...
- The Elf Wizard can cast a [Knock](3-Mechanics/CLI/spells/knock-xphb.md) spell on the door, causing it to swing open.  

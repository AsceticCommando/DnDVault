...
> 
> **B Boar Pen.** The gate to this room is lashed shut with rope. It holds a [boar](3-Mechanics/CLI/bestiary/beast/boar-xmm.md) that is the anchorite's companion and garbage disposal. The boar can't harm anyone while trapped in this room. If the gate is opened by anyone other than an [anchorite of Talos](3-Mechanics/CLI/bestiary/humanoid/anchorite-of-talos-dip.md), the boar tries to flee the cave, attacking anyone in its path.
> 
...
Ten twig dolls are bound to the charred tree, all within easy reach. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of transmutation magic emanating from the tree and the ground in a 60-foot radius around it.
...
As they move through the forest, the characters are beset by Yargath, an [anchorite of Talos](3-Mechanics/CLI/bestiary/humanoid/anchorite-of-talos-dip.md), and a band of [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)—two orcs per character in the party, including sidekicks. Set the scene as follows:
...
Yargath carries a [potion of greater healing](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md). If the characters acquire this potion, give the players the [Potion of Greater Healing](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) [card](3-Mechanics/CLI/decks/magic-item-cards-dip.md#Potion%20of%20Greater%20Healing) or they can reference it in the Magic Items Listing.
...
> [!gallery]
> ![Map: Circle of Thunder](file://adventure/DIP/011-map-cot-dm.webp#gallery)
> ![Player Version](file://adventure/DIP/012-map-cot-pc.webp#gallery)
...
Flenz hides a [potion of invulnerability](3-Mechanics/CLI/items/potion-of-invulnerability-xdmg.md) in his quarters, buried in a random square beneath the floor. If the characters obtain the potion, give the players the [Potion of Invulnerability](3-Mechanics/CLI/items/potion-of-invulnerability-xdmg.md) [card](3-Mechanics/CLI/decks/magic-item-cards-dip.md#Potion%20of%20Invulnerability) or they can reference it in the Magic Items Listing.
...
Narux hides a [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md) in his quarters, buried beneath the floor. If the characters obtain and identify it, give the players the [+1 Shield](3-Mechanics/CLI/items/1-shield-xdmg.md) [card](3-Mechanics/CLI/decks/magic-item-cards-dip.md#+1%20Shield) or they can reference it in the Magic Items Listing.

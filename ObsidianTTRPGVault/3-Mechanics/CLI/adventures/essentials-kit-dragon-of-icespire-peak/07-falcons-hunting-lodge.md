...
If the characters are eligible to undertake the Woodland Manse Quest, Falcon offers a pair of [boots of elvenkind](3-Mechanics/CLI/items/boots-of-elvenkind-xdmg.md) as a reward for completing it. Give the players the [Boots of Elvenkind](3-Mechanics/CLI/items/boots-of-elvenkind-xdmg.md) [card](3-Mechanics/CLI/decks/magic-item-cards-dip.md#Boots%20of%20Elvenkind) once the boots are acquired or they can reference them in the Magic Items Listing.
...
> [!gallery]
> ![Falcon's Hunting Lodge](file://adventure/DIP/017-map-fhl-dm.webp#gallery)
> ![Player Version](file://adventure/DIP/018-map-fhl-pc.webp#gallery)
...
Falcon's [riding horse](3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md), a reliable gray stallion named Baatorius, is usually lodged in the westernmost stall. The other stalls are empty.

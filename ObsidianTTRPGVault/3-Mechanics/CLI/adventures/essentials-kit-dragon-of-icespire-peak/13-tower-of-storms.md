...
Characters searching for a safe way down the cliffs discover a staircase carved into a narrow fissure. They can follow these steps all the way down to the shore just east of area T1. Crawling along the beach as they arrive there is a [giant crab](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md).
...
If the characters agree to help the giant crab, it asks them to lay to rest its dead sea elf master, Miraal, whose spirit haunts a nearby cave (area T1). If the characters do so, the crab thanks them and makes good on its promise, retrieving the [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) from the wreck of the *Star-Crossed Lover* (see the Shipwrecks table).
...
Rough-hewn stairs climb the eastern face of the rocky outcropping. The [harpies](3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md) in area T5 accost the characters as they climb these steps. See area T5 for details.
...
You become charged with the power of the storm, to the extent that tiny sparks crackle in your eyes. You can cast the [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md) spell (3rd-level version) as an action. Once used three times, the charm vanishes from you.
...
A ledge enclosed by a 3-foot-high stone retaining wall serves as a nest for [harpies](3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md). The harpies line their nest with rotting vegetation and the bones of previous meals, which they hunt up and down the coast. The number of harpies present equals the number of characters in the party, including sidekicks (maximum three harpies). A harpy reduced to 10 hit points or fewer tries to fly away on its next turn, hoping to live to fight another day.

##### Treasure

Characters who search through the harpies' nest find a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md). If the characters acquire this potion, give them the [Potion of Water Breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md) [card](3-Mechanics/CLI/decks/magic-item-cards-dip.md#Potion%20of%20Water%20Breathing) or they can reference it in the Magic Items Listing.
...
> 
> Three 15-foot-long [hunter sharks](3-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) glide among the wrecks. Daggermaw is the meanest and hungriest of the three, and it attacks characters without provocation after they finish searching two of the wrecks. If Daggermaw wounds a character, that character's blood in the water attracts the other two sharks, which join the fray on Daggermaw's next turn.
...
When a magic item is found and identified, give the players the corresponding [magic item card](3-Mechanics/CLI/decks/magic-item-cards-dip.md) or they can reference it in the Magic Items Listing. In the case of the [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) in area T10, choose from among the weapons available ([+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md), [+1 longbow](3-Mechanics/CLI/items/1-weapon-xdmg.md), [+1 mace](3-Mechanics/CLI/items/1-weapon-xdmg.md), or [+1 shortsword](3-Mechanics/CLI/items/1-weapon-xdmg.md)). Only one [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) can be found, so choose a weapon with which at least one party member has proficiency.

**Shipwrecks**

| Area | Ship Name | Treasure |
|------|-----------|----------|
| T10 | *Star-Crossed Lover* | [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) of your choice, found in the grip of a skeleton that used to be the ship's captain |
...
| T12 | *Vainglory* | [Cloak of many fashions](3-Mechanics/CLI/items/cloak-of-many-fashions-xdmg.md) worn by the skeleton of the ship's captain |
| T13 | *Golden Gull* | Locked chest containing 120 ep and six pearls (100 gp each) in a black silk pouch |
| T14 | *Orca* | Locked chest that holds a fully charged [wand of secrets](3-Mechanics/CLI/items/wand-of-secrets-xdmg.md) and a leather-bound spellbook that contains the wizard spells [blur](3-Mechanics/CLI/spells/blur-xphb.md), [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md), [comprehend languages](3-Mechanics/CLI/spells/comprehend-languages-xphb.md), [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [sleep](3-Mechanics/CLI/spells/sleep-xphb.md), and [spider climb](3-Mechanics/CLI/spells/spider-climb-xphb.md) |
^shipwrecks
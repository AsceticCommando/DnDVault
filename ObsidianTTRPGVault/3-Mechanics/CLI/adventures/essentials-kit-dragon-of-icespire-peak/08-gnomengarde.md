...
To complete the Gnomengarde Quest, the characters must obtain at least one magic item from the gnomes. Of the items they can secure, only the [hat of wizardry](3-Mechanics/CLI/items/hat-of-wizardry-xdmg.md) interests Townmaster Harbin Wester, who offers to buy it for 50 gp even though he knows no one who can attune to it. However, the gnomes won't hand over any magic items until the characters speak to Fibblestib and Dabbledob in area G11.

#### Gnome-Made Magic Items

If the characters rescue Gnerkli and end Korboz's madness, the grateful gnomes give them a [clockwork amulet](3-Mechanics/CLI/items/clockwork-amulet-xdmg.md) and [pole of collapsing](3-Mechanics/CLI/items/pole-of-collapsing-xdmg.md) (from area G13). The characters also receive a gift from each king: a [wand of pyrotechnics](3-Mechanics/CLI/items/wand-of-pyrotechnics-xdmg.md) from Gnerkli and a [hat of wizardry](3-Mechanics/CLI/items/hat-of-wizardry-xdmg.md) from Korboz. Give the players the [Clockwork Amulet](3-Mechanics/CLI/items/clockwork-amulet-xdmg.md), [Hat of Wizardry](3-Mechanics/CLI/items/hat-of-wizardry-xdmg.md), [Pole of Collapsing](3-Mechanics/CLI/items/pole-of-collapsing-xdmg.md), and [Wand of Pyrotechnics](3-Mechanics/CLI/items/wand-of-pyrotechnics-xdmg.md) [cards](3-Mechanics/CLI/decks/magic-item-cards-dip.md) as their characters obtain and identify each item or they can reference them in the Magic Items Listing.
...
> [!gallery]
> ![Map: Gnomengarde](file://adventure/DIP/019-map-gnomegarde-dm.webp#gallery)
> ![Player Version](file://adventure/DIP/020-map-gnomegarde-pc.webp#gallery)
...
*Melee Weapon Attack*: `dice:1d20+2|noform|noparens|text(+2)` to hit, reach 5 ft., one target. *Hit*: `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) piercing damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 10).
...
*Ranged Weapon Attack*: `dice:1d20+5|noform|noparens|text(+5)` to hit, range 50/200 ft., one target. *Hit*: `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) piercing damage.
...
Seven of the eight barrels in the north and east alcoves are untapped and full of mushroom wine. The eighth barrel is the [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md). You can decide where the mimic is, or roll a `dice:d8|noform|noparens|avg` (`d8`) to randomly determine which barrel is the fake one. See "Mystery Monster" for more information on the mimic and its behavior when discovered.
...
The book on the pedestal is a spellbook that the rock gnomes of Gnomengarde share. Its cover describes its title as *Magick of Gnomengarde* (in Common and Gnomish), and it contains the wizard spells [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md), [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [identify](3-Mechanics/CLI/spells/identify-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), and [sleep](3-Mechanics/CLI/spells/sleep-xphb.md).
...
Amid the clutter, the characters can find a [clockwork amulet](3-Mechanics/CLI/items/clockwork-amulet-xdmg.md) and a [pole of collapsing](3-Mechanics/CLI/items/pole-of-collapsing-xdmg.md), most easily by scanning the room with a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell. It otherwise takes 1 hour to find each item. Give the players the [Clockwork Amulet](3-Mechanics/CLI/items/clockwork-amulet-xdmg.md) and [Pole of Collapsing](3-Mechanics/CLI/items/pole-of-collapsing-xdmg.md) [cards](3-Mechanics/CLI/decks/magic-item-cards-dip.md) if their characters acquire and identify these magic items or they can reference them in the Magic Items Listing.
...
A small unlocked chest under the gnomes' bed contains a [hat of wizardry](3-Mechanics/CLI/items/hat-of-wizardry-xdmg.md) and a fully charged [wand of pyrotechnics](3-Mechanics/CLI/items/wand-of-pyrotechnics-xdmg.md). Give the players the [Hat of Wizardry](3-Mechanics/CLI/items/hat-of-wizardry-xdmg.md) and [Wand of Pyrotechnics](3-Mechanics/CLI/items/wand-of-pyrotechnics-xdmg.md) [cards](3-Mechanics/CLI/decks/magic-item-cards-dip.md) if their characters acquire and identify these magic items or they can reference them in the Magic Items Listing.
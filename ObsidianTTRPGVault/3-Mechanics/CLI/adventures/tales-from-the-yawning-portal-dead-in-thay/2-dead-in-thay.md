...
![](file://adventure/TftYP-DiT/000-totyp-05-book.webp#center)
...
![Map 5.1: The Doomvault](file://adventure/TftYP-DiT/001-dit01.webp#center)
...
A creature that enters an active gate's energy field while not holding a properly attuned glyph key is pushed back 10 feet. The first time a creature does so on a turn, the creature takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) force damage.
...
Once the characters learn that they need to disrupt the gates, anyone who understands the nature of the gates knows how to perform the disruption. As an action, a character who has the glyph key attuned to a black gate's zone can disrupt the gate. To do so, the character must touch the edge of the gate's energy field and succeed on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check. A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the gate up to 1 minute beforehand grants advantage on this check. On a failure, the character performing the check takes `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) force damage.

Creatures patrolling the Doomvault don't notice the disruption, since a disrupted black gate continues to function normally. However, the gate's active field deals `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) force damage (instead of `dice:2d6|noform|noparens|avg` (`2d6`)).
...
A creature that triggers the lid must succeed on a DC 15 Dexterity saving throw or fall 20 feet onto a bed of stone spikes, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) bludgeoning damage and `dice:2d12|noform|noparens|avg|text(13)` (`2d12`) piercing damage. The pit walls are smooth stone. The lid closes magically 5 minutes after being triggered. The lead on the lid prevents the magic of a closed trap from being detected.
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | 1 [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), 4 [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), and `dice:2d4\|noform\|noparens\|avg` (`2d4`) prisoners ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 2–3 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 4 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and `dice:2d4\|noform\|noparens\|avg` (`2d4`) [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) or [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
^encounter
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
| 2 | 1 [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 3 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
...
| dice: 2d4 | Encounter |
|-----------|-----------|
| 2 | 1 [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md), `dice:2d4\|noform\|noparens\|avg` (`2d4`) [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), and `dice:2d4\|noform\|noparens\|avg` (`2d4`) prisoners ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 3–4 | 1 [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md), `dice:1d3\|noform\|noparens\|avg` (`1d3`) [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), and `dice:2d4\|noform\|noparens\|avg` (`2d4`) [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) |
| 5–6 | 1 Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md), 1 [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) |
| 7–8 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) |
^2-encounter
...
Unless the dungeon is on high alert (level 6 or higher), a [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) and `dice:2d4|noform|noparens|avg` (`2d4`) [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) accompany a monster in any sector or individual encounter entry marked with an asterisk.
...
| 2 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [manes](3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) |
| 3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [quasits](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) |
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [giant centipedes](3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) |
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
...
| 3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) |
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [cockatrices](3-Mechanics/CLI/bestiary/monstrosity/cockatrice-xmm.md) |
...
| 3–4 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [gray oozes](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) |
^ooze-grottos
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [giant crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md)* |
| 2 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) |
| 3 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md)* (in water globes) |
| 4 | 1 [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md)* |
^predator-pools
...
Each group of Thayans has among them `dice:1d4|noform|noparens|avg` (`1d4`)−2 potions (minimum 0), each one determined by rolling on the following table.
...
![Map 5.2: Player Map](file://adventure/TftYP-DiT/002-dit02.webp#center)
...
![Map 5.3: Abyssal Prisons](file://adventure/TftYP-DiT/003-dit03.webp#center)
...
![](file://adventure/TftYP-DiT/004-totyp-05-05.webp#center)
...
The trap activates 3 rounds after a creature enters the room. ([Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md)'s steel key disables the trap for 1 minute when it is used to open the door to area 5.) At the start of the fourth round, and every 2 rounds thereafter, one circle (chosen randomly) glows white. At the end of the same round, lightning discharges through the room from the steel orb in the ceiling. When the lightning discharges, any creature in the room must make a DC 10 Dexterity saving throw. On a failed save, a creature takes `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) lightning damage.

A character who touches the steel orb and succeeds on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can suppress the orb's magic, disabling the trap for `dice:1d4|noform|noparens|avg` (`1d4`) rounds. A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the orb suppresses the magic for 1 hour. In both cases, the character doesn't know how long the suppression might last. The circles continue to glow at random.
...
![](file://adventure/TftYP-DiT/005-totyp-05-06.webp#center)
...
If a non-elemental creature ends its turn inside the room, it takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) damage of a random type (roll a `dice:d10|noform|noparens|avg` (`d10`): 1–2, acid; 3–4, cold; 5–6, fire; 7–8, lightning; 9–10, thunder).
...
If the doors are opened, roll initiative. Darkness immediately fills the corridor out to 20 feet from the doors. Any non-undead creature that starts its turn in the area must succeed on a DC 15 Charisma saving throw or take `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) necrotic damage and become [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) until the start of its next turn. The darkness remains as long as the doors are open.
...
![](file://adventure/TftYP-DiT/006-totyp-05-07.webp#center)
...
If the page explodes, everyone within 10 feet of the box must make a DC 15 Dexterity saving throw, which the reader makes with disadvantage. A creature takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) force damage on a failed saving throw and half as much damage on a successful one. The box and its contents are destroyed if the runes go off.
...
Any creature that enters the room and walks across the invisible field covering one of the open pits deactivates the gravity trap for 1 minute. Once deactivated, characters can move freely across the room for 1 minute before the trap reactivates. If the trap is active, any creature that enters the room without stepping onto the invisible field over one of the false pits is hurled toward the ceiling, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) piercing damage from the stalactites and remaining [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) on the ceiling for 1 minute. Then the creature is released and drops to the floor, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) falling damage and landing [prone](3-Mechanics/CLI/rules/conditions.md#Prone) in a random square near the center of the chamber. Moving onto or over the floor triggers the gravity trap again, but the creature can remain safe if it stays in the space where it fell until another character deactivates the trap.

#### 13. Sorlan's Haunt

The lock plainly visible on each of the double doors is false. The real locks and keyholes are hidden in the base of each door and detectable with a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. If any attempt is made to pick a false lock or force the doors, any creature within 10 feet of the doors must succeed on a DC 14 Constitution saving throw (with disadvantage, if trying to pick a lock or force the doors) or take `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) force damage and be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).
...
One Red Wizard [conjurer](3-Mechanics/CLI/bestiary/humanoid/conjurer-wizard-mpmm.md) oversees one [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) and one [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md). The conjurer knows the pass phrase for the maze of undoing (area 15) and might provide it to the characters in exchange for mercy, knowing that freed demons will attack their "rescuers."
...
When the characters arrive, a [glabrezu](3-Mechanics/CLI/bestiary/fiend/glabrezu-xmm.md) is trapped in the maze. The demon has learned how to navigate the maze, even though it can't escape the area. Place the demon on the ceiling above a random teleportation trigger point in the maze (roll a `dice:d20|noform|noparens|avg` (`d20`)). Once the demon notices the characters, it moves toward characters it can see and in its rage and madness attacks any creatures it manages to reach.
...
![Map 5.4: Blood Pens](file://adventure/TftYP-DiT/007-dit04.webp#center)
...
The 20-foot-tall white throne is a magic trap that the Thayans might use if desperate. When any non-undead creature climbs onto it, a swarm of stinging insects pours out of the back of the throne and quickly fills the chamber. Each creature in the room takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) piercing damage and `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) poison damage. For 1 minute thereafter, each creature that ends its turn in the room takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) piercing damage and `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) poison damage. The insects disappear after 1 minute, and the trap resets.
...
Three [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) oversee six [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). They attack intruders.
...
Twelve [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) are here, with a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and a [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) overseeing them. Eight work to the east, stacking butchered pigs along the wall. To the west, four more work at a sluice that carries offal to the black gate, where it disappears (transported to area 41). Occasionally they toss some of the foul slop toward an [otyugh](3-Mechanics/CLI/bestiary/aberration/otyugh-xmm.md) chained to the floor.
...
The magic stone braziers are built into the room and can't be moved. A creature that touches a brazier for the first time on a turn takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) fire damage.

##### Eggs

Clusters of eggs make this area difficult terrain. None of the eggs is close to hatching. One person with a weapon could destroy all the eggs in about 5 minutes. Leaving the eggs untended also renders them lifeless. The eggs are those of an assortment of creatures, including hook horrors, remorhazes, wyverns, and basilisks, with `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) of each kind. Identifying a particular kind of egg requires a successful DC 20 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check.
...
The vines ignore the undead. Any non-undead creature in the room when the vines emerge must succeed on a DC 13 Dexterity saving throw or become [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by a vine. A creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) piercing damage each time it starts its turn [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) in this way. As an action, a [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) creature can free itself or another creature with a successful DC 13 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check, or free only itself with a successful DC 13 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check. A vine that's restraining a creature can also be cut and killed; each vine has AC 15 and 8 hit points.

While the vines are present, the area is lightly obscured and difficult terrain. A creature takes `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) piercing damage for every 5 feet it moves through the room. A creature that moves more than 15 feet on its turn must immediately make a DC 13 Dexterity saving throw. On a failed save, the creature becomes [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) as described above.
...
The chamber's pillars respond when plant matter in the chamber is damaged. At the end of each round during which a shambling mound took damage, a discharge of energy ripples over the pillars, and each creature within 5 feet of a pillar takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) lightning damage.
...
![Map 5.5: Master's Domain](file://adventure/TftYP-DiT/008-dit05.webp#center)
...
![](file://adventure/TftYP-DiT/009-totyp-05-10.webp#center)
...
![](file://adventure/TftYP-DiT/010-totyp-05-11a.webp#center)
...
![](file://adventure/TftYP-DiT/011-totyp-05-11.webp#center)

##### Urns

The urns are magic and worthless but clever fakes that appear valuable, requiring a successful DC 20 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check to discern the truth. Any non-undead creature that touches an urn must succeed on a DC 17 Constitution or Wisdom saving throw (creature's choice) or take `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) necrotic damage and become [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) for 1 minute. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save. If this damage reduces a creature to 0 hit points, the creature dies and turns to dust.
...
Combat in the courtyard alerts the inhabitants of the cells. They take `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) rounds to respond (roll for each one):
...
Transmutation magic infuses the room. Any creature that spends more than 1 round in this area triggers the trap. When the trap triggers, each creature in the room who isn't wearing a Thayan uniform must make a DC 15 Dexterity saving throw, taking `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) piercing damage from flying shards on a failed save, or only half as much damage on a successful one. This effect repeats every round until the room is empty, when the trap resets.
...
Large fires brightly light this area. A creature that enters a bonfire for the first time on a turn, or starts its turn in a fire, takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) fire damage.
...
![Map 5.6: Far Realm Cysts](file://adventure/TftYP-DiT/012-dit06.webp#center)
...
Covering the rough floor is 1 foot of thick slime, which is difficult terrain and covers several hidden sinkholes. Any creature that starts its turn [prone](3-Mechanics/CLI/rules/conditions.md#Prone) in or submerged in the slime takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) poison damage.
...
Covering the rough floor is 1 foot of thick slime. Any creature that starts its turn [prone](3-Mechanics/CLI/rules/conditions.md#Prone) in the slime takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) poison damage.
...
![Map 5.7: Forests of Slaughter](file://adventure/TftYP-DiT/013-dit07.webp#center)
...
It isn't safe for an undead to drink from the pool. If the undead does, it gains no benefits and takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) radiant damage.
...
It isn't safe for a non-undead creature to drink from the pool. If the creature does, it gains no benefits and takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) necrotic damage.
...
Here lie fragments of bone left from bodies destroyed in attempts to infuse oozes with humanoid intelligence. The piles are 3 feet high. It costs 15 feet of movement to move 5 feet across a pile. A creature that enters or starts its turn in a pile takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) acid damage. A creature can take this damage only once per turn.
...
Two [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) with buckets and stone boots move among dozens of skeletons. They pour steaming ooze over the bones. Two [sentient ochre jellies](3-Mechanics/CLI/bestiary/ooze/sentient-ochre-jelly-tftyp.md) and two [sentient gray oozes](3-Mechanics/CLI/bestiary/ooze/sentient-gray-ooze-tftyp.md) are pooled near the benches.

##### Spilled Ooze

The spilled ooze essence makes the area around the benches difficult terrain. Any creature that ends its turn in the area of the spilled ooze takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) acid damage. The wights aren't affected, thanks to their boots.
...
Two [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) and four [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) move among the vats, using *ooze prods* to poke the mixtures. They challenge any intruders. If the undead become distracted, oozes might attack (see "Vat System" below).
...
A creature that enters the necrotic essence for the first time on a turn, or starts its turn there, takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) necrotic damage and must succeed on a DC 11 Constitution saving throw or become [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) until the start of its next turn.

Six of the eight square vats each contain one ooze, all of them reduced-threat versions of the creatures (see "Reduced-Threat Monsters" above). Two vats hold black puddings (marked B on the map), one has a gray ooze (G), and three contain ochre jellies (O). Usually, wights use *ooze prods* to keep the oozes in the vats. If the wights are engaged in combat, roll a `dice:d6|noform|noparens|avg` (`d6`) at the end of every round. If the indicated ooze is still in a vat, it escapes and tries to attack the nearest creatures.
...
The black pillar is infused with psionic energy. Any creature that touches it for the first time on a turn takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) psychic damage and is knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).
...
The red pillar flows like viscous fluid. When a creature moves within 10 feet of the pillar, the creature feels its body soften. Whenever a creature starts its turn within 10 feet of the pillar, the creature must succeed on a DC 15 Constitution saving throw or take `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) acid damage. A creature that drops to 0 hit points due to this effect dies and collapses into a puddle of gooey red liquid. The fluid then flows into the pillar.
...
The air contains acidic vapors. A creature that starts its turn here must succeed on a DC 10 Constitution saving throw or take `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) acid damage. A creature that holds its breath or doesn't need to breathe has advantage on the saving throw.

##### Ooze Pool

Filled with the remains of dead oozes, the pool is 2 feet deep and difficult terrain. A creature that enters the pool for the first time on a turn, or starts its turn there, takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) acid damage and `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) poison damage.
...
![Map 5.9: Predator Pools](file://adventure/TftYP-DiT/015-dit09.webp#center)
...
The necromancy magic in this pool is intended not to keep it clean but to kill intruders. Any creature that makes an attack dealing radiant damage in this area must succeed on a DC 15 Wisdom saving throw or move to the pool and jump in as soon as it can. A creature that enters the pool for the first time on a turn, or starts its turn there, takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) necrotic damage.
...
The magic stone braziers are built into the room and can't be moved. A creature that touches a brazier takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) fire damage. A creature can take this damage only once per turn.
...
Rectangular 5-foot-deep spawn pits are filled with spawning essence. Each pit holds juvenile predatory fish. A creature that enters a pit for the first time on a turn, or starts its turn there, takes `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) piercing damage from the attacks of these fish.
...
![Map 5.10: Golem Laboratories](file://adventure/TftYP-DiT/016-dit10.webp#center)
...
The first time a creature moves within 5 feet of a pillar on its turn, the creature must succeed on a DC 17 Wisdom saving throw or be teleported to a random space next to another pillar (roll a `dice:d20|noform|noparens|avg` (`d20`)). The creature also takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) lightning damage. If the destination pillar is the same as the origin pillar, the creature takes double damage.
...
Any creature that moves within 5 feet of the mist must succeed on a DC 20 Strength saving throw or be pulled into it and shunted violently into area 91, falling [prone](3-Mechanics/CLI/rules/conditions.md#Prone) and taking `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) bludgeoning damage.
...
The fiendish skulls are imbued with powerful magic. When any character steps into a skull's mouth, macabre laughter erupts from the northwest corner. The character is teleported to the mouth of a different skull (roll a `dice:d6|noform|noparens|avg` (`d6`)) and comes tumbling back into the room, falling [prone](3-Mechanics/CLI/rules/conditions.md#Prone) and taking `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) bludgeoning damage.

The character must then succeed on a DC 15 saving throw (the ability is tied to the skull's number; see the table) or suffer the skull's curse. The curses are cumulative, imposing a −`dice:1d4|noform|noparens|avg` (`1d4`) penalty to checks and saving throws of the indicated ability. If a character has a penalty of −5 or greater to a single ability, the character also suffers the curse's secondary effect.
...
![](file://adventure/TftYP-DiT/017-totyp-05-17.webp#center)
...
A gout of flame blocks the passage that leads to area 97. A creature can jump over the flame easily but takes `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) fire damage when doing so. A creature that enters the flame during its turn, or starts its turn there, takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) fire damage.
...
The pool has a 3-foot-high wall. A creature that enters the pool for the first time on a turn, or starts its turn there, takes `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) fire damage.
...
The 5-foot-high crucible contains molten metal. As an action, a creature can attempt to spill the contents by tipping the crucible over, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) fire damage in the process. On a successful DC 15 Strength check, the crucible tips, and on a successful DC 20 Strength check, a creature can also push the crucible 5 feet before it tips. Molten metal quickly spreads from the mouth of the crucible over an area 30 feet by 30 feet in size, including the crucible and the space within 5 feet of it.

Anyone caught in the molten metal takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) fire damage and must succeed on a DC 15 Constitution saving throw or fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone). The floor of the area is covered in molten metal. For the next 5 rounds, a creature that enters the area for the first time on a turn, or starts its turn there, takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) fire damage. For 5 rounds after that, the damage is `dice:1d6|noform|noparens|avg|text(3)` (`1d6`), and then it drops to none.
...
![Map 5.11: Temples of Extraction](file://adventure/TftYP-DiT/018-dit11.webp#center)
...
Venomous Touch. When the creature hits with a weapon attack, that attack also deals `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) poison damage.
...
![](file://adventure/TftYP-DiT/019-totyp-05-19.webp#center)
...
A [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mpmm.md) keeps watch here. One [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) and four [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) circle around the shrine, streaks of crimson trailing from their spectral forms.
...
Whenever a non-undead creature in this area takes damage, it must make a DC 15 Wisdom saving throw. On a failed save, the creature takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) poison damage, and it is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
High and low `dice:d20|noform|noparens|avg` (`d20`) results matter more in this area:
...
If combat occurs in this area, a creature takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) psychic damage at the end of each of its turns when it doesn't deal damage to another creature.
...
The shrine exudes poisonous mist that makes the area lightly obscured. Each creature that starts its turn in the room must make a DC 13 Constitution saving throw. On a failed save, the creature takes `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) poison damage and spends its turn [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) and retching. If a creature accumulates three failed saves against this mist, its hit point maximum is lowered by the amount of poison damage it has taken from the mist. A creature that makes three successful saving throws against the mist becomes immune to its effects for 4 hours.
...
> [!gallery]
> ![Map 5.12: The Phylactery Vault—Floor 1 & Floor 2](file://adventure/TftYP-DiT/020-dit12.webp#gallery)
> ![Map 5.13: The Phylactery Vault—Floor 3 & Floor 4](file://adventure/TftYP-DiT/021-dit13.webp#gallery)
...
A dark pool is 1 foot deep and difficult terrain. Any creature that starts its turn in a dark pool takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) necrotic damage. A creature in a dark pool can't regain hit points.

#### Pedestals

The 3-foot-high pedestals store radiant energy, which is released in the presence of undead intruders. If an undead creature other than Kazit Gul ends its turn within 5 feet of a pedestal, the creature must succeed on a DC 13 Charisma saving throw or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) radiant damage.

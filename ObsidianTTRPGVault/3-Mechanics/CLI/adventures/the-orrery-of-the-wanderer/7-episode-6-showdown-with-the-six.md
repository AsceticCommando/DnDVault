...
![The Dran & Courtier](file://adventure/OoW/089-04-46.webp#center)

The characters (now 6th level) have learned that the [Orrery of the Wanderer](3-Mechanics/CLI/items/orrery-of-the-wanderer-ai.md) channels magic even more powerful than intended by its creator, the lich Lottie. As such, Lottie broke the orrery into parts and scattered those parts far and wide, hoping that no one would discover their secret. But the enigmatic group known as the Six has collected at least one orrery component (perhaps more, depending on events in episode 5), and its agents now attempt to use those components to open a portal to the Far Realm.
...
More information on Kryptgarden and [Claugiyliamatar](3-Mechanics/CLI/bestiary/npc/claugiyliamatar-skt.md) can be found in the adventures Princes of the Apocalypse and Storm King's Thunder.
...
The amount of time the characters spend skulking around town is up to them. Each time they investigate a feature noted below, roll a `dice:d10|noform|noparens|avg` (`d10`). On a roll of 1, a patrol of two [nothics](3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) working for the Six attempts to ambush the party from the cover of nearby buildings, attacking with surprise if not seen.

### Corralled Townsfolk

Twenty locals have been gathered by Six operatives in a fenced-in yard behind Ironhead Arms, a shop selling new and used weapons and armor. Three townsfolk are currently plotting an escape, but they fear that the other captured folk are not prepared for battle. The three are the shop's owner Ironhead (NG male half-orc [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)), the town's constable Harburk (LG male human [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)), and an explorer from out of town named Silvana (CG female human [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)). The three work with any characters who help defend the townsfolk.

Guarding the yard are ten [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) that have been instructed to safeguard the prisoners—but only because it isn't clear to Splugoth whether the ritual might eventually require humanoid sacrifices. The bugbears are focused on watching their captives, and have disadvantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks to notice anyone approaching them. If the characters free the captives, Ironhead, Harburk, and Silvana offer to lead the other townsfolk to safety.
...
One of the NPCs the characters could meet is Imdarr Relvaunder (LN male human [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md)). Imdarr is hiding with four other townsfolk (male and female [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). He won't leave the others, but he casts any of his useful spells on the adventurers if he believes they are earnest about helping Red Larch.

### South Side of Town

As described above, characters can spot [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) townsfolk within the houses and other buildings, and can question them with appropriate Charisma checks or roleplaying. Scouting around the area also reveals the odd sight of an [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) wrapped up in a floral print dress.

Approaching the bugbear draws the attention of Haeleeya Hanadroum (NG female human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), who is holed up in her bathhouse and dress shop. Haeleeya knocked the bugbear [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) after winning an unlikely battle against it by dropping flowerpots on its head from the second-story landing. She tied it up in several of her dresses, and is now wondering what to do with it.
...
![Propha Dran](file://adventure/OoW/092-04-48.webp#center)
...
Propha keeps a supply of magic potions in tall, thin, color-coded bottles: three [potions of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md), a [potion of poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), and three potions that confer the benefit of a [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell. The Keymaster is aware of the potions and uses a [potion of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md) to get away from the characters if things go badly. See "Confronting the Keymaster" below.
...
Each of these four guest rooms is presently empty, but a search of the rooms and a successful DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check locates a silver ring under a carpet in one room—a [ring of free action](3-Mechanics/CLI/items/ring-of-free-action-xdmg.md), forgotten by a guest.
...
Both the knife and the bubbling pot are dangerous, and the cabinet holds a captured flumph. At the end of each character's turn, roll a `dice:d6|noform|noparens|avg` (`d6`). On a roll of 1, the boiling pot boils over (see below).

#### Creature

The gleaming butcher's knife is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md). The creature waits until it is picked up to trigger its Adhesive trait. If a creature is attacked by the mimic, the boiling pot's lid comes off.
...
The stove has no discernible fuel source or way to turn off its heat. If the lid comes off or is removed, an explosion of tentacles and scalding water fills the kitchen. Each character in the area must succeed on a DC 14 Dexterity saving throw or take `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) bludgeoning damage and `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) fire damage. The trap acts on initiative count 10, repeating this effect each turn until a character uses an action to replace the lid. Even with the lid on, the pot boils over again in `dice:1d4|noform|noparens|avg` (`1d4`) rounds unless disabled, as noted above.

#### Cabinet

The cabinet is locked, requiring a successful DC 14 Dexterity check using thieves' tools to pick or a successful DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to break open. Locked inside is a [flumph](3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md) named Phfffffffft. If freed, Phfffffffft shares how it sensed the aberrant horrors in this pocket dimension and came to help, but was captured. It heard the name "Splugoth" used by some of the creatures passing through the horrid inn. Phfffffffft also recalls someone discussing a terrifying guardian that protects "the dimensional caverns." The flumph can accompany the characters back to the default Test Market if they wish, helping them as best it can in future encounters (and probably dying horribly).

#### Chest

The iron-bound chest has a simple lock requiring a successful DC 10 Dexterity check using thieves' tools to open, and contains packets and jars of spices. Among these is a small packet containing [dust of sneezing and choking](3-Mechanics/CLI/items/dust-of-sneezing-and-choking-xdmg.md), another of [dust of dryness](3-Mechanics/CLI/items/dust-of-dryness-xdmg.md), and a jar of [Keoghtom's ointment](3-Mechanics/CLI/items/keoghtoms-ointment-xdmg.md).
...
In this reality, a small chest by the bed in the chuul room contains a [rod of the pact keeper +2](3-Mechanics/CLI/items/2-rod-of-the-pact-keeper-xdmg.md).
...
![Splugoth the Returned](file://adventure/OoW/094-04-50.webp#center)
...
If Splugoth was ridiculously successful in episode 5 and the Six now possess all the orrery components except the [wheel of stars](3-Mechanics/CLI/items/wheel-of-stars-ai.md), he's mostly just here to gloat. But no matter how many components the characters still possess, he offers the following sweet deal.
...
[Onyx](3-Mechanics/CLI/bestiary/npc/onyx-oow.md) uses the [cat](3-Mechanics/CLI/bestiary/beast/cat-xmm.md) stat block with these changes:
...
- Her claws attack uses the following statistics: `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 20 ft., one target. *Hit*: `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) slashing damage.  
...
| 2 | A small stool is tipped over, or a mug or plate goes flying off a table. The character must succeed on a DC 12 Dexterity saving throw to dodge it. On a failed save, the character is struck a glancing blow for `dice:1d8\|noform\|noparens\|avg\|text(4)` (`1d8`) bludgeoning damage and must succeed on a DC 15 Strength saving throw or be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). |
...
| 6 | The character attracts the attention of three huge cockroaches, and must succeed on a DC 10 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check to pass the enormous insects unimpeded. On a failed check, the character takes `dice:1d6\|noform\|noparens\|avg\|text(3)` (`1d6`) piercing damage from the roaches' bites, and the character's speed is halved until the end of their next turn. |
| 7 | A bottle falls off a table and rolls toward the character. The character must succeed on a DC 10 Strength or Dexterity saving throw to dodge or jump over it. On a failure, the character takes `dice:2d4\|noform\|noparens\|avg\|text(5)` (`2d4`) bludgeoning damage and is knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). |
...
| 9 | Three wasps feeding on fallen food catch sight of the character and zoom in. The character must succeed on a DC 10 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) or Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check to avoid angering them. On a failure, the character is stung and takes `dice:1d6\|noform\|noparens\|avg\|text(3)` (`1d6`) poison damage. |
| 10–20 | No complication. |
^cat-chase-complications

### Mouse Den

When the characters reach the mouse hole, they find a small cozy den inside, lined with matted hair and fur. Next to a block of cheese is a bound and [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) [Propha Dran](3-Mechanics/CLI/bestiary/npc/prophetess-dran-ai.md), her clothes stained with dried blood. This is the real Propha (see area 3 of the default inn), who is stable but requires healing to return to consciousness. If awakened, she thanks the characters for their rescue, listens to any explanation of how they got there, then shares the following information:

![](file://adventure/OoW/095-04-51.webp#center)
...
This creature is an eldritch horror from the Far Realm, using the stat block of an [otyugh](3-Mechanics/CLI/bestiary/aberration/otyugh-xmm.md).
...
As thanks for the rescue, K'thriss gifts a pair of [slippers of spider climbing](3-Mechanics/CLI/items/slippers-of-spider-climbing-xdmg.md) to the party. The characters then feel themselves being pulled away, back to the default inn of stage 1.
...
Fighting the patrons is difficult (use the [dire wolf](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) stat block for each to underline their fierce bite). But if two of them are forced together (by a character shoving one of them, a [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md) spell, and so forth), they immediately attack and wholly consume each other. When only one patron remains, it transforms into Propha (the Keymaster) and the stage ends.

### Food Fight

The characters appear behind the bar, with every patron in the inn shouting furiously at them regarding poor service. The patrons begin to hurl food at the characters: `dice:1d20+4|noform|noparens|text(+4)` to hit, `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) bludgeoning damage. The patrons are immune to damage from any of the characters' normal attacks and spells. However, each patron is vulnerable to one type of food currently being hurled around the inn. If that type of food hits a patron, they immediately vanish. When all the patrons have been vanquished in this way, the stage ends.
...
When the Keymaster's true nature is discovered, it shifts to its natural form and engages the characters in combat. The Keymaster uses the [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) stat block with the iconic affiliate of the Six features (see ""Iconic Faction Features"" in "appendix B").

The doppelganger leads with Multiattack if it has surprise, to make the most of its Surprise Attack trait. It otherwise uses its Glimpse of the Beyond feature to blind as many foes as possible. It then attempts to drink a [potion of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md) and flee.
...
- [Splugoth the Returned](3-Mechanics/CLI/bestiary/npc/splugoth-the-returned-ai.md) does not lead the Six, but he oversees this operation. He hates Acquisitions Incorporated, as does everyone in the Six.  
- The components of the [Orrery of the Wanderer](3-Mechanics/CLI/items/orrery-of-the-wanderer-ai.md) are being used to anchor a complex ritual that will open a portal to the Far Realm. When the portal opens completely, an otherworldly army will emerge to destroy Red Larch, sweep across the Sword Coast, and wipe out Acquisitions Incorporated in the process. Of course, all members of the Six have been promised safe harbor and cushy desk jobs under this new regime.  
...
The read-aloud text below assumes that the Six successfully gained the housing of the [Orrery of the Wanderer](3-Mechanics/CLI/items/orrery-of-the-wanderer-ai.md) in episode 5. If they don't have the housing, any components the Six have obtained spin in place on their own. (Even if the characters thwarted the Six at every turn, Splugoth holds at least the [far gear](3-Mechanics/CLI/items/far-gear-ai.md).)
...
![Map 6.2: Ritual Site](file://adventure/OoW/096-map-6-2-dm.webp#center)
...
| 2 | [Jim Darkmagic](3-Mechanics/CLI/bestiary/npc/jim-darkmagic-ai.md) |
| 3 | [Môrgæn](3-Mechanics/CLI/bestiary/npc/morgn-ai.md) |
| 4 | [Viari](3-Mechanics/CLI/bestiary/npc/viari-ai.md) |
^far-realm-friends
...
![](file://adventure/OoW/097-04-52.webp#center)
...
Once detected, a rune can be disabled with a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check or Dexterity check using thieves' tools. A character aware of the rune can also attempt a DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to jump safely over it. Moving past the rune otherwise deals `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) necrotic damage to a creature and teleports it back to the cavern entrance. The runes remain active until disabled.
...
The ritual takes its own turn on initiative count 1. If the characters do not control the orrery components, the rift pulses and `dice:2d4|noform|noparens|avg` (`2d4`) additional [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) appear on the battlefield wherever they are most effective.

If [Splugoth](3-Mechanics/CLI/bestiary/npc/splugoth-the-returned-ai.md) is dead and the characters do not control the orrery components, no goblins are summoned. Instead, the ritual resurrects Splugoth from the dead no matter what condition his body is in, returning him to combat with half his normal hit points.
...
- Fire a bolt of eldritch energy at a target the controlling creature can see: `dice:1d20+8|noform|noparens|text(+8)` to hit; `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) necrotic damage.  

[Splugoth](3-Mechanics/CLI/bestiary/npc/splugoth-the-returned-ai.md) is not affected by any goblin mutations created by the ritual.
...
| 3 | Each creature must make a DC 13 Constitution saving throw, taking `dice:2d6\|noform\|noparens\|avg\|text(7)` (`2d6`) radiant damage on a failed save or half as much damage on a successful one. |
| 4 | The ritual targets a random character who is below their hit point maximum. That character regains `dice:2d4\|noform\|noparens\|avg` (`2d4`) hit points. |
...
In keeping with their promise to Lottie, the characters are obliged to break the orrery up again and scatter its components far and wide. But hey, sometimes adventurers are forgetful. In the end, Omin Dran might have to announce that Head Office is taking charge of the orrery's final fate—though the franchise might certainly be entitled to keep a favorite timepiece. (Or two. Really, who can keep track of these things?) And wherever its pieces end up, the [Orrery of the Wanderer](3-Mechanics/CLI/items/orrery-of-the-wanderer-ai.md) still has a will of its own, and might spawn additional adventures in the future.

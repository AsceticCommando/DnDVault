...
![Jim Darkmagic](file://adventure/OoW/041-04-03.webp#center)
...
If the characters have any questions about the assignment, Jim can be the vessel through which you answer. Those who appear enthusiastic, appreciative, and deferential to Jim might even be gifted a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Jim's magic missile](3-Mechanics/CLI/spells/jims-magic-missile-ai.md). However, before an arcane caster can use the [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) or copy it into a spellbook, they need to understand the new royalty component for spells. See ""New Spells"" in chapter 3 for more information.
...
The rapscallion is Jerronimous "Jerr" Burntberry (CN male gnome [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) who is quite a bit older than he looks. A successful DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check tips the characters off that the adult gnome is disguised to look like a youngster. Jerr hopes to join the Zhentarim one day, but he needs a little more experience. In the meantime, he makes a living by scribbling on pieces of parchment he scrounges from garbage heaps, selling them as maps to unwitting fools searching for places in Dock Ward. He also collects fetid rainwater in small, red clay pots, which leach out just enough color that he can pass the water off as *potions of healing*.

The potions have a faintly fruity aroma. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell shows that they are indeed magical, though that magic is of the transmutation school rather than conjuration. Each day, a kindly druid who thinks Jerr is an honest soul gives the gnome a goodberry for his health. Rather than eat the berry, Jerr crushes it up and adds a drop of juice to each pot. Jerr sells maps for 1 gp and the potions for 10 gp. He also tries to sell other useless or counterfeit objects at your discretion.
...
The four [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) members of the crew are run-of-the-mill criminals looking to get ahead in the world through treachery. Their leader, [Jelayne](3-Mechanics/CLI/bestiary/npc/jelayne-oow.md), was similar... until she was killed a year before. [Jelayne](3-Mechanics/CLI/bestiary/npc/jelayne-oow.md) wasn't one to let death keep her down, however, and she continues to lead the group as an unusual [skeleton](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) with these changes:
...
In her belt pouch, [Jelayne](3-Mechanics/CLI/bestiary/npc/jelayne-oow.md) carries a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), 10 gp, and the bones of four of her toes that have fallen off. She used to be really attached to them.
...
The characters are 20 feet from the alley entrance when the old man—a seer named Kal Ruudheart (NG male human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md))—is grabbed. The perpetrators are Big Gustava (NE female [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) and her friend who goes by the name [Devil Dog](3-Mechanics/CLI/bestiary/npc/devil-dog-oow.md) (CE female tiefling [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)). The two are street thieves trying to work their way up to larger scores. [Devil Dog](3-Mechanics/CLI/bestiary/npc/devil-dog-oow.md) uses the acolyte stat block with these racial traits:

- She knows the [thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy-xphb.md) cantrip, and Charisma is her spellcasting ability for this spell.  
...
[Devil Dog](3-Mechanics/CLI/bestiary/npc/devil-dog-oow.md) carries nothing of value, but in exchange for her life, she promises to take her captors back to her apartment, where she says she keeps her money. Instead of doing so, however, she leads the characters on a merry walk through the worst parts of Dock Ward, where she knows six [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) who will attack them and allow her to flee.
...
The leader of the trio is Captain Mergen Truff (NG female elf [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)), a laconic figure who would rather be doing "real work" than standing here warning off vagrants too foolish to avoid falling into a massive hole in the ground. Her companions are Orvis Torval (N male firbolg [guard](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) and Rosko Bosh (N male halfling [guard](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)). Orvis and Rosko are new constables, not the sharpest swords in the armory, and as lazy as wizards who've used all their spell slots. Local thieves pay them to look the other way when ordered to do so, which becomes important later in the episode.
...
![Mergen Truff, Orvis Torval, and Rosko Bosh](file://adventure/OoW/042-04-04.webp#center)
...
![](file://adventure/OoW/043-04-05.webp#center)
...
Opening the lock without the key requires a successful DC 17 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md). Any unsuccessful attempt to pick the lock triggers a trap (see below). The door cannot be broken down or otherwise smashed, and attempting to do so triggers the trap.
...
A character fully submerged in this pool must make a DC 10 Constitution saving throw as poison courses into their body. On a failure, the character takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) poison damage and gains vulnerability to poison damage. On a successful save, the character takes no damage and gains resistance to poison damage. Either effect lasts until the end of the character's next long rest.
...
A character fully submerged in this pool must make a DC 10 Wisdom check to endure the intense itching caused by the acid that fills it. On a failure, the character takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) acid damage and gains vulnerability to acid damage. On a successful save, the character takes no damage and gains resistance to acid damage. Either effect lasts until the end of the character's next long rest.
...
Any creature in the room when the trap on the double doors triggers must make a DC 10 Constitution saving throw. On a failure, a creature is transformed into a [poisonous snake](3-Mechanics/CLI/bestiary/beast/venomous-snake-xmm.md) for `dice:1d4|noform|noparens|avg` (`1d4`) rounds, as if affected by the [polymorph](3-Mechanics/CLI/spells/polymorph-xphb.md) spell. The snakes are compelled to attack any other creatures in the room.
...
Nearly [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) runes cover the floor in this area. The runes radiate conjuration to a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar effect, or can be detected with a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check. When a creature steps into the area, the runes conjure up a swirling cloud of green dye that covers each creature in the area that fails a DC 15 Dexterity saving throw.

The magical dye is nontoxic, cruelty free, pet safe, and hypoallergenic. It vanishes if an affected creature is targeted by [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md). Otherwise, it takes `dice:1d4|noform|noparens|avg` (`1d4`) months to fade, even with constant scrubbing. Additionally, any savvy thief operating in the civilized settlements of the Sword Coast recognizes that a character covered in this dye fell victim to a trap. Those thieves might target such characters as easy marks in future adventures.
...
The ornate double doors here are locked, and are the trigger for trap D. They radiate conjuration to a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar effect. Opening the doors requires a successful DC 15 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md). The doors can also be smashed open with a successful DC 16 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check, or broken down with attacks (AC 10, 30 hit points, immunity to poison and psychic damage).
...
Each of the zombies wears a silver necklace worth 10 gp. Resting on one of the slabs is a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [bless](3-Mechanics/CLI/spells/bless-xphb.md).
...
The [giant spider](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) hides in a dust-filled depression in the floor. A successful DC 17 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check spots the arachnid before it springs from its hiding place to attack. Any characters who are focused on the webs above them have disadvantage on the check. Those who fail the check are [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised).
...
If the characters cut down the web cocoons, they find the corpses of three giant rats, Constable Boot, and a kobold explorer. The kobold has a [vial of acid](3-Mechanics/CLI/items/acid-xphb.md), a [flask of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), and a [vial of antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md). The deceased Boot has a [flask of holy water](3-Mechanics/CLI/items/holy-water-xphb.md) and a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).

> [!gallery]
> ![Map 1.3: Areas 6–10](file://adventure/OoW/047-map-1-3-dm.webp#gallery)
> ![Player Version](file://adventure/OoW/048-map-1-3-pc.webp#gallery)

### 6. Goblin

When Caerhan Coalsmith ventured into these caverns, his goblin sidekick Gorkoh (N male [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md)) came with him. Caerhan and the other members of his adventuring party had spared Gorkoh's life a few months back when they cleared out a temple to Maglubiyet, the chief of the goblin gods. Caerhan saw potential for the goblin to become a productive member of society, so he became a friend and mentor to Gorkoh, and encouraged him to learn about magic. Caerhan has also encouraged Gorkoh to expand his Common vocabulary, with inconsistent results.

Since becoming separated from Caerhan during a carrion crawler attack, Gorkoh has hidden here waiting for his mentor to return. He is starting to fear (rightfully) that Caerhan is dead, however, and if the characters treat him kindly, he might be convinced to join them. Gorkoh carries standard goblin weapons, plus three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [fog cloud](3-Mechanics/CLI/spells/fog-cloud-xphb.md) that Caerhan gave him for safekeeping and study.
...
Ten of the feet in the room are stomping feet, the lesser known and smellier cousins to the crawling claw. A [stomping foot](3-Mechanics/CLI/bestiary/undead/stomping-foot-oow.md) uses the [crawling claw](3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) stat block with these changes:
...
The [enormous tentacle](3-Mechanics/CLI/bestiary/beast/enormous-tentacle-oow.md) uses the stat block of a [giant constrictor snake](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) with these changes:
...
The dead dwarf is Caerhan Coalsmith. Sergeant Teeshe stands in the corner. The magical housing of the [Orrery of the Wanderer](3-Mechanics/CLI/items/orrery-of-the-wanderer-ai.md) sits before the altar.

#### Creatures

Teeshe touched the altar when she first entered this area, and a spirit loyal to That-Which-Endures possessed her (see below). If the adventurers touch or disturb anything in this chamber (including the altar, the gearwork maul, or Teeshe herself), the spirit controlling Sergeant Teeshe forces her to attack. Use the [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) stat block for her in this state.

#### Entropy Guardian

The gearwork device above the altar is called an entropy guardian, and it animates 1 round after Teeshe attacks. The entropy guardian's expanding clockwork arms allow it to attack anywhere in the room, but it cannot attack beyond it. On initiative count 10, it makes two attacks per round: `dice:1d20+4|noform|noparens|text(+4)` to hit, `dice:1d8+2|noform|noparens|avg|text(7)` (`1d8 + 2`) bludgeoning damage. The damaged entropy guardian is a Huge object with AC 18, 32 hit points, and immunity to poison and psychic damage. It focuses its attacks on intruders within 5 feet of the altar, anyone fighting with Sergeant Teeshe, and anyone holding the orrery housing (which its magic recognizes as an ongoing threat).
...
While the NPCs and characters are going over their bookkeeping, a group of villains working for the Xanathar Guild tries to take any treasure the party pulled out of the tunnels. The group consists of a [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) called Stork leading three [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md). Stork believes she has the advantage over the party members, who are probably coming out of the tunnels bruised and bloodied. Plus, she's already bribed the two City Watch guards, Orvis Torval and Rosko Bosh, to "take a walk," so neither is on hand during the attack.

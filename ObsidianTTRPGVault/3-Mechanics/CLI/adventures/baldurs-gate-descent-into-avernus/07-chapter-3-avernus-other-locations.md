...
![](file://adventure/BGDIA/084-qhkab-03-17.webp#center)
...
> [!gallery]
> ![Map 3.7: Styx Watchtower](file://adventure/BGDIA/085-peagh-map-3-7.webp#gallery)
> ![Player Version](file://adventure/BGDIA/086-4vafs-map-3-7-player.webp#gallery)
...
![](file://adventure/BGDIA/087-13nbu-03-18.webp#center)
...
![](file://adventure/BGDIA/088-ok5br-03-19.webp#center)
...
Crashing the fortress destroys it. Any creature aboard the flying fortress when it crashes takes `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage plus `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) fire damage, and falls [prone](3-Mechanics/CLI/rules/conditions.md#Prone) amid the twisted wreckage.
...
![](file://adventure/BGDIA/089-zbxl3-03-20.webp#center)
...
![Smiler the Defiler](file://adventure/BGDIA/090-637000767383854885.webp#center)
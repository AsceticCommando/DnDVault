...
The harsh conditions of the Nine Hells can cause an infernal war machine to stop functioning properly, until it eventually breaks down. Such wear and tear can be represented using [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion), as described in [appendix A](3-Mechanics/CLI/rules/conditions.md#Exhaustion) of the "Player's Handbook", with these modifications:

...
![](file://adventure/RoT/018-tod-13-01.webp#center)
...
* Use the [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) statistics but add resistance to lightning damage and the breath weapon of a [blue dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/blue-dragon-wyrmling-xmm.md).
...
* Use the [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) statistics but add resistance to fire damage and the breath weapon of a [red dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/red-dragon-wyrmling-xmm.md). These changes increase the gladiator's challenge by 1, increasing its XP value.

** Use the [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) statistics but add the breath weapon of a [green dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/green-dragon-wyrmling-xmm.md). This change doesn't affect the assassin's challenge.

### Plan of Attack

![Dragon Cultist](file://adventure/RoT/019-tod-13-02.webp#center)

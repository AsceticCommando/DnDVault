...
![](file://adventure/PotA/039-poa04-01.webp#center)
...
![](file://adventure/PotA/040-poa04-02.webp#center)
...
Although air cultists rarely do, many denizens of the air temple carry small amounts of treasure. Kenku value shiny baubles, and they always have such treasure. Creatures that own individual treasure have `dice:4d10|noform|noparens|avg` (`4d10`) gp worth of mixed coins and other minor valuables.

> [!gallery]
> ![Map 4.1: Temple of Howling Hatred](file://adventure/PotA/041-04-01.webp#gallery)
> ![Player Version](file://adventure/PotA/042-pam12_templeofhowlinghatred_dm-zf-0998-75774-1-004.webp#gallery)
...
If the characters loot the tombs of the Tyar-Besil, they find `dice:3d10|noform|noparens|avg` (`3d10`) figurines, keepsakes, and funerary masks worth 50 gp each.
...
> [!note] 
> 
> **Storm Boomerang.** *Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit; range 60/120 ft., one target. *Hit*: `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) bludgeoning damage plus `dice:3d4|noform|noparens|avg|text(7)` (`3d4`) thunder damage, and the target must succeed on a DC 10 Constitution saving throw or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) until the end of its next turn. *Miss*: The boomerang returns to the hurricane's hand.
^2e0
...
Check for a random encounter when the characters enter one of the apartments and every 10 minutes that they remain. Roll a `dice:d20|noform|noparens|avg` (`d20`) on the following table.

`dice: [](04-chapter-4-air-earth-fire-and-water.md#^encounter)`

| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [Howling Hatred initiates](3-Mechanics/CLI/bestiary/humanoid/howling-hatred-initiate-pota.md) (see area A3) |
| 3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [hurricanes](3-Mechanics/CLI/bestiary/humanoid/hurricane-pota.md) (see area A20) |
| 4 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [skyweavers](3-Mechanics/CLI/bestiary/humanoid/skyweaver-pota.md) (see area A20) |
| 5 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [Howling Hatred priests](3-Mechanics/CLI/bestiary/humanoid/howling-hatred-priest-pota.md) (see area A3) |
...
> [!note] 
> 
> **Seeker Dart.** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, and the hurricane gains advantage on the attack roll; range 120 ft., one target. *Hit*: `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) piercing damage plus `dice:3d4|noform|noparens|avg|text(7)` (`3d4`) lightning damage.
^2f3
...
![](file://adventure/PotA/043-poa04-03.webp#center)
...
Each time the characters travel the Dark Stream to or from the Temple of the Crushing Wave, roll a `dice:d20|noform|noparens|avg` (`d20`) for a random encounter at some point during the underground voyage.

`dice: [](04-chapter-4-air-earth-fire-and-water.md#^encounter)`

| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [darkmantles](3-Mechanics/CLI/bestiary/aberration/darkmantle-xmm.md) |
| 2 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [piercers](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) |
| 3 | `dice:1d4+4\|noform\|noparens\|avg` (`1d4 + 4`) [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) |
| 4 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
...
Many denizens of the temple carry small amounts of treasure. Creatures that own individual treasure have `dice:4d10|noform|noparens|avg` (`4d10`) gp worth of mixed coins and other minor valuables.

> [!gallery]
> ![Map 4.2: Temple of the Crushing Wave](file://adventure/PotA/044-04-02.webp#gallery)
> ![Player Version](file://adventure/PotA/045-pam13_templeofthecrushingwave_dm-zf-0998-75774-1.webp#gallery)
...
Aquatic creatures wander the canals. Check for a random encounter once every per hour while the party is swimming or moving by boat anywhere on a canal. Roll a `dice:d20|noform|noparens|avg` (`d20`) and consult the following table:

`dice: [](04-chapter-4-air-earth-fire-and-water.md#^encounter)`

| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) (see area C4) |
| 2–3 | `dice:1d4+4\|noform\|noparens\|avg` (`1d4 + 4`) [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) (see area C13) |
| 4 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) (see area C12) |
...
Cultists in this room are usually off-duty and might be asleep; roll `dice:1d6|noform|noparens|avg` (`1d6`) to see how many cultists are in their bunks. Sounds of fighting nearby rouse the sleeping cultists, who join the fray on their turns during the third round of combat.
...
This guard post is manned by a [one-eyed shiver](3-Mechanics/CLI/bestiary/humanoid/one-eyed-shiver-pota.md) named Khalt, a [Dark Tide knight](3-Mechanics/CLI/bestiary/humanoid/dark-tide-knight-pota.md) named Gordol, and three [Crushing Wave reavers](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) (see chapter 7 for all). Khalt is in charge, and he runs a tight ship. These reavers are armed with light crossbows instead of javelins (`dice:1d20+4|noform|noparens|text(+4)` to hit, `dice:1d8+2|noform|noparens|avg` (`1d8 + 2`) piercing damage), and Gordol also has a light crossbow (`dice:1d20+7|noform|noparens|text(+7)` to hit, `dice:1d8+3|noform|noparens|avg` (`1d8 + 3`) piercing damage).
...
![](file://adventure/PotA/046-poa04-05.webp#center)
...
The ceiling is 50 feet above water level. Its "stars" are small patches of luminescent lichen. Each patch is an inch in diameter and one-tenth as bright as a candle. If removed, a lichen's glow persists for `dice:1d3|noform|noparens|avg` (`1d3`) days.
...
Each time the characters pass through this area, roll a `dice:d20|noform|noparens|avg` (`d20`) on the following table to see what additional creatures, if any, are here.

`dice: [](04-chapter-4-air-earth-fire-and-water.md#^encounter)`

| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `dice:1d4+4\|noform\|noparens\|avg` (`1d4 + 4`) [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) (see area C13) |
| 2–3 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [Crushing Wave reavers](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) (see area C7) |
| 4 | `dice:1d3+1\|noform\|noparens\|avg` (`1d3 + 1`) [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) (see area C18) |
| 5 | 1 [Crushing Wave priest](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-priest-pota.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) (see area C27) |
...
> [!gallery]
> ![Map 4.3: Temple of Black Earth](file://adventure/PotA/047-04-03.webp#gallery)
> ![Player Version](file://adventure/PotA/048-pam15_templeofblackearth_dm-zf-0998-75774-1-006-0.webp#gallery)
...
If alerted by serious fighting or unusual activity outside, two duergar take light crossbows (`dice:1d20+2|noform|noparens|text(+2)` to hit, `dice:1d8|noform|noparens|avg` (`1d8`) piercing damage) and post themselves at the arrow slits. The other three prepare to defend the room's only entrance.
...
If the ogres are defeated, [Marlos Urnrayle](3-Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md) replaces them with an [earth elemental myrmidon](3-Mechanics/CLI/bestiary/elemental/earth-elemental-myrmidon-mpmm.md) (see chapter 7) after `dice:1d4|noform|noparens|avg` (`1d4`) days.
...
Two light crossbows are positioned near the arrow slit, so the guards can fire on intruders outside the room (`dice:1d20+3|noform|noparens|text(+3)` to hit, `dice:1d8|noform|noparens|avg` (`1d8`) piercing damage on a hit).
...
The mess hall sees a good deal of traffic, and characters who linger here are likely to run into more members of the Black Earth cult. Each time after the first the characters pass through this area, roll a `dice:d20|noform|noparens|avg` (`d20`) on the following table:

`dice: [](04-chapter-4-air-earth-fire-and-water.md#^encounter)`

| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | `dice:1d3+1\|noform\|noparens\|avg` (`1d3 + 1`) [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) (see area B5) |
| 3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) (see area B16) |
...
| 5 | 1 [burrowshark](3-Mechanics/CLI/bestiary/humanoid/burrowshark-pota.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) (see area B7) |
| 6 | 1 [Black Earth priest](3-Mechanics/CLI/bestiary/humanoid/black-earth-priest-pota.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [Black Earth guards](3-Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md) (see area B18) |
...
![](file://adventure/PotA/049-poa04-07.webp#center)
...
Erione has manacled a female [deep gnome](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) named Rukhelmoth "Rukh" Glitterstone to the stone post at the foot of the obelisk and intends to offer him as a sacrifice to the black pudding. When the pudding emerges, it seeps out of the obelisk like thick black blood and attacks the gnome first. Only after the gnome has been consumed does it pay attention to the characters.
...
> [!gallery]
> ![Map 4.4: Temple of Eternal Flame](file://adventure/PotA/050-04-04.webp#gallery)
> ![Player Version](file://adventure/PotA/051-pam16_templeofeternalflame_dm-zf-0998-75774-1-007.webp#gallery)
...
A creature that moves within 10 feet of one or more magma pillars for the first time on a turn or ends its turn there takes `dice:2d10|noform|noparens|avg` (`2d10`) fire damage. The razerblasts have immunity to fire damage.
...
The stone bridge is safe to cross. A creature takes `dice:6d10|noform|noparens|avg` (`6d10`) fire damage when it enters the lava for the first time on a turn or ends its turn there.
...
![](file://adventure/PotA/052-poa04-09.webp#center)

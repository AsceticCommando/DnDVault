...
![](file://adventure/PotA/013-poa02-01.webp#center)
...
> [!gallery]
> ![Map 2.1: Red Larch](file://adventure/PotA/014-02-02.webp#gallery)
> ![Player Version](file://adventure/PotA/015-poa1.webp#gallery)
...
![](file://adventure/PotA/016-poa02-03.webp#center)
...
![](file://adventure/PotA/017-poa02-04.webp#center)
...
Check for a random encounter in the morning, afternoon, evening, and midnight. Roll `dice:1d20|noform|noparens|avg` (`1d20`); an encounter occurs on an 18 or higher.
...
During chapters 3 and 4, use the "Early Travels" random encounter table. During chapter 5, use the "Later Travels" table. At any point during travel on or very near the Dessarin River, use the "River Travels" table. Roll `dice:1d12+1d8|noform|noparens|avg` (`1d12 + 1d8`) to determine what the adventurers run into.
...
| — | 2 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [jackalweres](3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) |
| 3 | — | Knights of Samular* |
| 4 | 3 | Pilgrims* |
| — | 4 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [owlbears](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md) |
| 5 | 5 | Elk tribe hunters* |
| 6 | 6 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ankhegs](3-Mechanics/CLI/bestiary/monstrosity/ankheg-xmm.md) |
| 7 | 7 | `dice:1d3+1\|noform\|noparens\|avg` (`1d3 + 1`) [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) |
| 8 | 8 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
| 9 | — | Dwarf miners* |
| 10 | — | Caravan* |
| 11 | — | Homestead* |
...
| 16 | 13 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
| 17 | — | Shepherds* |
| 18 | 14 | `dice:1d6+2\|noform\|noparens\|avg` (`1d6 + 2`) [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 19 | 15 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) |
| — | 16 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
| — | 17 | `dice:1d3+1\|noform\|noparens\|avg` (`1d3 + 1`) [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
| 20 | 18 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [perytons](3-Mechanics/CLI/bestiary/monstrosity/peryton-xmm.md) |
| — | 19 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
...
| 6–9 | River pirates* |
| 10–14 | Keelboat* |
| 15–16 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 17–18 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
...
| — | 2 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [jackalweres](3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) |
| 3 | 3 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [manticores](3-Mechanics/CLI/bestiary/monstrosity/manticore-xmm.md) |
| 4 | 4 | `dice:1d3+1\|noform\|noparens\|avg` (`1d3 + 1`) [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
| 5 | 5 | Elk tribe hunters* |
| — | 6 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [will-o'-wisps](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) |
| 6 | — | Knights of Samular* |
| 7 | — | Homestead* |
| — | 7 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [ghasts](3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) and `dice:1d4+2\|noform\|noparens\|avg` (`1d4 + 2`) [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
| 8 | 8 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
| 9 | 9 | Air cult skyriders* |
| 10 | 10 | Water cult raiders* |
| 11 | 11 | `dice:1d6+2\|noform\|noparens\|avg` (`1d6 + 2`) [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) |
| 12 | 12 | Fire cult war band* |
| 13 | 13 | Earth cult marauders* |
| 14 | 14 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) |
| 15 | — | Caravan* |
| — | 15 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 16 | 16 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) mephits* |
| 17 | — | Dwarf miners* |
| — | 17 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [vampire spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 18 | 18 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) elementals* |
| 19 | 19 | 1 [bulette](3-Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md) |
| 20 | 20 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) |

##### Aarakocra Scouts

These `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [aarakocra](3-Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) attack those who appear to be elemental cultists. Otherwise, the aarakocra might be helpful.

##### Aarakocra War Band

A war band consists of `dice:1d6+3|noform|noparens|avg` (`1d6 + 3`) [aarakocra](3-Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) and an [air elemental](3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md). They interact like the scouts, above.

##### Air Cult Scouts

A group of scouts for the air cult consists of `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [hurricanes](3-Mechanics/CLI/bestiary/humanoid/hurricane-pota.md) in [wingwear](3-Mechanics/CLI/items/wingwear-pota.md). See chapter 7 for the cultists' statistics and [wingwear](3-Mechanics/CLI/items/wingwear-pota.md) description.

##### Air Cult Skyriders

One [Feathergale knight](3-Mechanics/CLI/bestiary/humanoid/feathergale-knight-pota.md) leads `dice:1d4|noform|noparens|avg` (`1d4`) [skyweavers](3-Mechanics/CLI/bestiary/humanoid/skyweaver-pota.md). They all ride [giant vultures](3-Mechanics/CLI/bestiary/monstrosity/giant-vulture-xmm.md). See chapter 7 for the cultists' statistics

##### Caravan

A caravan consists of a merchant and his or her entourage heading for the nearest settlement. The group consists of `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), `dice:2d4|noform|noparens|avg` (`2d4`) [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), and the caravan leader (a spy).

##### Dwarf Miners

A band of dwarf miners consists of `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) shield dwarf [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) and a pugnacious leader (a shield dwarf [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)).

##### Earth Cult Marauders

A band of marauders for the earth cult consists of `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [Black Earth guards](3-Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md), a [Black Earth priest](3-Mechanics/CLI/bestiary/humanoid/black-earth-priest-pota.md), and `dice:1d4|noform|noparens|avg` (`1d4`)−1 [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md). See chapter 7 for the cultists' statistics.

##### Earth Cult Robbers

These earth cult robbers stake out spots to waylay passersby. The group consists of `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) and `dice:1d4|noform|noparens|avg` (`1d4`) [Black Earth guard](3-Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md)s (see chapter 7).

##### Elementals

A small group of elementals wanders freely. Roll a `dice:d4|noform|noparens|avg` (`d4`) to determine the type of elementals: 1, [air](3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md); 2, [earth](3-Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md); 3, [fire](3-Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md); 4, [water](3-Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md).

##### Elk Tribe Hunters

This group includes a [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md). They are hostile (see "The Uthgardt Tribes" section at the end of this chapter).

##### Fire Cult Raiders

The fire cult sends out raiders that include `dice:2d6|noform|noparens|avg` (`2d6`) [Eternal Flame guardians](3-Mechanics/CLI/bestiary/humanoid/eternal-flame-guardian-pota.md) and an [Eternal Flame priest](3-Mechanics/CLI/bestiary/humanoid/eternal-flame-priest-pota.md). See chapter 7 for the cultists' statistics.

##### Fire Cult War Band

A war band of the fire cult consists of `dice:1d6|noform|noparens|avg` (`1d6`) [Eternal Flame guardians](3-Mechanics/CLI/bestiary/humanoid/eternal-flame-guardian-pota.md), an [Eternal Flame priest](3-Mechanics/CLI/bestiary/humanoid/eternal-flame-priest-pota.md), and `dice:1d3|noform|noparens|avg` (`1d3`) [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md). See chapter 7 for the cultists' statistics.

##### Homestead

The party discovers a homestead. Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine the race of the people there: 1–3, Tethyrian human; 4, Illuskan human; 5–6, halfling. A homestead consists of `dice:1d6|noform|noparens|avg` (`1d6`) adult [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) and `dice:1d6|noform|noparens|avg` (`1d6`)−1 noncombatant children. Residents might provide friendly adventurers with food and shelter.

##### Keelboat

A river trader's keelboat carries `dice:1d4+4|noform|noparens|avg` (`1d4 + 4`) [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) (the sailors), `dice:1d4|noform|noparens|avg` (`1d4`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), and a captain (a [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)). They are willing to offer passage to adventurers heading in the same direction.

##### Knights of Samular

This armed patrol consists of `dice:1d4|noform|noparens|avg` (`1d4`) [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) and `dice:1d4|noform|noparens|avg` (`1d4`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md). They hail from Summit Hall and offer a hearty "Well met!" to the characters.

##### Mephits

Several mephits travel in a pack. Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine the mephit type: 1, [dust](3-Mechanics/CLI/bestiary/elemental/dust-mephit-xmm.md); 2, [ice](3-Mechanics/CLI/bestiary/elemental/ice-mephit-xmm.md); 3, [magma](3-Mechanics/CLI/bestiary/elemental/magma-mephit-xmm.md); 4, [mud](3-Mechanics/CLI/bestiary/elemental/mud-mephit-xmm.md); 5, [smoke](3-Mechanics/CLI/bestiary/elemental/smoke-mephit-xmm.md); 6, [steam](3-Mechanics/CLI/bestiary/elemental/steam-mephit-xmm.md).

##### Pilgrims

A group of pilgrims includes `dice:2d6|noform|noparens|avg` (`2d6`) [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), `dice:1d4|noform|noparens|avg` (`1d4`) [acolytes](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), and a [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) bound for a holy or special site. They're happy for company.

##### River Pirates

A keelboat carries `dice:2d4|noform|noparens|avg` (`2d4`) [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md), `dice:1d4|noform|noparens|avg` (`1d4`) [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), and a pirate captain (a [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)).

##### Shepherds

A group of shepherds watch over herd animals. Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine the shepherds' race: 1–4, human; 5–6, halfling. The group consists of `dice:1d4|noform|noparens|avg` (`1d4`) [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) and `dice:1d2|noform|noparens|avg` (`1d2`) leaders (scouts).

##### The Watchful Knight

Once, this [helmed horror](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md) stood watch in the common room of the Inn of the Watchful Knight in Beliard. It chooses one character at random, advances to within 5 feet, then studies the target for several seconds. If attacked, it fights back, retreating after it loses half its hit points. Otherwise, it follows the chosen character for `dice:1d3|noform|noparens|avg` (`1d3`) days, guarding its temporary master in combat. At the end of that time the helmed horror wanders off again.

##### Water Cult Marauders

A marauder gang of the water cult consists of `dice:2d6|noform|noparens|avg` (`2d6`) [Crushing Wave reavers](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md), a [Crushing Wave priest](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-priest-pota.md), and `dice:1d2|noform|noparens|avg` (`1d2`) [fathomers](3-Mechanics/CLI/bestiary/humanoid/fathomer-pota.md). See chapter 7 for the cultists' statistics.

##### Water Cult Raiders

A group of raiders from the water cult includes `dice:2d6|noform|noparens|avg` (`2d6`) [Crushing Wave reavers](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md), a [Crushing Wave priest](3-Mechanics/CLI/bestiary/humanoid/crushing-wave-priest-pota.md), and a [one-eyed shiver](3-Mechanics/CLI/bestiary/humanoid/one-eyed-shiver-pota.md). The leader is a [Dark Tide knight](3-Mechanics/CLI/bestiary/humanoid/dark-tide-knight-pota.md) mounted on a [giant crocodile](3-Mechanics/CLI/bestiary/beast/giant-crocodile-xmm.md). See chapter 7 for the cultists' statistics.
...
> [!gallery]
> ![Map 2.2: The Dessarin Valley](file://adventure/PotA/018-poa2-errata.webp#gallery)
> ![Player Version](file://adventure/PotA/019-poa2.webp#gallery)
...
![](file://adventure/PotA/020-poa02-06.webp#center)
...
![](file://adventure/PotA/021-poa02-07.webp#center)
...
![](file://adventure/PotA/022-poa02-08.webp#center)

...
![](file://adventure/PotA/070-poa06-01.webp#center)
...
> [!gallery]
> ![Map 6.1: Red Larch Surroundings](file://adventure/PotA/071-06-01.webp#gallery)
> ![Player Version](file://adventure/PotA/072-poa3.webp#gallery)
...
> [!gallery]
> ![Map 6.2: Necromancer's Cave](file://adventure/PotA/073-06-02.webp#gallery)
> ![Player Version](file://adventure/PotA/074-poa7.webp#gallery)
...
Those in the room can make DC 10 Dexterity saving throws, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) bludgeoning damage on a failure, or half that damage on a success.
...
![](file://adventure/PotA/075-poa06-04.webp#center)
...
![](file://adventure/PotA/076-poa06-05.webp#center)
...
> [!gallery]
> ![Map 6.3: Tomb of Moving Stones](file://adventure/PotA/077-06-03.webp#gallery)
> ![Player Version](file://adventure/PotA/078-pam05_tombmoving_dm-zf-0998-75774-1-001-0.webp#gallery)
...
![](file://adventure/PotA/079-poa06-07.webp#center)
...
> [!gallery]
> ![Map 6.4: Bargewright Inn](file://adventure/PotA/080-06-04.webp#gallery)
> ![Player Version](file://adventure/PotA/081-pam18_bargewright_dm-zf-0998-75774-1-009-0.webp#gallery)
...
![](file://adventure/PotA/082-poa06-09.webp#center)
...
![](file://adventure/PotA/083-poa06-10.webp#center)
...
> [!gallery]
> ![Map 6.5: Dellmon Ranch](file://adventure/PotA/084-06-05.webp#gallery)
> ![Player Version](file://adventure/PotA/085-pam11_iceshield_dm-zf-0998-75774-1-003-0.webp#gallery)
...
![Map 6.6: The Barrow Mound](file://adventure/PotA/086-06-06.webp#center)
...
Uthgardt of the fierce Elk tribe, as can be discerned from their garb and markings, this barbarian raiding band is led by a female [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) named [Fennor](3-Mechanics/CLI/bestiary/npc/fennor-pota.md). Other members include ten [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) and a male [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) named [Padraich](3-Mechanics/CLI/bestiary/npc/padraich-pota.md). [Fennor](3-Mechanics/CLI/bestiary/npc/fennor-pota.md) wears a chain shirt (AC 14), wields a greatsword that deals `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) slashing damage on a hit, and has the Multiattack action, allowing her to use an action to make two attacks with her sword. She has a challenge rating of 3. [Padraich](3-Mechanics/CLI/bestiary/npc/padraich-pota.md) wields a maul that deals `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) bludgeoning damage on a hit. The two berserkers ride [warhorses](3-Mechanics/CLI/bestiary/beast/warhorse-xmm.md).
...
> [!gallery]
> ![Map 6.7: Shrine of the Tender Oath](file://adventure/PotA/087-06-07.webp#gallery)
> ![Player Version](file://adventure/PotA/088-pam19_dancingwaters_dm-zf-0998-75774-1-010-0.webp#gallery)
...
Two dwarf [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) stand watch atop this stony shelf. Instead of spears and shields, they carry warhammers that they wield with two hands (`dice:1d10+1|noform|noparens|avg` (`1d10 + 1`) bludgeoning damage on a hit). Without shields, they have AC 14. Whether or not the guards are present depends on how quietly the characters approach:
...
If the characters think the ceremony is real and join the festivities, the dwarves wait for them to get close before drawing hidden weapons and taking the characters. Characters with a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 13 or higher notice that the dwarves are wearing chain shirts under their robes; these characters aren't [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised) when the dwarves attack. Instead of spears and shields, the dwarves carry warhammers that they wield with two hands (`dice:1d10+1|noform|noparens|avg` (`1d10 + 1`) bludgeoning damage on a hit). Without shields, these guards have AC 14.
...
![](file://adventure/PotA/089-poa06-14.webp#center)

The leather-clad dwarf is [Grumink the Renegade](3-Mechanics/CLI/bestiary/npc/grumink-the-renegade-pota.md) (see "Other Villains" in chapter 7), and the "blue-skinned ogre" is the [oni](3-Mechanics/CLI/bestiary/fiend/oni-xmm.md), Obratu. Eight dwarf [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) are hammering at the stone wall behind the altar. Instead of spears and shields, the guards carry warhammers that they wield with two hands (`dice:1d10+1|noform|noparens|avg` (`1d10 + 1`) bludgeoning damage on a hit). Without shields, these guards have AC 14.
...
![](file://adventure/PotA/090-poa06-15.webp#center)
...
> [!gallery]
> ![Map 6.8: Yartar](file://adventure/PotA/091-06-08.webp#gallery)
> ![Player Version](file://adventure/PotA/092-pam17_murderinyartar_dm-zf-0998-75774-1-008-0.webp#gallery)
...
![](file://adventure/PotA/093-poa06-17.webp#center)
...
![](file://adventure/PotA/094-poa06-18.webp#center)
...
> [!gallery]
> ![Map 6.9: Halls of the Hunting Axe](file://adventure/PotA/095-06-09.webp#gallery)
> ![Player Version](file://adventure/PotA/096-pam25_huntingaxe-zf-0998-75774-1-012-0.webp#gallery)
...
![](file://adventure/PotA/097-poa06-20.webp#center)
...
Opening the sarcophagus releases a cloud of poisonous gas that fills the room. Any creature in the chamber must make a DC 15 Constitution saving throw, taking `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) poison damage on a failed save, or half as much damage on a successful one. A creature that fails the saving throw is also [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 minute.
...
![](file://adventure/PotA/098-poa06-21.webp#center)

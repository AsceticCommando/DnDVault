...
[Barbatos](3-Mechanics/CLI/bestiary/npc/barbatos-imr.md) is always accompanied by his animal companion, a [hell hound](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) named Sadie III.

### Mack Francache

This neutral [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) thief is the leader of the band sent to the temple by [Moghadam](3-Mechanics/CLI/bestiary/npc/moghadam-imr.md), and charged with stealing the ruby eyes from the temple's great statue of Moloch. Having failed in his assignment, Francache now languishes in the temple's torture chamber.
...
![Thessalheart Construct](file://adventure/IMR/007-005.webp#center)
...
> [!gallery]
> ![Map 4.1: Temple of Moloch](file://adventure/IMR/008-map-1-2.webp#gallery)
> ![Player Version](file://adventure/IMR/009-map-1-2-player.webp#gallery)
...
Anyone who listens at the door to the west and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check hears a moaning that rises and fades away (caused by strong breezes in area 2). Opening the door causes the breeze to fill this corridor, creating the effect of a [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md) spell.

#### Creature

The webs on the ceiling conceal a mutated giant spider with the beak of a giant owl (use the [grell](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) stat block). This creature escaped from [Thessalar](3-Mechanics/CLI/bestiary/npc/thessalar-imr.md)'s labs and has been allowed to lair here to watch over the entrance. The lizardfolk have nicknamed it "Thacko."
...
Having a mechanical guide spend 1 charge in this area causes the guards in area 5 to change shifts, allowing the characters to pass through here without being noticed. Spending 2 charges also causes Thacko to grow younger or older. Roll a `dice:d4|noform|noparens|avg` (`d4`). On a 1–2, the creature halves its hit points. On a 3–4, the creature doubles its hit points.
...
Having a mechanical guide spend 1 or more charges in this area creates a 10 percent cumulative chance for a ruby (worth `1d10 × 10` gp) to wash into view from upstream, as well as a 25 percent cumulative chance for `dice:1d4|noform|noparens|avg` (`1d4`) [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) to arrive on assignment to bring more water into the temple.
...
Having a mechanical guide spend 1 charge in this area results in four [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) guards and a [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) opening the secret door to the south and conveying the bodies down the south corridor before vanishing from sight.
...
Eight [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), a [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md), and the shaman's [two-headed crocodile](3-Mechanics/CLI/bestiary/beast/two-headed-crocodile-imr.md) companion rest in this area. If they are alerted to intruders by the lizardfolk in area 5, they head directly for area 1 to challenge them.
...
Having a mechanical guide spend 1 charge in this area causes the guards to change shifts, leaving for areas 4 and 5. Spending 2 charges also brings the prisoner back to life. Little Gadai is a lawful neutral human [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md). He joins the characters if allowed to, seeking to rescue and rejoin the other thieves to complete their original mission. His knowledge of the temple is limited to areas 1 through 6.
...
Having a mechanical guide spend 1 or more charges in this area has a 20 percent cumulative chance that `dice:1d4|noform|noparens|avg` (`1d4`) [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) guards arrive to fetch more supplies for the temple. They attack intruders at once.
...
| 06–15 | A tiny [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) is disguised as a sack. The mimic deals half damage with its pseudopod and bite attacks, and has only 1 hit point. |
| 16–25 | A small box holds one [gauntlet of ogre power](3-Mechanics/CLI/items/gauntlets-of-ogre-power-xdmg.md) and one [boot of striding and springing](3-Mechanics/CLI/items/boots-of-striding-and-springing-xdmg.md). There is no sign of either item's missing mate unless you want to have it found elsewhere in the adventure. |
...
| 71–80 | A long piece of oilcloth wraps up a number of missing levers to an [apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md) (to be found in area 29). |
| 81–85 | A small sack is revealed to be a [bag of beans](3-Mechanics/CLI/items/bag-of-beans-xdmg.md) containing six beans. |
...
| 91–96 | A sack holds a common magic item and `dice:1d4\|noform\|noparens\|avg` (`1d4`) potions, all of your choice. |
| 97–99 | A leather case holds an uncommon magic item and `dice:1d4\|noform\|noparens\|avg` (`1d4`) scrolls, all of your choice. |
...
Mack Francache, the neutral [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) leader of [Moghadam](3-Mechanics/CLI/bestiary/npc/moghadam-imr.md)'s thieves, is the unwilling subject of one of [Thessalar](3-Mechanics/CLI/bestiary/npc/thessalar-imr.md)'s sadistic experiments, conducted by [Andras](3-Mechanics/CLI/bestiary/npc/andras-imr.md). His lycanthropic blood is being drained for study by [Thessalar](3-Mechanics/CLI/bestiary/npc/thessalar-imr.md), who has already discovered ways in which it might be weaponized (see "Poisons" in appendix C).

The silver wires connect Francache to a lawful neutral female human [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) named Big Gadai (sister to the dead thief in area 6) and a normal rat. As [Andras](3-Mechanics/CLI/bestiary/npc/andras-imr.md) operates the controls to this strange torture device, he causes Francache's lycanthropy to transform the rat into a duplicate of Big Gadai, to the pain and horror of everyone involved. When the rat is in human form, it insists that it is the real Big Gadai, as does the real Big Gadai.
...
Anyone attempting to disrupt the controls or the wires must succeed on a DC 13 Constitution saving throw or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) force damage. The controls and the wires are self-repairing, and cannot be severed or destroyed.
...
Three [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) here are being punished for various transgressions. Mean-tempered and suspicious, they nonetheless offer information regarding the temple in exchange for their freedom, knowing their fate is otherwise horrible experimentation. They are likely to turn against the party at the first opportunity.

##### 10b

Two of [Moghadam](3-Mechanics/CLI/bestiary/npc/moghadam-imr.md)'s thieves (both lawful evil [spies](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) are incarcerated here, one wounded and one near death, and both desperate to be freed. They are periodically taken out for interrogation in area 9, and are aware that experiments performed on them have created clones of themselves. They vehemently claim to be the real thieves.
...
- Replace his dagger attack with the following attack: ***Talons*.** *Melee Weapon Attack*: `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit*: `dice:2d6+1|noform|noparens|avg|text(8)` (`2d6 + 1`) slashing damage.  
...
The strongbox holds the treasure collected from [Stolos](3-Mechanics/CLI/bestiary/npc/stolos-imr.md)'s current prisoners—45 gp, 23 pp, ten small rubies (worth 25 gp each), a [ring of water walking](3-Mechanics/CLI/items/ring-of-water-walking-xdmg.md), and a vial of [blood of the lycanthrope antidote](3-Mechanics/CLI/items/blood-of-the-lycanthrope-antidote-imr.md) (see appendix C).
...
Whenever anyone enters this area, a huge cacophony of shrieks and hooting is raised from the animals kept here. The walls of the room are lined with cages filled with [owls](3-Mechanics/CLI/bestiary/beast/owl-xmm.md)—one pair each of barn owls, horned owls, screech owls, and snowy owls. Against one wall, a huge cage holds a [giant owl](3-Mechanics/CLI/bestiary/celestial/giant-owl-xmm.md). In addition, several terrariums hold live mice, lizards, and small snakes used as food for the owls. Various cabinets hold prepared owl food, supplies, and implements for both the care and dissection of these creatures.
...
Anyone attempting to disrupt the wires must succeed on a DC 13 Constitution saving throw or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) force damage. The wires are self-repairing, and cannot be severed or destroyed.
...
Whenever anyone enters this area, a low growling rises from the animals kept here. A number of large, sturdy cages house one pair each of [black bears](3-Mechanics/CLI/bestiary/beast/black-bear-xmm.md), [brown bears](3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md), and [polar bears](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md). In addition, shelves and cupboards throughout the room hold dried fish, dried berries, and grubs as food for the bears, along with tools and supplies.
...
The ranger [Barbatos](3-Mechanics/CLI/bestiary/npc/barbatos-imr.md) is either here or in area 12 (a 50 percent chance for either), accompanied by his [hell hound](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) companion, Sadie III. See appendix B for his stat block, and area 12 for more information.
...
Having a mechanical guide spend 1 charge in this area causes the lizardfolk renders on the tables to devolve back into standard [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md).
...
![Thessalar](file://adventure/IMR/010-cover-page.webp#center)
...
- The homunculus has the following additional attack option: ***Acidic Spittle*.** *Ranged Weapon Attack*: `dice:1d20+4|noform|noparens|text(+4)` to hit, range 30 ft., one target. *Hit*: `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) acid damage.  

#### Control Panel

The control panel on the desk is covered with dials, switches, and buttons—including three emerald-green buttons recognizable as missing components from the *Infernal Machine*. Removing these missing components deactivates the controls and releases the [pseudodragon](3-Mechanics/CLI/bestiary/dragon/pseudodragon-xmm.md) and the ant swarm (use the [swarm of insects](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) stat block), which attack the nearest creatures until destroyed.
...
In addition, this area contains [alchemist's supplies](3-Mechanics/CLI/items/alchemists-supplies-xphb.md), an [herbalism kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md), two vials each of [thessaltoxin poison](3-Mechanics/CLI/items/thessaltoxin-imr.md) and [thessaltoxin antidote](3-Mechanics/CLI/items/thessaltoxin-antidote-imr.md) (see appendix C), a box of ten [paper birds](3-Mechanics/CLI/items/paper-bird-wdh.md) (appendix C), and a strongbox containing three exceptional rubies worth 500 gp each.
...
Having a mechanical guide spend 1 charge in this area causes a [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) to appear here with a bucket of waste to dispose of. The lizardfolk ignores the characters, expecting that anyone hanging out in the midden must have some good reason to do so.

### 18. Disposal Pit

This open pit collects the waste thrown into the midden (area 17), where it feeds the [otyugh](3-Mechanics/CLI/bestiary/aberration/otyugh-xmm.md) that dwells in the pit. If any creature moves within 5 feet of the pit, the otyugh clambers out and attacks.
...
- A tiny [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) in the shape of a jewelry box; the mimic deals half damage with its pseudopod and bite attacks, and has only 1 hit point  
...
![Statue of Moloch](file://adventure/IMR/011-006.webp#center)
...
The larger alcove to the south of this area holds a pile of sacred stones for the construction of a powerful stone golem. This stone supposedly fell from Ogrémoch's body during the fight against Olhydra that carved out the first of the temple caverns. The smaller alcove holds the golem under construction. [Thessalar](3-Mechanics/CLI/bestiary/npc/thessalar-imr.md) hopes to recover his sculptors, their superior mason's tools, and their half of the [manual of stone golems](3-Mechanics/CLI/items/manual-of-stone-golems-xdmg.md) to complete this golem and send it out against [Moghadam](3-Mechanics/CLI/bestiary/npc/moghadam-imr.md).
...
In addition to mundane gear, this area contains a [folding boat](3-Mechanics/CLI/items/folding-boat-xdmg.md), a [helm of underwater action](3-Mechanics/CLI/items/helm-of-underwater-action-gos.md) (see appendix C), and an incomplete [apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md). The missing levers of the apparatus can be found in area 7, and require a successful DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check or a Dexterity check using thieves' tools or tinker's tools to reassemble.

#### Manipulating Time

Having a mechanical guide spend 1 charge in this area causes `dice:1d4|noform|noparens|avg` (`1d4`) [lizardfolk renders](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md) to arrive for the priest's blessing before departing down the stairs to the underground lake (area 30). They attack unless they can be convinced the characters are part of the blessing ceremony.
...
Having a mechanical guide spend 1 charge in this area causes the thessalkraken to reveal itself as it breaks the surface of the water seeking food. Spending 2 charges also causes `dice:1d4|noform|noparens|avg` (`1d4`) [lizardfolk renders](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md) to arrive, ready to brave the waters in search of gems. The lizardfolk take the appearance of the characters as a sign of offering, and attempt to force them into the water as sacrifices for their demigod.
...
If the characters talk of rescuing her, [Seodra](3-Mechanics/CLI/bestiary/npc/seodra-imr.md) refuses to leave unless they also promise to help her steal the statue's eyes. She takes her tools and the silver skull if the characters convince her to come with them. [Seodra](3-Mechanics/CLI/bestiary/npc/seodra-imr.md) uses the [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) stat block with the following changes:
...
[Seodra](3-Mechanics/CLI/bestiary/npc/seodra-imr.md) possesses a set of superior [jeweler's tools](3-Mechanics/CLI/items/jewelers-tools-xphb.md). These tools grant advantage when used to make an appropriate crafting check, and are worth 500 gp.

#### Manipulating Time

Having a mechanical guide spend 1 charge in this area taps into the ritual magic [Seodra](3-Mechanics/CLI/bestiary/npc/seodra-imr.md) is using to craft the demilich's skull, causing a random character to age by one year. This effect can be reversed by casting a [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell using a 6th-level spell slot.
...
Four [lizardfolk shamans](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) are stationed here as temple guards. If they hear any sign of trouble along the corridor from area 25, they rush through the concealed doors to help defend the eidolon and the sacred statue there.
...
![&quot;The Demogorgon&quot;](file://adventure/IMR/012-007.webp#center)
...
In addition, five magic gems and stones are stored in individual coffers scattered about the room—an [elemental gem (earth)](3-Mechanics/CLI/items/elemental-gem-yellow-diamond-xdmg.md), an [Ioun stone of vitality](3-Mechanics/CLI/items/ioun-stone-of-vitality-imr.md) (see appendix C), and three [spell gems](3-Mechanics/CLI/items/spell-gem-oota.md) (see appendix C). Two of the spell gems are [lapis lazuli](3-Mechanics/CLI/items/spell-gem-lapis-lazuli-oota.md) holding [identify](3-Mechanics/CLI/spells/identify-xphb.md) and [unseen servant](3-Mechanics/CLI/spells/unseen-servant-xphb.md). The third is a [quartz](3-Mechanics/CLI/items/spell-gem-quartz-oota.md) holding [locate object](3-Mechanics/CLI/spells/locate-object-xphb.md).

#### Manipulating Time

Having a mechanical guide spend 1 charge in this area either causes `dice:1d4|noform|noparens|avg` (`1d4`) of the largest uncut rubies to become cut and polished, doubling their value (a 50 percent chance), or causes the same number of the largest cut rubies to degrade back to raw stones, halving their value.
...
Lizardfolk in service to [Thessalar](3-Mechanics/CLI/bestiary/npc/thessalar-imr.md) are sent here to brave the waters and attempt to recover more gemstones from the bottom of the lake. When the characters arrive here, the bottom of the lake is littered with `dice:1d10|noform|noparens|avg` (`1d10`) rubies. Roll a `dice:d10|noform|noparens|avg` (`d10`) to determine the value of each ruby found—
...
Having a mechanical guide spend 1 charge in this area causes the thessalkraken to break the surface of the water seeking food, thus revealing itself. Spending 2 charges also causes `dice:1d4|noform|noparens|avg` (`1d4`) [lizardfolk renders](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md) to arrive, ready to brave the waters in search of gemstones. The lizardfolk take the appearance of the characters as a sign of offering, and attempt to force them into the water as sacrifices for their demigod.
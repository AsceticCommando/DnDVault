...
![The svirfneblin town of Little Lockford holds many wonders—and many hidden dangers](file://adventure/KftGV/036-05-001.ch5-splash.webp#center)

## Adventure Background

![](file://adventure/KftGV/037-05-002.ch5-key.webp#center)
...
Little Lockford is situated in the Underdark, but the tunnels leading to the settlement are well traveled and relatively easy to navigate. Stone signs illuminated by [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells can be found at every junction, pointing the way to the settlement.
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | Two [grells](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) drop on the characters from above. |
| 2 | The characters hear the clicks and clacks of three [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) several minutes before these predators appear and attack. |
| 3 | A [galeb duhr](3-Mechanics/CLI/bestiary/elemental/galeb-duhr-xmm.md) reveals itself and tries to converse with the characters in Terran. The creature is bored and eager to strike up a conversation, if only to ask about the weather. |
| 4 | A [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) oozes from a hole in the wall and attacks. |
...
| 6 | The characters enter a small cave containing a stone throne fit for a gnome. The throne, which looks like it was carved from a stalagmite, is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) that attacks anyone who sits on it. |
| 7–12 | A [deep gnome](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) named Nyx Riddlestone is on the lookout for adventurers heading to Little Lockford. Nyx speaks Common, Gnomish, Terran, and Undercommon. She greets the characters curtly and offers to escort them to Mayor Broadfoot without delay. |
^underdark-encounters

## Meeting the Mayor

Mayor Braith Broadfoot (neutral good, deep gnome [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) speaks Common in addition to Gnomish, Terran, and Undercommon. She and her fellow gnome exiles are gathered in a cavern not too far from the front gates of the Little Lockford. If the characters say they've come to help, the mayor eagerly gives them an overview of the situation:
...
- Four [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md)  
- A packet of [dust of disappearance](3-Mechanics/CLI/items/dust-of-disappearance-xdmg.md)  
- Two [flasks of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md)  

![Map 5.1: Players' Map](file://adventure/KftGV/038-05-003.players-map.webp#center)

## Planning the Heist

![Tixie Tockworth](file://adventure/KftGV/039-05-004.tixie-tockworth.webp#center)
...
- **Healing Aids.** The sergeant recalls that [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and [healer's kits](3-Mechanics/CLI/items/healers-kit-xphb.md) can be found in the city infirmary in Turbine Heights.  
...
Other Constructs under Tockworth's control include two suits of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md) (see area L9a) and a [shield guardian](3-Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md) that lost its master and its control amulet. The shield guardian stands guard outside Tockworth's workshop (area L9).
...
|----------|------------------------|---------------------|
| 1 | 2 [darkmantles](3-Mechanics/CLI/bestiary/aberration/darkmantle-xmm.md) following 1 [grick](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) | 3 [clockwork defenders](3-Mechanics/CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 2–3 | 2 [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) | 2 [clockwork defenders](3-Mechanics/CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 4–6 | 1 [shambling mound](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) made of fungi | 1 [clockwork observer](3-Mechanics/CLI/bestiary/construct/clockwork-observer-kftgv.md) |
^wandering-monsters
...
> [!gallery]
> ![Map 5.2: DM's map](file://adventure/KftGV/040-map-5.02-dms-map.webp#gallery)
> ![Player Version](file://adventure/KftGV/041-map-5.02-dms-map-player.webp#gallery)
...
The outer gates lock automatically when they close. The two gnome mages on duty have prepared [knock](3-Mechanics/CLI/spells/knock-xphb.md) spells, which they use to circumvent the gates' complex locking mechanisms. It takes two [knock](3-Mechanics/CLI/spells/knock-xphb.md) spells to open the gates.
...
From Mayor Broadfoot's office, characters can retrieve four [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), two [flasks of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), and one use of [dust of disappearance](3-Mechanics/CLI/items/dust-of-disappearance-xdmg.md) in a small packet. These items are kept in an unlocked footlocker under the mayor's desk. On the desk is a [calligraphy set](3-Mechanics/CLI/items/calligraphers-supplies-xphb.md).
...
The largest room in the abbey, directly across from the entrance, serves as a place of worship. Low benches face the middle of the domed chamber, where every word spoken—even a whisper—can be heard throughout the space. Skulking in the dark corners of this room are two prisoners who escaped the custody of their guards as they were being led from the jail (area L5) during the evacuation of Little Lockford. The two prisoners—a [goblin boss](3-Mechanics/CLI/bestiary/fey/goblin-boss-xmm.md) named Slonk and a [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) named Yuzzik—have manacles on their wrists and carry no weapons. Slonk was the leader of a gang of goblin brigands that preyed on travelers in the tunnels near Little Lockford. Yuzzik is Slonk's sole surviving bodyguard. Both are unscrupulous and will do almost anything to survive, short of betraying each other.
...
The abbot [Kavoda](3-Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) tried to flee Little Lockford with his fellow monks, but he didn't get far before one of Tockworth's automatons chased him back to the abbey. Minutes after [Kavoda](3-Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) returned to the abbey, Slonk and Yuzzik showed up. [Kavoda](3-Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) avoided them by casting [meld into stone](3-Mechanics/CLI/spells/meld-into-stone-xphb.md). He has been using [meld into stone](3-Mechanics/CLI/spells/meld-into-stone-xphb.md) spells to hide ever since. As the characters explore the abbey, [Kavoda](3-Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) hears one of them and emerges from a nearby wall when he thinks it's safe to do so.

[Kavoda](3-Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) is a chaotic good [deep gnome](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) who speaks Common, Gnomish, Terran, and Undercommon. His Innate Spellcasting trait includes the ability to cast [meld into stone](3-Mechanics/CLI/spells/meld-into-stone-xphb.md) three times per day. He wears a gray robe instead of armor (AC 12) and carries a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [magic weapon](3-Mechanics/CLI/spells/magic-weapon-xphb.md) and a [potion of giant strength (hill)](3-Mechanics/CLI/items/potion-of-hill-giant-strength-xdmg.md).
...
Characters who loot the storage rooms find six [healer's kits](3-Mechanics/CLI/items/healers-kit-xphb.md) and six [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
Characters who loot the foundry find three sets of [smith's tools](3-Mechanics/CLI/items/smiths-tools-xphb.md) and two sets of [tinker's tools](3-Mechanics/CLI/items/tinkers-tools-xphb.md).
...
The presence of intruders confuses, disturbs, and annoys Tockworth. If she is confronted by the characters here or if the [alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell triggers on the safe in area L9b, she casts [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md) and steps through the spell's magical doorway into area L9b. As she leaves, she says, "Break time's over, Poots!" (The characters have no way to know this, but Poots is the name of an imaginary friend Tockworth invented in her childhood. This long-lost imaginary friend has resurfaced recently in response to Tockworth's mounting loneliness.)
...
![Animated suits of armor do much of the assembly work in Tockworth's workshop](file://adventure/KftGV/042-05-005.animated-suits-assembly.webp#center)
...
This workshop is where Tockworth creates her clockwork automatons. Two suits of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md) named Rack and Pinion serve as her assistants and perform most of the hands-on work. These Constructs attack intruders on sight.

The workshop contains a smelter used to fabricate parts and tools. There are enough tools here to assemble one set of [smith's tools](3-Mechanics/CLI/items/smiths-tools-xphb.md) and one set of [tinker's tools](3-Mechanics/CLI/items/tinkers-tools-xphb.md).

The trapdoor in the ceiling opens into area L9b.

##### Geometric Design

A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic around the complex geometric symbol inscribed on the floor. When a creature other than Tockworth enters the space above the symbol for the first time on a turn or starts its turn there, that creature becomes the target of a [crown of madness](3-Mechanics/CLI/spells/crown-of-madness-xphb.md) spell (save DC 15) that has a duration of 1 minute.
...
The safe can't be moved, and a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic around it.

A character equipped with thieves' tools can spend 1 minute trying to crack open the safe door, doing so with a successful DC 20 Dexterity check. Alternatively, a character can spend 1 minute pressing their ear to the safe's door while trying to delicately pick its combination lock, opening the door with a successful DC 16 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) or Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. The safe door also opens when the proper command word ("Poots") is spoken within 5 feet of it. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic also opens the safe.

##### Tixie Tockworth

If the safe door is opened by any means other than speaking the proper command word, a mental [alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell alerts [Tixie Tockworth](3-Mechanics/CLI/bestiary/npc/tixie-tockworth-kftgv.md) (see her description and stat block at the end of the adventure). Unless she was defeated in area L8, Tockworth uses a [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md) spell to appear in the middle of the room and attacks any burglars she sees.

If Tockworth is reduced to 40 hit points or fewer, she uses her next action to cast [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md) again, then steps through the doorway into area L12.
...
- Zircon ring (60 gp)  
- Three [amethysts](3-Mechanics/CLI/items/amethyst-xdmg.md) (100 gp each)  
...
A thorough search of the building reveals the corpse of a robed deep gnome named Schnella Deepdelve, the master of the town's miners' guild. Schnella refused to leave and died fending off Tockworth's clockwork defenders. Her restless soul lurks in this building, manifesting as a troublesome [specter](3-Mechanics/CLI/bestiary/undead/specter-xmm.md) known as a [poltergeist](3-Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) (see the "Variant: Poltergeist" sidebar in the "Specter" entry of the "Monster Manual").
...
The dead gnomes are two [mimics](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) that attack anyone who touches or otherwise disturbs them. The mimics are working with a [psychic gray ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) (see the "Variant: Psychic Gray Ooze" sidebar in the "Oozes" entry of the "Monster Manual")—the "puddle of oil" mentioned above. The gray ooze and the mimics recently crept into the warehouse and are waiting for food to come to them.

##### Contraption

The vehicle in the warehouse is a Large, magical drilling machine used by the miners of Little Lockford to burrow new tunnels. The vehicle has the properties of an [apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md), with these changes:
...
- **Who Is Poots?.** When Tockworth is upset, she speaks to an imaginary friend named Poots—as if Poots were standing right next to her. (Ignus doesn't know that "Poots" is also the command word to bypass the [alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell on Tockworth's safe.)  
...
The cavern is home to six [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) and hundreds of ordinary [lizards](3-Mechanics/CLI/bestiary/beast/lizard-xmm.md), all of which are docile but skittish. The giant ones are trained to serve the svirfneblin as pack animals. A character who approaches a giant lizard can use an action to try to keep it from running away, doing so with a successful DC 13 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. A giant lizard that doesn't run away can be used by that character as a mount.

...
![A rogue rappels down the icy walls of Revel's End, a prison in the frozen north](file://adventure/KftGV/000-00-001.intro-splash.webp#center)
...
![Meera Raheer](file://adventure/KftGV/001-00-002.meera-raheer.webp#center)

[Meera Raheer](3-Mechanics/CLI/bestiary/npc/meera-raheer-kftgv.md) (lawful good, human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) is a Golden Vault handler you can assign to oversee your players' heist crew.
...
|-------|------------------------|------------------------|-------------------------|
| Arlo | [Bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) | [Knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) | [Mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) |
| Enna | [Bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) | [Spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) | [Assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) |
| Gregir | [Bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Sabrina | [Bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Torgja | [Bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Tosh | [Scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | [Spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) | [Veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
^rival-crew-statistics

![Careful planning is key to pulling off a dangerous heist](file://adventure/KftGV/002-00-003.careful-planning.webp#center)
...
![Golden Vault Seal](file://adventure/KftGV/003-00-004.golden-vault-seal.webp#center)
...
| The Stygian Gambit | Regor Falsain (neutral evil, human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), a gambler who wasn't invited to participate in the three-dragon ante tournament, hires the rivals to steal the erinyes statuette. |
| Reach for the Stars | Yexanthal (chaotic evil, elf [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) was one of [Markos Delphi](3-Mechanics/CLI/bestiary/npc/markos-delphi-kftgv.md)'s researchers until he was caught trying to steal The Celestial Codex. Eager to commune with Far Realm entities, Yexanthal hires the rivals to steal the book from Delphi Mansion. |
| Prisoner 13 | Horath Axebreaker (lawful evil, dwarf [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) hires the rivals to retrieve a copy of [Prisoner 13](3-Mechanics/CLI/bestiary/npc/prisoner-13-kftgv.md)'s keystone tattoo so he can steal Clan Axebreaker's treasure for himself. |
| Tockworth's Clockworks | Tockworth's security key is a copy of a key that opens a vault containing vast wealth in another svirfneblin stronghold. Waltabeth Brambleroot (neutral evil, deep gnome [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)) hires the rivals to retrieve the key for her so she can claim the treasure. |
| Masterpiece Imbroglio | The rivals are members of a thieves' guild from a neighboring city. They seek [Constantori's Portrait](3-Mechanics/CLI/items/constantoris-portrait-kftgv.md) for Skandor Torreth (neutral, human [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)), a guildmaster who needs information only the portrait knows. |
| Axe from the Grave | Zarthine Delthion (neutral, human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), the daughter of the wizard who gave Frody the Canaith mandolin, believes the instrument is rightfully hers. She hires the rivals to retrieve it. |
...
| Shard of the Accursed | Everett Stillwater (neutral evil, human [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)) hires the rivals to steal the shard the characters seek to return to the tomb. He believes he can break the shard's curse and sell it on the black market for a high price. |
| Heart of Ashes | Barolophine (neutral evil, elf [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) hires the rivals to recover the heart of Jhaeros, a focus item the archmage needs to fuel her journey to become a lich. |
...
| Party at Paliset Hall | The [adult black dragon](3-Mechanics/CLI/bestiary/dragon/adult-black-dragon-xmm.md) Inkscale, one of Zorhanna's oldest and bitterest enemies, hires the rivals to steal the [shard solitaire](3-Mechanics/CLI/items/shard-solitaire-kftgv.md) out of spite. |
| Fire and Darkness | Vrakir's jilted lover Zaltima, an [efreeti](3-Mechanics/CLI/bestiary/elemental/efreeti-xmm.md), hires the rivals to steal the [Book of Vile Darkness](3-Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) for her. |
^rival-crew-motivations
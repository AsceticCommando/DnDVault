...
![The city of Ghalasine lies in ruins, but it's not too late to undo the damage and set things right](file://adventure/KftGV/074-10-001.ch10-splash.webp#center)

## Adventure Background

![](file://adventure/KftGV/075-10-002.ch10-key.webp#center)
...
Unaware of Charmayne's magical hold over the king but afraid for his well-being, Naevys sought the counsel of a mage's guild in a neighboring city. With the help of [scrying](3-Mechanics/CLI/spells/scrying-xphb.md) spells, the mages gleaned the truth and revealed Charmayne's treachery to Naevys. The loyal captain returned to Ghalasine at once but found herself unable to enter the city. Charmayne had anticipated Naevys's return and prepared accordingly by invoking a powerful ward that prevents anyone born in Ghalasine from entering or leaving the city.
...
Naevys (lawful good, elf [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) equipped with a [flame tongue longsword](3-Mechanics/CLI/items/flame-tongue-xdmg.md)) approaches the characters with important business from Ghalasine. Her bronze-and-red armor gleams in tones that reflect her braided red-brown hair, and her skin is freckled. She is friendly toward the characters and asks to speak with them privately:
...
- **Ashen Defenders.** Castle Cinis is guarded by ashen creatures that used to be the king's guards. The king's dogs, Cinnabar and Sol, have become [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) that wander the castle's interior.  
...
![Map 10.1: Players' Map](file://adventure/KftGV/076-10-003.player-map.webp#center)
...
> [!gallery]
> ![Map 10.2: DM's Map](file://adventure/KftGV/077-map-10.02-dms-map.webp#gallery)
> ![Player Version](file://adventure/KftGV/078-map-10.02-dms-map-player.webp#gallery)
...
Characters can cross this hall safely if they are wearing the uniforms of castle guards. Otherwise, any attempt by them to cross the hall causes magical flames to fill three of the suits of armor, which spring to life as three [helmed horrors](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md). These helmed horrors also animate if anyone touches one of the suits of armor. The helmed horrors' Spell Immunity trait grants them immunity to [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md), [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), and [scorching ray](3-Mechanics/CLI/spells/scorching-ray-xphb.md) spells.
...
The hounds were once Jhaeros's beloved dogs, Cinnabar and Sol, now transformed into [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md). The hounds' names are written on their collars in Common. They obey only [King Jhaeros](3-Mechanics/CLI/bestiary/npc/king-jhaeros-kftgv.md), and they transform back into friendly mastiffs if the effects of Charmayne's ritual are undone.
...
Charmayne trapped a drow diplomat named [Jalynvyr Nir'Thinn](3-Mechanics/CLI/bestiary/npc/jalynvyr-nirthinn-kftgv.md) in the fireplace, from which he can't escape until Charmayne's ritual is undone. While trapped in the fireplace, Jalynvyr manifests as a [smoke mephit](3-Mechanics/CLI/bestiary/elemental/smoke-mephit-xmm.md) that speaks Common and Elvish instead of Auran and Ignan. The mephit is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained), and this condition can't be ended on it so long as Jalynvyr remains trapped. If the mephit is reduced to 0 hit points, Jalynvyr dies as the mephit's smoky form disperses.
...
- **Gift for the King.** "I delivered a [flame tongue longsword](3-Mechanics/CLI/items/flame-tongue-xdmg.md) to [King Jhaeros](3-Mechanics/CLI/bestiary/npc/king-jhaeros-kftgv.md), who then bequeathed it to his most loyal captain, Naevys, as thanks for her years of faithful service. Charmayne was furious that Jhaeros wasted coin on a sword for Naevys, but then, she was always distracted by one petty jealousy or another."  
...
If [King Jhaeros](3-Mechanics/CLI/bestiary/npc/king-jhaeros-kftgv.md)'s heart is taken from the city of Ghalasine or if Charmayne is killed, Jalynvyr reverts to his true form (that of a lawful neutral, drow [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)) and is no longer [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by the fireplace. The next time he encounters the characters, he gives them one or more potions or [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) as gifts for saving his life.
...
Two elementals made of swirling ash and smoke (use the [air elemental](3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md) stat block) materialize and attack characters who enter this room. The elementals use their Whirlwind action to hurl characters through the castle's weakened walls (see "General Features" earlier in the adventure). It's a 20-foot drop to the ground from there.
...
Among the many items on display is a [+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md) Jhaeros wielded in his youth.
...
![A daring adventurer leaps to a floating tower that has detached from Castle Cinis](file://adventure/KftGV/079-10-004.dnd-platforming.webp#center)
...
Characters who search the armory find a [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md), eight [+1 arrows](3-Mechanics/CLI/items/1-ammunition-xdmg.md), and two vials that each contain one use of [oil of sharpness](3-Mechanics/CLI/items/oil-of-sharpness-xdmg.md). All other equipment in the armory turns to ash when handled.
...
![King Jhaeros](file://adventure/KftGV/080-10-005.king-jhaeros.webp#center)

[King Jhaeros](3-Mechanics/CLI/bestiary/npc/king-jhaeros-kftgv.md) is hostile and uses the [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) stat block, with these changes:
...
- **The Void Collapses.** The void above Castle Cinis collapses, freeing all the souls trapped within it. Everyone whose soul was trapped inside the void is restored to life with all their hit points, materializing in unoccupied spaces within the city. Characters whose souls are released from the void are deposited in area S9, as is [King Jhaeros](3-Mechanics/CLI/bestiary/npc/king-jhaeros-kftgv.md) (lawful good, human [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) and Councilor Regine LaVerne (lawful neutral, tiefling [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)).  
...
- **The Hounds Are Restored.** The hell hounds Cinnabar and Sol transform back into friendly [mastiffs](3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md).  
...
- **Naevys's Gifts.** If Charmayne's ritual is reversed and Ghalasine is restored, Naevys gives the characters a [flame tongue longsword](3-Mechanics/CLI/items/flame-tongue-xdmg.md), a [necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md), and a suit of [dragon scale mail](3-Mechanics/CLI/items/dragon-scale-mail-xdmg.md) from Ghalasine's treasury. She also gives the characters 2,000 gp each from her personal savings. If the characters end the ritual but fail the undo the damage it caused, Naevys awards them the money but not the magic items.  

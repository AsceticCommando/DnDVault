...
![An unearthed tomb holds the key to saving a nearby town, as adventurers are about to discover](file://adventure/KftGV/066-09-001.ch9-splash.webp#center)

## Adventure Background

![](file://adventure/KftGV/067-09-002.ch9-key.webp#center)
...
Leandro (chaotic good [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) is a tabaxi—a Humanoid with feline features, including claws and a tail. He's short and stout, with lush, sand-colored fur and thin whiskers. Tiny square glasses frame his amber eyes. He was born in a distant land but has been traveling abroad for nearly twenty years. He arrived in Oztocan a few months ago and is working on a play inspired by the town's local legends. As a playwright, he often draws inspiration from history.
...
![Map 9.1: Players' Map](file://adventure/KftGV/069-09-004.players-map.webp#center)
...
The ten [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) guarding the tunnel entrance are loyal to Aminta and attack anyone who tries to enter the tunnel without an escort. If the characters come here in the guise of workers, five of the guards lead them to area X1 at the start of the next shift change, which occurs whenever you deem appropriate.
...
- **Light.** Areas X2, X3, X4, and X21 are brightly lit by torches imbued with [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells. The rest of the tomb is dark. Members of the Onyx Scar use oil lamps to light their surroundings. Area descriptions assume the characters have a light source or other means of seeing in the dark.  
...
> [!gallery]
> ![Map 9.2: DM's Map](file://adventure/KftGV/070-map-9.02-dms-map.webp#gallery)
> ![Player Version](file://adventure/KftGV/071-map-9.02-dms-map-player.webp#gallery)
...
If the characters arrive here under the pretext of pretending to be workers, their armed escort (five [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) leads them through the iron doors into area X2.
...
This antechamber once welcomed pilgrims wishing to pay their respects to Xeluan, but the Onyx Scar has converted it into a guard post. The guards stationed here are four [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
Four Onyx Scar [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) stand behind the western arrow slits, ready to shoot their crossbows at intruders who traverse the hallway without an Onyx Scar escort. The arrow slits give the thugs three-quarters cover.

No guards are stationed behind the eastern arrow slits.

![The statue of a giant braces the ceiling in Xeluan's Tomb](file://adventure/KftGV/072-09-005.statue-of-giants-braces.webp#center)
...
Roll `dice:1d6+3|noform|noparens|avg` (`1d6 + 3`) to determine how many workers ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) are here when the characters arrive. One of the workers acts as an overseer. If the characters are pretending to be workers, the overseer gives them tasks as the other workers retire to area X12 for some much-needed rest.
...
The room is lightly obscured by clouds of spores. The Order of Xeluan used to harvest mushrooms from the garden, which is now the home of two [myconid sovereigns](3-Mechanics/CLI/bestiary/plant/myconid-sovereign-xmm.md), four [myconid adults](3-Mechanics/CLI/bestiary/plant/myconid-adult-xmm.md), and a [shambling mound](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md). These creatures lurk amid the garden's vegetation. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher see the creatures.
...
The stairs in the garden ascend to a trapdoor that Edino (see area X10) has sealed with an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell. As an action, a character can use thieves' tools to try to bypass the magical lock, doing so with a successful DC 25 Dexterity check, or the character can try to force open the trapdoor, doing so with a successful DC 25 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic also opens the trapdoor, which swings upward into area X21.
...
Five Onyx Scar [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) sleep in these rooms, one per room. Each room contains a cot with an oil lamp hanging above it.
...
The door to area X10 is warded by an [alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell that mentally alerts Edino if anyone touches it.
...
The hulking figure is a [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) that doesn't wait for characters to enter the room before attacking them. It fights until destroyed.

A lawful evil, elf [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) named Edino lurks in the room. Edino is the Onyx Scar's resident spellcaster and has cast [greater invisibility](3-Mechanics/CLI/spells/greater-invisibility-xphb.md) on himself. If the characters defeat the golem, Edino hides until he can sneak to area X19 and alert Aminta.
...
A [spellbook](3-Mechanics/CLI/items/spellbook.md) on the western bookshelf contains the spells Edino has prepared plus [alarm](3-Mechanics/CLI/spells/alarm-xphb.md), [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md), [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md), [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md), and [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md). The other books in Edino's collection aren't valuable and cover such topics as geology, gemology, and mining.
...
This area is used as a mess hall for workers and low-ranking Onyx Scar members. Four [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) sit at one table, while two [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) eat snacks at the bar. As soon as they detect intruders, the thugs and veterans draw their weapons and attack.

Brego, the dwarf bartender (lawful evil [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)), is a longtime friend of Aminta's and a member of the Onyx Scar. He stands on a small crate to reach the bar's countertop. If a fight erupts, Brego ducks behind the bar and hurls flaming bottles of alcohol at intruders (treat each bottle as a [flask of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md)) unless he is stopped. The bar gives Brego three-quarters cover.
...
The women playing cards are two [doppelgangers](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) that look exactly like Aminta. If they see three or more intruders, the doppelgangers retreat to area X19; otherwise, they stand and fight.
...
A small coffer under Aminta's bed holds six [zircons](3-Mechanics/CLI/items/zircon-xdmg.md) (50 gp each). Characters who search the wine rack find two bottles of exquisite wine (100 gp each) and three bottles of fine wine (10 gp each). The remaining bottles hold common wine.
...
This room was once a library chronicling the history of Xeluan and his heroic companions. The Onyx Scar now uses it for leadership meetings. Aminta Solana (neutral evil, human [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)) claims the seat at the head of the table.
...
Aminta is meeting with two of her distribution generals ([veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)). Edino (the elf [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) from area X10) and the two [doppelgangers](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) from area X15 might be here as well.
...
An [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) floats near the ceiling and is the source of the breeze. If one or more characters disturb the supplies, the stalker attacks them. The stalker doesn't attack if the supplies are left alone.
...
The trapdoor leading to area X6 is secured with an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell. As an action, a character can use thieves' tools to try to bypass the magical lock, doing so with a successful DC 25 Dexterity check, or the character can try to wrench open the trapdoor, doing so with a successful DC 25 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic also opens the trapdoor.
...
If the characters ignore the warning and enter the crypt, four [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) emerge from the caskets that line the central wall. The wraiths don't respond to verbal entreaties and can't leave the crypt, but they attack anyone who sets foot inside.

##### Rilago's Ghost

The voice belongs to the [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) of [Rilago](3-Mechanics/CLI/bestiary/npc/rilago-kftgv.md). If the characters heed its warning and don't advance into the crypt, [Rilago](3-Mechanics/CLI/bestiary/npc/rilago-kftgv.md) materializes in front of them and strikes up a conversation:
...
![Rilago's Ghost](file://adventure/KftGV/073-09-006.rilagos-ghost.webp#center)

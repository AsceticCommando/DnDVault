...
![](file://adventure/HotDQ/037-tod-07-01.webp#center)
...
If the party lingers outside the lodge or explores the woods nearby, it finds company. Those with a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 12 or higher are not [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised) by the rush of a group of two [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) and three [ambush drakes](3-Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D for Statistics) that has been wandering the area. The combat alerts Talis that she has company. The trolls serve as the lodge's bouncers, and anyone who is not expected is eaten.
...
![Trepsin](file://adventure/HotDQ/038-tod-07-02.webp#center)
...
> [!gallery]
> ![Map 7.1: Hunting Lodge—Ground Floor](file://adventure/HotDQ/039-map-7-1-hunting-lodge.webp#gallery)
> ![Player Version](file://adventure/HotDQ/040-map-7-1-hunting-lodge-player.webp#gallery)
...
The freestanding suits of elven armor are warded with freezing runes that can be detected with a successful DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. Any character that touches one of the suits or passes between them must make a DC 15 Constitution saving throw. On a failed saving throw, the character takes `dice:1d12|noform|noparens|avg` (`1d12`) cold damage and is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) (frozen in place) for 1 minute. The character may use an action on his or her turn to make a DC 15 Strength check, ending the effect early on a success.
...
> [!gallery]
> ![Map 7.2: Hunting Lodge—Upper Floor](file://adventure/HotDQ/041-map-7-2-hunting-lodge.webp#gallery)
> ![Player Version](file://adventure/HotDQ/042-map-7-2-hunting-lodge-player.webp#gallery)
...
![Talis the White](file://adventure/HotDQ/043-tod-07-03.webp#center)
...
![Dragonclaw](file://adventure/HotDQ/044-tod-07-04.webp#center)
...
- Talis identifies the five leaders of the cult as "wyrmspeakers," each of whom has an affinity for a particular kind of chromatic dragon. The leaders' names are [Severin](3-Mechanics/CLI/bestiary/npc/severin-rot.md) the Red, [Galvan](3-Mechanics/CLI/bestiary/npc/galvan-rot.md) the Blue, [Neronvain](3-Mechanics/CLI/bestiary/npc/neronvain-rot.md) the Green, [Rezmir](3-Mechanics/CLI/bestiary/npc/rezmir-hotdq.md) the Black, and [Varram](3-Mechanics/CLI/bestiary/npc/varram-rot.md) the White.  

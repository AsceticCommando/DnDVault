...
![](file://adventure/HotDQ/045-tod-08-01.webp#center)
...
> [!gallery]
> ![Map 8.1: Parnast](file://adventure/HotDQ/046-map-8-1-parnast.webp#gallery)
> ![Player Version](file://adventure/HotDQ/047-map-8-1-parnast-player.webp#gallery)
...
![Captain Othelstan](file://adventure/HotDQ/048-tod-08-02.webp#center)
...
> [!gallery]
> ![Map 8.2: Skyreach Castle](file://adventure/HotDQ/049-map-8-2-skyreach.webp#gallery)
> ![Player Version](file://adventure/HotDQ/050-map-8-2-skyreach-player.webp#gallery)
...
Javelin. *Ranged Weapon Attack*: `dice:1d20+7|noform|noparens|text(+7)` to hit, range 120 ft./480 ft., one target. *Hit*: `dice:3d8|noform|noparens|avg|text(14)` (`3d8`) piercing damage.
...
![Rezmir](file://adventure/HotDQ/051-tod-08-03.webp#center)
...
![Rath Modar](file://adventure/HotDQ/052-tod-08-04.webp#center)
...
If he is outmatched, [Rath Modar](3-Mechanics/CLI/bestiary/npc/rath-modar-hotdq.md) turns [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible), casts [fly](3-Mechanics/CLI/spells/fly-xphb.md) on himself, touches the disappearing wall, and leaps off the landing platform, leaving [Azbara Jos](3-Mechanics/CLI/bestiary/npc/azbara-jos-hotdq.md) to fend for himself. If the gargoyle is still alive, it tries to cover Rath's escape. His [fly](3-Mechanics/CLI/spells/fly-xphb.md) spell and disappearing trick mean that an escape is very likely.
...
![Sandesyl Morgia](file://adventure/HotDQ/053-tod-08-05.webp#center)
...
![Blagothkus](file://adventure/HotDQ/054-tod-08-06.webp#center)
...
![Mask of the Dragon Queen](file://adventure/HotDQ/055-tod-08-07.webp#center)

...
![](file://adventure/HotDQ/020-tod-04-01.webp#center)
...
![Ontharr Frume](file://adventure/HotDQ/021-tod-04-02.webp#center)
...
On a trip of this length, checking for random events every hour is excessive. The Trade Way sees a lot of travelers and it is relatively (if not entirely) safe. Check for a random event each day by rolling a `dice:d20|noform|noparens|avg` (`d20`). On a roll of 16 or higher, one or more events occur as indicated below:
...
![Jamna Gleamsilver](file://adventure/HotDQ/023-tod-04-04.webp#center)

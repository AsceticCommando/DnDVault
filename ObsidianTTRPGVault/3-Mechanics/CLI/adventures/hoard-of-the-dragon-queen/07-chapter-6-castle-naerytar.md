...
![](file://adventure/HotDQ/027-tod-06-01.webp#center)
...
The Mere of Dead Men is a place filled with dangerous creatures. Roll a `dice:d20|noform|noparens|avg` (`d20`) per hour of travel; an encounter occurs on a roll of 18–20. Determine the encounter by rolling on the table below, or choose an encounter.
...
![Pharblex Spattergoo](file://adventure/HotDQ/028-tod-06-02.webp#center)
...
> [!gallery]
> ![Map 6.1: Castle Naerytar—Ground Level](file://adventure/HotDQ/029-map-6-1-castle-naerytar.webp#gallery)
> ![Player Version](file://adventure/HotDQ/030-map-6-1-castle-naerytar-player.webp#gallery)
...
The barbican is the primary defensive position for the castle. It is guarded round-the-clock by ten [bullywugs](3-Mechanics/CLI/bestiary/fey/bullywug-warrior-xmm.md) and `dice:1d6|noform|noparens|avg` (`1d6`) [giant frogs](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md). Unless a fight or other disturbance has happened somewhere, these guards are at low alertness.
...
The ground here was once hard-packed earth, but the area in front of the barracks (area 1G) has been churned into mud by flapping bullywug feet. At any particular time, there are `dice:1d6|noform|noparens|avg` (`1d6`)–1 [bullywugs](3-Mechanics/CLI/bestiary/fey/bullywug-warrior-xmm.md) and `dice:1d6|noform|noparens|avg` (`1d6`)–1 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) present in the outer ward. Lizardfolk are likely to be working (training their giant lizards), while bullywugs might be loafing or giving orders to the lizardfolk.
...
Normally, these rooms aren't used, but [Azbara Jos](3-Mechanics/CLI/bestiary/npc/azbara-jos-hotdq.md) occupies them currently. They are reasonably warm and comfortable. [Jos](3-Mechanics/CLI/bestiary/npc/azbara-jos-hotdq.md) will be here when he isn't consulting with [Rezmir](3-Mechanics/CLI/bestiary/npc/rezmir-hotdq.md) in area 1U, 2N, or 3L. [Jos](3-Mechanics/CLI/bestiary/npc/azbara-jos-hotdq.md) keeps all of his real valuables with him. The only things he leaves in these chambers are his clothes and his traveling spellbook—which contains all the spells he has prepared (see appendix D). The spellbook is locked inside a box of silver-inlaid redwood. The lock can be opened with a successful DC 15 Dexterity check, but if the roll is less than 20, the tampering sets off a magical ward with the same effect as a [Melf's acid arrow](3-Mechanics/CLI/spells/melfs-acid-arrow-xphb.md) spell; the acid arrow launches at the character who opened the box and causes `dice:4d6|noform|noparens|avg` (`4d6`) acid damage immediately plus another `dice:4d6|noform|noparens|avg` (`4d6`) acid damage at the end of the character's next turn. The damage is halved if the character makes a successful DC 15 Dexterity saving throw. Opening the box with the key disarms the trap automatically; [Jos](3-Mechanics/CLI/bestiary/npc/azbara-jos-hotdq.md) carries the key on a string around his neck.

## Second Floor

> [!gallery]
> ![Map 6.2: Castle Naerytar—Level 2](file://adventure/HotDQ/031-map-6-2-castle-naerytar.webp#gallery)
> ![Player Version](file://adventure/HotDQ/032-map-6-2-castle-naerytar-player.webp#gallery)
...
Books and manuscripts line wooden shelves constructed from salvaged lumber. One [dragonwing](3-Mechanics/CLI/bestiary/humanoid/dragonwing-hotdq.md) (see appendix D for statistics) and four [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) (initiates) spend most of their time here, organizing the books.
...
> [!gallery]
> ![Map 6.3: Castle Naerytar—Level 3](file://adventure/HotDQ/033-map-6-3-castle-naerytar.webp#gallery)
> ![Player Version](file://adventure/HotDQ/034-map-6-3-castle-naerytar-player.webp#gallery)
...
> [!gallery]
> ![Map 6.4: Castle Naerytar—Dungeon](file://adventure/HotDQ/035-map-6-4-castle-naerytar.webp#gallery)
> ![Player Version](file://adventure/HotDQ/036-map-6-4-castle-naerytar-player.webp#gallery)

...
![](file://adventure/GoS/009-02-01-chapter-2.webp#center)
...
![](file://adventure/GoS/010-02-02-module-the-sinister-secret-of-saltmarsh.webp#center)
...
The secret of the haunted house is that it is not, in fact, haunted. It is the shore base for a band of smugglers led by a wizard named [Sanbalet](3-Mechanics/CLI/bestiary/npc/sanbalet-gos.md). The eerie lights seen at night by onlookers are the smugglers' signals to a ship out at sea. The unearthly shrieks and other sounds are caused by [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spells strategically placed in the building. The smugglers, during their three years of successful operation, have through these tactics frightened away all local attempts at investigating their hideout.
...
Two [giant poisonous snakes](3-Mechanics/CLI/bestiary/beast/giant-venomous-snake-xmm.md) make their homes in the crumbled and crevice-ridden walls of the well shaft. They emerge and strike at anything that descends into the well. They also emerge if the characters linger near the well while investigating it.
...
> [!gallery]
> ![Map 2.1: Haunted House](file://adventure/GoS/011-06-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/012-06-pc.webp#gallery)
...
Inside the secret compartment, wrapped in cloth, is a glass vial containing two doses of [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
At your discretion, the smuggler in the cellar below the trapdoor might notice the [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) being triggered. In this case, the smugglers become aware of the characters and investigate or prepare themselves for the intruders; see "The Smugglers" above.
...
A [swarm of insects (spiders)](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) lurks in the crevices of the fireplace and chimney. The spiders flood forth with obvious irritation if any creatures move to within 5 feet of the fireplace.
...
Four [giant centipedes](3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) nest under the floor below the sink. They come and go through a hole in the foundation beneath the kitchen. The centipedes skitter up the drain, enter the room, and attack anyone investigating the cupboard or the sink.
...
[Sanbalet](3-Mechanics/CLI/bestiary/npc/sanbalet-gos.md) has cast a [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell on the stairs, which is triggered when anyone treads on the top step. If the spell is set off, hideous screams—as if of a soul in torment—rise from the cellar below.
...
The man on the floor is Ned Shakeshaft ([spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) (see "A Man on the Inside" in the Adventure Summary and the "Snake in the Grass" sidebar), who does a convincing job of wanting to be rescued. He has a pretty good idea where his clothes are, and will ask to be escorted to area 17 to retrieve them. Ned has no other possessions, except for a single dose of [basic poison](3-Mechanics/CLI/items/basic-poison-xphb.md) (see "chapter 5" of the "Player's Handbook") that he has concealed in the waistband of his undergarments. He can apply it to any slashing or piercing weapon as a bonus action.
...
A group of six [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) nests in the rafters of the attic. They descend on the party at an opportune moment, revealing themselves after the characters enter the attic.
...
> [!gallery]
> ![Map 2.2: Haunted House Cellar and Caverns](file://adventure/GoS/013-04-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/014-04-pc.webp#gallery)
...
The [plate mail](3-Mechanics/CLI/items/plate-armor-xphb.md) is banged up—the result of brutal clubbing and kicking—but serviceable and fits a Medium creature. The [longsword](3-Mechanics/CLI/items/longsword-xphb.md) and the [shield](3-Mechanics/CLI/items/shield-xphb.md) are in good condition. An [explorer's pack](3-Mechanics/CLI/items/explorers-pack-xphb.md), lacking the rations and water, is under the corpse.
...
If the characters avoided making undue noise in area 20, a single smuggler ([bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) is scrubbing pots in a washbasin near the stove. He tries to flee through the secret door as soon as the characters appear. Otherwise, if the smugglers have been alerted to the party's presence, two [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) and a [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) are here and ready to fight.
...
The [lantern](3-Mechanics/CLI/items/bullseye-lantern-xphb.md) is used to signal the *Sea Ghost*. Someone who makes a successful DC 10 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check realizes that the lantern is used only infrequently.
...
The alchemist wears an empty [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md) at the waist. One rib bone on each of the skeletons is dipped in gold and is worth 5 gp. The alchemist also carries a [cursed luckstone](3-Mechanics/CLI/items/cursed-luckstone-gos.md) (see appendix B).

![](file://adventure/GoS/015-02-04-skeletal-alchemist.webp#center)
...
The table holds small stacks of gold coins totaling 47 gp. Examining the table closely reveals a concealed drawer that contains the spellbook the alchemist used when he was alive. The book's contents include [dancing lights](3-Mechanics/CLI/spells/dancing-lights-xphb.md), [comprehend languages](3-Mechanics/CLI/spells/comprehend-languages-xphb.md), [Tenser's floating disk](3-Mechanics/CLI/spells/tensers-floating-disk-xphb.md), and [shatter](3-Mechanics/CLI/spells/shatter-xphb.md). The chemical apparatus on the bench is worth 20 gp.

### The Caverns

![](file://adventure/GoS/016-02-06.webp#center)
...
If the smugglers are not yet aware of the characters' presence, three [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) are resting here while they await instructions. There is nothing else of note in this area.
...
If an alarm has not been raised, two [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) and a [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) are here, stealing drinks from the store of brandy.

If the smugglers have been alerted, [Sanbalet](3-Mechanics/CLI/bestiary/npc/sanbalet-gos.md) (see appendix C and the following sidebar), one [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md), one [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), and one [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) defend this room. [Sanbalet](3-Mechanics/CLI/bestiary/npc/sanbalet-gos.md) stays clear of the melee, taking cover behind the casks in the southeast corner. The hobgoblin and the bandit try to prevent the characters from entering the room, while the scout hangs back to fire its ranged weapon.
...
[Sanbalet](3-Mechanics/CLI/bestiary/npc/sanbalet-gos.md) carries a [pipe of remembrance](3-Mechanics/CLI/items/pipe-of-remembrance-gos.md) (see appendix B) and a set of masterfully crafted loaded gaming dice (20 gp). The hobgoblin wears a suit of [mariner's armor (scale mail)](3-Mechanics/CLI/items/mariners-armor-xdmg.md).
...
A lone [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) is here if the smugglers aren't on alert.

If either of the [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spells has been triggered, a lone [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) keeps watch here (guarding against an approach by sea) and joins the fray in area 27 if it hears sounds of combat.
...
If the characters have avoided triggering either of the [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spells, the two [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) smugglers are standing guard here.
...
![](file://adventure/GoS/017-02-07.webp#center)
...
Aside from Captain Sigurd "Snake Eyes" ([pirate captain](3-Mechanics/CLI/bestiary/humanoid/pirate-captain-xmm.md); see appendix C), the crew of the *Sea Ghost* consists of the following members:
...
- 7 crew members ([bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md))  
- 3 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)  
...
> [!gallery]
> ![Map 2.3: Sea Ghost](file://adventure/GoS/018-03-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/019-03-pc.webp#gallery)
...
The two figures are Bloody Bjorn ([pirate first mate](3-Mechanics/CLI/bestiary/humanoid/pirate-first-mate-gos.md); see appendix C) and a crew member ([bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)).
...
The figure is a single crew member ([bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) watching for any signals from shore.
...
The figure leaning against the tiller is a crew member ([bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)). The others, from fore to aft, are Punketah ([pirate deck wizard](3-Mechanics/CLI/bestiary/humanoid/pirate-deck-wizard-gos.md); see appendix C), the ship's captain Sigurd "Snake Eyes" ([pirate captain](3-Mechanics/CLI/bestiary/humanoid/pirate-captain-xmm.md); see appendix C) and another crew member ([bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)). The last holds a [bullseye lantern](3-Mechanics/CLI/items/bullseye-lantern-xphb.md) that has a shutter over its lens; from time to time the crew member moves the shutter and sends out the prearranged signal.
...
A [pseudodragon](3-Mechanics/CLI/bestiary/dragon/pseudodragon-xmm.md) named Bimz sleeps in a small nest behind the chest. It is the companion of one of the lizardfolk and joins in the combat to defend its master.
...
When it is triggered, the trap releases a cloud of noxious gas in a 5-foot radius around the chest. Creatures caught in the cloud must succeed on a DC 12 Constitution saving throw or be knocked [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) for `dice:1d4|noform|noparens|avg` (`1d4`) minutes.

The chest holds items of clothing, a leather purse containing 50 gp, and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md). It also holds Punketah's spellbook, which has all the spells he has prepared recorded on its pages.

![](file://adventure/GoS/020-02-09.webp#center)
...
The first drawer contains two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), a dose of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md), and the key that unlocks the chains holding [Oceanus](3-Mechanics/CLI/bestiary/npc/oceanus-gos.md) in area 14.
...
Four crew members ([bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) under the supervision of Foul Frithoff ([pirate bosun](3-Mechanics/CLI/bestiary/humanoid/pirate-bosun-gos.md); see appendix C) are wandering about the hold, securing the cargo and taking inventory. They chat about all manner of depraved conquests as they do. Once they become aware of the party, they attack immediately.
...
10 [shields](3-Mechanics/CLI/items/shield-xphb.md)

20 [javelins](3-Mechanics/CLI/items/javelin-xphb.md)
...
A number of [rats](3-Mechanics/CLI/bestiary/beast/rat-xmm.md) eke out a precarious existence here, but they are of the normal variety and harmless. The bilge offers only 4 feet of headroom.

...
![](file://adventure/GoS/021-03-01-chapter-3.webp#center)
...
![](file://adventure/GoS/022-03-02-module-danger-at-dunwater.webp#center)
...
`dice: [](04-chapter-3-danger-at-dunwater.md#^lizardfolk-quirks)`
...
If the characters want to travel by sea, the council places at their disposal a modified [keelboat](3-Mechanics/CLI/vehicles/keelboat.md) with two pairs of oars and a step-down mast, large enough to accommodate the characters and any reasonable amount of equipment they want to take with them. Navigation and propulsion of the craft is handled by two members of the town guard ([guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)), who are assigned by the council to sail or row the boat. The guards do not disembark when the characters reach their destination, instead staying with the boat to keep it under their control and guard the party's return trip.
...
**Wave 1**. Six [bullywugs](3-Mechanics/CLI/bestiary/fey/bullywug-warrior-xmm.md) attempt to surprise the characters, leaping from the muddy water to attack.

**Wave 2**. Arrp ([bullywug croaker](3-Mechanics/CLI/bestiary/humanoid/bullywug-croaker-gos.md); see appendix C) and two [bullywugs](3-Mechanics/CLI/bestiary/fey/bullywug-warrior-xmm.md) arrive shortly after the first wave is defeated. They make a grand show of battling the characters, and Arrp grins at the king whenever he is effective in combat.

**Wave 3**. Gulpa'Gor ([bullywug royal](3-Mechanics/CLI/bestiary/humanoid/bullywug-royal-gos.md); see appendix C) arrives mounted on a [giant toad](3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) shortly after Arrp and his guards are slain.
...
> 
> **Green Slime.** Patches of [green slime](3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md) (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide") coat the overhead branches of dead trees. The slime falls on creatures passing below.
> 
...
|------|--------------------|-------|
| 2 | 5 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | These guards are alerted by noise in 1. If they are challenged, one of the guards tries to escape to 3 for help. |
| 3 | 3 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | If a guard from 2 escaped, these guards go to 2. If not, they remain here until alerted by noise nearby. |
...
| 9 | 4 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md),*1 [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) | These guards go to 7 if a commoner escapes to warn them of the characters in that room. Otherwise they remain here. |
...
| 12 | 2 [amphisbaenae](3-Mechanics/CLI/bestiary/monstrosity/amphisbaena-gos.md)*, 1 [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) | The shaman tries to flee to the west. If it does so, it races to 20 looking for help. |
| 20 | 2 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) | These lizardfolk go to 12, responding to the threat if alerted by the shaman that escaped from that area. |
| 22 | 6 [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) | The giant lizards remain here until encountered. No amount of noise or disruption will coax the reptiles elsewhere. |
| 23 | 3 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | These lizardfolk go to 22 if alerted by sounds of combat there. They go to 24 if a commoner escapes from that room and arrives here. |
...
| 26 | 5 [giant poisonous snakes](3-Mechanics/CLI/bestiary/beast/giant-venomous-snake-xmm.md) | The snakes remain here. |
| 27 | 1 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk render](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md)* | These lizardfolk move toward the gate if alerted by noise in that area. Otherwise they remain here. |
| 29 | 4 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk render](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md),*1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These lizardfolk go to 10 if a commoner escapes to warn them of the characters in that room. Otherwise they remain here. |
| 32 | 3 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These lizardfolk remain here until encountered. |
...
| 38 | [Sauriv](3-Mechanics/CLI/bestiary/npc/sauriv-gos.md) (lizardfolk [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) | The minister (noncombatant) remains here unless the characters fail to win his favor. If that happens, he tries to flee to 40. |
| 40 | 1 [lizard queen](3-Mechanics/CLI/bestiary/elemental/lizardfolk-sovereign-xmm.md), 1 [lizardfolk subchief](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-subchief-gos.md),* 2 [lizardfolk scaleshields](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md),* 1 [lizardfolk render](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md),* 8 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | These lizardfolk remain here until encountered, unwilling to jeopardize the queen's defense by leaving. |
| 42 | 3 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These guards go to the gate at 41 (north) in response to noise there. Otherwise they remain here until encountered. If that happens, one tries to flee to 44 to get reinforcements. |
| 43a | 1 [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) | The sahuagin remains here unless the characters release it. |
...
| 44 | 2 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), 1 [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These guards go to 42, 48, or 52 if alerted to the presence of characters in those areas. Otherwise they remain here until encountered. |
| 48 | 4 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | These guards go to the gate at 41 (south) in response to noise there. If they hear sounds of combat in 52, three go there and one goes to 44 for added help. |
| 49 | 4 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) | If these lizardfolk become aware of intruders, one goes to 42 and elsewhere looking for reinforcements. Another one goes to 50, 51, and 52 in succession to alert the occupants there. |
...
| 52 | 3 [merfolk](3-Mechanics/CLI/bestiary/elemental/merfolk-skirmisher-xmm.md), 1 [merfolk salvager](3-Mechanics/CLI/bestiary/humanoid/merfolk-salvager-gos.md)* | The merfolk go to 49 if alerted to the presence of intruders there, cooperating with their allies. |
^lizardfolk-roster
...
The lizardfolk patrol the corridors of their lair routinely. Unless the characters are extremely stealthy and careful, they are bound to encounter a patrol at some point. A guard patrol consists of two [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), one of which carries a torch (because the corridors are normally unlit), and one [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C).
...
> [!gallery]
> ![Map 3.1: Lizardfolk Lair](file://adventure/GoS/023-05-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/024-05-pc.webp#gallery)
...
There are three [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) in this room forming up under one officer ([lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md); see appendix C) to go on patrol in the lair.
...
10 [clubs](3-Mechanics/CLI/items/club-xphb.md)

10 [longswords](3-Mechanics/CLI/items/longsword-xphb.md)

10 [morningstars](3-Mechanics/CLI/items/morningstar-xphb.md)
...
![](file://adventure/GoS/025-03-04-banquet-hall-p73.webp#center)
...
If they have not been called elsewhere, four [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), one [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C), and one [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) prepare for patrol in this room.
...
A single [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) worships at the altar in this room. Two [amphisbaenae](3-Mechanics/CLI/bestiary/monstrosity/amphisbaena-gos.md) (see appendix C) serve as guardians here, and live within the hollow altar.
...
The carafe, cup, and incense burner are silver, worth 10 gp, 3 gp, and 5 gp respectively. The chest contains 20 gp and a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).
...
The chest contains the personal wealth of the senior shaman: a silver figure of Semuanya (25 gp), a leather bag containing 50 ep, and a [pearl of power](3-Mechanics/CLI/items/pearl-of-power-xdmg.md).
...
A [lizardfolk shaman](3-Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) is leading two disciples ([lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) in a short prayer to Semuanya.
...
The incense burner is worth 5 gp, and the silver statue is worth 50 gp. The chest contains the following items: a bolt of green velvet cloth (5 gp), a large leather sack holding 200 ep, an ivory figurine depicting Semuanya (25 gp), and a small, padded wooden box containing two doses of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md) (100 gp).
...
These items were the property of a member of a band of inexperienced adventurers who tried to penetrate the lair on their own some weeks ago and were killed in the attempt. The breastplate is too battered to perform any useful function, but the weapon is a [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md).

![](file://adventure/GoS/026-03-05-nursery-p77.webp#center)
...
Three [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) keep guard in this room, alert for unusual sounds coming from the north or south. If the guards have not moved elsewhere, they are sitting on the bench, talking and keeping their weapons near.
...
Inside the pit are five [giant poisonous snakes](3-Mechanics/CLI/bestiary/beast/giant-venomous-snake-xmm.md), which attack anything that falls in.
...
Four [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), one [lizardfolk render](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md) (see appendix C), and one [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) are in this chamber, awaiting their turn at patrol duty, if they have not been called elsewhere.
...
The bowl is made of pure electrum and is worth 50 gp. The cask contains wine—quite pleasant to the human palate. The goblet is made of silver and is worth 7 gp, and the lantern is a normal [hooded lantern](3-Mechanics/CLI/items/hooded-lantern-xphb.md).
...
When triggered, the trap fills the room with paralyzing gas. Creatures caught in the gas must succeed on a DC 10 Constitution saving throw or be [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) for `dice:1d4|noform|noparens|avg` (`1d4`) minutes. A creature can repeat the saving throw at the end of each minute.
...
[Sauriv](3-Mechanics/CLI/bestiary/npc/sauriv-gos.md) has the statistics of a lizardfolk [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md), with these changes:
...
![](file://adventure/GoS/027-03-06-sauriv-p80.webp#center)
...
[Othokent](3-Mechanics/CLI/bestiary/npc/othokent-gos.md), Irhtos ([lizardfolk subchief](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-subchief-gos.md)), and two [lizardfolk scaleshields](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) observe eight [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) and one [lizardfolk render](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-render-gos.md) as they train for battle (see appendix C for all but the [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)).

[Othokent](3-Mechanics/CLI/bestiary/npc/othokent-gos.md) is a [lizard queen](3-Mechanics/CLI/bestiary/elemental/lizardfolk-sovereign-xmm.md), with these changes:
...
Three [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) and one [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) stand guard here. Melee in this area is not heard by the occupants of area 44, but if one of the guards escapes, it goes there and calls for help.
...
Two [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) and one [lizardfolk scaleshield](3-Mechanics/CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) are seated at the table, playing a dice game for copper pieces.
...
The backpack can be discovered by a character who rifles around in the heap of cloth and makes a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. It contains 5 gp, 11 sp, a topaz (10 gp), and an [explorer's pack](3-Mechanics/CLI/items/explorers-pack-xphb.md) that has all its contents except the rations and water.
...
Four [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) are stationed here. These guards hear any sounds of melee in area 52. If this happens, three of them go immediately to that area, and the fourth goes to area 44 to summon reinforcements.
...
Four [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) hide in the seaweed of the pool.
...
![](file://adventure/GoS/028-03-07-koalinth-sergeant-p83.webp#center)
...
One [merfolk salvager](3-Mechanics/CLI/bestiary/humanoid/merfolk-salvager-gos.md) (see appendix C) and three [merfolk](3-Mechanics/CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) are beneath the algae.
...
If the party agrees to solve the tribe's crocodile problem, Queen [Othokent](3-Mechanics/CLI/bestiary/npc/othokent-gos.md) offers them a vile-tasting flask of swamp water mashed with various roots (a [potion of superior healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md)).
...
`dice: [](04-chapter-3-danger-at-dunwater.md#^marsh-random-encounters)`

| dice: d8 | Result |
|----------|--------|
| 1 | 6 hungry [giant frogs](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md) |
| 2 | 1 [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) eating crabs |
| 3 | 2 [cult fanatics](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) performing a ritual |
| 4 | 3 [swarms of insects (wasps)](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) defending their nest |
| 5 | 1 [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (evil-aligned) and two [swarms of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
| 6 | 4 [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) (not from the queen's lair) |
| 7 | 1 injured (half hit points) [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md) beset by 6 [swarms of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
| 8 | 2 [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md), lost in the marsh |
^marsh-random-encounters
...
![Thousand Teeth](file://adventure/GoS/029-03-08-thousand-teeth-p85.webp#center)
...
In addition to [Thousand Teeth](3-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md) (see appendix C) in its muddy mound, two [giant constrictor snakes](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) lurk in the canopy of vines and drop down on unsuspecting creatures that linger too long at the pool's edge. A character who has a passive Perception score of 15 or more notices the snakes before they attack.

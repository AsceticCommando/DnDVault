...
![](file://adventure/GoS/036-05-01-chapter-5.webp#center)
...
![](file://adventure/GoS/037-05-02-original-adventure-p98.webp#center)
...
The lighthouse where the characters begin the adventure is manned by a retired officer named Major Ursa. The major (LG male human [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) is a huge, barrel-chested man with a bright red beard and a circlet of thin red-gray hair on his balding head. His usual garb is a gaudy red and yellow kilt with his warhammer and dagger hanging from a broad leather belt.
...
> [!gallery]
> ![Map 5.1: Abbey Isle](file://adventure/GoS/038-26-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/039-26-pc.webp#gallery)
...
> [!gallery]
> ![Map 5.2: Skull Dunes](file://adventure/GoS/040-25-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/041-25-pc.webp#gallery)
...
If the characters enter an unmarked square, nothing happens. If they enter a square marked with a number, they are immediately attacked by that number of [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). To begin an encounter, the skeletons rise from the sand, expending half of their movement on their first turn. They are encrusted with sand but unhindered by it, so they retain their normal speed while in the dunes.
...
![](file://adventure/GoS/042-05-05-complications-on-the-dunes-p101.webp#center)
...
`dice: [](06-chapter-5-isle-of-the-abbey.md#^skull-dunes-complications)`

| dice: d6 | Event |
|----------|-------|
| 1 | Three [manticores](3-Mechanics/CLI/bestiary/monstrosity/manticore-xmm.md) that lair on a nearby coast swoop down to attack. They use the skeletons to help finish off land-based prey by landing in a square infested with them, then flying off as they emerge. |
| 2 | The surge of necromantic energy caused by the skeletons' awakening draws `dice:4d10\|noform\|noparens\|avg` (`4d10`) [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) of slain pirates out of the waters and toward the beach. |
| 3 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [swarms of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) infest the waters around the island. Having feasted on those who fell during the battle, they are eager for more fresh meat. |
| 4 | A sudden squall kicks up! The sudden driving rain causes [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) to arise in three random squares. |
| 5 | A pirate, Knife-Catcher Skeen (NE male human [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)), has hidden in a clear square in the dunes. Left for dead by his comrades, he begs the characters for help. |
| 6 | A [keelboat](3-Mechanics/CLI/vehicles/keelboat.md) with a full crew and carrying five rival treasure hunters (LE human [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) arrives at the island. The group scouted the beach earlier and now plans on luring the skeletons out of the dunes and killing them with ranged attacks. They come ashore while the characters are crossing the dunes, and then attack. |
^skull-dunes-complications
...
These three disciplined warriors ([veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) are the last of the abbey guards. All were dying of their wounds when they were found and healed by the clerics. Ozymandias has ordered them to obey Bayleaf, but the guards prefer Ogmund as their leader because he is one of them and not a hired sword. They will fight to the death to save the clerics.
...
Ozymandius and Odium try to remain in their rooms while casting spells through the doorway. Odium uses [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md) to shut down potent warriors, while Ozymandius relies on [spirit guardians](3-Mechanics/CLI/spells/spirit-guardians-xphb.md) and [spiritual weapon](3-Mechanics/CLI/spells/spiritual-weapon-xphb.md) to wear down the characters.
...
> [!gallery]
> ![Map 5.3: Abbey Ruins](file://adventure/GoS/043-24-dm.webp#gallery)
> ![Player Version](file://adventure/GoS/044-24-pc.webp#gallery)
...
Ogmund ([gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md)) and two disciples (one [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), one [cultist](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md)) sit at the table gambling.
...
Unless alerted by a commotion in area 2, one guard ([veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) is napping on a pallet.
...
If not drawn into area 2 by intruders, one disciple ([acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) is cleaning the table and floors here.
...
Until unknown voices or the sounds of battle draw his attention, Ozymandias ([priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md)) is in this room discussing survival tactics with a guard ([veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)). The room serves as Ozymandias's bedroom, office, and storeroom.
...
Ozymandius wears the special golden medallion (see the sidebar). Carefully searching under the cot reveals four [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) in fancy crystal decanters. The decanters are worth 20 gp each if empty.
...
Bayleaf ([bard](3-Mechanics/CLI/bestiary/humanoid/bard-mpmm.md)) is in this room exchanging war stories with one of the guards ([veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) unless they hear a disturbance outside. This former armory of the clerics and the abbey guards is now devoid of such contents.
...
Bayleaf's [boots of striding and springing](3-Mechanics/CLI/items/boots-of-striding-and-springing-xdmg.md) sit next to the bed. Under the loose stone are a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [silent image](3-Mechanics/CLI/spells/silent-image-xphb.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [phantasmal force](3-Mechanics/CLI/spells/phantasmal-force-xphb.md), a leather pouch containing 75 gp, and a pair of ruby earrings worth 150 gp. If the characters make a bargain with Bayleaf and convince him to leave peacefully, he takes his treasure with him.
...
Odium ([cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) now lives in this storage area and is plotting his escape. He emerges hoping that the visitors will provide an opportunity.
...
The hollow base of the medusa statue contains several items that Odium has hidden here: a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [command](3-Mechanics/CLI/spells/command-xphb.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md), a gilded tome of dark ritual incantations written in Aquan and Infernal (25 gp), and a large silver holy symbol (50 gp).
...
The desk is locked. A character who makes a successful DC 12 Dexterity check using thieves' tools can open the desk. Inside the desk are two vials of rare ink worth 25 gp each. The ink smells faintly of copper. Amid the papers and dusty ledgers on the bookshelves are a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [light](3-Mechanics/CLI/spells/light-xphb.md) and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [bless](3-Mechanics/CLI/spells/bless-xphb.md).
...
The builders placed several open pits throughout the Winding Way, each measuring 6 feet by 6 feet and with a depth of 10 feet. Covering each pit is an illusory section of floor ([major image](3-Mechanics/CLI/spells/major-image-xphb.md) cast at 6th level). A character who has a passive [Perception](3-Mechanics/CLI/rules/skills.md#Perception) score of 19 or higher notices the illusory floor shimmering slightly. A creature that falls into the pit takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) acid damage from the pool of corrosive slime at the bottom. A character who remains in the pit at the end of their turn takes this damage again. A character must make a successful DC 10 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to climb out of the pit because of the slick slime and moss growing on its sides.
...
![](file://adventure/GoS/045-05-07-floor-trap-p108.webp#center)
...
Two [minotaur skeletons](3-Mechanics/CLI/bestiary/undead/minotaur-skeleton-xmm.md), two [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md), and a [bodak](3-Mechanics/CLI/bestiary/undead/bodak-mpmm.md) (see appendix C) guard this area. The undead attack until they are destroyed or the intruders have been driven away. They pursue intruders throughout the tunnels but do not leave the Winding Way. Once any intruders have been killed or driven back through the door of the room, the undead return to their original positions.
...
One [ogre zombie](3-Mechanics/CLI/bestiary/undead/ogre-zombie-xmm.md), two [ghasts](3-Mechanics/CLI/bestiary/undead/ghast-xmm.md), and one [minotaur living crystal statue](3-Mechanics/CLI/bestiary/construct/minotaur-living-crystal-statue-gos.md) (see appendix C) guard this area.
...
The walls in this area are under the effects of a [major image](3-Mechanics/CLI/spells/major-image-xphb.md) spell (cast at 6th level) and appear to be made of solid iron.
...
Treasure. If the characters overcome the statues and search the bags, chests, and urns, they find 480 gp and 1,200 sp. Another 1,000 gp in gems and jewelry can be found in the urns. A large chest in the northwest corner contains five bolts of rare silk worth 100 gp each, two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md), and a suit of Medium [mithral armor](3-Mechanics/CLI/items/mithral-armor-xdmg.md) (your choice of type).

...
![](file://adventure/RtG/001.webp#center)
...
![](file://adventure/RtG/002.webp#center)
...
![Map 1](file://adventure/RtG/003.webp#center)
...
The bust of the icy countenance of Ganash, Tusk of the North scowls from the wall. A thin layer of frost covers the trophies kept here, which include human-crafted arrows, a [silvered elven warhammer](3-Mechanics/CLI/items/silvered-weapon-xdmg.md), and a variety of gnomish polyhedral objects covered in numbers ranging from 1 to 20.
...
The pillars are covered in geometric patterns, but have no hidden function. They aren't connected to the ceiling, and can be pushed over with a successful DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. A creature hit by a falling pillar takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) bludgeoning damage.
...
The statue at the end of the central hallway wears +1 leather armor and wields a [silvered battleaxe](3-Mechanics/CLI/items/silvered-weapon-xdmg.md). If a character wears both of these pieces in view of the statue, they gain inspiration; this effect only happens once.
...
![Map 2](file://adventure/RtG/004.webp#center)
...
![Map 3](file://adventure/RtG/005.webp#center)
...
The creature begins stalking the characters once they enter—the characters see and hear the junk shuffling around. It attacks after `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) rounds. Using an action to bang gong loudly causes the otyugh to dive beneath a tall pile of junk and lie still for 1 minute.
...
This old guardroom was enchanted to help the guards recuperate rapidly after combat. Anyone who finishes a short rest here recovers an additional `dice:1d6|noform|noparens|avg` (`1d6`) hit points.
...
The western door has a silver plaque with "Beware!" engraved on it. The door is protected by an [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) ward, and anyone who touches it without saying "Hail the Overlox!" must make a DC 15 Constitution saving throw, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) force damage on a failed save, or half as much on a successful one.
...
![Map 4](file://adventure/RtG/006.webp#center)
...
![Map 5](file://adventure/RtG/007.webp#center)
...
Frug, a gnome [mummy](3-Mechanics/CLI/bestiary/undead/mummy-xmm.md), has no interest in fighting. They asked to be mummified in order to take care of the clockwork creatures found while exploring here. Frug hides next to the portcullis leading to area 39 (the portcullis is open), with two [iron cobras](3-Mechanics/CLI/bestiary/construct/clockwork-iron-cobra-mpmm.md) (see appendix A) as guards. The [bronze scouts](3-Mechanics/CLI/bestiary/construct/clockwork-bronze-scout-mpmm.md) (see appendix A) use their Lightning Flare to warn the gnome mummy that the characters are coming closer. They engage in a delaying tactic while the [iron cobras](3-Mechanics/CLI/bestiary/construct/clockwork-iron-cobra-mpmm.md) move up and Frug flees to the stairway in area 39.
...
![Map 6](file://adventure/RtG/008.webp#center)
...
![](file://adventure/RtG/009.webp#center)
...
![Map 7](file://adventure/RtG/010.webp#center)
...
![Map 8](file://adventure/RtG/011.webp#center)
...
![](file://adventure/RtG/012.webp#center)
...
![Map 9](file://adventure/RtG/013.webp#center)
...
- They carry greataxes with a `dice:1d20+5|noform|noparens|text(+5)` to hit which deal `dice:1d12+3|noform|noparens|avg|text(9)` (`1d12 + 3`) slashing damage.  
...
![Map 10](file://adventure/RtG/014.webp#center)
...
- Great Claw is Large and has `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) hit points.  
...
- They are Large and have `dice:9d10+27|noform|noparens|avg|text(76)` (`9d10 + 27`) hit points each.  
...
Torin cast a ward on his [shield guardian amulet](3-Mechanics/CLI/items/shield-guardian-amulet-idrotf.md) that makes it crumble to dust if it is removed from his body. His spellbook contains all the spells he has prepared.
...
![Map 11](file://adventure/RtG/015.webp#center)

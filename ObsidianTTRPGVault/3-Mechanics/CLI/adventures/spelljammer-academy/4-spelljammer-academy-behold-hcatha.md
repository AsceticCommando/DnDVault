...
![](file://adventure/SjA/036-03-001.sja-04-splash.webp#center)
...
![](file://adventure/SjA/037-03-002.bag-of-holdingh.webp#center)
...
![](file://adventure/SjA/038-03-003.boatswain-tarto.webp#center)
...
![](file://adventure/SjA/039-03-004.sarthe-abizjn.webp#center)
...
![Spindle Cavern Map](file://adventure/SjA/040-03-009.spindle-cavern.webp#center)
...
![](file://adventure/SjA/041-03-005.orlob-spectator.webp#center)
...
Qitru, a [githyanki warrior](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md), rides a [star lancer](3-Mechanics/CLI/bestiary/celestial/star-lancer-mcv1sc.md). The star lancer used Invisibility Cloak to approach the tyrant ship unseen.
...
![](file://adventure/SjA/042-03-006.star-lancer.webp#center)
...
If a character uses the [sending stone](3-Mechanics/CLI/items/sending-stones-xdmg.md) to request help from Boatswain Tarto, she says, "I'll be right there!" and heads to the Hollow Deck. Tarto is armed with a musket (`dice:1d20+7|noform|noparens|text(+7)` to hit) that deals `dice:1d12+3|noform|noparens|avg` (`1d12 + 3`) piercing damage on a hit.
...
The damselfly ship has a crew of four [giff shipmates](3-Mechanics/CLI/bestiary/humanoid/giff-shipmate-bam.md) and four [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) (not including Qitru). As the tyrant ship moves away from the asteroid, the damselfly's canny giff captain, Mustaf Shultz, instructs the ship's spelljammer, a githyanki named Nalvoor, to follow the tyrant ship to Toril while keeping a safe distance.
...
The two [giff shipmates](3-Mechanics/CLI/bestiary/humanoid/giff-shipmate-bam.md) have orders to secure the *Flighty Foundling* while an extraction team retrieves Miken, dead or alive. The giff give the characters a chance to flee the vessel. If the characters stand their ground, the giff hurl grenades at them before closing to melee range.
...
> [!gallery]
> ![Hammerhead Ship Map](file://adventure/SjA/043-map-3.02-hammerhead.webp#gallery)
> ![Player Version](file://adventure/SjA/044-map-3.02-hammerhead-player.webp#gallery)

##### Shipboard Weapons

The ballista on the forecastle takes 1 action to load, 1 action to aim, and 1 action to fire. A ballista bolt (`dice:1d20+6|noform|noparens|text(+6)` to hit) deals `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) piercing damage on a hit. The hammerhead ship's mangonels are undergoing maintenance and have no ammunition available.

##### Shoved Overboard

A creature that is pushed over the edge of the ship must succeed on a DC 10 Dexterity saving throw to grab hold of the side of the ship. On a failure, the creature plunges down to the water 400 feet below, taking `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage.
...
One of the dead giff's grenades was primed but not released when the giff died at the bend in the corridor. At the end of each turn in combat, roll a `dice:d6|noform|noparens|avg` (`d6`). On a 6, the grenade rolls from the giff's hand and goes off. Each creature within a 20-foot-radius area of the bend in the south end of the corridor must make a DC 17 Dexterity saving throw, taking `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) force damage on a failed save, or half as much damage on a successful one.
...
![](file://adventure/SjA/045-03-007.githyanki-warrior.webp#center)
...
![](file://adventure/SjA/046-03-008.star-moth-splash.webp#center)
...
> [!gallery]
> ![Spelljammer Academy Handout](file://adventure/SjA/047-map-1.01-spelljammer-academy.webp#gallery)
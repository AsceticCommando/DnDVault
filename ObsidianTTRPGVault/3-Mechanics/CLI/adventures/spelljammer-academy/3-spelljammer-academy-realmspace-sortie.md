...
![](file://adventure/SjA/024-02-001.sja03-splash.webp#center)
...
![](file://adventure/SjA/025-02-002.tyrant-splash.webp#center)
...
![Tyrant Ship Deck Plans](file://adventure/SjA/026-02-011.tyrant-ship-without-notes.webp#center)
...
Petty Officer Ryeback keeps a weather eye on the characters and serves mostly in an advisory role throughout the mission. Feel free to use him as a means of providing hints and guidance. If the characters get over their heads in a fight, Petty Officer Ryeback can back them up at range, using his musket. He uses the [giff](3-Mechanics/CLI/bestiary/humanoid/giff-mpmm.md) stat block (see "Creature Statistics" later in the adventure), though his Longsword attacks are made with a giant cleaver that deals the same amount of damage.

![](file://adventure/SjA/027-02-002.o-winston-ryeback.webp#center)
...
> *Giff Galley Cook*
> 
> Petty Officer Ryeback (RIE-bak) is a muscular [giff](3-Mechanics/CLI/bestiary/humanoid/giff-mpmm.md) in charge of the food served at the Academy (and on the rare occasion, he crews a ship). Like anyone else who runs a respectable galley, he's a staunch believer in the four basic food groups: beans, bacon, whiskey, and lard. He's raucous and brash and gives bear hugs so good you think he might break a rib (but in a good way). His gray skin is usually coated with light sheen of sweat; kitchens are hot!
> 
...
- [Hammers](3-Mechanics/CLI/items/hammer.md) (1 per character)  
- 100 [pitons](3-Mechanics/CLI/items/piton.md)  
- 5 100-foot lengths of hempen rope  
- 2 [mess kits](3-Mechanics/CLI/items/mess-kit.md)  
- Portable cooking surface  
- 2 [barrels](3-Mechanics/CLI/items/barrel-xphb.md) of water  

- 5 [flasks](3-Mechanics/CLI/items/tankard.md) of cooking oil  
...
![](file://adventure/SjA/028-02-003.o-miken-haverstance.webp#center)
...
![](file://adventure/SjA/029-02-005.krik-lit.webp#center)
...
![](file://adventure/SjA/030-02-006.pffred.webp#center)
...
Three [clockwork horrors](3-Mechanics/CLI/bestiary/construct/clockwork-horror-mcv1sc.md) are methodically salvaging pieces and parts from dead autognomes to construct a fourth clockwork horror, which is only half assembled. Once these creatures notice the characters, read or paraphrase the following:
...
![](file://adventure/SjA/031-02-007.wizpop.webp#center)
...
![](file://adventure/SjA/032-02-008.clockwork-horror.webp#center)
...
![](file://adventure/SjA/033-02-009.magma-mephit.webp#center)
...
![Realmspace Map](file://adventure/SjA/034-02-012.realmspace.webp#center)
...
![](file://adventure/SjA/035-02-010.tyrant-ship-with-notes.webp#center)

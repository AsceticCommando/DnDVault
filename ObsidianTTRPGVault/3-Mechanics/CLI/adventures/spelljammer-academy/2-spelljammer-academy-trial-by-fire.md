...
![](file://adventure/SjA/012-02-001.o-sja02-splash.webp#center)
...
![](file://adventure/SjA/013-02-002.o-winston-ryeback.webp#center)
...
![](file://adventure/SjA/014-02-003.o-miken-haverstance.webp#center)
...
![](file://adventure/SjA/015-02-004.o-boatswain-tarto.webp#center)
...
![](file://adventure/SjA/016-02-005.o-sarthe-abizjn.webp#center)
...
![](file://adventure/SjA/017-02-006.o-mister-blip.webp#center)
...
![](file://adventure/SjA/018-02-007.o-swashbuckling-splash.webp#center)
...
Using the side initiative variant rules from "chapter 9" of the "Dungeon Master's Guide", the players roll a `dice:d20|noform|noparens|avg` (`d20`) for their initiative as a group, and you roll a `dice:d20|noform|noparens|avg` (`d20`) for the githyanki aboard the enemy ship. Neither roll takes any modifiers.
...
Each character must make a DC 13 Dexterity saving throw, taking `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) lightning damage on a failed save, or half as much damage on a successful one.
...
![Hammerhead Printout](file://adventure/SjA/hammerhead-printout.webp#center)

![](file://adventure/SjA/019-02-008.o-hammerhead-splash.webp#center)
...
![](file://adventure/SjA/020-02-009.o-scoring-sheet-handout.webp#center)
...
![](file://adventure/SjA/021-02-010.o-squid-splash.webp#center)

### Appendix C: Squid Ship Map

> [!gallery]
> ![Squid Ship Map](file://adventure/SjA/022-map-2.01-squid.webp#gallery)
> ![Player Version](file://adventure/SjA/023-map-2.01-squid-player.webp#gallery)
...
![](file://adventure/SjA/000-01-001.o-sja01-splash.webp#center)
...
![Forecastle Map](file://adventure/SjA/001-01-009.o-forecastle.webp#center)
...
| 14 | A second spelljamming ship soars overhead, raining arrows down on the defenders. Each character must roll a `dice:d20\|noform\|noparens\|avg` (`d20`). On a roll of 1–9, they are targeted by an arrow (`dice:1d20+3\|noform\|noparens\|text(+3)` to hit, 3 piercing damage on a hit). |
...
| 17 | The ship's dog, Bruno, rushes to the aid of a character of the player's choosing. The character can use a reaction to sip once from the healing keg around Bruno's neck (no action required), regaining `dice:1d6\|noform\|noparens\|avg` (`1d6`) hit points. |
| 18–20 | An allied sailor on the main deck fires an arrow at a reaver (`dice:1d20+3\|noform\|noparens\|text(+3)` to hit, 5 piercing damage on a hit). |
^battle-events
...
![](file://adventure/SjA/002-01-002.o-boatswain-tarto.webp#center)
...
![Handout 2.1](file://adventure/SjA/003-01-007.o-orientation-tasks.webp#center)
...
![Handout 2.2](file://adventure/SjA/004-01-008.o-warning.webp#center)
...
Veena and the other cadets use the [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) stat block but carry no weapons. Instead, they make unarmed attacks (`dice:1d20+3|noform|noparens|text(+3)` to hit, 2 bludgeoning damage on a hit). Anyone reduced to 0 hit points by such attacks is knocked [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) for 5 minutes but doesn't make death saving throws. Veena and her friends flee if they take 2 or more damage in total.
...
![](file://adventure/SjA/005-01-003.o-sky-dock.webp#center)
...
![](file://adventure/SjA/006-01-004.o-sarthe-abizjn.webp#center)
...
![](file://adventure/SjA/007-01-005.o-mister-blip.webp#center)
...
![Mirt's Quarters](file://adventure/SjA/008-01-010.o-mirts-quarters.webp#center)
...
Close inspection of the map on the table reveals that it is set with tiny figurines representing troops. The figurines magically animate whenever a creature moves within 5 feet of the table, playing out a mock battle between giants and dragons. Disturbing the battle is dangerous, though. Anyone who touches the table or a figurine is targeted by tiny catapults (`dice:1d20+4|noform|noparens|text(+4)` to hit; 3 bludgeoning damage on a hit). After making three such attacks, the catapults run out of ammunition.
...
![](file://adventure/SjA/009-01-006.o-neogi-hatchlings.webp#center)
...
> [!gallery]
> ![Spelljammer Academy](file://adventure/SjA/010-map-1.01-spelljammer-academy.webp#gallery)
> ![Player Version](file://adventure/SjA/011-map-1.01-spelljammer-academy-player.webp#gallery)
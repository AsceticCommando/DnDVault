...
![](file://adventure/LR/001-9ogdg-lr-002.webp#center)
...
> [!gallery]
> ![Map 1: Umberlee's Maw](file://adventure/LR/002-rkwsk-lr-004.webp#gallery)
> ![Player Version](file://adventure/LR/003-hbo0x-lr-004-player.webp#gallery)
...
There are four padlocks keeping the grate bolted down. Each grate can be opened with a successful DC 15 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md). Three of the four must be unlocked in order to open the grate wide enough for the characters to pass through.
...
If all of the corpses are thoroughly searched, they have a combined stash of 250 gp and 500 sp. Additionally, there are `dice:1d10|noform|noparens|avg` (`1d10`) pearls (worth 25 gp each) that adorn various earrings, necklaces, and the odd bellybutton piercing.
...
At the moment, [Amble](3-Mechanics/CLI/bestiary/npc/amble-lr.md) is waiting for someone to wake them up. Any good-aligned character who touches the tortle will wake them. When this occurs, [Amble](3-Mechanics/CLI/bestiary/npc/amble-lr.md) is momentarily confused, and then gathering their wits, casts [water breathing](3-Mechanics/CLI/spells/water-breathing-xphb.md) on themself.
...
> 
> **Ballistae Trap.** Ranged Weapon Attack: `dice:1d20+8|noform|noparens|text(+8)` to hit, range 120/480 ft., one or two targets. Hit: `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) piercing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) poison damage, and the target must succeed on a DC 12 Constitution saving throw or contract [bluerot](3-Mechanics/CLI/rules/diseases.md#Bluerot) (see the "Bluerot" sidebar). This attack can't gain advantage or disadvantage.
^ballistae-trap
...
![](file://adventure/LR/005-pmamp-lr-005.webp#center)
...
![](file://adventure/LR/006-4te04-lr-006.webp#center)

Otherwise, as the characters pass between (or into) areas 8 and 9, one of the kraken priests triggers the ballistae trap, firing both siege weapons simultaneously, while the other casts [Evard's black tentacles](3-Mechanics/CLI/spells/evards-black-tentacles-xphb.md), effectively blocking off the entrance to area 10. On the following round, the other kraken priest will also cast [Evard's black tentacles](3-Mechanics/CLI/spells/evards-black-tentacles-xphb.md), and the two of them will proceed to do whatever they can (such as casting command) to keep the characters caught up in those spell areas.

Once the characters emerge from those areas, or manage to remove the spells altogether, the kraken priests cast [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md) and then move to use their thunderous touch attack, as they have no choice but to engage in melee combat.
...
Lastly, there is a [periapt of wound closure](3-Mechanics/CLI/items/periapt-of-wound-closure-xdmg.md) and a [gem of seeing](3-Mechanics/CLI/items/gem-of-seeing-xdmg.md) amidst the rest of the hoard.
...
When a character crosses the threshold of the bulkhead between the back and the front of the ship, the trap is triggered. When that occurs, refer to the "Olhydra's Gambit" sidebar. [Dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md), successfully cast against a 6th level spell, suppresses this trap for 1 minute.
...
> 
> As the characters are being grappled, a freezing fog fills the inside of the ship. Creatures and objects within or beyond the fog are heavily obscured. A creature that enters the freezing cloud for the first time on a turn or starts its turn there takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) cold damage, and its speed is reduced by 10 feet.
> 
...
![](file://adventure/LR/007-ugyzu-lr-007.webp#center)
...
Shoalar is already under the effect of the [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md) spell when the characters arrive. He begins combat by casting [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md), affecting as many characters as possible. He's likely to follow up with [watery sphere](3-Mechanics/CLI/spells/watery-sphere-xge.md) to restrain troublesome characters so the water elemental myrmidons can attack while they're [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained).

#### Treasure

Shoalar possesses a [bowl of commanding water elementals](3-Mechanics/CLI/items/bowl-of-commanding-water-elementals-xdmg.md). If the characters defeat him, they'll find it on his person. If they befriend him, he'll offer it to them as assistance in the fight to come.
...
With the exception of anyone under the effect of a [nondetection](3-Mechanics/CLI/spells/nondetection-xphb.md) spell, Gar is aware of every inhabitant within the coral mountain and has been tracking the characters' progress through his domain. While he doesn't know precisely what they've accomplished, outside of any creatures they might have killed or destroyed, he is ready for their arrival.
...
![](file://adventure/LR/008-lb7ay-lr-008.webp#center)
...
In both instances, Gar teleports using the coral as a means of transport, similar to the tree stride spell. He casts no spell to do this, so [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md) cannot be used to prevent his departure.
...
When Gar leaves this area, the [sea lions](3-Mechanics/CLI/bestiary/monstrosity/sea-lion-tftyp.md) attack the characters, and the entire room is flooded with magic that acts like an [entangle](3-Mechanics/CLI/spells/entangle-xphb.md) spell of massive proportions.
...
A character who successfully casts [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) against a 6th level spell suppresses this effect for 1 minute.
...
It's possible to push through the coral, but doing so requires a successful DC 18 Dexterity saving throw. A creature who fails this saving throw takes `dice:7d8|noform|noparens|avg` (`7d8`) slashing damage, or half as much on a success. The wall is 5 feet thick and every 1 foot costs 5 feet of movement. Characters stuck in the wall are considered restrained until they push through, and are required to make the above Dexterity saving throw on their turn each round.
...
> 
> **Round 1.** Not suspecting treachery, the kraken priests aren't prepared when Gar casts [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) as a 2nd level spell, charming them both.
> 
> **Round 2.** Gar and the two priests swim to area 6, outside the range of the young kraken's telepathy.
> 
> **Round 3 (and 4).** If the drowned ascetics are still in area 6, they attack the kraken priests. If the characters destroyed the drowned ascetics in this area, Gar will require an additional round to slay both in melee combat using his claw and [Wave](3-Mechanics/CLI/items/wave-xdmg.md).
> 
> **Round 4.** Gar swims back.
> 
> **Round 5.** Upon returning to the young kraken, Gar casts [charm monster](3-Mechanics/CLI/spells/charm-monster-xphb.md) on the creature. It fails its saving throw and believes Gar to be a friend.
> 
> **Round 6.** Gar surprises the [kraken](3-Mechanics/CLI/bestiary/monstrosity/young-kraken-lr.md), hitting it twice with [Wave](3-Mechanics/CLI/items/wave-xdmg.md) before the creature can react, and achieving a critical hit both times. The kraken is slain, and Gar begins the process of drawing blood from the creature, storing it in massive five-gallon bladders he brought along for this purpose.
...
> 
> **Round 1.** Gar activates the [cube of force](3-Mechanics/CLI/items/cube-of-force-xdmg.md) function on [Wave](3-Mechanics/CLI/items/wave-xdmg.md), so that living creatures may not harm approach him. [Fhenimore](3-Mechanics/CLI/bestiary/npc/fhenimore-lr.md) and [Whymsee](3-Mechanics/CLI/bestiary/npc/whymsee-lr.md) will both cast lightning bolt on Gar, who will succeed at on only one saving throw only, but then use his Legendary Resistance feature to save on the other. Gar takes 28 hit points lightning damage.
> 
> **Round 2.** Gar casts [conjure animals](3-Mechanics/CLI/spells/conjure-animals-xphb.md) as a 7th level spell, summoning six [swarms of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) and directing them to slay and consume the kraken priests.
> 
...
> 
> **Round 5.** Gar casts [freedom of movement](3-Mechanics/CLI/spells/freedom-of-movement-xphb.md), escaping the grapple, and then uses a legendary action to attack the creature. He will score a critical hit, slaying the kraken.
> 
> **Round 6.** Gar casts [heal](3-Mechanics/CLI/spells/heal-xphb.md) on himself, bringing him back to his hit point maximum, and begins the process of drawing blood from the kraken, storing it in massive five-gallon bladders he brought along for this purpose.
...
![](file://adventure/LR/009-twm3q-lr-009.webp#center)

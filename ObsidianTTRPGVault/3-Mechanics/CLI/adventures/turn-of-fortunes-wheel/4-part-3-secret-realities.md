...
![Shemeshka admires a captive soul in her secret Abyssal realm, the House of Liars](file://adventure/ToFW/045-03-001.splash.webp#center)
...
![Platinum Razorleaf Casino Chip](file://adventure/ToFW/046-03-002.razorleaf-casino-chip.webp#center)
...
> [!gallery]
> ![Map 14.1: Platinum Rooms](file://adventure/ToFW/047-map-03.01-platinum-rooms.webp#gallery)
> ![Player Version](file://adventure/ToFW/048-map-03.01-platinum-rooms-player.webp#gallery)
...
![In Dungeonland, otherworldly gamblers bet on adventurers across the planes](file://adventure/ToFW/049-03-003.dungeonland.webp#center)
...
There is a 50 percent chance for either Bowolg or Volsheez to win their ages-long battle, but which of these fantastically slow-moving entities will triumph won't be known for hundreds of years. In the sped-up time of the Supertemporal Arena, though, the battle plays out in `dice:3d6|noform|noparens|avg` (`3d6`) minutes. A creature needs to spend approximately 10 rounds (aging 100 years) to witness the end of the battle. On seeing the battle's end, a creature can use the gate to return to Fortune's Wheel and collect any winnings they've earned from Amber.
...
![Shemeshka's uniformed bodyguards, a maelephant and an eater of knowledge, defend the House of Liars](file://adventure/ToFW/050-03-004.bodyguards.webp#center)
...
[Shemeshka](3-Mechanics/CLI/bestiary/npc/shemeshka-mpp.md) (see "Morte's Planar Parade") wants the characters dead and gone. She calls on her two [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) bodyguards lurking in alcoves near the door: an [eater of knowledge](3-Mechanics/CLI/bestiary/aberration/eater-of-knowledge-mpp.md) (that has consumed 5 brains) and a [maelephant](3-Mechanics/CLI/bestiary/fiend/maelephant-mpp.md) (see "Morte's Planar Parade" for both stat blocks). Shemeshka has dressed them in Fortune's Wheel uniforms and doused them in perfume. The bodyguards attack when called.
...
| 2 | Razorvine Bloom. Razorvines burst from the floor. Creatures of Shemeshka's choice in contact with the floor must make a DC 18 Dexterity saving throw. On a failed save, a creature takes `dice:4d10\|noform\|noparens\|avg\|text(22)` (`4d10`) slashing damage and has the [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition until the end of the next round. On a successful save, a creature takes half as much damage only. |
...
![Modrons marching endlessly through Tyrant's Spiral pass the skull of the former archdevil Beherit... again](file://adventure/ToFW/051-03-005.tyrants-spiral.webp#center)
...
> [!gallery]
> ![Map 15.1: Tyrant's Spiral](file://adventure/ToFW/052-map-03.02-tyrants-spiral.webp#gallery)
> ![Player Version](file://adventure/ToFW/053-map-03.02-tyrants-spiral-player.webp#gallery)
...
![Modrons trample the endlessly regenerating remains of the demon Arlgolcheir](file://adventure/ToFW/054-03-006.modrons.webp#center)
...
The pit is bottomless. Any creature that falls into it plummets for over 200 feet before landing on a ledge and taking `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage.
...
- When a creature enters the area covered in ooze for the first time on a turn or starts its turn there, it must succeed on a DC 16 Strength saving throw or take `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) acid damage and have the [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition. A [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) creature can repeat the saving throw at the start of each of its turns, ending the effect on itself on a success. Arlgolcheir can choose not to restrain a creature.  
...
Hundreds of modrons form the bridge that spans the ravine while other modrons cross along their backs. These modrons don't defend themselves, but three [nonaton modrons](3-Mechanics/CLI/bestiary/construct/nonaton-modron-mpp.md) (see "Morte's Planar Parade") emerge from the marching throng and engage any creature that attacks the bridge. These nonatons fight to the death. If the nonatons are defeated, three more nonatons arrive to defend the bridge after 1 minute.
...
The modrons' belief that the Outlands have been corrupted are so strong that they've shaken the underpinnings of the plane. Now these mistaken beliefs manifest as a [planar incarnate](3-Mechanics/CLI/bestiary/miscellaneous/planar-incarnate-mpp.md) (see "Morte's Planar Parade") of a plane that doesn't exist: a Fiend-overrun version of the Outlands (use the planar incarnate's Fiend form). The planar incarnate is hostile toward non-modrons. The round after appearing, it attacks the characters and fights until destroyed.
...
![The distorted beliefs of the hexton modron X01 and its wayward followers manifest as a godlike incarnation of a nonexistent realm](file://adventure/ToFW/055-03-007.modron-corruption.webp#center)

### Reactivating X01

![In one possible reality, modrons enter the fray in the endless Blood War between demons and devils](file://adventure/ToFW/056-03-008.blood.war.webp#center)
...
The portal in area T1, which the characters used to enter Tyrant's Spiral, still functions. However, like the portal to Hopeless, it is difficult to reach. Additionally, unleashing thousands of modrons on Sigil is dangerous. Should this happen, the Lady of Pain intervenes quickly and, through a [dabus](3-Mechanics/CLI/bestiary/celestial/dabus-mpp.md), informs the characters they have 10 minutes to set things right. How the characters can reconcile this—and avoid the Mazes—is up to you.

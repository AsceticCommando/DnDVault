...
![The walking castle Iedcaru endlessly explores the Outlands](file://adventure/ToFW/018-02-001.splash.webp#center)
...
> [!gallery]
> ![Map 4.1: Walking Castle](file://adventure/ToFW/019-map-2.01-walking-castle.webp#gallery)
> ![Player Version](file://adventure/ToFW/020-map-2.01-walking-castle-player.webp#gallery)
...
The Fiends have kept the castle's caretaker, a neutral [githzerai uniter](3-Mechanics/CLI/bestiary/aberration/githzerai-uniter-mpp.md) (see "Morte's Planar Parade") named [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md), in this chamber. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) is eager to be free and evict the devils from her home. She is further detailed in the "Zaythir" section.
...
![The githzerai Zaythir uses the Castellan to set the walking castle's course across the Outlands](file://adventure/ToFW/021-02-002.zaythir.webp#center)
...
![R04M the Missing Monodrone](file://adventure/ToFW/022-02-003.ro4m.webp#center)
...
![Handout 4.1: Mimir Restoration Tracker](file://adventure/ToFW/023-02-017.mimir-tracker.webp#center)
...
The Outlands is infinite in size and changes constantly. This makes the distances between locations and the time it takes to get from place to place variable. How long travel takes is up to you—it could take `dice:3d6|noform|noparens|avg` (`3d6`) days to get from one gate-town to the next closest one, or weeks, or longer. While traveling in the walking castle, the characters are safe, and encounters occur only when you choose.
...
![Beltha and her chaotic gang operate out of the Inverse, the upside-down realm beneath Automata](file://adventure/ToFW/024-02-004.the-inverse.webp#center)
...
The gate to Mechanus is guarded by a [decaton modron](3-Mechanics/CLI/bestiary/construct/decaton-modron-mpp.md) (see "Morte's Planar Parade") and four [pentadrones](3-Mechanics/CLI/bestiary/construct/modron-pentadrone-xmm.md). If any of these modrons are attacked or feel threatened, they can call on more pentadrones, which arrive in 3 rounds. The guards are indifferent to the characters, and they tell anyone who approaches to get in line. It takes `dice:3d12|noform|noparens|avg|text(19)` (`3d12`) hours for a creature at the back of the line to reach the gate. Even then, only those with a gate-access permit may approach the gate (see "Accessing the Gate"). If anyone approaches with questions about the gate, the guards direct them to the Gate Travel Administration.
...
Creatures seeking to use the gate or get close enough to record data using the Mosaic Mimir must obtain an access permit at the Gate Travel Administration building nearby. This monument to bureaucracy is filled with offices, forms, modron officials, and lengthy queues. It takes `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) hours of standing in lines and answering repetitive questions before the characters receive the exception forms they need to fill out to approach the gate. This halfling-sized stack of forms takes `dice:1d4|noform|noparens|avg` (`1d4`) days to fill out and requires a character to succeed on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. If a character fails this check, they miss a field or otherwise err and are provided a new stack of forms to fill out. These take just as long to complete as the first set of forms.

If the characters settle in for the long haul of Mechanus bureaucracy, word filters through the administration's ranks until Aristimus hears about the characters and comes to investigate their intentions after `dice:1d4|noform|noparens|avg` (`1d4`) hours (proceed with "Agents of Order").

#### Agents of Order

Aristimus (lawful neutral [githzerai futurist](3-Mechanics/CLI/bestiary/aberration/githzerai-futurist-mpp.md); see "Morte's Planar Parade") is the captain of Automata's guards and a member of the town's ruling body, the Council of Order. If the characters clearly want to use the gate for something other than travel to Mechanus, they come to Aristimus's attention, either at the gate or in the Gate Travel Administration. The guard captain approaches them with a job in mind. Read or paraphrase the following text to introduce Aristimus:
...
> [!gallery]
> ![Map 5.1: Inverse Hideout](file://adventure/ToFW/025-map-2.02-inverse-hideout.webp#gallery)
> ![Player Version](file://adventure/ToFW/026-map-2.02-inverse-hideout-player.webp#gallery)
...
| 2 | Two [Hands of Havoc fire starters](3-Mechanics/CLI/bestiary/humanoid/hands-of-havoc-fire-starter-mpp.md) (see "Morte's Planar Parade") encourage the characters to share how "the system" has wronged them and offer a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) if a character has need. |
...
![Without help, Valder and Fellik Sands have little hope of escaping the oppressive gate-town of Curst](file://adventure/ToFW/027-02-005.valder-and-fellik.webp#center)
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | A [farastu demodand](3-Mechanics/CLI/bestiary/fiend/farastu-demodand-mpp.md) (see "Morte's Planar Parade") drags a [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) to the gate to Carceri and intends to throw the criminal through it. |
...
| 4–6 | Eyes peer at the characters from the shadows. Roll a die. If you roll an even number, the watcher is a [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) who's suspicious of the characters. If you roll an odd number, it's a [cranium rat squeaker swarm](3-Mechanics/CLI/bestiary/aberration/cranium-rat-squeaker-swarm-mpp.md) (see "Morte's Planar Parade"). |
^curst-encounters
...
A 30-foot-tall wall of rusted metal and razorvine surrounds Curst. It's patrolled by a ruthless cadre of guards called the Wall Watch. These guards are under orders from the town's leader, Baron Villigus Bazengar, to prevent anyone from leaving. Two neutral evil [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) and a [maelephant](3-Mechanics/CLI/bestiary/fiend/maelephant-mpp.md) (see "Morte's Planar Parade") guard Curst's gates. If attacked, these guards call on additional [maelephants](3-Mechanics/CLI/bestiary/fiend/maelephant-mpp.md), which arrive in 2 rounds. The Watch also uses a flight of four trained [wyverns](3-Mechanics/CLI/bestiary/dragon/wyvern-xmm.md) to prevent flying creatures from escaping. If the characters attack and are defeated by Curst's guards, the characters' bodies are thrown in the gate-town's dump.

#### Leaving Curst

The Wall Watch prevents characters from leaving Curst, using either threats or outright force. Characters who ask how to gain permission to leave the gate-town are dismissively referred to the burgomaster's estate to get permission from the burgomaster. Baron Villigus isn't currently in the gate-town, though, so even attempting to get his permission to leave is impossible. The [farastu demodands](3-Mechanics/CLI/bestiary/fiend/farastu-demodand-mpp.md) (see "Morte's Planar Parade") who serve as the baron's guards stiffly relate this to anyone who appears at the estate before urging them to move on.
...
> [!gallery]
> ![Map 6.1: Curst Escape](file://adventure/ToFW/028-map-2.02-curst-escape.webp#gallery)
> ![Player Version](file://adventure/ToFW/029-map-2.02-curst-escape-player.webp#gallery)
...
The figures are Amod Ka and Lot Sheng, lawful neutral, human [Mercykiller bloodhounds](3-Mechanics/CLI/bestiary/humanoid/mercykiller-bloodhound-mpp.md) (see "Morte's Planar Parade"). Lot's [driftglobe](3-Mechanics/CLI/items/driftglobe-xdmg.md) lights the room. On spotting Fellik, Amod asks, "Any luck finding your pops, kid?"
...
![A mysterious criminal uses sinister magic to capture souls in Excelsior](file://adventure/ToFW/030-02-006.sinister-magic.webp#center)
...
Celestial and Humanoid townsfolk go about their business in peaceful harmony, moving between lush gardens and crisply clean shops and homes. Shortly after the characters arrive, a smiling [lantern archon](3-Mechanics/CLI/bestiary/celestial/lantern-archon-mpp.md) (see "Morte's Planar Parade") approaches, welcomes the characters to Excelsior, and politely offers them directions to destinations in town.
...
The gate's guards are [warden archons](3-Mechanics/CLI/bestiary/celestial/warden-archon-mpp.md) (see "Morte's Planar Parade"). They question the intentions of anyone who nears the gate, but they allow the characters to ascend and use the Mosaic Mimir.

#### Uncertain Investigations

After the characters update their [mimir](3-Mechanics/CLI/items/mimir-sato.md), they're approached by a [hound archon](3-Mechanics/CLI/bestiary/celestial/hound-archon-mpp.md) (see "Morte's Planar Parade"). He's one of the locals who's been reflecting on the gate, and he introduces himself as Varrel, a member of the town guard. He asks if the characters are adventurers who'd be interested in helping him with a task. If the characters agree to hear him out, read or paraphrase the following text:
...
![The leaders of Faunel's three packs of sapient animals argue over how best to lead the gate-town](file://adventure/ToFW/031-02-008.leaders-of-faunel.webp#center)
...
> [!gallery]
> ![Map 8.1: Vile Hunt Camp](file://adventure/ToFW/032-map-2.03-vile-hunt-camp.webp#gallery)
> ![Player Version](file://adventure/ToFW/033-map-2.03-vile-hunt-camp-player.webp#gallery)
...
![Whirlwyrms attack the living ship, Courier, in the whirlpool-portal to Ysgard](file://adventure/ToFW/034-02-009.courier.webp#center)
...
- **Sytri.** A silent, masked woman wearing Doomguard armor, Sytri is a chaotic good [Doomguard rot blade](3-Mechanics/CLI/bestiary/humanoid/doomguard-rot-blade-mpp.md) (see "Morte's Planar Parade"). She unfurls a [carpet of flying](3-Mechanics/CLI/items/carpet-of-flying-3-ft-5-ft-xdmg.md) measuring 3 feet by 5 feet and woven with the image of a flying demon skull.  
- **Tol Frostmane.** Full of flattery and bravo, Tol is a towering [equinal guardinal](3-Mechanics/CLI/bestiary/celestial/equinal-guardinal-mpp.md) (see "Morte's Planar Parade") with a neatly braided black mane and a loose poet's shirt. He sails a swift sailboat called the Allure.  
...
![An ettin warlord emerges through the gate to Acheron, leading an invasion of Rigus](file://adventure/ToFW/036-02-010.ettin-warlord.webp#center)
...
The sight of a walking castle closing on the gate-town puts all of Rigus on alert. Blaring horns precede every gate into town closing and patrols outside the gate-town converging into a small army in the walking castle's path. Moments later, a [Harmonium captain](3-Mechanics/CLI/bestiary/humanoid/harmonium-captain-mpp.md) (see "Morte's Planar Parade") who imbibed a [potion of flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md) approaches the walking castle. When the captain is close enough to be heard, read or paraphrase the following boxed text:
...
> [!gallery]
> ![Map 10.1: Gate to Acheron](file://adventure/ToFW/037-map-02.05-gate-to-acheron.webp#gallery)
> ![Player Version](file://adventure/ToFW/038-map-02.05-gate-to-acheron-player.webp#gallery)
...
| 6–9 | A stray heavy crossbow bolt targets a random character. The attack has a `dice:1d20+4\|noform\|noparens\|text(+4)` bonus to hit and deals `dice:1d10+2\|noform\|noparens\|avg\|text(7)` (`1d10 + 2`) piercing damage on a hit. |
| 10 | A 10-foot-wide, iron projectile blasts from the gate to Acheron along the path that affects the greatest number of characters. Creatures in the projectile's path must make a DC 15 Dexterity saving throw, taking `dice:10d6\|noform\|noparens\|avg\|text(35)` (`10d6`) piercing damage on a failed save, or half as much damage on a successful one. |
^gate-to-acheron-battlefield-events
...
![The revels of Kopoha the empyrean get out of hand in the gate-town of Sylvania](file://adventure/ToFW/039-02-011.kopoha.webp#center)
...
| 2 | A [cranium rat squeaker swarm](3-Mechanics/CLI/bestiary/aberration/cranium-rat-squeaker-swarm-mpp.md) (see "Morte's Planar Parade") wants to help one its members that has a hangover. The swarm asks if the lone rat can sleep in a character's pack or asks if the characters know another good place for a nap. |
| 3 | Three [musteval guardinals](3-Mechanics/CLI/bestiary/celestial/musteval-guardinal-mpp.md) (see "Morte's Planar Parade") mistake a character for a stranger who sang with their band last night. They insist the character perform in the show the guardinals are headed to. |
...
| 2 | A [kolyarut](3-Mechanics/CLI/bestiary/construct/kolyarut-mpp.md) (see "Morte's Planar Parade") arrives to interview the characters about their strange situation. It seeks information so greater powers in Mechanus can decide whether they want to blame the characters for their reality-defying situation. |
| 3 | The characters reach a gate-town and find the last gate-town they visited in its place. To the inhabitants, everything is normal. After `dice:1d4\|noform\|noparens\|avg` (`1d4`) days, the gate-towns return to their original locations. |
...
The Noxious Stampede consists of nine [maelephants](3-Mechanics/CLI/bestiary/fiend/maelephant-mpp.md) (see "Morte's Planar Parade"). Their star pitcher, who goes by "Snot Rocket," shoots stinking balls from its trunk like a cannon. The Fiends are sore losers and insufferable winners.

#### Righteous Hands

A team of Celestials, the Righteous Hands consist of eight [hound archons](3-Mechanics/CLI/bestiary/celestial/hound-archon-mpp.md) (see "Morte's Planar Parade") and their star player, a [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) named [Shariel](3-Mechanics/CLI/bestiary/npc/shariel-tofw.md) whose flanged mace rings deeply when it connects with its target. The Righteous Hands are paragons of sportsmanship and honesty, rooting for each other and never disrespecting their opponents, no matter how low the Noxious Stampede stoops.

#### Spireball Rules

![Shariel, Star Player of the Righteous Hands](file://adventure/ToFW/040-02-012.shariel.webp#center)
...
![Dragons from across the planes visit the Mausoleum of Chronepsis, seeking to learn the secrets of fate](file://adventure/ToFW/041-02-013.chronepsis.webp#center)
...
The dragon is Renesnuprah, now a [time dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/time-dragon-wyrmling-mpp.md) (see "Morte's Planar Parade") reduced to 10 hit points. The dragon quickly spots a character and begs to be hidden from the witch. If asked, the dragon refers to herself as Reenee.
...
![Athletic petitioners train and compete in the swampy realm of the lizardfolk deity, Semuanya](file://adventure/ToFW/042-02-014.petitioners.webp#center)
...
![Dendradis, a Rilmani Community in the Spire](file://adventure/ToFW/043-02-015.dendradis.webp#center)
...
If the group fails to get the plumach to speak with them, Ascetelis can find them another plumach willing to talk, but doing so takes `dice:1d4|noform|noparens|avg` (`1d4`) hours. Plumachs avoid conflict; they use the same stat block as [ferrumach rilmani](3-Mechanics/CLI/bestiary/celestial/ferrumach-rilmani-mpp.md) (see "Morte's Planar Parade").
...
The giant defends himself if attacked, and turns hostile if the characters antagonize him. During battle, any creature affected by the giant's Curse of the Evil Eye action gains amphibian-like features. If the giant is slain, his body rapidly decays into a heap of mold. From the remains grow `dice:2d4|noform|noparens|avg` (`2d4`) magical, neon-green toadstools. A creature that consumes one of these 3-inch toadstools is affected as if by a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).
...
It's easy to climb the stone wall to the 10-foot-wide, 25-foot-deep crag above. The space within is cramped, with a 6-foot-high ceiling. This forces the [baernaloth](3-Mechanics/CLI/bestiary/fiend/baernaloth-mpp.md) (see "Morte's Planar Parade") inside to contort its gangly form in a painful-looking crouch. Around the baernaloth, the walls are smeared with blasphemous symbols, and foul icons dangle from twine made from hair.
...
The creature here is a [darkweaver](3-Mechanics/CLI/bestiary/aberration/darkweaver-mpp.md) (see "Morte's Planar Parade"). As soon as it spots other creatures, it attacks and fights to the death—all the while narrating the ways it plans to prepare and consume its prey. If Ascetelis is with the party, she doesn't aid the characters in fighting the darkweaver.

![In the hollow heights of the Spire, RO4M struggles in a darkweaver's web](file://adventure/ToFW/044-02-016.darkweaver.webp#center)

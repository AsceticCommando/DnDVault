...
![The floating skull Morte welcomes some less-than-dead adventurers to the Mortuary](file://adventure/ToFW/002-01-001.splash.webp#center)
...
> [!gallery]
> ![Map 1.1: Mortuary Basement](file://adventure/ToFW/003-map-1.01-mortuary-basement.webp#gallery)
> ![Player Version](file://adventure/ToFW/004-map-1.01-mortuary-basement-player.webp#gallery)
...
Jex, a wispy-haired [Heralds of Dust remnant](3-Mechanics/CLI/bestiary/humanoid/heralds-of-dust-remnant-mpp.md) (see "Morte's Planar Parade"), dissects a [flesh golem](3-Mechanics/CLI/bestiary/construct/flesh-golem-xmm.md) in the autopsy room. The cold-hearted mortician is trying to locate a key she accidentally dropped inside the golem during a routine grafting procedure.
...
![The zombie Maurice dutifully attends one of the Mortuary's deluxe-sized crematoriums](file://adventure/ToFW/006-01-002.zombie-mortuary.webp#center)
...
When pulled, the furnace lever causes the torches set into the walls to erupt with gouts of flame. Creatures inside the fire-filled crematorium must make a DC 18 Dexterity saving throw, taking `dice:8d10|noform|noparens|avg|text(44)` (`8d10`) fire damage on a failed save, or half as much damage on a successful one.
...
On initiative count 20, creatures within 10 feet of the chute must succeed on a DC 14 Dexterity saving throw or take `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) bludgeoning damage and have the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition. The chute stops ejecting corpses after 3 rounds.
...
The dinner is laced with poison. A creature that partakes in any food or drink in this room must make a DC 15 Constitution saving throw, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) poison damage on a failed save, or half as much damage on a successful one.
...
- **Send a Squeak.** A guide introduces the characters to the pervasive rodents called [cranium rat squeakers](3-Mechanics/CLI/bestiary/aberration/cranium-rat-squeaker-mpp.md) (see "Morte's Planar Parade") and explains how to communicate using them.  
...
![Parisa the bariaur tout guides visitors wherever they want to go in Sigil](file://adventure/ToFW/007-01-003.parisa-guides-visitors.webp#center)
...
Intellectuals from three factions—the Athar, the Bleak Cabal, and the Mind's Eye—are locked in debate in a public forum, such as the Trianym outside the Hall of Speakers. The quarrelers consist of a strident [Athar null](3-Mechanics/CLI/bestiary/humanoid/athar-null-mpp.md), an apathetic [Bleak Cabal void soother](3-Mechanics/CLI/bestiary/humanoid/bleak-cabal-void-soother-mpp.md), and an uplifting [Mind's Eye matter smith](3-Mechanics/CLI/bestiary/humanoid/minds-eye-matter-smith-mpp.md) (see "Morte's Planar Parade" for these stat blocks). Their dispute concerns the legitimacy of gods in the grand scheme of the multiverse. Their bombastic arguments have drawn a small crowd of spectators.
...
The three [Harmonium peacekeepers](3-Mechanics/CLI/bestiary/humanoid/harmonium-peacekeeper-mpp.md) (see "Morte's Planar Parade") command the characters to drop their weapons and come quietly. The officers have been ordered to bring the characters before the High Courts of Sigil, where the characters must stand trial for supposed crimes against reality.
...
![Farrow and Their Alter Ego Josbert Plum](file://adventure/ToFW/008-01-004.farrow-and-plum.webp#center)
...
**Aza Dowling**, a self-indulgent tiefling [Society of Sensation muse](3-Mechanics/CLI/bestiary/humanoid/society-of-sensation-muse-mpp.md).

**Josbert Plum**, a belligerent human [Harmonium peacekeeper](3-Mechanics/CLI/bestiary/humanoid/harmonium-peacekeeper-mpp.md) with a blonde buzz cut.

**Kal the Crisp**, a freckled gnome [Hands of Havoc fire starter](3-Mechanics/CLI/bestiary/humanoid/hands-of-havoc-fire-starter-mpp.md) with a penchant for destruction.
...
The speaker is a [cranium rat squeaker](3-Mechanics/CLI/bestiary/aberration/cranium-rat-squeaker-mpp.md) (see "Morte's Planar Parade"), a scout for a cranium rat collective known as the Us, which is scouting new territory. The rat uses the pronouns "we" and "us" when referring to itself. Overwhelmed by the sweet scent of dessert, the rat abandoned its mission and gorged itself on cake here moments ago. Its belly full, the rat has the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) and [prone](3-Mechanics/CLI/rules/conditions.md#Prone) conditions and is indifferent to the party.

If the characters leave the defenseless rat in peace, it gives them a cryptic warning about the tunnels beyond: "Beware the scent of strawberry." If the characters harm it, the rat lets out a telepathic shriek, and a hostile [cranium rat squeaker swarm](3-Mechanics/CLI/bestiary/aberration/cranium-rat-squeaker-swarm-mpp.md) (see "Morte's Planar Parade") pours out from nearby cracks to avenge it.
...
> [!gallery]
> ![Map 2.1: Caker Tea Party](file://adventure/ToFW/009-map-1.02-caker-tea-party.webp#gallery)
> ![Player Version](file://adventure/ToFW/010-map-1.02-caker-tea-party-player.webp#gallery)
...
![Gertrube invites visitors to a Caker celebration in Undersigil](file://adventure/ToFW/011-01-005.gertrube.webp#center)
...
Creatures other than Constructs, Fiends, or Undead that partake of the cake are cursed. Over `dice:1d4|noform|noparens|avg` (`1d4`) hours, a cursed creature's head takes on fiendish aspects. At the end of this time, the creature dies, and its head tears from its body as a hostile [vargouille reflection](3-Mechanics/CLI/bestiary/fiend/vargouille-reflection-mpp.md) (see "Morte's Planar Parade"). Casting [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md), [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md), or a similar spell on the target before this transformation completes ends the curse and undoes its effects.

#### Cursed Cakers

The Cakers have eaten the cursed cake. Makeup masks their languid complexions, but a character who succeeds on a DC 14 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight) or [Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check determines the Cakers aren't well. If a Caker is reduced to 0 hit points, a hostile [vargouille reflection](3-Mechanics/CLI/bestiary/fiend/vargouille-reflection-mpp.md) sprouts from their corpse.
...
![Wealthy and daring gamblers from across the planes mingle at the Fortune's Wheel casino](file://adventure/ToFW/012-01-006.fortunes-wheel.webp#center)
...
> [!gallery]
> ![Map 3.1: Fortune's Wheel](file://adventure/ToFW/013-map-1.03-fortunes-wheel.webp#gallery)
> ![Player Version](file://adventure/ToFW/014-map-1.03-fortunes-wheel-player.webp#gallery)
...
A sculpture of a red dragon head protrudes from the wall above this mirrored bar, which is tended by a dead-eyed, lawful neutral [equinal guardinal](3-Mechanics/CLI/bestiary/celestial/equinal-guardinal-mpp.md) (see "Morte's Planar Parade") named Brayson. He is taciturn but friendly.
...
![Duodrone Slot Machine](file://adventure/ToFW/015-01-08.slot-machine.webp#center)
...
|----------|--------|-----------------------|---------|
| 1 | Worm | `dice:1d3\|noform\|noparens\|avg` (`1d3`) wriggling, indifferent, Tiny [larvae](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) (see the "Dungeon Master's Guide") | [Dimensional shackles](3-Mechanics/CLI/items/dimensional-shackles-xdmg.md) |
| 2 | Tooth | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) teeth from various animals and strangers | [Spell scroll](3-Mechanics/CLI/items/spell-scroll-level-4-xdmg.md) of [polymorph](3-Mechanics/CLI/spells/polymorph-xphb.md) |
...
| 5 | Heart | `dice:1d10\|noform\|noparens\|avg` (`1d10`) "temporary hit points" given to the participant | [Potion of healing (supreme)](3-Mechanics/CLI/items/potion-of-supreme-healing-xdmg.md) |
| 6 | Pitchfork | `dice:1d6\|noform\|noparens\|avg` (`1d6`) fire damage dealt to the participant | [Necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md) |
^slot-machine-results
...
![Dare to test your luck with a spin of fortune's wheel](file://adventure/ToFW/016-01-09.spin-the-wheel.webp#center)
...
- **Dealer's Roll.** After all bets are placed, the dealer rolls itself. Roll a `dice:d20|noform|noparens|avg` (`d20`); if the number on the die matches a number on which the participant bet, the participant collects five times the amount of chips they wagered. Chips wagered on any other numbers are lost.  
...
Fortune's wheel costs 5 razorleaves per spin, and a creature is allowed only one spin every 24 hours (the wheel doesn't function if more spins are attempted). To play, the participant sits in the chair, inserts the chips into a slot in the pedestal, and pulls the lever. To determine the result, roll a `dice:d10|noform|noparens|avg` (`d10`) and consult the Outer Wheel column of the Fortune's Wheel Results table, following its instructions or comparing the result to the entries below. The game always starts on the outer wheel and ends with a single result.
...
The participant gains a [boon of luck](3-Mechanics/CLI/rewards/boon-of-luck.md) (see the "Dungeon Master's Guide").
...
![One of the Dubious Vecna Impersonators Who Perform at Fortune's Wheel](file://adventure/ToFW/017-01-010.vecna-impersonator.webp#center)
...
These lavish rooms are used for private meetings or exclusive table games. In one room, three [hound archons](3-Mechanics/CLI/bestiary/celestial/hound-archon-mpp.md) (see "Morte's Planar Parade") are playing dead hand's dice (see area F5).
...
Read the following text when [Shemeshka](3-Mechanics/CLI/bestiary/npc/shemeshka-mpp.md) (see "Morte's Planar Parade") makes her appearance:

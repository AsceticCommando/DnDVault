...
| 37 | A beholder is trapped within a cavern of the mountains, as the result of some strange draw from a [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md). To pass the time, the creature stages plays with the monsters and prisoners it keeps. |

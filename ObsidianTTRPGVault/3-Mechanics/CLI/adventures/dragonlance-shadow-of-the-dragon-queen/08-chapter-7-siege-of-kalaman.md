...
Later in the day (likely while the characters are on the streets or walls), the character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score spots a dragonnel ridden by two figures flying over the city toward the spires of Castle Kalaman. At a glance, the character doesn't see any Dragon Army colors on the distant figures.
...
This encounter occurs while the characters are outside, possibly on Kalaman's walls or the city streets. The character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score sees a strange violet light in the sky. After they react, read the following text:
...
The small room is strewn with shattered pottery, a broken chest of empty drawers, and a moldering pile of clothes. A successful DC 12 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check shows this room has been ransacked; the chest of drawers and pottery have been carelessly handled and the clothes tossed about.
...
If the characters examine the statue of Takhisis, they notice depressions spaced along its base and a plaque reading, "Yield to Her Will." A character who inspects the depressions and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check realizes they serve as handles to rotate the statue.
...
There are secret doors in the north and south walls. A character can find one by searching that area and succeeding on a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check, but there's no clear way of opening either door until the statue is moved.
...
If Drayan was encountered in area S12 and escaped, she is here when the characters arrive. If so, only four sivak draconians are with her. [Drayan](3-Mechanics/CLI/bestiary/monstrosity/aurak-draconian-dsotdq.md) has [readied](3-Mechanics/CLI/rules/actions.md#Ready) an action to use her Noxious Breath as soon as she sees a character in range.
...
A cleric of Nuitari or a character who succeeds on a DC 12 Intelligence ([Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check recognizes the moon in the wall carvings represents the god Nuitari.
...
If confronted with the [mirror of reflected pasts](3-Mechanics/CLI/items/mirror-of-reflected-pasts-dsotdq.md) (see appendix A), [Lord Soth](3-Mechanics/CLI/bestiary/npc/lord-soth-dsotdq.md) fails all saving throws to resist its effects. He whispers the name "Isolde" before staring into the mirror, transfixed. So long as [Lord Soth](3-Mechanics/CLI/bestiary/npc/lord-soth-dsotdq.md) can see the mirror, he is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) for 1 hour or until he takes damage. If damaged while [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) by the mirror, [Lord Soth](3-Mechanics/CLI/bestiary/npc/lord-soth-dsotdq.md) can make saving throws against the mirror's effects as normal.

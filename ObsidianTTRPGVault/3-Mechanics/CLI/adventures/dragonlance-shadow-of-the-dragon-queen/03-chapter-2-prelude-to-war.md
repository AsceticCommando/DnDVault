...
The mysterious raiders are a [kapak draconian](3-Mechanics/CLI/bestiary/monstrosity/kapak-draconian-dsotdq.md) and four [baaz draconians](3-Mechanics/CLI/bestiary/monstrosity/baaz-draconian-dsotdq.md) (see appendix B for both stat blocks). They wear armor emblazoned with the symbol of Takhisis, which any character can recognize by succeeding on a DC 12 Intelligence ([Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check.

If the characters want to remain hidden, have them roll Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks against the kapak draconian's passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 13. If the draconians don't notice the characters, they pick the wagon clean of valuables and leave shortly after.

...
![](file://adventure/DC/023-ynkgo-donnabella.webp#center)
...
![](file://adventure/DC/024-leeom-galandro.webp#center)
...
![](file://adventure/DC/025-l3v6r-inverna.webp#center)
...
![](file://adventure/DC/026-3krsm-nib.webp#center)
...
![](file://adventure/DC/027-pu4f2-pete.webp#center)
...
![](file://adventure/DC/028-gttxp-quinn.webp#center)
...
![](file://adventure/DC/029-1qyge-ruby.webp#center)
...
![](file://adventure/DC/030-nemem-shanjan.webp#center)
...
![](file://adventure/DC/031-nrqv1-talon.webp#center)
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 10th | 49 (`dice:11d8\|noform\|noparens\|avg` (`11d8`)) | **Empowered Spells.** Choose one "school of magic". Whenever the spellcaster casts a spell of that school by expending a spell slot, the spellcaster can add its spellcasting ability modifier to the spell's damage roll or healing roll, if any. Spellcasting. The spellcaster learns another cantrip: [spare the dying](3-Mechanics/CLI/spells/spare-the-dying-xphb.md) (healer) or [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp-xphb.md) (mage). The caster also gains one 5th‐level spell slot and learns one new 5th‐level spell: [mass cure wounds](3-Mechanics/CLI/spells/mass-cure-wounds-xphb.md) (healer) or [hold monster](3-Mechanics/CLI/spells/hold-monster-xphb.md) (mage). |
| 11th | 54 (`dice:12d8\|noform\|noparens\|avg` (`12d8`)) | **Spellcasting.** The spellcaster gains one 6th‐level spell slot and learns one new 6th‐level spell: [heal](3-Mechanics/CLI/spells/heal-xphb.md) (healer) or [chain lightning](3-Mechanics/CLI/spells/chain-lightning-xphb.md) (mage). |
^level-hit-points-new-features
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 10th | 71 (`dice:11d8+22\|noform\|noparens\|avg` (`11d8 + 22`)) | **Improved Defense.** The warrior's AC increases by 1. |
| 11th | 78 (`dice:12d8+24\|noform\|noparens\|avg` (`12d8 + 24`)) | **Extra Attack.** The warrior can attack three times, instead of once, whenever it takes the attack action on its turn. |
^level-hit-points-new-features
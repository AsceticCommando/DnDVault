...
> [!gallery]
> ![Map 7: Leilon Point Farming Community](file://adventure/SDW/014-9qjz8-map-leilon-point_dm.webp#gallery)
> ![Player Version](file://adventure/SDW/015-ca4ip-map-leilon-point_player.webp#gallery)
...
> [!note] Wait It Out
> 
> The characters might decide to wait for the sahuagin to exit the cave to raid the town rather than assault the cave. If they take this course of action, roll a `dice:d10|noform|noparens|avg` (`d10`). The result equals the number of hours the characters wait. At the end of this time, all the sahuagin and the giant shark skeleton exit the cave and attack.
^wait-it-out

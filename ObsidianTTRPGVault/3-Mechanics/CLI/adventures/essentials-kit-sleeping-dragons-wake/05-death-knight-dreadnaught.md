...
> [!gallery]
> ![Map 5: Death Knight-Dreadnaught](file://adventure/SDW/010-bivmm-map-deathknight-dreadnaught_dm.webp#gallery)
> ![Player Version](file://adventure/SDW/011-jxmkr-map-deathknight-dreadnaught_player.webp#gallery)
...
*Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 20 ft., one target. *Hit*: `dice:3d10+5|noform|noparens|avg|text(21)` (`3d10 + 5`) slashing damage.

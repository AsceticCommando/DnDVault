...
![](file://adventure/SDW/005-hvzlg-shadowy-bronze-dragon.webp#center)
...
> 
> **Rage of Bahamut.** If a creature kills [Lhammaruntosz](3-Mechanics/CLI/bestiary/npc/lhammaruntosz-sdw.md) or a Scaly Eye member while inside the temple, a spectral dragon appears and attacks the creature. The dragon makes an attack roll with a `dice:1d20+10|noform|noparens|text(+10)` bonus to hit and deals `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) psychic damage on a hit. After attacking once, the dragon disappears.
> 
...
> [!gallery]
> ![Map 3: Caverns with Bahamut Shrine](file://adventure/SDW/006-jhbh5-map-bronze-shrine_dm.webp#gallery)
> ![Player Version](file://adventure/SDW/007-vrzqg-map-bronze-shrine_player.webp#gallery)
...
[Lhammaruntosz](3-Mechanics/CLI/bestiary/npc/lhammaruntosz-sdw.md) is an 8th-level spellcaster. Her spellcasting ability is Charisma (spell save DC 17; `dice:1d20+9|noform|noparens|text(+9)` to hit with spell attacks). She has the following sorcerer spells prepared:

...
![](file://adventure/VNotEE/000-00-001.something-wicked-approaches.webp#center)
...
> [!gallery]
> ![Map: Nest of the Eldritch Eye](file://adventure/VNotEE/001-map-0.01-catacombs.webp#gallery)
> ![Player Version](file://adventure/VNotEE/002-map-0.01-catacombs-player.webp#gallery)
...
To move through these rooms without waking the cultists, a creature must succeed on a DC 14 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check. On a failed check, `dice:1d4|noform|noparens|avg` (`1d4`) of the cultists wake up.
...
The box is trapped. A creature that opens the box by any means other than using the proper key must make a DC 13 Constitution saving throw, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) necrotic damage on a failed saved or half as much damage on a successful one. This trap can't be detected or disarmed.

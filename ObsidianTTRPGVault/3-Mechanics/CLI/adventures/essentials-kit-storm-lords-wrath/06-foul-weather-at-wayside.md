...
Unless the tridents can be pulled out with a soft touch, requiring a successful DC 15 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) or Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check, the removal does `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) points of damage, and easily kills the victim.

> [!gallery]
> ![Map 5: Wayside Inn](file://adventure/SLW/009-ivsrz-map-wayside-inn-final_dm.webp#gallery)
> ![Player Version](file://adventure/SLW/010-unnbj-map-wayside-inn_player.webp#gallery)

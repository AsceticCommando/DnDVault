...
As the party loses the trail for a moment, they stumble into a dangerous part of the marsh with a 10-foot square, 20-foot deep pit of quicksand. Unless the character doing the tracking succeeds on a DC 18 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check, they lead the party into it. When a creature enters the area, it sinks `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) feet into the quicksand and becomes [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained). At the start of each of the creature's turns, it sinks another `dice:1d4|noform|noparens|avg` (`1d4`) feet.
...
> [!gallery]
> ![Map 7: Lizardfolk Camp](file://adventure/SLW/013-ibxmx-map-lizardfolk-camp_dm.webp#gallery)
> ![Player Version](file://adventure/SLW/014-ibxmx-map-lizardfolk-camp_dm.webp#gallery)

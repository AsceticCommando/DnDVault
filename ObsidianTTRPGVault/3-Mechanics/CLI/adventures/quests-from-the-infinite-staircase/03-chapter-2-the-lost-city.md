...
![Isolated for centuries, the masked citizens of Cynidicea seek to appease old gods, restless spirits, and ancient evils](file://adventure/QftIS/006-02-001.ch2-the-lost-city.webp#center)
...
![A Door to the Lost City](file://adventure/QftIS/007-02-002.lost-city-door.webp#center)
...
![](file://adventure/QftIS/008-02-003.lost-city-original.webp#center)
...
![A Pair of Cynidicean Masks](file://adventure/QftIS/009-02-004.cynidicean-masks.webp#center)
...
For each hour the party spends in the ruins, roll a `dice:d6|noform|noparens|avg` (`d6`). On a roll of 1, an encounter occurs. To determine what the characters encounter, roll on the Random Ziggurat Encounters table.
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | 1 [rust monster](3-Mechanics/CLI/bestiary/monstrosity/rust-monster-xmm.md) |
| 2 | 2 [giant centipedes](3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) |
| 3 | 1 [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md) |
| 4 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [hobgoblins](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) search for treasure. |
| 5 | A [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) in a Cynidicean wolf mask believes he's a werewolf. When he sees the party, he drops on all fours, howls, and sniffs each character. He's friendly toward the characters but afraid of silver. |
| 6 | Three [priests](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) in fiendish Cynidicean masks approach the party with censers. Convinced the characters are possessed by demons, the priests assail the characters with chants and foul-smelling smoke before continuing on their way. |
| 7 | Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) in bright yellow robes and Cynidicean masks of scowling warriors kneel before one of the characters, addressing them as King Alendria or Queen Zanobis. They follow the character, singing songs of praise and defending them from peril. |
| 8 | A number of [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) equal to the number of characters appear, wearing masks eerily similar to the characters' faces. These Cynidiceans mimic the characters as best they can for 10 minutes, even if it costs the Cynidiceans their lives. |
| 9 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [guardians of Gorm](3-Mechanics/CLI/bestiary/humanoid/guardian-of-gorm-qftis.md) try to escort the characters to their leader in area B12. |
| 10 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [mages of Usamigaras](3-Mechanics/CLI/bestiary/humanoid/mage-of-usamigaras-qftis.md) try to escort the characters to their leader in area B18. |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [warriors of Madarua](3-Mechanics/CLI/bestiary/humanoid/warrior-of-madarua-qftis.md) try to escort the characters to their leader in area B25. |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) of Zargon declare that the characters must be sacrificed to the Returner and attempt to capture them alive. |
^random-ziggurat-encounters
...
> [!gallery]
> ![Map 2.1: Buried Ziggurat, Tiers 1-3](file://adventure/QftIS/010-map-2.01-buried-ziggurat-1-3.webp#gallery)
> ![Player Version](file://adventure/QftIS/011-map-2.01-buried-ziggurat-1-3-player.webp#gallery)
...
If all characters succumb to the gas, `dice:1d4|noform|noparens|avg` (`1d4`) [guardians of Gorm](3-Mechanics/CLI/bestiary/humanoid/guardian-of-gorm-qftis.md) eventually discover them and deliver them to the faction's leader in area B12.
...
Three [giant fire beetles](3-Mechanics/CLI/bestiary/beast/giant-fire-beetle-xmm.md) skitter about this storeroom, hunting for food. If the beetles detect the characters, the beetles hiss and attack.

##### Treasure

This room contains spare parts for the machinery and traps in area B1. Strewn throughout the room are twenty [crossbow bolts](3-Mechanics/CLI/items/crossbow-bolt-case-xphb.md), six [flasks of oil](3-Mechanics/CLI/items/oil-xphb.md), and a set of [smith's tools](3-Mechanics/CLI/items/smiths-tools-xphb.md) near a small foundry.
...
Four [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md), their bellies engorged with the corpse's blood, hang asleep from the ceiling. Bright light or any noise louder than a whisper wakes the stirges, causing them to attack. A character attempting to retrieve the gems must succeed on a DC 15 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check to avoid waking the stirges.
...
![A Mask of Gorm](file://adventure/QftIS/012-02-005.gorm-mask.webp#center)
...
Three [pixies](3-Mechanics/CLI/bestiary/fey/pixie-xmm.md)—Wenly, Weenly, and Wally—are investigating the crates in this storeroom. The pixies speak Common and Sylvan. If approached, the friendly pixies introduce themselves and flit about the characters. The pixies inquire eagerly about the characters' outfits, equipment, and travels, but nothing holds the pixies' attention for long.
...
Each sawdust-packed crate contains ten fireworks—stiff paper tubes filled with a gray powder. The fireworks have been neglected for centuries. Roll a `dice:d6|noform|noparens|avg` (`d6`) for each of the six crates. On a 6, the crate's contents are intact. Otherwise, the fireworks are clearly ruined.
...
The walls and floors of this room are covered in patches of [hazardous green slime](3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md) (see the "Dungeon Master's Guide"). A dwarf member of the Guardians of Gorm perished here weeks ago. The slime has been slowly digesting the body since.
...
On the bed, a [giant lizard](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) munches on the body of an unfortunate Cynidicean. If the lizard notices the characters, it abandons its meal in favor of fresh meat. While feasting on the corpse, the lizard tangled its tail in the dead Cynidicean's mask; during combat, the mask remains wrapped around the lizard's tail.

A second [giant lizard](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) with pale blue scales and orange spots clings to the ceiling, waiting to ambush unsuspecting entrants. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 13 or higher notice the lizard before it attacks.

##### Treasure

The Cynidicean's mask, depicting a hawk with a golden beak, is worth 20 gp. The chest contains a rusty [dagger](3-Mechanics/CLI/items/dagger-xphb.md) and a set of torn vestments.
...
The chest in this room contains a [priest's pack](3-Mechanics/CLI/items/priests-pack-xphb.md). The rations inside spoiled long ago.
...
Three [maces](3-Mechanics/CLI/items/mace-xphb.md) rest against a weapons rack on the west wall. This room also contains enough food and water to sustain ten Humanoids for five days. The five guardians each wear a brass mask of Gorm worth 10 gp.

#### B12: Grand Master of Gorm

![The Guardians of Gorm drum up a musical storm in honor of Gorm, their stern-faced god](file://adventure/QftIS/013-02-006.guardians-of-gorm.webp#center)
...
Kanadius wears a [Helm of Telepathy](3-Mechanics/CLI/items/helm-of-telepathy-xdmg.md). He and the other five guardians each wear a brass mask of Gorm worth 10 gp. Stashed in a chest under one of the beds are six more masks, six blue tunics, and three [Potions of Healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
The stores in this room are covered in four patches of [yellow mold](3-Mechanics/CLI/traps-hazards/yellow-mold-xdmg.md) (see the "Dungeon Master's Guide").

Most of the food here is unfit for consumption, but a crate marked with a bee along the east wall contains `dice:1d4|noform|noparens|avg` (`1d4`) doses of healing honey, crystallized but still edible. A creature that consumes one dose of this honey as an action regains `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) hit points. This honey was produced by bees like those in area B5. Characters can open the crate without disturbing the yellow mold.
...
This room is hidden behind a secret door in the hallway bordering it and another in the next room. A large wicker basket, filled with coins and gems, rests on the floor. Two horned vipers ([poisonous snakes](3-Mechanics/CLI/bestiary/beast/venomous-snake-xmm.md)) hide in the basket, ready to strike.
...
![Through a starry ritual, the Mages of Usamigaras initiate a new member to their faction](file://adventure/QftIS/014-02-008.mages-of-usamigraras.webp#center)

The corridors outside this room are painted black with tiny stars resembling the night sky. The room's iron doors each bear an engraved star. An audible [Alarm](3-Mechanics/CLI/spells/alarm-xphb.md) spell warns the room's inhabitants when a creature other than a mage of Usamigaras touches either door.
...
![A Mask of Usamigaras](file://adventure/QftIS/015-02-007.usamigaras-mask.webp#center)
...
The mages give each inductee a set of starry robes, a [silvered dagger](3-Mechanics/CLI/items/silvered-weapon-xdmg.md), a silver mask worth 25 gp, and a silver tattoo of a five-pointed star on their right palm. Auriga also tells inductees how to operate the shifting wall in area B21. Additionally, if at least one character joins the faction, Auriga gifts the party a [Wand of Secrets](3-Mechanics/CLI/items/wand-of-secrets-xdmg.md) from a hidden niche in the altar.
...
Auriga and their four mages each wear a silver mask of Usamigaras worth 25 gp. Auriga wears a bejeweled silver crown worth 100 gp and carries a [Wand of Magic Detection](3-Mechanics/CLI/items/wand-of-magic-detection-xdmg.md).

A character who inspects the altar and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a hidden compartment. Inside are six more masks, six sets of robes, six [silvered daggers](3-Mechanics/CLI/items/silvered-weapon-xdmg.md), and a [Wand of Secrets](3-Mechanics/CLI/items/wand-of-secrets-xdmg.md).
...
If the wand is pulled to the right, the statue exhales poison gas in a 15-foot-cone. Each creature in that area must succeed on a DC 13 Constitution saving throw or take `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) poison damage.
...
Four [dust mephits](3-Mechanics/CLI/bestiary/elemental/dust-mephit-xmm.md) rummage through the stores in this room. They've just discovered a cask of wine. The dust mephits are hostile toward characters who disrupt their festivities but friendly toward any who join in the revelry.
...
![A Mask of Madarua](file://adventure/QftIS/016-02-009.madarua-mask.webp#center)
...
The vault contains 300 gp, ten tiger's eye gems worth 25 gp each, six bronze [spears](3-Mechanics/CLI/items/spear-xphb.md) worth 10 gp each, six bronze masks of Madarua worth 15 gp each, and a [Weapon of Warning (spear)](3-Mechanics/CLI/items/weapon-of-warning-xdmg.md).

#### B25: Gymnasium of Madarua

![The fearless Warriors of Madarua sharpen their fighting techniques in their stone gymnasium](file://adventure/QftIS/017-02-010.warriors-of-madarua.webp#center)
...
New faction members are inducted in the ceremonial chamber of Madarua (area B23). The warriors give each inductee a green tunic, a [spear](3-Mechanics/CLI/items/spear-xphb.md), a bronze mask of Madarua worth 15 gp, and a small sickle-shaped brand on their left wrist. Additionally, if at least one character joins the Warriors of Madarua, Pandora gifts the party the [Weapon of Warning (spear)](3-Mechanics/CLI/items/weapon-of-warning-xdmg.md) from the faction's treasure room (area B24).
...
Pandora carries a ceremonial [+1 Longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md) and the key to the treasure vault in area B24. She and the other six warriors each wear a bronze mask of Madarua worth 15 gp.

#### B26: Ceremonial Chamber of Gorm

The door to this ceremonial chamber is engraved with three lightning bolts limned in blue light. The door is locked and magically trapped. As an action, a character can pick the lock with a successful DC 15 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check using thieves' tools. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of evocation magic around the door. If a creature outside the chamber picks the lock or touches the trapped door without first speaking the words "by the great god Gorm," the creature takes `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) lightning damage.
...
The gold altar bowl is worth 50 gp. A character who inspects the altar and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a secret compartment containing a [Javelin of Lightning](3-Mechanics/CLI/items/javelin-of-lightning-xdmg.md).
...
> [!gallery]
> ![Map 2.2: Buried Ziggurat, Tier 4](file://adventure/QftIS/018-map-2.02-buried-ziggurat-4.webp#gallery)
> ![Player Version](file://adventure/QftIS/019-map-2.02-buried-ziggurat-4-player.webp#gallery)
...
Three [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) are devouring the corpse of a former high priest. When they detect the characters, the ghouls attack, eager to taste ripe flesh.

##### Treasure

The coffin holds a jeweled necklace worth 300 gp, two jeweled bracelets worth 100 gp each, and two [flasks of holy water](3-Mechanics/CLI/items/holy-water-xphb.md).
...
The figure is the spirit of Alendria (lawful good [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md)), the last king of Cynidicea. Cursed to wander his once-splendid tomb, the ghost lingers here to warn honorable travelers of its dangers.
...
This burial chamber belongs to King Alendria's honor guard, who defend his kingdom even in death. If the characters enter before defeating the banshee in area B44, the five [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) animate and attack. The skeletons don't pursue characters outside this room.

If the characters defeat the banshee, the skeletons instead kneel, each pledging a silent vow to defend the characters for the next `dice:1d4|noform|noparens|avg` (`1d4`) hours or until the skeletons earn their second death (whichever comes sooner). After these vows are fulfilled, the skeletons crumble to dust.
...
A [mummy](3-Mechanics/CLI/bestiary/undead/mummy-xmm.md) rests in the coffin, clutching a [+1 Rapier](3-Mechanics/CLI/items/1-weapon-xdmg.md) to its wrinkled chest. If disturbed, the mummy awakens, releases the rapier, and attacks.
...
The mound obscures a narrow dead-end tunnel in the west wall, just big enough for a Small creature to squeeze through. Here, a giant rat has stored its treasures: a corroded [dagger](3-Mechanics/CLI/items/dagger-xphb.md), a purse containing 55 gp, and an unhatched ankheg egg.
...
This burial chamber is brightly lit by two [Continual Flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on brass jars at the coffin's head and foot. Inside the coffin lies the astrologer's body.
...
A [carrion crawler](3-Mechanics/CLI/bestiary/monstrosity/carrion-crawler-xmm.md) clings to the ceiling in this room, waiting to ambush entrants. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 13 or higher notice the carrion crawler before it attacks.
...
Ten jewels set in the coffin are worth 50 gp each. Inside the coffin is a gold-plated set of [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md) worth 10 gp and two [silvered daggers](3-Mechanics/CLI/items/silvered-weapon-xdmg.md).
...
This burial room was looted during Cynidicea's fall. In the years following, trespassers fell prey to the dangers of the tomb complex. They rose again as five [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) that rush to consume entrants.
...
This room was used for embalming corpses. The jars on the tables contain various chemicals for preserving bodies. When the characters enter, two [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) rise from the floor and attack.

##### Treasure

One of the jars is a [flask of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md). The linen bin contains a [Potion of Invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md).
...
Four [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) have chewed a hole in the coffin and made it their den. The coffin is otherwise empty, its contents pilfered long ago. The rats attack anyone who approaches the coffin.
...
The blades sweep down on each creature that passes under them. The target must make a DC 15 Dexterity saving throw, taking `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) slashing damage on a failed save or half as much damage on a successful one. After a blade swings, the trap resets.
...
This tomb once contained a treasure trove, which the surviving Cynidiceans plundered long ago. As an action, a character can try to pry open the lid of the sarcophagus, doing so with a successful DC 13 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. If the sarcophagus is opened, Queen Zanobis—now a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md)—springs from it and attacks. She wields a scepter instead of a blade, so her melee attacks deal bludgeoning damage instead of slashing damage.
...
Queen Zanobis wears a jeweled crown worth 1,000 gp. Her scepter is a fully charged [Wand of Paralysis](3-Mechanics/CLI/items/wand-of-paralysis-xdmg.md), but if its last charge is expended, the scepter loses its magic. In undeath, Queen Zanobis has forgotten how to access the scepter's magic.

![The once-beloved Queen Zanobis springs from her sarcophagus as a wright dead set on revenge](file://adventure/QftIS/020-02-011.queen-zanobis.webp#center)
...
A [banshee](3-Mechanics/CLI/bestiary/undead/banshee-xmm.md) haunts King Alendria's grave, weeping over the dead monarch centuries after his passing. Characters who saw the frescoes in area B38 recognize the wailing spirit as Queen Zanobis's lady-in-waiting, Therisina. She attacks all who enter.

##### Kingly Gift

If the characters defeat the banshee, the spirit of King Alendria appears to them and bestows a [Charm of Heroism](3-Mechanics/CLI/rewards/charm-of-heroism-xdmg.md) (see the "Dungeon Master's Guide") on each character responsible for this act. He then fades away. This gift vanishes from any character who plunders his sarcophagus.

##### Treasure

King Alendria's tomb was stripped of its riches long ago, except for those inside his sarcophagus. The king's corpse wears a jeweled crown worth 1,000 gp and a suit of [plate armor](3-Mechanics/CLI/items/plate-armor-xphb.md).
...
> [!gallery]
> ![Map 2.3: Buried Ziggurat, Tier 5](file://adventure/QftIS/021-map-2.03-buried-ziggurat-5.webp#gallery)
> ![Player Version](file://adventure/QftIS/022-map-2.03-buried-ziggurat-5-player.webp#gallery)
...
As an action, a host inhabited by Demetrius can ask the spirit to cast one of the following spells (spell save DC 13), requiring no material components: [Command](3-Mechanics/CLI/spells/command-xphb.md), [Find Traps](3-Mechanics/CLI/spells/find-traps-xphb.md), or [Lesser Restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md). Once Demetrius casts one of these spells, he can't cast that spell again until the next dawn.
...
Demetrius never willingly leaves a host, but his spirit is forced back into the white robe if a host dies or is targeted by the [Dispel Evil and Good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md) spell. Demetrius automatically fails his saving throw against any effect that turns Undead, which also forces his spirit back into the robe.
...
If Darius is slain, Demetrius passes to the afterlife, and his robe becomes a [Cloak of Protection](3-Mechanics/CLI/items/cloak-of-protection-xdmg.md).
...
The tapestry behind the chest is a hostile [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md). Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 14 or higher notice that despite the breeze, the tapestry remains unnaturally still.
...
The chest contains 330 gp, 600 sp, and a [Potion of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md).
...
The [giant constrictor snake](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) strikes at any who interrupt its meal. The cupboards are empty, but the dead Cynidicean's robes contain a full waterskin and two days of rations.
...
The two statues are suits of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md). Both statues awaken if either door to this room is opened. Created to protect Cynidiceans in this room, the statues are indifferent toward creatures wearing stylized Cynidicean masks and hostile toward all others. The statues never leave the room.
...
Two [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) guard this room. The gargoyles are hostile toward the characters but don't pursue them beyond the room.

##### Treasure

The desk's bottom drawer is locked. As an action, a character can open the drawer with a successful DC 13 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check using thieves' tools. It contains a [Potion of Poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md). The other drawers contain only aged writing supplies and boring municipal documentation.
...
When a weight greater than 50 pounds is placed on the trapdoor, the door swings downward. Each creature and object on it falls into the pit, taking `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) bludgeoning damage from the fall and landing with the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition on a pile of brittle bones.

#### B52: Abandoned Clerical Quarters

This damp room's interior shimmers faintly, as if seen through clear water. Just inside the doorway is a hostile [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md). The cube is still digesting the remains of its last meal—a skeleton that appears to float in mid-air, chunks of gooey flesh clinging to its bones. The room is otherwise empty.
...
The masked elf is a [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) that killed the Cynidicean it now impersonates. When it becomes aware of the characters, the doppelganger introduces itself as Kastrith, a friendly Cynidicean priest, and volunteers to help the party navigate the ziggurat. The doppelganger aims to split the party and take a character's place by any means necessary.
...
Two [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) rummage for morsels in this storage room. Candles, incense, and other ceremonial items line its dusty shelves. When the characters enter, the ogres are eating a box of candles. Hungry and unsatisfied, the ogres demand food from all entrants and clobber any who refuse to give it to them.

##### Treasure

One of the ogres carries an oversized leather sack containing the corpse of an explorer, a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Comprehend Languages](3-Mechanics/CLI/spells/comprehend-languages-xphb.md), a [dagger](3-Mechanics/CLI/items/dagger-xphb.md) clearly used as a toothpick, and 80 gp.
...
Two [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) thieves in humanoid form divide their recent spoils. When they notice the characters, the wererats throw a cloth over the chest to conceal it and leap to their feet.
...
The women atop the dais are [jackalweres](3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) disguised as human Cynidiceans. Sisters and charlatans, the two happened on the ziggurat and began scouring it for valuables. The siblings are insufferably vain but ultimately indifferent toward the characters.

When the sisters notice the characters, they bow and introduce themselves as Chana and Vana, potion sellers extraordinaire. The charlatans try to sell the characters fake potions—glittering bottles advertised as "rare and magical elixirs" with outlandish properties—for anything precious the characters can offer. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals the potions as fakes. If confronted, the sisters flee, defending themselves as necessary. Failing that, they attempt to wangle their freedom through bribery and deceit.
...
![Deep within the ziggurat, a time-worn wall mosaic depicts the rise and fall of Cynidicea](file://adventure/QftIS/023-02-012.cynidicea-mosaic.webp#center)
...
The floor of this sunken room is filled with a 6-foot-deep pool of vaporific acid. A creature that enters the pool for the first time on a turn or starts its turn there takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) acid damage.

A corroded metal box bobs in the hissing pool; its padlocked lid protrudes above the liquid's surface.

##### Treasure

The box's padlock breaks if touched. Inside is a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Levitation](3-Mechanics/CLI/spells/levitate-xphb.md) and 200 sp.
...
The masked figures are six [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) of Zargon. Mesmerized by a visage of their overlord reflected in a bowl of slime, the cultists are indifferent toward the characters. If disturbed, the cultists become hostile.
...
Nine Cynidiceans ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) revel quietly in this fungal room. To escape their bleak existence, the Cynidiceans have partnered with a [myconid sovereign](3-Mechanics/CLI/bestiary/plant/myconid-sovereign-xmm.md). In exchange for the Cynidiceans tending its garden, the myconid facilitates group melds—vivid, shared dreams that provide entertainment and social interaction. As the partygoers meld, they are blissfully unaware of the characters.
...
Some surviving Cynidiceans gamble the fortunes of their lost kingdom in this secluded room. Twelve masked [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) play games here, supervised by four [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) of Zargon.
...
![A Mask of Zargon](file://adventure/QftIS/024-02-013.zargon-mask.webp#center)
...
Darius (chaotic evil, human [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) and two [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) of Zargon lurk in this office, counting coins confiscated from Cynidicean gamblers. They are hostile toward anyone not garbed in their cult's attire.
...
For each hour the party spends on this level, roll a `dice:d6|noform|noparens|avg` (`d6`). On a roll of 1, the characters encounter `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) led by a [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) looking for sacrifices. Each cult member wears a gold mask of Zargon worth 50 gp.
...
> [!gallery]
> ![Map 2.4: Expanded Ziggurat](file://adventure/QftIS/025-map-2.04-expanded-ziggurat.webp#gallery)
> ![Player Version](file://adventure/QftIS/026-map-2.04-expanded-ziggurat-player.webp#gallery)
...
A [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) creeps along the ceiling. It attempts to plop onto one of the characters and drag them into one of the slimy chutes on the floor.
...
Twelve [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) perform a wicked ritual in this room. The cultists are hostile toward intruders but continue intoning even in combat—only death can separate the Zargonites from their goal. The cultist on the pedestal refrains from joining combat until the ritual is complete; if they are killed, another cultist takes their place on the altar.

The ritual continues for 3 rounds or until all cultists have been dispatched. A [Silence](3-Mechanics/CLI/spells/silence-xphb.md) spell that envelops all the cultists also stops the ritual.

If one or more cultists are still chanting at the end of round 2, the cultist on the altar (or closest to it) transforms into a [gibbering mouther](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) with all its hit points. Read or paraphrase the following text:
...
Four clammy cocoons, ready to burst, stick to the bottoms of four beds. If a creature disturbs a cocoon or moves within 10 feet of it, the cocoon bursts. Each creature within 10 feet of a bursting cocoon must succeed on a DC 13 Dexterity saving throw or take `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) poison damage and have the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition for 1 minute.

Immediately after a cocoon bursts, a mass of squirming, barbed tentacles (use the [swarm of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md) stat block) emerges in the nearest unoccupied space. The oily limbs attack the nearest creature.

##### Treasure

Three of the chests contain gold masks of Zargon worth 50 gp each. Another contains a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Evard's Black Tentacles](3-Mechanics/CLI/spells/evards-black-tentacles-xphb.md).
...
Six [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) loyal to Zargon work to expand this fleshy chamber. When the characters enter, two of the duergar are arguing over the quality of their tools. The duergar are friendly to characters who wear the masks of Zargon's cultists, allowing them to pass; otherwise, the duergar greet intruders with hostility.

##### Acid Pool

A hissing, 3-foot-deep pool of digestive acid fills the area around the stone path. A creature that enters the pool for the first time on a turn or starts its turn there takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) acid damage.

##### Bile Spouts

Four bile spouts, agitated by the duergar excavators, stud the walls. At initiative count 10 on each round (losing initiative ties), the spouts erupt with gouts of acid in a 60-foot line that is 10 feet wide. Each creature in that area must make a DC 14 Dexterity saving throw, taking `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) acid damage on a failed save or half as much damage on a successful one.
...
Four [cult fanatics](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) deposit leftovers from sacrifices in area B69 into vats here in hopes of birthing Oozes to serve Zargon. The cultists are hostile toward intruders not garbed in their cult's attire.
...
The three 10-foot-wide vats each hold the essence of a different variety of Ooze. A creature that enters a vat for the first time on a turn or starts its turn there takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) acid damage. If a creature dies in a vat, a hostile ooze emerges from it 1 round later. The ooze has the same initiative count as the creature whose death spawned it. An ooze spawned this way is indifferent to the cultists but hostile to all other creatures.

The contents of the vats and the oozes they spawn are as follows:

- **Black Vat.** A tarry, black substance bubbles within this vat, which can produce one [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md).  
- **Clear Vat.** This vat wobbles with a crystal-clear liquid that can produce up to two [gelatinous cubes](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md).  
- **Yellow Vat.** The glistening, amber-hued jam within this vat can produce up to two [ochre jellies](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md).  
...
Two sets of iron [manacles](3-Mechanics/CLI/items/manacles-xphb.md) (see the "Player's Handbook") are bolted to the altar. A creature chained to the altar has the [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition.
...
A 10-foot-wide patch of [green slime](3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md) (see the "Dungeon Master's Guide") intersects the pews. The slime doesn't harm Zargon or its cultists.
...
The treasures Zargon has gathered lie submerged in unlocked iron chests at the bottom of the lake. Its hoard contains the following rewards, which it never parts with willingly: 11,600 sp and 1,800 gp, a [Cloak of Elvenkind](3-Mechanics/CLI/items/cloak-of-elvenkind-xdmg.md), a [Deck of Illusions](3-Mechanics/CLI/items/deck-of-illusions-xdmg.md), a [+2 Shield](3-Mechanics/CLI/items/2-shield-xdmg.md), and a [Scimitar of Speed](3-Mechanics/CLI/items/scimitar-of-speed-xdmg.md).

![Zargon the returner rises from a lake of slime within its lair](file://adventure/QftIS/027-02-014.zargon-the-returner.webp#center)

### The Underground City

> [!gallery]
> ![Map 2.5: Underground City](file://adventure/QftIS/028-map-2.05-underground-city.webp#gallery)
> ![Player Version](file://adventure/QftIS/029-map-2.05-underground-city-player.webp#gallery)

...
![Caerwyn and Porphura, two powerful spellcasters in love, relax in the fairytale garden they created together](file://adventure/QftIS/054-04-001.ch4-beyond-the-crystal-cave.webp#center)
...
![A Door to the Eternal Garden](file://adventure/QftIS/055-04-002.eternal-garden-door.webp#center)
...
![](file://adventure/QftIS/056-04-003.beyond-the-crystal-cave-original.webp#center)
...
![Governor Isabela Folcarae](file://adventure/QftIS/057-04-004.governor-isabela-folcarae.webp#center)
...
Governor Isabela Folcarae (lawful good, human [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)) receives the characters shortly after they call at her mansion. Read or paraphrase the following text to begin the adventure:
...
> [!gallery]
> ![Map 4.1: Cave of Echoes](file://adventure/QftIS/058-map-4.01-cave-of-echoes.webp#gallery)
> ![Player Version](file://adventure/QftIS/059-map-4.01-cave-of-echoes-player.webp#gallery)
...
Sounds in this area echo loudly. Noises louder than a typical conversation—such as shouting or playing an instrument—reverberate painfully. If this occurs, each creature in the chamber must succeed on a DC 15 Constitution saving throw or take `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) thunder damage and have the [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened) condition for 1 minute. The echo then dissipates and doesn't compound.

##### Whispers of Fate

The magic of the Feywild whispers into the cavern, offering aid to those in true need and without selfish intent. When such a creature requests help in this area, the cavern can offer answers or intervene by duplicating any spell of 8th level or lower (your choice, not the creature's). The most common assistance provided by the cave comes in the form of the [Greater Restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md), [Heal](3-Mechanics/CLI/spells/heal-xphb.md), and [Plane Shift](3-Mechanics/CLI/spells/plane-shift-xphb.md) (to the Eternal Garden only) spells; when duplicating the effect of a spell, the cavern targets the creature that requested its aid.

A creature that asks a question here receives a truthful, albeit cryptic, answer in Common with clues to its goals. Those who can help themselves, such as the characters, receive only this benefit from the cavern. If the characters inquire about the whereabouts of Juliana and Orlando, disembodied voices tell them their quarry is just beyond the crystal cave (area C6). The cave's oracular power is similar to a [Divination](3-Mechanics/CLI/spells/divination-xphb.md) spell.
...
Three [poltergeists](3-Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) (variant [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md)) haunt the main chamber of the cavern, venting their fury on intruders. The restless spirits hurl broken stalactites at unsuspecting entrants or toss creatures onto pointed stalagmites in the cavern.

A cavity to the north collects moisture dripping from the ceiling. An [ochre jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) lurks here, content to feed on fungus and the remains of the poltergeists' occasional victims. It slithers into the main cavern if battle breaks out.

##### Stalagmites

The rock formations throughout this cavern are dangerously sharp. A creature pushed into a stalagmite takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) piercing damage.

##### Treasure

The skeleton of a decades-dead human knight rests in the south chamber, impaled on a stalagmite by the poltergeists. Most equipment the knight once carried has rusted or rotted away, but a [Necklace of Adaptation](3-Mechanics/CLI/items/necklace-of-adaptation-xdmg.md) hangs around the dead warrior's neck. Scattered on the floor beneath the skeleton are 8 pp, 22 gp, and a yellow topaz (250 gp).
...
Each mud elemental uses the [water elemental](3-Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md) stat block with the following changes:
...
One mound entombs the remains of a human warrior. His [chain mail](3-Mechanics/CLI/items/chain-mail-xphb.md), [shield](3-Mechanics/CLI/items/shield-xphb.md), and [longsword](3-Mechanics/CLI/items/longsword-xphb.md) are rusted but still functional, and he has 20 gp in a crumbled purse.

The other mound holds the remains of an elf thief with a set of [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md), 50 gp, and 50 pp. Her shriveled hand clutches a [+1 Dagger](3-Mechanics/CLI/items/1-weapon-xdmg.md) with the name "Madrigal" carved into its ivory handle in Elvish.
...
![A waterfall in a crystal cave hides a fey crossing to the Eternal Garden](file://adventure/QftIS/060-04-005.crystal-cave-waterfall.webp#center)
...
- [Control Water](3-Mechanics/CLI/spells/control-water-xphb.md) parts or raises the waterfall for the spell's duration.  
- [Create or Destroy Water](3-Mechanics/CLI/spells/create-or-destroy-water-xphb.md) cast to destroy part of the waterfall destroys a 5-foot-cube of water, which fills in after 1 minute.  
- Teleportation bypasses the waterfall as normal.  
- A creature under the effect of a [Slow](3-Mechanics/CLI/spells/slow-xphb.md) spell more closely matches the waterfall's altered time and can move through the waterfall as if it were "difficult terrain".  
- A successful [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell (DC 15) cast on the waterfall causes it to flow normally for 1 minute, during which time creatures can move through the water as if it were difficult terrain.  
...
| dice: d8 | Encounter |
|----------|-----------|
| 1 | Two awakened [giant badgers](3-Mechanics/CLI/bestiary/beast/giant-badger-xmm.md) (see the "Awakened Animals" section) fret as they prepare their burrow for a visit from one of the badger's in-laws. |
...
| 3 | Three [satyrs](3-Mechanics/CLI/bestiary/fey/satyr-xmm.md) argue as they pick berries for making wine. They ask the characters to settle a dispute over which of the satyrs has the best muscles. |
| 4 | Stargleam and Silverlily, the [unicorns](3-Mechanics/CLI/bestiary/celestial/unicorn-xmm.md) from area G15, discuss philosophy while on a walk. |
| 5 | Gnarlroot, the irascible [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md) from area G12, lumbers through the garden, grumbling to himself about the antics of a prank-loving leprechaun. |
| 6 | A fun-loving [awakened tree](3-Mechanics/CLI/bestiary/plant/awakened-tree-xmm.md) uproots and blocks a character's path, mimicking their movements. |
| 7 | Gorguth the [chimera](3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md) (see area G7) flies overhead and lets out a fearsome roar. If the characters draw Gorguth's attention, he descends to meet them. |
...
> [!gallery]
> ![Map 4.2: Eternal Garden](file://adventure/QftIS/061-map-4.02-eternal-garden.webp#gallery)
> ![Player Version](file://adventure/QftIS/062-map-4.02-eternal-garden-player.webp#gallery)
...
The toadstools form a fairy ring that acts as a permanent teleportation circle, which can serve as the destination of teleportation magic and spells such as [Plane Shift](3-Mechanics/CLI/spells/plane-shift-xphb.md). Though the fairy ring once provided an exit from the garden, the fey crossing is now one-way, allowing exit only with a special key (see the "Returning to the Garden" section of this adventure's conclusion for more on exiting through the fairy ring).
...
![A boisterous gaggle of leprechauns greets entrants to the Eternal Garden with japery and merriment](file://adventure/QftIS/063-04-006.leprechauns.webp#center)
...
Several leprechauns live inside this great oak. The interior is sized for Small creatures and is brightly lit by cage lanterns full of fireflies. At any given time, `dice:1d4|noform|noparens|avg` (`1d4`) friendly [leprechauns](3-Mechanics/CLI/bestiary/fey/leprechaun-qftis.md) are here, enjoying the comforts of their home.
...
A character who digs at the bottom of the kitchen pit discovers a pouch with an [Ioun Stone (sustenance)](3-Mechanics/CLI/items/ioun-stone-sustenance-xdmg.md) and two dull-gray stones that lost their magic long ago. Digging deeper reveals a copper crock filled with 2,500 gp—the leprechauns' collected gold. If the gold is stolen, the leprechauns stop at nothing to retrieve it.
...
![Vuuthramis, a timid bronze dragon, gambols in the river when no one is watching](file://adventure/QftIS/064-04-007.vuuthramis.webp#center)

The river is home to Vuuthramis, a shy but playful [young bronze dragon](3-Mechanics/CLI/bestiary/dragon/young-bronze-dragon-xmm.md). She lives in a cave hidden beneath the river. Vuuthramis drank from the Fountain All Heal (area G9) and succumbed to its enchantment. As a result, she has no desire to keep a treasure hoard. She's content to swim and frolic in the river, occasionally venturing onto its banks.
...
Vuuthramis watches and listens along the course of the river and knows the surrounding inhabitants. If a character overcomes the dragon's shyness, she tells the characters about a few of the garden's denizens, such as Gnarlroot, the [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md) in area G12, who "seems extra grumpy today."
...
Fluttering in the branches of Sonna's tree is a [Cloak of Elvenkind](3-Mechanics/CLI/items/cloak-of-elvenkind-xdmg.md). Yvra's tree has the set's matching [Boots of Elvenkind](3-Mechanics/CLI/items/boots-of-elvenkind-xdmg.md) hidden in a hollow. One of the boots holds a leather pouch containing thin ivory plates whose illustrations resemble those of the storied [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things-xdmg.md). The deck is nonmagical and worth 100 gp. Yvra uses them to play a solitary card game called patience.
...
In the tree hollow is a leather sack containing 400 gp and a locked wooden box. As an action, a character can pick the lock with a successful DC 20 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check using thieves' tools. The box holds three sapphires (200 gp each), a [Potion of Animal Friendship](3-Mechanics/CLI/items/potion-of-animal-friendship-xdmg.md), a [Potion of Diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md), a [Potion of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md), and a set of fine reed pipes worth 25 gp.
...
Gorguth is a [chimera](3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md) with the following changes:
...
A mated pair of awakened [brown bears](3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md) (see the "Awakened Animals" section) and their awakened cub (use the [black bear](3-Mechanics/CLI/bestiary/beast/black-bear-xmm.md) stat block) live in the cave and claim the surrounding area as their territory. The adult bears are hostile toward strangers but not violent unless provoked. Suspicious of visitors, they warn trespassers to back away from their den. The cub is indifferent—curious but skittish.
...
![The enchanting waters of the Fountain All Heal make its drinkers never want to leave the garden](file://adventure/QftIS/065-04-008.fountain-all-heal.webp#center)
...
This stretch of forest is home to a gathering of Fey folk. Six [pixies](3-Mechanics/CLI/bestiary/fey/pixie-xmm.md) and six [sprites](3-Mechanics/CLI/bestiary/fey/sprite-xmm.md) are present in and around the willow tree at any time. Though there are dozens of the Fey in total, most of them are gallivanting about the woods and the greater garden.
...
Hidden in the fairies' burrow are a [Potion of Clairvoyance](3-Mechanics/CLI/items/potion-of-clairvoyance-xdmg.md) and a gold ring (250 gp) set with a [Pearl of Power](3-Mechanics/CLI/items/pearl-of-power-xdmg.md).

#### G11: Barkburrs' Grove

![Spooky faces haunt the burled trees of the barkburrs' gloomy thicket](file://adventure/QftIS/066-04-009.barkburrs.webp#center)
...
Hidden in a leather sack under some mossy rocks in the cave is a [Potion of Growth](3-Mechanics/CLI/items/potion-of-growth-xdmg.md). A character searching the cave finds the stash with a successful DC 20 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check.
...
The stream runs into a crack in the rock at the back of the 30-foot-deep cave. Two [giant toads](3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) lair in the cave, guarding their clutch of eggs. The toads are indifferent to the characters unless the characters come more than 10 feet into their den, at which point the toads croak angrily in defense of their eggs. A character can use an action to try to calm the toads, doing so with a successful DC 15 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. Once calmed, the toads allow the characters to explore the cave unhindered. The toads attack if their eggs are threatened.

##### Treasure

Wedged into the crack where the stream begins is a [+1 Shield](3-Mechanics/CLI/items/1-shield-xdmg.md) emblazoned with the image of a brightly painted frog.
...
The meadow and structure are home to a family of four [centaurs](3-Mechanics/CLI/bestiary/fey/centaur-trooper-xmm.md). The parents, Heraq and Persella, are initially wary of the characters and tersely ask them to state their business. The centaur children, Kari and Vinz, spend most of their time running through the meadows and swimming in the lake with the giant otters (area G18). If the characters are respectful, the centaurs invite them inside for tea sweetened with honey.

The bees are docile unless their hive is damaged. If a creature damages the beehive, a [swarm of insects (wasps)](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) erupts from the hive and attacks until the offending creature dies or flees.
...
A character can carefully harvest a single dose of magical honey from the hive without upsetting the bees with a successful DC 10 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check. The honey collected functions as a [Potion of Vitality](3-Mechanics/CLI/items/potion-of-vitality-xdmg.md).

![With sharp horns and even sharper wit, the unicorns Stargleam and Silverlily delight in philosophical debates](file://adventure/QftIS/067-04-010.stargleam-and-silverlily.webp#center)
...
Two mated [unicorns](3-Mechanics/CLI/bestiary/celestial/unicorn-xmm.md) named Stargleam and Silverlily live here. They enjoy walking the paths of the hedge maze (area G21) and occasionally assist [the Gardener](3-Mechanics/CLI/bestiary/npc/the-gardener-qftis.md) in protecting the domain. It's been decades since their help was required, but they remain vigilant and intensely question newcomers to the garden.
...
Two friendly giant otters ([giant weasels](3-Mechanics/CLI/bestiary/beast/giant-weasel-xmm.md) with a swimming speed of 40 feet) frolic in this shallow lake, which slopes gently from the shore to a depth of 10 feet. The otters are curious and playful; they dart up to investigate anyone in the lake.
...
[The Gardener](3-Mechanics/CLI/bestiary/npc/the-gardener-qftis.md) is present the first time the characters arrive. The archfey is friendly toward the characters and curiously inquires as to their business in the domain. After some initial investigation of the characters' intentions, the Gardener offers refreshment. If the characters have behaved peacefully toward the garden's denizens, the Gardener also casts the [Heroes' Feast](3-Mechanics/CLI/spells/heroes-feast-xphb.md) spell to produce a repast of delicious vegetables for the characters.
...
The hedge wall is 5 feet thick and immune to all damage. A creature can force its way through the wall, spending 4 feet of movement for each foot traveled. Creatures that push through a hedge wall must make a DC 15 Dexterity saving throw, taking `dice:7d8|noform|noparens|avg|text(31)` (`7d8`) piercing damage on a failed save or half as much damage on a successful one.
...
![Tucked away in a demiplane of its own, the Palace of Spires shields inhabitants from the worries of the world](file://adventure/QftIS/068-04-011.palace-of-spires.webp#center)
...
- **Lighting.** Soft light permeates the demiplane. Light outside the palace matches that of the Eternal Garden (see the "Eternal Garden Features" section), while interior areas are brightly lit by [Continual Flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells.  
...
> [!gallery]
> ![Map 4.3: Palace of Spires](file://adventure/QftIS/069-map-4.03-palace-of-spires.webp#gallery)
> ![Player Version](file://adventure/QftIS/070-map-4.03-palace-of-spires-player.webp#gallery)
...
![Juliana and Orlando lounge carefree in the palace, unaware two years have passed since they absconded](file://adventure/QftIS/071-04-012.juliana-and-orlando.webp#center)
...
Juliana and Orlando (neutral good, human [nobles](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) with Armor Class 11 and no armor or weapons) recline together here on the suspended couch, relaxing and chatting. They're dressed in bright lounging robes with slippers. The pair are surprised but not perturbed by the characters' arrival if it's peaceful. They are indifferent to the characters, and to their perception, they have been in the Eternal Garden for only two days, not the two years that have already passed on the island of Sybarate.
...
Juliana and Orlando are under the enchantment of the Fountain All Heal and regard the palace as their new home. Until they're freed from the domain's allure—such as by a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell granted in the tomb (see area P12)—they won't entertain any notion of leaving. If the effect on them is broken, the couple entertains reasonable arguments to return home and speak to their worried families.
...
Julianna and Orlando's possessions are stored in the secret closet behind the tapestry and include two sets of [fine clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), two [rapiers](3-Mechanics/CLI/items/rapier-xphb.md), two [breastplates](3-Mechanics/CLI/items/breastplate-xphb.md), a purse containing 30 gp and three diamonds worth 300 gp each, and a gold signet ring worth 50 gp bearing Orlando's family crest.
...
A secret closet in the southeastern corner of the room holds Argus' [spellbook](3-Mechanics/CLI/items/spellbook.md), which contains all his prepared spells; a [Wand of Magic Detection](3-Mechanics/CLI/items/wand-of-magic-detection-xdmg.md); an ivory inlaid box (150 gp) holding five sets of spare key leaves (see the "Key Leaves" section above); two [Potions of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md); and a bag with 10 pp, 20 gp, 15 sp, and a flawed emerald worth 500 gp.
...
![Long after their happily ever after, Caerwyn and Porphura remain by each other's side](file://adventure/QftIS/072-04-013.sarcophagus.webp#center)

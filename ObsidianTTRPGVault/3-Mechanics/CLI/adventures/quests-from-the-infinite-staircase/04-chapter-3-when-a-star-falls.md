...
![In an event foretold by the Books of Prophecy, a falling star lands in the Tegefed Mountains](file://adventure/QftIS/030-03-001.ch3-when-a-star-falls.webp#center)
...
![A Door to the Tower of the Heavens](file://adventure/QftIS/031-03-002.tower-of-the-heavens-door.webp#center)
...
![](file://adventure/QftIS/032-03-003.when-a-star-falls-original.webp#center)
...
> [!gallery]
> ![Map 3.1: Tegefed Mountains](file://adventure/QftIS/033-map-3.01-tegefed-mountains.webp#gallery)
> ![Player Version](file://adventure/QftIS/034-map-3.01-tegefed-mountains-player.webp#gallery)
...
| dice: d8 | Encounter |
|----------|-----------|
| 1 | Three [griffons](3-Mechanics/CLI/bestiary/monstrosity/griffon-xmm.md) hunt the characters. A griffon egg in a nearby nest can fetch a price of up to 300 gp if sold to the right buyer. |
| 2 | Two [displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) quietly stalk the characters. |
| 3 | An [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) trains five [boars](3-Mechanics/CLI/bestiary/beast/boar-xmm.md) to hunt wild animals. On noticing the characters, the ogre sets the pet boars loose on them instead. |
| 4 | Five [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) ambush the party, demanding the characters give them 100 gp or face certain death. Each bugbear carries 3 gp in a coin pouch. |
| 5 | Ten [giant bats](3-Mechanics/CLI/bestiary/beast/giant-bat-xmm.md) swoop in and attack the characters. The bats focus their attacks on the character who makes the most noise. |
| 6 | The characters hear distant howls. Two [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) and five [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) descend on them 1 minute later. |
| 7 | A [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) drags a large sack containing the carcass of a giant goat, seeking a good place to eat it. If the troll notices the characters, the troll drops the sack and attacks, deeming them a much tastier meal. |
| 8 | The characters encounter an injured hunter in the wilderness who calls out for help. The hunter is actually a hungry [jackalwere](3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) bandit in human form. Five more [jackalweres](3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) lie in ambush nearby. |
^random-tegefed-mountains-encounters
...
The robed figures are the corpses of four tower hands whom Shalfey sent to track down the star. The messengers' minds were drained by the memory web before death. As a result, the [Speak with Dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md) spell and similar magic yield only confused, meaningless responses.
...
Sion is accompanied by a hound and an oversized raven, both made of pure shadow (both creatures use the [shadow](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) stat block, but the raven has a flying speed of 40 feet). When a companion drops to 0 hit points, it vanishes in a cloud of shadow. The companions also vanish when Sion dies.
...
![Sion and his shadowy pets skulk toward a group of unsuspecting travelers](file://adventure/QftIS/035-03-004.sion-lurking.webp#center)
...
Avri and Ivo, two [giant eagles](3-Mechanics/CLI/bestiary/celestial/giant-eagle-xmm.md) who speak Common, welcome the characters to Derwyth's wood. The eagles are loyal to Derwyth and friendly to those who regard her home with respect. They spend their days soaring over the valley and watching for intruders.

The eagles offer to lead the characters to Derwyth's homestead. If the characters decline or offend Avri and Ivo, the eagles tell them to leave. If combat ensues, three [elk](3-Mechanics/CLI/bestiary/beast/elk-xmm.md) join the fray on initiative count 20 of the third round (losing initiative ties); the elk aid the eagles however they can. Attacking the eagles sours Derwyth's opinion of the characters, who fail her test (see the "Derwyth's Test" section later in this adventure).
...
> [!gallery]
> ![Map 3.2: Derwyth's Homestead](file://adventure/QftIS/036-map-3.02-derwyths-homestead.webp#gallery)
> ![Player Version](file://adventure/QftIS/037-map-3.02-derwyths-homestead-player.webp#gallery)
...
[Derwyth](3-Mechanics/CLI/bestiary/npc/derwyth-qftis.md) is a neutral good, elf [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) who has [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) out to 60 feet, speaks Common and Elvish, and has the following additional trait:
...
The stag statue in the alcove is made of fine wood and worth 160 gp. The chest is unlocked; it contains a bag of 50 gp; three [Potions of Healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) in ceramic flagons; gardening implements; and worn robes, cloaks, tunics, boots, and sandals.
...
![Derwyth the druid pets a blissful giant goat in her barn](file://adventure/QftIS/038-03-005.derwyth-the-druid.webp#center)
...
Three [giant goats](3-Mechanics/CLI/bestiary/beast/giant-goat-xmm.md) live here. If it's clear Derwyth is in danger, the goats come to her aid, but they're otherwise friendly toward strangers and usually don't mind being milked.

A character can attempt to milk a goat by making a DC 10 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. On a successful check, the goat produces one bucket's worth of milk. On a failed check, the goat delivers a swift, agitated kick, and the milker takes `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) bludgeoning damage and has the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition.
...
Derwyth's [saber-toothed tiger](3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm.md) lazes here during the druid's test (see the "Trial of Trust" section). The tiger is initially indifferent toward the party and doesn't stop characters from stealing food from the hut; however, it leaps to Derwyth's aid if the druid is in danger.
...
If the characters failed Derwyth's test or they otherwise break her trust, she orders them to leave. A character who offers an earnest apology can convince Derwyth to let them stay with a successful DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. If the characters don't make amends and refuse to leave the homestead, Derwyth attacks, calling the [saber-toothed tiger](3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm.md) in area H7 and the three [giant goats](3-Mechanics/CLI/bestiary/beast/giant-goat-xmm.md) in area H6 to back her up. If Derwyth is defeated, news of the battle quickly spreads to Beasts throughout Cernant Valley, who regard the characters with hostility.
...
After sharing this information, Derwyth offers the characters the opportunity to rest in her homestead before the party departs. If the characters made a good impression on her, she also gives them the three [Potions of Healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) from the chest in her room. The giant eagles Avri and Ivo then escort the characters out of Cernant Valley.
...
> [!gallery]
> ![Map 3.3: Derro Lair](file://adventure/QftIS/039-map-3.03-derro-lair.webp#gallery)
> ![Player Version](file://adventure/QftIS/040-map-3.03-derro-lair-player.webp#gallery)
...
The derro apprentice carries a decorative silver [dagger](3-Mechanics/CLI/items/dagger-xphb.md) with an ivory handle, worth 50 gp, along with a belt pouch containing 20 gp.
...
Shortly after the party arrives, a [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) emerges from the east tunnel and empties a basket of small rocks onto the pile below. The zombie is indifferent toward the characters and ignores them unless they try to get its attention, at which point it attacks.

#### D4: Temple

![Derro raiders and their zombie thralls work to clear a pile of stony rubble inside the derro's lair](file://adventure/QftIS/041-03-007.derro-raiders.webp#center)
...
Four [derro raiders](3-Mechanics/CLI/bestiary/aberration/derro-raider-qftis.md) and four [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) attempt to clear a collapsed passage. They hope to eventually reach a tunnel leading down to the Underdark (see area D10) blocked by debris.
...
Three [derro raiders](3-Mechanics/CLI/bestiary/aberration/derro-raider-qftis.md) and two [derro apprentices](3-Mechanics/CLI/bestiary/aberration/derro-apprentice-qftis.md) gather around a chest in the middle of this room. They're guarded by two [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md). The derro and their Undead thralls attack intruders on sight.

##### Fallen Star

Inside the chest rests the fallen star, laid reverently on a rich, red cloak. The 10-pound star is roughly spherical and about the size of a grapefruit. It's made of a black, glass-like material with a burnt appearance. The star is nonmagical but extremely resilient; it can't be destroyed by anything short of a [Disintegrate](3-Mechanics/CLI/spells/disintegrate-xphb.md) spell.

##### Treasure

One derro apprentice wears a pair of gold armbands worth 50 gp each, and the other apprentice has a [Potion of Diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md) hanging from their belt. The golden antlers are worth 300 gp each; they were stolen from the hunters of Therno Lake. The other crates in this room contain additional goods stolen from Therno Lake: casks of ale, dishware, fur coats, spears, and carved wooden trinkets.

![The Prophesied Fallen Star](file://adventure/QftIS/042-03-006.fallen-star.webp#center)
...
Five [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) are trapped in a small pocket of loose rubble (see the "Derro Lair Features" section). If the characters clear the rubble, the freed zombies attack their liberators.
...
The overseer's corpse has a [Wand of Magic Detection](3-Mechanics/CLI/items/wand-of-magic-detection-xdmg.md) in one hand and, in a pocket, the key to the locked chest in area `D7`. The corpse also wears a gold ring worth 50 gp. The boots, though stylish, are worth no more than ordinary boots.
...
A [lamia](3-Mechanics/CLI/bestiary/fiend/lamia-xmm.md) sits in this room. Formerly an ally of the derro, she used her magic to help the raiders learn Therno Lake's defenses. Secretly, many derro feared the lamia, and they were relieved when the cave-in trapped her here.
...
Therno Lake is home to a family of intelligent giant beavers. These beavers use the [giant weasel](3-Mechanics/CLI/bestiary/beast/giant-weasel-xmm.md) stat block with the following changes.
...
> [!gallery]
> ![Map 3.4: Therno Lake](file://adventure/QftIS/043-map-3.04-therno-lake.webp#gallery)
> ![Player Version](file://adventure/QftIS/044-map-3.04-therno-lake-player.webp#gallery)
...
Six hunters ([scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) are fishing in the lake, two per hunting boat. One is their community's leader, a red-haired human woman named Aspen.
...
An underwater entrance to this beaver lodge leads to an air pocket above water level. Inside, two friendly [giant beavers](3-Mechanics/CLI/bestiary/beast/giant-weasel-xmm.md) (see the "Giant Beavers" section) tend to five baby beavers. A pile of fish bones sits on one side of the room.
...
The hunters of Therno Lake live in this camp. Eight hunters ([scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) and twenty [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), all in thick leather clothes, make up the community. They are wary of outsiders but otherwise indifferent toward the characters.
...
![A stronghold of astrology and prophecy, the Tower of the Heavens stands in the middle of a vast, rushing river](file://adventure/QftIS/045-03-008.the-tower-of-the-heavens.webp#center)
...
Hadley (neutral good, human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) greets the characters with the first part of a secret phrase used by Shalfey and his allies. Hadley hopes the characters will reply, "but fairer the jewels of the evening." This phrase was part of the visions imparted by the memory web (see the "Flood of Memories" section earlier in this adventure), though the characters might not recognize its significance. A character who succeeds on a DC 14 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check gets the sense Hadley is looking for a specific reply.
...
- **Lighting.** The tower uses wall-mounted torches lit with [Continual Flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells, while the hostel uses ordinary lamps. The hostel's rooms are brightly lit during the day and dark at night, while the tower's rooms are always brightly lit.  
...
> [!gallery]
> ![Map 3.5: Tower of the Heavens](file://adventure/QftIS/046-map-3.05-tower-of-the-heavens.webp#gallery)
> ![Player Version](file://adventure/QftIS/047-map-3.05-tower-of-the-heavens-player.webp#gallery)
...
The Hostel Visitors table details guests the characters might encounter in the hostel. All adult visitors use the [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) stat block. If the characters failed to earn Hadley's trust earlier, you can use these visitors to spur the plot forward.
...
The door is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) trained to guard the staircase. It functions like an ordinary door until a creature it doesn't recognize tries to open it, at which point the mimic reveals its true nature and attacks. The mimic is friendly toward the tower sages, tower hands, and gnomes of the Griswill Garrison.
...
Three members of the Griswill Garrison (lawful neutral, gnome [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) sit here, relaxing between shifts. Accompanying them is the garrison's leader, Captain Mainwaring (lawful neutral, gnome [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md)).
...
At any given time, three members of the Griswill Garrison (lawful neutral, gnome [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) are sleeping in these beds with weapons close at hand. The larger bed belongs to Captain Mainwaring, leader of the Griswill Garrison (see area T6).
...
Dozens of boxes, casks, and sacks are neatly stacked on shelves and racks this storeroom, which holds food stores and equipment for the entire tower. Amid the provisions are two [explorer's packs](3-Mechanics/CLI/items/explorers-pack-xphb.md), two [scholar's packs](3-Mechanics/CLI/items/scholars-pack-xphb.md), and enough food and drink to sustain the tower's residents for a month.
...
When the characters enter, Cipolla and Porro silently direct the hands to attack. Meanwhile, the sages flee toward Piyarz in the scholars' hall (area T17), where they can more freely use their magic. Once there, Cipolla or Porro casts the [Arcane Lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell on the door to buy themselves time.

##### Silence

A permanent [Silence](3-Mechanics/CLI/spells/silence-xphb.md) spell pervades the library, eliminating all sound in this area. A [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell ends the effect. The magical silence prevents casting spells with verbal components.
...
Porro's desk drawer is locked and magically trapped. Porro carries its key (see area T12), and only he knows the password to safely unlock the drawer: "Altair." As an action, a character can unlock the door with a successful DC 15 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check using thieves' tools. If the drawer is unlocked without first speaking the password, a magical glyph inside the drawer triggers, erupting with icy wind in a 10-foot-radius sphere. Each creature in that area must make a DC 13 Constitution saving throw, taking `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) cold damage on a failed save or half as much damage on a successful one. The glyph vanishes after it triggers, and the wind doesn't damage the contents of the room.

##### Treasure

The desk drawer contains quills, ink, paper, a small necklace of emerald beads (worth 160 gp), a pouch holding 30 gp, and Porro's [spellbook](3-Mechanics/CLI/items/spellbook.md). The spellbook contains the spells in the [tower sage](3-Mechanics/CLI/bestiary/humanoid/tower-sage-qftis.md) stat block plus the following: [Color Spray](3-Mechanics/CLI/spells/color-spray-xphb.md), [Disguise Self](3-Mechanics/CLI/spells/disguise-self-xphb.md), and [Nystul's Magic Aura](3-Mechanics/CLI/spells/nystuls-magic-aura-xphb.md).
...
Piyarz is here with two [tower hands](3-Mechanics/CLI/bestiary/humanoid/tower-hand-qftis.md). His loyal [imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) rests smugly on his shoulder in the form of a raven. Piyarz is a lawful evil [tower sage](3-Mechanics/CLI/bestiary/humanoid/tower-sage-qftis.md) who wears a [Ring of Fire Resistance](3-Mechanics/CLI/items/ring-of-fire-resistance-xdmg.md), granting him resistance to fire damage.

If Cipolla or Porro successfully fled area T12, they're here as well, and one of them has cast the [Arcane Lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell on the south door to buy time.
...
Piyarz wears a [Ring of Fire Resistance](3-Mechanics/CLI/items/ring-of-fire-resistance-xdmg.md) and a platinum chain belt worth 300 gp.

![The treacherous sage Piyarz and two of his lackeys, Cipolla and Porro, lounge amid the spoils of their coup](file://adventure/QftIS/048-03-009.piyarz-cipolla-porro.webp#center)
...
The creature is a [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) in Piyarz's service. Commanded to guard the chamber, the spectator telepathically warns unauthorized entrants to "scram or get zapped" and attacks any who refuse.
...
The desk has a drawer containing parchment, quills, and ink. The coffer is unlocked and contains two [Potions of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md), a [Folding Boat](3-Mechanics/CLI/items/folding-boat-xdmg.md), 3,600 gp, and Piyarz's [spellbook](3-Mechanics/CLI/items/spellbook.md). The spellbook contains the spells in the [tower sage](3-Mechanics/CLI/bestiary/humanoid/tower-sage-qftis.md) stat block plus the following: [Color Spray](3-Mechanics/CLI/spells/color-spray-xphb.md), [Find Familiar](3-Mechanics/CLI/spells/find-familiar-xphb.md), [Locate Object](3-Mechanics/CLI/spells/locate-object-xphb.md), [Magic Missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), and [Sleep](3-Mechanics/CLI/spells/sleep-xphb.md).
...
![In a moment of desperation, Shalfey, Elder Sage of the Tower of the Heavens, burns the Books of Prophecy](file://adventure/QftIS/049-03-010.elder-sage.webp#center)
...
The statues are two [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md). They're trained to attack any visitors unaccompanied by a tower sage or tower hand.
...
Recently, a [young red dragon](3-Mechanics/CLI/bestiary/dragon/young-red-dragon-xmm.md) named Grisdelfawr made a lair near the forge and began terrorizing any svirfneblin who dared venture outside. To distract the dragon, the svirfneblin corralled a horde of [gibberlings](3-Mechanics/CLI/bestiary/fiend/gibberling-qftis.md), noisy fiends prevalent in the Underdark, and set them loose in the valley.
...
> [!gallery]
> ![Map 3.6: Forge of the Kagu-svirfneblin](file://adventure/QftIS/050-map-3.06-forge-of-the-kagu-svirfneblin.webp#gallery)
> ![Player Version](file://adventure/QftIS/051-map-3.06-forge-of-the-kagu-svirfneblin-player.webp#gallery)
...
A metal bridge spans this 5-foot-deep stream, which issues from the workshop in area F8 and is scalding hot. A creature that enters the stream for the first time on a turn or starts its turn there must make a DC 13 Constitution saving throw, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) fire damage on a failed save or half as much damage on a successful one.
...
The svirfneblin keep two [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) trained as mounts in these pens. A [gibberling](3-Mechanics/CLI/bestiary/fiend/gibberling-qftis.md) scrabbles at the bars in a frenzied attempt to get at the lizards. The gibberling attacks the characters on sight.
...
![Atop giant lizard steeds, the Kagu-svirfneblin emerge to greet visitors to their steam-powered forge](file://adventure/QftIS/052-03-011.kagu-svirfneblin.webp#center)
...
This area is "lightly obscured" by mist and steam. The clockwork machines are three [maschin-i-bozorgs](3-Mechanics/CLI/bestiary/construct/maschin-i-bozorg-qftis.md), created by the kagu-svirfneblin to guard their forge. The seven [svirfneblin](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)—each riding a [giant lizard](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md)—constitute the entire deep gnome population here. They eagerly expect the arrival of the prophesied star.

##### Steamy Stream

The steaming stream, which flows from the workshop in area F8, is scalding hot and 3 feet deep. A creature that enters the stream for the first time on a turn or starts its turn there must make a DC 13 Constitution saving throw, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) fire damage on a failed save or half as much damage on a successful one.
...
The locked alcove contains racks of items labeled in Gnomish. Among them are a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Fire Shield](3-Mechanics/CLI/spells/fire-shield-xphb.md), a [Potion of Heroism](3-Mechanics/CLI/items/potion-of-heroism-xdmg.md) labeled "magical vitality," and a jar of [Keoghtom's Ointment](3-Mechanics/CLI/items/keoghtoms-ointment-xdmg.md) mislabeled "war paint."
...
Two [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) reside within, guarding the kagu-svirfneblin's treasure. They lumber about in the darkness, tapping their long, bony claws along the floor. The hook horrors obey the deep gnomes but attack all other creatures on sight.
...
The machines are powered by steam from a large cylinder at the east end of the workshop, which is fed by a natural geyser. The kagu-svirfneblin built these machines according to their own designs, and only they know how to operate them. A character who tampers with the machines must make a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check. On a successful check, the contraptions whir and move but nothing disastrous happens. On a failed check, the character takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) fire damage from a blast of scalding steam.
...
After setting the machines in the workshop (area F8) to overload, the kagu-svirfneblin depart for the Underdark via the tunnel in area F10. The workshop machines soon begin to shake violently, causing the whole lair to tremble. One minute later, the steam cylinder in the workshop explodes, causing area F8 to cave in and dealing `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage to any creatures still in that room.

#### Death from Above

![The pitiless red dragon Grisdelfawr delights in terrorizing creatures of the Tegefed Mountains](file://adventure/QftIS/053-03-012.grisdelfawr.webp#center)

The detonation in the forge draws the attention of Grisdelfawr, the [young red dragon](3-Mechanics/CLI/bestiary/dragon/young-red-dragon-xmm.md) who recently took up residence in the Tegefed Mountains. Within moments of the explosion, Grisdelfawr begins circling over the misty gulch (area F1).
...
- [+1 Weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) (any)  

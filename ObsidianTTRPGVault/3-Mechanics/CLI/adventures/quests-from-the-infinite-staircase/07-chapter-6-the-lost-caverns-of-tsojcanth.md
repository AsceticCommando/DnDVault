...
Despite the decades since her disappearance, Iggwilv's impact persists in the caverns, where she is believed to have penned, at least in part, the [Demonomicon of Iggwilv](3-Mechanics/CLI/items/demonomicon-of-iggwilv-xdmg.md): her infamous treatise on the infinite layers of the Abyss and its inhabitants. Abyssal rifts—the byproducts of past magical experiments—leak demonic energy into the tunnels, and guardians bound from faraway planes await rescue or defend the caverns from thieves and trespassers. Other creatures have simply taken up residence in the cave system, adding to its dangers.

"The Lost Caverns of Tsojcanth" is designed for four to six 9th-level characters.

![Adventurers clash with the Behir Lludd in his lair within the Lost Caverns of Tsojcanth](file://adventure/QftIS/095-06-001.ch6-tsojcanth.webp#center)

## Background

![A door to the Lost Caverns](file://adventure/QftIS/096-06-002.lost-caverns-door.webp#center)
...
![](file://adventure/QftIS/097-06-003.the-lost-caverns-of-tsojcanth-original.webp#center)
...
![The hooked peak of Iggwilv's Horn towers over the rest of the Yatil Mountains](file://adventure/QftIS/098-06-004.iggwilvs-horn.webp#center)
...
The agent, Bannik Vorl (lawful neutral, human [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)), can offer the following details:
...
- **Travel Arrangements.** If requested, Bannik can supply each character with a sure-footed [riding horse](3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) and ten days of rations.  
...
> [!gallery]
> ![Map 6.1: Yatil Mountains](file://adventure/QftIS/099-map-6.01-yatil-mountains-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/100-map-6.01-yatil-mountains-map-player.webp#gallery)

### Mountain Encounters

While the characters are exploring or camping in the Yatil Mountains, roll a `dice:d20|noform|noparens|avg` (`d20`) three times per day of game time, checking for encounters each morning, afternoon, and night. An encounter occurs on a roll of 16 or higher. Alternatively, map 6.1 offers suggested locations where encounters might occur. To determine what the characters find, roll on the Mountain Encounters table, rerolling duplicates.
...
A group of human soldiers from a nation bordering the mountain range travels the road. A captain (use the [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) stat block) leads two [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) and six [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md). All the soldiers are lawful neutral. Their orders are to catch brigands and smugglers, drive monsters from the roads, and prevent raids.
...
Berythrach, a [young blue dragon](3-Mechanics/CLI/bestiary/dragon/young-blue-dragon-xmm.md), recently made her lair in a rugged valley between two low peaks. The dragon has been raiding the surrounding lands in ever-widening sweeps, expanding her territory.
...
A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) lumbers through the mountains, seeking revenge on a group of trolls that stole a hammer from the giant's forge. The giant is indifferent toward the characters and informs them of the trolls' theft. If the characters hunt down the trolls and return with the stolen hammer (see the "Troll Cave" encounter), the fire giant uses it to craft them a [Flame Tongue](3-Mechanics/CLI/items/flame-tongue-xdmg.md) sword of their choice; this process takes `dice:1d4|noform|noparens|avg` (`1d4`) days.
...
Five guards (lawful neutral, gnome [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) watch the canyon entrance at all hours. If the characters approach in a peaceful manner, one of the scouts runs back to the vale to fetch their leaders, Laira Na'Gwaylar (lawful good, gnome [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) and Saleen Glimmershade (neutral, gnome [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md)).
...
A nameless, wizened hermit (neutral good, human [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) lives in a simple hut in a wooded grove not far from one of the roads. He's been here as long as anyone can remember, seeking enlightenment in his solitude. Dirty and disheveled, the hermit dresses in simple, homespun clothing and carries no weapons, though he wears an invisible [Ring of Mind Shielding](3-Mechanics/CLI/items/ring-of-mind-shielding-xdmg.md) to protect his thoughts.
...
Two [wyverns](3-Mechanics/CLI/bestiary/dragon/wyvern-xmm.md) roost in a crevice atop a 100-foot-tall spire 1 mile from the road. They have a clutch of three eggs in their nest and are fiercely territorial of the surrounding area as a result. The wyverns take turns hunting and watching the eggs. When the characters near the roost, roll a die. On an odd number, only one wyvern is in the nest; on an even number, both wyverns are present.
...
![A ghastly visage outside the entry caverns portends the dangers within](file://adventure/QftIS/101-06-005.cavern-entrance.webp#center)
...
> [!gallery]
> ![Map 6.2: Lesser Caverns](file://adventure/QftIS/102-map-6.02-lesser-caverns-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/103-map-6.02-lesser-caverns-map-player.webp#gallery)
...
Twenty [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) hang from the ceiling of this cave. Bright light or any noise louder than a whisper disturbs the stirges, causing them to attack.
...
The figure is a [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) created by Iggwilv to destroy intruders. The golem attacks any creatures that enter the chamber. The golem fights to the death and pursues trespassers relentlessly, even chasing them out of the caverns.

##### Treasure

The weapon stuck in the clay golem is a slender-bladed [Giant Slayer (shortsword)](3-Mechanics/CLI/items/giant-slayer-xdmg.md). The sword's name ("Longtooth") is engraved into the blade in Gnomish. Once the golem is destroyed, the sword can easily be freed from its chest.
...
The ceiling of this soiled cave is 50 feet high. This cave once hosted dozens of bats, but a [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) that dwells here devoured them. The hungry creature hides among the stalactites, waiting to fall on one of the characters.
...
![Four pechs diligently dig a staired tunnel up into the mountain, decorating its walls with carvings](file://adventure/QftIS/104-06-006.digging-pechs.webp#center)
...
The carvings on the walls depict cave-dwelling creatures such as bats and reptiles, as well as creatures from the Elemental Plane of Earth such as [dao](3-Mechanics/CLI/bestiary/elemental/dao-xmm.md), [pechs](3-Mechanics/CLI/bestiary/elemental/pech-qftis.md), [xorn](3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md), and [earth elementals](3-Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md). Characters who inspect the carvings and succeed on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check identify the planar creatures.
...
Three ghost-white cave crickets (use the [giant frog](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md) stat block) nibble at the glowing mushrooms in this cave, which radiate dim light. The crickets are indifferent toward the characters.
...
The elf corpse carries a [silvered rapier](3-Mechanics/CLI/items/silvered-weapon-xdmg.md) and wears [Bracers of Defense](3-Mechanics/CLI/items/bracers-of-defense-xdmg.md).

#### L9: Stinking Cave

![Three hungry trolls pass the time in their foul-smelling cave](file://adventure/QftIS/105-06-007.three-trolls.webp#center)
...
Gathered under the trolls' beds is their accumulated loot: 120 gp, 900 sp, four gems worth 50 gp each, wooden dentures set with mother-of-pearl teeth (worth 50 gp), a quiver with twenty [silvered arrows](3-Mechanics/CLI/items/silvered-ammunition.md), and a [Potion of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md).
...
While the bats are roosting, bright light or any noise louder than a whisper agitates them and sends them into a panic. A number of [swarms of bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) equal to the number of characters in this area descend from the ceiling and attack the source of the disturbance. The swarms extinguish any nonmagical light sources they come within 5 feet of with a flurry of buffeting wings.
...
The indentations are the rock-cyst burrows of four cave morays—sluglike scavengers that slither between the burrow entrances through tunnels in the rock. The cave morays use the [giant poisonous snake](3-Mechanics/CLI/bestiary/beast/giant-venomous-snake-xmm.md) stat block. They use their reach to bite at prey from the safety of their burrows.
...
Loud sounds here, including the din of battle, draw the attention of the [fomorians](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) in area L12. The cave morays retreat into their burrows when the fomorians arrive.
...
Two [fomorians](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) inhabit this cave. The beds, fire pit, and utensils are all sized for Huge creatures.
...
Stashed beneath the fomorians' beds are two ivory mammoth tusks (each is worth 600 gp and weighs 100 pounds), a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Levitate](3-Mechanics/CLI/spells/levitate-xphb.md), and a beaten copper bowl with lapis lazuli handles, which is worth 750 gp.
...
The vessel is a [Folding Boat](3-Mechanics/CLI/items/folding-boat-xdmg.md) created to traverse the lake and the rivers that branch from it. In addition to its usual properties, the boat has an extra command word that functions only while the boat is within the Lost Caverns. A character who knows this extra command word ("Shrimpkin")—discovered by casting the [Identify](3-Mechanics/CLI/spells/identify-xphb.md) spell on the boat or by examining clues in the boat's intricate designs and succeeding on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check—can command the boat to row itself in a particular direction at a speed of 30 feet or to hold its position in defiance of the water's swiftest currents.
...
Four [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) lurk near the lake bed, 90 feet below the surface. They're content to creep along the lightless depths and prey on cave fish unless something else catches their attention. Bright light draws the chuuls to the water's edge, as does any magic in the lake or near its surface, such as the boat from area L13. If drawn to the surface, the chuuls attack.
...
Four [basilisks](3-Mechanics/CLI/bestiary/monstrosity/basilisk-xmm.md) dwell in this cave. Toward the back of the cave is a nest where the basilisks lay eggs. The basilisks are protective of their den, attacking any creatures that enter the cave.

##### Treasure

The head and shoulder of a [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) gnome lie near the basilisk nest at the back of the cave. The broken statue wears a pair of unpetrified goggles, which are [Eyes of Minute Seeing](3-Mechanics/CLI/items/eyes-of-minute-seeing-xdmg.md).
...
The remains of a [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) adventurer stand among the stalagmites. A [Bag of Holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md) hangs from the drab statue, which is missing its head. The bag contains a set of robes, 9 days of rations, a lacquered pipe, and a scorched [spellbook](3-Mechanics/CLI/items/spellbook.md) containing the following spells: [Darkvision](3-Mechanics/CLI/spells/darkvision-xphb.md), [Fog Cloud](3-Mechanics/CLI/spells/fog-cloud-xphb.md), [Grease](3-Mechanics/CLI/spells/grease-xphb.md), [Identify](3-Mechanics/CLI/spells/identify-xphb.md), and [Web](3-Mechanics/CLI/spells/web-xphb.md).
...
Three [xorn](3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md) from the Elemental Plane of Earth found their way to this cave through a planar rift that has since closed, stranding them here. The xorn are initially indifferent to the characters but defend themselves if attacked.
...
The river dead-ends in this flooded chamber. A [marid](3-Mechanics/CLI/bestiary/elemental/marid-xmm.md) named Kasdu'ul is trapped at the bottom of the pool, 30 feet below the surface. An unbreakable stone cage etched with glowing runes confines the genie to the pool. Characters who look into the pool and succeed on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notice the cage's faint, glimmering light in the water.

##### Bound Genie

Kasdu'ul was trapped here by the dao Kashem (see area L18) centuries ago, shortly before Kashem was fooled and bound by Iggwilv in turn. A permanent [Antipathy/Sympathy](3-Mechanics/CLI/spells/antipathy-sympathy-xphb.md) spell (save DC 18) protects the cage and repels creatures that aren't native to the Elemental Plane of Earth with its Antipathy effect. The runes on the cage invoke the hatred of Ogrémoch, the Prince of Evil Earth.
...
- A successful [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 18) spell cast on the cage causes it to crumble.  
...
As thanks for freeing her, she's willing to cast [Tongues](3-Mechanics/CLI/spells/tongues-xphb.md), [Water Breathing](3-Mechanics/CLI/spells/water-breathing-xphb.md), and [Water Walk](3-Mechanics/CLI/spells/water-walk-xphb.md) on the characters to facilitate their exploration. If the characters also present proof of Kashem's demise—such as a pinch of the dust left behind after her death—or they offer a convincing story and succeed on a DC 17 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check, Kasdu'ul summons a [water weird](3-Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) and orders it to serve the characters for 1 hour, after which it vanishes. In either case, Kasdu'ul then bids the characters farewell and returns to the Elemental Plane of Water.
...
> [!gallery]
> ![Map 6.3: Greater Caverns](file://adventure/QftIS/106-map-6.03-greater-caverns-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/107-map-6.03-greater-caverns-map-player.webp#gallery)
...
The hezrou's chamber contains a [Potion of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) and a [Sword of Vengeance (longsword)](3-Mechanics/CLI/items/sword-of-vengeance-xdmg.md).
...
The calcified corpses include dead explorers, troglodytes, and cave-dwelling creatures. A wicked spirit of hunger (use the [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) stat block) resides here, a sliver of the lesser god Laogzed's power. The troglodytes worship this ravenous spirit and offer up captives and treasure to it as sacrifices. Seven [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md) created by the spirit lie dormant in their former bodies, awaiting its command.

When the characters enter the cavern, the spirit and specters attack, eager to feed off the characters' life force.

##### Treasure

Scattered on the floor at the far end of the chamber are 480 gp, 800 sp, twenty assorted gems worth 50 gp each, and a sealed scroll tube with a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Raise Dead](3-Mechanics/CLI/spells/raise-dead-xphb.md).

![A spirit of hunger emerges from a wall of calcified corpses to devour the souls of the living](file://adventure/QftIS/108-06-008.spirit-of-hunger.webp#center)
...
The ceiling of this long cavern rises to a height of 50 feet. Careful examination of the floor reveals many cracked bone fragments among the fungi. This is the lair of Lludd, a clever and long-lived [behir](3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) who speaks Common and Giant in addition to Draconic. Lludd lurks on a ledge near the entrance to the chamber, waiting for morsels worthy of his hunger.
...
Inside Lludd's stomach is a [Periapt of Proof against Poison](3-Mechanics/CLI/items/periapt-of-proof-against-poison-xdmg.md) left over from an unlucky explorer the behir digested.
...
The rolling boulders are three [galeb duhr](3-Mechanics/CLI/bestiary/elemental/galeb-duhr-xmm.md), created and bound by Iggwilv to defend this cave. The elementals attack any intruders.

##### Treasure

A scattering of treasure glints in the bottom of the cave: 60 pp, 285 gp, 87 sp, three rubies worth 300 gp each, and a [+1 War Pick](3-Mechanics/CLI/items/1-weapon-xdmg.md).
...
Two [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md) burrowed through this area recently. Though their tunnels collapsed behind them, the creatures lurk just beyond the alcove. If the irritable umber hulks detect the characters, the monsters burst through the rubble and attack.
...
The three [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) pose no threat to the characters. As they graze, the lizards nervously eye anyone who approaches them and keep their distance.

If a character casts the [Speak with Animals](3-Mechanics/CLI/spells/speak-with-animals-xphb.md) spell or uses other means to communicate with the lizards, the reptiles explain one of their siblings was recently slain by a terrible, red-furred creature from a large cave to the west (see area G8). If the characters avenge the lizards' fallen kin, one of the lizards agrees to serve the party as a cavern guide and mount for the next hour.

![A barlgura leers atop a pillar infused with Abyssal energy](file://adventure/QftIS/109-06-009.barlgura.webp#center)
...
Two [gas spores](3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) grow in this cavern, one tucked among the boulders near the sinkhole and the other in the hole itself. When a creature comes within 30 feet of either spore, both spores attack.
...
Four [barlguras](3-Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) lair in this dimly lit cave. Each demon perches on one of the pillars, waiting to ambush unsuspecting entrants. When combat begins in this area, the pillars activate.
...
Each of the pillars has Armor Class 17, 50 hit points, immunity to poison and psychic damage, and vulnerability to radiant damage. Destroying the pillars prevents them from emitting Abyssal energy. A [Hallow](3-Mechanics/CLI/spells/hallow-xphb.md) spell cleanses the pillars, accomplishing the same feat.
...
The characters arrive in the presence of two [minotaurs](3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md), each accompanied by a [gorgon](3-Mechanics/CLI/bestiary/construct/gorgon-xmm.md). Servants of Baphomet, the minotaurs seek to offer up the characters' heads as gifts to the demon lord. The gorgons obey the minotaurs' spoken commands.
...
| 13–14 | A bloodthirsty [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) with crooked horns |
| 15–16 | An enormous, rampaging giant bull (use the [mammoth](3-Mechanics/CLI/bestiary/beast/mammoth-xmm.md) stat block) |
| 17–18 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [minotaurs](3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
| 19–20 | An aspect of the demon lord Baphomet (use the [goristro](3-Mechanics/CLI/bestiary/fiend/goristro-xmm.md) stat block) |
^labyrinth-encounters

##### Treasure

Near the labyrinth's exit, a desiccated, severed hand clutches a [+2 Greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md).
...
This box canyon on the plane of Elysium tests the compassion and resolve of those trapped within. Six [centaurs](3-Mechanics/CLI/bestiary/fey/centaur-trooper-xmm.md) who speak Common were exploring the canyon when its walls collapsed, stranding them here. Unable to scale the sheer, 60-foot-high walls, the centaurs are out of ideas. The centaurs are friendly toward the characters unless attacked.
...
Shaydun wears a magic necklace adorned with a small silver horseshoe. The necklace allows the creature wearing it to cast the [Plane Shift](3-Mechanics/CLI/spells/plane-shift-xphb.md) spell once, after which the necklace loses its magic.
...
A [Levitate](3-Mechanics/CLI/spells/levitate-xphb.md) spell allows a creature imprisoned in one of the pentacles to rise through the prison's area of effect and up to the ceiling. This exception doesn't apply to other forms of flight, such as the [Fly](3-Mechanics/CLI/spells/fly-xphb.md) spell or wings.

A character who examines the pentacle beneath them and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check notices smudges along the metal, suggesting someone traced the shape in the past. If the character traces the shape of the pentacle imprisoning them, they gain the effects of a [Levitate](3-Mechanics/CLI/spells/levitate-xphb.md) spell for 1 minute, with no concentration required.
...
- **Dispelling the Circle.** A successful [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell (DC 15) cast on the pentacle suppresses its magic for 1 hour, freeing the creature inside.  
- **Levitation.** A [Levitate](3-Mechanics/CLI/spells/levitate-xphb.md) spell allows a character to rise out of the pentacle's area of effect.  
...
Propped against a column near one of the pentacles is a [Weapon of Warning (glaive)](3-Mechanics/CLI/items/weapon-of-warning-xdmg.md) veined with hellfire.
...
This checkpoint is located on Mechanus, a plane of absolute order. The three automatons (lawful neutral [helmed horrors](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md)) attack the characters, who are unauthorized visitors. On initiative count 20 of the next round (losing initiative ties), up to three more automatons (lawful neutral suits of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md)) emerge from the wall to replace any that were slain. These reinforcements continue to appear until the characters leave the area or die trying.
...
Two [chasmes](3-Mechanics/CLI/bestiary/fiend/chasme-xmm.md) buzz out from the rift and attack. At the end of each round, roll a `dice:d20|noform|noparens|avg` (`d20`). On a 10 or lower, another [chasme](3-Mechanics/CLI/bestiary/fiend/chasme-xmm.md) wriggles through the portal.

![Within the Lost Caverns, Iggwilv penned her fabled treatise on demons. The tome disappeared when she did](file://adventure/QftIS/110-06-010.the-tome.webp#center)
...
- **Dispelling the Book.** A [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the book suppresses its magic for 1 hour.  

Closing the portal doesn't return escaped chasmes to the Abyss.

##### Treasure

Amid the bones on the floor is a [Cloak of Elvenkind](3-Mechanics/CLI/items/cloak-of-elvenkind-xdmg.md).
...
The skull belonged to a wizard who challenged Iggwilv and lost badly. The garment nearby, however, is a motionless [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) that ambushes any creature that approaches the coffer.

##### Treasure

The coffer is worth 750 gp. It contains ten cracked emeralds worth 100 gp each and a jar of [Keoghtom's Ointment](3-Mechanics/CLI/items/keoghtoms-ointment-xdmg.md).
...
Two [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) lurk among the calcite columns at the cavern's south end. The monsters attack when they can each lash out at a victim with their tendrils.
...
The remains of rotting mushrooms litter this chamber. Three [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) thrive amid the detritus. When the characters enter the cave, the creatures lurch out of the piles of filth and attack.

The stone giant in area G14 regularly tosses dead mushrooms in to feed the shambling mounds.

##### Treasure

Buried in the rotting mush is a collection of shiny objects the shambling mounds have gathered, including 340 gp, a [Potion of Clairvoyance](3-Mechanics/CLI/items/potion-of-clairvoyance-xdmg.md), and a silver scroll tube worth 125 gp containing a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Cloudkill](3-Mechanics/CLI/spells/cloudkill-xphb.md).
...
This is the lair of Zyzkathol, a chaotic evil [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) who succumbed to the demonic energy that permeates the greater caverns. He's accompanied by two giant beetles (use the [rhinoceros](3-Mechanics/CLI/bestiary/beast/rhinoceros-xmm.md) stat block). When at rest, the beetles resemble boulders, requiring a successful DC 18 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check to discern they're animate.
...
The fungus here is a food source for many of the greater caverns' creatures, including eight [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) that are currently feeding here. If the shriekers sound off, Zyzkathol and his giant beetles (see area G14) come to investigate.
...
An [adult black dragon](3-Mechanics/CLI/bestiary/dragon/adult-black-dragon-xmm.md) named Calumnus recently moved into this vast cavern, whose natural ceiling rises to a height of 60 feet. Calumnus is aggressive and territorial, attacking all who enter, but the dragon retreats if reduced to 50 hit points or fewer.

##### Treasure

The treasure near the west wall is the dragon's hoard. It includes 67 pp, 235 gp, 2,750 sp, assorted gems worth 700 gp, and an ivory case worth 300 gp containing a [Wand of Magic Missiles](3-Mechanics/CLI/items/wand-of-magic-missiles-xdmg.md).
...
This chamber is yet another trap devised to foil would-be plunderers. The demonic idol uses the [stone golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) stat block but is carved in the likeness of a nalfeshnee. While the idol remains motionless, it's indistinguishable from an ordinary statue.

When the characters enter the chamber, a [Magic Mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell cast on the idol utters the following:
...
![Great iron doors mark the entrance to the Witch Queen's inner sanctum](file://adventure/QftIS/111-06-011.inner-sanctum.webp#center)
...
The inner sphere is cloaked by a permanent [Mordenkainen's Private Sanctum](3-Mechanics/CLI/spells/mordenkainens-private-sanctum-xphb.md) spell. The spell can't be dispelled—the magic is woven into the construction of the sphere. Iggwilv delighted in using her old rival's signature spell against his efforts to spy on her and locate her treasures.
...
- A [Manual of Bodily Health](3-Mechanics/CLI/items/manual-of-bodily-health-xdmg.md)  
- A [Manual of Gainful Exercise](3-Mechanics/CLI/items/manual-of-gainful-exercise-xdmg.md)  
- A [Manual of Quickness of Action](3-Mechanics/CLI/items/manual-of-quickness-of-action-xdmg.md)  
- A [Tome of Clear Thought](3-Mechanics/CLI/items/tome-of-clear-thought-xdmg.md)  
- A [Tome of Leadership and Influence](3-Mechanics/CLI/items/tome-of-leadership-and-influence-xdmg.md)  
- A [Tome of Understanding](3-Mechanics/CLI/items/tome-of-understanding-xdmg.md)  

Additionally, Drelnza's coffin holds a small golden birdcage. The cage is a magical prison that functions as an [Iron Flask](3-Mechanics/CLI/items/iron-flask-xdmg.md). Unlike a typical *Iron Flask*, however, a creature trapped inside has the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) condition but can perceive through the cage and converse with nearby creatures. The birdcage is filled with bracelets, rings, and necklaces made of platinum, diamonds, and rubies worth a total of 10,000 gp.
...
> 
> In the original version of this adventure, Iggwilv's foremost treatise on the Abyss, the [Demonomicon of Iggwilv](3-Mechanics/CLI/items/demonomicon-of-iggwilv-xdmg.md), appeared as part of the trove in the departed archmage's inner sanctum. If you'd like to include that book as part of Iggwilv's hoard, you can find it described in "Tasha's Cauldron of Everything".
^499

![Iggwilv's greatest treasure—her daughter, the vampire Drelnza—defends what remains of the archmage's hoard](file://adventure/QftIS/112-06-012.drelnza.webp#center)
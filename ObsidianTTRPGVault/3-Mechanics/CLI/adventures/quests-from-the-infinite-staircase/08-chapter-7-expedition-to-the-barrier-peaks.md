...
![Aphelion 3000, an evil supercomputer, commands a fleet of cold-hearted robots on a crashed spaceship](file://adventure/QftIS/113-07-001.ch7-barrier-peaks.webp#center)

## Background

![A door to the Barrier Peaks](file://adventure/QftIS/114-07-002.barrier-peaks-door.webp#center)
...
![](file://adventure/QftIS/115-07-003.expedition-to-the-barrier-peaks-original.webp#center)
...
![Aphelion's gladsome visage appears on the screen of a computer terminal](file://adventure/QftIS/116-07-004.computer-terminal.webp#center)
...
- [Antimatter rifle](3-Mechanics/CLI/items/antimatter-rifle-xdmg.md)  
- [Energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md)  
- [Laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md)  
- [Laser rifle](3-Mechanics/CLI/items/laser-rifle-xdmg.md)  
- [Smoke grenade](3-Mechanics/CLI/items/smoke-grenade-xdmg.md)  

Additional technological devices are provided in appendix A. Many of these devices use [energy cells](3-Mechanics/CLI/items/energy-cell-xdmg.md) as ammunition or power sources. Energy cells found on the spaceship look like blue, coin-sized glass discs.
...
|--------------------------|--------|
| 4 or lower | One failure; 1 charge or use is wasted, if applicable; character takes `dice:2d6\|noform\|noparens\|avg\|text(7)` (`2d6`) lightning damage and has disadvantage on next check |
...
For each hour the party spends on the spaceship, roll a `dice:d12|noform|noparens|avg` (`d12`). On a roll of 1, an encounter occurs. To determine what the characters encounter, roll on the Random Spaceship Encounters table.
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [vegepygmy thorny hunters](3-Mechanics/CLI/bestiary/plant/vegepygmy-thorny-hunter-qftis.md) |
| 2 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) |
...
| 9 | A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) with a moan like a klaxon |
| 10 | A [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) with a metallic sheen |
^random-spaceship-encounters
...
| 3 | A [laser rifle](3-Mechanics/CLI/items/laser-rifle-xdmg.md) with a depleted [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md) rests under a rusty bed. |
...
| 7 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) Humanoid skeletons are sprawled on the floor. One carries a key card whose color matches this room's door. If the door is open or doesn't require a key card, the skeleton carries a blue key card. |
| 8 | A metal box stamped with a lightning bolt rests on the floor of this room. Inside are `dice:1d4\|noform\|noparens\|avg` (`1d4`) [energy cells](3-Mechanics/CLI/items/energy-cell-xdmg.md). |
...
> [!gallery]
> ![Map 7.1: Spaceship Level 1](file://adventure/QftIS/117-map-7.01-spaceship-level-1-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/118-map-7.01-spaceship-level-1-map-player.webp#gallery)
...
A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) lurks above, waiting to ambush the characters. The creature strikes at an opportune moment.
...
The hand tools scattered around the robot make up a complete set of [tinker's tools](3-Mechanics/CLI/items/tinkers-tools-xphb.md) formerly used by the robot to repair areas of the ship. The tools can be used to pry open the robot's chest plate and access the contents of its torso.

##### Treasure

Inside the robot's chest compartment are five gems worth 50 gp each. Safely retrieving the gems without getting electrocuted by exposed wiring requires a successful DC 16 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check. On a failed check, a character takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) lightning damage and doesn't retrieve the gems.
...
- `dice:1d6+2|noform|noparens|avg` (`1d6 + 2`) [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md)  
- `dice:1d6+2|noform|noparens|avg` (`1d6 + 2`) [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md)  
- `dice:1d6+2|noform|noparens|avg` (`1d6 + 2`) [smoke grenades](3-Mechanics/CLI/items/smoke-grenade-xdmg.md)  
...
Spare components fill bins near the repair area. A character who searches the bins and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds `dice:1d4|noform|noparens|avg` (`1d4`) energy cells and three spaceship trinkets (roll thrice on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md)).
...
![A worker robot roams the wreckage of an abandoned dining room](file://adventure/QftIS/119-07-005.abandoned-dining-room.webp#center)
...
Six [displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) dwell in the southeast lounge. Their den is a collection of bones, chewed-up power cables, shredded upholstery, and soiled uniforms. The displacer beasts are hungry and territorial. The predators attack the characters on sight but flee if three or more of their clowder are slain.
...
Two [gray slaadi](3-Mechanics/CLI/bestiary/aberration/gray-slaad-xmm.md) use the supplies in this art room to create an abstract mural. The slaadi pause intermittently to criticize each other's work in muttered croaks. They are hostile toward intruders.
...
Two [healer's kits](3-Mechanics/CLI/items/healers-kit-xphb.md) are mounted on the walls of this room. The cabinets contain three vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md) and expired medications in little orange bottles. The medications have lost their potency and have no effect if taken.

In addition to its built-in healing capabilities, the android carries a canister of healing spray (an aerosolized jar of [Keoghtom's Ointment](3-Mechanics/CLI/items/keoghtoms-ointment-xdmg.md)). The android kindly administers one dose of the spray to characters who need it.
...
This web-covered room is the nest of eight [phase spiders](3-Mechanics/CLI/bestiary/monstrosity/phase-spider-xmm.md). When the characters enter, the spiders are away, hunting on the Ethereal Plane. The spiders return 1 minute later and attack any creatures in their nest.

Stuck to the ceiling are `dice:1d6+2|noform|noparens|avg` (`1d6 + 2`) cocoons containing the desiccated remains of dead crew, passengers, and pets. A character who searches a cocoon and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds one spaceship trinket. Roll on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md) to determine the trinket. On a failed check, the character mistakenly punctures an egg sac, causing a hostile [swarm of insects (spiders)](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) to burst forth from the cocoon.
...
| dice: d4 | Description |
|----------|-------------|
| 1 | Two [worker robots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) attempt to corner a three-eyed [giant toad](3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) in this room. All three creatures ignore the effects of radiation. If the characters capture or slay the toad, the robots reward the characters with two spaceship trinkets (roll twice on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md)). |
| 2 | Two [blue slaadi](3-Mechanics/CLI/bestiary/aberration/blue-slaad-xmm.md) take turns drinking radioactive gunk oozing from a busted pipe that juts from the wall. The slaadi attack the characters on sight and ignore the effects of radiation. |
...
| 4 | The skeleton of a crew member leans against the wall on the far side of this room, clutching a fully loaded [laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md). |
^irradiated-room-contents
...
Bioluminescent fungi carpet the floor of this damp, dimly lit corridor, which reeks of mold. The vegepygmies cultivate the fungi as both a food source and a warning system. At each end of this corridor grows a 10-foot-wide fungal cluster containing four [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md). Other fungi grow in a humus layer spread along the length of the passage.
...
The vegepygmies keep a stockpile of technology scavenged from the ship hidden behind the grill of a small air duct in this room. The cache includes two [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md), a moldy [laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md), and a red key card. The pistol can fire 15 shots before its [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md) is drained.

#### S17: Will-o'-Wisps (Violet)

Three [will-o'-wisps](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) haunt these two abandoned rooms and roam the corridor outside. When they detect a creature, the will-o'-wisps attempt to lure it to the nearest irradiated room (see area S13), where they attack. The will-o'-wisps ignore the effects of radiation.
...
East of the office is a locked storage closet secured with a five-digit code. A character who searches the room and succeeds on a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) finds the code (07734) scrawled under a paperweight on the commander's desk. Inside the closet is a fully charged [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md) and `dice:1d4|noform|noparens|avg` (`1d4`) [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md). An unlocked safe on the closet floor contains twenty plastic-encased diamonds worth 100 gp each.
...
A makeshift [laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md), haphazardly cobbled together from spare robot parts, lies on the desk. The pistol can fire 20 shots before its [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md) is drained. After its last shot is expended, the weapon becomes inoperable. The energy cell can't be removed or recharged.
...
The rooms are damp, simple apartments with scant furnishings, and most vegepygmies leave the doors open. Roll a `dice:d6|noform|noparens|avg` (`d6`) for each room. On a 6, a glass wall pocket inside the room contains a violet key card. The rooms otherwise contain nothing of value.
...
The two rooms to the south are both exam rooms. Each contains an exam table, a couple of chairs, and a workspace for medical professionals. A [healer's kit](3-Mechanics/CLI/items/healers-kit-xphb.md) is mounted on the wall inside each room.
...
This room was a special hydroponic culture lab. The old cultures have died, and the lab has since been overtaken by two patches of [yellow mold](3-Mechanics/CLI/traps-hazards/yellow-mold-xdmg.md).

##### S24c: Chemical Storage

The majority of the chemicals stored in this room are no longer active or have no use to those ignorant of advanced chemistry. Useful items include three vials of [acid](3-Mechanics/CLI/items/acid-xphb.md), a [flask of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), and a jar containing [Dust of Sneezing and Choking](3-Mechanics/CLI/items/dust-of-sneezing-and-choking-xdmg.md).
...
![A suit of powered armor stands in a metal alcove](file://adventure/QftIS/120-07-006.powered-armor.webp#center)
...
This room contains six containment cells, each protected by a permanent [Wall of Force](3-Mechanics/CLI/spells/wall-of-force-xphb.md) spell. The spell can be disabled or reactivated for a cell by inserting a red key card into a card-lock panel outside that cell like those found on doors throughout the ship. The cells are currently empty, but a combat robot from area S26 roves this area at the end of each hour.
...
The alcove is the chief's personal locker. It is card-locked and requires a red key card to open. Inside are a pristine officer's uniform decorated with three glass medals and a suit of [powered armor](3-Mechanics/CLI/items/powered-armor-qftis.md) with a depleted [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md).
...
The monitor has an on-off switch, a toggle for zooming in and out, and dials to cycle through the ship's rooms. As an action, a character can adjust the dials to glimpse the contents of another room on this level. Have the character choose a number between 1 and 30, then describe the room that corresponds to that area number. On a result of 27, the screen shows an unflattering angle of the viewing character's face. For areas with multiple rooms, the screen displays a view of your choice. Each time the monitor is used, roll a `dice:d6|noform|noparens|avg` (`d6`). On a 1, the screen fizzles and goes black, and the monitor can't be used again.

#### S28: Armory (Platinum)

This partially stripped armory holds an arsenal of dangerous technology. An unlocked metal chest on the floor contains ten [energy cells](3-Mechanics/CLI/items/energy-cell-xdmg.md).
...
- Ten [smoke grenades](3-Mechanics/CLI/items/smoke-grenade-xdmg.md)  
...
- An [antimatter rifle](3-Mechanics/CLI/items/antimatter-rifle-xdmg.md)  
- Four [laser pistols](3-Mechanics/CLI/items/laser-pistol-xdmg.md)  
- Two [laser rifles](3-Mechanics/CLI/items/laser-rifle-xdmg.md)  
...
This emergency storage area contains dehydrated provisions sufficient to equal one hundred days of rations. There are also three healing syringes—injectable [Potions of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md)—four vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md), and three restorative ampules. If consumed by a creature as an action, each ampule reduces the creature's [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) level by 1.
...
For each task the characters complete, Aphelion rewards the characters with a firearm and three grenades from the armory (area S28), with a preference for devices the characters don't already possess. If the characters previously looted that area, Aphelion gifts them four [energy cells](3-Mechanics/CLI/items/energy-cell-xdmg.md) instead. The items are delivered by a [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) that arrives via the nearest drop tube before returning to the first level of the ship.
...
> [!gallery]
> ![Map 7.2: Spaceship Level 2](file://adventure/QftIS/121-map-7.02-spaceship-level-2-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/122-map-7.02-spaceship-level-2-map-player.webp#gallery)
...
Two [fomorians](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) rummage through the containers for food. Mutated by radiation on the ship, the giants are riddled with hideous boils that throb with a pale-green glow. The ravenous fomorians attack the characters on sight.
...
A [githyanki knight](3-Mechanics/CLI/bestiary/aberration/githyanki-knight-xmm.md) and five [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) search this cargo hold for [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md). The githyanki are initially indifferent toward the characters and know nothing of the ship's history. One of them carries a violet key card.
...
Ten [gas spores](3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) grow here. They are hostile toward all entrants.
...
![A mind flayer in a spacesuit](file://adventure/QftIS/123-07-007.space-mind-flayer.webp#center)
...
Two [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) dwell here. The illithids discovered the ship weeks ago and have been studying its technology ever since, intent on using it to conquer other worlds. Four [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) loyal to the mind flayers hide under the first row of seats in the audience. The intellect devourers fiercely defend their creators, who attack intruders on sight.
...
The technology on the mind flayers' workstation includes two [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md), a red key card, and a [laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md). The pistol can fire 5 more shots before its [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md) is drained.
...
Four [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) thrive in the shade of this fungal bush. The fomorians in the east cargo hold (area S33b) investigate any shrieking here, breaking down the cargo doors in the process.
...
Three conical, carnivorous plants with rocklike bark and grasping vines occupy this stretch of the walkway. The creatures use the [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) stat block but are Plants instead of Monstrosities. They are hostile toward all non-Plant creatures.
...
![Three malfunctioning physical training androids prepare to mete out hard-earned lessons in the ring](file://adventure/QftIS/124-07-008.training-androids.webp#center)
...
The supplies in this room includes a canister of healing spray (an aerosolized jar of [Keoghtom's Ointment](3-Mechanics/CLI/items/keoghtoms-ointment-xdmg.md)), ten [healer's kits](3-Mechanics/CLI/items/healers-kit-xphb.md), three vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md), and a yellow key card on a Humanoid skeleton.

#### S43: Whirlpools

Three 5-foot-diameter pools swirl with fetid brine in this muggy room. Passengers relaxed in these former mineral baths, which are now contaminated. Three [grells](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) hide here, each slurping from its own pool, waiting to ambush creatures that pass by.
...
An [aboleth](3-Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) lurks at the deep end of the pool. During the chaos of the outbreak and the events that followed, the aboleth escaped a laboratory tank in another part of the ship and made this area its lair.
...
| 4 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [barkburrs](3-Mechanics/CLI/bestiary/plant/barkburr-qftis.md) |
| 5 | A [swarm of gibberlings](3-Mechanics/CLI/bestiary/fiend/swarm-of-gibberlings-qftis.md) |
| 6 | A carnivorous plant sapling (use the [awakened shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub-xmm.md) stat block) |
| 7 | A six-eyed [giant toad](3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) |
| 8 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) bunnyoids (use the [weasel](3-Mechanics/CLI/bestiary/beast/weasel-xmm.md) stat block) |
^random-garden-encounters
...
> [!gallery]
> ![Map 7.3: Spaceship Level 3](file://adventure/QftIS/125-map-7.03-spaceship-level-3-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/126-map-7.03-spaceship-level-3-map-player.webp#gallery)
...
If the characters remain in this room for 10 minutes or longer, three [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md) burrow up from a hole beneath one of the containers and attack.
...
The baby aurumvoraxes use the [badger](3-Mechanics/CLI/bestiary/beast/badger-xmm.md) stat block. They are indifferent toward the characters but defend themselves if necessary.
...
Twenty gas bats—bloated, chiropteran plants propelled by embarrassing-sounding emissions—float above this futuristic taproom, where androids and crew once shared drinks together. Each bat uses the [gas spore](3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) stat block, but its size is Tiny.
...
As an action, a character can adjust the machine's settings to change the weather over the garden (areas S56–S60). Roll on the Garden Weather Effects table to determine the effect. It takes 10 minutes for the new weather to take effect. If unchanged, the new weather lasts for `dice:1d4|noform|noparens|avg` (`1d4`) hours, after which time it becomes balmy again and the machine resumes its normal, automated weather cycle.
...
Two deadly, bipedal lizards captured from another world dwell here. They have short horns, mottled hides, and spiny frills. The lizards use the [tyrannosaurus rex](3-Mechanics/CLI/bestiary/beast/tyrannosaurus-rex-xmm.md) stat block, but their size is Large.
...
A school of twenty scintillating fish with gemlike scales inhabits this streamlet and its pool. The fish use the [swarm of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) stat block but shed dim light in a 10-foot radius. The fish are indifferent toward the characters unless disturbed, at which point they retreat downstream toward the swamp (area S58).
...
Four [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) lurk among the thick growth near the path to catch the unwary. After dispatching the mounds, a character who surveys the area and succeeds on a DC 14 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check finds a narrow path to the creatures' den nearby. A heap of rotting vegetation within contains two [energy cells](3-Mechanics/CLI/items/energy-cell-xdmg.md), a Humanoid skeleton with a jeweled ring worth 1,000 gp, and dozens of finger-sized maggots.

##### S56e: Squealer

This area is the territory of a squealer—a porcine-headed predator unleashed during the crash. The squealer uses the [nalfeshnee](3-Mechanics/CLI/bestiary/fiend/nalfeshnee-xmm.md) stat block, but it's a Monstrosity and has a 30-foot climbing speed instead of a flying speed. The creature [hides](3-Mechanics/CLI/rules/actions.md#Hide) in the treetops, mimicking the cries of distressed Beasts to attract prey. A character who hears the sounds recognizes them as imitations with a successful DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check.
...
Five [thri-kreen](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-marauder-xmm.md) and their leader, a [psionic thri-kreen](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-marauder-xmm.md) (a variant thri-kreen), hide in the canopies near this snaking pathway. The character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score notices the thri-kreen, who are initially indifferent toward the party.

If the characters parley with the thri-kreen, the insectile warriors ask them to destroy the [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) in area S56d in exchange for two [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md) the thri-kreen have accumulated. The thri-kreen cryptically warn the characters they'll need the explosives to cross the lake. If the characters decline, the thri-kreen disappear into the foliage without another word.

##### S57c: Boring Grass Patch

The grass surrounding this northern path has bristly, corkscrew-shaped leaves. A non-Plant creature that enters the grass for the first time on a turn or starts its turn there takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) piercing damage and has its speed reduced by 10 feet until the start of its next turn.
...
Eight giant leeches (use the [giant constrictor snake](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) stat block) dwell in the swamp. Each leech has two eyestalks and a translucent underbelly that reveals a mingling of blood-engorged sacs, peristaltic organs, and smooth muscle tissue. The parasites flatten their bodies to hide beneath the water's edge and ambush passersby. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher notice the leeches.

#### S59: Lake

![A froghemoth elder—a giant, amphibious predator from another world—blocks the path forward](file://adventure/QftIS/127-07-009.froghemoth.webp#center)
...
![A cute little bunnyoid sits on a stump](file://adventure/QftIS/128-07-010.bunnyoid.webp#center)
...
> [!gallery]
> ![Map 7.4: Spaceship Level 4](file://adventure/QftIS/129-map-7.04-spaceship-level-4-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/130-map-7.04-spaceship-level-4-map-player.webp#gallery)
...
Each server has Armor Class 19; 50 hit points; and immunity to lightning, poison, and psychic damage. Electrical piping and exposed wiring cover each server. A creature that touches a server or hits it with a melee attack takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) lightning damage and must succeed on a DC 10 Constitution saving throw or have the [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) condition until the start of its next turn.
...
A cobwebbed Humanoid skeleton in a regal uniform is sprawled on the cold floor here. These are the jumbled bones of the ship's commander, whose [laser pistol](3-Mechanics/CLI/items/laser-pistol-xdmg.md) and platinum key card are nearby. The pistol can fire 10 shots before its [energy cell](3-Mechanics/CLI/items/energy-cell-xdmg.md) is drained.
...
A herd of ten [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) roams this area, preying on creatures that happen on this entrance to the ship. When the characters inspect the breach, the aberrations emerge from air ducts in the surrounding machinery and attack.
...
![An intellect devourer stalks a group of explorers on the service deck](file://adventure/QftIS/131-07-011.intellect-devourer.webp#center)
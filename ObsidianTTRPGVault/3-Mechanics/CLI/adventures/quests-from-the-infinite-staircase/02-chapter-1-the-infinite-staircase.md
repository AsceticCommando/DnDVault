...
![While traversing the Infinite Staircase, two adventurers happen on the Censer of Dreams, a noble genie's palace](file://adventure/QftIS/002-01-001.ch1-the-infinite-staircase.webp#center)
...
The Infinite Staircase is immune to all damage and can't have its form changed by spells like [Passwall](3-Mechanics/CLI/spells/passwall-xphb.md) or similar magic. No one knows who or what built the staircase—or continues to add to it. Its masons are never seen but often heard, their hammers ringing in the distance like rolling thunder.
...
Areas of the staircase plagued by the Iron Shadow appear cold and lifeless and are shrouded in palls of magical gloom. A creature that enters the gloom for the first time on a turn or starts its turn there must succeed on a DC 10 Constitution saving throw or gain 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). If this effect increases a creature's level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) above 5, the creature becomes a [shadow](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) under the Iron Shadow's control. Nothing short of a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell or divine intervention can reverse this transformation.

If an area of bright light created by a spell of 3rd level or higher overlaps with an area of gloom, that gloom disappears for 1 hour. Only a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell can permanently expunge a patch of the Iron Shadow from the staircase.

### Umbral Manifestations

Aspects of the Iron Shadow occasionally take on physical forms, manifesting as [memory webs](3-Mechanics/CLI/bestiary/aberration/memory-web-qftis.md), [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md), or shadow dragons.
...
| 2 | Deepest door of an infamous [lich's](3-Mechanics/CLI/bestiary/undead/lich-xmm.md) tomb |
| 3 | Door to a giant's outhouse |
| 4 | Fleshy aperture in a [mind flayer's](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) laboratory |
| 5 | Grandfather clock in an inventor's workshop |
| 6 | Locked wardrobe in a [noble's](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) mansion |
...
Traveling to another plane requires locating a door that corresponds to the desired destination. There's no reason to the doors' arrangement, but creatures on the staircase longing for a specific destination feel the tug of its magic pulling them toward where they want to go. Finding the right door is a matter of exploration and time: locating the correct one takes `dice:4d12|noform|noparens|avg` (`4d12`) hours of travel. If a creature has visited the door before, this time is halved.
...
| 64–68 | Ornate, upright coffin that expels a hostile [swarm of bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) when opened | Empty crypt in the bowels of Castle Ravenloft, a fortress in the Shadowfell ruled by the vampire Count Strahd von Zarovich |
...
![A cadre of marching modrons encounters a section of the Infinite Staircase engulfed by the Iron Shadow](file://adventure/QftIS/003-01-002.marching-modrons.webp#center)
...
| dice: d100 | Encounter |
|------------|-----------|
| 01–07 | An [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md) ascends the staircase to a goodly realm. Flowers sprout from the steps behind it as it walks. The empyrean waves politely at the party. |
...
| 15–21 | Three [aarakocra](3-Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) return to the Censer of Dreams (detailed later in this chapter) from a faraway plane. The friendly avian travelers invite the characters to accompany them back to the palace. |
| 22–28 | Melvin Manyroads (chaotic good, gnome [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)), a planar cartographer, stops to ask the characters if they've seen a particular door on the staircase. |
| 29–35 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [bearded devils](3-Mechanics/CLI/bestiary/fiend/bearded-devil-xmm.md) look for a door that leads behind enemy lines of the Blood War, the eternal conflict between demons and devils. |
| 36–42 | A stubborn dwarf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) bumps into the characters. He's been wandering the staircase for decades but won't admit he's lost. |
| 43–49 | A masked [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) loyal to Selûne offers to guide the characters to a door of their choosing. The angel plays melodies on its harp during the journey. |
| 50–56 | An aspect of the Iron Shadow, a [young red shadow dragon](3-Mechanics/CLI/bestiary/dragon/shadow-dragon-xmm.md), rises from a staircase shrouded in dusk to confront the characters. |
| 57–63 | Inky tendrils writhe from a fleshy door to the Far Realm. Two [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) struggle to hold the door shut. They call out to the party for aid. |
| 64–70 | A lost unit of the Great Modron March consisting of `dice:1d8\|noform\|noparens\|avg` (`1d8`) [duodrones](3-Mechanics/CLI/bestiary/construct/modron-duodrone-xmm.md) and `dice:1d6\|noform\|noparens\|avg` (`1d6`) [tridrones](3-Mechanics/CLI/bestiary/construct/modron-tridrone-xmm.md) proceeds down the staircase, cataloging its every door. |
...
| 78–84 | A [mastiff](3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md) that wandered through a portal trots up to the party. It drops a stick in front of one of the characters and wags its tail eagerly. |
| 85–91 | A [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) happens on the staircase, flooding it with a deluge of water from an aquatic plane. |
...
- **Wish.** Nafas grants the characters one to three castings of the [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell on their behalf. The djinni might require the characters to complete multiple adventures before allotting such a handsome gift.  

![The noble genie Nafas entertains guests with a thrilling story in his palace](file://adventure/QftIS/004-01-003.the-genie-nafas.webp#center)
...
- **Unseen Stewards.** A staff of one hundred [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) zephyrs tends to the palace and its guests. Each of these stewards functions as if created by the [Unseen Servant](3-Mechanics/CLI/spells/unseen-servant-xphb.md) spell; however, the zephyrs are permanent fixtures that last until destroyed, and they can move anywhere in the palace without dissipating. Only Nafas and creatures he designates can command the zephyrs. A destroyed zephyr re-forms in a random location within the palace after `dice:1d4|noform|noparens|avg` (`1d4`) days.  
...
![Travelers from all places arrive at the Censer of Dreams, Nafas's palace on the Infinite Staircase](file://adventure/QftIS/005-01-004.censer-of-dreams.webp#center)
...
| 3 | A powerful [efreeti](3-Mechanics/CLI/bestiary/elemental/efreeti-xmm.md) from the City of Brass sets out to conquer numerous worlds through the doors of the Infinite Staircase. Nafas charges the characters with foiling the efreeti's scheme. |

...
![The ghost of the pharaoh Amun Sa wanders the Desert of Desolation, searching for worthy souls to break his curse](file://adventure/QftIS/073-05-001.ch5-pharaoh.webp#center)
...
![A Door to the Pharaoh's Pyramid](file://adventure/QftIS/074-05-002.pharaoh-door.webp#center)
...
- **Recover Amun Sa's Implements.** The characters gain 1 level when they recover both the [Staff of Ruling](3-Mechanics/CLI/items/staff-of-ruling-qftis.md) and the [star-gem of Mo-Pelar](3-Mechanics/CLI/items/gem-of-seeing-xdmg.md).  

If you follow this method, the characters should reach 9th level by the adventure's conclusion.

![](file://adventure/QftIS/075-05-003.pharaoh-original.webp#center)
...
The adventure begins with the characters trekking through the desert. Depending on what brings the characters there, they might be searching for answers within the region or trying desperately to escape it. At your discretion, each of the characters might begin this adventure with a [camel](3-Mechanics/CLI/bestiary/beast/camel-xmm.md) or a [draft horse](3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) to ride.

### Desert Heat

For `dice:1d6|noform|noparens|avg` (`1d6`) hours of each day, the desert becomes unbearably hot, rising to temperatures well over 100 degrees Fahrenheit. The "extreme heat" has detrimental effects on creatures not acclimated to such environments (see the "Dungeon Master's Guide").
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | Two [bulettes](3-Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md) with sandstone-textured carapaces burrow up from the dunes and attack. The bulettes focus on mounts and Small creatures in the party (if any), seeking to drag them beneath the sands. |
| 2 | The characters spot a lush oasis, but it's a mirage. A character who studies the oasis and succeeds on a DC 20 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check recognizes the illusion for what it is. A creature that enters the oasis steps into a [quicksand pit](3-Mechanics/CLI/traps-hazards/quicksand-pit-xdmg.md) (see the [Dungeon Master's Guide](3-Mechanics/CLI/traps-hazards/quicksand-pit-xdmg.md)). |
| 3 | A dust storm rises on the wind. The storm lasts 1 hour, during which time the characters have disadvantage on ranged weapon attack rolls and Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks. Shortly after the dust storm begins, an [air elemental](3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md) and eight [dust mephits](3-Mechanics/CLI/bestiary/elemental/dust-mephit-xmm.md) materialize from the sands and attack. |
| 4 | Four [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) lie in ambush just beneath the sand. Adapted to the desert climate, the gricks have advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks to [hide](3-Mechanics/CLI/rules/actions.md#Hide) in desert terrain. |
| 5 | A snobbish [efreeti](3-Mechanics/CLI/bestiary/elemental/efreeti-xmm.md) royal saunters across the desert. He demands each character pledge a vow of fealty to him or face his wrath. |
| 6 | Two [wyverns](3-Mechanics/CLI/bestiary/dragon/wyvern-xmm.md) soar above the characters, circling them like vultures. After 1 minute, the wyverns swoop down and attack. |
^desert-of-desolation-encounters
...
This is the [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) of Amun Sa, former pharaoh of Bakar. He walks in a straight line that intersects the characters' path, shuffling along with a blank gaze like a haunted man.
...
- **Warded Walls.** Magic that would alter the pyramid's stone—such as the [Stone Shape](3-Mechanics/CLI/spells/stone-shape-xphb.md) or [Passwall](3-Mechanics/CLI/spells/passwall-xphb.md) spells—has no effect on the pyramid.  
...
> [!gallery]
> ![Map 5.1: False Tomb](file://adventure/QftIS/076-map-5.01-false-tomb.webp#gallery)
> ![Player Version](file://adventure/QftIS/077-map-5.01-false-tomb-player.webp#gallery)
...
Two siblings, Atfez and Pachi (neutral good, human [bandit captains](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)), stand guard outside the pyramid's entrance, keeping watch for creatures that might disrupt their faction's activities within. Atfez and Pachi are members of the Tears of Athis, a group of historians, priests, and descendants of Bakar who hope to see the River Athis flow once more.
...
![Iaseda, leader of the Tears of Athis, pieces together two shattered fragments of the pyramid's inner halls](file://adventure/QftIS/078-05-004.iaseda.webp#center)

The robed woman is Iaseda (lawful good, human [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)), leader of the Tears of Athis. She is fifty years old and has a calm, determined manner. Around her, five more members of the Tears of Athis (neutral good [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) use a sticky paste to carefully repair the room's plaster walls, which they hope hold clues to restoring the River Athis. If the characters were peaceful toward the guards outside the pyramid, Iaseda is friendly toward them. If the characters pose a threat to the Tears of Athis, Iaseda and her fellow Tears defend themselves and the pyramid fiercely, decrying the characters as defilers.
...
This room is brightly lit by [Continual Flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on wall sconces. When Amun Sa was interred, his most loyal priests dutifully locked themselves inside the pyramid's upper floors. In the brief period between Amun Sa's death and the collapse of Bakar, the people of Bakar brought food and drink to this room. They believed they were bringing offerings for the gods, but in truth, they were sending sustenance to the priests in the pyramid.
...
The bowl's flame gives off neither heat nor smoke. Whenever an object or creature enters the bowl, the flames surge around the object or creature, concealing it completely and teleporting it to area P13 of the pyramid's second floor. To an onlooker, the object or creature appears to be consumed by the flame, vanishing in an instant. An onlooker who succeeds on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can tell that the bowl teleported its contents somewhere else. A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of conjuration magic around the bowl.
...
As in area P10, this scene was staged by the priests of Amun Sa long ago. Three hostile [mimics](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) lie in wait here, disguised as an unbroken chest and a couple of intact vases.
...
For each hour the party spends in the Maze of Mists, roll a `dice:d6|noform|noparens|avg` (`d6`). On a roll of 1, an encounter occurs. To determine what the characters encounter, roll on the Random Maze of Mists Encounters table, rerolling duplicates.
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | Four [phase spiders](3-Mechanics/CLI/bestiary/monstrosity/phase-spider-xmm.md) |
| 2 | Two [invisible stalkers](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) |
| 3 | Eight [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
| 4 | Two [minotaurs](3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) chasing a scared human [bandit](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) who belongs to the Hands of Plenty (see area P16) |
^random-maze-of-mists-encounters

The following locations are keyed to map 5.2.

> [!gallery]
> ![Map 5.2: Maze of Mists](file://adventure/QftIS/079-map-5.02-maze-of-mists-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/080-map-5.02-maze-of-mists-map-player.webp#gallery)
...
A [+1 Warhammer](3-Mechanics/CLI/items/1-weapon-xdmg.md) lies near a heavy plank door in this clear stretch of corridor.

##### P14c

A tiny ring made of fine silver lies on the floor in the center of this corridor. The ring is a cursed [Ring of Feather Falling](3-Mechanics/CLI/items/ring-of-feather-falling-xdmg.md). Attuning to the ring extends its curse to the wearer, who suffers the following effect:

- **Curse of Ill Temper.** You are overcome with an urge to disagree with others' actions, ideas, and opinions.  

While cursed in this way, the wearer is unwilling to part with the ring. A [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic breaks the curse.
...
The axe is a [Berserker Axe](3-Mechanics/CLI/items/berserker-axe-xdmg.md). The weapon's name ("Enduval") is inscribed into the blade. The axe stops shimmering once it's removed from the corpse.
...
A leather knapsack lies on the floor next to a door. It contains a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Fly](3-Mechanics/CLI/spells/fly-xphb.md), a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md), and a pouch containing 30 pp.

##### P14l

A [Ring of Protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md) sits on the floor of this clear section of corridor.
...
The "elves" are five [doppelgangers](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) that devoured a group of adventurers in this room four days ago; like the characters, those adventurers sought to break the pharaoh's curse. The doppelgangers then took on the adventurers' appearances.
...
Seven human [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) camp in this room. They are led by Cateline and Imbert (chaotic neutral, human [bandit captains](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)). The bandits are part of a thieving troupe called the Hands of Plenty. Dirty, sweaty, and tired, the bandits are initially indifferent toward the characters. If the characters knocked on the door before entering, the bandits have their weapons at the ready. Otherwise, they are arguing loudly.
...
An oversized chest sits atop a beautiful rug in this dome-ceilinged room. The rug beneath the chest is a [rug of smothering](3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md).

If the chest or the rug is disturbed, the rug slips from beneath the chest and attacks. At the same time, the chest opens to reveal three more [rugs of smothering](3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md) that unfurl themselves and join the fight. Apart from these rugs, the chest is empty.
...
A [gynosphinx](3-Mechanics/CLI/bestiary/celestial/sphinx-of-lore-xmm.md) named Senenura resides in this room. Initially indifferent to the characters, she asks them what they are doing here, then she makes them an offer. If the characters can answer a riddle, Senenura promises to answer one question they have about the tomb. She warns, however, that if the characters don't answer correctly, she will eat them. The characters need to accept or decline the offer before knowing the riddle.
...
> [!gallery]
> ![Diagram 5.1: Well of Questions](file://adventure/QftIS/084-well-of-questions-gm.webp#gallery)
> ![Player Version](file://adventure/QftIS/084-well-of-questions-player.webp#gallery)
...
An [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) lurks in this room. When two or more creatures enter the room, the invisible stalker severs the pendulum's rope, causing the blade to sweep down at them. It then attempts to [shove](3-Mechanics/CLI/rules/variant-rules/unarmed-strike-xphb.md) creatures into the blade's path.

##### Pendulum

If the rope securing the pendulum is cut, the blade swings down toward the door and back again. A creature in the swinging blade's path must succeed on a DC 15 Dexterity saving throw or take `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) slashing damage. The blade swings again on initiative count 20 of each round (losing initiative ties), and the damage on subsequent rounds is reduced by `dice:1d10|noform|noparens|avg` (`1d10`). When the number of damage dice reaches 0, the blade stops.
...
![Bloodthirsty minotaurs stalk the Maze of Mists, hacking trespassers to bits with wicked-looking axes](file://adventure/QftIS/081-05-005.minotaur.webp#center)
...
Magical darkness fills this room. A [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the darkness dispels it, as does the [Daylight](3-Mechanics/CLI/spells/daylight-xphb.md) spell.

A locked chest rests against the west wall. Two [black puddings](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) cling to the ceiling above it. The oozes drop from the ceiling to ambush any creature that approach the chest.

##### Treasure

The chest holds three identical bottles: two [Potions of Healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and a [Potion of Poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md).
...
Three [flameskulls](3-Mechanics/CLI/bestiary/undead/flameskull-xmm.md) fly in circles around this room, whose domed ceiling is encircled by a narrow ledge. The flameskulls attack intruders on sight.
...
A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) camouflaged to match the stonework lies flush against the ceiling of this room, whose domed ceiling is encircled by a narrow ledge. The cloaker attacks the first creature that enters the chamber.
...
For each hour the party spends on this floor, roll a `dice:d6|noform|noparens|avg` (`d6`). On a roll of 1, an encounter occurs. To determine what the characters encounter, roll on the Random Upper Priesthood Encounters table, rerolling duplicates.
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | Eight [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) |
| 2 | Three [carrion crawlers](3-Mechanics/CLI/bestiary/monstrosity/carrion-crawler-xmm.md) |
| 3 | Six [ghasts](3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) |
| 4 | Three [banshees](3-Mechanics/CLI/bestiary/undead/banshee-xmm.md) |
^random-upper-priesthood-encounters

The following locations are keyed to map 5.3.

> [!gallery]
> ![Map 5.3: Halls of the Upper Priesthood](file://adventure/QftIS/082-map-5.04-halls-of-the-upper-priesthood-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/083-map-5.04-halls-of-the-upper-priesthood-map-player.webp#gallery)
...
- **"Reverse.** " The entire room is affected by a [Reverse Gravity](3-Mechanics/CLI/spells/reverse-gravity-xphb.md) spell. The waterfall flows upward, exposing the hidden archway to area P44 and forming an upside-down pond in the ceiling. This effect can exist simultaneously with the "float" effect.  
...
If a character tells the statue a secret, a [Potion of Resistance (necrotic)](3-Mechanics/CLI/items/potion-of-necrotic-resistance-xdmg.md) glitters into existence at the statue's feet. This happens only once.
...
If a character sings a song or plays a tune before the statue, a [Potion of Resistance (necrotic)](3-Mechanics/CLI/items/potion-of-necrotic-resistance-xdmg.md) glitters into existence at the statue's feet. This happens only once.
...
Two [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) haunt this hallway like sentries. A character looking to traverse the hall undetected must succeed on a DC 12 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check.
...
This room is a long-abandoned kitchen, its counters and cutlery coated in a thick layer of dust. In the center of the room, a heavy wooden block has a cleaver stuck into it. The cleaver, which is made of fine silver, functions as a [silvered handaxe](3-Mechanics/CLI/items/silvered-weapon-xdmg.md).
...
> [!gallery]
> ![Diagram 5.2: Dome of Flight](file://adventure/QftIS/084-map-5.05-dome-of-flight-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/085-map-5.05-dome-of-flight-map-player.webp#gallery)
...
Two unfinished sarcophagi face each other from opposite ends of this long chamber. Two [mummies](3-Mechanics/CLI/bestiary/undead/mummy-xmm.md) lurk inside the sarcophagi, lurching forth to attack any creatures that enter the room.
...
A human [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) named Uma is fighting seven [ghasts](3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) in this octagonal room. Two slain ghasts lie at her feet. If the characters don't immediately join her in battle, Uma shouts for their aid when she notices them.
...
![Uma, a valiant warrior who headed Amun Sa's call, fends off a horde of ghasts](file://adventure/QftIS/086-05-006.uma.webp#center)
...
The sarcophagi are actually doors to the inside of the stone block, which is hollow. Five [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) lurk within. They rush out to attack the characters as soon as any of the lids are opened.
...
Three [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) float within this room. When the characters enter, the wraiths are hissing at a holy-looking mace on the floor. The wraiths attack the characters on sight.

##### Treasure

The mace is a [Mace of Disruption](3-Mechanics/CLI/items/mace-of-disruption-xdmg.md) that belonged to an honorable warrior who braved Amun Sa's tomb years ago and perished. The weapon's name ("Bar-ethel") is inscribed in its hilt.
...
> [!gallery]
> ![Diagram 5.3: Observation Dome](file://adventure/QftIS/087-map-5.06-observation-dome-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/088-map-5.06-observation-dome-map-player.webp#gallery)
...
> [!gallery]
> ![Map 5.4: Gauntlet](file://adventure/QftIS/089-map-5.07-gauntlet.webp#gallery)
> ![Player Version](file://adventure/QftIS/090-map-5.07-gauntlet-player.webp#gallery)
...
![Nafik, the undead former high priest of Amun Sa, spews a dastardly monologue in the Gauntlet of the True Way](file://adventure/QftIS/091-05-007.nafik.webp#center)
...
- **North Landing.** Two [ochre jellies](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) ooze from small holes in the east and west alcoves of this landing. They are loyal to Nafik and fight to the death.  
- **Center Landing.** A 30-foot-tall, 50-foot-wide wall of flame erupts from the floor in the middle of this landing, dividing the northern and southern halves of the room. The wall is opaque and lasts for 1 minute or until dispelled by a [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell (DC 15). A creature that passes through the wall must make a DC 15 Dexterity saving throw, taking `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage on a failed save or half as much damage on a successful one.  
- **South Landing.** A number of [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) equal to the number of characters appear from the southernmost alcoves. Each shadow is a wispy duplicate of a character intent on killing its original.  
...
A creature that falls into an aqueduct is swept to the northern end of the room and slams against the ledge face, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) bludgeoning damage. A creature can climb from the water level onto the north landing without needing to make any checks.
...
A pool of stagnant water rests in this octagonal room. Three hostile [water weirds](3-Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) lurk in the pool.
...
Nafik keeps his heart in a glass bell jar in the cavern's northeast cave. It's guarded by two [earth elementals](3-Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md). The elementals stand in stony silence unless intruders approach the northeastern alcove, at which point they attack.
...
> [!gallery]
> ![Map 5.5: Tomb of Amun Sa](file://adventure/QftIS/092-map-5.08-tomb-of-amun-sa-map.webp#gallery)
> ![Player Version](file://adventure/QftIS/093-map-5.08-tomb-of-amun-sa-map-player.webp#gallery)
...
This magic mural is a portal. A character who inspects the mural and succeeds on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can tell that the mural is magical, and a [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of conjuration magic around it.
...
- Grabbing the gem with a spell such as [Mage Hand](3-Mechanics/CLI/spells/mage-hand-xphb.md)  
...
A creature that falls from the boat or the portal plummets 10,000 feet to the ground; it takes `dice:20d6|noform|noparens|avg|text(70)` (`20d6`) bludgeoning damage and has the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition at the base of the pyramid.

##### Treasure

The star-gem of Mo-Pelar lodged into the floating boat is a [Gem of Seeing](3-Mechanics/CLI/items/gem-of-seeing-xdmg.md). The ten ornate vases in the boat each contain 200 pp (for a total of 2,000 pp). Each vase weighs 15 pounds.
...
![Held aloft by magic, a reed boat floats high above the clouds, carrying the treasures of the pharaoh Amun Sa](file://adventure/QftIS/094-05-008.treasures-of-amun-sa.webp#center)

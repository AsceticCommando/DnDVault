...
![](file://adventure/WDH/ChapterSeven.webp#center)
...
![The Eyecatcher](file://adventure/WDH/Eyecatcher.webp#center)
...
> [!gallery]
> ![Ships](file://adventure/WDH/Ships-DM.webp#gallery)
> ![Ships, Main Deck (Player Version)](file://adventure/WDH/Main-Deck-Players.webp#gallery)
...
Each chest holds two sets of [common clothes](3-Mechanics/CLI/items/common-clothes.md), a [waterskin](3-Mechanics/CLI/items/waterskin-xphb.md) filled with wine, and a pouch containing `dice:3d6|noform|noparens|avg` (`3d6`) gp and `dice:4d10|noform|noparens|avg` (`4d10`) sp.
...
- Aboard the *Heartbreaker* or the *Hellraiser*, the sailors are joined by `dice:1d4|noform|noparens|avg` (`1d4`) carnies ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Furnishings include a table, ten stools, and two oak cabinets containing dishes, [tankards](3-Mechanics/CLI/items/tankard.md), and utensils.  
...
![Ships, Fore and Aft (Player Version)](file://adventure/WDH/Fore-and-Aft-Players.webp#center)
...
A successful DC 20 Dexterity check by a character using thieves' tools opens the padlock, or it can be broken off with a successful DC 20 Strength (Athletics) check. The trunk contains folded clothes, 250 gp in a sack, `dice:1d6|noform|noparens|avg` (`1d6`) pearls (worth 100 gp each) in a silk pouch, a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md), and a bottle of excellent wine (worth 25 gp), bearing a label in the shape of an eye patch and the name "One-Eyed Jax" in Common.
...
![Ships, Aft Castle (Player Version)](file://adventure/WDH/Aft-Castle-Players.webp#center)
...
![Ships, Orlop Deck (Player Version)](file://adventure/WDH/Orlop-Deck-Players.webp#center)
...
`dice: [](09-chapter-7-maestros-fall.md#^brig-occupant)`
...
![Ships, Upper Hold (Player Version)](file://adventure/WDH/Upper-Hold-Players.webp#center)
...
![Ships, Heartbreakers' Upper Hold (Player Version)](file://adventure/WDH/Upper-Hold-Heartbreaker.webp#center)
...
![Ships, Lower Hold (Player Version)](file://adventure/WDH/Lower-Hold-Players.webp#center)
...
![Ships, Eyecatchers' Lower Hold (Player Version)](file://adventure/WDH/Lower-Hold-Eyecatcher.webp#center)
...
![Scarlet Marpenoth](file://adventure/WDH/Scarlet-Marpenoth.webp#center)
...
> [!gallery]
> ![Scarlet Marpenoth](file://adventure/WDH/Scarlet-Marpenoth-DM.webp#gallery)
> ![Scarlet Marpenoth, Upper Deck (Player Version)](file://adventure/WDH/Scarlet-Marpenoth-Upper-Deck.webp#gallery)
> ![Scarlet Marpenoth, Lower Deck (Player Version)](file://adventure/WDH/Scarlet-Marpenoth-Lower-Deck.webp#gallery)
...
![Scarlet Marpenoth, Lower Deck (Player Version)](file://adventure/WDH/Scarlet-Marpenoth-Lower-Deck.webp#center)
...
If a battle erupts and escape appears impossible, the drow fight to the death. A City Watch patrol consisting of six [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) arrives `dice:1d4|noform|noparens|avg` (`1d4`) minutes later to make arrests.
...
![Nat, Jenks and Squiddly enjoy a windy autumn day on the docks](file://adventure/WDH/Autumn-Scene.webp#center)

...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/drde-dotsc
aliases:
- "Introduction"
---
# Introduction
*Source: Dragon Delves: Dragons of the Sandstone City, p. 4* 

![](file://adventure/DrDe/000-dragon-delves-cover.webp#center)
...
![](file://adventure/DrDe/001-00-001.intro-splash.webp#center)
...
- **Monster Wranglers.** Whenever the characters enter combat with Hostile monsters, one or two players run these monsters using the stat blocks in the "Monster Manual". (Two players can share this role.)  
- **Rules Consultant.** One player references rules in the "Player's Handbook" or other books as needed.  

### Adventures for One Character
...
Central to those instructions is the [Blessing of the Lone Champion](3-Mechanics/CLI/rewards/blessing-of-the-lone-champion-drde.md), a supernatural gift that bolsters the solo character's abilities.

> [!embed-reward]- Blessing of the Lone Champion
> ![Blessing of the Lone Champion](3-Mechanics/CLI/rewards/blessing-of-the-lone-champion-drde.md)

The blessing lasts for the duration of the adventure.

> [!note] A Draconic History
> 

...
If Red goes to investigate, the sapling, a young [awakened shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub-xmm.md), introduces herself as Elowen Greenleaf. She knows all about Red the Ranger and recommended Red to Mr. Honeycutt to help unravel and solve the mystery of the color outages.
...
A successful DC 10 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check reveals that the thorn bushes are two [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md), while the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) sapling wearing a green sash with stitched-on badges is an [awakened shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub-xmm.md), Elowen Greenleaf.
...
The [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) have orders from the shadowy Mr. Greystone to find the Scarlet Sentinel and retrieve the Crimson Gem. For what purpose, they don't know, but what they do know is that bringing Elowen Greenleaf back to their master is a good first step to finding the gem.
...
This is also a good place to have Red discover some healing plants that Red (or Elowen) can brew into a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). Finding the healing plants requires a successful DC 14 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check, or you can have Red automatically find the plants and brew the potion.
...
Whether Red is climbing up the cliff or rappelling down it, they must make a DC 12 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check for every 15 feet of movement (rounded up). Using climbing gear or anchoring themselves to a tree with a rope gives them advantage on the check. If the check fails, and the character isn't anchored to a tree by a rope, any falling character takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) bludgeoning damage for every 10 feet fall.
...
![](file://adventure/NRH-AVitW/004.webp#center)
...
![](file://adventure/NRH-AVitW/sheet003.webp#center)

![](file://adventure/NRH-AVitW/sheet004.webp#center)
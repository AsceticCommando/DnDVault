...
![](file://variantrules/GoS/095-za-05-travel-at-sea-p199.webp#center)
...
At the end of the day, the ship's bosun can make a Strength check using [carpenter's tools](3-Mechanics/CLI/items/carpenters-tools-xphb.md). On a 15 or higher, each damaged component regains hit points equal to `dice:1d6|noform|noparens|avg` (`1d6`) + the crew's quality score (minimum of 1 hit point). A component other than the hull that had 0 hit points becomes functional again.
...
| Cook | Intelligence ([brewer's supplies](3-Mechanics/CLI/items/brewers-supplies-xphb.md)) |
^crew-conflict-checks
...
| Surgeon | Intelligence ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) |
| Cook | Constitution ([cook's utensils](3-Mechanics/CLI/items/cooks-utensils-xphb.md)) |
^infestation-checks

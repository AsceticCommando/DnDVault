...
In the case of spells that cover an area, such as [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) or [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md), you might track the exact location of the spell and crew to determine how many sailors it affects. Alternatively, you can roll `dice:1d6|noform|noparens|avg` (`1d6`) per level of the spell. The total of the dice is the number of crew members caught in the spell's area.

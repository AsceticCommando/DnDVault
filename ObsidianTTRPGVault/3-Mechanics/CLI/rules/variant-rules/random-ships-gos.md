...
Most crew members and officers on cargo ships are [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md). Vessels with valuable cargo may carry `dice:2d10|noform|noparens|avg` (`2d10`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) with a [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) guard captain. Cargo ships that transport livestock may have [goats](3-Mechanics/CLI/bestiary/beast/goat-xmm.md), [camels](3-Mechanics/CLI/bestiary/beast/camel-xmm.md), [draft horses](3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md), [mules](3-Mechanics/CLI/bestiary/beast/mule-xmm.md), and other beasts, in addition to their crews and passengers.
...
Most crew members and officers on passenger ships are [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md). Vessels carrying important people may carry `dice:2d10|noform|noparens|avg` (`2d10`) [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) with a [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) guard captain. The passengers on a passenger ship generally consist of [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) and [nobles](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md), though many creatures have the need to travel by ship.
...
Most crew members and officers on commercial fishing ships are [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), but whaling vessels and sport hunters often have [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) among their ranks.
...
Most crew members on military ships are [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) or [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md). Officers are [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md). Many military ships carry extra [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) as passengers for invasion, boarding, and operating siege weapons. A military ship may also carry `dice:1d4|noform|noparens|avg` (`1d4`) [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) or [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) as prisoners.
...
Most crew members on pirate ships are [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md). Officers are [bandit captains](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) and could include a [pirate captain](3-Mechanics/CLI/bestiary/humanoid/pirate-captain-xmm.md) (see appendix C) and a [pirate bosun](3-Mechanics/CLI/bestiary/humanoid/pirate-bosun-gos.md) (see appendix C). Many pirate ships carry extra [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) and at least one [pirate deck wizard](3-Mechanics/CLI/bestiary/humanoid/pirate-deck-wizard-gos.md) (see appendix C) as passengers.
...
![](file://variantrules/GoS/098-za-08-ghost-ship-p210.webp#center)
...
Crew members and officers on good and neutral ghost ships are [ghosts](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md). On evil ghost ships, the crew members are 90 percent [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) and [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) (even mix of each), 10 percent are [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md), and the officers are [wraiths](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md).

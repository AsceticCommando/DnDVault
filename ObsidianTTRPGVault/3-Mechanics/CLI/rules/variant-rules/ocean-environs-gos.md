...
|-----------|-----------------------|
| 1 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [giant octopus](3-Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) |
| 3 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) |
| 4 | 1 [sea hag](3-Mechanics/CLI/bestiary/fey/sea-hag-xmm.md) and `dice:2d4\|noform\|noparens\|avg` (`2d4`) [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 5 | 1 [plesiosaurus](3-Mechanics/CLI/bestiary/beast/plesiosaurus-xmm.md) |
| 6 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [swarms of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) |
| 7 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [reef sharks](3-Mechanics/CLI/bestiary/beast/reef-shark-xmm.md) |
| 8 | 1 [giant shark](3-Mechanics/CLI/bestiary/beast/giant-shark-xmm.md) |
| 9 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) items from "Magic Item Table A" in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
| 10 | Treasure rolled on the [Treasure Hoard: Challenge 0—4](3-Mechanics/CLI/tables/treasure-hoard-challenge-04.md) table in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
^hiding-in-blue-holes
...
![](file://variantrules/GoS/096-za-06-ocean-environs-p203.webp#center)
...
The souls of the dead want the living to join them. Every hour a ship is immersed in ghost fog, roll any die. On an even number, `dice:2d4|noform|noparens|avg` (`2d4`) hostile [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md) appear and attack those on the ship. If a humanoid creature dies in ghost fog, its spirit rises as a specter that is hostile toward all creatures that aren't undead.
...
Whenever a creature in wild magic fog casts a spell of 1st level or higher, roll on the [Wild Magic Surge](3-Mechanics/CLI/tables/wild-magic-surge-xphb.md) table in chapter 3, ""Classes"," of the "Player's Handbook" to create a magical effect.
...
When conjuration magic churns within a storm's heart, creatures of wind and rain emerge from distant realms to attack anything they encounter. The ship encounters `dice:1d3|noform|noparens|avg` (`1d3`) hostile [air elementals](3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md).
...
Ghosts howl and whirl in this storm's wind, while the remains of long-dead mariners stir in their watery graves. During the storm, `dice:1d4|noform|noparens|avg` (`1d4`) [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md), `dice:2d4|noform|noparens|avg` (`2d4`) [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md), and `dice:4d6|noform|noparens|avg` (`4d6`) [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) emerge from the waves to attack the ship.
...
| dice: d10 | Creatures or Treasure |
|-----------|-----------------------|
| 1 | 1 [sahuagin priestess](3-Mechanics/CLI/bestiary/fiend/sahuagin-priest-xmm.md) and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [young bronze dragon](3-Mechanics/CLI/bestiary/dragon/young-bronze-dragon-xmm.md) |
| 3 | `dice:4d10\|noform\|noparens\|avg` (`4d10`) [giant crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md) |
| 4 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [giant seahorses](3-Mechanics/CLI/bestiary/beast/giant-seahorse-xmm.md) |
| 5 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [hunter sharks](3-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) |
| 6 | 1 [giant octopus](3-Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) |
| 7 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 8 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [merfolk](3-Mechanics/CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) |
| 9 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) items from [Magic Item Table B](3-Mechanics/CLI/tables/magic-item-table-b.md) in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
| 10 | Treasure rolled on the [Treasure Hoard: Challenge 5—10](3-Mechanics/CLI/tables/treasure-hoard-challenge-510.md) table in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
^shipwreck-contents
...
![](file://variantrules/GoS/097-za-07-p206.webp#center)
...
| Bosun | Strength ([carpenter's tools](3-Mechanics/CLI/items/carpenters-tools-xphb.md)) |

...
The most potent personal changes inspired by team building can last a lifetime. Or at least an encounter. A character who earns a team building memory gains an extraordinary ability that can be used once. As a bonus action, the character gains one effect of the [enhance ability](3-Mechanics/CLI/spells/enhance-ability-xphb.md) spell for 10 minutes (no [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) required).

...
If you do want to add elements of Emrakul's madness to your campaign, use the [Sanity](3-Mechanics/CLI/rules/variant-rules/new-ability-scores-honor-and-sanity.md) score rules in chapter 9 of the Dungeon Master's Guide. Allow characters to make Sanity checks to interpret the effects of Emrakul's corruption, and Sanity saving throws to resist the effects of the spreading madness.

A creature or character whose [Sanity score](3-Mechanics/CLI/rules/variant-rules/new-ability-scores-honor-and-sanity.md) is below 10 can begin to manifest signs of physical corruption, which progresses in stages.

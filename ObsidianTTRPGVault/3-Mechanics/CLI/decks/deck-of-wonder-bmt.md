...
### Chancellor
![](file://decks/BMT/Deck%20of%20Wonder/01-chancellor.webp#card)
Within 8 hours of drawing this card, you can cast [Augury](3-Mechanics/CLI/spells/augury-xphb.md) once as an action, requiring no material components. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).

### Day
![](file://decks/BMT/Deck%20of%20Wonder/02-day.webp#card)
You gain a +1 bonus to saving throws. This benefit lasts until you finish a long rest.

### Night
![](file://decks/BMT/Deck%20of%20Wonder/03-night.webp#card)
...
### Dawn
![](file://decks/BMT/Deck%20of%20Wonder/04-dawn.webp#card)
This card invigorates you. For the next 8 hours, you can add your proficiency bonus to your initiative rolls.

### Dusk
![](file://decks/BMT/Deck%20of%20Wonder/05-dusk.webp#card)
This card supernaturally saps your energy. You have disadvantage on initiative rolls. This effect lasts until you finish a long rest, but it can be ended early by a [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic.

### Destiny
![](file://decks/BMT/Deck%20of%20Wonder/06-destiny.webp#card)
...
### Crown
![](file://decks/BMT/Deck%20of%20Wonder/07-crown.webp#card)
You learn the [Friends](3-Mechanics/CLI/spells/friends-xphb.md) cantrip. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice). If you already know this cantrip, the card has no effect.

### Lock
![](file://decks/BMT/Deck%20of%20Wonder/08-lock.webp#card)
You gain the ability to cast [Knock](3-Mechanics/CLI/spells/knock-xphb.md) `dice:1d3|noform|noparens|avg` (`1d3`) times. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).

### Champion
![](file://decks/BMT/Deck%20of%20Wonder/09-champion.webp#card)
You gain a +1 bonus to weapon attack and damage rolls. This bonus lasts for 8 hours.

### Coin
![](file://decks/BMT/Deck%20of%20Wonder/10-coin.webp#card)
Five pieces of jewelry, each worth 100 gp, or ten gemstones, each worth 50 gp, appear at your feet.

### Vulture
![](file://decks/BMT/Deck%20of%20Wonder/11-vulture.webp#card)
...
### Chaos
![](file://decks/BMT/Deck%20of%20Wonder/12-chaos.webp#card)
...
### Order
![](file://decks/BMT/Deck%20of%20Wonder/13-order.webp#card)
...
### Beginning
![](file://decks/BMT/Deck%20of%20Wonder/14-beginning.webp#card)
...
### Mystery
![](file://decks/BMT/Deck%20of%20Wonder/15-mystery.webp#card)
...
### Isolation
![](file://decks/BMT/Deck%20of%20Wonder/16-isolation.webp#card)
...
### End
![](file://decks/BMT/Deck%20of%20Wonder/17-end.webp#card)
This card is an omen of death. You take `dice:2d10|noform|noparens|avg` (`2d10`) necrotic damage, and your hit point maximum is reduced by an amount equal to the damage taken. This effect can't reduce your hit point maximum below 10 hit points. This reduction lasts until you finish a long rest, but it can be ended early by a [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic.

### Monster
![](file://decks/BMT/Deck%20of%20Wonder/18-monster.webp#card)
This card's monstrous visage curses you. While cursed in this way, whenever you make a saving throw, you must roll `dice:1d4|noform|noparens|avg` (`1d4`) and subtract the number rolled from the total. The curse lasts until you finish a long rest, but it can be ended early with a [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic.

### Knife
![](file://decks/BMT/Deck%20of%20Wonder/19-knife.webp#card)
An uncommon magic weapon you're proficient with appears in your hands. The DM chooses the weapon.

### Justice
![](file://decks/BMT/Deck%20of%20Wonder/20-justice.webp#card)
...
### Student
![](file://decks/BMT/Deck%20of%20Wonder/21-student.webp#card)
...
### Mischief
![](file://decks/BMT/Deck%20of%20Wonder/22-mischief.webp#card)

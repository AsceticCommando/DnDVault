...
- The target regains hit points equal to `dice:1d8|noform|noparens|avg` (`1d8`) + your Wisdom modifier, and you can cure the target of one disease or neutralize one poison affecting it.  

...
Your attack rolls with weapons and Unarmed Strikes can score a [Critical Hit](3-Mechanics/CLI/rules/variant-rules/critical-hit-xphb.md) on a roll of 19 or 20 on the `dice:d20|noform|noparens|avg` (`d20`).
...
Your attack rolls with weapons and Unarmed Strikes can now score a [Critical Hit](3-Mechanics/CLI/rules/variant-rules/critical-hit-xphb.md) on a roll of 18–20 on the `dice:d20|noform|noparens|avg` (`d20`).

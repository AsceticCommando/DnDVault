...
The Death domain is concerned with the forces that cause death, as well as the negative energy that gives rise to undead creatures. Deities such as Chemosh, Myrkul, and [Wee Jas](3-Mechanics/CLI/deities/greyhawk-wee-jas.md) are patrons of necromancers, death knights, liches, mummy lords, and vampires. Gods of the Death domain also embody murder ([Anubis](3-Mechanics/CLI/deities/egyptian-anubis.md), Bhaal, and Pyremius), pain ([Iuz](3-Mechanics/CLI/deities/greyhawk-iuz.md) or Loviatar), disease or poison ([Incabulos](3-Mechanics/CLI/deities/greyhawk-incabulos.md), Talona, or Morgion), and the underworld ([Hades](3-Mechanics/CLI/deities/greek-hades.md) and [Hel](3-Mechanics/CLI/deities/norse-hel.md)).

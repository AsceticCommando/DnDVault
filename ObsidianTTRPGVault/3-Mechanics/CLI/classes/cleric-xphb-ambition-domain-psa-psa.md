...
- ttrpg-cli/domain/ambition-psa
- ttrpg-cli/subclass/cleric/ambition-psa
aliases:
- "Ambition Domain (PSA)"
---
# Ambition Domain (PSA)
...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Ambition Domain (PSA) (Level 3)' class='internal-link'>Ambition Domain (PSA)</a>, <a href='#Channel Divinity: Invoke Duplicity (Level 3)' class='internal-link'>Channel Divinity: Invoke Duplicity</a></td></tr>
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [bane](3-Mechanics/CLI/spells/bane-xphb.md), [disguise self](3-Mechanics/CLI/spells/disguise-self-xphb.md) |
| 3rd | [mirror image](3-Mechanics/CLI/spells/mirror-image-xphb.md), [ray of enfeeblement](3-Mechanics/CLI/spells/ray-of-enfeeblement-xphb.md) |
| 5th | [bestow curse](3-Mechanics/CLI/spells/bestow-curse-xphb.md), [vampiric touch](3-Mechanics/CLI/spells/vampiric-touch-xphb.md) |
| 7th | [death ward](3-Mechanics/CLI/spells/death-ward-xphb.md), [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md) |
...
Starting at 6th level, you can use your Channel Divinity to vanish. As an action, you become [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) until the end of your next turn. You become visible if you attack or cast a spell.

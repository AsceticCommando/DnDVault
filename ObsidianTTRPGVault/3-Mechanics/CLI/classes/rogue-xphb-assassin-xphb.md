...
When you use the Poison option of your Cunning Strike, the target also takes `dice:2d6|noform|noparens|avg` (`2d6`) Poison damage whenever it fails the saving throw. This damage ignores [Resistance](3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Poison damage.

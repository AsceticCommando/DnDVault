...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Knowledge Domain (PSA) (Level 3)' class='internal-link'>Knowledge Domain (PSA)</a>, <a href='#Channel Divinity: Knowledge of the Ages (Level 3)' class='internal-link'>Channel Divinity: Knowledge of the Ages</a></td></tr>
...
Kefnet's domain is identical to the [Knowledge domain in the Player's Handbook](3-Mechanics/CLI/classes/cleric-xphb-knowledge-domain-frhof.md).

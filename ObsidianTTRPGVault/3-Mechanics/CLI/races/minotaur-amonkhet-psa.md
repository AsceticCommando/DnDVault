...
![Neheb, the Worthy](file://races/PSA/Minotaur%20%28Amonkhet%29.webp#right)
...
You can use your horns as a natural weapon to make unarmed strikes. If you hit with your horns, you deal bludgeoning damage equal to `dice:1d6|noform|noparens|avg` (`1d6`) + your Strength modifier.
...
The relatively few minotaurs who specialize in long-range combat enjoy one aspect of that style in particular—the opportunity to draw first blood, marking the moment when a battle has truly begun. Minotaurs use [heavy bows](3-Mechanics/CLI/items/longbow-xphb.md) and [javelins](3-Mechanics/CLI/items/javelin-xphb.md), and take special delight in firing into the middle of enemy formations to sow as much chaos and confusion as possible.


![Minotaur Sureshot](file://races/PSA/Minotaur%20%28Amonkhet%292.webp#center)
...
- ttrpg-cli/race/rimekin
aliases:
- "Rimekin"
---
# Rimekin
*Source: Lorwyn: First Light*  
![](file://races/LFL/Rimekin.webp#right)
...
You know the [Ray of Frost](3-Mechanics/CLI/spells/ray-of-frost-xphb.md) cantrip. When you reach character levels 3 and 5, you learn the [Ice Knife](3-Mechanics/CLI/spells/ice-knife-xphb.md) spell and the [Flame Blade](3-Mechanics/CLI/spells/flame-blade-xphb.md) spell, respectively. You always have those spells prepared. You can cast each once without a spell slot, and you regain the ability to cast these spells in this way when you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md). You can also cast the spells using any spell slots you have of the appropriate level. When you cast [Flame Blade](3-Mechanics/CLI/spells/flame-blade-xphb.md) using this trait, the spell deals Cold damage instead of Fire damage.
...
You have [Resistance](3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Cold damage.

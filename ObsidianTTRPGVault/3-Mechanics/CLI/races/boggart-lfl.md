...
- ttrpg-cli/race/boggart
aliases:
- "Boggart"
---
# Boggart
*Source: Lorwyn: First Light*  
![A boggart in Lorwyn uses a frog as a dowsing pendulum](file://races/LFL/Boggart.webp#right)
...
Lorwyn boggarts also have a knack for magic. Boggarts who feel drawn to learning and using these natural affinities often become Druids. A Lorwyn boggart might alternatively find a calling as a Ranger, especially the [Fey Wanderer](3-Mechanics/CLI/classes/ranger-xphb.md) subclass, or as a Wizard, especially the [Diviner](3-Mechanics/CLI/classes/wizard-xphb.md) subclass, as boggarts have proven fond of ascertaining information through divination magic.
...
Like their Lorwyn counterparts, Shadowmoor boggarts are drawn to magic. These boggarts might become Warlocks, particularly leaning toward the [Archfey Patron](3-Mechanics/CLI/classes/warlock-xphb.md) subclass; some might believe their patron is Isilu. Others prove to be Sorcerers and are especially likely to manifest their power in the form of the [Wild Magic Sorcery](3-Mechanics/CLI/classes/sorcerer-xphb.md) subclass.
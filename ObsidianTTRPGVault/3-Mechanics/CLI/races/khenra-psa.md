...
![Trueheart Twins](file://races/PSA/Khenra.webp#right)
...
You have proficiency with the khopesh ([longsword](3-Mechanics/CLI/items/longsword-xphb.md)), [spear](3-Mechanics/CLI/items/spear-xphb.md), and [javelin](3-Mechanics/CLI/items/javelin-xphb.md).
...
The khenra of Amonkhet are tall and lean, with graceful bodies and heads that strongly resemble [jackals](3-Mechanics/CLI/bestiary/beast/jackal-xmm.md). Their snouts are long and sharp, and their angular ears rise straight above their heads. Their bodies are covered in dark, sleek hair that ranges from the brown of the desert sands to ebony black. Despite their sharp teeth, they consider biting to be an uncouth and unworthy combat tactic.
...
![Nimble-Blade Khenra](file://races/PSA/Khenra2.webp#center)
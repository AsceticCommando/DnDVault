...
![On Kaladesh, an aether-powered arrow of slaying can be launched without a bow.](file://races/PSK/Aetherborn.webp#right)
...
> 
> An aetherborn with this gift gains the Drain Life ability: a natural attack that deals `dice:1d6|noform|noparens|avg` (`1d6`) necrotic damage and restores the same number of hit points to the aetherborn. However, if the aetherborn goes for 7 days without dealing this damage, their hit point maximum is reduced by `dice:1d6|noform|noparens|avg` (`1d6`) per week. This reduction can't be removed until the aetherborn has used their Drain Life ability and completed a long rest.
...
![Essence Extraction](file://races/PSK/Aetherborn2.webp#center)
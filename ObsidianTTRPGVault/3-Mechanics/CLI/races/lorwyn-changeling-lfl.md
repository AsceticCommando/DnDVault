...
- ttrpg-cli/race/lorwyn-changeling
aliases:
- "Lorwyn Changeling"
---
# Lorwyn Changeling
*Source: Lorwyn: First Light*  
![](file://races/LFL/Changeling.webp#right)
...
You have proficiency in the [Deception](3-Mechanics/CLI/rules/skills.md#Deception) or [Performance](3-Mechanics/CLI/rules/skills.md#Performance) skill.

### Unpredictable Movement

When you roll [Initiative](3-Mechanics/CLI/rules/variant-rules/initiative-xphb.md), you can immediately move up to half your [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md), provided you don't have [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on the [Initiative](3-Mechanics/CLI/rules/variant-rules/initiative-xphb.md) roll.

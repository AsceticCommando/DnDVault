...
![Tah-Crop Elite](file://races/PSA/Aven.webp#right)
...
Following the example of Oketra, hawk-headed aven often focus on the techniques of long-range combat. Most prefer [javelins](3-Mechanics/CLI/items/javelin-xphb.md), but some are skilled with bows, [spears](3-Mechanics/CLI/items/spear-xphb.md), and [throwing axes](3-Mechanics/CLI/items/handaxe-xphb.md).

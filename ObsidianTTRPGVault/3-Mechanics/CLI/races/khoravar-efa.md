...
![](file://races/EFA/Khoravar.webp#right)
...
You know the [Friends](3-Mechanics/CLI/spells/friends-xphb.md) cantrip. Whenever you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md), you can replace that cantrip with a different cantrip from the Cleric, Druid, or Wizard spell list. Intelligence, Wisdom, or Charisma is your spellcasting ability for it (choose the ability when you select this species).

### Lethargy Resilience

When you fail a saving throw to avoid or end the [Unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) condition, you can succeed instead. Once you use this trait, you can't do so again until you finish `dice:1d4|noform|noparens|avg` (`1d4`) [Long Rests](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).

### Skill Versatility

You gain proficiency in one skill or with one tool of your choice. Whenever you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md), you can replace it with another skill or tool proficiency.

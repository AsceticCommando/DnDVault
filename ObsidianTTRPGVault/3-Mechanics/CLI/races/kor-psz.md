...
![Kor Sanctifiers](file://races/PSZ/Kor.webp#right)
...
When you roll a 1 on the `dice:d20|noform|noparens|avg` (`d20`) for an attack roll, ability check, or saving throw, you can reroll the die and must use the new roll.
...
![Kor Entanglers](file://races/PSZ/Kor2.webp#center)
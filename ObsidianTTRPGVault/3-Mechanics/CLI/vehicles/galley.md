...
- Five other officers: a first mate, a bosun, a quartermaster, a surgeon, and a cook ([scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md))  
- Forty-two sailors ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md))  
- Twelve siege engineers ([guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md))  
- Twenty [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)  
...
```ad-statblock
title: Galley
![](file://vehicles/tokens/GoS/Galley.webp#token)
...
- **Fire Ballistas.** The galley can fire its [ballistas](3-Mechanics/CLI/objects/ballista-xdmg.md) (DMG, ch. 8).  
- **Fire Mangonels.** The galley can fire its [mangonels](3-Mechanics/CLI/objects/mangonel-xdmg.md) (DMG, ch. 8).  

...
- One captain ([berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md))  
- Five other officers: a first mate, a bosun, a quartermaster, a surgeon, and a cook ([berserkers](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md))  
- Thirty-four sailors ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md))  
...
```ad-statblock
title: Longship
![](file://vehicles/tokens/GoS/Longship.webp#token)

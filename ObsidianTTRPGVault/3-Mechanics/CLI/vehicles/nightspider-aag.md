...
A nightspider's crew usually consists of nineteen neogi and up to a half-dozen [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md), which the neogi use as shock troops.
...
```ad-statblock
title: Nightspider
![](file://vehicles/tokens/AAG/Nightspider.webp#token)

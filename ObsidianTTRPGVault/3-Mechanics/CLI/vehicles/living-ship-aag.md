...
```ad-statblock
title: Living Ship
![](file://vehicles/tokens/AAG/Living%20Ship.webp#token)
...
- **Cargo** 10 tons tons
- **Crew** 5 crew (plus the [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md))

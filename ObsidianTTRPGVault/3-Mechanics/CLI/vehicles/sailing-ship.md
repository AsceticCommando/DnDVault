...
- **Mangonel.** Sailing ships have one [mangonel](3-Mechanics/CLI/objects/mangonel-xdmg.md) (DMG, ch. 8) attached to the deck. Each weapon has 10 mangonel stones stacked and secured near it.  
...
```ad-statblock
title: Sailing Ship
![](file://vehicles/tokens/GoS/Sailing%20Ship.webp#token)
...
- **Fire Ballista.** The ship can fire its [ballista](3-Mechanics/CLI/objects/ballista-xdmg.md) (DMG, ch. 8).  
- **Fire Mangonel.** The ship can fire its [mangonel](3-Mechanics/CLI/objects/mangonel-xdmg.md) (DMG, ch. 8).  

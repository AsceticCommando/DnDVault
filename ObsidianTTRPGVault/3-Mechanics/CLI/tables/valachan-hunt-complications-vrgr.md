...
| 4 | [Chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md), [vine blights](3-Mechanics/CLI/bestiary/plant/vine-blight-xmm.md), or [zombie plague spreaders](3-Mechanics/CLI/bestiary/undead/zombie-plague-spreader-rhw.md) (see "chapter 5") ambush the party. |
| 5 | The characters find a tree bound in rope. One or more withered, oversized hearts hang from cords attached to its branches. Roll a die. If you roll an even number, the hearts look grim but are harmless. If you roll an odd number, the `dice:1d6\|noform\|noparens\|avg` (`1d6`) hearts have the statistics of gnashing [death's heads](3-Mechanics/CLI/bestiary/undead/deaths-head-rhw.md) (see "chapter 5") and attack. |

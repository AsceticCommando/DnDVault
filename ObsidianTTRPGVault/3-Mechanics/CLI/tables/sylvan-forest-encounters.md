...
| 5 | A grove of burned trees. Characters searching the area and succeeding on a DC 10 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check find [gnoll](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) tracks. Following the tracks for `dice:1d4\|noform\|noparens\|avg` (`1d4`) hours leads to an encounter with [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md), or the discovery of dead [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) with elven arrows sticking out of their flea-ridden corpses. |

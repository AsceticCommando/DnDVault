...
|----------|----------------|
| 1 | A [medusa](3-Mechanics/CLI/bestiary/monstrosity/medusa-xmm.md) sends authorities a broken stone finger bearing a distinctive signet ring, and invites emissaries to bring gold, a magic item, or some other ransom for the [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) individual's release. |
...
| 6 | An [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) warlord is accused of destroying a village just outside the borders of Droaam. The characters must bring the warlord to justice or work with the ogre to find the real culprit. |
^droaam-adventure-hooks
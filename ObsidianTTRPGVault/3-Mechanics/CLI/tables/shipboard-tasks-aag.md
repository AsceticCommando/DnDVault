...
| 6 | Repair the captain's favorite pair of boots, which requires cobbler's tools. (A [mending](3-Mechanics/CLI/spells/mending-xphb.md) spell also does the trick.) |
| 7 | Repair superficial damage to the ship, which requires carpenter's tools or woodcarver's tools. (A [mending](3-Mechanics/CLI/spells/mending-xphb.md) spell also does the trick.) |
| 8 | Compose a new chantey, which requires a musical instrument. |
| 9 | Entertain the crew with tall tales or gossip. |
| 10 | Fix the captain's broken spyglass, which requires jeweler's tools or tinker's tools. (A [mending](3-Mechanics/CLI/spells/mending-xphb.md) spell also does the trick.) |

...
| dice: d12 | Calamity |
|-----------|----------|
| 1 | The [tarrasque](3-Mechanics/CLI/bestiary/monstrosity/tarrasque-xmm.md) awakens. (A [kraken](3-Mechanics/CLI/bestiary/monstrosity/kraken-xmm.md), an [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md), or another titan might also serve as an agent of apocalyptic wrath.) |
...
| 10 | Magic goes awry, creating random zones of wild magic (where casting any spell of 1st level or higher causes a roll on the [Wild Magic Surge table](3-Mechanics/CLI/tables/wild-magic-surge-xphb.md) in the "Player's Handbook") and dead magic (like an [Antimagic Field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell on a larger scale). |

...
| 2 | You gain `dice:1d3\|noform\|noparens\|avg` (`1d3`) levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Until the curse ends, these levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) can't be removed. |
...
| 6 | Moonlight burns your flesh. You take `dice:1d10\|noform\|noparens\|avg` (`1d10`) radiant damage when you start your turn in moonlight. |
...
| 8 | Whenever you tell a lie, you lose the ability to speak for `dice:1d8\|noform\|noparens\|avg` (`1d8`) hours. |
^fey-curses
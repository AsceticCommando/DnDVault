...
| dice: d20 | Injury |
|-----------|--------|
| 1 | **Lose an Eye.** You have disadvantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight and on ranged attack rolls. Magic such as the [regenerate](3-Mechanics/CLI/spells/regenerate-xphb.md) spell can restore the lost eye. If you have no eyes left after sustaining this injury, you're [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded). |

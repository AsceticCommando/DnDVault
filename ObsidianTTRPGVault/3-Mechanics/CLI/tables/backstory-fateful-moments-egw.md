...
| 13 | While exploring a remote forest, you were attacked by evil lycanthropes but escaped before being killed. You are cursed with [wereboar](3-Mechanics/CLI/bestiary/monstrosity/wereboar-xmm.md), [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md), or [werewolf](3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md) (DM's choice). |
| 14 | While lost in a remote forest or jungle, you were saved by a [werebear](3-Mechanics/CLI/bestiary/monstrosity/werebear-xmm.md) or [weretiger](3-Mechanics/CLI/bestiary/monstrosity/weretiger-xmm.md) (DM's choice). The lycanthrope believed you were destined for greatness and granted you the gift of [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md) with your consent. |
...
| 18 | You saved a riderless horse wearing full tack and harness from wolves. You own a [riding horse](3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) and a saddle, and you have proficiency in the [Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling) skill. |

...
tags:
  - Category/People
MyContainer: "[[2-World/Hubs/The Slack-Tide.md|The Slack-Tide]]"
MyCategory: Refugee weaver (an edition)
image: Template_Person_Placeholder.png
obsidianUIMode: preview
char_status: Saved (archived edition)
char_race: Human (edition)
char_gender: Female
char_age: Adult
Connected_Groups:
  - "[[2-World/Groups/The Errata.md|The Errata]]"
Connected_Quests:
  - "[[2-World/Quests/The Peripeteia.md|The Peripeteia]]"
---
